...
class HXCPP_CLASS_ATTRIBUTES HBGlyphPosition_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< HBGlyphPosition_obj > __new() {
			hx::ObjectPtr< HBGlyphPosition_obj > __this = new HBGlyphPosition_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< HBGlyphPosition_obj > __alloc(hx::Ctx *_hx_ctx) {
			...
			*(void **)__this = HBGlyphPosition_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_HCSTRING("HBGlyphPosition","\x1b","\xa3","\x0d","\x8d"); }
