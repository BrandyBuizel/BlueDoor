...
HXLINE(  28)		this->rawRight = (int)-1;
HXLINE(  23)		this->rawLeft = (int)-1;
HXLINE(  18)		this->rawDown = (int)-1;
...
HXDLIN(  59)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN(  60)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXDLIN(  61)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
...
HXDLIN(  62)		 ::flixel::util::LabelValuePair _hx_tmp3 = _this3;
...
HXDLIN(  63)		 ::flixel::util::LabelValuePair _hx_tmp4 = _this4;
...
HXDLIN(  64)		 ::flixel::util::LabelValuePair _hx_tmp5 = _this5;
...
HXDLIN(  65)		 ::flixel::util::LabelValuePair _hx_tmp6 = _this6;
...
HXLINE(  58)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(8)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_hx_tmp3)->init(4,_hx_tmp4)->init(5,_hx_tmp5)->init(6,_hx_tmp6)->init(7,_this7));
            	}
