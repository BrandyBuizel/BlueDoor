...
HX_DEFINE_STACK_FRAME(_hx_pos_fa6bbd6c5d089215_53_new,"__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","lime/_internal/macros/AssetsMacro.hx",53,0xc651f030)
...
void __ASSET__flixel_sounds_beep_ogg_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_fa6bbd6c5d089215_53_new)
HXLINE(  54)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_sounds_beep_ogg_obj::resourceName);
...
bool __ASSET__flixel_sounds_beep_ogg_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x4e491606) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x4e491606;
	} else {
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:file___ASSET__flixel_sounds_beep_ogg",6d,0a,6e,70);
            	}
}
