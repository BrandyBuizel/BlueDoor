...
HX_DEFINE_STACK_FRAME(_hx_pos_0f70c5927802d56d_1641_new,"lime._internal.graphics._ImageDataUtil.ImageDataView","new",0x36089ace,"lime._internal.graphics._ImageDataUtil.ImageDataView.new","lime/_internal/graphics/ImageDataUtil.hx",1641,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1665_clip,"lime._internal.graphics._ImageDataUtil.ImageDataView","clip",0x0a3ec4a2,"lime._internal.graphics._ImageDataUtil.ImageDataView.clip","lime/_internal/graphics/ImageDataUtil.hx",1665,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1675_hasRow,"lime._internal.graphics._ImageDataUtil.ImageDataView","hasRow",0xdbd8dd32,"lime._internal.graphics._ImageDataUtil.ImageDataView.hasRow","lime/_internal/graphics/ImageDataUtil.hx",1675,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1679_offset,"lime._internal.graphics._ImageDataUtil.ImageDataView","offset",0x80da85e5,"lime._internal.graphics._ImageDataUtil.ImageDataView.offset","lime/_internal/graphics/ImageDataUtil.hx",1679,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1707_row,"lime._internal.graphics._ImageDataUtil.ImageDataView","row",0x360bac88,"lime._internal.graphics._ImageDataUtil.ImageDataView.row","lime/_internal/graphics/ImageDataUtil.hx",1707,0x59dddace)
HX_LOCAL_STACK_FRAME(_hx_pos_0f70c5927802d56d_1711___update,"lime._internal.graphics._ImageDataUtil.ImageDataView","__update",0xdf2597fb,"lime._internal.graphics._ImageDataUtil.ImageDataView.__update","lime/_internal/graphics/ImageDataUtil.hx",1711,0x59dddace)
namespace lime{
namespace _internal{
namespace graphics{
...
void ImageDataView_obj::__construct( ::lime::graphics::Image image, ::lime::math::Rectangle rect){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1641_new)
HXLINE(1642)		this->image = image;
HXLINE(1644)		if (hx::IsNull( rect )) {
HXLINE(1646)			this->rect = image->get_rect();
            		}
            		else {
HXLINE(1650)			if ((rect->x < (int)0)) {
HXLINE(1650)				rect->x = (int)0;
            			}
HXLINE(1651)			if ((rect->y < (int)0)) {
HXLINE(1651)				rect->y = (int)0;
            			}
HXLINE(1652)			if (((rect->x + rect->width) > image->width)) {
HXLINE(1652)				rect->width = (image->width - rect->x);
            			}
HXLINE(1653)			if (((rect->y + rect->height) > image->height)) {
HXLINE(1653)				rect->height = (image->height - rect->y);
            			}
HXLINE(1654)			if ((rect->width < (int)0)) {
HXLINE(1654)				rect->width = (int)0;
            			}
HXLINE(1655)			if ((rect->height < (int)0)) {
HXLINE(1655)				rect->height = (int)0;
            			}
HXLINE(1656)			this->rect = rect;
            		}
HXLINE(1659)		this->stride = image->buffer->get_stride();
HXLINE(1661)		this->_hx___update();
            	}
...
void ImageDataView_obj::clip(int x,int y,int width,int height){
            	HX_GC_STACKFRAME(&_hx_pos_0f70c5927802d56d_1665_clip)
HXLINE(1666)		if (hx::IsNull( this->tempRect )) {
HXLINE(1666)			this->tempRect =  ::lime::math::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
HXLINE(1667)		this->tempRect->setTo(x,y,width,height);
HXLINE(1669)		this->rect->intersection(this->tempRect,this->rect);
HXLINE(1670)		this->_hx___update();
            	}
...
bool ImageDataView_obj::hasRow(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1675_hasRow)
HXDLIN(1675)		if ((y >= (int)0)) {
HXDLIN(1675)			return (y < this->height);
            		}
            		else {
...
void ImageDataView_obj::offset(int x,int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1679_offset)
HXLINE(1680)		if ((x < (int)0)) {
HXLINE(1682)			 ::lime::math::Rectangle _hx_tmp = this->rect;
HXDLIN(1682)			_hx_tmp->x = (_hx_tmp->x + x);
HXLINE(1683)			if ((this->rect->x < (int)0)) {
HXLINE(1683)				this->rect->x = (int)0;
            			}
            		}
            		else {
HXLINE(1687)			 ::lime::math::Rectangle _hx_tmp1 = this->rect;
HXDLIN(1687)			_hx_tmp1->x = (_hx_tmp1->x + x);
HXLINE(1688)			 ::lime::math::Rectangle _hx_tmp2 = this->rect;
HXDLIN(1688)			_hx_tmp2->width = (_hx_tmp2->width - x);
            		}
HXLINE(1691)		if ((y < (int)0)) {
HXLINE(1693)			 ::lime::math::Rectangle _hx_tmp3 = this->rect;
HXDLIN(1693)			_hx_tmp3->y = (_hx_tmp3->y + y);
HXLINE(1694)			if ((this->rect->y < (int)0)) {
HXLINE(1694)				this->rect->y = (int)0;
            			}
            		}
            		else {
HXLINE(1698)			 ::lime::math::Rectangle _hx_tmp4 = this->rect;
HXDLIN(1698)			_hx_tmp4->y = (_hx_tmp4->y + y);
HXLINE(1699)			 ::lime::math::Rectangle _hx_tmp5 = this->rect;
HXDLIN(1699)			_hx_tmp5->height = (_hx_tmp5->height - y);
            		}
HXLINE(1702)		this->_hx___update();
            	}
...
int ImageDataView_obj::row(int y){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1707_row)
HXDLIN(1707)		int _hx_tmp = this->byteOffset;
HXDLIN(1707)		return (_hx_tmp + (this->stride * y));
            	}
...
void ImageDataView_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_0f70c5927802d56d_1711___update)
HXLINE(1712)		this->x = ::Math_obj::ceil(this->rect->x);
HXLINE(1713)		this->y = ::Math_obj::ceil(this->rect->y);
HXLINE(1714)		this->width = ::Math_obj::floor(this->rect->width);
HXLINE(1715)		this->height = ::Math_obj::floor(this->rect->height);
HXLINE(1716)		int _hx_tmp = this->stride;
HXDLIN(1716)		int _hx_tmp1 = (_hx_tmp * (this->y + this->image->offsetY));
HXDLIN(1716)		this->byteOffset = (_hx_tmp1 + ((this->x + this->image->offsetX) * (int)4));
            	}
