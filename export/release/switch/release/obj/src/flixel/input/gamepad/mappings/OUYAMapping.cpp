...
HXLINE(  59)				return (int)8;
            			...
            			break;
            			case (int)3: {
HXLINE(  60)				return (int)9;
            			}
            			break;
            			case (int)4: {
HXLINE(  64)				return (int)15;
            			}
            			break;
            			case (int)5: {
...
HXLINE(  62)				return (int)13;
            			...
            			break;
            			case (int)9: {
HXLINE(  63)				return (int)14;
            			}
            			break;
            			case (int)10: {
HXLINE(  61)				return (int)16777234;
            			}
            			break;
            			case (int)11: {
HXLINE(  66)				return (int)17;
            			}
            			break;
            			case (int)12: {
HXLINE(  67)				return (int)18;
            			}
            			break;
            			case (int)13: {
HXLINE(  68)				return (int)19;
            			}
            			break;
            			case (int)14: {
HXLINE(  69)				return (int)20;
            			}
            			break;
            			case (int)17: {
HXLINE(  70)				return (int)4;
            			}
            			break;
            			case (int)18: {
HXLINE(  71)				return (int)5;
            			}
            			break;
            			case (int)34: {
