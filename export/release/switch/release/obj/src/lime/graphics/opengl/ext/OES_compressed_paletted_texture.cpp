...
HXLINE(  15)		this->PALETTE8_RGB5_A1_OES = (int)35737;
HXLINE(  14)		this->PALETTE8_RGBA4_OES = (int)35736;
HXLINE(  13)		this->PALETTE8_R5_G6_B5_OES = (int)35735;
HXLINE(  12)		this->PALETTE8_RGBA8_OES = (int)35734;
HXLINE(  11)		this->PALETTE8_RGB8_OES = (int)35733;
HXLINE(  10)		this->PALETTE4_RGB5_A1_OES = (int)35732;
HXLINE(   9)		this->PALETTE4_RGBA4_OES = (int)35731;
HXLINE(   8)		this->PALETTE4_R5_G6_B5_OES = (int)35730;
HXLINE(   7)		this->PALETTE4_RGBA8_OES = (int)35729;
HXLINE(   6)		this->PALETTE4_RGB8_OES = (int)35728;
            	}
