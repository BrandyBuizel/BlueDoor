...
class HXCPP_CLASS_ATTRIBUTES FlxUnicodeUtil_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< FlxUnicodeUtil_obj > __new() {
			hx::ObjectPtr< FlxUnicodeUtil_obj > __this = new FlxUnicodeUtil_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< FlxUnicodeUtil_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("FlxUnicodeUtil","\x8d","\x20","\x33","\xeb"); }
