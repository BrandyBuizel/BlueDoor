...
bool Pointer_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1b123bf8) {
		...
		if (inClassId<=(int)0x3f2b00af) {
			return inClassId==(int)0x350cec4c || inClassId==(int)0x3f2b00af;
		} else {
...
HXLINE(  37)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::GraphicCursorCross_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
...
HXLINE(  67)		if ((this->_itemsInSelectionArea->length > (int)0)) {
HXLINE(  69)			this->handleItemAddition(this->_itemsInSelectionArea);
            		}
            		else {
HXLINE(  71)			bool _hx_tmp1;
HXDLIN(  71)			if (!(this->_brain->keyPressed((int)17))) {
HXLINE(  71)				_hx_tmp1 = !(this->_selectionCancelled);
            			}
            			else {
