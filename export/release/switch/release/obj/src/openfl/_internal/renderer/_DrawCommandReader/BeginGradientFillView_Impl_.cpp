...
HXDLIN( 422)		::Array< ::Dynamic> this2 = this1->buffer->ii;
HXDLIN( 422)		return this2->__get((this1->iiPos + (int)1)).StaticCast< ::Array< int > >();
            	}
...
HXDLIN( 429)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 429)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
HXDLIN( 436)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 436)		return this2->__get((this1->oPos + (int)2));
            	}
...
HXDLIN( 443)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 443)		return this2->__get((this1->oPos + (int)3));
            	}
