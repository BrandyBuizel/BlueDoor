...
void RenderEvent_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("objectColorTransform","\xa8","\x9a","\x71","\x7d"));
	outFields->push(HX_HCSTRING("objectMatrix","\x60","\x42","\xd2","\x95"));
...
static hx::StorageInfo RenderEvent_obj_sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(RenderEvent_obj,allowSmoothing),HX_HCSTRING("allowSmoothing","\xab","\xb7","\x66","\x68")},
	{hx::fsObject /*::openfl::geom::ColorTransform*/ ,(int)offsetof(RenderEvent_obj,objectColorTransform),HX_HCSTRING("objectColorTransform","\xa8","\x9a","\x71","\x7d")},
	{hx::fsObject /*::openfl::geom::Matrix*/ ,(int)offsetof(RenderEvent_obj,objectMatrix),HX_HCSTRING("objectMatrix","\x60","\x42","\xd2","\x95")},
	{hx::fsObject /*::openfl::display::DisplayObjectRenderer*/ ,(int)offsetof(RenderEvent_obj,renderer),HX_HCSTRING("renderer","\x43","\xc5","\xdb","\xb2")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo RenderEvent_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &RenderEvent_obj::CLEAR_DOM,HX_HCSTRING("CLEAR_DOM","\x50","\x87","\x7e","\xd8")},
	{hx::fsString,(void *) &RenderEvent_obj::RENDER_CAIRO,HX_HCSTRING("RENDER_CAIRO","\x7f","\xeb","\x7b","\xe1")},
	{hx::fsString,(void *) &RenderEvent_obj::RENDER_CANVAS,HX_HCSTRING("RENDER_CANVAS","\xe1","\x31","\x43","\x6e")},
	{hx::fsString,(void *) &RenderEvent_obj::RENDER_DOM,HX_HCSTRING("RENDER_DOM","\xb9","\x9d","\x78","\xf8")},
	{hx::fsString,(void *) &RenderEvent_obj::RENDER_OPENGL,HX_HCSTRING("RENDER_OPENGL","\x78","\x41","\x95","\xd7")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String RenderEvent_obj_sMemberFields[] = {
	...
	HX_HCSTRING("objectColorTransform","\xa8","\x9a","\x71","\x7d"),
	HX_HCSTRING("objectMatrix","\x60","\x42","\xd2","\x95"),
...
static void RenderEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(RenderEvent_obj::__mClass,"__mClass");
...
static void RenderEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(RenderEvent_obj::__mClass,"__mClass");
...
static ::String RenderEvent_obj_sStaticFields[] = {
	HX_HCSTRING("CLEAR_DOM","\x50","\x87","\x7e","\xd8"),
	HX_HCSTRING("RENDER_CAIRO","\x7f","\xeb","\x7b","\xe1"),
	HX_HCSTRING("RENDER_CANVAS","\xe1","\x31","\x43","\x6e"),
	HX_HCSTRING("RENDER_DOM","\xb9","\x9d","\x78","\xf8"),
	HX_HCSTRING("RENDER_OPENGL","\x78","\x41","\x95","\xd7"),
	::String(null())
};

void RenderEvent_obj::__register()
{
	hx::Object *dummy = new RenderEvent_obj;
	RenderEvent_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("openfl.events.RenderEvent","\x0d","\x0a","\x8b","\xd1");
