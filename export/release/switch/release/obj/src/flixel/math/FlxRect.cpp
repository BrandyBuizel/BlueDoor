...
HXLINE( 220)			Float Rect1 = Rect->x;
HXDLIN( 220)			result2 = (Rect1 < (this->x + this->width));
            		}
            		else {
...
HXLINE( 220)			Float Rect2 = Rect->y;
HXDLIN( 220)			result = (Rect2 < (this->y + this->height));
            		}
            		else {
...
HXLINE( 249)		Float maxX = (this->x + this->width);
HXDLIN( 249)		Float maxX1 = ::Math_obj::max(maxX,(Rect->x + Rect->width));
HXLINE( 250)		Float maxY = (this->y + this->height);
HXDLIN( 250)		Float maxY1 = ::Math_obj::max(maxY,(Rect->y + Rect->height));
...
HXDLIN( 253)		this->width = (maxX1 - minX);
HXDLIN( 253)		this->height = (maxY1 - minY);
...
HXLINE( 261)		this->x = ::Math_obj::floor(this->x);
HXLINE( 262)		this->y = ::Math_obj::floor(this->y);
HXLINE( 263)		this->width = ::Math_obj::floor(this->width);
HXLINE( 264)		this->height = ::Math_obj::floor(this->height);
...
HXLINE( 273)		this->x = ::Math_obj::ceil(this->x);
HXLINE( 274)		this->y = ::Math_obj::ceil(this->y);
HXLINE( 275)		this->width = ::Math_obj::ceil(this->width);
HXLINE( 276)		this->height = ::Math_obj::ceil(this->height);
...
HXLINE( 285)		this->x = ::Math_obj::round(this->x);
HXLINE( 286)		this->y = ::Math_obj::round(this->y);
HXLINE( 287)		this->width = ::Math_obj::round(this->width);
HXLINE( 288)		this->height = ::Math_obj::round(this->height);
...
HXLINE( 368)		Float x1;
HXDLIN( 368)		Float x11 = (this->x + this->width);
HXDLIN( 368)		if ((x11 > (rect->x + rect->width))) {
...
HXLINE( 376)		Float y1;
HXDLIN( 376)		Float y11 = (this->y + this->height);
HXDLIN( 376)		if ((y11 > (rect->y + rect->height))) {
...
HXDLIN( 393)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 394)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXDLIN( 395)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
...
HXLINE( 392)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_this3));
            	}
...
HXDLIN( 446)		if ((this->width != (int)0)) {
HXDLIN( 446)			return (this->height == (int)0);
            		}
            		else {
