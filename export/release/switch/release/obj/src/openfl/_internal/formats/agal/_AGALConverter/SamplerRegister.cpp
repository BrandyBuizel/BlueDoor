...
HXLINE( 889)		{
HXLINE( 889)			int _g = this->f;
HXDLIN( 889)			switch((int)(_g)){
            				case (int)0: {
HXLINE( 892)					filter = (int)5;
            				}
            				break;
            				case (int)1: {
HXLINE( 894)					filter = (int)4;
            				}
            				break;
            				default:{
...
HXLINE( 900)		{
HXLINE( 900)			int _g1 = this->m;
HXDLIN( 900)			switch((int)(_g1)){
            				case (int)0: {
HXLINE( 904)					mipfilter = (int)2;
            				}
            				break;
            				case (int)1: {
HXLINE( 907)					mipfilter = (int)1;
            				}
            				break;
            				case (int)2: {
HXLINE( 910)					mipfilter = (int)0;
            				}
            				break;
            				default:{
...
HXLINE( 918)		{
HXLINE( 918)			int _g2 = this->w;
HXDLIN( 918)			switch((int)(_g2)){
            				case (int)0: {
HXLINE( 921)					wrap = (int)0;
            				}
            				break;
            				case (int)1: {
HXLINE( 923)					wrap = (int)2;
            				}
            				break;
            				default:{
...
HXLINE( 928)		bool ignoreSampler = (((int)this->s & (int)(int)4) == (int)4);
HXLINE( 929)		bool centroid = (((int)this->s & (int)(int)1) == (int)1);
HXLINE( 930)		bool textureAlpha = (this->t == (int)2);
HXLINE( 933)		Float lodBias = ((Float)((int)((int)this->b << (int)(int)24) >> (int)(int)24) / (Float)((Float)8.0));
...
HXLINE( 862)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)60);
HXDLIN( 862)		sr->f = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)15))));
HXLINE( 863)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)56);
HXDLIN( 863)		sr->m = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)15))));
HXLINE( 864)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)52);
HXDLIN( 864)		sr->w = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 865)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)48);
HXDLIN( 865)		sr->s = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 866)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)44);
HXDLIN( 866)		sr->d = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)15))));
HXLINE( 867)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)40);
HXDLIN( 867)		sr->t = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)15))));
HXLINE( 868)		 cpp::Int64Struct a6 = _hx_int64_shr(v,(int)32);
HXDLIN( 868)		sr->type = _hx_int64_low(_hx_int64_and(a6,( ::cpp::Int64Struct((int)15))));
HXLINE( 869)		 cpp::Int64Struct a7 = _hx_int64_shr(v,(int)16);
HXDLIN( 869)		sr->b = _hx_int64_low(_hx_int64_and(a7,( ::cpp::Int64Struct((int)255))));
HXLINE( 870)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
