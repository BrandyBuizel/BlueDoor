...
HXLINE(  38)		this->COLOR_ATTACHMENT15_NV = (int)36079;
HXLINE(  37)		this->COLOR_ATTACHMENT14_NV = (int)36078;
HXLINE(  36)		this->COLOR_ATTACHMENT13_NV = (int)36077;
HXLINE(  35)		this->COLOR_ATTACHMENT12_NV = (int)36076;
HXLINE(  34)		this->COLOR_ATTACHMENT11_NV = (int)36075;
HXLINE(  33)		this->COLOR_ATTACHMENT10_NV = (int)36074;
HXLINE(  32)		this->COLOR_ATTACHMENT9_NV = (int)36073;
HXLINE(  31)		this->COLOR_ATTACHMENT8_NV = (int)36072;
HXLINE(  30)		this->COLOR_ATTACHMENT7_NV = (int)36071;
HXLINE(  29)		this->COLOR_ATTACHMENT6_NV = (int)36070;
HXLINE(  28)		this->COLOR_ATTACHMENT5_NV = (int)36069;
HXLINE(  27)		this->COLOR_ATTACHMENT4_NV = (int)36068;
HXLINE(  26)		this->COLOR_ATTACHMENT3_NV = (int)36067;
HXLINE(  25)		this->COLOR_ATTACHMENT2_NV = (int)36066;
HXLINE(  24)		this->COLOR_ATTACHMENT1_NV = (int)36065;
HXLINE(  23)		this->COLOR_ATTACHMENT0_NV = (int)36064;
HXLINE(  22)		this->DRAW_BUFFER15_NV = (int)34868;
HXLINE(  21)		this->DRAW_BUFFER14_NV = (int)34867;
HXLINE(  20)		this->DRAW_BUFFER13_NV = (int)34866;
HXLINE(  19)		this->DRAW_BUFFER12_NV = (int)34865;
HXLINE(  18)		this->DRAW_BUFFER11_NV = (int)34864;
HXLINE(  17)		this->DRAW_BUFFER10_NV = (int)34863;
HXLINE(  16)		this->DRAW_BUFFER9_NV = (int)34862;
HXLINE(  15)		this->DRAW_BUFFER8_NV = (int)34861;
HXLINE(  14)		this->DRAW_BUFFER7_NV = (int)34860;
HXLINE(  13)		this->DRAW_BUFFER6_NV = (int)34859;
HXLINE(  12)		this->DRAW_BUFFER5_NV = (int)34858;
HXLINE(  11)		this->DRAW_BUFFER4_NV = (int)34857;
HXLINE(  10)		this->DRAW_BUFFER3_NV = (int)34856;
HXLINE(   9)		this->DRAW_BUFFER2_NV = (int)34855;
HXLINE(   8)		this->DRAW_BUFFER1_NV = (int)34854;
HXLINE(   7)		this->DRAW_BUFFER0_NV = (int)34853;
HXLINE(   6)		this->MAX_DRAW_BUFFERS_NV = (int)34852;
            	}
