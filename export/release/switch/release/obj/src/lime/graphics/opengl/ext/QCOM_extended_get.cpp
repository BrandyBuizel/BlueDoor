...
HXLINE(  16)		this->STATE_RESTORE = (int)35804;
HXLINE(  15)		this->TEXTURE_OBJECT_VALID_QCOM = (int)35803;
HXLINE(  14)		this->TEXTURE_TARGET_QCOM = (int)35802;
HXLINE(  13)		this->TEXTURE_NUM_LEVELS_QCOM = (int)35801;
HXLINE(  12)		this->TEXTURE_IMAGE_VALID_QCOM = (int)35800;
HXLINE(  11)		this->TEXTURE_TYPE_QCOM = (int)35799;
HXLINE(  10)		this->TEXTURE_FORMAT_QCOM = (int)35798;
HXLINE(   9)		this->TEXTURE_INTERNAL_FORMAT_QCOM = (int)35797;
HXLINE(   8)		this->TEXTURE_DEPTH_QCOM = (int)35796;
HXLINE(   7)		this->TEXTURE_HEIGHT_QCOM = (int)35795;
HXLINE(   6)		this->TEXTURE_WIDTH_QCOM = (int)35794;
            	}
