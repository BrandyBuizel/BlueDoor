...
{
	outFields->push(HX_HCSTRING("uBias","\x8e","\xf5","\xd1","\x89"));
	outFields->push(HX_HCSTRING("uConvoMatrix","\x27","\x06","\x24","\x20"));
	outFields->push(HX_HCSTRING("uDivisor","\x69","\x15","\x42","\x62"));
	outFields->push(HX_HCSTRING("uPreserveAlpha","\x3d","\xd2","\x3a","\x39"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo ConvolutionShader_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(ConvolutionShader_obj,uBias),HX_HCSTRING("uBias","\x8e","\xf5","\xd1","\x89")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(ConvolutionShader_obj,uConvoMatrix),HX_HCSTRING("uConvoMatrix","\x27","\x06","\x24","\x20")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(ConvolutionShader_obj,uDivisor),HX_HCSTRING("uDivisor","\x69","\x15","\x42","\x62")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Bool*/ ,(int)offsetof(ConvolutionShader_obj,uPreserveAlpha),HX_HCSTRING("uPreserveAlpha","\x3d","\xd2","\x3a","\x39")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String ConvolutionShader_obj_sMemberFields[] = {
	HX_HCSTRING("uBias","\x8e","\xf5","\xd1","\x89"),
	HX_HCSTRING("uConvoMatrix","\x27","\x06","\x24","\x20"),
	HX_HCSTRING("uDivisor","\x69","\x15","\x42","\x62"),
	HX_HCSTRING("uPreserveAlpha","\x3d","\xd2","\x3a","\x39"),
	::String(null()) };

static void ConvolutionShader_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ConvolutionShader_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ConvolutionShader_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(ConvolutionShader_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new ConvolutionShader_obj;
	ConvolutionShader_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("openfl.filters._ConvolutionFilter.ConvolutionShader","\x51","\x6d","\x41","\xf8");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = ConvolutionShader_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ConvolutionShader_obj_sVisitStatics;
#endif
