...
bool Promise_lime_text_Font_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3a6ea007;
}
...
{
	hx::Object *dummy = new Promise_lime_text_Font_obj;
	Promise_lime_text_Font_obj::_hx_vtable = *(void **)dummy;
