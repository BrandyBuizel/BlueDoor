...
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_71_get_guid,"lime.ui.Gamepad","get_guid",0x2f6ca220,"lime.ui.Gamepad.get_guid","lime/ui/Gamepad.hx",71,0x36bc843e)
HX_LOCAL_STACK_FRAME(_hx_pos_b33f1f9ffbdc366b_82_get_npadid,"lime.ui.Gamepad","get_npadid",0x43a6b117,"lime.ui.Gamepad.get_npadid","lime/ui/Gamepad.hx",82,0x36bc843e)
...
::String Gamepad_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_71_get_guid)
HXDLIN(  71)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_guid(this->id)) );
            	}


HX_DEFINE_DYNAMIC_FUNC0(Gamepad_obj,get_guid,return )

int Gamepad_obj::get_npadid(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_82_get_npadid)
HXLINE(  83)		int n = (int)-1;
HXLINE(  85)		n = ::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_npadid(this->id);
HXLINE(  87)		return n;
            	}


HX_DEFINE_DYNAMIC_FUNC0(Gamepad_obj,get_npadid,return )

::String Gamepad_obj::get_name(){
            	HX_STACKFRAME(&_hx_pos_b33f1f9ffbdc366b_96_get_name)
HXDLIN(  96)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gamepad_get_device_name(this->id)) );
            	}
...
HXLINE(  58)		 ::lime::ui::Gamepad gamepad = ::lime::ui::Gamepad_obj::devices->get(id).StaticCast<  ::lime::ui::Gamepad >();
