...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::QCOM_alpha_test)(__this) )->ALPHA_TEST_REF_QCOM = (int)3010;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::QCOM_alpha_test)(__this) )->ALPHA_TEST_FUNC_QCOM = (int)3009;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::QCOM_alpha_test)(__this) )->ALPHA_TEST_QCOM = (int)3008;
            	}
