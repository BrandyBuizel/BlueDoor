...
HXDLIN( 201)				int _g = list1->length;
...
HXLINE( 382)		bool capture = (event->eventPhase == (int)1);
HXLINE( 384)		::Array< ::Dynamic> iterators = ( (::Array< ::Dynamic>)(this->_hx___iterators->get(type)) );
HXLINE( 385)		 ::openfl::events::_EventDispatcher::DispatchIterator iterator = iterators->__get((int)0).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >();
...
HXLINE( 413)		if (hx::IsNotEq( iterator,iterators->__get((int)0).StaticCast<  ::openfl::events::_EventDispatcher::DispatchIterator >() )) {
...
HXLINE( 436)		{
HXLINE( 436)			int _g1 = (int)0;
HXDLIN( 436)			int _g = numElements;
HXDLIN( 436)			while((_g1 < _g)){
HXLINE( 436)				_g1 = (_g1 + (int)1);
HXDLIN( 436)				int i = (_g1 - (int)1);
