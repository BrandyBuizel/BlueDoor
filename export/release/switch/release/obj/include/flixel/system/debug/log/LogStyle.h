...
class HXCPP_CLASS_ATTRIBUTES LogStyle_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< LogStyle_obj > __new(::String __o_Prefix,::String __o_Color,hx::Null< int >  __o_Size,hx::Null< bool >  __o_Bold,hx::Null< bool >  __o_Italic,hx::Null< bool >  __o_Underlined,::String ErrorSound,hx::Null< bool >  __o_OpenConsole, ::Dynamic CallbackFunction) {
		...
		static hx::ObjectPtr< LogStyle_obj > __alloc(hx::Ctx *_hx_ctx,::String __o_Prefix,::String __o_Color,hx::Null< int >  __o_Size,hx::Null< bool >  __o_Bold,hx::Null< bool >  __o_Italic,hx::Null< bool >  __o_Underlined,::String ErrorSound,hx::Null< bool >  __o_OpenConsole, ::Dynamic CallbackFunction) {
