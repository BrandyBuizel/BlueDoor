...
HXLINE(  29)		this->_hx___graphicsDataType = (int)5;
HXLINE(  30)		this->_hx___graphicsFillType = (int)3;
            	}
...
static hx::StorageInfo GraphicsEndFill_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(GraphicsEndFill_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{hx::fsInt,(int)offsetof(GraphicsEndFill_obj,_hx___graphicsFillType),HX_HCSTRING("__graphicsFillType","\xe8","\x75","\xeb","\x27")},
	{ hx::fsUnknown, 0, null()}
};
