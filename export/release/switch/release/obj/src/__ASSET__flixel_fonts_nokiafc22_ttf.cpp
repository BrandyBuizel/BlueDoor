...
HX_DEFINE_STACK_FRAME(_hx_pos_b3ea4ee380faf667_324_new,"__ASSET__flixel_fonts_nokiafc22_ttf","new",0x22f03f2a,"__ASSET__flixel_fonts_nokiafc22_ttf.new","lime/_internal/macros/AssetsMacro.hx",324,0xc651f030)
...
void __ASSET__flixel_fonts_nokiafc22_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_b3ea4ee380faf667_324_new)
HXLINE( 325)		super::__construct(null());
HXLINE( 327)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_fonts_nokiafc22_ttf_obj::resourceName));
            	}
...
HXDLIN(   1)		resourceName = HX_("LIME_font___ASSET__flixel_fonts_nokiafc22_ttf",32,8e,cf,38);
            	}
}
