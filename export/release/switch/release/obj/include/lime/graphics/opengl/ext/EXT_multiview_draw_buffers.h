...
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_multiview_draw_buffers)(__this) )->MAX_MULTIVIEW_BUFFERS_EXT = (int)37106;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_multiview_draw_buffers)(__this) )->READ_BUFFER_EXT = (int)3074;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_multiview_draw_buffers)(__this) )->DRAW_BUFFER_EXT = (int)3073;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_multiview_draw_buffers)(__this) )->MULTIVIEW_EXT = (int)37105;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_multiview_draw_buffers)(__this) )->COLOR_ATTACHMENT_EXT = (int)37104;
            	}
