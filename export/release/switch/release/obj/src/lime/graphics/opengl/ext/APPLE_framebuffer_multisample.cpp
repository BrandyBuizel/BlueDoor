...
HXLINE(  12)		this->READ_FRAMEBUFFER_BINDING_APPLE = (int)36010;
HXLINE(  11)		this->DRAW_FRAMEBUFFER_BINDING_APPLE = (int)36006;
HXLINE(  10)		this->DRAW_FRAMEBUFFER_APPLE = (int)36009;
HXLINE(   9)		this->READ_FRAMEBUFFER_APPLE = (int)36008;
HXLINE(   8)		this->MAX_SAMPLES_APPLE = (int)36183;
HXLINE(   7)		this->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_APPLE = (int)36182;
HXLINE(   6)		this->RENDERBUFFER_SAMPLES_APPLE = (int)36011;
            	}
