...
HXLINE( 100)		this->_hx___graphicsDataType = (int)4;
HXLINE( 101)		this->_hx___graphicsFillType = (int)2;
            	}
...
static hx::StorageInfo GraphicsBitmapFill_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsBitmapFill_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{hx::fsInt,(int)offsetof(GraphicsBitmapFill_obj,_hx___graphicsFillType),HX_HCSTRING("__graphicsFillType","\xe8","\x75","\xeb","\x27")},
	{ hx::fsUnknown, 0, null()}
};
