...
HXDLIN(  25)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACKFRAME(&_hx_pos_350a610213d94b8b_26_boot)
HXDLIN(  26)		DPAD_UP = (int)17;
            	}
{
...
HXDLIN(  35)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
