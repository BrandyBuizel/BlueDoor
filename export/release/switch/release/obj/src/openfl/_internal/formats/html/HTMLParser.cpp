...
HX_LOCAL_STACK_FRAME(_hx_pos_f7ce69a5a5ff89f9_257___getAttributeMatch,"openfl._internal.formats.html.HTMLParser","__getAttributeMatch",0xdadef73c,"openfl._internal.formats.html.HTMLParser.__getAttributeMatch","openfl/_internal/formats/html/HTMLParser.hx",257,0x6cb5a975)
...
HXLINE(  33)		value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)0).StaticCast<  ::EReg >()->replace(value,HX_("\"",22,00,00,00));
HXLINE(  34)		value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)1).StaticCast<  ::EReg >()->replace(value,HX_("'",27,00,00,00));
HXLINE(  35)		value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)2).StaticCast<  ::EReg >()->replace(value,HX_("&",26,00,00,00));
HXLINE(  36)		value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)5).StaticCast<  ::EReg >()->replace(value,HX_(" ",20,00,00,00));
HXLINE(  40)		::Array< ::String > segments = value.split(HX_("<",3c,00,00,00));
HXLINE(  42)		if ((segments->length == (int)1)) {
HXLINE(  44)			value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexHTMLTag->replace(value,HX_("",00,00,00,00));
HXLINE(  46)			if ((textFormatRanges->get_length() > (int)1)) {
HXLINE(  48)				textFormatRanges->splice((int)1,(textFormatRanges->get_length() - (int)1));
            			}
HXLINE(  51)			value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)3).StaticCast<  ::EReg >()->replace(value,HX_("<",3c,00,00,00));
HXLINE(  52)			value = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)4).StaticCast<  ::EReg >()->replace(value,HX_(">",3e,00,00,00));
HXLINE(  54)			 ::openfl::_internal::text::TextFormatRange range = textFormatRanges->get((int)0).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXLINE(  55)			range->format = textFormat;
HXLINE(  56)			range->start = (int)0;
HXLINE(  57)			range->end = value.length;
HXLINE(  59)			return value;
            		}
            		else {
HXLINE(  63)			textFormatRanges->splice((int)0,textFormatRanges->get_length());
HXLINE(  65)			value = HX_("",00,00,00,00);
HXLINE(  66)			::String segment;
HXLINE(  68)			{
HXLINE(  68)				int _g1 = (int)0;
HXDLIN(  68)				int _g = segments->length;
HXDLIN(  68)				while((_g1 < _g)){
HXLINE(  68)					_g1 = (_g1 + (int)1);
HXDLIN(  68)					int i = (_g1 - (int)1);
HXLINE(  70)					segment = segments->__get(i);
HXLINE(  71)					segment = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)3).StaticCast<  ::EReg >()->replace(segment,HX_("<",3c,00,00,00));
HXLINE(  72)					segment = ::openfl::_internal::formats::html::HTMLParser_obj::_hx___regexEntities->__get((int)4).StaticCast<  ::EReg >()->replace(segment,HX_(">",3e,00,00,00));
...
HXDLIN(  95)						if ((_hx_tmp != ( (::String)(tagStack->__get((tagStack->length - (int)1))->__Field(HX_("toLowerCase",56,4c,64,b8),hx::paccDynamic)()) ))) {
HXLINE(  97)							::lime::utils::Log_obj::info((HX_("Invalid HTML, unexpected closing tag ignored: ",c0,13,d6,64) + tagName3),hx::SourceInfo(HX_("HTMLParser.hx",54,b8,12,94),97,HX_("openfl._internal.formats.html.HTMLParser",8b,ff,72,57),HX_("parse",33,90,55,bd)));
HXLINE(  98)							continue;
            						}
HXLINE( 101)						tagStack->pop();
HXLINE( 102)						formatStack->pop().StaticCast<  ::openfl::text::TextFormat >();
HXLINE( 103)						format = formatStack->__get((formatStack->length - (int)1)).StaticCast<  ::openfl::text::TextFormat >()->clone();
HXLINE( 105)						bool _hx_tmp1;
HXDLIN( 105)						if ((tagName3.toLowerCase() == HX_("p",70,00,00,00))) {
HXLINE( 105)							_hx_tmp1 = (textFormatRanges->get_length() > (int)0);
            						}
            						else {
...
HXLINE( 109)							 ::openfl::_internal::text::TextFormatRange _hx_tmp2 = textFormatRanges->get((textFormatRanges->get_length() - (int)1)).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN( 109)							_hx_tmp2->end++;
            						}
HXLINE( 112)						if ((start < segment1.length)) {
HXLINE( 114)							sub = segment1.substr(start,null());
HXLINE( 115)							{
HXLINE( 115)								int value1 = value.length;
HXDLIN( 115)								textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value1,(value.length + sub.length)));
            							}
...
HXLINE( 122)						format = formatStack->__get((formatStack->length - (int)1)).StaticCast<  ::openfl::text::TextFormat >()->clone();
HXLINE( 124)						if ((tagEndIndex > (int)-1)) {
HXLINE( 126)							{
HXLINE( 126)								::String _g11 = tagName3.toLowerCase();
HXDLIN( 126)								::String _hx_switch_0 = _g11;
...
HXLINE( 160)										 ::Dynamic firstChar = sizeAttr.charCodeAt((int)0);
HXLINE( 162)										bool _hx_tmp3;
HXDLIN( 162)										if (hx::IsNotEq( firstChar,(int)43 )) {
HXLINE( 162)											_hx_tmp3 = hx::IsEq( firstChar,(int)45 );
            										}
            										else {
...
HXDLIN( 164)											if ((formatStack->length >= (int)2)) {
HXLINE( 164)												parentFormat = formatStack->__get((formatStack->length - (int)2)).StaticCast<  ::openfl::text::TextFormat >();
            											}
            											else {
...
HXDLIN( 135)									if ((textFormatRanges->get_length() > (int)0)) {
HXLINE( 135)										_hx_tmp4 = !(noLineBreak);
            									}
            									else {
...
HXLINE( 213)										{
HXLINE( 213)											int _g12 = (int)0;
HXDLIN( 213)											while((_g12 < values->length)){
HXLINE( 213)												::String stop = values->__get(_g12);
HXDLIN( 213)												_g12 = (_g12 + (int)1);
...
HXLINE( 228)								{
HXLINE( 228)									int value2 = value.length;
HXDLIN( 228)									textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value2,(value.length + sub.length)));
            								}
HXLINE( 229)								value = (value + sub);
HXLINE( 230)								noLineBreak = false;
            							}
            							else {
HXLINE( 232)								if ((textFormatRanges->get_length() > (int)0)) {
HXLINE( 234)									 ::openfl::_internal::text::TextFormatRange _hx_tmp5 = textFormatRanges->get((textFormatRanges->get_length() - (int)1)).StaticCast<  ::openfl::_internal::text::TextFormatRange >();
HXDLIN( 234)									_hx_tmp5->end++;
            								}
            							}
            						}
            						else {
HXLINE( 239)							{
HXLINE( 239)								int value3 = value.length;
HXDLIN( 239)								textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,format,value3,(value.length + segment1.length)));
            							}
HXLINE( 240)							value = (value + segment1);
HXLINE( 241)							noLineBreak = false;
            						}
            					}
            				}
            			}
HXLINE( 246)			if ((textFormatRanges->get_length() == (int)0)) {
HXLINE( 248)				textFormatRanges->push( ::openfl::_internal::text::TextFormatRange_obj::__alloc( HX_CTX ,formatStack->__get((int)0).StaticCast<  ::openfl::text::TextFormat >(),(int)0,(int)0));
            			}
            		}
...
::String HTMLParser_obj::_hx___getAttributeMatch( ::EReg regex){
            	HX_STACKFRAME(&_hx_pos_f7ce69a5a5ff89f9_257___getAttributeMatch)
HXDLIN( 257)		if (hx::IsNotNull( regex->matched((int)2) )) {
HXDLIN( 257)			return regex->matched((int)2);
            		}
            		else {
HXDLIN( 257)			return regex->matched((int)3);
            		}
