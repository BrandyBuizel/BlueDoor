...
HXLINE(  40)				_hx_tmp1 = (width >= (int)1);
            			}
            			else {
HXLINE(  40)				_hx_tmp1 = false;
            			}
HXDLIN(  40)			if (_hx_tmp1) {
HXLINE(  40)				_hx_tmp = (height >= (int)1);
            			}
            			else {
...
HXLINE(  48)					_hx_tmp4 = (transform->b == (int)0);
            				}
            				else {
HXLINE(  48)					_hx_tmp4 = false;
            				}
HXDLIN(  48)				if (_hx_tmp4) {
HXLINE(  48)					_hx_tmp3 = (transform->c == (int)0);
            				}
            				else {
...
HXLINE(  80)						renderTransform->a = ((Float)dWidth / (Float)sWidth);
HXLINE(  81)						renderTransform->d = ((Float)dHeight / (Float)sHeight);
...
HXLINE(  95)						cairo->rectangle((int)0,(int)0,sWidth,sHeight);
HXLINE(  96)						cairo->clip();
HXLINE(  98)						if ((alpha == (int)1)) {
...
HXLINE(  70)					int renderCenterWidth = ((::Math_obj::round((width * renderScaleX)) - renderLeft) - renderRight1);
HXLINE(  71)					int renderCenterHeight = ((::Math_obj::round((height * renderScaleY)) - renderTop) - renderBottom1);
...
HXLINE(  75)					::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,(int)3);
...
HXDLIN( 110)					if ((centerWidth != (int)0)) {
HXLINE( 110)						_hx_tmp5 = (centerHeight != (int)0);
            					}
            					else {
HXLINE( 110)						_hx_tmp5 = false;
            					}
HXDLIN( 110)					if (_hx_tmp5) {
HXLINE( 112)						drawImage((int)0,(int)0,left,top,(int)0,(int)0,renderLeft,renderTop);
HXLINE( 113)						drawImage(left,(int)0,centerWidth,top,renderLeft,(int)0,renderCenterWidth,renderTop);
HXLINE( 114)						drawImage((left + centerWidth),(int)0,right1,top,(renderLeft + renderCenterWidth),(int)0,renderRight1,renderTop);
HXLINE( 116)						drawImage((int)0,top,left,centerHeight,(int)0,renderTop,renderLeft,renderCenterHeight);
...
HXLINE( 120)						drawImage((int)0,(top + centerHeight),left,bottom1,(int)0,(renderTop + renderCenterHeight),renderLeft,renderBottom1);
...
HXDLIN( 125)						if ((centerWidth == (int)0)) {
HXLINE( 125)							_hx_tmp6 = (centerHeight != (int)0);
            						}
            						else {
...
HXLINE( 129)							drawImage((int)0,(int)0,width,top,(int)0,(int)0,renderWidth,renderTop);
HXLINE( 130)							drawImage((int)0,top,width,centerHeight,(int)0,renderTop,renderWidth,renderCenterHeight);
HXLINE( 131)							drawImage((int)0,(top + centerHeight),width,bottom1,(int)0,(renderTop + renderCenterHeight),renderWidth,renderBottom1);
            						}
            						else {
HXLINE( 133)							bool _hx_tmp7;
HXDLIN( 133)							if ((centerHeight == (int)0)) {
HXLINE( 133)								_hx_tmp7 = (centerWidth != (int)0);
            							}
            							else {
...
HXLINE( 137)								drawImage((int)0,(int)0,left,height,(int)0,(int)0,renderLeft,renderHeight);
HXLINE( 138)								drawImage(left,(int)0,centerWidth,height,renderLeft,(int)0,renderCenterWidth,renderHeight);
HXLINE( 139)								drawImage((left + centerWidth),(int)0,right1,height,(renderLeft + renderCenterWidth),(int)0,renderRight1,renderHeight);
            							}
            						}
            					}
...
HXDLIN( 148)					cairo->setSourceSurface(_hx_tmp8,(int)0,(int)0);
HXLINE( 150)					if ((alpha >= (int)1)) {
...
static hx::StaticInfo CairoShape_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*::lime::math::Matrix3*/ ,(void *) &CairoShape_obj::sourceTransform,HX_HCSTRING("sourceTransform","\x11","\xe9","\x32","\x19")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String CairoShape_obj_sStaticFields[] = {
	HX_HCSTRING("sourceTransform","\x11","\xe9","\x32","\x19"),
