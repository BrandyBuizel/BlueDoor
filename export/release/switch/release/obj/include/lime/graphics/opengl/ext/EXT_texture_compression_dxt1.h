...
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_dxt1)(__this) )->COMPRESSED_RGBA_S3TC_DXT1_EXT = (int)33777;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_dxt1)(__this) )->COMPRESSED_RGB_S3TC_DXT1_EXT = (int)33776;
            	}
