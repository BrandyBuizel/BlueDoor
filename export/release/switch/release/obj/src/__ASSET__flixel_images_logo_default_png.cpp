...
HX_DEFINE_STACK_FRAME(_hx_pos_17702da0942c0225_363_new,"__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","lime/_internal/macros/AssetsMacro.hx",363,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_d329051c686ea84b_1_boot,"__ASSET__flixel_images_logo_default_png","boot",0x6c1f3055,"__ASSET__flixel_images_logo_default_png.boot","?",1,0x0000003f)
...
void __ASSET__flixel_images_logo_default_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_17702da0942c0225_363_new)
HXLINE( 392)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 394)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_images_logo_default_png_obj::resourceName),null());
            	}
...
bool __ASSET__flixel_images_logo_default_png_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2bf5b37f) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x2bf5b37f;
	} else {
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_logo_default_png",5d,c4,77,3f);
            	}
}
