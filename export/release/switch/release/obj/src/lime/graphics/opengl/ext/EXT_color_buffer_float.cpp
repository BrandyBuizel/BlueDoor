...
bool EXT_color_buffer_float_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x5b0bc7e9;
}
...
static void EXT_color_buffer_float_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(EXT_color_buffer_float_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void EXT_color_buffer_float_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new EXT_color_buffer_float_obj;
	EXT_color_buffer_float_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = EXT_color_buffer_float_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(0 /* sMemberFields */);
	__mClass->mCanCast = hx::TCanCast< EXT_color_buffer_float_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = EXT_color_buffer_float_obj_sVisitStatics;
#endif
