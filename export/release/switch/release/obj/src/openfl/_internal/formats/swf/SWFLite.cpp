...
HX_LOCAL_STACK_FRAME(_hx_pos_6f11ba33c9e9e3a5_154___init,"openfl._internal.formats.swf.SWFLite","__init",0x0348bb1c,"openfl._internal.formats.swf.SWFLite.__init","openfl/_internal/formats/swf/SWFLite.hx",154,0x106a09c0)
...
HXLINE(  51)			 ::openfl::_internal::symbols::SWFSymbol symbol = this->symbolsByClassName->get(className).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >();
...
HXLINE(  66)		 ::openfl::_internal::symbols::SWFSymbol symbol = this->symbolsByClassName->get(className).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >();
...
void SWFLite_obj::_hx___init(){
            	HX_GC_STACKFRAME(&_hx_pos_6f11ba33c9e9e3a5_154___init)
HXLINE( 155)		if (hx::IsNull( this->symbols )) {
HXLINE( 155)			return;
            		}
HXLINE( 156)		if (hx::IsNull( this->symbolsByClassName )) {
HXLINE( 156)			this->symbolsByClassName =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            		}
HXLINE( 158)		{
HXLINE( 158)			 ::Dynamic symbol = this->symbols->iterator();
HXDLIN( 158)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 158)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 160)				bool _hx_tmp;
HXDLIN( 160)				if (hx::IsNotNull( symbol1 )) {
HXLINE( 160)					_hx_tmp = hx::IsNull( symbol1->className );
            				}
            				else {
...
HXLINE( 161)				this->symbolsByClassName->set(symbol1->className,symbol1);
            			}
            		}
            	}
...
void SWFLite_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("symbolsByClassName","\x71","\x53","\xec","\xf9"));
...
static hx::StorageInfo SWFLite_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_internal::formats::swf::SWFLiteLibrary*/ ,(int)offsetof(SWFLite_obj,library),HX_HCSTRING("library","\xfb","\x26","\x70","\x3f")},
	...
	{hx::fsObject /*::haxe::ds::StringMap*/ ,(int)offsetof(SWFLite_obj,symbolsByClassName),HX_HCSTRING("symbolsByClassName","\x71","\x53","\xec","\xf9")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String SWFLite_obj_sMemberFields[] = {
	...
	HX_HCSTRING("symbolsByClassName","\x71","\x53","\xec","\xf9"),
...
void SWFLite_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("openfl._internal.formats.swf.SWFLite","\x02","\xde","\xe2","\xbb");
