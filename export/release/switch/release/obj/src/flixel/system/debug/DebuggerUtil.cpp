...
HXLINE(  33)		( ( ::openfl::text::TextField)(tf) )->set_defaultTextFormat( ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEBUGGER,Size,((int)Color & (int)(int)16777215),null(),null(),null(),null(),null(),null(),null(),null(),null(),null()));
HXLINE(  34)		( ( ::openfl::display::DisplayObject)(tf) )->set_alpha(((Float)((int)((int)Color >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
HXLINE(  35)		( ( ::openfl::text::TextField)(tf) )->set_autoSize((int)1);
HXLINE(  36)		return tf;
            	}
