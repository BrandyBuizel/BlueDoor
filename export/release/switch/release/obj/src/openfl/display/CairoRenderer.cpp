...
HXLINE(  79)			this->_hx___matrix3->tx = ::Math_obj::round(this->_hx___matrix->tx);
HXLINE(  80)			this->_hx___matrix3->ty = ::Math_obj::round(this->_hx___matrix->ty);
            		}
            		else {
...
HXLINE( 102)			 ::lime::graphics::cairo::Cairo _hx_tmp1 = this->cairo;
HXDLIN( 102)			Float _hx_tmp2 = this->_hx___stage->_hx___colorSplit->__get((int)0);
HXDLIN( 102)			Float _hx_tmp3 = this->_hx___stage->_hx___colorSplit->__get((int)1);
HXDLIN( 102)			_hx_tmp1->setSourceRGB(_hx_tmp2,_hx_tmp3,this->_hx___stage->_hx___colorSplit->__get((int)2));
