...
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_552_match,"openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",552,0xe2270714)
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_552_match)
HXDLIN( 552)		if (::Reflect_obj::compareMethods(this->callback,callback)) {
HXDLIN( 552)			return (this->useCapture == useCapture);
            		}
            		else {
