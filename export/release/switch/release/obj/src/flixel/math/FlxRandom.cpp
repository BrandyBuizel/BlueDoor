...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_483_updateStateSeed,"flixel.math.FlxRandom","updateStateSeed",0xf8abb60c,"flixel.math.FlxRandom.updateStateSeed","flixel/math/FlxRandom.hx",483,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_495_updateRecordingSeed,"flixel.math.FlxRandom","updateRecordingSeed",0xd463b3ec,"flixel.math.FlxRandom.updateRecordingSeed","flixel/math/FlxRandom.hx",495,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_504_getRecordingSeed,"flixel.math.FlxRandom","getRecordingSeed",0xe07c99f9,"flixel.math.FlxRandom.getRecordingSeed","flixel/math/FlxRandom.hx",504,0x4fa37e1d)
...
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_467_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",467,0x4fa37e1d)
HX_LOCAL_STACK_FRAME(_hx_pos_eba801adaf62ef5c_472_boot,"flixel.math.FlxRandom","boot",0x1eb7001f,"flixel.math.FlxRandom.boot","flixel/math/FlxRandom.hx",472,0x4fa37e1d)
namespace flixel{
namespace math{
...
int FlxRandom_obj::_stateSeed;

int FlxRandom_obj::_recordingSeed;

int FlxRandom_obj::updateStateSeed(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_483_updateStateSeed)
HXDLIN( 483)		return (::flixel::math::FlxRandom_obj::_stateSeed = ::Std_obj::_hx_int(::flixel::FlxG_obj::random->internalSeed));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxRandom_obj,updateStateSeed,return )

int FlxRandom_obj::updateRecordingSeed(hx::Null< bool >  __o_StandardMode){
bool StandardMode = __o_StandardMode.Default(true);
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_495_updateRecordingSeed)
HXDLIN( 495)		 ::flixel::math::FlxRandom _this = ::flixel::FlxG_obj::random;
HXDLIN( 495)		int NewSeed;
HXDLIN( 495)		if (StandardMode) {
HXDLIN( 495)			NewSeed = ::flixel::FlxG_obj::random->initialSeed;
            		}
            		else {
HXDLIN( 495)			NewSeed = ::flixel::math::FlxRandom_obj::_stateSeed;
            		}
HXDLIN( 495)		Float lowerBound;
HXDLIN( 495)		if ((NewSeed < (int)1)) {
HXDLIN( 495)			lowerBound = (int)1;
            		}
            		else {
HXDLIN( 495)			lowerBound = NewSeed;
            		}
HXDLIN( 495)		 ::Dynamic NewSeed1;
HXDLIN( 495)		if ((lowerBound > (int)2147483646)) {
HXDLIN( 495)			NewSeed1 = (int)2147483646;
            		}
            		else {
HXDLIN( 495)			NewSeed1 = lowerBound;
            		}
HXDLIN( 495)		int NewSeed2 = ::Std_obj::_hx_int(NewSeed1);
HXDLIN( 495)		Float lowerBound1;
HXDLIN( 495)		if ((NewSeed2 < (int)1)) {
HXDLIN( 495)			lowerBound1 = (int)1;
            		}
            		else {
HXDLIN( 495)			lowerBound1 = NewSeed2;
            		}
HXDLIN( 495)		 ::Dynamic _hx_tmp;
HXDLIN( 495)		if ((lowerBound1 > (int)2147483646)) {
HXDLIN( 495)			_hx_tmp = (int)2147483646;
            		}
            		else {
HXDLIN( 495)			_hx_tmp = lowerBound1;
            		}
HXDLIN( 495)		return (::flixel::math::FlxRandom_obj::_recordingSeed = (_this->initialSeed = ::Std_obj::_hx_int((_this->internalSeed = ::Std_obj::_hx_int(_hx_tmp)))));
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC1(FlxRandom_obj,updateRecordingSeed,return )

int FlxRandom_obj::getRecordingSeed(){
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_504_getRecordingSeed)
HXDLIN( 504)		return ::flixel::math::FlxRandom_obj::_recordingSeed;
            	}


STATIC_HX_DEFINE_DYNAMIC_FUNC0(FlxRandom_obj,getRecordingSeed,return )
...
bool FlxRandom_obj::__GetStatic(const ::String &inName, Dynamic &outValue, hx::PropertyAccess inCallProp)
{
	...
	case 10:
		...
		if (HX_FIELD_EQ(inName,"_stateSeed") ) { outValue = ( _stateSeed ); return true; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_recordingSeed") ) { outValue = ( _recordingSeed ); return true; }
		break;
	case 15:
		if (HX_FIELD_EQ(inName,"updateStateSeed") ) { outValue = updateStateSeed_dyn(); return true; }
		break;
	case 16:
		if (HX_FIELD_EQ(inName,"getRecordingSeed") ) { outValue = getRecordingSeed_dyn(); return true; }
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"_arrayFloatHelper") ) { outValue = ( _arrayFloatHelper ); return true; }
		break;
	case 19:
		if (HX_FIELD_EQ(inName,"updateRecordingSeed") ) { outValue = updateRecordingSeed_dyn(); return true; }
	}
	return false;
}
...
bool FlxRandom_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 10:
		if (HX_FIELD_EQ(inName,"_stateSeed") ) { _stateSeed=ioValue.Cast< int >(); return true; }
		break;
	case 14:
		if (HX_FIELD_EQ(inName,"_recordingSeed") ) { _recordingSeed=ioValue.Cast< int >(); return true; }
		break;
	case 17:
...
static hx::StaticInfo FlxRandom_obj_sStaticStorageInfo[] = {
	...
	{hx::fsInt,(void *) &FlxRandom_obj::_stateSeed,HX_HCSTRING("_stateSeed","\xe3","\x7f","\x9a","\x8a")},
	{hx::fsInt,(void *) &FlxRandom_obj::_recordingSeed,HX_HCSTRING("_recordingSeed","\x43","\xb5","\x11","\x4b")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static void FlxRandom_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxRandom_obj::_stateSeed,"_stateSeed");
	HX_MARK_MEMBER_NAME(FlxRandom_obj::_recordingSeed,"_recordingSeed");
};
...
static void FlxRandom_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxRandom_obj::_stateSeed,"_stateSeed");
	HX_VISIT_MEMBER_NAME(FlxRandom_obj::_recordingSeed,"_recordingSeed");
};
...
static ::String FlxRandom_obj_sStaticFields[] = {
	...
	HX_HCSTRING("_stateSeed","\xe3","\x7f","\x9a","\x8a"),
	HX_HCSTRING("_recordingSeed","\x43","\xb5","\x11","\x4b"),
	HX_HCSTRING("updateStateSeed","\xd9","\xd4","\x82","\x7e"),
	HX_HCSTRING("updateRecordingSeed","\x39","\xbd","\x46","\xa0"),
	HX_HCSTRING("getRecordingSeed","\x8c","\x6e","\xe0","\x76"),
	::String(null())
};
...
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_467_boot)
HXDLIN( 467)		_stateSeed = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_eba801adaf62ef5c_472_boot)
HXDLIN( 472)		_recordingSeed = (int)1;
            	}
}
