...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_read_format_bgra)(__this) )->UNSIGNED_SHORT_1_5_5_5_REV_EXT = (int)33638;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_read_format_bgra)(__this) )->UNSIGNED_SHORT_4_4_4_4_REV_EXT = (int)33637;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_read_format_bgra)(__this) )->BGRA_EXT = (int)32993;
            	}
