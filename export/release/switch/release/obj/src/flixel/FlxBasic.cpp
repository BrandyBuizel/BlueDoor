...
HXDLIN( 135)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 136)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXDLIN( 137)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
...
HXLINE( 134)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_this3));
            	}
...
HXDLIN( 169)			_hx_tmp = (this->_cameras->length == (int)0);
            		}
            		else {
HXDLIN( 169)			_hx_tmp = true;
            		}
HXDLIN( 169)		if (_hx_tmp) {
HXDLIN( 169)			return ::flixel::FlxCamera_obj::defaultCameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
            		else {
HXDLIN( 169)			return this->_cameras->__get((int)0).StaticCast<  ::flixel::FlxCamera >();
            		}
...
HXLINE( 178)			this->_cameras[(int)0] = Value;
            		}
