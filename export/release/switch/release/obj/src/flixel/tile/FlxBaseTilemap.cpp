...
HX_LOCAL_STACK_FRAME(_hx_pos_36d94048d9e4941f_212_loadMapFromCSV,"flixel.tile.FlxBaseTilemap","loadMapFromCSV",0xbac5ecbb,"flixel.tile.FlxBaseTilemap.loadMapFromCSV","flixel/tile/FlxBaseTilemap.hx",212,0x0139d8e5)
...
HXLINE( 105)		this->_collideIndex = (int)0;
HXLINE( 104)		this->_drawIndex = (int)0;
HXLINE(  97)		this->_startingIndex = (int)0;
...
HXLINE( 168)		this->flixelType = (int)3;
...
HXLINE( 176)		this->super::destroy();
 ...
 ::flixel::tile::FlxBaseTilemap FlxBaseTilemap_obj::loadMapFromCSV(::String MapData, ::Dynamic TileGraphic,hx::Null< int >  __o_TileWidth,hx::Null< int >  __o_TileHeight, ::flixel::tile::FlxTilemapAutoTiling AutoTile,hx::Null< int >  __o_StartingIndex,hx::Null< int >  __o_DrawIndex,hx::Null< int >  __o_CollideIndex){
            		...
            		bool _hx_run(::String line){
            			HX_GC_STACKFRAME(&_hx_pos_36d94048d9e4941f_212_loadMapFromCSV)
HXLINE( 212)			return (line != HX_("",00,00,00,00));
            		}
...
HXLINE( 212)		::Array< ::String > rows = lines->filter( ::Dynamic(new _hx_Closure_0()));
HXLINE( 214)		this->heightInTiles = rows->length;
HXLINE( 215)		this->widthInTiles = (int)0;
HXLINE( 217)		int row = (int)0;
...
HXLINE( 222)				rowString = rowString.substr((int)0,(rowString.length - (int)1));
            			}
HXLINE( 223)			columns = rowString.split(HX_(",",2c,00,00,00));
HXLINE( 225)			if ((columns->length == (int)0)) {
HXLINE( 227)				this->heightInTiles--;
HXLINE( 228)				continue;
            			}
HXLINE( 230)			if ((this->widthInTiles == (int)0)) {
HXLINE( 232)				this->widthInTiles = columns->length;
            			}
HXLINE( 235)			int column = (int)0;
...
HXLINE( 351)		{
HXLINE( 351)			int _g1 = (int)0;
HXDLIN( 351)			int _g = this->_data->length;
HXDLIN( 351)			while((_g1 < _g)){
HXLINE( 351)				_g1 = (_g1 + (int)1);
HXDLIN( 351)				int i = (_g1 - (int)1);
HXLINE( 353)				if ((this->_data->__get(i) < (int)0)) {
HXLINE( 354)					this->_data[i] = (int)0;
            				}
            			}
            		}
...
HXDLIN( 359)		if ((StartingIndex <= (int)0)) {
HXLINE( 359)			_hx_tmp1 = (int)0;
            		}
            		else {
...
HXLINE( 363)			this->_startingIndex = (int)1;
HXLINE( 364)			DrawIndex = (int)1;
HXLINE( 365)			CollideIndex = (int)1;
            		}
...
HXLINE( 393)				i = (i + (int)1);
HXDLIN( 393)				this->autoTile((i - (int)1));
            			}
            		}
            	}
...
HXLINE( 456)		if ((this->_data->__get(Index) == (int)0)) {
HXLINE( 458)			return;
            		}
...
HXLINE( 467)		this->_data[Index] = (int)0;
HXLINE( 470)		bool _hx_tmp;
HXDLIN( 470)		if (((Index - this->widthInTiles) >= (int)0)) {
HXLINE( 470)			::Array< int > _hx_tmp1 = this->_data;
HXDLIN( 470)			_hx_tmp = (_hx_tmp1->__get((Index - this->widthInTiles)) > (int)0);
            		}
            		else {
HXLINE( 470)			_hx_tmp = true;
            		}
HXDLIN( 470)		if (_hx_tmp) {
HXLINE( 472)			::Array< int > _hx_tmp2 = this->_data;
HXDLIN( 472)			int Index1 = Index;
HXDLIN( 472)			_hx_tmp2[Index1] = (_hx_tmp2->__get(Index1) + (int)1);
            		}
HXLINE( 475)		bool _hx_tmp3;
HXDLIN( 475)		int _hx_tmp4 = hx::Mod(Index,this->widthInTiles);
HXDLIN( 475)		if ((_hx_tmp4 < (this->widthInTiles - (int)1))) {
HXLINE( 475)			::Array< int > _hx_tmp5 = this->_data;
HXDLIN( 475)			_hx_tmp3 = (_hx_tmp5->__get((Index + (int)1)) > (int)0);
            		}
            		else {
HXLINE( 475)			_hx_tmp3 = true;
            		}
HXDLIN( 475)		if (_hx_tmp3) {
HXLINE( 477)			::Array< int > _hx_tmp6 = this->_data;
HXDLIN( 477)			int Index2 = Index;
HXDLIN( 477)			_hx_tmp6[Index2] = (_hx_tmp6->__get(Index2) + (int)2);
            		}
HXLINE( 480)		bool _hx_tmp7;
HXDLIN( 480)		int _hx_tmp8 = ::Std_obj::_hx_int((Index + this->widthInTiles));
HXDLIN( 480)		if ((_hx_tmp8 < this->totalTiles)) {
HXLINE( 480)			::Array< int > _hx_tmp9 = this->_data;
HXDLIN( 480)			_hx_tmp7 = (_hx_tmp9->__get((Index + this->widthInTiles)) > (int)0);
            		}
            		else {
HXLINE( 480)			_hx_tmp7 = true;
            		}
HXDLIN( 480)		if (_hx_tmp7) {
HXLINE( 482)			::Array< int > _hx_tmp10 = this->_data;
HXDLIN( 482)			int Index3 = Index;
HXDLIN( 482)			_hx_tmp10[Index3] = (_hx_tmp10->__get(Index3) + (int)4);
            		}
HXLINE( 485)		bool _hx_tmp11;
HXDLIN( 485)		if ((hx::Mod(Index,this->widthInTiles) > (int)0)) {
HXLINE( 485)			::Array< int > _hx_tmp12 = this->_data;
HXDLIN( 485)			_hx_tmp11 = (_hx_tmp12->__get((Index - (int)1)) > (int)0);
            		}
            		else {
HXLINE( 485)			_hx_tmp11 = true;
            		}
HXDLIN( 485)		if (_hx_tmp11) {
HXLINE( 487)			::Array< int > _hx_tmp13 = this->_data;
HXDLIN( 487)			int Index4 = Index;
HXDLIN( 487)			_hx_tmp13[Index4] = (_hx_tmp13->__get(Index4) + (int)8);
            		}
HXLINE( 491)		bool _hx_tmp14;
HXDLIN( 491)		if (hx::IsEq( this->_hx_auto,::flixel::tile::FlxTilemapAutoTiling_obj::ALT_dyn() )) {
HXLINE( 491)			_hx_tmp14 = (this->_data->__get(Index) == (int)15);
            		}
            		else {
HXLINE( 491)			_hx_tmp14 = false;
            		}
HXDLIN( 491)		if (_hx_tmp14) {
HXLINE( 494)			bool _hx_tmp15;
HXDLIN( 494)			bool _hx_tmp16;
HXDLIN( 494)			if ((hx::Mod(Index,this->widthInTiles) > (int)0)) {
HXLINE( 494)				int _hx_tmp17 = ::Std_obj::_hx_int((Index + this->widthInTiles));
HXDLIN( 494)				_hx_tmp16 = (_hx_tmp17 < this->totalTiles);
            			}
            			else {
HXLINE( 494)				_hx_tmp16 = false;
            			}
HXDLIN( 494)			if (_hx_tmp16) {
HXLINE( 494)				::Array< int > _hx_tmp18 = this->_data;
HXDLIN( 494)				_hx_tmp15 = (_hx_tmp18->__get(((Index + this->widthInTiles) - (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 494)				_hx_tmp15 = false;
            			}
HXDLIN( 494)			if (_hx_tmp15) {
HXLINE( 496)				this->_data[Index] = (int)1;
            			}
HXLINE( 499)			bool _hx_tmp19;
HXDLIN( 499)			bool _hx_tmp20;
HXDLIN( 499)			if ((hx::Mod(Index,this->widthInTiles) > (int)0)) {
HXLINE( 499)				_hx_tmp20 = ((Index - this->widthInTiles) >= (int)0);
            			}
            			else {
HXLINE( 499)				_hx_tmp20 = false;
            			}
HXDLIN( 499)			if (_hx_tmp20) {
HXLINE( 499)				::Array< int > _hx_tmp21 = this->_data;
HXDLIN( 499)				_hx_tmp19 = (_hx_tmp21->__get(((Index - this->widthInTiles) - (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 499)				_hx_tmp19 = false;
            			}
HXDLIN( 499)			if (_hx_tmp19) {
HXLINE( 501)				this->_data[Index] = (int)2;
            			}
HXLINE( 504)			bool _hx_tmp22;
HXDLIN( 504)			bool _hx_tmp23;
HXDLIN( 504)			int _hx_tmp24 = hx::Mod(Index,this->widthInTiles);
HXDLIN( 504)			if ((_hx_tmp24 < (this->widthInTiles - (int)1))) {
HXLINE( 504)				_hx_tmp23 = ((Index - this->widthInTiles) >= (int)0);
            			}
            			else {
HXLINE( 504)				_hx_tmp23 = false;
            			}
HXDLIN( 504)			if (_hx_tmp23) {
HXLINE( 504)				::Array< int > _hx_tmp25 = this->_data;
HXDLIN( 504)				_hx_tmp22 = (_hx_tmp25->__get(((Index - this->widthInTiles) + (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 504)				_hx_tmp22 = false;
            			}
HXDLIN( 504)			if (_hx_tmp22) {
HXLINE( 506)				this->_data[Index] = (int)4;
            			}
HXLINE( 509)			bool _hx_tmp26;
HXDLIN( 509)			bool _hx_tmp27;
HXDLIN( 509)			int _hx_tmp28 = hx::Mod(Index,this->widthInTiles);
HXDLIN( 509)			if ((_hx_tmp28 < (this->widthInTiles - (int)1))) {
HXLINE( 510)				int _hx_tmp29 = ::Std_obj::_hx_int((Index + this->widthInTiles));
HXLINE( 509)				_hx_tmp27 = (_hx_tmp29 < this->totalTiles);
            			}
            			else {
HXLINE( 509)				_hx_tmp27 = false;
            			}
HXDLIN( 509)			if (_hx_tmp27) {
HXLINE( 511)				::Array< int > _hx_tmp30 = this->_data;
HXLINE( 509)				_hx_tmp26 = (_hx_tmp30->__get(((Index + this->widthInTiles) + (int)1)) <= (int)0);
            			}
            			else {
HXLINE( 509)				_hx_tmp26 = false;
            			}
HXDLIN( 509)			if (_hx_tmp26) {
HXLINE( 513)				this->_data[Index] = (int)8;
            			}
            		}
HXLINE( 517)		::Array< int > _hx_tmp31 = this->_data;
HXDLIN( 517)		int Index5 = Index;
HXDLIN( 517)		_hx_tmp31[Index5] = (_hx_tmp31->__get(Index5) + (int)1);
            	}
...
HXLINE( 527)		this->_data[Index] = (int)0;
HXLINE( 529)		bool wallUp = ((Index - this->widthInTiles) < (int)0);
HXLINE( 530)		int wallRight = hx::Mod(Index,this->widthInTiles);
HXDLIN( 530)		bool wallRight1 = (wallRight >= (this->widthInTiles - (int)1));
HXLINE( 531)		int wallDown = ::Std_obj::_hx_int((Index + this->widthInTiles));
HXDLIN( 531)		bool wallDown1 = (wallDown >= this->totalTiles);
HXLINE( 532)		bool wallLeft = (hx::Mod(Index,this->widthInTiles) <= (int)0);
HXLINE( 534)		bool up;
HXDLIN( 534)		if (!(wallUp)) {
HXLINE( 534)			::Array< int > up1 = this->_data;
HXDLIN( 534)			up = (up1->__get((Index - this->widthInTiles)) > (int)0);
            		}
            		else {
HXLINE( 534)			up = true;
            		}
...
HXLINE( 535)			upRight1 = wallRight1;
            		}
            		else {
HXLINE( 535)			upRight1 = true;
            		}
HXDLIN( 535)		if (!(upRight1)) {
HXLINE( 535)			::Array< int > upRight2 = this->_data;
HXDLIN( 535)			upRight = (upRight2->__get(((Index - this->widthInTiles) + (int)1)) > (int)0);
            		}
            		else {
HXLINE( 535)			upRight = true;
            		}
HXLINE( 536)		bool right;
HXDLIN( 536)		if (!(wallRight1)) {
HXLINE( 536)			::Array< int > right1 = this->_data;
HXDLIN( 536)			right = (right1->__get((Index + (int)1)) > (int)0);
            		}
            		else {
...
HXLINE( 537)			::Array< int > rightDown2 = this->_data;
HXDLIN( 537)			rightDown = (rightDown2->__get(((Index + this->widthInTiles) + (int)1)) > (int)0);
            		}
            		else {
...
HXLINE( 538)			::Array< int > down1 = this->_data;
HXDLIN( 538)			down = (down1->__get((Index + this->widthInTiles)) > (int)0);
            		}
            		else {
...
HXLINE( 539)			::Array< int > downLeft2 = this->_data;
HXDLIN( 539)			downLeft = (downLeft2->__get(((Index + this->widthInTiles) - (int)1)) > (int)0);
            		}
            		else {
...
HXLINE( 540)			::Array< int > left1 = this->_data;
HXDLIN( 540)			left = (left1->__get((Index - (int)1)) > (int)0);
            		}
            		else {
...
HXLINE( 541)			::Array< int > leftUp2 = this->_data;
HXDLIN( 541)			leftUp = (leftUp2->__get(((Index - this->widthInTiles) - (int)1)) > (int)0);
            		}
            		else {
...
HXDLIN( 544)			_hx_tmp[Index1] = (_hx_tmp->__get(Index1) + (int)1);
            		}
HXLINE( 545)		bool _hx_tmp1;
HXDLIN( 545)		bool _hx_tmp2;
HXDLIN( 545)		if (upRight) {
HXLINE( 545)			_hx_tmp2 = up;
            		}
            		else {
HXLINE( 545)			_hx_tmp2 = false;
            		}
HXDLIN( 545)		if (_hx_tmp2) {
HXLINE( 545)			_hx_tmp1 = right;
            		}
            		else {
HXLINE( 545)			_hx_tmp1 = false;
            		}
HXDLIN( 545)		if (_hx_tmp1) {
HXLINE( 546)			::Array< int > _hx_tmp3 = this->_data;
HXDLIN( 546)			int Index2 = Index;
HXDLIN( 546)			_hx_tmp3[Index2] = (_hx_tmp3->__get(Index2) + (int)2);
            		}
HXLINE( 547)		if (right) {
HXLINE( 548)			::Array< int > _hx_tmp4 = this->_data;
HXDLIN( 548)			int Index3 = Index;
HXDLIN( 548)			_hx_tmp4[Index3] = (_hx_tmp4->__get(Index3) + (int)4);
            		}
HXLINE( 549)		bool _hx_tmp5;
HXDLIN( 549)		bool _hx_tmp6;
HXDLIN( 549)		if (rightDown) {
HXLINE( 549)			_hx_tmp6 = right;
            		}
            		else {
HXLINE( 549)			_hx_tmp6 = false;
            		}
HXDLIN( 549)		if (_hx_tmp6) {
HXLINE( 549)			_hx_tmp5 = down;
            		}
            		else {
HXLINE( 549)			_hx_tmp5 = false;
            		}
HXDLIN( 549)		if (_hx_tmp5) {
HXLINE( 550)			::Array< int > _hx_tmp7 = this->_data;
HXDLIN( 550)			int Index4 = Index;
HXDLIN( 550)			_hx_tmp7[Index4] = (_hx_tmp7->__get(Index4) + (int)8);
            		}
HXLINE( 551)		if (down) {
HXLINE( 552)			::Array< int > _hx_tmp8 = this->_data;
HXDLIN( 552)			int Index5 = Index;
HXDLIN( 552)			_hx_tmp8[Index5] = (_hx_tmp8->__get(Index5) + (int)16);
            		}
HXLINE( 553)		bool _hx_tmp9;
HXDLIN( 553)		bool _hx_tmp10;
HXDLIN( 553)		if (downLeft) {
HXLINE( 553)			_hx_tmp10 = down;
            		}
            		else {
HXLINE( 553)			_hx_tmp10 = false;
            		}
HXDLIN( 553)		if (_hx_tmp10) {
HXLINE( 553)			_hx_tmp9 = left;
            		}
            		else {
HXLINE( 553)			_hx_tmp9 = false;
            		}
HXDLIN( 553)		if (_hx_tmp9) {
HXLINE( 554)			::Array< int > _hx_tmp11 = this->_data;
HXDLIN( 554)			int Index6 = Index;
HXDLIN( 554)			_hx_tmp11[Index6] = (_hx_tmp11->__get(Index6) + (int)32);
            		}
HXLINE( 555)		if (left) {
HXLINE( 556)			::Array< int > _hx_tmp12 = this->_data;
HXDLIN( 556)			int Index7 = Index;
HXDLIN( 556)			_hx_tmp12[Index7] = (_hx_tmp12->__get(Index7) + (int)64);
            		}
HXLINE( 557)		bool _hx_tmp13;
HXDLIN( 557)		bool _hx_tmp14;
HXDLIN( 557)		if (leftUp) {
HXLINE( 557)			_hx_tmp14 = left;
            		}
            		else {
HXLINE( 557)			_hx_tmp14 = false;
            		}
HXDLIN( 557)		if (_hx_tmp14) {
HXLINE( 557)			_hx_tmp13 = up;
            		}
            		else {
HXLINE( 557)			_hx_tmp13 = false;
            		}
HXDLIN( 557)		if (_hx_tmp13) {
HXLINE( 558)			::Array< int > _hx_tmp15 = this->_data;
HXDLIN( 558)			int Index8 = Index;
HXDLIN( 558)			_hx_tmp15[Index8] = (_hx_tmp15->__get(Index8) + (int)128);
            		}
HXLINE( 560)		::Array< int > _hx_tmp16 = this->_data;
HXDLIN( 560)		int Index9 = Index;
HXDLIN( 560)		::Array< int > _hx_tmp17 = ::flixel::tile::FlxBaseTilemap_obj::offsetAutoTile;
HXDLIN( 560)		_hx_tmp16[Index9] = (_hx_tmp16->__get(Index9) - (_hx_tmp17->__get(this->_data->__get(Index)) - (int)1));
            	}
...
HXLINE( 580)				_hx_tmp = (this->_randomChoices->length == (int)0);
            			}
            			else {
...
HXLINE( 582)			HX_STACK_DO_THROW(HX_("You must provide valid 'randomChoices' if you wish to randomize tilemap indices, please read documentation of 'setCustomTileMappings' function.",b3,ce,50,22));
            		}
            	}
...
HXDLIN( 595)		::Array< int > _hx_tmp = this->_data;
HXDLIN( 595)		return _hx_tmp->__get(((Y * this->widthInTiles) + X));
            	}
...
HXLINE( 699)		int i;
HXLINE( 700)		int row = (::Std_obj::_hx_int(((Float)Index / (Float)this->widthInTiles)) - (int)1);
HXLINE( 701)		int rowLength = (row + (int)3);
HXLINE( 702)		int column = (hx::Mod(Index,this->widthInTiles) - (int)1);
HXLINE( 703)		int columnHeight = (column + (int)3);
HXLINE( 705)		while((row < rowLength)){
HXLINE( 707)			column = (columnHeight - (int)3);
HXLINE( 709)			while((column < columnHeight)){
HXLINE( 711)				bool _hx_tmp;
HXDLIN( 711)				bool _hx_tmp1;
HXDLIN( 711)				bool _hx_tmp2;
HXDLIN( 711)				if ((row >= (int)0)) {
...
HXLINE( 711)					_hx_tmp1 = (column >= (int)0);
            				}
            				else {
...
HXLINE( 717)				column = (column + (int)1);
            			}
HXLINE( 719)			row = (row + (int)1);
            		}
...
HXLINE( 738)		if ((Range <= (int)0)) {
HXLINE( 740)			Range = (int)1;
            		}
...
HXLINE( 750)			HX_STACK_DO_THROW(((((((((HX_("Index ",ee,88,87,c8) + l) + HX_(" exceeds the maximum tile index of ",d9,51,06,f4)) + maxIndex) + HX_(". Please verify the Tile (",88,d4,6b,e3)) + Tile) + HX_(") and Range (",25,ce,96,19)) + Range) + HX_(") parameters.",cd,e3,29,61)));
            		}
HXLINE( 753)		while((i < l)){
HXLINE( 755)			::cpp::VirtualArray tile1 = this->_tileObjects;
HXDLIN( 755)			i = (i + (int)1);
HXDLIN( 755)			tile = tile1->__get((i - (int)1));
...
HXDLIN( 783)			::cpp::VirtualArray _hx_tmp1 = this->_tileObjects;
HXDLIN( 783)			if ((( ( ::flixel::FlxObject)(_hx_tmp1->__get(this->_data->__get(i))) )->allowCollisions > (int)0)) {
HXLINE( 783)				_hx_tmp = (int)1;
            			}
            			else {
HXLINE( 783)				_hx_tmp = (int)0;
            			}
HXDLIN( 783)			data[i] = _hx_tmp;
HXLINE( 784)			i = (i + (int)1);
            		}
...
HXDLIN( 809)		if ((startIndex >= (int)0)) {
HXLINE( 809)			_hx_tmp = (endIndex < (int)0);
            		}
            		else {
...
HXDLIN( 813)		::cpp::VirtualArray _hx_tmp2 = this->_tileObjects;
HXDLIN( 813)		if ((( ( ::flixel::FlxObject)(_hx_tmp2->__get(this->_data->__get(startIndex))) )->allowCollisions <= (int)0)) {
HXLINE( 813)			::cpp::VirtualArray _hx_tmp3 = this->_tileObjects;
HXDLIN( 813)			_hx_tmp1 = (( ( ::flixel::FlxObject)(_hx_tmp3->__get(this->_data->__get(endIndex))) )->allowCollisions > (int)0);
            		}
            		else {
...
HXLINE( 831)		 ::flixel::math::FlxPoint node = points->__get((points->length - (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 833)		{
...
HXLINE( 834)		node = points->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE( 835)		{
...
HXLINE( 849)		int i = (points->length - (int)1);
HXLINE( 851)		while((i >= (int)0)){
HXLINE( 853)			i = (i - (int)1);
HXDLIN( 853)			node = points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
...
HXLINE( 881)		int i = (int)0;
HXLINE( 883)		while((i < mapSize)){
HXLINE( 885)			::cpp::VirtualArray _hx_tmp = this->_tileObjects;
HXDLIN( 885)			if ((( ( ::flixel::FlxObject)(_hx_tmp->__get(this->_data->__get(i))) )->allowCollisions != (int)0)) {
HXLINE( 887)				distances[i] = (int)-2;
            			}
            			else {
HXLINE( 891)				distances[i] = (int)-1;
            			}
HXLINE( 893)			i = (i + (int)1);
            		}
HXLINE( 896)		distances[StartIndex] = (int)0;
HXLINE( 897)		int distance = (int)1;
...
HXLINE( 908)		while((neighbors->length > (int)0)){
...
HXLINE( 917)				i = (i + (int)1);
HXDLIN( 917)				currentIndex = current->__get((i - (int)1));
HXLINE( 919)				if ((currentIndex == ::Std_obj::_hx_int(EndIndex))) {
...
HXLINE( 930)				left = (hx::Mod(currentIndex,this->widthInTiles) > (int)0);
HXLINE( 931)				int right1 = hx::Mod(currentIndex,this->widthInTiles);
HXDLIN( 931)				right = (right1 < (this->widthInTiles - (int)1));
HXLINE( 932)				up = (((Float)currentIndex / (Float)this->widthInTiles) > (int)0);
HXLINE( 933)				Float down1 = ((Float)currentIndex / (Float)this->widthInTiles);
HXDLIN( 933)				down = (down1 < (this->heightInTiles - (int)1));
HXLINE( 935)				int index;
HXLINE( 937)				if (up) {
HXLINE( 939)					index = (currentIndex - this->widthInTiles);
HXLINE( 941)					if ((distances->__get(index) == (int)-1)) {
HXLINE( 943)						distances[index] = distance;
HXLINE( 944)						neighbors->push(index);
            					}
            				}
HXLINE( 947)				if (right) {
HXLINE( 949)					index = (currentIndex + (int)1);
HXLINE( 951)					if ((distances->__get(index) == (int)-1)) {
...
HXLINE( 961)					if ((distances->__get(index) == (int)-1)) {
HXLINE( 963)						distances[index] = distance;
HXLINE( 964)						neighbors->push(index);
            					}
            				}
HXLINE( 967)				if (left) {
HXLINE( 969)					index = (currentIndex - (int)1);
HXLINE( 971)					if ((distances->__get(index) == (int)-1)) {
HXLINE( 973)						distances[index] = distance;
HXLINE( 974)						neighbors->push(index);
            					}
            				}
HXLINE( 978)				if ((DiagonalPolicy != (int)0)) {
HXLINE( 980)					bool wideDiagonal = (DiagonalPolicy == (int)2);
HXLINE( 981)					bool _hx_tmp1;
HXDLIN( 981)					if (up) {
HXLINE( 981)						_hx_tmp1 = right;
            					}
            					else {
HXLINE( 981)						_hx_tmp1 = false;
            					}
HXDLIN( 981)					if (_hx_tmp1) {
HXLINE( 983)						index = ((currentIndex - this->widthInTiles) + (int)1);
HXLINE( 985)						bool _hx_tmp2;
HXDLIN( 985)						bool _hx_tmp3;
HXDLIN( 985)						bool _hx_tmp4;
HXDLIN( 985)						if (wideDiagonal) {
HXLINE( 985)							_hx_tmp4 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE( 985)							_hx_tmp4 = false;
            						}
HXDLIN( 985)						if (_hx_tmp4) {
HXLINE( 985)							_hx_tmp3 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE( 985)							_hx_tmp3 = false;
            						}
HXDLIN( 985)						if (_hx_tmp3) {
HXLINE( 985)							_hx_tmp2 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
...
HXLINE( 993)							bool _hx_tmp5;
HXDLIN( 993)							if (!(wideDiagonal)) {
HXLINE( 993)								_hx_tmp5 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE( 993)								_hx_tmp5 = false;
            							}
...
HXLINE( 999)					bool _hx_tmp6;
HXDLIN( 999)					if (right) {
HXLINE( 999)						_hx_tmp6 = down;
            					}
            					else {
HXLINE( 999)						_hx_tmp6 = false;
            					}
HXDLIN( 999)					if (_hx_tmp6) {
HXLINE(1001)						index = ((currentIndex + this->widthInTiles) + (int)1);
HXLINE(1003)						bool _hx_tmp7;
HXDLIN(1003)						bool _hx_tmp8;
HXDLIN(1003)						bool _hx_tmp9;
HXDLIN(1003)						if (wideDiagonal) {
HXLINE(1003)							_hx_tmp9 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE(1003)							_hx_tmp9 = false;
            						}
HXDLIN(1003)						if (_hx_tmp9) {
HXLINE(1003)							_hx_tmp8 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE(1003)							_hx_tmp8 = false;
            						}
HXDLIN(1003)						if (_hx_tmp8) {
HXLINE(1003)							_hx_tmp7 = (distances->__get((currentIndex + (int)1)) >= (int)-1);
            						}
            						else {
HXLINE(1003)							_hx_tmp7 = false;
            						}
HXDLIN(1003)						if (_hx_tmp7) {
...
HXLINE(1011)								_hx_tmp10 = (distances->__get(index) == (int)-1);
            							}
            							else {
...
HXLINE(1017)					bool _hx_tmp11;
HXDLIN(1017)					if (left) {
HXLINE(1017)						_hx_tmp11 = down;
            					}
            					else {
HXLINE(1017)						_hx_tmp11 = false;
            					}
HXDLIN(1017)					if (_hx_tmp11) {
HXLINE(1019)						index = ((currentIndex + this->widthInTiles) - (int)1);
HXLINE(1021)						bool _hx_tmp12;
HXDLIN(1021)						bool _hx_tmp13;
HXDLIN(1021)						bool _hx_tmp14;
HXDLIN(1021)						if (wideDiagonal) {
HXLINE(1021)							_hx_tmp14 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE(1021)							_hx_tmp14 = false;
            						}
HXDLIN(1021)						if (_hx_tmp14) {
HXLINE(1021)							_hx_tmp13 = (distances->__get((currentIndex + this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE(1021)							_hx_tmp13 = false;
            						}
HXDLIN(1021)						if (_hx_tmp13) {
HXLINE(1021)							_hx_tmp12 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE(1021)							_hx_tmp12 = false;
            						}
HXDLIN(1021)						if (_hx_tmp12) {
HXLINE(1026)							distances[index] = distance;
HXLINE(1027)							neighbors->push(index);
            						}
            						else {
HXLINE(1029)							bool _hx_tmp15;
HXDLIN(1029)							if (!(wideDiagonal)) {
HXLINE(1029)								_hx_tmp15 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE(1029)								_hx_tmp15 = false;
            							}
HXDLIN(1029)							if (_hx_tmp15) {
HXLINE(1031)								distances[index] = distance;
HXLINE(1032)								neighbors->push(index);
            							}
            						}
            					}
HXLINE(1035)					bool _hx_tmp16;
HXDLIN(1035)					if (up) {
HXLINE(1035)						_hx_tmp16 = left;
            					}
            					else {
HXLINE(1035)						_hx_tmp16 = false;
            					}
HXDLIN(1035)					if (_hx_tmp16) {
HXLINE(1037)						index = ((currentIndex - this->widthInTiles) - (int)1);
HXLINE(1039)						bool _hx_tmp17;
HXDLIN(1039)						bool _hx_tmp18;
HXDLIN(1039)						bool _hx_tmp19;
HXDLIN(1039)						if (wideDiagonal) {
HXLINE(1039)							_hx_tmp19 = (distances->__get(index) == (int)-1);
            						}
            						else {
HXLINE(1039)							_hx_tmp19 = false;
            						}
HXDLIN(1039)						if (_hx_tmp19) {
HXLINE(1039)							_hx_tmp18 = (distances->__get((currentIndex - this->widthInTiles)) >= (int)-1);
            						}
            						else {
HXLINE(1039)							_hx_tmp18 = false;
            						}
HXDLIN(1039)						if (_hx_tmp18) {
HXLINE(1039)							_hx_tmp17 = (distances->__get((currentIndex - (int)1)) >= (int)-1);
            						}
            						else {
HXLINE(1039)							_hx_tmp17 = false;
            						}
HXDLIN(1039)						if (_hx_tmp17) {
HXLINE(1044)							distances[index] = distance;
HXLINE(1045)							neighbors->push(index);
            						}
            						else {
HXLINE(1047)							bool _hx_tmp20;
HXDLIN(1047)							if (!(wideDiagonal)) {
HXLINE(1047)								_hx_tmp20 = (distances->__get(index) == (int)-1);
            							}
            							else {
HXLINE(1047)								_hx_tmp20 = false;
            							}
HXDLIN(1047)							if (_hx_tmp20) {
...
HXLINE(1050)								neighbors->push(index);
            			...
            			_hx_goto_50:;
HXLINE(1056)			distance = (distance + (int)1);
            		}
...
HXLINE(1077)		if ((Data->__get(Start) == (int)0)) {
HXLINE(1079)			return;
            		}
HXLINE(1083)		bool left = (hx::Mod(Start,this->widthInTiles) > (int)0);
HXLINE(1084)		int right = hx::Mod(Start,this->widthInTiles);
HXDLIN(1084)		bool right1 = (right < (this->widthInTiles - (int)1));
HXLINE(1085)		bool up = (((Float)Start / (Float)this->widthInTiles) > (int)0);
HXLINE(1086)		Float down = ((Float)Start / (Float)this->widthInTiles);
HXDLIN(1086)		bool down1 = (down < (this->heightInTiles - (int)1));
...
HXDLIN(1095)			if ((i >= (int)0)) {
HXLINE(1095)				_hx_tmp1 = (Data->__get(i) >= (int)0);
            			}
            			else {
...
HXLINE(1100)		if (right1) {
HXLINE(1102)			i = (Start + (int)1);
HXLINE(1104)			bool _hx_tmp2;
HXDLIN(1104)			bool _hx_tmp3;
HXDLIN(1104)			if ((i >= (int)0)) {
HXLINE(1104)				_hx_tmp3 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1104)				_hx_tmp3 = false;
            			}
HXDLIN(1104)			if (_hx_tmp3) {
HXLINE(1104)				_hx_tmp2 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1104)				_hx_tmp2 = false;
            			}
...
HXLINE(1109)		if (down1) {
HXLINE(1111)			i = (Start + this->widthInTiles);
HXLINE(1113)			bool _hx_tmp4;
HXDLIN(1113)			bool _hx_tmp5;
HXDLIN(1113)			if ((i >= (int)0)) {
HXLINE(1113)				_hx_tmp5 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1113)				_hx_tmp5 = false;
            			}
HXDLIN(1113)			if (_hx_tmp5) {
HXLINE(1113)				_hx_tmp4 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1113)				_hx_tmp4 = false;
            			}
...
HXLINE(1118)		if (left) {
HXLINE(1120)			i = (Start - (int)1);
HXLINE(1122)			bool _hx_tmp6;
HXDLIN(1122)			bool _hx_tmp7;
HXDLIN(1122)			if ((i >= (int)0)) {
HXLINE(1122)				_hx_tmp7 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1122)				_hx_tmp7 = false;
            			}
HXDLIN(1122)			if (_hx_tmp7) {
HXLINE(1122)				_hx_tmp6 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1122)				_hx_tmp6 = false;
            			}
...
HXLINE(1127)		bool _hx_tmp8;
HXDLIN(1127)		if (up) {
HXLINE(1127)			_hx_tmp8 = right1;
            		}
            		else {
HXLINE(1127)			_hx_tmp8 = false;
            		}
HXDLIN(1127)		if (_hx_tmp8) {
HXLINE(1129)			i = ((Start - this->widthInTiles) + (int)1);
HXLINE(1131)			bool _hx_tmp9;
HXDLIN(1131)			bool _hx_tmp10;
HXDLIN(1131)			if ((i >= (int)0)) {
HXLINE(1131)				_hx_tmp10 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1131)				_hx_tmp10 = false;
            			}
HXDLIN(1131)			if (_hx_tmp10) {
HXLINE(1131)				_hx_tmp9 = (Data->__get(i) < current);
            			}
            			else {
...
HXLINE(1136)		bool _hx_tmp11;
HXDLIN(1136)		if (right1) {
HXLINE(1136)			_hx_tmp11 = down1;
            		}
            		else {
HXLINE(1136)			_hx_tmp11 = false;
            		}
HXDLIN(1136)		if (_hx_tmp11) {
HXLINE(1138)			i = ((Start + this->widthInTiles) + (int)1);
HXLINE(1140)			bool _hx_tmp12;
HXDLIN(1140)			bool _hx_tmp13;
HXDLIN(1140)			if ((i >= (int)0)) {
HXLINE(1140)				_hx_tmp13 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1140)				_hx_tmp13 = false;
            			}
HXDLIN(1140)			if (_hx_tmp13) {
HXLINE(1140)				_hx_tmp12 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1140)				_hx_tmp12 = false;
            			}
HXDLIN(1140)			if (_hx_tmp12) {
HXLINE(1142)				this->walkPath(Data,i,Points);
HXDLIN(1142)				return;
            			}
            		}
HXLINE(1145)		bool _hx_tmp14;
HXDLIN(1145)		if (left) {
HXLINE(1145)			_hx_tmp14 = down1;
            		}
            		else {
HXLINE(1145)			_hx_tmp14 = false;
            		}
HXDLIN(1145)		if (_hx_tmp14) {
HXLINE(1147)			i = ((Start + this->widthInTiles) - (int)1);
HXLINE(1149)			bool _hx_tmp15;
HXDLIN(1149)			bool _hx_tmp16;
HXDLIN(1149)			if ((i >= (int)0)) {
HXLINE(1149)				_hx_tmp16 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1149)				_hx_tmp16 = false;
            			}
HXDLIN(1149)			if (_hx_tmp16) {
HXLINE(1149)				_hx_tmp15 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1149)				_hx_tmp15 = false;
            			}
HXDLIN(1149)			if (_hx_tmp15) {
HXLINE(1151)				this->walkPath(Data,i,Points);
HXDLIN(1151)				return;
            			}
            		}
HXLINE(1154)		bool _hx_tmp17;
HXDLIN(1154)		if (up) {
HXLINE(1154)			_hx_tmp17 = left;
            		}
            		else {
HXLINE(1154)			_hx_tmp17 = false;
            		}
HXDLIN(1154)		if (_hx_tmp17) {
HXLINE(1156)			i = ((Start - this->widthInTiles) - (int)1);
HXLINE(1158)			bool _hx_tmp18;
HXDLIN(1158)			bool _hx_tmp19;
HXDLIN(1158)			if ((i >= (int)0)) {
HXLINE(1158)				_hx_tmp19 = (Data->__get(i) >= (int)0);
            			}
            			else {
HXLINE(1158)				_hx_tmp19 = false;
            			}
HXDLIN(1158)			if (_hx_tmp19) {
HXLINE(1158)				_hx_tmp18 = (Data->__get(i) < current);
            			}
            			else {
HXLINE(1158)				_hx_tmp18 = false;
            			}
HXDLIN(1158)			if (_hx_tmp18) {
...
HXLINE(1176)		 ::flixel::math::FlxPoint last = Points->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1177)		 ::flixel::math::FlxPoint node;
HXLINE(1178)		int i = (int)1;
HXLINE(1179)		int l = (Points->length - (int)1);
HXLINE(1181)		while((i < l)){
HXLINE(1183)			node = Points->__get(i).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1184)			Float deltaPrevious1 = (node->x - last->x);
HXDLIN(1184)			deltaPrevious = ((Float)deltaPrevious1 / (Float)(node->y - last->y));
HXLINE(1185)			Float deltaNext1 = (node->x - Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(1185)			deltaNext = ((Float)deltaNext1 / (Float)(node->y - Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->y));
HXLINE(1187)			bool _hx_tmp;
HXDLIN(1187)			bool _hx_tmp1;
HXDLIN(1187)			if ((last->x != Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->x)) {
HXLINE(1187)				_hx_tmp1 = (last->y == Points->__get((i + (int)1)).StaticCast<  ::flixel::math::FlxPoint >()->y);
            			}
            			else {
...
HXLINE(1207)		 ::flixel::math::FlxPoint source = Points->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1208)		int lastIndex = (int)-1;
HXLINE(1209)		 ::flixel::math::FlxPoint node;
HXLINE(1210)		int i = (int)1;
HXLINE(1211)		int l = Points->length;
HXLINE(1213)		while((i < l)){
HXLINE(1215)			i = (i + (int)1);
HXDLIN(1215)			node = Points->__get((i - (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
HXLINE(1217)			if (hx::IsNull( node )) {
HXLINE(1219)				continue;
            			}
HXLINE(1222)			if (this->ray(source,node,this->_point,null())) {
HXLINE(1224)				if ((lastIndex >= (int)0)) {
...
HXLINE(1254)			return ::flixel::group::FlxTypedGroup_obj::overlaps(this->tilemapOverlapsCallback_dyn(),group,(int)0,(int)0,InScreenSpace,Camera);
            		}
            		else {
HXLINE(1256)			Float X = (int)0;
HXDLIN(1256)			Float Y = (int)0;
HXDLIN(1256)			bool _hx_tmp;
HXDLIN(1256)			bool _hx_tmp1;
HXDLIN(1256)			if ((ObjectOrGroup->flixelType != (int)1)) {
HXLINE(1256)				_hx_tmp1 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
...
HXLINE(1256)				_hx_tmp = this->overlaps(ObjectOrGroup,false,null());
            			}
...
HXDLIN(1265)		if ((ObjectOrGroup->flixelType != (int)1)) {
HXDLIN(1265)			_hx_tmp = (ObjectOrGroup->flixelType == (int)3);
            		}
            		else {
...
HXDLIN(1295)			if ((ObjectOrGroup->flixelType != (int)1)) {
HXLINE(1295)				_hx_tmp1 = (ObjectOrGroup->flixelType == (int)3);
            			}
            			else {
...
HXDLIN(1305)		if ((ObjectOrGroup->flixelType != (int)1)) {
HXDLIN(1305)			_hx_tmp = (ObjectOrGroup->flixelType == (int)3);
            		}
            		else {
...
HXDLIN(1340)		if ((tileIndex >= (int)0)) {
...
HXLINE(1342)		::cpp::VirtualArray _hx_tmp1 = this->_tileObjects;
HXDLIN(1342)		return (( ( ::flixel::FlxObject)(_hx_tmp1->__get(this->_data->__get(tileIndex))) )->allowCollisions > (int)0);
            	}
...
HXDLIN(1354)			_this->x = (int)0;
HXDLIN(1354)			_this->y = (int)0;
HXDLIN(1354)			_this->width = (int)0;
HXDLIN(1354)			_this->height = (int)0;
