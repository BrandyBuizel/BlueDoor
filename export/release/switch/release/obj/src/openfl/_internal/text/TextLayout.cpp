...
HXLINE(  90)		if ((language.length != (int)4)) {
HXLINE(  90)			return;
            		}
...
HXDLIN(  94)			switch((int)(direction)){
            				case (int)4: {
HXLINE(  94)					value = (int)4;
            				}
            				break;
            				case (int)5: {
HXLINE(  94)					value = (int)5;
            				}
            				break;
            				case (int)6: {
HXLINE(  94)					value = (int)6;
            				}
            				break;
            				case (int)7: {
HXLINE(  94)					value = (int)7;
            				}
            				break;
            				default:{
HXLINE(  94)					value = (int)0;
            				}
            			}
...
HXLINE( 109)				this->_hx___buffer = ::haxe::io::Bytes_obj::alloc((this->text.length * (int)5));
            			}
...
HXLINE( 122)					::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_ft_font_set_load_flags(hx::DynamicPtr(this->_hx___hbFont),(int)32);
            				}
            			}
            			else {
...
HXDLIN( 139)				switch((int)(this->get_direction())){
            					case (int)4: {
HXLINE( 139)						value = (int)4;
            					}
            					break;
            					case (int)5: {
HXLINE( 139)						value = (int)5;
            					}
            					break;
            					case (int)6: {
HXLINE( 139)						value = (int)6;
            					}
            					break;
            					case (int)7: {
HXLINE( 139)						value = (int)7;
            					}
            					break;
            					default:{
HXLINE( 139)						value = (int)0;
            					}
            				}
...
HXLINE( 143)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF8(this->_hx___hbBuffer,this->text,(int)0,(int)-1);
...
HXLINE( 153)				int lastCluster = (int)-1;
HXLINE( 155)				int length = ::Std_obj::_hx_int(::Math_obj::min(_info->length,_positions->length));
HXLINE( 157)				{
HXLINE( 157)					int _g1 = (int)0;
HXDLIN( 157)					int _g = length;
...
HXLINE( 162)						{
HXLINE( 162)							int _g3 = (lastCluster + (int)1);
HXDLIN( 162)							int _g2 = info->cluster;
HXDLIN( 162)							while((_g3 < _g2)){
HXLINE( 162)								_g3 = (_g3 + (int)1);
HXDLIN( 162)								int j = (_g3 - (int)1);
HXLINE( 166)								::Array< ::Dynamic> _hx_tmp4 = this->get_positions();
HXDLIN( 166)								 ::lime::math::Vector2 _hx_tmp5 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,(int)0,(int)0);
HXDLIN( 166)								_hx_tmp4->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,(int)0,_hx_tmp5, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(int)0,(int)0)));
            							}
            						}
HXLINE( 169)						::Array< ::Dynamic> _hx_tmp6 = this->get_positions();
HXDLIN( 169)						int info1 = info->codepoint;
HXDLIN( 169)						Float _hx_tmp7 = (((Float)position->xAdvance / (Float)(int)64) + this->letterSpacing);
HXDLIN( 169)						 ::lime::math::Vector2 _hx_tmp8 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp7,((Float)position->yAdvance / (Float)(int)64));
HXLINE( 170)						Float _hx_tmp9 = ((Float)position->xOffset / (Float)(int)64);
HXLINE( 169)						_hx_tmp6->push( ::openfl::_internal::text::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp8, ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp9,((Float)position->yOffset / (Float)(int)64))));
