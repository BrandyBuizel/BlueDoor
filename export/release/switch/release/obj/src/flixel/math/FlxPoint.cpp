...
HXLINE( 219)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 329)		this->set_x(::Math_obj::floor(this->x));
HXLINE( 330)		this->set_y(::Math_obj::floor(this->y));
...
HXLINE( 339)		this->set_x(::Math_obj::ceil(this->x));
HXLINE( 340)		this->set_y(::Math_obj::ceil(this->y));
...
HXLINE( 349)		this->set_x(::Math_obj::round(this->x));
HXLINE( 350)		this->set_y(::Math_obj::round(this->y));
...
HXLINE( 363)		Float radians = (Angle * ((Float)::Math_obj::PI / (Float)(int)180));
HXLINE( 364)		Float n = radians;
HXDLIN( 364)		n = (n * ((Float)0.3183098862));
HXDLIN( 364)		if ((n > (int)1)) {
HXLINE( 364)			n = (n - ((int)((int)::Math_obj::ceil(n) >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 364)			if ((n < (int)-1)) {
HXLINE( 364)				n = (n + ((int)((int)::Math_obj::ceil(-(n)) >> (int)(int)1) << (int)(int)1));
            			}
            		}
HXDLIN( 364)		Float sin;
HXDLIN( 364)		if ((n > (int)0)) {
...
HXDLIN( 365)		if ((n1 > (int)1)) {
HXLINE( 365)			n1 = (n1 - ((int)((int)::Math_obj::ceil(n1) >> (int)(int)1) << (int)(int)1));
            		}
            		else {
HXLINE( 365)			if ((n1 < (int)-1)) {
HXLINE( 365)				n1 = (n1 + ((int)((int)::Math_obj::ceil(-(n1)) >> (int)(int)1) << (int)(int)1));
            			}
            		}
HXDLIN( 365)		Float cos;
HXDLIN( 365)		if ((n1 > (int)0)) {
...
HXLINE( 386)		Float angle = (int)0;
HXLINE( 388)		bool _hx_tmp;
HXDLIN( 388)		if ((x == (int)0)) {
HXLINE( 388)			_hx_tmp = (y != (int)0);
            		}
            		else {
...
HXLINE( 391)			Float c2 = ((int)3 * c1);
HXLINE( 392)			Float ay;
HXDLIN( 392)			if ((y < (int)0)) {
HXLINE( 392)				ay = -(y);
            			}
            			else {
HXLINE( 392)				ay = y;
            			}
HXLINE( 394)			if ((x >= (int)0)) {
HXLINE( 396)				angle = (c1 - (c1 * ((Float)(x - ay) / (Float)(x + ay))));
            			}
            			else {
HXLINE( 400)				angle = (c2 - (c1 * ((Float)(x + ay) / (Float)(ay - x))));
            			}
HXLINE( 402)			Float angle1;
HXDLIN( 402)			if ((y < (int)0)) {
HXLINE( 402)				angle1 = -(angle);
            			}
            			else {
HXLINE( 402)				angle1 = angle;
            			}
HXDLIN( 402)			angle = (angle1 * ((Float)(int)180 / (Float)::Math_obj::PI));
HXLINE( 404)			if ((angle > (int)90)) {
HXLINE( 406)				angle = (angle - (int)270);
            			}
            			else {
HXLINE( 410)				angle = (angle + (int)90);
            			}
            		}
...
HXLINE( 453)		Float x1 = (this->x * matrix->a);
HXDLIN( 453)		Float x11 = ((x1 + (this->y * matrix->c)) + matrix->tx);
HXLINE( 454)		Float y1 = (this->x * matrix->b);
HXDLIN( 454)		Float y11 = ((y1 + (this->y * matrix->d)) + matrix->ty);
HXLINE( 456)		return this->set(x11,y11);
            	}
...
HXDLIN( 464)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 464)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
...
static ::String FlxPoint_obj_sMemberFields[] = {
	...
	HX_HCSTRING("addPointWeak","\x87","\xc6","\xaa","\x23"),
	HX_HCSTRING("subtract","\x14","\x75","\x11","\xf8"),
	HX_HCSTRING("subtractPoint","\x9c","\xc6","\x66","\x44"),
	HX_HCSTRING("subtractPointWeak","\x34","\xcd","\x92","\xd2"),
