...
HX_DEFINE_STACK_FRAME(_hx_pos_0beb5da3a19aed74_363_new,"__ASSET__flixel_flixel_ui_img_check_mark_png","new",0xfe81e957,"__ASSET__flixel_flixel_ui_img_check_mark_png.new","lime/_internal/macros/AssetsMacro.hx",363,0xc651f030)
...
void __ASSET__flixel_flixel_ui_img_check_mark_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_0beb5da3a19aed74_363_new)
HXLINE( 392)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 394)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_img_check_mark_png_obj::resourceName),null());
            	}
...
bool __ASSET__flixel_flixel_ui_img_check_mark_png_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2036f1e5) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x2036f1e5;
	} else {
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_check_mark_png",73,3f,b4,e4);
            	}
}
