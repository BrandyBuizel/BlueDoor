...
HXDLIN( 225)		if (!(::flixel::math::FlxMath_obj::pointInCoordinates(PointX,PointY,_hx_tmp,_hx_tmp1,_hx_tmp2,::Std_obj::_hx_int(Target->get_height())))) {
...
HXLINE( 238)		int Value = ::Math_obj::floor((PointX - Target->x));
HXDLIN( 238)		int pixelAlpha = ((int)((int)::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(test->getPixel32(Value,::Math_obj::floor((PointY - Target->y)))) >> (int)(int)24) & (int)(int)255);
HXLINE( 240)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 242)			pixelAlpha = ::Std_obj::_hx_int((pixelAlpha * Target->alpha));
            		}
...
HXLINE( 267)			int left1 = ::Math_obj::floor((Camera->x - Thickness));
HXDLIN( 267)			int left2 = ::Math_obj::floor((Camera->y + Thickness));
HXDLIN( 267)			int Camera1 = Camera->height;
HXDLIN( 267)			left =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,left1,left2,Thickness,(Camera1 - (Thickness * (int)2)));
HXLINE( 268)			int right1 = ::Math_obj::floor((Camera->x + Camera->width));
HXDLIN( 268)			int right2 = ::Math_obj::floor((Camera->y + Thickness));
HXDLIN( 268)			int Camera2 = Camera->height;
HXDLIN( 268)			right =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,right1,right2,Thickness,(Camera2 - (Thickness * (int)2)));
HXLINE( 269)			int top1 = ::Math_obj::floor((Camera->x - Thickness));
HXDLIN( 269)			int top2 = ::Math_obj::floor((Camera->y - Thickness));
HXDLIN( 269)			int Camera3 = Camera->width;
HXDLIN( 269)			top =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,top1,top2,(Camera3 + (Thickness * (int)2)),Thickness);
HXLINE( 270)			int bottom1 = ::Math_obj::floor((Camera->x - Thickness));
HXDLIN( 270)			int Camera4 = Camera->height;
HXDLIN( 270)			int Camera5 = Camera->width;
HXDLIN( 270)			bottom =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,bottom1,Camera4,(Camera5 + (Thickness * (int)2)),Thickness);
HXLINE( 272)			if (AdjustWorldBounds) {
HXLINE( 274)				 ::flixel::math::FlxRect _this = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 274)				int Camera6 = Camera->width;
HXDLIN( 274)				int Camera7 = Camera->height;
HXDLIN( 274)				_this->x = (Camera->x - Thickness);
HXDLIN( 274)				_this->y = (Camera->y - Thickness);
HXDLIN( 274)				_this->width = (Camera6 + (Thickness * (int)2));
HXDLIN( 274)				_this->height = (Camera7 + (Thickness * (int)2));
            			}
            		}
            		else {
HXLINE( 279)			int left3 = ::Math_obj::floor(Camera->x);
HXDLIN( 279)			int left4 = ::Math_obj::floor((Camera->y + Thickness));
HXDLIN( 279)			int Camera8 = Camera->height;
HXDLIN( 279)			left =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,left3,left4,Thickness,(Camera8 - (Thickness * (int)2)));
HXLINE( 280)			int right3 = ::Math_obj::floor(((Camera->x + Camera->width) - Thickness));
HXDLIN( 280)			int right4 = ::Math_obj::floor((Camera->y + Thickness));
HXLINE( 281)			int Camera9 = Camera->height;
HXLINE( 280)			right =  ::flixel::tile::FlxTileblock_obj::__alloc( HX_CTX ,right3,right4,Thickness,(Camera9 - (Thickness * (int)2)));
