...
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->VERTEX_ARRAY_OBJECT_EXT = (int)37204;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->QUERY_OBJECT_EXT = (int)37203;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->BUFFER_OBJECT_EXT = (int)37201;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->SHADER_OBJECT_EXT = (int)35656;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->PROGRAM_OBJECT_EXT = (int)35648;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_debug_label)(__this) )->PROGRAM_PIPELINE_OBJECT_EXT = (int)35407;
            	}
