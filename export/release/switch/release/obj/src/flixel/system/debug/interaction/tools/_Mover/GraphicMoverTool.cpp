...
HX_LOCAL_STACK_FRAME(_hx_pos_3d22618cdf95ebc1_1_boot,"flixel.system.debug.interaction.tools._Mover.GraphicMoverTool","boot",0x4e4b3cfa,"flixel.system.debug.interaction.tools._Mover.GraphicMoverTool.boot","?",1,0x0000003f)
namespace flixel{
...
bool GraphicMoverTool_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28c743a7) {
		...
		return inClassId==(int)0x3a1ea8c0;
	}
}
...
void GraphicMoverTool_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Mover.GraphicMoverTool","\xa6","\x5c","\x4f","\x05");
...
{
{
            	HX_STACKFRAME(&_hx_pos_3d22618cdf95ebc1_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Mover_GraphicMoverTool",5e,5f,d5,0e);
            	}
}
