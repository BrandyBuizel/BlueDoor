...
HXDLIN( 638)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 638)		return ( ( ::openfl::_Vector::IntVector)(this2->__get((this1->oPos + (int)1))) );
            	}
...
HXDLIN( 645)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 645)		return ( ( ::openfl::_Vector::FloatVector)(this2->__get((this1->oPos + (int)2))) );
            	}
