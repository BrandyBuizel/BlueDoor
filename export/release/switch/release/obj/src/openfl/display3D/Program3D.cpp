...
HXLINE(  85)		if (hx::IsEq( this->_hx___format,(int)0 )) {
HXLINE(  88)			this->_hx___agalSamplerUsageMask = (int)0;
HXLINE(  89)			this->_hx___agalUniforms =  ::List_obj::__alloc( HX_CTX );
HXLINE(  90)			this->_hx___agalSamplerUniforms =  ::List_obj::__alloc( HX_CTX );
HXLINE(  91)			this->_hx___agalAlphaSamplerUniforms =  ::List_obj::__alloc( HX_CTX );
...
HXDLIN( 126)		if (hx::IsEq( this->_hx___format,(int)0 )) {
HXLINE( 130)			if (::StringTools_obj::startsWith(name,HX_("va",2b,67,00,00))) {
HXLINE( 132)				return ::Std_obj::parseInt(name.substring((int)2,null()));
            			}
            			else {
...
HXDLIN( 141)				int _g = this->_hx___glslAttribNames->length;
...
HXDLIN( 160)		if (hx::IsEq( this->_hx___format,(int)0 )) {
HXLINE( 164)			if (::StringTools_obj::startsWith(name,HX_("vc",2d,67,00,00))) {
HXLINE( 166)				return ::Std_obj::parseInt(name.substring((int)2,null()));
            			}
            			else {
HXLINE( 168)				if (::StringTools_obj::startsWith(name,HX_("fc",3d,59,00,00))) {
HXLINE( 170)					return ::Std_obj::parseInt(name.substring((int)2,null()));
            				}
            				else {
...
HXDLIN( 179)				int _g = this->_hx___glslUniformNames->length;
...
HXLINE( 389)		if (hx::IsNotEq( this->_hx___format,(int)0 )) {
HXLINE( 389)			return;
            		}
...
HXLINE( 397)		bool _hx_tmp = (::lime::utils::Log_obj::level == (int)5);
...
HXLINE( 407)		{
HXLINE( 407)			int _g1 = (int)0;
HXDLIN( 407)			int _g = samplerStates->length;
HXDLIN( 407)			while((_g1 < _g)){
HXLINE( 407)				_g1 = (_g1 + (int)1);
HXDLIN( 407)				int i = (_g1 - (int)1);
HXLINE( 409)				::Array< ::Dynamic> _hx_tmp1 = this->_hx___samplerStates;
HXDLIN( 409)				_hx_tmp1[i] = samplerStates->__get(i).StaticCast<  ::openfl::_internal::renderer::SamplerState >();
            			}
            		}
            	}
...
HXLINE( 420)		if (hx::IsNotEq( this->_hx___format,(int)1 )) {
HXLINE( 420)			return;
            		}
...
HXLINE( 469)				::Array< ::String > _hx_tmp1 = this->_hx___glslAttribNames;
HXDLIN( 469)				_hx_tmp1[index] = attribNames->__get(i);
HXLINE( 470)				::Array< ::Dynamic> _hx_tmp2 = this->_hx___glslAttribTypes;
HXDLIN( 470)				_hx_tmp2[index] = attribTypes->__get(i);
            			}
            		}
HXLINE( 473)		{
HXLINE( 473)			int _g11 = (int)0;
HXDLIN( 473)			int _g3 = uniformNames->length;
HXDLIN( 473)			while((_g11 < _g3)){
...
HXLINE( 482)		if (hx::IsEq( this->_hx___format,(int)1 )) {
HXLINE( 482)			return;
            		}
...
HXLINE( 492)		this->_hx___agalSamplerUsageMask = (int)0;
HXLINE( 494)		int numActive = (int)0;
HXLINE( 495)		numActive = ( (int)(gl->getProgramParameter(this->_hx___glProgram,gl->ACTIVE_UNIFORMS)) );
HXLINE( 497)		 ::List vertexUniforms =  ::List_obj::__alloc( HX_CTX );
HXLINE( 498)		 ::List fragmentUniforms =  ::List_obj::__alloc( HX_CTX );
HXLINE( 500)		{
HXLINE( 500)			int _g1 = (int)0;
HXDLIN( 500)			int _g = numActive;
HXDLIN( 500)			while((_g1 < _g)){
HXLINE( 500)				_g1 = (_g1 + (int)1);
HXDLIN( 500)				int i = (_g1 - (int)1);
...
HXLINE( 516)				if ((indexBracket >= (int)0)) {
HXLINE( 518)					uniform->name = uniform->name.substring((int)0,indexBracket);
            				}
HXLINE( 521)				{
HXLINE( 521)					int _g2 = uniform->type;
HXDLIN( 521)					switch((int)(_g2)){
            						case (int)35674: {
HXLINE( 524)							uniform->regCount = (int)2;
            						}
            						break;
            						case (int)35675: {
HXLINE( 526)							uniform->regCount = (int)3;
            						}
            						break;
            						case (int)35676: {
HXLINE( 528)							uniform->regCount = (int)4;
            						}
            						break;
            						default:{
HXLINE( 530)							uniform->regCount = (int)1;
            						}
            					}
            				}
...
HXLINE( 543)						uniform->regIndex = ::Std_obj::parseInt(uniform->name.substring((int)2,null()));
...
HXLINE( 549)							uniform->regIndex = ::Std_obj::parseInt(uniform->name.substring((int)2,null()));
...
HXLINE( 553)								_hx_tmp = (uniform->name.indexOf(HX_("alpha",5e,a7,96,21),null()) == (int)-1);
            							}
            							else {
HXLINE( 553)								_hx_tmp = false;
            							}
HXDLIN( 553)							if (_hx_tmp) {
HXLINE( 555)								uniform->regIndex = ::Std_obj::parseInt(uniform->name.substring((int)7,null()));
HXLINE( 556)								this->_hx___agalSamplerUniforms->add(uniform);
HXLINE( 558)								{
HXLINE( 558)									int _g4 = (int)0;
HXDLIN( 558)									int _g3 = uniform->regCount;
HXDLIN( 558)									while((_g4 < _g3)){
HXLINE( 558)										_g4 = (_g4 + (int)1);
HXDLIN( 558)										int reg = (_g4 - (int)1);
HXLINE( 560)										 ::openfl::display3D::Program3D _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 560)										_hx_tmp1->_hx___agalSamplerUsageMask = ((int)_hx_tmp1->_hx___agalSamplerUsageMask | (int)((int)(int)1 << (int)(uniform->regIndex + reg)));
            									}
            								}
            							}
            							else {
...
HXLINE( 565)									int len = (uniform->name.indexOf(HX_("_",5f,00,00,00),null()) - (int)7);
HXLINE( 566)									::String uniform2 = uniform->name;
HXDLIN( 566)									uniform->regIndex = (::Std_obj::parseInt(uniform2.substring((int)7,((int)7 + len))) + (int)4);
...
HXLINE( 571)										uniform->regIndex = ::Std_obj::parseInt(uniform->name.substring((int)7,null()));
...
HXDLIN( 610)		bool _hx_tmp = hx::IsEq( this->_hx___format,(int)1 );
            	}
...
HXLINE( 662)					if ((sampler->regCount == (int)1)) {
...
HXLINE( 672)			{
HXLINE( 672)				 ::_List::ListNode _g_head1 = this->_hx___agalAlphaSamplerUniforms->h;
...
HXLINE( 674)					if ((sampler1->regCount == (int)1)) {
...
HXDLIN( 707)		if (hx::IsEq( this->_hx___format,(int)0 )) {
...
HXDLIN( 748)		return this->_hx___samplerStates->__get(sampler).StaticCast<  ::openfl::_internal::renderer::SamplerState >();
            	}
...
HXLINE( 753)		if (hx::IsEq( this->_hx___format,(int)1 )) {
HXLINE( 753)			return;
            		}
...
HXLINE( 767)		int lastMatch = (int)0;
...
HXLINE( 780)			type = regex->matched((int)1);
HXLINE( 781)			name = regex->matched((int)2);
...
HXLINE( 833)			lastMatch = (( (int)(position->__Field(HX_("pos",94,5d,55,00),hx::paccDynamic)) ) + ( (int)(position->__Field(HX_("len",d5,4b,52,00),hx::paccDynamic)) ));
            		}
            	}
...
HXLINE( 839)		if (hx::IsEq( this->_hx___format,(int)1 )) {
HXLINE( 839)			return;
            		}
...
HXLINE( 844)					_hx_tmp = ((int)positionScale->length >> (int)(int)2);
            				}
            				else {
HXLINE( 844)					_hx_tmp = (int)0;
            				}
...
HXLINE( 864)		if (hx::IsEq( gl->getShaderParameter(this->_hx___glVertexShader,gl->COMPILE_STATUS),(int)0 )) {
...
HXLINE( 869)			::lime::utils::Log_obj::error(message,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),869,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__uploadFromGLSL",a9,36,31,0d)));
            		}
...
HXLINE( 876)		if (hx::IsEq( gl->getShaderParameter(this->_hx___glFragmentShader,gl->COMPILE_STATUS),(int)0 )) {
...
HXLINE( 881)			::lime::utils::Log_obj::error(message1,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),881,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__uploadFromGLSL",a9,36,31,0d)));
            		}
HXLINE( 884)		this->_hx___glProgram = gl->createProgram();
HXLINE( 886)		if (hx::IsEq( this->_hx___format,(int)0 )) {
HXLINE( 889)			int _g = (int)0;
HXDLIN( 889)			while((_g < (int)16)){
HXLINE( 889)				_g = (_g + (int)1);
HXDLIN( 889)				int i = (_g - (int)1);
HXLINE( 893)				::String name = (HX_("va",2b,67,00,00) + i);
HXLINE( 895)				if ((vertexShaderSource.indexOf((HX_(" ",20,00,00,00) + name),null()) != (int)-1)) {
HXLINE( 897)					gl->bindAttribLocation(this->_hx___glProgram,i,name);
            				}
            			}
            		}
            		else {
HXLINE( 904)			int _g1 = (int)0;
HXDLIN( 904)			::Array< ::String > _g11 = this->_hx___glslAttribNames;
HXDLIN( 904)			while((_g1 < _g11->length)){
HXLINE( 904)				::String name1 = _g11->__get(_g1);
HXDLIN( 904)				_g1 = (_g1 + (int)1);
HXLINE( 906)				bool _hx_tmp;
HXDLIN( 906)				if ((name1.indexOf(HX_("Position",c9,5c,ac,a4),null()) > (int)-1)) {
...
HXLINE( 908)					gl->bindAttribLocation(this->_hx___glProgram,(int)0,name1);
...
HXLINE( 918)		if (hx::IsEq( gl->getProgramParameter(this->_hx___glProgram,gl->LINK_STATUS),(int)0 )) {
...
HXLINE( 922)			::lime::utils::Log_obj::error(message2,hx::SourceInfo(HX_("Program3D.hx",c9,bd,cd,87),922,HX_("openfl.display3D.Program3D",7c,83,68,f5),HX_("__uploadFromGLSL",a9,36,31,0d)));
            		}
            	}
...
void Program3D_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("__glslUniformLocations","\x08","\x06","\x40","\x87"));
...
static hx::StorageInfo Program3D_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(Program3D_obj,_hx___glslUniformLocations),HX_HCSTRING("__glslUniformLocations","\x08","\x06","\x40","\x87")},
...
static ::String Program3D_obj_sMemberFields[] = {
	...
	HX_HCSTRING("__glslUniformLocations","\x08","\x06","\x40","\x87"),
