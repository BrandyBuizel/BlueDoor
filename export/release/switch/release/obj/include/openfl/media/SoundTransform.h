...
HXLINE(  61)		( ( ::openfl::media::SoundTransform)(__this) )->leftToLeft = (int)0;
HXLINE(  62)		( ( ::openfl::media::SoundTransform)(__this) )->leftToRight = (int)0;
HXLINE(  63)		( ( ::openfl::media::SoundTransform)(__this) )->rightToLeft = (int)0;
HXLINE(  64)		( ( ::openfl::media::SoundTransform)(__this) )->rightToRight = (int)0;
            	}
