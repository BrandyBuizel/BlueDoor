...
HXLINE(  42)		this->_lastUniqueKeyIndex = (int)0;
...
HXLINE(  53)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE(  69)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE(  86)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXLINE( 103)			 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXDLIN( 120)		return hx::IsNotNull( ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(this->_cache,Key)) ) );
            	}
...
HXLINE( 151)		if (::Std_obj::is(Graphic,hx::ClassOf< ::flixel::graphics::FlxGraphic >())) {
...
HXDLIN( 183)		return this->_cache->get(key).StaticCast<  ::flixel::graphics::FlxGraphic >();
            	}
...
HXLINE( 196)				 ::flixel::graphics::FlxGraphic obj = this->_cache->get(key1).StaticCast<  ::flixel::graphics::FlxGraphic >();
...
HXDLIN( 397)		return ( (int)(::lime::graphics::opengl::GL_obj::context->getParameter((int)3379)) );
            	}
...
HXLINE( 405)			 ::openfl::display::BitmapData bd =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)10,(int)10,true,(int)-1);
