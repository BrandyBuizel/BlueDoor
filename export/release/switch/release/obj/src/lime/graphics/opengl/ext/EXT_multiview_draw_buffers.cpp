...
HXLINE(  10)		this->MAX_MULTIVIEW_BUFFERS_EXT = (int)37106;
HXLINE(   9)		this->READ_BUFFER_EXT = (int)3074;
HXLINE(   8)		this->DRAW_BUFFER_EXT = (int)3073;
HXLINE(   7)		this->MULTIVIEW_EXT = (int)37105;
HXLINE(   6)		this->COLOR_ATTACHMENT_EXT = (int)37104;
            	}
