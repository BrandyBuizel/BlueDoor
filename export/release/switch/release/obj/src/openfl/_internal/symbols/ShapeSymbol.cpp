...
HXLINE(  48)				switch((int)(_hx_getEnumValueIndex(command))){
            					case (int)0: {
...
HXDLIN(  53)						{
HXLINE(  55)							 ::openfl::_internal::symbols::BitmapSymbol bitmapSymbol = ( ( ::openfl::_internal::symbols::BitmapSymbol)(::haxe::IMap_obj::get(swf->symbols,bitmapID)) );
