...
HXLINE(  63)		this->_hx___graphicsDataType = (int)3;
            	}
...
HXLINE(  88)		this->commands->push((int)6);
...
HXLINE( 119)		this->commands->push((int)3);
...
HXLINE( 138)		this->commands->push((int)2);
...
HXLINE( 155)		this->commands->push((int)1);
...
HXLINE( 172)		this->commands->push((int)2);
...
HXLINE( 189)		this->commands->push((int)1);
...
HXDLIN( 196)		this->_hx___drawRoundRect((x - radius),(y - radius),(radius * (int)2),(radius * (int)2),(radius * (int)2),(radius * (int)2));
            	}
...
HXLINE( 218)		if ((ellipseWidth > ((Float)width / (Float)(int)2))) {
HXLINE( 218)			ellipseWidth = ((Float)width / (Float)(int)2);
            		}
HXLINE( 219)		if ((ellipseHeight > ((Float)height / (Float)(int)2))) {
HXLINE( 219)			ellipseHeight = ((Float)height / (Float)(int)2);
            		}
...
static hx::StorageInfo GraphicsPath_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsPath_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{ hx::fsUnknown, 0, null()}
};
