...
HX_DEFINE_STACK_FRAME(_hx_pos_0bb624e4e0669b45_53_new,"__ASSET__flixel_flixel_ui_xml_defaults_xml","new",0x9f4395df,"__ASSET__flixel_flixel_ui_xml_defaults_xml.new","lime/_internal/macros/AssetsMacro.hx",53,0xc651f030)
...
void __ASSET__flixel_flixel_ui_xml_defaults_xml_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_0bb624e4e0669b45_53_new)
HXLINE(  54)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_defaults_xml_obj::resourceName);
...
bool __ASSET__flixel_flixel_ui_xml_defaults_xml_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x2517afd1) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x2517afd1;
	} else {
