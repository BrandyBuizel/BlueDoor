...
HXLINE(  61)		this->displayMode =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,(int)0);
...
HXLINE(  66)		int flags = (int)0;
HXLINE(  68)		if (!(::Reflect_obj::hasField(contextAttributes,HX_("antialiasing",f4,16,b3,48)))) {
HXLINE(  68)			contextAttributes->__SetField(HX_("antialiasing",f4,16,b3,48),(int)0,hx::paccDynamic);
            		}
HXLINE(  69)		if (!(::Reflect_obj::hasField(contextAttributes,HX_("background",ee,93,1d,26)))) {
HXLINE(  69)			contextAttributes->__SetField(HX_("background",ee,93,1d,26),(int)0,hx::paccDynamic);
            		}
HXLINE(  70)		if (!(::Reflect_obj::hasField(contextAttributes,HX_("colorDepth",a0,08,96,fb)))) {
HXLINE(  70)			contextAttributes->__SetField(HX_("colorDepth",a0,08,96,fb),(int)24,hx::paccDynamic);
            		}
...
HXLINE(  79)			_hx_tmp = (( (::String)(contextAttributes->__Field(HX_("type",ba,f2,08,4d),hx::paccDynamic)) ) == HX_("cairo",88,30,19,41));
            		}
            		else {
...
HXLINE(  81)			flags = ((int)flags | (int)(int)2048);
            		}
...
HXLINE(  82)			flags = ((int)flags | (int)(int)32768);
            		}
...
HXLINE(  83)			flags = ((int)flags | (int)(int)2);
            		}
...
HXLINE(  84)			flags = ((int)flags | (int)(int)1);
            		}
...
HXLINE(  85)			flags = ((int)flags | (int)(int)4096);
            		}
...
HXLINE(  86)			flags = ((int)flags | (int)(int)16384);
            		}
...
HXLINE(  87)			flags = ((int)flags | (int)(int)8192);
            		}
...
HXLINE(  88)			flags = ((int)flags | (int)(int)4);
            		}
HXLINE(  90)		if (hx::IsGreaterEq( contextAttributes->__Field(HX_("antialiasing",f4,16,b3,48),hx::paccDynamic),(int)4 )) {
HXLINE(  92)			flags = ((int)flags | (int)(int)96);
            		}
            		else {
HXLINE(  94)			if (hx::IsGreaterEq( contextAttributes->__Field(HX_("antialiasing",f4,16,b3,48),hx::paccDynamic),(int)2 )) {
HXLINE(  96)				flags = ((int)flags | (int)(int)32);
            			}
            		}
HXLINE(  99)		if (hx::IsEq( contextAttributes->__Field(HX_("colorDepth",a0,08,96,fb),hx::paccDynamic),(int)32 )) {
HXLINE(  99)			flags = ((int)flags | (int)(int)65536);
            		}
HXLINE( 100)		if (( (bool)(contextAttributes->__Field(HX_("depth",03,f1,29,d7),hx::paccDynamic)) )) {
HXLINE( 100)			flags = ((int)flags | (int)(int)512);
            		}
HXLINE( 101)		if (( (bool)(contextAttributes->__Field(HX_("hardware",a8,e2,d3,75),hx::paccDynamic)) )) {
HXLINE( 101)			flags = ((int)flags | (int)(int)8);
            		}
HXLINE( 102)		if (( (bool)(contextAttributes->__Field(HX_("stencil",fc,bd,03,80),hx::paccDynamic)) )) {
HXLINE( 102)			flags = ((int)flags | (int)(int)1024);
            		}
HXLINE( 103)		if (( (bool)(contextAttributes->__Field(HX_("vsync",d1,2d,a8,3d),hx::paccDynamic)) )) {
HXLINE( 103)			flags = ((int)flags | (int)(int)16);
            		}
...
HXLINE( 109)		this->handle = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_create(hx::DynamicPtr(parent->application->_hx___backend->handle),width,height,flags,title)) );
...
HXLINE( 148)				_hx_tmp10 = (gl->version >= (int)3);
            			}
            			else {
...
HXLINE( 328)		{
HXLINE( 328)			::String _g = this->parent->context->type;
HXDLIN( 328)			::String _hx_switch_0 = _g;
...
HXLINE( 332)				int windowWidth = ::Std_obj::_hx_int((this->parent->_hx___width * this->parent->_hx___scale));
HXLINE( 333)				int windowHeight = ::Std_obj::_hx_int((this->parent->_hx___height * this->parent->_hx___scale));
HXLINE( 335)				int x;
HXDLIN( 335)				int y;
...
HXLINE( 340)					y = ::Std_obj::_hx_int(((windowHeight - rect->y) - rect->height));
...
HXLINE( 352)				 ::Dynamic elements = ((width * height) * (int)4);
HXDLIN( 352)				 ::lime::utils::ArrayBufferView this1;
HXDLIN( 352)				if (hx::IsNotNull( elements )) {
HXLINE( 352)					this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,(int)4);
            				}
            				else {
...
HXDLIN( 354)					{
HXLINE( 354)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data,null(),(int)0);
...
HXLINE( 358)				int rowLength = (width * (int)4);
HXLINE( 359)				int srcPosition = ((height - (int)1) * rowLength);
HXLINE( 360)				int destPosition = (int)0;
HXLINE( 362)				 ::haxe::io::Bytes temp = ::haxe::io::Bytes_obj::alloc(rowLength);
HXLINE( 363)				 ::haxe::io::Bytes buffer = data->buffer;
HXLINE( 364)				int rows = ::Std_obj::_hx_int(((Float)height / (Float)(int)2));
HXLINE( 366)				while(true){
HXLINE( 366)					rows = (rows - (int)1);
HXDLIN( 366)					if (!(((rows + (int)1) > (int)0))) {
HXLINE( 366)						goto _hx_goto_13;
            					}
HXLINE( 368)					temp->blit((int)0,buffer,destPosition,rowLength);
HXLINE( 369)					buffer->blit(destPosition,buffer,srcPosition,rowLength);
HXLINE( 370)					buffer->blit(srcPosition,temp,(int)0,rowLength);
HXLINE( 372)					destPosition = (destPosition + rowLength);
HXLINE( 373)					srcPosition = (srcPosition - rowLength);
            				}
            				_hx_goto_13:;
HXLINE( 377)				imageBuffer =  ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,data,width,height,(int)32,(int)0);
HXLINE( 330)				goto _hx_goto_12;
            			}
            			/* default */{
HXLINE( 382)				 ::Dynamic imageBuffer1 = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN( 382)				 ::Dynamic imageBuffer2 = this->handle;
HXDLIN( 382)				 ::haxe::io::Bytes buffer1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN( 382)				 ::lime::utils::ArrayBufferView this2;
HXDLIN( 382)				if (hx::IsNotNull( buffer1 )) {
HXLINE( 382)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 382)					int in_byteOffset = (int)0;
HXDLIN( 382)					if ((in_byteOffset < (int)0)) {
HXLINE( 382)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 382)					if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 382)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 382)						if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 382)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 382)						if ((newByteLength < (int)0)) {
HXLINE( 382)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
...
HXDLIN( 382)				imageBuffer = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_window_read_pixels(hx::DynamicPtr(imageBuffer2),hx::DynamicPtr(rect),hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this2,null(),null(),null(),null())))) );
HXLINE( 393)				if (hx::IsNotNull( imageBuffer )) {
HXLINE( 395)					imageBuffer->format = (int)0;
            				}
            			}
            			_hx_goto_12:;
            		}
...
HXLINE( 418)					_hx_tmp2 = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)) );
            				}
            				else {
HXLINE( 418)					_hx_tmp2 = true;
            				}
HXDLIN( 418)				if (!(_hx_tmp2)) {
HXLINE( 418)					_hx_tmp1 = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) );
            				}
            				else {
HXLINE( 418)					_hx_tmp1 = true;
            				}
HXDLIN( 418)				if (!(_hx_tmp1)) {
HXLINE( 417)					_hx_tmp = hx::IsNotEq(  ::Dynamic(this->cacheLock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(lock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) );
            				}
            				else {
...
HXLINE( 420)				this->primarySurface = ::lime::graphics::cairo::_CairoImageSurface::CairoImageSurface_Impl__obj::create(( (Float)(lock->__Field(HX_("pixels",2d,ef,a9,8c),hx::paccDynamic)) ),(int)0,( (int)(lock->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)) ),( (int)(lock->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)) ),( (int)(lock->__Field(HX_("pitch",c0,bb,a0,c2),hx::paccDynamic)) ));
...
HXLINE( 471)				::lime::_internal::backend::native::NativeCFFI_obj::lime_window_set_cursor(hx::DynamicPtr(this->handle),(int)0);
            			}
            			else {
HXLINE( 476)				int type;
HXDLIN( 476)				switch((int)(_hx_getEnumValueIndex(value))){
            					case (int)0: {
HXLINE( 476)						type = (int)1;
            					}
            					break;
            					case (int)1: {
HXLINE( 476)						type = (int)2;
            					}
            					break;
            					case (int)3: {
HXLINE( 476)						type = (int)4;
            					}
            					break;
            					case (int)4: {
HXLINE( 476)						type = (int)5;
            					}
            					break;
            					case (int)5: {
HXLINE( 476)						type = (int)6;
            					}
            					break;
            					case (int)6: {
HXLINE( 476)						type = (int)7;
            					}
            					break;
            					case (int)7: {
HXLINE( 476)						type = (int)8;
            					}
            					break;
            					case (int)8: {
HXLINE( 476)						type = (int)9;
            					}
            					break;
            					case (int)9: {
HXLINE( 476)						type = (int)10;
            					}
            					break;
            					case (int)10: {
HXLINE( 476)						type = (int)11;
            					}
            					break;
            					case (int)11: {
HXLINE( 476)						type = (int)12;
            					}
            					break;
            					default:{
HXLINE( 476)						type = (int)3;
            					}
            				}
