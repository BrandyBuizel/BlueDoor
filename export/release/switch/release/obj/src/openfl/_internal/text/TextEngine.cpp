...
static const ::String _hx_array_data_a0887a60_139[] = {
	HX_("Noto Sans Regular",13,a4,57,e5),
};
static const ::String _hx_array_data_a0887a60_140[] = {
	HX_("Noto Mono",c7,ee,d0,eb),
};
static const ::String _hx_array_data_a0887a60_141[] = {
	HX_("Noto Serif Regular",75,9b,9f,e4),
};
...
HXDLIN( 193)		if (hx::IsNotNull( name )) {
HXLINE( 193)			_hx_tmp1 = (name.indexOf(HX_(":/",b5,32,00,00),null()) == (int)-1);
            		}
            		else {
HXLINE( 193)			_hx_tmp1 = false;
            		}
HXDLIN( 193)		if (_hx_tmp1) {
HXLINE( 193)			name = null();
            		}
...
HXDLIN( 371)				::String _hx_switch_0 = _g;
            				if (  (_hx_switch_0==HX_("_sans",32,a0,5e,ff)) ){
HXLINE( 413)					fontList = ::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_139,1);
...
HXLINE( 416)					goto _hx_goto_135;
            				...
            				if (  (_hx_switch_0==HX_("_typewriter",0c,5e,52,94)) ){
HXLINE( 460)					fontList = ::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_140,1);
HXDLIN( 460)					goto _hx_goto_135;
            				}
            				/* default */{
...
HXLINE( 526)		fontList = ::Array_obj< ::String >::fromData( _hx_array_data_a0887a60_141,1);
HXLINE( 529)		{
