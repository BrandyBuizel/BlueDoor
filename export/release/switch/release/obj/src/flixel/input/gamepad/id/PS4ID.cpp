...
HXDLIN(  87)		SHARE = (int)10;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_ad6715070e6121e4_89_boot)
HXDLIN(  89)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  95)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN( 102)		TOUCHPAD_CLICK = (int)30;
            	}
{
