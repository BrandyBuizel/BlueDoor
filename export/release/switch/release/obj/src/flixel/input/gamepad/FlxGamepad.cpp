...
HXDLIN( 127)			while((_g1 < (int)6)){
HXLINE( 127)				_g1 = (_g1 + (int)1);
HXDLIN( 127)				int i = (_g1 - (int)1);
HXDLIN( 127)				_g->push((int)0);
            			}
            		}
...
HXLINE( 145)		this->pressed =  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,(int)1,hx::ObjectPtr<OBJ_>(this));
HXLINE( 146)		this->released =  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,(int)0,hx::ObjectPtr<OBJ_>(this));
HXLINE( 147)		this->justPressed =  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,(int)2,hx::ObjectPtr<OBJ_>(this));
HXLINE( 148)		this->justReleased =  ::flixel::input::gamepad::lists::FlxGamepadButtonList_obj::__alloc( HX_CTX ,(int)-1,hx::ObjectPtr<OBJ_>(this));
...
HXLINE( 191)			axisValue = (axisValue * (int)-1);
            		}
...
HXDLIN( 207)			int _g = this->_device->get_numControls();
...
HXLINE( 255)		{
HXLINE( 255)			int _g2 = (int)0;
HXDLIN( 255)			::Array< ::Dynamic> _g11 = this->buttons;
HXDLIN( 255)			while((_g2 < _g11->length)){
HXLINE( 255)				 ::flixel::input::gamepad::FlxGamepadButton button1 = _g11->__get(_g2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 255)				_g2 = (_g2 + (int)1);
...
HXLINE( 276)		{
HXLINE( 276)			int _g11 = (int)0;
HXDLIN( 276)			int _g2 = numAxis;
HXDLIN( 276)			while((_g11 < _g2)){
HXLINE( 276)				_g11 = (_g11 + (int)1);
HXDLIN( 276)				int i = (_g11 - (int)1);
HXLINE( 278)				this->axis[i] = (int)0;
            			}
            		}
            	}
...
HXDLIN( 388)		return this->checkButtonArrayState(IDArray,(int)1);
            	}
...
HXDLIN( 399)		return this->checkButtonArrayStateRaw(RawIDArray,(int)1);
            	}
...
HXDLIN( 410)		return this->checkButtonArrayState(IDArray,(int)2);
            	}
...
HXDLIN( 421)		return this->checkButtonArrayStateRaw(RawIDArray,(int)2);
            	}
...
HXDLIN( 432)		return this->checkButtonArrayState(IDArray,(int)-1);
            	}
...
HXDLIN( 443)		return this->checkButtonArrayStateRaw(RawIDArray,(int)-1);
            	}
...
HXDLIN( 461)				_g = (_g + (int)1);
HXLINE( 463)				bool _hx_tmp;
HXDLIN( 463)				if (hx::IsNotNull( button )) {
HXLINE( 463)					if ((button->current != (int)0)) {
HXLINE( 463)						_hx_tmp = (button->current == (int)-1);
            					}
            					else {
...
HXLINE( 488)					_hx_tmp = (button->current == (int)2);
            				}
            				else {
...
HXDLIN( 511)				_g = (_g + (int)1);
HXLINE( 513)				bool _hx_tmp;
HXDLIN( 513)				if (hx::IsNotNull( button )) {
HXLINE( 513)					_hx_tmp = (button->current == (int)-1);
            				}
            				else {
...
HXLINE( 578)				_hx_tmp1 = (AxisIndex == rightStick->y);
            			}
            			else {
...
HXLINE( 667)		{
HXLINE( 667)			int _g1 = (int)0;
HXDLIN( 667)			int _g = numAxis;
HXDLIN( 667)			while((_g1 < _g)){
HXLINE( 667)				_g1 = (_g1 + (int)1);
HXDLIN( 667)				int i = (_g1 - (int)1);
HXLINE( 669)				if ((this->axis->__get((int)0) != (int)0)) {
...
HXLINE( 692)		Float axisValue = (int)0;
HXLINE( 695)		if ((AxisID == (int)-1)) {
...
HXLINE( 699)			 ::Dynamic Max = (this->_device->get_numControls() - (int)1);
HXDLIN( 699)			if ((AxisID >= (int)0)) {
...
HXLINE( 714)				axisValue1 = (axisValue1 * (int)-1);
            			}
...
HXLINE( 748)		Float length = (vector->x * vector->x);
HXDLIN( 748)		Float length1 = ::Math_obj::sqrt((length + (vector->y * vector->y)));
HXLINE( 749)		vector->put();
HXLINE( 751)		if ((length1 > this->get_deadZone())) {
...
HXLINE( 772)			bool stick3;
HXDLIN( 772)			bool stick4;
HXDLIN( 772)			if (hx::IsNotNull( rightStick )) {
HXLINE( 772)				stick4 = (axis == rightStick->x);
            			}
            			else {
HXLINE( 772)				stick4 = false;
            			}
HXDLIN( 772)			if (!(stick4)) {
HXLINE( 772)				stick3 = (axis == rightStick->y);
            			}
            			else {
HXLINE( 772)				stick3 = true;
            			}
HXDLIN( 772)			if (stick3) {
...
HXDLIN( 773)		if (hx::IsNotEq( stick->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 773)			_hx_tmp = hx::IsEq( stick->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
HXLINE( 773)			_hx_tmp = true;
            		}
HXDLIN( 773)		if (_hx_tmp) {
HXLINE( 775)			this->handleAxisMoveSub(stick,axis,newValue,oldValue,((Float)1.0));
HXLINE( 776)			this->handleAxisMoveSub(stick,axis,newValue,oldValue,((Float)-1.0));
HXLINE( 778)			bool _hx_tmp1 = hx::IsEq( stick->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
...
HXLINE( 787)		int digitalButton = (int)-1;
HXLINE( 789)		if ((axis == stick->x)) {
HXLINE( 791)			if ((sign < (int)0)) {
...
HXLINE( 808)				_hx_tmp1 = (oldValueSign > threshold);
            			}
            			else {
HXLINE( 808)				_hx_tmp1 = false;
            			}
HXDLIN( 808)			if (_hx_tmp1) {
HXLINE( 810)				 ::flixel::input::gamepad::FlxGamepadButton btn1 = this->getButton(digitalButton);
HXLINE( 811)				if (hx::IsNotNull( btn1 )) {
HXLINE( 812)					btn1->release();
            				}
            			}
            		}
            	}
...
HXDLIN( 818)		switch((int)(_hx_getEnumValueIndex(model))){
            			case (int)0: {
...
HXDLIN( 862)			return this->manager->globalDeadZone;
            		}
...
HXDLIN( 881)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 882)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXLINE( 880)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(3)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_this2));
            	}
...
static ::String FlxGamepad_obj_sMemberFields[] = {
	...
	HX_HCSTRING("checkButtonArrayState","\x32","\x1b","\x8c","\x3e"),
	HX_HCSTRING("checkButtonArrayStateRaw","\xd6","\xfd","\x01","\x5b"),
