...
HXLINE(1092)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE(1092)			_hx_tmp = BorderColor;
            		}
...
static hx::StorageInfo FlxTextFormat_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::text::TextFormat*/ ,(int)offsetof(FlxTextFormat_obj,format),HX_HCSTRING("format","\x37","\x8f","\x8e","\xfd")},
	{ hx::fsUnknown, 0, null()}
};
