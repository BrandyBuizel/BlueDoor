...
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::IMG_read_format)(__this) )->UNSIGNED_SHORT_4_4_4_4_REV_IMG = (int)33637;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::IMG_read_format)(__this) )->BGRA_IMG = (int)32993;
            	}
