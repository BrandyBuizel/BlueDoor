...
HXLINE(  33)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR = (int)37853;
HXLINE(  32)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR = (int)37852;
HXLINE(  31)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR = (int)37851;
HXLINE(  30)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR = (int)37850;
HXLINE(  29)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR = (int)37849;
HXLINE(  28)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR = (int)37848;
HXLINE(  27)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR = (int)37847;
HXLINE(  26)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR = (int)37846;
HXLINE(  25)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR = (int)37845;
HXLINE(  24)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR = (int)37844;
HXLINE(  23)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR = (int)37843;
HXLINE(  22)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR = (int)37842;
HXLINE(  21)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR = (int)37841;
HXLINE(  20)		this->COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR = (int)37840;
HXLINE(  19)		this->COMPRESSED_RGBA_ASTC_12x12_KHR = (int)37821;
HXLINE(  18)		this->COMPRESSED_RGBA_ASTC_12x10_KHR = (int)37820;
HXLINE(  17)		this->COMPRESSED_RGBA_ASTC_10x10_KHR = (int)37819;
HXLINE(  16)		this->COMPRESSED_RGBA_ASTC_10x8_KHR = (int)37818;
HXLINE(  15)		this->COMPRESSED_RGBA_ASTC_10x6_KHR = (int)37817;
HXLINE(  14)		this->COMPRESSED_RGBA_ASTC_10x5_KHR = (int)37816;
HXLINE(  13)		this->COMPRESSED_RGBA_ASTC_8x8_KHR = (int)37815;
HXLINE(  12)		this->COMPRESSED_RGBA_ASTC_8x6_KHR = (int)37814;
HXLINE(  11)		this->COMPRESSED_RGBA_ASTC_8x5_KHR = (int)37813;
HXLINE(  10)		this->COMPRESSED_RGBA_ASTC_6x6_KHR = (int)37812;
HXLINE(   9)		this->COMPRESSED_RGBA_ASTC_6x5_KHR = (int)37811;
HXLINE(   8)		this->COMPRESSED_RGBA_ASTC_5x5_KHR = (int)37810;
HXLINE(   7)		this->COMPRESSED_RGBA_ASTC_5x4_KHR = (int)37809;
HXLINE(   6)		this->COMPRESSED_RGBA_ASTC_4x4_KHR = (int)37808;
            	}
