...
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1245_requestSoftKeyboard,"openfl.display.InteractiveObject","requestSoftKeyboard",0x985d3a49,"openfl.display.InteractiveObject.requestSoftKeyboard","openfl/display/InteractiveObject.hx",1245,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1253___allowMouseFocus,"openfl.display.InteractiveObject","__allowMouseFocus",0x4a3f2aa5,"openfl.display.InteractiveObject.__allowMouseFocus","openfl/display/InteractiveObject.hx",1253,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1257___getInteractive,"openfl.display.InteractiveObject","__getInteractive",0xf3ec43c3,"openfl.display.InteractiveObject.__getInteractive","openfl/display/InteractiveObject.hx",1257,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1273___hitTest,"openfl.display.InteractiveObject","__hitTest",0x5938388e,"openfl.display.InteractiveObject.__hitTest","openfl/display/InteractiveObject.hx",1273,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1280___tabTest,"openfl.display.InteractiveObject","__tabTest",0xbc287590,"openfl.display.InteractiveObject.__tabTest","openfl/display/InteractiveObject.hx",1280,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1289_get_tabEnabled,"openfl.display.InteractiveObject","get_tabEnabled",0x09837aec,"openfl.display.InteractiveObject.get_tabEnabled","openfl/display/InteractiveObject.hx",1289,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1293_set_tabEnabled,"openfl.display.InteractiveObject","set_tabEnabled",0x29a36360,"openfl.display.InteractiveObject.set_tabEnabled","openfl/display/InteractiveObject.hx",1293,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1306_get_tabIndex,"openfl.display.InteractiveObject","get_tabIndex",0x2bde10bd,"openfl.display.InteractiveObject.get_tabIndex","openfl/display/InteractiveObject.hx",1306,0x983a3689)
HX_LOCAL_STACK_FRAME(_hx_pos_762cd2e6f13bb015_1310_set_tabIndex,"openfl.display.InteractiveObject","set_tabIndex",0x40d73431,"openfl.display.InteractiveObject.set_tabIndex","openfl/display/InteractiveObject.hx",1310,0x983a3689)
namespace openfl{
namespace display{
...
HXLINE(1224)		this->_hx___tabIndex = (int)-1;
            	}
...
bool InteractiveObject_obj::requestSoftKeyboard(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1245_requestSoftKeyboard)
HXLINE(1246)		::openfl::_internal::Lib_obj::notImplemented(hx::SourceInfo(HX_("InteractiveObject.hx",3d,87,79,89),1246,HX_("openfl.display.InteractiveObject",97,3a,cb,f4),HX_("requestSoftKeyboard",a0,f5,a9,d4)));
...
bool InteractiveObject_obj::_hx___allowMouseFocus(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1253___allowMouseFocus)
HXDLIN(1253)		return this->get_tabEnabled();
            	}
...
bool InteractiveObject_obj::_hx___getInteractive(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1257___getInteractive)
HXLINE(1258)		if (hx::IsNotNull( stack )) {
HXLINE(1260)			stack->push(hx::ObjectPtr<OBJ_>(this));
HXLINE(1262)			if (hx::IsNotNull( this->parent )) {
HXLINE(1264)				this->parent->_hx___getInteractive(stack);
            			}
            		}
...
bool InteractiveObject_obj::_hx___hitTest(Float x,Float y,bool shapeFlag,::Array< ::Dynamic> stack,bool interactiveOnly, ::openfl::display::DisplayObject hitObject){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1273___hitTest)
HXLINE(1274)		bool _hx_tmp;
HXDLIN(1274)		bool _hx_tmp1;
HXDLIN(1274)		if (!(!(hitObject->get_visible()))) {
HXLINE(1274)			_hx_tmp1 = this->_hx___isMask;
            		}
            		else {
HXLINE(1274)			_hx_tmp1 = true;
            		}
HXDLIN(1274)		if (!(_hx_tmp1)) {
HXLINE(1274)			if (interactiveOnly) {
HXLINE(1274)				_hx_tmp = !(this->mouseEnabled);
            			}
            			else {
...
HXLINE(1274)			_hx_tmp = true;
            		}
HXDLIN(1274)		if (_hx_tmp) {
HXLINE(1274)			return false;
            		}
HXLINE(1275)		return this->super::_hx___hitTest(x,y,shapeFlag,stack,interactiveOnly,hitObject);
            	}


void InteractiveObject_obj::_hx___tabTest(::Array< ::Dynamic> stack){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1280___tabTest)
HXDLIN(1280)		if (this->get_tabEnabled()) {
...
bool InteractiveObject_obj::get_tabEnabled(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1289_get_tabEnabled)
HXDLIN(1289)		if (hx::IsEq( this->_hx___tabEnabled,true )) {
HXDLIN(1289)			return true;
            		}
            		else {
HXDLIN(1289)			return false;
            		}
HXDLIN(1289)		return false;
            	}
...
bool InteractiveObject_obj::set_tabEnabled(bool value){
            	HX_GC_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1293_set_tabEnabled)
HXLINE(1294)		if (hx::IsNotEq( this->_hx___tabEnabled,value )) {
HXLINE(1296)			this->_hx___tabEnabled = value;
HXLINE(1298)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("tabEnabledChange",3c,45,98,72),true,false));
            		}
HXLINE(1301)		return this->_hx___tabEnabled;
            	}
...
int InteractiveObject_obj::get_tabIndex(){
            	HX_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1306_get_tabIndex)
HXDLIN(1306)		return this->_hx___tabIndex;
            	}
...
int InteractiveObject_obj::set_tabIndex(int value){
            	HX_GC_STACKFRAME(&_hx_pos_762cd2e6f13bb015_1310_set_tabIndex)
HXLINE(1311)		if ((this->_hx___tabIndex != value)) {
HXLINE(1313)			if ((value < (int)-1)) {
HXLINE(1313)				HX_STACK_DO_THROW( ::openfl::errors::RangeError_obj::__alloc( HX_CTX ,(HX_("Parameter tabIndex must be a non-negative number; got ",9c,f8,24,a4) + value)));
            			}
HXLINE(1315)			this->_hx___tabIndex = value;
HXLINE(1317)			this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("tabIndexChange",cd,1d,78,90),true,false));
            		}
HXLINE(1320)		return this->_hx___tabIndex;
            	}
