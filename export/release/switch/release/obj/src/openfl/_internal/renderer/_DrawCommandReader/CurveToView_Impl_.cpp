...
HXDLIN( 537)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 537)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 544)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 544)		return this2->__get((this1->fPos + (int)2));
            	}
...
HXDLIN( 551)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 551)		return this2->__get((this1->fPos + (int)3));
            	}
