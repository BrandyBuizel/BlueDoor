...
HXDLIN( 797)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 797)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
HXDLIN( 811)		::Array< bool > this2 = this1->buffer->b;
HXDLIN( 811)		return this2->__get((this1->bPos + (int)1));
            	}
