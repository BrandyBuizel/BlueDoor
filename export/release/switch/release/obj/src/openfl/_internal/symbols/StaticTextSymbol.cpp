...
HXLINE(  46)			int color = (int)16777215;
...
HXLINE(  54)						font = ( ( ::openfl::_internal::symbols::FontSymbol)(swf->symbols->get(record->fontID).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >()) );
            					}
HXLINE(  55)					if (hx::IsNotNull( record->offsetX )) {
HXLINE(  55)						Float offsetX1 = this->matrix->tx;
HXDLIN(  55)						offsetX = (offsetX1 + (record->offsetX * ((Float)0.05)));
            					}
HXLINE(  56)					if (hx::IsNotNull( record->offsetY )) {
HXLINE(  56)						Float offsetY1 = this->matrix->ty;
HXDLIN(  56)						offsetY = (offsetY1 + (record->offsetY * ((Float)0.05)));
            					}
HXLINE(  57)					if (hx::IsNotNull( record->color )) {
HXLINE(  57)						color = record->color;
            					}
HXLINE(  59)					if (hx::IsNotNull( font )) {
HXLINE(  61)						scale = (((Float)record->fontHeight / (Float)(int)1024) * ((Float)0.05));
HXLINE(  63)						{
HXLINE(  63)							int _g3 = (int)0;
HXDLIN(  63)							int _g2 = record->glyphs->length;
HXDLIN(  63)							while((_g3 < _g2)){
HXLINE(  63)								_g3 = (_g3 + (int)1);
HXDLIN(  63)								int i = (_g3 - (int)1);
HXLINE(  65)								index = record->glyphs->__get(i);
HXLINE(  66)								text = (text + ::String::fromCharCode(font->codes->__get(index)));
HXLINE(  68)								{
HXLINE(  68)									int _g4 = (int)0;
HXDLIN(  68)									::Array< ::Dynamic> _g5 = font->glyphs->__get(index).StaticCast< ::Array< ::Dynamic> >();
HXDLIN(  68)									while((_g4 < _g5->length)){
HXLINE(  68)										 ::openfl::_internal::formats::swf::ShapeCommand command = _g5->__get(_g4).StaticCast<  ::openfl::_internal::formats::swf::ShapeCommand >();
HXDLIN(  68)										_g4 = (_g4 + (int)1);
HXLINE(  70)										switch((int)(_hx_getEnumValueIndex(command))){
            											case (int)1: {
HXLINE(  72)												Float alpha = command->_hx_getFloat(1);
HXLINE(  73)												graphics->beginFill(((int)color & (int)(int)16777215),((Float)((int)((int)color >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
            											}
            											break;
            											case (int)3: {
