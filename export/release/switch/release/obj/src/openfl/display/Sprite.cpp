...
HXDLIN( 248)					Float px = (_this1 * (_this->ty - point->y));
HXDLIN( 248)					Float _this2 = _this->d;
HXDLIN( 248)					Float px1 = (((Float)((Float)1.0) / (Float)norm1) * (px + (_this2 * (point->x - _this->tx))));
HXDLIN( 248)					Float _this3 = _this->a;
HXDLIN( 248)					Float _hx_tmp4 = (_this3 * (point->y - _this->ty));
HXDLIN( 248)					Float _this4 = _this->b;
HXDLIN( 248)					point->y = (((Float)((Float)1.0) / (Float)norm1) * (_hx_tmp4 + (_this4 * (_this->tx - point->x))));
HXDLIN( 248)					point->x = px1;
            				}
            			}
...
HXLINE( 263)				_hx_tmp6 = hx::IsNotNull( this->_hx___graphics );
            			}
            			else {
HXLINE( 263)				_hx_tmp6 = false;
            			}
HXDLIN( 263)			if (_hx_tmp6) {
HXLINE( 263)				 ::openfl::display::Graphics _hx_tmp7 = this->_hx___graphics;
HXDLIN( 263)				_hx_tmp5 = _hx_tmp7->_hx___hitTest(x,y,shapeFlag,this->_hx___getRenderTransform());
            			}
            			else {
...
HXLINE( 265)						_hx_tmp8 = this->mouseEnabled;
            					}
            					else {
...
HXDLIN( 326)			return this->_hx___tabEnabled;
            		}
