...
HXLINE( 227)		this->_hx___offsetX = (int)0;
HXLINE( 228)		this->_hx___offsetY = (int)0;
...
HXLINE( 259)		int r = ((int)((int)this->_hx___color >> (int)(int)16) & (int)(int)255);
HXLINE( 260)		int g = ((int)((int)this->_hx___color >> (int)(int)8) & (int)(int)255);
HXLINE( 261)		int b = ((int)this->_hx___color & (int)(int)255);
HXLINE( 263)		Float point = (destPoint->x + this->_hx___offsetX);
HXDLIN( 263)		 ::openfl::geom::Point point1 =  ::openfl::geom::Point_obj::__alloc( HX_CTX ,point,(destPoint->y + this->_hx___offsetY));
...
HXDLIN( 265)		 ::lime::math::Vector2 finalImage1 = point1->_hx___toLimeVector2();
...
HXDLIN( 267)		finalImage2->colorTransform(_hx_tmp, ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,this->_hx___alpha,r,g,b,(int)0)->_hx___toLimeColorMatrix());
...
HXLINE( 276)		Float _hx_tmp = this->_hx___distance;
HXDLIN( 276)		this->_hx___offsetX = ::Std_obj::_hx_int((_hx_tmp * ::Math_obj::cos(((Float)(this->_hx___angle * ::Math_obj::PI) / (Float)(int)180))));
HXLINE( 277)		Float _hx_tmp1 = this->_hx___distance;
HXDLIN( 277)		this->_hx___offsetY = ::Std_obj::_hx_int((_hx_tmp1 * ::Math_obj::sin(((Float)(this->_hx___angle * ::Math_obj::PI) / (Float)(int)180))));
HXLINE( 278)		Float _hx_tmp2;
HXDLIN( 278)		if ((this->_hx___offsetY < (int)0)) {
HXLINE( 278)			_hx_tmp2 = -(this->_hx___offsetY);
            		}
            		else {
HXLINE( 278)			_hx_tmp2 = (int)0;
            		}
HXDLIN( 278)		this->_hx___topExtension = ::Math_obj::ceil((_hx_tmp2 + this->_hx___blurY));
HXLINE( 279)		Float _hx_tmp3;
HXDLIN( 279)		if ((this->_hx___offsetY > (int)0)) {
HXLINE( 279)			_hx_tmp3 = this->_hx___offsetY;
            		}
            		else {
HXLINE( 279)			_hx_tmp3 = (int)0;
            		}
HXDLIN( 279)		this->_hx___bottomExtension = ::Math_obj::ceil((_hx_tmp3 + this->_hx___blurY));
HXLINE( 280)		Float _hx_tmp4;
HXDLIN( 280)		if ((this->_hx___offsetX < (int)0)) {
HXLINE( 280)			_hx_tmp4 = -(this->_hx___offsetX);
            		}
            		else {
HXLINE( 280)			_hx_tmp4 = (int)0;
            		}
HXDLIN( 280)		this->_hx___leftExtension = ::Math_obj::ceil((_hx_tmp4 + this->_hx___blurX));
HXLINE( 281)		Float _hx_tmp5;
HXDLIN( 281)		if ((this->_hx___offsetX > (int)0)) {
HXLINE( 281)			_hx_tmp5 = this->_hx___offsetX;
            		}
            		else {
HXLINE( 281)			_hx_tmp5 = (int)0;
            		}
HXDLIN( 281)		this->_hx___rightExtension = ::Math_obj::ceil((_hx_tmp5 + this->_hx___blurX));
            	}
