...
HXLINE(  86)		this->_hx___graphicsDataType = (int)7;
            	}
...
static hx::StorageInfo GraphicsTrianglePath_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsTrianglePath_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{ hx::fsUnknown, 0, null()}
};
