...
HXDLIN( 124)		if (!((rect->width <= (int)0))) {
HXDLIN( 124)			_hx_tmp = (rect->height <= (int)0);
            		}
            		else {
...
HXDLIN( 176)		_hx_tmp1->width = (_hx_tmp1->width + (dx * (int)2));
...
HXDLIN( 178)		_hx_tmp3->height = (_hx_tmp3->height + (dy * (int)2));
            	}
...
HXDLIN( 256)		if (!((this->width <= (int)0))) {
HXDLIN( 256)			return (this->height <= (int)0);
            		}
            		else {
...
HXDLIN( 285)		this->x = (this->y = (this->width = (this->height = (int)0)));
            	}
...
HXDLIN( 314)		if ((this->width != (int)0)) {
HXLINE( 314)			_hx_tmp = (this->height == (int)0);
            		}
            		else {
...
HXDLIN( 318)			if ((toUnion->width != (int)0)) {
HXLINE( 318)				_hx_tmp1 = (toUnion->height == (int)0);
            			}
            			else {
...
HXDLIN( 358)		return  ::lime::math::Vector2_obj::__alloc( HX_CTX ,_hx_tmp,(this->y + this->height));
            	}
