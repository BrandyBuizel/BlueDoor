...
void AudioContext_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("html5","\x6a","\x28","\xac","\x2e"));
	outFields->push(HX_HCSTRING("openal","\x35","\x5f","\x94","\x21"));
	outFields->push(HX_HCSTRING("type","\xba","\xf2","\x08","\x4d"));
	outFields->push(HX_HCSTRING("web","\x94","\xa4","\x5a","\x00"));
	super::__GetFields(outFields);
};

#if HXCPP_SCRIPTABLE
static hx::StorageInfo AudioContext_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(AudioContext_obj,custom),HX_HCSTRING("custom","\xb1","\x87","\x92","\x3f")},
	{hx::fsObject /*::lime::media::FlashAudioContext*/ ,(int)offsetof(AudioContext_obj,flash),HX_HCSTRING("flash","\xb0","\x35","\x8c","\x02")},
	{hx::fsObject /*::lime::media::HTML5AudioContext*/ ,(int)offsetof(AudioContext_obj,html5),HX_HCSTRING("html5","\x6a","\x28","\xac","\x2e")},
	{hx::fsObject /*::lime::media::OpenALAudioContext*/ ,(int)offsetof(AudioContext_obj,openal),HX_HCSTRING("openal","\x35","\x5f","\x94","\x21")},
	{hx::fsString,(int)offsetof(AudioContext_obj,type),HX_HCSTRING("type","\xba","\xf2","\x08","\x4d")},
	{hx::fsObject /*::lime::media::WebAudioContext*/ ,(int)offsetof(AudioContext_obj,web),HX_HCSTRING("web","\x94","\xa4","\x5a","\x00")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String AudioContext_obj_sMemberFields[] = {
	...
	HX_HCSTRING("html5","\x6a","\x28","\xac","\x2e"),
	HX_HCSTRING("openal","\x35","\x5f","\x94","\x21"),
	HX_HCSTRING("type","\xba","\xf2","\x08","\x4d"),
	HX_HCSTRING("web","\x94","\xa4","\x5a","\x00"),
	::String(null()) };

static void AudioContext_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(AudioContext_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void AudioContext_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new AudioContext_obj;
	AudioContext_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.media.AudioContext","\x5c","\xaf","\x9d","\x2f");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = AudioContext_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = AudioContext_obj_sVisitStatics;
#endif
