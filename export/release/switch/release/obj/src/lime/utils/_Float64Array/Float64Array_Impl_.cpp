...
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_120_subarray,"lime.utils._Float64Array.Float64Array_Impl_","subarray",0x21ecbb22,"lime.utils._Float64Array.Float64Array_Impl_.subarray","lime/utils/Float64Array.hx",120,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_125_fromBytes,"lime.utils._Float64Array.Float64Array_Impl_","fromBytes",0x75afb378,"lime.utils._Float64Array.Float64Array_Impl_.fromBytes","lime/utils/Float64Array.hx",125,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_130_toBytes,"lime.utils._Float64Array.Float64Array_Impl_","toBytes",0xdbbc6207,"lime.utils._Float64Array.Float64Array_Impl_.toBytes","lime/utils/Float64Array.hx",130,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_135_get_length,"lime.utils._Float64Array.Float64Array_Impl_","get_length",0xa8e8fff8,"lime.utils._Float64Array.Float64Array_Impl_.get_length","lime/utils/Float64Array.hx",135,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_153_toString,"lime.utils._Float64Array.Float64Array_Impl_","toString",0x52da37b5,"lime.utils._Float64Array.Float64Array_Impl_.toString","lime/utils/Float64Array.hx",153,0x73d83bc7)
HX_LOCAL_STACK_FRAME(_hx_pos_8b7b048dadc59c63_84_boot,"lime.utils._Float64Array.Float64Array_Impl_","boot",0x289272bb,"lime.utils._Float64Array.Float64Array_Impl_.boot","lime/utils/Float64Array.hx",84,0x73d83bc7)
namespace lime{
namespace utils{
...
bool Float64Array_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x28fea341;
}
...
int Float64Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView Float64Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_8b7b048dadc59c63_120_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_8b7b048dadc59c63_125_fromBytes)
HXDLIN( 125)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 125)		if (hx::IsNotNull( bytes )) {
HXDLIN( 125)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)9);
...
HXDLIN( 125)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float64Array",8f,de,6b,1e));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(Float64Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes Float64Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_130_toBytes)
...
int Float64Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_135_get_length)
...
::String Float64Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_153_toString)
HXDLIN( 153)		if (hx::IsNotNull( this1 )) {
HXDLIN( 153)			return ((((HX_("Float64Array [byteLength:",32,73,38,ac) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
	hx::Object *dummy = new Float64Array_Impl__obj;
	Float64Array_Impl__obj::_hx_vtable = *(void **)dummy;
...
{
{
            	HX_STACKFRAME(&_hx_pos_8b7b048dadc59c63_84_boot)
HXDLIN(  84)		BYTES_PER_ELEMENT = (int)8;
            	}
}
