...
HXLINE( 131)		this->_shadow =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)2,true,(int)-16777216),null(),null());
HXLINE( 132)		this->_background =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)1,(int)1,true,(int)-12961222),null(),null());
HXLINE( 134)		this->textField = ::flixel::_hx_system::debug::DebuggerUtil_obj::createTextField((int)2,(int)1,null(),null());
...
HXLINE( 179)		this->maxSize->x = ::Std_obj::_hx_int(::Math_obj::abs(Width));
HXLINE( 180)		this->maxSize->y = ::Std_obj::_hx_int(::Math_obj::abs(Height));
...
HXDLIN( 237)		if ((this->maxSize->x <= (int)0)) {
HXLINE( 237)			_hx_tmp = this->textField->get_textWidth();
            		}
            		else {
HXLINE( 237)			_hx_tmp = ::Math_obj::abs(this->maxSize->x);
            		}
HXDLIN( 237)		this->_width = (::Std_obj::_hx_int(_hx_tmp) + (int)8);
HXLINE( 238)		Float _hx_tmp1;
HXDLIN( 238)		if ((this->maxSize->y <= (int)0)) {
HXLINE( 238)			_hx_tmp1 = this->textField->get_textHeight();
            		}
            		else {
HXLINE( 238)			_hx_tmp1 = ::Math_obj::abs(this->maxSize->y);
            		}
HXDLIN( 238)		this->_height = (::Std_obj::_hx_int(_hx_tmp1) + (int)8);
HXLINE( 239)		this->_background->set_scaleX(this->_width);
HXLINE( 240)		this->_background->set_scaleY(this->_height);
HXLINE( 241)		this->_shadow->set_scaleX(this->_width);
HXLINE( 242)		this->_shadow->set_y(this->_height);
HXLINE( 243)		this->textField->set_width(this->_width);
            	}
...
HXDLIN( 250)		if ((this->get_x() < (int)0)) {
HXLINE( 250)			_hx_tmp = (int)0;
            		}
            		else {
...
HXDLIN( 251)		if ((this->get_y() < (int)0)) {
HXLINE( 251)			_hx_tmp1 = (int)0;
            		}
            		else {
...
HXDLIN( 255)			offsetX = (offsetX3 - (offsetX4 + this->get_width()));
            		}
            		else {
HXLINE( 255)			offsetX = (int)0;
            		}
...
HXDLIN( 256)			offsetY = (offsetY3 - (offsetY4 + this->get_height()));
            		}
            		else {
HXLINE( 256)			offsetY = (int)0;
            		}
HXLINE( 258)		{
...
HXLINE( 266)			this->set_x((event->stageX + (int)10));
