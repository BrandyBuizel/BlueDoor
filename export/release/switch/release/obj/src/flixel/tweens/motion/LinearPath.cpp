...
HXLINE( 177)			::Array< Float > _hx_tmp = this->_pointT;
HXDLIN( 177)			int i1 = i;
HXDLIN( 177)			::Array< Float > _hx_tmp1 = this->_pointD;
HXDLIN( 177)			i = (i + (int)1);
HXDLIN( 177)			_hx_tmp[i1] = ((Float)_hx_tmp1->__get((i - (int)1)) / (Float)this->distance);
            		}
            	}
