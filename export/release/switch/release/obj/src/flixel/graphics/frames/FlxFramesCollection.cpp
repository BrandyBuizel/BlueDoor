...
HXDLIN(  73)		return this->framesHash->get(name).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            	}
...
HXDLIN(  95)			int _g = this->frames->length;
...
HXLINE( 134)		frame->type = (int)2;
HXLINE( 135)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 135)		_this->x = (int)0;
HXDLIN( 135)		_this->y = (int)0;
HXDLIN( 135)		_this->width = (int)0;
HXDLIN( 135)		_this->height = (int)0;
...
HXLINE( 152)		frame->offset->set((int)0,(int)0);
...
HXLINE( 222)			return this->framesHash->get(name).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            		}
...
HXDLIN( 241)		HX_STACK_DO_THROW(HX_("To be overriden in subclasses",8b,78,89,60));
...
HXDLIN( 247)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 247)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
