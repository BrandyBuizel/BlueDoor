...
HXLINE( 467)			 ::Dynamic f = this->_hx___onWindowClose_dyn();
HXDLIN( 467)			 ::lime::ui::Window a1 = window;
HXDLIN( 467)			 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN( 467)			window->onClose->add(_hx_tmp,false,(int)-10000);
...
HXLINE( 516)		application->onExit->add(this->onModuleExit_dyn(),false,(int)0);
HXLINE( 517)		application->onExit->add(this->_hx___onModuleExit_dyn(),false,(int)0);
HXLINE( 519)		{
...
HXLINE( 552)			if ((this->_hx___windows->length == (int)0)) {
HXLINE( 555)				::lime::_hx_system::System_obj::exit((int)0);
            			}
            		}
            	}
...
HXLINE( 565)		 ::Dynamic f = this->onGamepadAxisMove_dyn();
HXDLIN( 565)		 ::lime::ui::Gamepad a1 = gamepad;
HXDLIN( 565)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN( 565)		gamepad->onAxisMove->add(_hx_tmp,null(),null());
HXLINE( 566)		 ::Dynamic f1 = this->onGamepadButtonDown_dyn();
HXDLIN( 566)		 ::lime::ui::Gamepad a11 = gamepad;
HXDLIN( 566)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN( 566)		gamepad->onButtonDown->add(_hx_tmp1,null(),null());
HXLINE( 567)		 ::Dynamic f2 = this->onGamepadButtonUp_dyn();
HXDLIN( 567)		 ::lime::ui::Gamepad a12 = gamepad;
HXDLIN( 567)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN( 567)		gamepad->onButtonUp->add(_hx_tmp2,null(),null());
HXLINE( 568)		 ::Dynamic f3 = this->onGamepadDisconnect_dyn();
HXDLIN( 568)		 ::lime::ui::Gamepad a13 = gamepad;
HXDLIN( 568)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(a13,f3));
...
HXLINE( 580)			f5(a15,a24,x,y);
            		}
            		HX_END_LOCAL_FUNC3((void))

            	HX_STACKFRAME(&_hx_pos_da4fb7bee4c62773_572___onJoystickConnect)
HXLINE( 573)		this->onJoystickConnect(joystick);
HXLINE( 575)		 ::Dynamic f = this->onJoystickAxisMove_dyn();
HXDLIN( 575)		 ::lime::ui::Joystick a1 = joystick;
HXDLIN( 575)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
HXDLIN( 575)		joystick->onAxisMove->add(_hx_tmp,null(),null());
HXLINE( 576)		 ::Dynamic f1 = this->onJoystickButtonDown_dyn();
HXDLIN( 576)		 ::lime::ui::Joystick a11 = joystick;
HXDLIN( 576)		 ::Dynamic _hx_tmp1 =  ::Dynamic(new _hx_Closure_1(a11,f1));
HXDLIN( 576)		joystick->onButtonDown->add(_hx_tmp1,null(),null());
HXLINE( 577)		 ::Dynamic f2 = this->onJoystickButtonUp_dyn();
HXDLIN( 577)		 ::lime::ui::Joystick a12 = joystick;
HXDLIN( 577)		 ::Dynamic _hx_tmp2 =  ::Dynamic(new _hx_Closure_2(a12,f2));
HXDLIN( 577)		joystick->onButtonUp->add(_hx_tmp2,null(),null());
HXLINE( 578)		 ::Dynamic f3 = this->onJoystickDisconnect_dyn();
HXDLIN( 578)		 ::lime::ui::Joystick a13 = joystick;
HXDLIN( 578)		 ::Dynamic _hx_tmp3 =  ::Dynamic(new _hx_Closure_3(a13,f3));
HXDLIN( 578)		joystick->onDisconnect->add(_hx_tmp3,null(),null());
HXLINE( 579)		 ::Dynamic f4 = this->onJoystickHatMove_dyn();
HXDLIN( 579)		 ::lime::ui::Joystick a14 = joystick;
HXDLIN( 579)		 ::Dynamic _hx_tmp4 =  ::Dynamic(new _hx_Closure_4(a14,f4));
HXDLIN( 579)		joystick->onHatMove->add(_hx_tmp4,null(),null());
HXLINE( 580)		 ::Dynamic f5 = this->onJoystickTrackballMove_dyn();
HXDLIN( 580)		 ::lime::ui::Joystick a15 = joystick;
HXDLIN( 580)		 ::Dynamic _hx_tmp5 =  ::Dynamic(new _hx_Closure_5(f5,a15));
...
HXLINE( 611)		this->onModuleExit((int)0);
            	}
