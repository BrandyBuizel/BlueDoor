...
HXLINE(  30)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::_Mover::GraphicMoverTool_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
...
HXLINE(  78)				if (!(::Std_obj::is(member,hx::ClassOf< ::flixel::FlxObject >()))) {
HXLINE(  79)					continue;
            				}
HXLINE(  81)				 ::flixel::FlxObject object = member;
HXLINE(  82)				if (hx::IsNotNull( object )) {
HXLINE(  84)					{
HXLINE(  84)						 ::flixel::FlxObject _g2 = object;
HXDLIN(  84)						_g2->set_x((_g2->x + dx));
            					}
HXLINE(  85)					{
HXLINE(  85)						 ::flixel::FlxObject _g21 = object;
HXDLIN(  85)						_g21->set_y((_g21->y + dy));
            					}
            				}
            			}
            		}
