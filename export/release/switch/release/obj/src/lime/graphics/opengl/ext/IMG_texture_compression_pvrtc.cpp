...
HXLINE(   9)		this->COMPRESSED_RGBA_PVRTC_2BPPV1_IMG = (int)35843;
HXLINE(   8)		this->COMPRESSED_RGBA_PVRTC_4BPPV1_IMG = (int)35842;
HXLINE(   7)		this->COMPRESSED_RGB_PVRTC_2BPPV1_IMG = (int)35841;
HXLINE(   6)		this->COMPRESSED_RGB_PVRTC_4BPPV1_IMG = (int)35840;
            	}
