...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("BlueDoor", null, 960, 480);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["build"] = "358";
		app.meta["company"] = "Blue Door Runners";
		app.meta["file"] = "BlueDoor";
		app.meta["name"] = "Blue Door";
	...
	macro public static function getPreloader () {
		...
		return macro { new openfl.display.Preloader (new Preloader ()); }
