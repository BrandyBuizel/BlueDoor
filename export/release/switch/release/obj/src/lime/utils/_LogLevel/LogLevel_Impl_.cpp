...
bool LogLevel_Impl__obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x4c2a8a4b;
}
...
void LogLevel_Impl__obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime.utils._LogLevel.LogLevel_Impl_","\xe5","\x1b","\x96","\x4c");
