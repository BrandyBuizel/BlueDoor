...
HXLINE(  31)				_hx_tmp1 = offset;
            			}
            			else {
HXLINE(  31)				_hx_tmp1 = (int)0;
            			}
...
HXDLIN(  47)			return this1->bytes->b->__get((index + this1->offset));
            		}
            		else {
...
HXLINE(  52)			this1->bytes->b[(index + this1->offset)] = value;
            		}
...
HXLINE(  74)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,buffer,(int)0);
            	}
...
HXDLIN(  80)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,(int)0);
            	}
...
HXDLIN(  85)			return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
            		}
            		else {
HXLINE(  87)			return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,::haxe::io::Bytes_obj::ofData(bytesData),(int)0);
            		}
...
HXDLIN(  92)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,::lime::utils::_Bytes::Bytes_Impl__obj::fromFile(path),(int)0);
            	}
...
HXDLIN(  97)		return  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,bytes,(int)0);
            	}
...
HXDLIN( 105)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)8));
HXDLIN( 105)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 105)		if (hx::IsNotNull( buffer )) {
HXDLIN( 105)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 105)			int in_byteOffset = byteoffset;
HXDLIN( 105)			if ((in_byteOffset < (int)0)) {
HXDLIN( 105)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 105)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXDLIN( 105)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 105)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXDLIN( 105)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 105)				if ((newByteLength < (int)0)) {
HXDLIN( 105)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 116)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)8));
HXDLIN( 116)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 116)		if (hx::IsNotNull( buffer )) {
HXLINE( 116)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)5);
HXDLIN( 116)			int in_byteOffset = byteoffset;
...
HXDLIN( 127)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)8));
HXDLIN( 127)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 127)		if (hx::IsNotNull( buffer )) {
HXLINE( 127)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)1);
HXDLIN( 127)			int in_byteOffset = byteoffset;
...
HXDLIN( 138)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)16));
HXDLIN( 138)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 138)		if (hx::IsNotNull( buffer )) {
HXLINE( 138)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
HXDLIN( 138)			int in_byteOffset = byteoffset;
HXDLIN( 138)			if ((in_byteOffset < (int)0)) {
HXLINE( 138)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 138)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 138)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 138)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 138)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 138)				if ((newByteLength < (int)0)) {
HXLINE( 138)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 149)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)16));
HXDLIN( 149)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 149)		if (hx::IsNotNull( buffer )) {
HXLINE( 149)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)2);
HXDLIN( 149)			int in_byteOffset = byteoffset;
HXDLIN( 149)			if ((in_byteOffset < (int)0)) {
HXLINE( 149)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 149)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 149)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 149)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 149)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 149)				if ((newByteLength < (int)0)) {
HXLINE( 149)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 160)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)32));
HXDLIN( 160)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 160)		if (hx::IsNotNull( buffer )) {
HXLINE( 160)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)7);
HXDLIN( 160)			int in_byteOffset = byteoffset;
HXDLIN( 160)			if ((in_byteOffset < (int)0)) {
HXLINE( 160)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 160)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 160)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 160)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 160)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 160)				if ((newByteLength < (int)0)) {
HXLINE( 160)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 171)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)32));
HXDLIN( 171)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 171)		if (hx::IsNotNull( buffer )) {
HXLINE( 171)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)3);
HXDLIN( 171)			int in_byteOffset = byteoffset;
HXDLIN( 171)			if ((in_byteOffset < (int)0)) {
HXLINE( 171)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 171)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 171)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 171)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 171)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 171)				if ((newByteLength < (int)0)) {
HXLINE( 171)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 182)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)32));
HXDLIN( 182)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 182)		if (hx::IsNotNull( buffer )) {
HXLINE( 182)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)8);
...
HXDLIN( 193)		 ::Dynamic byteoffset = ::Std_obj::_hx_int(((Float)bytePointer->offset / (Float)(int)64));
HXDLIN( 193)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 193)		if (hx::IsNotNull( buffer )) {
HXLINE( 193)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)9);
HXDLIN( 193)			int in_byteOffset = byteoffset;
HXDLIN( 193)			if ((in_byteOffset < (int)0)) {
HXLINE( 193)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 193)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 193)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 193)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 193)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 193)				if ((newByteLength < (int)0)) {
HXLINE( 193)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
