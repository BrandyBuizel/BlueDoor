...
HXLINE(  82)		int offset = (byteArrayOffset + (startOffset * (int)2));
...
HXLINE(  83)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
HXDLIN(  83)			int in_byteOffset = offset;
HXDLIN(  83)			if ((in_byteOffset < (int)0)) {
HXLINE(  83)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN(  83)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE(  83)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN(  83)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE(  83)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN(  83)				if ((newByteLength < (int)0)) {
HXLINE(  83)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
            			else {
...
HXLINE( 130)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,count,(int)6);
            			}
            			else {
...
HXDLIN( 134)				int offset = (int)0;
HXDLIN( 134)				if (hx::IsNotNull( existingUInt16Array )) {
HXLINE( 134)					 ::haxe::io::Bytes _this1 = _this->buffer;
HXDLIN( 134)					_this1->blit((offset * _this->bytesPerElement),existingUInt16Array->buffer,existingUInt16Array->byteOffset,existingUInt16Array->byteLength);
            				}
            				else {
...
HXLINE( 138)		{
HXLINE( 138)			int _g1 = startOffset;
HXDLIN( 138)			int _g = length;
...
HXDLIN( 140)					{
HXLINE( 140)						int this3 = this2->byteOffset;
HXDLIN( 140)						::__hxcpp_memory_set_ui16(this2->buffer->b,(this3 + ((i - startOffset) * (int)2)),val);
            					}
            				}
            			}
            		}
