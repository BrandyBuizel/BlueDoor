...
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT = (int)33296;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB8_ALPHA8_EXT = (int)35907;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB_ALPHA_EXT = (int)35906;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_sRGB)(__this) )->SRGB_EXT = (int)35904;
            	}
