...
HXLINE(  77)		 ::haxe::io::Bytes bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc((int)0);
...
HXLINE(  94)				int bytes1 = bytes->b->__get(position);
HXDLIN(  94)				::Array< unsigned char > bytes2 = bytes->b;
HXDLIN(  94)				int _hx_tmp = ((int)bytes1 | (int)((int)bytes2->__get((position + (int)1)) << (int)(int)8));
HXDLIN(  94)				::Array< unsigned char > bytes3 = bytes->b;
HXDLIN(  94)				int _hx_tmp1 = ((int)_hx_tmp | (int)((int)bytes3->__get((position + (int)2)) << (int)(int)16));
HXDLIN(  94)				::Array< unsigned char > bytes4 = bytes->b;
HXDLIN(  94)				info->codepoint = ((int)_hx_tmp1 | (int)((int)bytes4->__get((position + (int)3)) << (int)(int)24));
HXLINE(  95)				position = (position + (int)4);
HXLINE(  96)				int bytes5 = bytes->b->__get(position);
HXDLIN(  96)				::Array< unsigned char > bytes6 = bytes->b;
HXDLIN(  96)				int _hx_tmp2 = ((int)bytes5 | (int)((int)bytes6->__get((position + (int)1)) << (int)(int)8));
HXDLIN(  96)				::Array< unsigned char > bytes7 = bytes->b;
HXDLIN(  96)				int _hx_tmp3 = ((int)_hx_tmp2 | (int)((int)bytes7->__get((position + (int)2)) << (int)(int)16));
HXDLIN(  96)				::Array< unsigned char > bytes8 = bytes->b;
HXDLIN(  96)				info->mask = ((int)_hx_tmp3 | (int)((int)bytes8->__get((position + (int)3)) << (int)(int)24));
HXLINE(  97)				position = (position + (int)4);
HXLINE(  98)				int bytes9 = bytes->b->__get(position);
HXDLIN(  98)				::Array< unsigned char > bytes10 = bytes->b;
HXDLIN(  98)				int _hx_tmp4 = ((int)bytes9 | (int)((int)bytes10->__get((position + (int)1)) << (int)(int)8));
HXDLIN(  98)				::Array< unsigned char > bytes11 = bytes->b;
HXDLIN(  98)				int _hx_tmp5 = ((int)_hx_tmp4 | (int)((int)bytes11->__get((position + (int)2)) << (int)(int)16));
HXDLIN(  98)				::Array< unsigned char > bytes12 = bytes->b;
HXDLIN(  98)				info->cluster = ((int)_hx_tmp5 | (int)((int)bytes12->__get((position + (int)3)) << (int)(int)24));
HXLINE(  99)				position = (position + (int)4);
...
HXLINE( 113)		 ::haxe::io::Bytes bytes = ::lime::utils::_Bytes::Bytes_Impl__obj::alloc((int)0);
...
HXLINE( 130)				int bytes1 = bytes->b->__get(position);
HXDLIN( 130)				::Array< unsigned char > bytes2 = bytes->b;
HXDLIN( 130)				int _hx_tmp = ((int)bytes1 | (int)((int)bytes2->__get((position + (int)1)) << (int)(int)8));
HXDLIN( 130)				::Array< unsigned char > bytes3 = bytes->b;
HXDLIN( 130)				int _hx_tmp1 = ((int)_hx_tmp | (int)((int)bytes3->__get((position + (int)2)) << (int)(int)16));
HXDLIN( 130)				::Array< unsigned char > bytes4 = bytes->b;
HXDLIN( 130)				glyphPosition->xAdvance = ((int)_hx_tmp1 | (int)((int)bytes4->__get((position + (int)3)) << (int)(int)24));
HXLINE( 131)				position = (position + (int)4);
HXLINE( 132)				int bytes5 = bytes->b->__get(position);
HXDLIN( 132)				::Array< unsigned char > bytes6 = bytes->b;
HXDLIN( 132)				int _hx_tmp2 = ((int)bytes5 | (int)((int)bytes6->__get((position + (int)1)) << (int)(int)8));
HXDLIN( 132)				::Array< unsigned char > bytes7 = bytes->b;
HXDLIN( 132)				int _hx_tmp3 = ((int)_hx_tmp2 | (int)((int)bytes7->__get((position + (int)2)) << (int)(int)16));
HXDLIN( 132)				::Array< unsigned char > bytes8 = bytes->b;
HXDLIN( 132)				glyphPosition->yAdvance = ((int)_hx_tmp3 | (int)((int)bytes8->__get((position + (int)3)) << (int)(int)24));
HXLINE( 133)				position = (position + (int)4);
HXLINE( 134)				int bytes9 = bytes->b->__get(position);
HXDLIN( 134)				::Array< unsigned char > bytes10 = bytes->b;
HXDLIN( 134)				int _hx_tmp4 = ((int)bytes9 | (int)((int)bytes10->__get((position + (int)1)) << (int)(int)8));
HXDLIN( 134)				::Array< unsigned char > bytes11 = bytes->b;
HXDLIN( 134)				int _hx_tmp5 = ((int)_hx_tmp4 | (int)((int)bytes11->__get((position + (int)2)) << (int)(int)16));
HXDLIN( 134)				::Array< unsigned char > bytes12 = bytes->b;
HXDLIN( 134)				glyphPosition->xOffset = ((int)_hx_tmp5 | (int)((int)bytes12->__get((position + (int)3)) << (int)(int)24));
HXLINE( 135)				position = (position + (int)4);
HXLINE( 136)				int bytes13 = bytes->b->__get(position);
HXDLIN( 136)				::Array< unsigned char > bytes14 = bytes->b;
HXDLIN( 136)				int _hx_tmp6 = ((int)bytes13 | (int)((int)bytes14->__get((position + (int)1)) << (int)(int)8));
HXDLIN( 136)				::Array< unsigned char > bytes15 = bytes->b;
HXDLIN( 136)				int _hx_tmp7 = ((int)_hx_tmp6 | (int)((int)bytes15->__get((position + (int)2)) << (int)(int)16));
HXDLIN( 136)				::Array< unsigned char > bytes16 = bytes->b;
HXDLIN( 136)				glyphPosition->yOffset = ((int)_hx_tmp7 | (int)((int)bytes16->__get((position + (int)3)) << (int)(int)24));
HXLINE( 137)				position = (position + (int)4);
