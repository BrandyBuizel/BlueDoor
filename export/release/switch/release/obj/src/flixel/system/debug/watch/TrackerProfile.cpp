...
HXDLIN( 286)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXLINE( 285)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(2)->init(0,_hx_tmp)->init(1,_this1));
            	}
