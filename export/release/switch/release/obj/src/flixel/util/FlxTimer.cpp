...
HXLINE( 127)		if ((Loops < (int)0)) {
HXLINE( 128)			Loops = (Loops * (int)-1);
            		}
HXLINE( 130)		this->loops = Loops;
HXLINE( 131)		this->onComplete = OnComplete;
HXLINE( 132)		this->_timeCounter = (int)0;
HXLINE( 133)		this->_loopsCounter = (int)0;
...
HXLINE( 176)				_hx_tmp2 = this->active;
            			}
            			else {
HXLINE( 176)				_hx_tmp2 = false;
            			}
HXDLIN( 176)			if (_hx_tmp2) {
HXLINE( 176)				_hx_tmp1 = !(this->finished);
            			}
            			else {
...
HXLINE( 178)			 ::flixel::util::FlxTimer _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 178)			_hx_tmp3->_timeCounter = (_hx_tmp3->_timeCounter - this->time);
HXLINE( 179)			this->_loopsCounter++;
HXLINE( 181)			bool _hx_tmp4;
HXDLIN( 181)			if ((this->loops > (int)0)) {
HXLINE( 181)				_hx_tmp4 = (this->_loopsCounter >= this->loops);
            			}
            			else {
...
HXDLIN( 220)		if ((this->time > (int)0)) {
HXDLIN( 220)			return ((Float)this->_timeCounter / (Float)this->time);
            		}
            		else {
HXDLIN( 220)			return (int)0;
            		}
