...
HX_LOCAL_STACK_FRAME(_hx_pos_9f7ac0293b858dd4_637___fromSymbol,"openfl.display.MovieClip","__fromSymbol",0xc2d8a9fa,"openfl.display.MovieClip.__fromSymbol","openfl/display/MovieClip.hx",637,0x2b84738a)
...
HXLINE( 218)		this->_hx___currentFrame = (int)1;
...
HXLINE( 221)		this->_hx___totalFrames = (int)0;
...
HXLINE( 238)		if ((index < (int)0)) {
HXLINE( 238)			return;
            		}
HXLINE( 239)		int frame = (index + (int)1);
...
HXLINE( 307)		this->_hx___goto((this->_hx___currentFrame + (int)1));
            	}
...
HXLINE( 318)			_hx_tmp = (this->_hx___totalFrames < (int)2);
            		}
            		else {
...
HXLINE( 323)		{
HXLINE( 324)			this->_hx___frameTime = ::Std_obj::_hx_int(((Float)(int)1000 / (Float)this->_hx___swf->frameRate));
HXLINE( 325)			this->_hx___timeElapsed = (int)0;
            		}
            	}
...
HXLINE( 337)		this->_hx___goto((this->_hx___currentFrame - (int)1));
            	}
...
HXLINE( 381)					this->_hx___currentFrame = (int)1;
            				}
...
HXLINE( 411)			{
HXLINE( 411)				int _g1 = (int)0;
HXDLIN( 411)				int _g = targetFrame;
HXDLIN( 411)				while((_g1 < _g)){
HXLINE( 411)					_g1 = (_g1 + (int)1);
HXDLIN( 411)					int i = (_g1 - (int)1);
HXLINE( 413)					frame = (i + (int)1);
...
HXDLIN( 418)						::Array< ::Dynamic> _g3 = frameData->objects;
HXDLIN( 418)						while((_g2 < _g3->length)){
HXLINE( 418)							 ::openfl::_internal::symbols::timeline::FrameObject frameObject = _g3->__get(_g2).StaticCast<  ::openfl::_internal::symbols::timeline::FrameObject >();
HXDLIN( 418)							_g2 = (_g2 + (int)1);
HXLINE( 420)							{
HXLINE( 420)								 ::openfl::_internal::symbols::timeline::FrameObjectType _g4 = frameObject->type;
HXDLIN( 420)								switch((int)(_hx_getEnumValueIndex(_g4))){
            									case (int)0: {
HXLINE( 423)										instance = ( ( ::openfl::display::_MovieClip::FrameSymbolInstance)(::haxe::IMap_obj::get(this->_hx___activeInstancesByFrameObjectID,frameObject->id)) );
...
HXLINE( 428)											this->_hx___updateDisplayObject(instance->displayObject,frameObject,true);
            									...
            									break;
            									case (int)1: {
HXLINE( 432)										instance = currentInstancesByFrameObjectID->get(frameObject->id).StaticCast<  ::openfl::display::_MovieClip::FrameSymbolInstance >();
...
HXLINE( 452)					if ((currentInstances->indexOf(instance2,null()) == (int)-1)) {
HXLINE( 454)						currentInstances->push(instance2);
HXLINE( 456)						if ((instance2->clipDepth > (int)0)) {
...
HXLINE( 471)			{
HXLINE( 471)				int _g11 = (int)0;
HXDLIN( 471)				int _g5 = currentInstances->length;
HXDLIN( 471)				while((_g11 < _g5)){
HXLINE( 471)					_g11 = (_g11 + (int)1);
HXDLIN( 471)					int i1 = (_g11 - (int)1);
...
HXLINE( 491)					{
HXLINE( 491)						int _g21 = (int)0;
HXDLIN( 491)						while((_g21 < currentMasks->length)){
HXLINE( 491)							 ::openfl::display::_MovieClip::FrameSymbolInstance mask = currentMasks->__get(_g21).StaticCast<  ::openfl::display::_MovieClip::FrameSymbolInstance >();
HXDLIN( 491)							_g21 = (_g21 + (int)1);
...
HXDLIN( 501)					if ((currentMasks->length > (int)0)) {
...
HXLINE( 517)				{
HXLINE( 517)					int _g6 = (int)0;
HXDLIN( 517)					::Array< ::Dynamic> _g12 = this->_hx___activeInstances;
HXDLIN( 517)					while((_g6 < _g12->length)){
HXLINE( 517)						 ::openfl::display::_MovieClip::FrameSymbolInstance instance3 = _g12->__get(_g6).StaticCast<  ::openfl::display::_MovieClip::FrameSymbolInstance >();
HXDLIN( 517)						_g6 = (_g6 + (int)1);
...
HXLINE( 525)								movie->gotoAndPlay((int)1,null());
            							}
HXLINE( 528)							this->removeChild(child1);
HXLINE( 529)							i2 = (i2 - (int)1);
HXLINE( 530)							length = (length - (int)1);
            						}
            					}
            				}
HXLINE( 534)				i2 = (i2 + (int)1);
            			}
...
HXLINE( 547)		{
HXLINE( 547)			int _g1 = this->_hx___currentFrame;
HXDLIN( 547)			int _g = (advanceToFrame + (int)1);
HXDLIN( 547)			while((_g1 < _g)){
HXLINE( 547)				_g1 = (_g1 + (int)1);
HXDLIN( 547)				int frame = (_g1 - (int)1);
...
HXLINE( 584)		this->_hx___currentFrame = (int)1;
HXLINE( 585)		this->_hx___lastFrameScriptEval = (int)-1;
HXLINE( 586)		this->_hx___lastFrameUpdate = (int)-1;
...
HXLINE( 593)		 ::hscript::Parser parser = null();
HXLINE( 596)		{
HXLINE( 596)			int _g1 = (int)0;
HXDLIN( 596)			int _g = this->_hx___symbol->frames->length;
HXDLIN( 596)			while((_g1 < _g)){
HXLINE( 596)				_g1 = (_g1 + (int)1);
HXDLIN( 596)				int i = (_g1 - (int)1);
HXLINE( 598)				frame = (i + (int)1);
...
HXDLIN( 603)					::String frameData1 = frameData->label;
HXDLIN( 603)					_hx_tmp->push( ::openfl::display::FrameLabel_obj::__alloc( HX_CTX ,frameData1,(i + (int)1)));
            				}
...
HXLINE( 622)						try {
            							...
            							void _hx_run(){
            								HX_GC_STACKFRAME(&_hx_pos_9f7ac0293b858dd4_637___fromSymbol)
HXLINE( 637)								interp->execute(program);
            							}
            							HX_END_LOCAL_FUNC0((void))

            							HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 625)							if (hx::IsNull( parser )) {
HXLINE( 627)								parser =  ::hscript::Parser_obj::__alloc( HX_CTX );
HXLINE( 628)								parser->allowTypes = true;
            							}
HXLINE( 631)							 ::hscript::Expr program = parser->parseString(frameData->scriptSource,null());
HXLINE( 632)							 ::hscript::Interp interp =  ::hscript::Interp_obj::__alloc( HX_CTX );
HXLINE( 633)							interp->variables->set(HX_("this",5e,06,fc,4c),hx::ObjectPtr<OBJ_>(this));
HXLINE( 635)							 ::Dynamic script =  ::Dynamic(new _hx_Closure_0(interp,program));
HXLINE( 640)							this->_hx___frameScripts->set(frame,script);
            						}
            						catch( ::Dynamic _hx_e){
...
HXLINE( 672)									::lime::utils::Log_obj::warn((((((HX_("Unable to evaluate frame script source for symbol \"",a3,42,39,7c) + this->_hx___symbol->className) + HX_("\" frame ",91,af,e7,77)) + frame) + HX_("\n",0a,00,00,00)) + frameData->scriptSource),hx::SourceInfo(HX_("MovieClip.hx",3e,f0,29,2f),672,HX_("openfl.display.MovieClip",f6,30,c3,c4),HX_("__fromSymbol",82,2f,b5,6a)));
            								}
            								else {
HXLINE( 677)									::lime::utils::Log_obj::warn((HX_("Unable to evaluate frame script source:\n",1e,90,6f,3e) + frameData->scriptSource),hx::SourceInfo(HX_("MovieClip.hx",3e,f0,29,2f),677,HX_("openfl.display.MovieClip",f6,30,c3,c4),HX_("__fromSymbol",82,2f,b5,6a)));
            								}
            							}
            							else {
...
HXLINE( 684)		 ::openfl::_internal::symbols::timeline::Frame frameData2;
...
HXDLIN( 692)			int _g2 = this->_hx___totalFrames;
HXDLIN( 692)			while((_g11 < _g2)){
HXLINE( 692)				_g11 = (_g11 + (int)1);
HXDLIN( 692)				int i1 = (_g11 - (int)1);
HXLINE( 694)				frame1 = (i1 + (int)1);
HXLINE( 695)				frameData2 = this->_hx___symbol->frames->__get(i1).StaticCast<  ::openfl::_internal::symbols::timeline::Frame >();
HXLINE( 697)				if (hx::IsNull( frameData2->objects )) {
HXLINE( 697)					continue;
            				}
HXLINE( 699)				{
HXLINE( 699)					int _g21 = (int)0;
HXDLIN( 699)					::Array< ::Dynamic> _g3 = frameData2->objects;
HXDLIN( 699)					while((_g21 < _g3->length)){
HXLINE( 699)						 ::openfl::_internal::symbols::timeline::FrameObject frameObject = _g3->__get(_g21).StaticCast<  ::openfl::_internal::symbols::timeline::FrameObject >();
HXDLIN( 699)						_g21 = (_g21 + (int)1);
...
HXLINE( 712)								{
HXLINE( 712)									int _g4 = (int)0;
HXDLIN( 712)									::Array< ::Dynamic> _g5 = this->_hx___activeInstances;
HXDLIN( 712)									while((_g4 < _g5->length)){
HXLINE( 712)										 ::openfl::display::_MovieClip::FrameSymbolInstance activeInstance = _g5->__get(_g4).StaticCast<  ::openfl::display::_MovieClip::FrameSymbolInstance >();
HXDLIN( 712)										_g4 = (_g4 + (int)1);
...
HXLINE( 728)								symbol1 = this->_hx___swf->symbols->get(frameObject->symbol).StaticCast<  ::openfl::_internal::symbols::SWFSymbol >();
...
HXLINE( 795)		if ((this->_hx___totalFrames > (int)1)) {
HXLINE( 797)			this->play();
            		}
HXLINE( 800)		this->_hx___enterFrame((int)0);
...
HXLINE( 810)		int nextFrame = (int)0;
HXLINE( 813)		{
...
HXLINE( 815)			int nextFrame1 = this->_hx___currentFrame;
HXDLIN( 815)			nextFrame = (nextFrame1 + ::Math_obj::floor(((Float)this->_hx___timeElapsed / (Float)this->_hx___frameTime)));
HXLINE( 816)			if ((nextFrame < (int)1)) {
HXLINE( 816)				nextFrame = (int)1;
            			}
HXLINE( 817)			if ((nextFrame > this->_hx___totalFrames)) {
HXLINE( 817)				nextFrame = (::Math_obj::floor(hx::Mod((nextFrame - (int)1),this->_hx___totalFrames)) + (int)1);
            			}
...
HXLINE( 833)		if ((frame < (int)1)) {
HXLINE( 833)			frame = (int)1;
            		}
            		else {
...
HXLINE( 837)		this->_hx___enterFrame((int)0);
            	}
...
HXDLIN( 910)					_g = (_g + (int)1);
HXLINE( 912)					switch((int)(_hx_getEnumValueIndex(filter))){
            						case (int)0: {
...
HXLINE( 937)			displayObject->set_visible(frameObject->visible);
            		}
...
HXLINE( 947)			displayObject->set_cacheAsBitmap(frameObject->cacheAsBitmap);
            		}
            	}
...
HXLINE( 957)		::Array< ::Dynamic> _hx_tmp = this->_hx___symbol->frames;
HXDLIN( 957)		this->_hx___currentFrameLabel = _hx_tmp->__get((this->_hx___currentFrame - (int)1)).StaticCast<  ::openfl::_internal::symbols::timeline::Frame >()->label;
...
HXDLIN( 967)					_g = (_g + (int)1);
HXLINE( 969)					int _hx_tmp1 = label->get_frame();
HXDLIN( 969)					if ((_hx_tmp1 < this->_hx___currentFrame)) {
HXLINE( 971)						this->_hx___currentLabel = label->get_name();
            					}
            					else {
HXLINE( 975)						goto _hx_goto_35;
            					}
            				}
            				_hx_goto_35:;
            			}
...
HXDLIN( 983)		int _g = (int)0;
HXDLIN( 983)		::Array< ::String > _g1 = this->_hx___instanceFields;
HXDLIN( 983)		while((_g < _g1->length)){
HXDLIN( 983)			::String field = _g1->__get(_g);
HXDLIN( 983)			_g = (_g + (int)1);
HXLINE( 985)			{
HXLINE( 985)				int _g2 = (int)0;
HXDLIN( 985)				::Array< ::Dynamic> _g3 = this->_hx___children;
HXDLIN( 985)				while((_g2 < _g3->length)){
HXLINE( 985)					 ::openfl::display::DisplayObject child = _g3->__get(_g2).StaticCast<  ::openfl::display::DisplayObject >();
HXDLIN( 985)					_g2 = (_g2 + (int)1);
HXLINE( 987)					if ((child->get_name() == field)) {
HXLINE( 989)						::Reflect_obj::setField(hx::ObjectPtr<OBJ_>(this),field,child);
HXLINE( 990)						goto _hx_goto_38;
            					}
            				}
            				_hx_goto_38:;
            			}
