...
HX_DEFINE_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_164_new,"openfl.events.FocusEvent","new",0xf00a0d8b,"openfl.events.FocusEvent.new","openfl/events/FocusEvent.hx",164,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_173_clone,"openfl.events.FocusEvent","clone",0x40033148,"openfl.events.FocusEvent.clone","openfl/events/FocusEvent.hx",173,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_183_toString,"openfl.events.FocusEvent","toString",0x8b53f7a1,"openfl.events.FocusEvent.toString","openfl/events/FocusEvent.hx",183,0xe559e625)
...
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_37_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",37,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_62_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",62,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_79_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",79,0xe559e625)
HX_LOCAL_STACK_FRAME(_hx_pos_919c1dfcca12e2f6_96_boot,"openfl.events.FocusEvent","boot",0x10dacca7,"openfl.events.FocusEvent.boot","openfl/events/FocusEvent.hx",96,0xe559e625)
namespace openfl{
namespace events{
...
int keyCode = __o_keyCode.Default(0);
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_164_new)
HXLINE( 165)		super::__construct(type,bubbles,cancelable);
HXLINE( 167)		this->keyCode = keyCode;
HXLINE( 168)		this->shiftKey = shiftKey;
HXLINE( 169)		this->relatedObject = relatedObject;
            	}
...
bool FocusEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event FocusEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_173_clone)
HXLINE( 174)		 ::openfl::events::FocusEvent event =  ::openfl::events::FocusEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->relatedObject,this->shiftKey,this->keyCode);
HXLINE( 175)		event->target = this->target;
HXLINE( 176)		event->currentTarget = this->currentTarget;
HXLINE( 177)		event->eventPhase = this->eventPhase;
HXLINE( 178)		return event;
            	}


::String FocusEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_183_toString)
HXDLIN( 183)		return this->_hx___formatToString(HX_("FocusEvent",42,6d,d7,2e),::Array_obj< ::String >::fromData( _hx_array_data_ade3ec19_3,6));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_37_boot)
HXDLIN(  37)		FOCUS_IN = HX_("focusIn",dd,45,83,41);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_62_boot)
HXDLIN(  62)		FOCUS_OUT = HX_("focusOut",96,6f,5e,11);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_79_boot)
HXDLIN(  79)		KEY_FOCUS_CHANGE = HX_("keyFocusChange",09,9c,8e,e5);
            	}
{
            	HX_STACKFRAME(&_hx_pos_919c1dfcca12e2f6_96_boot)
HXDLIN(  96)		MOUSE_FOCUS_CHANGE = HX_("mouseFocusChange",43,f1,81,96);
            	}
}
