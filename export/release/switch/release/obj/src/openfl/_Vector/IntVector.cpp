...
HXLINE(1385)			return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,false,this->_hx___array->copy());
            		}
            		else {
HXLINE(1389)			 ::openfl::_Vector::IntVector other = ( ( ::openfl::_Vector::IntVector)(a) );
HXLINE(1391)			if ((other->_hx___array->length > (int)0)) {
HXLINE(1393)				return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,false,this->_hx___array->concat(other->_hx___array));
            			}
            			else {
HXLINE(1397)				return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,false,this->_hx___array->copy());
            			}
            		}
...
HXDLIN(1404)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,_hx_tmp,this->_hx___array->copy());
            	}
...
HXLINE(1414)		{
HXLINE(1414)			int _g1 = from;
HXDLIN(1414)			int _g = this->_hx___array->length;
HXDLIN(1414)			while((_g1 < _g)){
HXLINE(1414)				_g1 = (_g1 + (int)1);
HXDLIN(1414)				int i = (_g1 - (int)1);
...
HXDLIN(1445)		if (i1) {
HXLINE(1445)			i = (this->_hx___array->length - (int)1);
            		}
            		else {
HXLINE(1445)			i = from;
            		}
HXLINE(1447)		while(hx::IsGreaterEq( i,(int)0 )){
HXLINE(1449)			if ((this->_hx___array->__get(i) == x)) {
HXLINE(1449)				return i;
            			}
HXLINE(1450)			i = (i - (int)1);
            		}
HXLINE(1453)		return (int)-1;
            	}
...
HXLINE(1484)			return this->_hx___array->splice(index,(int)1)->__get((int)0);
            		}
...
HXLINE(1522)			endIndex = (int)16777215;
            		}
HXLINE(1523)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,false,this->_hx___array->slice(startIndex,endIndex));
            	}
...
HXDLIN(1533)		return  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,(int)0,false,this->_hx___array->splice(pos,len));
            	}
