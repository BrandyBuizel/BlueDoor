...
HXDLIN(  17)		return _this->getAnalogXAxisValue(_this->mapping->getAnalogStick((int)19));
            	}
...
HXDLIN(  22)		return _this->getYAxisRaw(_this->mapping->getAnalogStick((int)19));
            	}
...
HXDLIN(  27)		return _this->getAnalogXAxisValue(_this->mapping->getAnalogStick((int)20));
            	}
...
HXDLIN(  32)		return _this->getYAxisRaw(_this->mapping->getAnalogStick((int)20));
            	}
...
HXDLIN(  37)		return this->gamepad->getAxis((int)17);
            	}
...
HXDLIN(  42)		return this->gamepad->getAxis((int)18);
            	}
...
HXDLIN(  47)		return this->gamepad->getAxis((int)28);
            	}
...
HXDLIN(  52)		return this->gamepad->getAxis((int)29);
            	}
