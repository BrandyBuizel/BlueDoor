...
HX_LOCAL_STACK_FRAME(_hx_pos_5ef75db01c4e3075_52_fromLimeCursor,"openfl.ui._MouseCursor.MouseCursor_Impl_","fromLimeCursor",0x6bf8a63e,"openfl.ui._MouseCursor.MouseCursor_Impl_.fromLimeCursor","openfl/ui/MouseCursor.hx",52,0xebae9dff)
HX_LOCAL_STACK_FRAME(_hx_pos_5ef75db01c4e3075_73_toLimeCursor,"openfl.ui._MouseCursor.MouseCursor_Impl_","toLimeCursor",0xdd84694f,"openfl.ui._MouseCursor.MouseCursor_Impl_.toLimeCursor","openfl/ui/MouseCursor.hx",73,0xebae9dff)
...
::String MouseCursor_Impl__obj::fromLimeCursor( ::lime::ui::MouseCursor cursor){
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_52_fromLimeCursor)
HXDLIN(  52)		switch((int)(_hx_getEnumValueIndex(cursor))){
            			case (int)0: {
HXLINE(  54)				return HX_("arrow",c9,79,8f,25);
            			}
            			break;
            			case (int)1: {
HXLINE(  59)				return HX_("crosshair",a2,46,c8,8a);
            			}
            			break;
            			case (int)2: {
HXLINE(  55)				return HX_("auto",6f,df,76,40);
            			}
            			break;
            			case (int)3: {
HXLINE(  57)				return HX_("hand",6f,2b,08,45);
            			}
            			break;
            			case (int)4: {
HXLINE(  56)				return HX_("button",f2,61,e0,d9);
            			}
            			break;
            			case (int)5: {
HXLINE(  60)				return HX_("resize_nesw",06,ae,e9,a7);
            			}
            			break;
            			case (int)6: {
HXLINE(  61)				return HX_("resize_ns",f0,cc,f2,ab);
            			}
            			break;
            			case (int)7: {
HXLINE(  62)				return HX_("resize_nwse",86,56,f7,a7);
            			}
            			break;
            			case (int)8: {
HXLINE(  63)				return HX_("resize_we",b9,d4,f2,ab);
            			}
            			break;
            			case (int)9: {
HXLINE(  58)				return HX_("ibeam",58,ca,26,b6);
            			}
            			break;
            			case (int)10: {
HXLINE(  64)				return HX_("wait",75,5a,f2,4e);
            			}
            			break;
            			case (int)11: {
HXLINE(  65)				return HX_("waitarrow",34,17,98,4f);
            			}
            			break;
            			case (int)12: {
HXLINE(  66)				return HX_("custom",b1,87,92,3f);
            			}
            			break;
            		}
...
HXDLIN(  39)		_hx___CROSSHAIR = HX_("crosshair",a2,46,c8,8a);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_40_boot)
HXDLIN(  40)		_hx___CUSTOM = HX_("custom",b1,87,92,3f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_41_boot)
HXDLIN(  41)		_hx___MOVE = HX_("move",11,e3,60,48);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_42_boot)
HXDLIN(  42)		_hx___RESIZE_NESW = HX_("resize_nesw",06,ae,e9,a7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_43_boot)
HXDLIN(  43)		_hx___RESIZE_NS = HX_("resize_ns",f0,cc,f2,ab);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_44_boot)
HXDLIN(  44)		_hx___RESIZE_NWSE = HX_("resize_nwse",86,56,f7,a7);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_45_boot)
HXDLIN(  45)		_hx___RESIZE_WE = HX_("resize_we",b9,d4,f2,ab);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_46_boot)
HXDLIN(  46)		_hx___WAIT = HX_("wait",75,5a,f2,4e);
            	}
{
            	HX_STACKFRAME(&_hx_pos_5ef75db01c4e3075_47_boot)
HXDLIN(  47)		_hx___WAIT_ARROW = HX_("waitarrow",34,17,98,4f);
            	}
}
