...
HXLINE(  93)			return ::cpp::Lib_obj::load(library,method,args);
            		}
...
HXLINE( 205)		try {
            			HX_STACK_CATCHABLE( ::Dynamic, 0);
HXLINE( 207)			 ::sys::io::Process proc =  ::sys::io::Process_obj::__alloc( HX_CTX ,HX_("haxelib",df,b6,80,08),::Array_obj< ::String >::__new(2)->init(0,HX_("path",a5,e5,51,4a))->init(1,library));
...
HXLINE( 219)						if ((s.substr((int)0,(int)1) != HX_("-",2d,00,00,00))) {
...
HXLINE( 319)		 ::Dynamic sys_string = ::cpp::Lib_obj::load(HX_("std",a3,a8,57,00),HX_("sys_string",03,f9,de,46),(int)0);
