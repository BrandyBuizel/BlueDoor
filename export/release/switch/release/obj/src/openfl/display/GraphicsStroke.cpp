...
HXLINE( 225)		this->thickness = thickness;
HXLINE( 226)		this->_hx___graphicsDataType = (int)0;
            	}
...
static hx::StorageInfo GraphicsStroke_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsStroke_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{ hx::fsUnknown, 0, null()}
};
