...
HXLINE(  52)		Float _hx_tmp3 = (((int)3 * this->scale) * this->scale);
HXDLIN(  52)		Float _hx_tmp4 = this->_fromX;
HXLINE(  51)		Float _hx_tmp5 = (_hx_tmp2 + (_hx_tmp3 * ((_hx_tmp4 - ((int)2 * this->_aX)) + this->_bX)));
HXLINE(  53)		Float _hx_tmp6 = ((int)3 * this->scale);
HXLINE(  51)		this->x = ((_hx_tmp5 + (_hx_tmp6 * (this->_aX - this->_fromX))) + this->_fromX);
HXLINE(  55)		Float _hx_tmp7 = ((this->scale * this->scale) * this->scale);
HXDLIN(  55)		Float _hx_tmp8 = this->_toY;
HXDLIN(  55)		Float _hx_tmp9 = (_hx_tmp7 * ((_hx_tmp8 + ((int)3 * (this->_aY - this->_bY))) - this->_fromY));
HXLINE(  56)		Float _hx_tmp10 = (((int)3 * this->scale) * this->scale);
HXDLIN(  56)		Float _hx_tmp11 = this->_fromY;
HXLINE(  55)		Float _hx_tmp12 = (_hx_tmp9 + (_hx_tmp10 * ((_hx_tmp11 - ((int)2 * this->_aY)) + this->_bY)));
HXLINE(  57)		Float _hx_tmp13 = ((int)3 * this->scale);
HXLINE(  55)		this->y = ((_hx_tmp12 + (_hx_tmp13 * (this->_aY - this->_fromY))) + this->_fromY);
