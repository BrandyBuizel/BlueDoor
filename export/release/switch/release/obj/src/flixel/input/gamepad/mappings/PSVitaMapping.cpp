...
HXLINE(  48)				return (int)8;
            			...
            			break;
            			case (int)3: {
HXLINE(  49)				return (int)9;
            			}
            			break;
            			case (int)4: {
HXLINE(  52)				return (int)15;
            			}
            			break;
            			case (int)5: {
HXLINE(  53)				return (int)16;
            			}
            			break;
            			case (int)6: {
HXLINE(  50)				return (int)10;
            			}
            			break;
            			case (int)7: {
HXLINE(  51)				return (int)12;
            			...
            			break;
            			case (int)11: {
HXLINE(  54)				return (int)17;
            			}
            			break;
            			case (int)12: {
HXLINE(  55)				return (int)18;
            			}
            			break;
            			case (int)13: {
HXLINE(  56)				return (int)19;
            			}
            			break;
            			case (int)14: {
HXLINE(  57)				return (int)20;
            			}
            			break;
            			case (int)34: {
