...
HXLINE(  10)		this->QUERY_RESULT_AVAILABLE_EXT = (int)34919;
HXLINE(   9)		this->QUERY_RESULT_EXT = (int)34918;
HXLINE(   8)		this->CURRENT_QUERY_EXT = (int)34917;
HXLINE(   7)		this->ANY_SAMPLES_PASSED_CONSERVATIVE_EXT = (int)36202;
HXLINE(   6)		this->ANY_SAMPLES_PASSED_EXT = (int)35887;
            	}
