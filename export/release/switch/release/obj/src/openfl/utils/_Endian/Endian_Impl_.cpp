...
HXDLIN(  65)		switch((int)(_hx_getEnumValueIndex(value))){
            			case (int)0: {
...
HXDLIN(  41)		_hx_BIG_ENDIAN = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_f2873c031a8a146e_60_boot)
HXDLIN(  60)		_hx_LITTLE_ENDIAN = (int)1;
            	}
}
