...
HXLINE(  77)		this->blendDestinationAlphaFactor = (int)9;
HXLINE(  78)		this->blendSourceAlphaFactor = (int)2;
HXLINE(  79)		this->blendDestinationRGBFactor = (int)9;
HXLINE(  80)		this->blendSourceRGBFactor = (int)2;
...
HXLINE(  85)		this->culling = (int)3;
HXLINE(  86)		this->depthCompareMode = (int)4;
...
HXLINE(  90)		this->stencilCompareMode = (int)0;
HXLINE(  91)		this->stencilDepthFail = (int)5;
HXLINE(  92)		this->stencilFail = (int)5;
HXLINE(  93)		this->stencilPass = (int)5;
HXLINE(  94)		this->stencilReadMask = (int)255;
HXLINE(  95)		this->stencilReferenceValue = (int)0;
HXLINE(  96)		this->stencilTriangleFace = (int)2;
HXLINE(  97)		this->stencilWriteMask = (int)255;
HXLINE(  98)		this->textures = ::Array_obj< ::Dynamic>::__new();
HXLINE(  99)		this->_hx___frontFaceGLCCW = true;
HXLINE( 102)		this->_hx___glBlendEquation = (int)32774;
            	}
