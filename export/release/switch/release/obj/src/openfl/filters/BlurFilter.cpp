...
HX_DEFINE_STACK_FRAME(_hx_pos_6e95f8db175a4230_158_new,"openfl.filters.BlurFilter","new",0x2ff6acc2,"openfl.filters.BlurFilter.new","openfl/filters/BlurFilter.hx",158,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_172_clone,"openfl.filters.BlurFilter","clone",0xcbbf4c3f,"openfl.filters.BlurFilter.clone","openfl/filters/BlurFilter.hx",172,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_176___applyFilter,"openfl.filters.BlurFilter","__applyFilter",0x511b0b88,"openfl.filters.BlurFilter.__applyFilter","openfl/filters/BlurFilter.hx",176,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_189___initShader,"openfl.filters.BlurFilter","__initShader",0xc19d1cd3,"openfl.filters.BlurFilter.__initShader","openfl/filters/BlurFilter.hx",189,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_211_get_blurX,"openfl.filters.BlurFilter","get_blurX",0xeb11be0a,"openfl.filters.BlurFilter.get_blurX","openfl/filters/BlurFilter.hx",211,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_215_set_blurX,"openfl.filters.BlurFilter","set_blurX",0xce62aa16,"openfl.filters.BlurFilter.set_blurX","openfl/filters/BlurFilter.hx",215,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_228_get_blurY,"openfl.filters.BlurFilter","get_blurY",0xeb11be0b,"openfl.filters.BlurFilter.get_blurY","openfl/filters/BlurFilter.hx",228,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_232_set_blurY,"openfl.filters.BlurFilter","set_blurY",0xce62aa17,"openfl.filters.BlurFilter.set_blurY","openfl/filters/BlurFilter.hx",232,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_245_get_quality,"openfl.filters.BlurFilter","get_quality",0xa28f7338,"openfl.filters.BlurFilter.get_quality","openfl/filters/BlurFilter.hx",245,0x46563eac)
HX_LOCAL_STACK_FRAME(_hx_pos_6e95f8db175a4230_249_set_quality,"openfl.filters.BlurFilter","set_quality",0xacfc7a44,"openfl.filters.BlurFilter.set_quality","openfl/filters/BlurFilter.hx",249,0x46563eac)
...
int quality = __o_quality.Default(1);
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_158_new)
HXLINE( 159)		super::__construct();
HXLINE( 161)		this->set_blurX(blurX);
HXLINE( 162)		this->set_blurY(blurY);
HXLINE( 163)		this->set_quality(quality);
HXLINE( 165)		this->_hx___needSecondBitmapData = true;
HXLINE( 166)		this->_hx___preserveObject = false;
...
bool BlurFilter_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::filters::BitmapFilter BlurFilter_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_6e95f8db175a4230_172_clone)
HXDLIN( 172)		return  ::openfl::filters::BlurFilter_obj::__alloc( HX_CTX ,this->_hx___blurX,this->_hx___blurY,this->_hx___quality);
            	}
 ...
 ::openfl::display::BitmapData BlurFilter_obj::_hx___applyFilter( ::openfl::display::BitmapData bitmapData, ::openfl::display::BitmapData sourceBitmapData, ::openfl::geom::Rectangle sourceRect, ::openfl::geom::Point destPoint){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_176___applyFilter)
HXLINE( 178)		int timer = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 178)		Float time;
HXDLIN( 178)		if ((timer > (int)0)) {
HXLINE( 178)			time = ((Float)timer / (Float)(int)1000);
            		}
            		else {
HXLINE( 178)			time = (int)0;
            		}
HXLINE( 179)		 ::lime::graphics::Image bitmapData1 = bitmapData->image;
HXDLIN( 179)		 ::lime::graphics::Image sourceBitmapData1 = sourceBitmapData->image;
HXDLIN( 179)		 ::lime::math::Rectangle finalImage = sourceRect->_hx___toLimeRectangle();
HXDLIN( 179)		 ::lime::math::Vector2 finalImage1 = destPoint->_hx___toLimeVector2();
HXDLIN( 179)		 ::lime::graphics::Image finalImage2 = ::lime::_internal::graphics::ImageDataUtil_obj::gaussianBlur(bitmapData1,sourceBitmapData1,finalImage,finalImage1,this->_hx___blurX,this->_hx___blurY,this->_hx___quality,null(),null());
HXLINE( 181)		int timer1 = ::lime::_hx_system::System_obj::getTimer();
HXDLIN( 181)		Float elapsed;
HXDLIN( 181)		if ((timer1 > (int)0)) {
HXLINE( 181)			elapsed = ((Float)timer1 / (Float)(int)1000);
            		}
            		else {
HXLINE( 181)			elapsed = (int)0;
            		}
HXDLIN( 181)		Float elapsed1 = (elapsed - time);
HXLINE( 183)		if (hx::IsEq( finalImage2,bitmapData->image )) {
HXLINE( 183)			return bitmapData;
            		}
HXLINE( 185)		return sourceBitmapData;
            	}


 ::openfl::display::Shader BlurFilter_obj::_hx___initShader( ::openfl::display::DisplayObjectRenderer renderer,int pass){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_189___initShader)
HXLINE( 191)		if ((pass <= this->_hx___horizontalPasses)) {
HXLINE( 193)			Float scale = ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1));
HXLINE( 194)			::Array< Float > _hx_tmp = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN( 194)			_hx_tmp[(int)0] = (this->get_blurX() * scale);
HXLINE( 195)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)1] = (int)0;
            		}
            		else {
HXLINE( 199)			Float scale1 = ::Math_obj::pow(((Float)0.5),((int)(pass - this->_hx___horizontalPasses) >> (int)(int)1));
HXLINE( 200)			::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value[(int)0] = (int)0;
HXLINE( 201)			::Array< Float > _hx_tmp1 = ::openfl::filters::BlurFilter_obj::_hx___blurShader->uRadius->value;
HXDLIN( 201)			_hx_tmp1[(int)1] = (this->get_blurY() * scale1);
            		}
HXLINE( 205)		return ::openfl::filters::BlurFilter_obj::_hx___blurShader;
            	}


Float BlurFilter_obj::get_blurX(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_211_get_blurX)
HXDLIN( 211)		return this->_hx___blurX;
            	}
...
Float BlurFilter_obj::set_blurX(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_215_set_blurX)
HXLINE( 216)		if ((value != this->_hx___blurX)) {
HXLINE( 218)			this->_hx___blurX = value;
HXLINE( 219)			this->_hx___renderDirty = true;
HXLINE( 220)			int _hx_tmp;
HXDLIN( 220)			if ((value > (int)0)) {
HXLINE( 220)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 220)				_hx_tmp = (int)0;
            			}
HXDLIN( 220)			this->_hx___leftExtension = _hx_tmp;
HXLINE( 221)			this->_hx___rightExtension = this->_hx___leftExtension;
            		}
...
Float BlurFilter_obj::get_blurY(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_228_get_blurY)
HXDLIN( 228)		return this->_hx___blurY;
            	}
...
Float BlurFilter_obj::set_blurY(Float value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_232_set_blurY)
HXLINE( 233)		if ((value != this->_hx___blurY)) {
HXLINE( 235)			this->_hx___blurY = value;
HXLINE( 236)			this->_hx___renderDirty = true;
HXLINE( 237)			int _hx_tmp;
HXDLIN( 237)			if ((value > (int)0)) {
HXLINE( 237)				_hx_tmp = ::Math_obj::ceil(value);
            			}
            			else {
HXLINE( 237)				_hx_tmp = (int)0;
            			}
HXDLIN( 237)			this->_hx___topExtension = _hx_tmp;
HXLINE( 238)			this->_hx___bottomExtension = this->_hx___topExtension;
            		}
...
int BlurFilter_obj::get_quality(){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_245_get_quality)
HXDLIN( 245)		return this->_hx___quality;
            	}
...
int BlurFilter_obj::set_quality(int value){
            	HX_STACKFRAME(&_hx_pos_6e95f8db175a4230_249_set_quality)
