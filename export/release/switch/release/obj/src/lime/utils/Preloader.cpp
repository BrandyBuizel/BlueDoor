...
HXLINE(  59)		this->bytesLoaded = (int)0;
HXLINE(  60)		this->bytesTotal = (int)0;
...
HXDLIN( 114)		if ((this->libraryNames->indexOf(name,null()) == (int)-1)) {
...
HXLINE( 127)		this->loadedLibraries = (int)-1;
HXLINE( 128)		this->preloadStarted = false;
HXLINE( 130)		{
HXLINE( 130)			int _g2 = (int)0;
HXDLIN( 130)			::Array< ::Dynamic> _g11 = this->libraries;
...
HXLINE( 137)					if (!(_gthis->bytesLoadedCache->exists(library1))) {
HXLINE( 139)						 ::lime::utils::Preloader _gthis1 = _gthis;
HXDLIN( 139)						_gthis1->bytesLoaded = (_gthis1->bytesLoaded + loaded);
            					}
            					else {
HXLINE( 143)						 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 143)						int _gthis3 = _gthis2->bytesLoaded;
HXDLIN( 143)						_gthis2->bytesLoaded = (_gthis3 + (loaded - _gthis->bytesLoadedCache->get(library1)));
            					}
HXLINE( 146)					_gthis->bytesLoadedCache->set(library1,loaded);
...
HXLINE( 155)					if (!(_gthis->bytesLoadedCache->exists(library1))) {
HXLINE( 157)						 ::lime::utils::Preloader _gthis4 = _gthis;
HXDLIN( 157)						_gthis4->bytesLoaded = (_gthis4->bytesLoaded + library1->bytesTotal);
            					}
            					else {
HXLINE( 161)						 ::lime::utils::Preloader _gthis5 = _gthis;
HXDLIN( 161)						int _gthis6 = _gthis5->bytesLoaded;
HXDLIN( 161)						int library2 = library1->bytesTotal;
HXDLIN( 161)						_gthis5->bytesLoaded = (_gthis6 + (library2 - _gthis->bytesLoadedCache->get(library1)));
            					}
...
HXLINE( 168)					::lime::utils::Log_obj::error(e,hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),168,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("load",26,9a,b7,47)));
            				}
            				HX_END_LOCAL_FUNC1((void))

HXLINE( 130)				 ::lime::utils::AssetLibrary library1 = _g11->__get(_g2).StaticCast<  ::lime::utils::AssetLibrary >();
HXDLIN( 130)				_g2 = (_g2 + (int)1);
HXLINE( 132)				::lime::utils::Log_obj::verbose(HX_("Preloading asset library",44,27,6d,96),hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),132,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("load",26,9a,b7,47)));
HXLINE( 134)				library1->load()->onProgress( ::Dynamic(new _hx_Closure_0(_gthis,library1)))->onComplete( ::Dynamic(new _hx_Closure_1(_gthis,library1)))->onError( ::Dynamic(new _hx_Closure_2()));
            			}
            		}
HXLINE( 174)		{
HXLINE( 174)			int _g3 = (int)0;
HXDLIN( 174)			::Array< ::String > _g12 = this->libraryNames;
HXDLIN( 174)			while((_g3 < _g12->length)){
HXLINE( 174)				::String name = _g12->__get(_g3);
HXDLIN( 174)				_g3 = (_g3 + (int)1);
HXLINE( 176)				 ::lime::utils::Preloader _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 176)				_hx_tmp1->bytesTotal = (_hx_tmp1->bytesTotal + (int)200);
            			}
            		}
...
HXLINE( 189)			current = (current + (int)1);
            		}
HXLINE( 191)		int totalLibraries = (this->libraries->length + this->libraryNames->length);
HXLINE( 193)		if (hx::IsNotNull( name )) {
HXLINE( 195)			::lime::utils::Log_obj::verbose(((((((HX_("Loaded asset library: ",36,ba,cc,98) + name) + HX_(" [",3b,1c,00,00)) + current) + HX_("/",2f,00,00,00)) + totalLibraries) + HX_("]",5d,00,00,00)),hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),195,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("loadedAssetLibrary",90,0a,d2,6a)));
            		}
            		else {
HXLINE( 199)			::lime::utils::Log_obj::verbose(((((HX_("Loaded asset library [",cb,a3,cc,98) + current) + HX_("/",2f,00,00,00)) + totalLibraries) + HX_("]",5d,00,00,00)),hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),199,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("loadedAssetLibrary",90,0a,d2,6a)));
            		}
...
HXDLIN( 246)								_gthis1->bytesTotal = (_gthis1->bytesTotal + (total - (int)200));
            							}
HXLINE( 249)							if ((loaded > total)) {
HXLINE( 249)								loaded = total;
            							}
HXLINE( 251)							if (!(_gthis->bytesLoadedCache2->exists(name))) {
HXLINE( 253)								 ::lime::utils::Preloader _gthis2 = _gthis;
HXDLIN( 253)								_gthis2->bytesLoaded = (_gthis2->bytesLoaded + loaded);
            							}
            							else {
HXLINE( 257)								 ::lime::utils::Preloader _gthis3 = _gthis;
HXDLIN( 257)								int _gthis4 = _gthis3->bytesLoaded;
HXDLIN( 257)								_gthis3->bytesLoaded = (_gthis4 + (loaded - _gthis->bytesLoadedCache2->get(name)));
            							}
...
HXLINE( 270)						int total1 = (int)200;
HXLINE( 272)						if (_gthis->bytesTotalCache->exists(name)) {
HXLINE( 274)							total1 = ( (int)(_gthis->bytesTotalCache->get(name)) );
            						}
HXLINE( 277)						if (!(_gthis->bytesLoadedCache2->exists(name))) {
HXLINE( 279)							 ::lime::utils::Preloader _gthis5 = _gthis;
HXDLIN( 279)							_gthis5->bytesLoaded = (_gthis5->bytesLoaded + total1);
            						}
            						else {
HXLINE( 283)							 ::lime::utils::Preloader _gthis6 = _gthis;
HXDLIN( 283)							int _gthis7 = _gthis6->bytesLoaded;
HXDLIN( 283)							_gthis6->bytesLoaded = (_gthis7 + (total1 - _gthis->bytesLoadedCache2->get(name)));
            						}
...
HXLINE( 290)						::lime::utils::Log_obj::error(e,hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),290,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
            					}
            					HX_END_LOCAL_FUNC1((void))

HXLINE( 234)					::String name = _g1->__get(_g);
HXDLIN( 234)					_g = (_g + (int)1);
HXLINE( 236)					::lime::utils::Log_obj::verbose((HX_("Preloading asset library: ",ea,b2,78,e9) + name),hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),236,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
...
HXLINE( 295)			int _hx_tmp2 = this->loadedLibraries;
HXDLIN( 295)			_hx_tmp1 = (_hx_tmp2 == (this->libraries->length + this->libraryNames->length));
            		}
            		else {
...
HXLINE( 301)				::lime::utils::Log_obj::verbose(HX_("Preload complete",10,f4,03,24),hx::SourceInfo(HX_("Preloader.hx",28,58,3f,c7),301,HX_("lime.utils.Preloader",80,b4,12,ca),HX_("updateProgress",d6,ea,54,bb)));
            			}
