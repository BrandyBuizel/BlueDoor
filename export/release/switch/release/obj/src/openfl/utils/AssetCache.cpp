...
HXDLIN( 131)		return this->bitmapData->get(id).StaticCast<  ::openfl::display::BitmapData >();
            	}
...
HXDLIN( 142)		return this->font->get(id).StaticCast<  ::openfl::text::Font >();
            	}
...
HXDLIN( 153)		return this->sound->get(id).StaticCast<  ::openfl::media::Sound >();
            	}
