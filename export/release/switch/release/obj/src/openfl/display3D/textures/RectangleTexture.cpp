...
HXLINE(  42)			this->_hx___getGLFramebuffer(true,(int)0,(int)0);
            		}
            	}
...
HXDLIN( 106)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 106)			int in_byteOffset = byteArrayOffset;
HXDLIN( 106)			if ((in_byteOffset < (int)0)) {
HXDLIN( 106)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 106)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXDLIN( 106)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 106)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXDLIN( 106)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 106)				if ((newByteLength < (int)0)) {
HXDLIN( 106)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXDLIN( 122)			{
HXLINE( 122)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data,null(),(int)0);
HXDLIN( 122)				gl->texImage2D(target,(int)0,internalformat,width,height,(int)0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
...
HXLINE( 132)			if ((::openfl::display3D::Context3D_obj::_hx___glMaxTextureMaxAnisotropy != (int)0)) {
HXLINE( 134)				int aniso;
HXDLIN( 134)				 ::Dynamic _g = state->filter;
HXDLIN( 134)				 ::Dynamic _hx_switch_0 = _g;
            				if (  (_hx_switch_0==(int)0) ){
HXLINE( 134)					aniso = (int)16;
HXDLIN( 134)					goto _hx_goto_4;
            				}
            				if (  (_hx_switch_0==(int)1) ){
HXLINE( 134)					aniso = (int)2;
HXDLIN( 134)					goto _hx_goto_4;
            				}
            				if (  (_hx_switch_0==(int)2) ){
HXLINE( 134)					aniso = (int)4;
HXDLIN( 134)					goto _hx_goto_4;
            				}
            				if (  (_hx_switch_0==(int)3) ){
HXLINE( 134)					aniso = (int)8;
HXDLIN( 134)					goto _hx_goto_4;
            				}
            				/* default */{
HXLINE( 134)					aniso = (int)1;
            				}
            				_hx_goto_4:;
...
HXLINE( 148)				gl->texParameterf(gl->TEXTURE_2D,::openfl::display3D::Context3D_obj::_hx___glTextureMaxAnisotropy,aniso);
            			}
...
HXLINE( 163)		if ((image->buffer->bitsPerPixel == (int)1)) {
...
HXDLIN( 198)			{
HXLINE( 198)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),(int)0);
HXDLIN( 198)				gl->texImage2D(target,(int)0,internalFormat,width,height,(int)0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
