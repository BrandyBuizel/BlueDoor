...
HXLINE(   9)		this->MAX_SAMPLES_EXT = (int)36183;
HXLINE(   8)		this->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT = (int)36182;
HXLINE(   7)		this->RENDERBUFFER_SAMPLES_EXT = (int)36011;
HXLINE(   6)		this->FRAMEBUFFER_ATTACHMENT_TEXTURE_SAMPLES_EXT = (int)36204;
            	}
