...
HXLINE(   8)		this->MAX_SAMPLES_ANGLE = (int)36183;
HXLINE(   7)		this->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_ANGLE = (int)36182;
HXLINE(   6)		this->RENDERBUFFER_SAMPLES_ANGLE = (int)36011;
            	}
