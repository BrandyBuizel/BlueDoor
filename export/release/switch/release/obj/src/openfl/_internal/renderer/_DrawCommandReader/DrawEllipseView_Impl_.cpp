...
HXDLIN( 602)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 602)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 609)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 609)		return this2->__get((this1->fPos + (int)2));
            	}
...
HXDLIN( 616)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 616)		return this2->__get((this1->fPos + (int)3));
            	}
