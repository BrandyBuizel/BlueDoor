...
HXLINE(  11)		this->VERTEX_ARRAY_OBJECT_EXT = (int)37204;
HXLINE(  10)		this->QUERY_OBJECT_EXT = (int)37203;
HXLINE(   9)		this->BUFFER_OBJECT_EXT = (int)37201;
HXLINE(   8)		this->SHADER_OBJECT_EXT = (int)35656;
HXLINE(   7)		this->PROGRAM_OBJECT_EXT = (int)35648;
HXLINE(   6)		this->PROGRAM_PIPELINE_OBJECT_EXT = (int)35407;
            	}
