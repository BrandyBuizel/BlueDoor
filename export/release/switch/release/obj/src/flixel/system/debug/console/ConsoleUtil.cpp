...
HX_LOCAL_STACK_FRAME(_hx_pos_a994ee380c23f681_138_sortFields,"flixel.system.debug.console.ConsoleUtil","sortFields",0x773f00ab,"flixel.system.debug.console.ConsoleUtil.sortFields","flixel/system/debug/console/ConsoleUtil.hx",138,0x2e8bcde6)
...
HXLINE(  52)			Input = Input.substr((int)0,(int)-1);
            		}
...
HXLINE( 105)		if (::Std_obj::is(Object,hx::ClassOf< ::hx::Class >())) {
HXLINE( 106)			fields = ::Type_obj::getClassFields(Object);
            		}
            		else {
HXLINE( 107)			if (::Std_obj::is(Object,hx::ClassOf< ::Enum >())) {
...
HXLINE( 121)					::String name = field.substr((int)4,null());
HXLINE( 123)					bool _hx_tmp1;
HXDLIN( 123)					if ((fields->indexOf(name,null()) == (int)-1)) {
HXLINE( 123)						_hx_tmp1 = (filteredFields->indexOf(name,null()) == (int)-1);
            					}
            					else {
...
::Array< ::String > ConsoleUtil_obj::sortFields(::Array< ::String > fields){
            		...
            		bool _hx_run(::String field){
            			HX_STACKFRAME(&_hx_pos_a994ee380c23f681_138_sortFields)
HXLINE( 139)			if (::StringTools_obj::startsWith(field,HX_("_",5f,00,00,00))) {
HXLINE( 141)				underscoreList->push(field);
...
HXLINE( 137)		fields = fields->filter( ::Dynamic(new _hx_Closure_0(underscoreList)));
