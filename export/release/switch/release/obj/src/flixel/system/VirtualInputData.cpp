...
HX_DEFINE_STACK_FRAME(_hx_pos_32211c0ca20fb474_131_new,"flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","lime/_internal/macros/AssetsMacro.hx",131,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_b9d97b5828a49549_1_boot,"flixel.system.VirtualInputData","boot",0x6c8c736a,"flixel.system.VirtualInputData.boot","?",1,0x0000003f)
namespace flixel{
namespace _hx_system{

void VirtualInputData_obj::__construct( ::Dynamic __o_length){
 ::Dynamic length = __o_length.Default(0);
            	HX_STACKFRAME(&_hx_pos_32211c0ca20fb474_131_new)
HXLINE( 132)		super::__construct(null());
HXLINE( 134)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::flixel::_hx_system::VirtualInputData_obj::resourceName);
HXLINE( 135)		this->_hx___fromBytes(bytes);
            	}
...
HXDLIN(   1)		resourceName = HX_("__ASSET__:file_flixel_system_VirtualInputData",cf,a9,c1,46);
            	}
}
