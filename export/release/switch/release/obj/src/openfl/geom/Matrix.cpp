...
HXLINE( 192)		Float a1 = (this->a * m->a);
HXDLIN( 192)		Float a11 = (a1 + (this->b * m->c));
HXLINE( 193)		Float _hx_tmp = (this->a * m->b);
HXDLIN( 193)		this->b = (_hx_tmp + (this->b * m->d));
HXLINE( 194)		this->a = a11;
HXLINE( 196)		Float c1 = (this->c * m->a);
HXDLIN( 196)		Float c11 = (c1 + (this->d * m->c));
HXLINE( 197)		Float _hx_tmp1 = (this->c * m->b);
HXDLIN( 197)		this->d = (_hx_tmp1 + (this->d * m->d));
HXLINE( 198)		this->c = c11;
HXLINE( 200)		Float tx1 = (this->tx * m->a);
HXDLIN( 200)		Float tx11 = ((tx1 + (this->ty * m->c)) + m->tx);
HXLINE( 201)		Float _hx_tmp2 = (this->tx * m->b);
HXDLIN( 201)		this->ty = ((_hx_tmp2 + (this->ty * m->d)) + m->ty);
HXLINE( 202)		this->tx = tx11;
            	}
...
HXLINE( 390)			this->b = (int)0;
HXLINE( 391)			this->c = (int)0;
...
HXLINE( 435)		this->a = ((Float)width / (Float)((Float)1638.4));
HXLINE( 436)		this->d = ((Float)height / (Float)((Float)1638.4));
HXLINE( 439)		if ((rotation != (int)0)) {
...
HXLINE( 451)			this->b = (int)0;
HXLINE( 452)			this->c = (int)0;
            		}
HXLINE( 455)		this->tx = (tx + ((Float)width / (Float)(int)2));
HXLINE( 456)		this->ty = (ty + ((Float)height / (Float)(int)2));
            	}
...
HXDLIN( 473)		Float _hx_tmp = (point->x * this->a);
HXDLIN( 473)		Float _hx_tmp1 = (_hx_tmp + (point->y * this->c));
HXDLIN( 473)		Float _hx_tmp2 = (point->x * this->b);
HXDLIN( 473)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp1,(_hx_tmp2 + (point->y * this->d)));
            	}
...
HXLINE( 494)		this->a = (int)1;
HXLINE( 495)		this->b = (int)0;
HXLINE( 496)		this->c = (int)0;
HXLINE( 497)		this->d = (int)1;
HXLINE( 498)		this->tx = (int)0;
HXLINE( 499)		this->ty = (int)0;
            	}
...
HXLINE( 510)		Float norm = (this->a * this->d);
HXDLIN( 510)		Float norm1 = (norm - (this->b * this->c));
HXLINE( 512)		if ((norm1 == (int)0)) {
HXLINE( 514)			this->a = (this->b = (this->c = (this->d = (int)0)));
HXLINE( 515)			this->tx = -(this->tx);
HXLINE( 516)			this->ty = -(this->ty);
            		}
            		else {
HXLINE( 520)			norm1 = ((Float)((Float)1.0) / (Float)norm1);
HXLINE( 521)			Float a1 = (this->d * norm1);
HXLINE( 522)			this->d = (this->a * norm1);
HXLINE( 523)			this->a = a1;
HXLINE( 524)			 ::openfl::geom::Matrix _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 524)			_hx_tmp->b = (_hx_tmp->b * -(norm1));
HXLINE( 525)			 ::openfl::geom::Matrix _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 525)			_hx_tmp1->c = (_hx_tmp1->c * -(norm1));
HXLINE( 527)			Float tx1 = (-(this->a) * this->tx);
HXDLIN( 527)			Float tx11 = (tx1 - (this->c * this->ty));
HXLINE( 528)			Float _hx_tmp2 = (-(this->b) * this->tx);
HXDLIN( 528)			this->ty = (_hx_tmp2 - (this->d * this->ty));
HXLINE( 529)			this->tx = tx11;
            		}
...
HXLINE( 565)		Float a1 = (this->a * cos);
HXDLIN( 565)		Float a11 = (a1 - (this->b * sin));
HXLINE( 566)		Float _hx_tmp = (this->a * sin);
HXDLIN( 566)		this->b = (_hx_tmp + (this->b * cos));
HXLINE( 567)		this->a = a11;
HXLINE( 569)		Float c1 = (this->c * cos);
HXDLIN( 569)		Float c11 = (c1 - (this->d * sin));
HXLINE( 570)		Float _hx_tmp1 = (this->c * sin);
HXDLIN( 570)		this->d = (_hx_tmp1 + (this->d * cos));
HXLINE( 571)		this->c = c11;
HXLINE( 573)		Float tx1 = (this->tx * cos);
HXDLIN( 573)		Float tx11 = (tx1 - (this->ty * sin));
HXLINE( 574)		Float _hx_tmp2 = (this->tx * sin);
HXDLIN( 574)		this->ty = (_hx_tmp2 + (this->ty * cos));
HXLINE( 575)		this->tx = tx11;
            	}
...
HXDLIN( 684)		Float _hx_tmp = (pos->x * this->a);
HXDLIN( 684)		Float _hx_tmp1 = (pos->x * this->b);
HXDLIN( 684)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,((_hx_tmp + (pos->y * this->c)) + this->tx),((_hx_tmp1 + (pos->y * this->d)) + this->ty));
            	}
...
HXDLIN( 712)				::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)4),val1);
            			}
HXLINE( 713)			{
HXLINE( 713)				 ::lime::utils::ArrayBufferView this4 = this->_hx___array;
HXDLIN( 713)				::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)8),(int)0);
            			}
HXLINE( 714)			{
HXLINE( 714)				 ::lime::utils::ArrayBufferView this5 = this->_hx___array;
HXDLIN( 714)				Float val2 = this->c;
HXDLIN( 714)				::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)12),val2);
            			}
HXLINE( 715)			{
HXLINE( 715)				 ::lime::utils::ArrayBufferView this6 = this->_hx___array;
HXDLIN( 715)				Float val3 = this->d;
HXDLIN( 715)				::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)16),val3);
            			}
HXLINE( 716)			{
HXLINE( 716)				 ::lime::utils::ArrayBufferView this7 = this->_hx___array;
HXDLIN( 716)				::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)20),(int)0);
            			}
HXLINE( 717)			{
HXLINE( 717)				 ::lime::utils::ArrayBufferView this8 = this->_hx___array;
HXDLIN( 717)				Float val4 = this->tx;
HXDLIN( 717)				::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)24),val4);
            			}
HXLINE( 718)			{
HXLINE( 718)				 ::lime::utils::ArrayBufferView this9 = this->_hx___array;
HXDLIN( 718)				Float val5 = this->ty;
HXDLIN( 718)				::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)28),val5);
            			}
HXLINE( 719)			{
HXLINE( 719)				 ::lime::utils::ArrayBufferView this10 = this->_hx___array;
HXDLIN( 719)				::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + (int)32),(int)1);
            			}
            		}
            		else {
HXLINE( 723)			{
...
HXDLIN( 724)				::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + (int)4),val7);
            			}
HXLINE( 725)			{
HXLINE( 725)				 ::lime::utils::ArrayBufferView this13 = this->_hx___array;
HXDLIN( 725)				Float val8 = this->tx;
HXDLIN( 725)				::__hxcpp_memory_set_float(this13->buffer->b,(this13->byteOffset + (int)8),val8);
            			}
HXLINE( 726)			{
HXLINE( 726)				 ::lime::utils::ArrayBufferView this14 = this->_hx___array;
HXDLIN( 726)				Float val9 = this->b;
HXDLIN( 726)				::__hxcpp_memory_set_float(this14->buffer->b,(this14->byteOffset + (int)12),val9);
            			}
HXLINE( 727)			{
HXLINE( 727)				 ::lime::utils::ArrayBufferView this15 = this->_hx___array;
HXDLIN( 727)				Float val10 = this->d;
HXDLIN( 727)				::__hxcpp_memory_set_float(this15->buffer->b,(this15->byteOffset + (int)16),val10);
            			}
HXLINE( 728)			{
HXLINE( 728)				 ::lime::utils::ArrayBufferView this16 = this->_hx___array;
HXDLIN( 728)				Float val11 = this->ty;
HXDLIN( 728)				::__hxcpp_memory_set_float(this16->buffer->b,(this16->byteOffset + (int)20),val11);
            			}
HXLINE( 729)			{
HXLINE( 729)				 ::lime::utils::ArrayBufferView this17 = this->_hx___array;
HXDLIN( 729)				::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + (int)24),(int)0);
            			}
HXLINE( 730)			{
HXLINE( 730)				 ::lime::utils::ArrayBufferView this18 = this->_hx___array;
HXDLIN( 730)				::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + (int)28),(int)0);
            			}
HXLINE( 731)			{
HXLINE( 731)				 ::lime::utils::ArrayBufferView this19 = this->_hx___array;
HXDLIN( 731)				::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + (int)32),(int)1);
            			}
            		}
...
HXLINE( 740)		this->a = ((Float)::Math_obj::round((this->a * (int)1000)) / (Float)(int)1000);
HXLINE( 741)		this->b = ((Float)::Math_obj::round((this->b * (int)1000)) / (Float)(int)1000);
HXLINE( 742)		this->c = ((Float)::Math_obj::round((this->c * (int)1000)) / (Float)(int)1000);
HXLINE( 743)		this->d = ((Float)::Math_obj::round((this->d * (int)1000)) / (Float)(int)1000);
HXLINE( 744)		this->tx = ((Float)::Math_obj::round((this->tx * (int)10)) / (Float)(int)10);
HXLINE( 745)		this->ty = ((Float)::Math_obj::round((this->ty * (int)10)) / (Float)(int)10);
            	}
...
HXLINE( 758)		Float norm = (this->a * this->d);
HXDLIN( 758)		Float norm1 = (norm - (this->b * this->c));
HXLINE( 760)		if ((norm1 == (int)0)) {
HXLINE( 762)			point->x = -(this->tx);
HXLINE( 763)			point->y = -(this->ty);
            		}
            		else {
HXLINE( 767)			Float px = this->c;
HXDLIN( 767)			Float px1 = (px * (this->ty - point->y));
HXDLIN( 767)			Float px2 = this->d;
HXDLIN( 767)			Float px3 = (((Float)((Float)1.0) / (Float)norm1) * (px1 + (px2 * (point->x - this->tx))));
HXLINE( 768)			Float _hx_tmp = this->a;
HXDLIN( 768)			Float _hx_tmp1 = (_hx_tmp * (point->y - this->ty));
HXDLIN( 768)			Float _hx_tmp2 = this->b;
HXDLIN( 768)			point->y = (((Float)((Float)1.0) / (Float)norm1) * (_hx_tmp1 + (_hx_tmp2 * (this->tx - point->x))));
HXLINE( 769)			point->x = px3;
            		}
            	}
...
HXLINE( 789)		Float norm = (this->a * this->d);
HXDLIN( 789)		Float norm1 = (norm - (this->b * this->c));
HXLINE( 791)		if ((norm1 == (int)0)) {
HXLINE( 793)			return -(this->ty);
            		}
            		else {
HXLINE( 797)			Float _hx_tmp = this->a;
HXDLIN( 797)			Float _hx_tmp1 = (_hx_tmp * (py - this->ty));
HXDLIN( 797)			Float _hx_tmp2 = this->b;
HXDLIN( 797)			return (((Float)((Float)1.0) / (Float)norm1) * (_hx_tmp1 + (_hx_tmp2 * (this->tx - px))));
            		}
...
HXLINE( 806)		Float _hx_tmp = (px * this->a);
HXDLIN( 806)		point->x = ((_hx_tmp + (py * this->c)) + this->tx);
HXLINE( 807)		Float _hx_tmp1 = (px * this->b);
HXDLIN( 807)		point->y = ((_hx_tmp1 + (py * this->d)) + this->ty);
            	}
...
HXDLIN( 812)		Float _hx_tmp = (px * this->a);
HXDLIN( 812)		return ((_hx_tmp + (py * this->c)) + this->tx);
            	}
...
HXDLIN( 817)		Float _hx_tmp = (px * this->b);
HXDLIN( 817)		return ((_hx_tmp + (py * this->d)) + this->ty);
            	}
...
HXLINE( 822)		Float _hx_tmp = (px * this->a);
HXDLIN( 822)		this->tx = ((_hx_tmp + (py * this->c)) + this->tx);
HXLINE( 823)		Float _hx_tmp1 = (px * this->b);
HXDLIN( 823)		this->ty = ((_hx_tmp1 + (py * this->d)) + this->ty);
            	}
