...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::NV_fence)(__this) )->FENCE_CONDITION_NV = (int)34036;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::NV_fence)(__this) )->FENCE_STATUS_NV = (int)34035;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::NV_fence)(__this) )->ALL_COMPLETED_NV = (int)34034;
            	}
