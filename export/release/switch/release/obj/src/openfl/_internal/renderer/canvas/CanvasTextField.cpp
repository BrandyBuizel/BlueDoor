...
HX_LOCAL_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_29_render,"openfl._internal.renderer.canvas.CanvasTextField","render",0xbf0ed28a,"openfl._internal.renderer.canvas.CanvasTextField.render","openfl/_internal/renderer/canvas/CanvasTextField.hx",29,0xcdf61a26)
HX_LOCAL_STACK_FRAME(_hx_pos_33c2fcb60c1e8950_21_boot,"openfl._internal.renderer.canvas.CanvasTextField","boot",0x6b18f666,"openfl._internal.renderer.canvas.CanvasTextField.boot","openfl/_internal/renderer/canvas/CanvasTextField.hx",21,0xcdf61a26)
namespace openfl{
namespace _internal{
namespace renderer{
namespace canvas{
...
void CanvasTextField_obj::render( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer, ::openfl::geom::Matrix transform){
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_29_render)
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_33c2fcb60c1e8950_21_boot)
