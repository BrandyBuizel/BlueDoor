...
HXLINE( 227)		this->x = (int)0;
HXLINE( 228)		this->y = (int)0;
HXLINE( 230)		this->_time = (int)0;
...
HXLINE( 238)		this->_radius = (int)0;
HXLINE( 239)		this->_proximityPan = false;
HXLINE( 240)		this->set_visible(false);
HXLINE( 241)		this->amplitude = (int)0;
HXLINE( 242)		this->amplitudeLeft = (int)0;
HXLINE( 243)		this->amplitudeRight = (int)0;
...
HXLINE( 248)		this->_transform->pan = (int)0;
            	}
...
HXDLIN( 294)			radialMultiplier = ((Float)radialMultiplier1 / (Float)this->_radius);
HXLINE( 295)			targetPosition->put();
HXLINE( 296)			Float lowerBound;
HXDLIN( 296)			if ((radialMultiplier < (int)0)) {
HXLINE( 296)				lowerBound = (int)0;
            			}
            			else {
HXLINE( 296)				lowerBound = radialMultiplier;
            			}
HXDLIN( 296)			 ::Dynamic radialMultiplier2;
HXDLIN( 296)			if ((lowerBound > (int)1)) {
HXLINE( 296)				radialMultiplier2 = (int)1;
            			}
            			else {
HXLINE( 296)				radialMultiplier2 = lowerBound;
            			}
HXDLIN( 296)			radialMultiplier = ((int)1 - radialMultiplier2);
HXLINE( 298)			if (this->_proximityPan) {
HXLINE( 300)				Float d = ((Float)(this->x - this->_target->x) / (Float)this->_radius);
HXLINE( 301)				Float lowerBound1;
HXDLIN( 301)				if ((d < (int)-1)) {
HXLINE( 301)					lowerBound1 = (int)-1;
            				}
            				else {
HXLINE( 301)					lowerBound1 = d;
            				}
HXDLIN( 301)				 ::Dynamic _hx_tmp;
HXDLIN( 301)				if ((lowerBound1 > (int)1)) {
HXLINE( 301)					_hx_tmp = (int)1;
            				}
            				else {
HXLINE( 301)					_hx_tmp = lowerBound1;
            				}
...
HXLINE( 308)		if ((this->_transform->volume > (int)0)) {
HXLINE( 310)			this->amplitudeLeft = ((Float)this->_channel->leftPeak / (Float)this->_transform->volume);
HXLINE( 311)			this->amplitudeRight = ((Float)this->_channel->rightPeak / (Float)this->_transform->volume);
HXLINE( 312)			this->amplitude = ((this->amplitudeLeft + this->amplitudeRight) * ((Float)0.5));
            		}
            		else {
HXLINE( 316)			this->amplitudeLeft = (int)0;
HXLINE( 317)			this->amplitudeRight = (int)0;
HXLINE( 318)			this->amplitude = (int)0;
            		}
HXLINE( 321)		bool _hx_tmp1;
HXDLIN( 321)		if (hx::IsNotNull( this->endTime )) {
HXLINE( 321)			_hx_tmp1 = hx::IsGreaterEq( this->_time,this->endTime );
            		}
            		else {
...
HXLINE( 347)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::openfl::media::Sound >())) {
HXLINE( 349)			this->_sound = ( ( ::openfl::media::Sound)(EmbeddedSound) );
            		}
            		else {
HXLINE( 351)			if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::hx::Class >())) {
HXLINE( 353)				this->_sound = ( ( ::openfl::media::Sound)(::Type_obj::createInstance(EmbeddedSound,::cpp::VirtualArray_obj::__new(0))) );
            			}
            			else {
HXLINE( 355)				if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >())) {
...
HXLINE( 360)						 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
            					}
            				}
            			}
            		}
...
HXLINE( 416)			_hx_tmp = this->_sound->get_length();
            		}
...
HXLINE( 515)		this->fadeTween = ::flixel::tweens::FlxTween_obj::num(this->_volume,To,Duration, ::Dynamic(hx::Anon_obj::Create(1)
...
HXLINE( 573)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 573)			_hx_tmp = (int)1;
            		}
...
HXLINE( 574)			_hx_tmp1 = (int)1;
            		}
HXLINE( 573)		this->_transform->volume = ((((_hx_tmp * ::flixel::FlxG_obj::sound->volume) * _hx_tmp1) * this->_volume) * this->_volumeAdjust);
...
HXLINE( 591)		this->_channel = this->_sound->play(this->_time,(int)0,this->_transform);
...
HXDLIN( 716)		if ((Volume < (int)0)) {
HXLINE( 716)			lowerBound = (int)0;
            		}
            		else {
HXLINE( 716)			lowerBound = Volume;
            		}
HXDLIN( 716)		 ::Dynamic _hx_tmp;
HXDLIN( 716)		if ((lowerBound > (int)1)) {
HXLINE( 716)			_hx_tmp = (int)1;
            		}
            		else {
...
HXDLIN( 768)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN( 769)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXDLIN( 770)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
...
HXLINE( 767)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_this3));
            	}
...
static hx::StorageInfo FlxSound_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::media::Sound*/ ,(int)offsetof(FlxSound_obj,_sound),HX_HCSTRING("_sound","\x10","\xd4","\xb3","\x7c")},
	{hx::fsObject /*::openfl::media::SoundChannel*/ ,(int)offsetof(FlxSound_obj,_channel),HX_HCSTRING("_channel","\x44","\x5a","\x8a","\x06")},
