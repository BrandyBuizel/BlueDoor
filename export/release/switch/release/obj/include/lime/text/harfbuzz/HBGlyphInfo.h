...
class HXCPP_CLASS_ATTRIBUTES HBGlyphInfo_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< HBGlyphInfo_obj > __new() {
			hx::ObjectPtr< HBGlyphInfo_obj > __this = new HBGlyphInfo_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< HBGlyphInfo_obj > __alloc(hx::Ctx *_hx_ctx) {
			...
			*(void **)__this = HBGlyphInfo_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_HCSTRING("HBGlyphInfo","\xe0","\x99","\xdb","\xf5"); }
