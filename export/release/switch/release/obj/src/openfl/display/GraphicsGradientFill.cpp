...
HXLINE( 182)			type = (int)0;
            		}
HXLINE( 185)		if (hx::IsNull( spreadMethod )) {
HXLINE( 187)			spreadMethod = (int)0;
            		}
HXLINE( 190)		if (hx::IsNull( interpolationMethod )) {
HXLINE( 192)			interpolationMethod = (int)1;
            		}
...
HXLINE( 203)		this->_hx___graphicsDataType = (int)2;
HXLINE( 204)		this->_hx___graphicsFillType = (int)1;
            	}
...
static hx::StorageInfo GraphicsGradientFill_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsGradientFill_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{hx::fsInt,(int)offsetof(GraphicsGradientFill_obj,_hx___graphicsFillType),HX_HCSTRING("__graphicsFillType","\xe8","\x75","\xeb","\x27")},
	{ hx::fsUnknown, 0, null()}
};
