...
HXLINE(  43)		this->_hx___worldAlpha = (int)1;
            	}
...
void DisplayObjectRenderer_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("__overrideBlendMode","\x48","\x21","\xda","\xac"));
...
static hx::StorageInfo DisplayObjectRenderer_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(DisplayObjectRenderer_obj,_hx___cleared),HX_HCSTRING("__cleared","\x0c","\x58","\x93","\x2c")},
	...
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(DisplayObjectRenderer_obj,_hx___overrideBlendMode),HX_HCSTRING("__overrideBlendMode","\x48","\x21","\xda","\xac")},
...
static ::String DisplayObjectRenderer_obj_sMemberFields[] = {
	...
	HX_HCSTRING("__overrideBlendMode","\x48","\x21","\xda","\xac"),
