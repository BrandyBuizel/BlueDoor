...
HXLINE( 303)		if (hx::IsNotNull( format->url )) {
HXLINE( 303)			this->url = format->url;
            		}
HXLINE( 304)		if (hx::IsNotNull( format->target )) {
HXLINE( 304)			this->target = format->target;
            		}
HXLINE( 305)		if (hx::IsNotNull( format->align )) {
HXLINE( 305)			this->align = format->align;
            		}
HXLINE( 306)		if (hx::IsNotNull( format->leftMargin )) {
HXLINE( 306)			this->leftMargin = format->leftMargin;
            		}
HXLINE( 307)		if (hx::IsNotNull( format->rightMargin )) {
HXLINE( 307)			this->rightMargin = format->rightMargin;
            		}
HXLINE( 308)		if (hx::IsNotNull( format->indent )) {
HXLINE( 308)			this->indent = format->indent;
            		}
HXLINE( 309)		if (hx::IsNotNull( format->leading )) {
HXLINE( 309)			this->leading = format->leading;
            		}
HXLINE( 310)		if (hx::IsNotNull( format->blockIndent )) {
HXLINE( 310)			this->blockIndent = format->blockIndent;
            		}
HXLINE( 311)		if (hx::IsNotNull( format->bullet )) {
HXLINE( 311)			this->bullet = format->bullet;
            		}
HXLINE( 312)		if (hx::IsNotNull( format->kerning )) {
HXLINE( 312)			this->kerning = format->kerning;
            		}
HXLINE( 313)		if (hx::IsNotNull( format->letterSpacing )) {
HXLINE( 313)			this->letterSpacing = format->letterSpacing;
            		}
HXLINE( 314)		if (hx::IsNotNull( format->tabStops )) {
HXLINE( 314)			this->tabStops = format->tabStops;
            		}
HXLINE( 316)		if (hx::IsNotNull( format->_hx___ascent )) {
HXLINE( 316)			this->_hx___ascent = format->_hx___ascent;
            		}
HXLINE( 317)		if (hx::IsNotNull( format->_hx___descent )) {
HXLINE( 317)			this->_hx___descent = format->_hx___descent;
            		}
            	}
