...
HX_DEFINE_STACK_FRAME(_hx_pos_755626a2d0343a0b_47_new,"LogoImage","new",0x28d6d4c2,"LogoImage.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_fdfbec15190f4556_1_boot,"LogoImage","boot",0x8b3c5590,"LogoImage.boot","?",1,0x0000003f)

void LogoImage_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ::Dynamic transparent = __o_transparent.Default(true);
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_755626a2d0343a0b_47_new)
...
bool LogoImage_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x140eb208) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x140eb208;
	} else {
...
static hx::StaticInfo LogoImage_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &LogoImage_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void LogoImage_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(LogoImage_obj::__mClass,"__mClass");
	HX_MARK_MEMBER_NAME(LogoImage_obj::resourceName,"resourceName");
};

#ifdef HXCPP_VISIT_ALLOCS
static void LogoImage_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(LogoImage_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new LogoImage_obj;
	LogoImage_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("LogoImage","\xd0","\x0b","\xe1","\xd9");
...
{
{
            	HX_STACKFRAME(&_hx_pos_fdfbec15190f4556_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_LogoImage",aa,a8,3b,0a);
            	}
}
