...
::Array< ::Dynamic> FlxArrayUtil_obj::setLength_flixel_system_replay_FrameRecord(::Array< ::Dynamic> array,int newLength){
            	HX_STACKFRAME(&_hx_pos_80883519d7ae1644_16_setLength_flixel_system_replay_FrameRecord)
HXLINE(  17)		if ((newLength < (int)0)) {
HXLINE(  18)			return array;
            		}
HXLINE(  20)		int oldLength = array->length;
...
HXDLIN( 176)		return (array->indexOf(element,null()) != (int)-1);
            	}
...
static ::String FlxArrayUtil_obj_sStaticFields[] = {
	...
	HX_HCSTRING("safePush","\xc7","\xe5","\x64","\x98"),
