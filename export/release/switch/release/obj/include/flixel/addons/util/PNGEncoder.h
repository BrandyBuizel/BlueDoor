...
class HXCPP_CLASS_ATTRIBUTES PNGEncoder_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< PNGEncoder_obj > __new() {
			hx::ObjectPtr< PNGEncoder_obj > __this = new PNGEncoder_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< PNGEncoder_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("PNGEncoder","\x13","\x24","\xb2","\xb4"); }
