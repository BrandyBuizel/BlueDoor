...
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_120_subarray,"lime.utils._UInt16Array.UInt16Array_Impl_","subarray",0xb49bfdea,"lime.utils._UInt16Array.UInt16Array_Impl_.subarray","lime/utils/UInt16Array.hx",120,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_125_fromBytes,"lime.utils._UInt16Array.UInt16Array_Impl_","fromBytes",0x3c5adfb0,"lime.utils._UInt16Array.UInt16Array_Impl_.fromBytes","lime/utils/UInt16Array.hx",125,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_130_toBytes,"lime.utils._UInt16Array.UInt16Array_Impl_","toBytes",0x3715903f,"lime.utils._UInt16Array.UInt16Array_Impl_.toBytes","lime/utils/UInt16Array.hx",130,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_135_get_length,"lime.utils._UInt16Array.UInt16Array_Impl_","get_length",0xb80484c0,"lime.utils._UInt16Array.UInt16Array_Impl_.get_length","lime/utils/UInt16Array.hx",135,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_153_toString,"lime.utils._UInt16Array.UInt16Array_Impl_","toString",0xe5897a7d,"lime.utils._UInt16Array.UInt16Array_Impl_.toString","lime/utils/UInt16Array.hx",153,0x124ad8bc)
HX_LOCAL_STACK_FRAME(_hx_pos_7359f16dc6b9beb0_84_boot,"lime.utils._UInt16Array.UInt16Array_Impl_","boot",0xe126b183,"lime.utils._UInt16Array.UInt16Array_Impl_.boot","lime/utils/UInt16Array.hx",84,0x124ad8bc)
namespace lime{
namespace utils{
...
int UInt16Array_Impl__obj::BYTES_PER_ELEMENT;
 ...
 ::lime::utils::ArrayBufferView UInt16Array_Impl__obj::subarray( ::lime::utils::ArrayBufferView this1,int begin, ::Dynamic end){
            	HX_GC_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_120_subarray)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,subarray,return )
 ...
 ::Dynamic byteOffset = __o_byteOffset.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_125_fromBytes)
HXDLIN( 125)		 ::lime::utils::ArrayBufferView this1;
HXDLIN( 125)		if (hx::IsNotNull( bytes )) {
HXDLIN( 125)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
...
HXDLIN( 125)			HX_STACK_DO_THROW(HX_("Invalid constructor arguments for UInt16Array",0a,c7,2d,d5));
            		}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(UInt16Array_Impl__obj,fromBytes,return )
 ...
 ::haxe::io::Bytes UInt16Array_Impl__obj::toBytes( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_130_toBytes)
...
int UInt16Array_Impl__obj::get_length( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_135_get_length)
...
::String UInt16Array_Impl__obj::toString( ::lime::utils::ArrayBufferView this1){
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_153_toString)
HXDLIN( 153)		if (hx::IsNotNull( this1 )) {
HXDLIN( 153)			return ((((HX_("UInt16Array [byteLength:",b7,19,59,35) + this1->byteLength) + HX_(", length:",a0,04,67,ef)) + this1->length) + HX_("]",5d,00,00,00));
            		}
            		else {
...
{
{
            	HX_STACKFRAME(&_hx_pos_7359f16dc6b9beb0_84_boot)
HXDLIN(  84)		BYTES_PER_ELEMENT = (int)2;
            	}
}
