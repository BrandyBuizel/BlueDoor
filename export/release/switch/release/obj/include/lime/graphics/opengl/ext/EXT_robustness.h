...
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->NO_RESET_NOTIFICATION_EXT = (int)33377;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->LOSE_CONTEXT_ON_RESET_EXT = (int)33362;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->RESET_NOTIFICATION_STRATEGY_EXT = (int)33366;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->CONTEXT_ROBUST_ACCESS_EXT = (int)37107;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->UNKNOWN_CONTEXT_RESET_EXT = (int)33365;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->INNOCENT_CONTEXT_RESET_EXT = (int)33364;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_robustness)(__this) )->GUILTY_CONTEXT_RESET_EXT = (int)33363;
            	}
