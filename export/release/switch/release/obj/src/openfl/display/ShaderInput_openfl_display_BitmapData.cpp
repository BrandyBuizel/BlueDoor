...
HX_DEFINE_STACK_FRAME(_hx_pos_e18280422777664c_140_new,"openfl.display.ShaderInput_openfl_display_BitmapData","new",0x3cac89f3,"openfl.display.ShaderInput_openfl_display_BitmapData.new","openfl/display/ShaderInput.hx",140,0xcc724ba5)
HX_LOCAL_STACK_FRAME(_hx_pos_e18280422777664c_151___disableGL,"openfl.display.ShaderInput_openfl_display_BitmapData","__disableGL",0x1fba3f80,"openfl.display.ShaderInput_openfl_display_BitmapData.__disableGL","openfl/display/ShaderInput.hx",151,0xcc724ba5)
HX_LOCAL_STACK_FRAME(_hx_pos_e18280422777664c_158___updateGL,"openfl.display.ShaderInput_openfl_display_BitmapData","__updateGL",0xe64a7a5b,"openfl.display.ShaderInput_openfl_display_BitmapData.__updateGL","openfl/display/ShaderInput.hx",158,0xcc724ba5)
...
void ShaderInput_openfl_display_BitmapData_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_140_new)
HXLINE( 141)		this->channels = (int)0;
HXLINE( 142)		this->filter = (int)5;
HXLINE( 143)		this->height = (int)0;
HXLINE( 144)		this->index = (int)0;
HXLINE( 145)		this->mipFilter = (int)2;
HXLINE( 146)		this->width = (int)0;
HXLINE( 147)		this->wrap = (int)0;
            	}
...
void ShaderInput_openfl_display_BitmapData_obj::_hx___disableGL( ::openfl::display3D::Context3D context,int id){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_151___disableGL)
...
void ShaderInput_openfl_display_BitmapData_obj::_hx___updateGL( ::openfl::display3D::Context3D context,int id, ::openfl::display::BitmapData overrideInput, ::Dynamic overrideFilter, ::Dynamic overrideMipFilter, ::Dynamic overrideWrap){
            	HX_STACKFRAME(&_hx_pos_e18280422777664c_158___updateGL)
HXLINE( 159)		 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = context->gl;
HXLINE( 160)		 ::openfl::display::BitmapData input;
...
HXLINE( 169)			 ::openfl::display::BitmapData bitmapData = input;
