...
HX_DEFINE_STACK_FRAME(_hx_pos_fcfbd4dc8a597209_47_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleXY","new",0x6ddd6519,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleXY.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_a971c769a541528c_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleXY","boot",0xabf41159,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleXY.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformCursorScaleXY_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_fcfbd4dc8a597209_47_new)
...
bool GraphicTransformCursorScaleXY_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x02b4c79b) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x02b4c79b;
	} else {
...
void GraphicTransformCursorScaleXY_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleXY","\xa7","\xe4","\xf4","\x40");
...
{
{
            	HX_STACKFRAME(&_hx_pos_a971c769a541528c_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorScaleXY",6f,8f,8d,55);
            	}
}
