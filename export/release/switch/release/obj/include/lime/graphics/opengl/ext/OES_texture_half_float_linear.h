...
class HXCPP_CLASS_ATTRIBUTES OES_texture_half_float_linear_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< OES_texture_half_float_linear_obj > __new() {
			hx::ObjectPtr< OES_texture_half_float_linear_obj > __this = new OES_texture_half_float_linear_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< OES_texture_half_float_linear_obj > __alloc(hx::Ctx *_hx_ctx) {
			...
			*(void **)__this = OES_texture_half_float_linear_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_HCSTRING("OES_texture_half_float_linear","\x8e","\x83","\x0b","\x8c"); }
