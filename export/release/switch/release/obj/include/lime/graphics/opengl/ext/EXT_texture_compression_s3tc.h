...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_s3tc)(__this) )->COMPRESSED_RGBA_S3TC_DXT5_EXT = (int)33779;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_s3tc)(__this) )->COMPRESSED_RGBA_S3TC_DXT3_EXT = (int)33778;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_s3tc)(__this) )->COMPRESSED_RGBA_S3TC_DXT1_EXT = (int)33777;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_texture_compression_s3tc)(__this) )->COMPRESSED_RGB_S3TC_DXT1_EXT = (int)33776;
            	}
