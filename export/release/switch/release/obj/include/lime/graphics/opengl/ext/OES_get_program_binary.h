...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_get_program_binary)(__this) )->PROGRAM_BINARY_FORMATS_OES = (int)34815;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_get_program_binary)(__this) )->NUM_PROGRAM_BINARY_FORMATS_OES = (int)34814;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_get_program_binary)(__this) )->PROGRAM_BINARY_LENGTH_OES = (int)34625;
            	}
