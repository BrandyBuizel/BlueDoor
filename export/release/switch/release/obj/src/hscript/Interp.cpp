...
HXLINE(  71)		this->variables->set(HX_("null",87,9e,0e,49),null());
...
HXLINE(  77)				if ((el->get_length() > (int)0)) {
...
HXDLIN(  98)			return (_hx_tmp1 - me->expr(e21));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN(  99)			return (_hx_tmp2 * me->expr(e22));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 107)			return hx::UShr(_hx_tmp10,me->expr(e210));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 117)			return  ::IntIterator_obj::__alloc( HX_CTX ,_hx_tmp17,me->expr(e219));
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 121)			return ((Float)v13 / (Float)v23);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 123)			return ((int)v15 & (int)v25);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 124)			return ((int)v16 | (int)v26);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 125)			return ((int)v17 ^ (int)v27);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 126)			return ((int)v18 << (int)v28);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 127)			return ((int)v19 >> (int)v29);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXLINE( 133)		switch((int)(_hx_getEnumValueIndex(e1))){
            			case (int)1: {
HXLINE( 134)				::String id = e1->_hx_getString(0);
HXDLIN( 134)				{
HXLINE( 135)					 ::Dynamic l = ::haxe::IMap_obj::get(this->locals,id);
HXLINE( 136)					if (hx::IsNull( l )) {
HXLINE( 137)						::haxe::IMap_obj::set(this->variables,id,v);
            					}
            					else {
...
HXLINE( 146)						::haxe::IMap_obj::set(arr,index1,v);
            					}
            					else {
...
HXLINE( 165)		switch((int)(_hx_getEnumValueIndex(e1))){
            			case (int)1: {
...
HXLINE( 170)						::haxe::IMap_obj::set(this->variables,id,v);
            					}
            					else {
...
HXLINE( 181)						 ::Dynamic v3 = ::haxe::IMap_obj::get(arr,index1);
HXDLIN( 181)						v = fop(v3,this->expr(e2));
HXLINE( 182)						::haxe::IMap_obj::set(arr,index1,v);
            					}
            					else {
...
HXDLIN( 199)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)1: {
HXLINE( 200)				::String id = e->_hx_getString(0);
HXLINE( 201)				 ::Dynamic l = ::haxe::IMap_obj::get(this->locals,id);
HXLINE( 202)				 ::Dynamic v;
HXDLIN( 202)				if (hx::IsNull( l )) {
HXLINE( 202)					v = ::haxe::IMap_obj::get(this->variables,id);
            				}
            				else {
...
HXLINE( 205)						::haxe::IMap_obj::set(this->variables,id,v);
            					}
            					else {
...
HXLINE( 207)						::haxe::IMap_obj::set(this->variables,id,(v + delta));
            					}
            					else {
...
HXLINE( 222)					int v2 = ( (int)(::haxe::IMap_obj::get(arr,index1)) );
HXLINE( 223)					if (prefix) {
HXLINE( 224)						v2 = (v2 + delta);
HXLINE( 225)						::haxe::IMap_obj::set(arr,index1,v2);
            					}
            					else {
HXLINE( 228)						::Dynamic _hx_tmp = arr;
HXDLIN( 228)						::haxe::IMap_obj::set(_hx_tmp,index1,(v2 + delta));
            					}
...
HXLINE( 261)				switch((int)(_hx_getEnumValueIndex(e1))){
            					case (int)0: {
...
HXLINE( 460)						::haxe::IMap_obj::set(this->variables,name,f5);
            					}
            					else {
...
HXLINE( 478)							 ::hscript::Expr e19 = arr1->__get(_g12).StaticCast<  ::hscript::Expr >();
HXDLIN( 478)							_g12 = (_g12 + (int)1);
HXLINE( 479)							if ((_hx_getEnumValueIndex(e19) == (int)6)) {
HXLINE( 479)								if ((e19->_hx_getString(0) == HX_("=>",61,35,00,00))) {
...
HXLINE( 507)							 ::hscript::Expr e20 = arr1->__get(_g14).StaticCast<  ::hscript::Expr >();
...
HXLINE( 523)						 ::hscript::Expr e23 = params2->__get(_g6).StaticCast<  ::hscript::Expr >();
...
HXLINE( 553)						 ::Dynamic f6 = fl->__get(_g7);
...
HXLINE( 390)				return null();
            			...
            			break;
            			case (int)25: {
HXLINE( 575)				 ::hscript::Expr e29 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE( 576)				return this->expr(e29);
            			}
            			break;
            			case (int)26: {
HXLINE( 577)				 ::hscript::Expr e30 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
...
HXLINE( 587)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 589)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
...
HXLINE( 604)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 606)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
...
HXDLIN( 622)		if (hx::IsNotNull(  ::Dynamic(v->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)) )) {
HXLINE( 622)			_hx_tmp = hx::IsNull(  ::Dynamic(v->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)) );
            		}
            		else {
...
HXLINE( 633)				this->expr(e);
            				...
            				if (_hx_e.IsClass<  ::hscript::_Interp::Stop >() ){
            					HX_STACK_BEGIN_CATCH
            					 ::hscript::_Interp::Stop err = _hx_e;
HXLINE( 635)					switch((int)(_hx_getEnumValueIndex(err))){
            						case (int)0: {
...
HXDLIN( 650)		return ::haxe::IMap_obj::get(map,key);
            	}
...
HXDLIN( 654)		::haxe::IMap_obj::set(map,key,value);
            	}
...
static ::String Interp_obj_sMemberFields[] = {
	...
	HX_HCSTRING("resetVariables","\xe8","\x46","\xd3","\xdc"),
