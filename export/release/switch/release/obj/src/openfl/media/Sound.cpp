...
HXLINE( 271)		this->bytesLoaded = (int)0;
HXLINE( 272)		this->bytesTotal = (int)0;
...
HXLINE( 475)			_hx_tmp = (bytesLength <= (int)0);
            		}
            		else {
...
HXLINE( 576)			bitsPerSample = (int)32;
            		}
            		else {
HXLINE( 576)			bitsPerSample = (int)16;
            		}
HXLINE( 577)		int channels;
HXDLIN( 577)		if (stereo) {
HXLINE( 577)			channels = (int)2;
            		}
            		else {
HXLINE( 577)			channels = (int)1;
            		}
HXLINE( 578)		int bytesLength = ::Std_obj::_hx_int(((samples * channels) * ((Float)bitsPerSample / (Float)(int)8)));
HXLINE( 580)		bool _hx_tmp;
HXDLIN( 580)		int a = bytes->position;
HXDLIN( 580)		bool aNeg = (a < (int)0);
HXDLIN( 580)		bool bNeg = ((int)0 < (int)0);
HXDLIN( 580)		bool _hx_tmp1;
HXDLIN( 580)		if ((aNeg != bNeg)) {
HXLINE( 580)			_hx_tmp1 = aNeg;
            		}
            		else {
HXLINE( 580)			_hx_tmp1 = (a > (int)0);
            		}
HXDLIN( 580)		if (!(_hx_tmp1)) {
HXLINE( 580)			int a1 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(bytes);
HXDLIN( 580)			bool aNeg1 = (a1 < (int)0);
HXDLIN( 580)			bool bNeg1 = (bytesLength < (int)0);
...
HXLINE( 591)		 ::haxe::io::Bytes buffer = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::toArrayBuffer(bytes);
HXDLIN( 591)		 ::lime::utils::ArrayBufferView this2;
HXDLIN( 591)		if (hx::IsNotNull( buffer )) {
HXLINE( 591)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 591)			int in_byteOffset = (int)0;
HXDLIN( 591)			if ((in_byteOffset < (int)0)) {
HXLINE( 591)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 591)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 591)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 591)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 591)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 591)				if ((newByteLength < (int)0)) {
HXLINE( 591)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXLINE( 623)			_hx_tmp = (::openfl::media::SoundMixer_obj::_hx___soundChannels->length >= (int)32);
            		}
            		else {
...
HXLINE( 639)		if ((pan > (int)1)) {
HXLINE( 639)			pan = (int)1;
            		}
HXLINE( 640)		if ((pan < (int)-1)) {
HXLINE( 640)			pan = (int)-1;
            		}
...
HXLINE( 646)		if ((loops > (int)1)) {
HXLINE( 646)			source->set_loops((loops - (int)1));
            		}
HXLINE( 648)		source->set_gain(volume);
HXLINE( 650)		 ::lime::math::Vector4 position = source->get_position();
HXLINE( 651)		position->x = pan;
HXLINE( 652)		position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
...
HXLINE( 677)				int samples = (this->_hx___buffer->data->length * (int)8);
HXDLIN( 677)				Float samples1 = ((Float)samples / (Float)(this->_hx___buffer->channels * this->_hx___buffer->bitsPerSample));
HXLINE( 678)				return ::Std_obj::_hx_int((((Float)samples1 / (Float)this->_hx___buffer->sampleRate) * (int)1000));
            			}
            			else {
...
HXDLIN( 682)					if ((_hx_tmp != ((int)_hx_int64_low(x) >> (int)(int)31))) {
HXLINE( 682)						HX_STACK_DO_THROW(HX_("Overflow",62,9f,ed,1a));
            					}
HXDLIN( 682)					int samples2 = _hx_int64_low(x);
HXLINE( 683)					return ::Std_obj::_hx_int((((Float)samples2 / (Float)this->_hx___buffer->sampleRate) * (int)1000));
            				}
            				else {
HXLINE( 687)					return (int)0;
            				}
            			}
            		}
