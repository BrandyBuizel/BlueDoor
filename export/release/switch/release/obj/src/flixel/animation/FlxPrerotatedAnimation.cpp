...
HXLINE(  18)		this->rotations = ::Math_obj::round(((Float)(int)360 / (Float)Baked));
            	}
...
HXLINE(  29)		int angleHelper = ::Math_obj::floor(hx::Mod(Value,(int)360));
HXLINE(  31)		while((angleHelper < (int)0)){
HXLINE(  33)			angleHelper = (angleHelper + (int)360);
            		}
HXLINE(  36)		int newIndex = ::Math_obj::floor((((Float)angleHelper / (Float)this->baked) + ((Float)0.5)));
HXLINE(  37)		newIndex = ::Std_obj::_hx_int(hx::Mod(newIndex,this->rotations));
