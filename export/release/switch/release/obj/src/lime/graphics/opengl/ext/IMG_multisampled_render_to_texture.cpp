...
HXLINE(   9)		this->TEXTURE_SAMPLES_IMG = (int)37174;
HXLINE(   8)		this->MAX_SAMPLES_IMG = (int)37173;
HXLINE(   7)		this->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_IMG = (int)37172;
HXLINE(   6)		this->RENDERBUFFER_SAMPLES_IMG = (int)37171;
            	}
