...
HXLINE( 339)		this->executions = (int)0;
...
HXLINE( 380)			Options->__SetField(HX_("type",ba,f2,08,4d),(int)8,hx::paccDynamic);
            		}
...
HXDLIN( 410)		return this->addChainedTween(::flixel::tweens::FlxTween_obj::num((int)0,(int)0,delay,null(),null()));
            	}
...
HXDLIN( 428)		if ((this->executions > (int)0)) {
...
HXLINE( 433)		this->scale = ((Float)::Math_obj::max((this->_secondsSinceStart - delay),(int)0) / (Float)this->duration);
HXLINE( 434)		if (hx::IsNotNull( this->ease )) {
HXLINE( 436)			this->scale = ( (Float)(this->ease(this->scale)) );
            		}
HXLINE( 438)		if (this->backward) {
HXLINE( 440)			this->scale = ((int)1 - this->scale);
            		}
...
HXLINE( 448)		Float _hx_tmp2 = this->_secondsSinceStart;
HXDLIN( 448)		if ((_hx_tmp2 >= (this->duration + delay))) {
HXLINE( 450)			Float _hx_tmp3;
...
HXDLIN( 450)			this->scale = _hx_tmp3;
...
HXLINE( 466)		this->_secondsSinceStart = (int)0;
HXLINE( 467)		Float _hx_tmp;
HXDLIN( 467)		if ((this->executions > (int)0)) {
...
HXLINE( 468)		if ((this->duration == (int)0)) {
...
HXLINE( 523)		int type = ((int)this->type & (int)~((int)16));
HXLINE( 525)		bool _hx_tmp;
HXDLIN( 525)		if ((type != (int)1)) {
HXLINE( 525)			_hx_tmp = (type == (int)8);
            		}
            		else {
...
HXDLIN( 530)			if ((type == (int)8)) {
HXLINE( 530)				_hx_tmp1 = hx::IsNotNull( this->manager );
            			}
            			else {
...
HXDLIN( 536)		if ((type != (int)2)) {
HXLINE( 536)			_hx_tmp2 = (type == (int)4);
            		}
            		else {
...
HXLINE( 539)			this->scale = ((Float)::Math_obj::max((this->_secondsSinceStart - this->_delayToUse),(int)0) / (Float)this->duration);
HXLINE( 541)			bool _hx_tmp3;
HXDLIN( 541)			bool _hx_tmp4;
HXDLIN( 541)			if (hx::IsNotNull( this->ease )) {
HXLINE( 541)				_hx_tmp4 = (this->scale > (int)0);
            			}
            			else {
HXLINE( 541)				_hx_tmp4 = false;
            			}
HXDLIN( 541)			if (_hx_tmp4) {
HXLINE( 541)				_hx_tmp3 = (this->scale < (int)1);
            			}
            			else {
...
HXLINE( 577)			_hx_tmp = (this->_chainedTweens->length <= (int)0);
            		}
            		else {
...
HXLINE( 633)			_hx_tmp = StartDelay;
            		}
            		else {
HXLINE( 633)			_hx_tmp = (int)0;
            		}
HXDLIN( 633)		this->set_startDelay(_hx_tmp);
HXLINE( 634)		Float _hx_tmp1;
HXDLIN( 634)		if (hx::IsNotNull( LoopDelay )) {
HXLINE( 634)			_hx_tmp1 = LoopDelay;
            		}
            		else {
HXLINE( 634)			_hx_tmp1 = (int)0;
            		}
...
HXLINE( 641)		if ((this->executions == (int)0)) {
HXLINE( 643)			Float _hx_tmp = this->duration;
HXDLIN( 643)			Float _hx_tmp1 = (_hx_tmp * ((Float)::Math_obj::max((this->_secondsSinceStart - this->_delayToUse),(int)0) / (Float)this->duration));
HXDLIN( 643)			this->_secondsSinceStart = (_hx_tmp1 + ::Math_obj::max((dly - this->startDelay),(int)0));
...
HXLINE( 651)		Float dly = ::Math_obj::abs(value);
HXLINE( 652)		if ((this->executions > (int)0)) {
HXLINE( 654)			Float _hx_tmp = this->duration;
HXDLIN( 654)			Float _hx_tmp1 = (_hx_tmp * ((Float)::Math_obj::max((this->_secondsSinceStart - this->_delayToUse),(int)0) / (Float)this->duration));
HXDLIN( 654)			this->_secondsSinceStart = (_hx_tmp1 + ::Math_obj::max((dly - this->loopDelay),(int)0));
...
HXDLIN( 662)		return ((Float)::Math_obj::max((this->_secondsSinceStart - this->_delayToUse),(int)0) / (Float)this->duration);
            	}
...
HXLINE( 672)		if ((value == (int)0)) {
HXLINE( 674)			value = (int)8;
            		}
            		else {
HXLINE( 676)			if ((value == (int)16)) {
HXLINE( 678)				value = ((int)(int)1 | (int)(int)16);
            			}
            		}
HXLINE( 681)		this->backward = (((int)value & (int)(int)16) > (int)0);
