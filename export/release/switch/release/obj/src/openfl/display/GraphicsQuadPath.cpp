...
HXLINE(  71)		this->_hx___graphicsDataType = (int)6;
            	}
...
static hx::StorageInfo GraphicsQuadPath_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsQuadPath_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{ hx::fsUnknown, 0, null()}
};
