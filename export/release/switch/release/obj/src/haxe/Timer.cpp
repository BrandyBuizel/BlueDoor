...
HXDLIN( 277)				int _g = ::haxe::Timer_obj::sRunningTimers->length;
...
HXDLIN( 252)		return ::lime::_hx_system::System_obj::getTimer();
            	}
...
HXDLIN( 257)		Float t0;
HXDLIN( 257)		if ((timer > (int)0)) {
HXLINE( 257)			t0 = ((Float)timer / (Float)(int)1000);
            		}
            		else {
HXLINE( 257)			t0 = (int)0;
            		}
...
HXDLIN( 259)		if ((timer1 > (int)0)) {
HXLINE( 259)			_hx_tmp1 = ((Float)timer1 / (Float)(int)1000);
            		}
            		else {
HXLINE( 259)			_hx_tmp1 = (int)0;
            		}
...
HXLINE( 268)		if ((timer > (int)0)) {
HXLINE( 268)			return ((Float)timer / (Float)(int)1000);
            		}
            		else {
