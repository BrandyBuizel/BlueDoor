...
HX_DEFINE_STACK_FRAME(_hx_pos_fc7225994009fbb7_47_new,"flixel.system.debug.GraphicBitmapLog","new",0xf8da4027,"flixel.system.debug.GraphicBitmapLog.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
...
void GraphicBitmapLog_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_fc7225994009fbb7_47_new)
...
bool GraphicBitmapLog_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x1849f829) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x1849f829;
	} else {
