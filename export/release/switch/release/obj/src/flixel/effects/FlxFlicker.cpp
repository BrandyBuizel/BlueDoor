...
HXDLIN( 144)		this->timer = _hx_tmp->start(_hx_tmp1,this->flickerProgress_dyn(),::Std_obj::_hx_int(((Float)this->duration / (Float)this->interval)));
            	}
...
HXDLIN( 178)		if ((Timer->loops > (int)0)) {
HXLINE( 178)			_hx_tmp = ((Timer->loops - Timer->_loopsCounter) == (int)0);
            		}
            		else {
...
HXLINE(  48)				return ::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object).StaticCast<  ::flixel::effects::FlxFlicker >();
            			}
            		}
HXLINE(  52)		if ((Interval <= (int)0)) {
...
HXLINE(  79)		 ::flixel::effects::FlxFlicker boundFlicker = ::flixel::effects::FlxFlicker_obj::_boundObjects->get(Object).StaticCast<  ::flixel::effects::FlxFlicker >();
