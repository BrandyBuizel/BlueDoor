...
HXDLIN(  89)		Float _hx_tmp = (v->x + this->x);
HXDLIN(  89)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(v->y + this->y));
            	}
...
HXDLIN( 176)		if ((this->x == (int)0)) {
HXDLIN( 176)			_hx_tmp = (this->y == (int)0);
            		}
            		else {
...
HXLINE( 182)			Float norm = (this->x * this->x);
HXDLIN( 182)			Float norm1 = ((Float)thickness / (Float)::Math_obj::sqrt((norm + (this->y * this->y))));
HXLINE( 183)			 ::openfl::geom::Point _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 183)			_hx_tmp1->x = (_hx_tmp1->x * norm1);
HXLINE( 184)			 ::openfl::geom::Point _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 184)			_hx_tmp2->y = (_hx_tmp2->y * norm1);
            		}
            	}
...
HXDLIN( 237)		Float _hx_tmp = (this->x - v->x);
HXDLIN( 237)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(this->y - v->y));
            	}
...
HXDLIN( 269)		Float _hx_tmp = (this->x * this->x);
HXDLIN( 269)		return ::Math_obj::sqrt((_hx_tmp + (this->y * this->y)));
            	}
...
HXDLIN( 162)		Float pt21 = pt2->x;
HXDLIN( 162)		Float _hx_tmp = (pt21 + (f * (pt1->x - pt2->x)));
HXDLIN( 162)		Float pt22 = pt2->y;
HXDLIN( 162)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(pt22 + (f * (pt1->y - pt2->y))));
            	}
...
HXDLIN( 213)		Float _hx_tmp = (len * ::Math_obj::cos(angle));
HXDLIN( 213)		return  ::openfl::geom::Point_obj::__alloc( HX_CTX ,_hx_tmp,(len * ::Math_obj::sin(angle)));
            	}
