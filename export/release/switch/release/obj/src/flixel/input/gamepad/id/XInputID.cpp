...
HXDLIN(  76)		DPAD_UP = (int)17;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_77_boot)
HXDLIN(  77)		DPAD_DOWN = (int)18;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_78_boot)
HXDLIN(  78)		DPAD_LEFT = (int)19;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_79_boot)
HXDLIN(  79)		DPAD_RIGHT = (int)20;
            	}
{
            	HX_GC_STACKFRAME(&_hx_pos_559677d855d318da_81_boot)
HXDLIN(  81)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  87)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  94)		LEFT_TRIGGER = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_559677d855d318da_95_boot)
HXDLIN(  95)		RIGHT_TRIGGER = (int)5;
            	}
}
