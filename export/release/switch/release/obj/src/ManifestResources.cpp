...
HXLINE(  41)			::ManifestResources_obj::rootPath = ::lime::_hx_system::System_obj::get_applicationDirectory();
            		}
...
HXLINE(  57)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_notomono_regular_ttf >());
HXLINE(  58)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_notosans_regular_ttf >());
HXLINE(  59)		::openfl::text::Font_obj::registerFont(hx::ClassOf< ::__ASSET__OPENFL__assets_fonts_notoserif_regular_ttf >());
HXLINE(  63)		 ::Dynamic data;
HXDLIN(  63)		 ::Dynamic manifest;
HXDLIN(  63)		 ::lime::utils::AssetLibrary library;
HXLINE(  76)		{
HXLINE(  76)			::String v = (::ManifestResources_obj::rootPath + HX_("manifest/default.json",95,ea,cc,42));
HXDLIN(  76)			::lime::utils::Assets_obj::libraryPaths->set(HX_("default",c1,d8,c3,9b),v);
            		}
HXLINE(  79)		library = ::lime::utils::Assets_obj::getLibrary(HX_("default",c1,d8,c3,9b));
HXLINE(  80)		if (hx::IsNotNull( library )) {
HXLINE(  80)			::ManifestResources_obj::preloadLibraries->push(library);
            		}
            		else {
HXLINE(  81)			::ManifestResources_obj::preloadLibraryNames->push(HX_("default",c1,d8,c3,9b));
            		}
            	}
...
static hx::StaticInfo ManifestResources_obj_sStaticStorageInfo[] = {
	...
	{hx::fsString,(void *) &ManifestResources_obj::rootPath,HX_HCSTRING("rootPath","\xe7","\xb8","\x88","\xe1")},
	{ hx::fsUnknown, 0, null()}
};
#endif
