...
HXLINE(  14)		this->COVERAGE_BUFFER_BIT_NV = (int)32768;
HXLINE(  13)		this->COVERAGE_AUTOMATIC_NV = (int)36567;
HXLINE(  12)		this->COVERAGE_EDGE_FRAGMENTS_NV = (int)36566;
HXLINE(  11)		this->COVERAGE_ALL_FRAGMENTS_NV = (int)36565;
HXLINE(  10)		this->COVERAGE_SAMPLES_NV = (int)36564;
HXLINE(   9)		this->COVERAGE_BUFFERS_NV = (int)36563;
HXLINE(   8)		this->COVERAGE_ATTACHMENT_NV = (int)36562;
HXLINE(   7)		this->COVERAGE_COMPONENT4_NV = (int)36561;
HXLINE(   6)		this->COVERAGE_COMPONENT_NV = (int)36560;
            	}
