...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::IMG_multisampled_render_to_texture)(__this) )->TEXTURE_SAMPLES_IMG = (int)37174;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::IMG_multisampled_render_to_texture)(__this) )->MAX_SAMPLES_IMG = (int)37173;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::IMG_multisampled_render_to_texture)(__this) )->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_IMG = (int)37172;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::IMG_multisampled_render_to_texture)(__this) )->RENDERBUFFER_SAMPLES_IMG = (int)37171;
            	}
