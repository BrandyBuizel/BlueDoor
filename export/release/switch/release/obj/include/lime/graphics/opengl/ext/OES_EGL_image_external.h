...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::OES_EGL_image_external)(__this) )->REQUIRED_TEXTURE_IMAGE_UNITS_OES = (int)36200;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_EGL_image_external)(__this) )->TEXTURE_BINDING_EXTERNAL_OES = (int)36199;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_EGL_image_external)(__this) )->SAMPLER_EXTERNAL_OES = (int)36198;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_EGL_image_external)(__this) )->TEXTURE_EXTERNAL_OES = (int)36197;
            	}
