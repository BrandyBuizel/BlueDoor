...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_449_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",449,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_471_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",471,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_482_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",482,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_493_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",493,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_497___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",497,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_38_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",38,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_76_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",76,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_106_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",106,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_136_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",136,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_166_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",166,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_196_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",196,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_226_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",226,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_256_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",256,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_286_boot,"openfl.events.TouchEvent","boot",0xf5220b4e,"openfl.events.TouchEvent.boot","openfl/events/TouchEvent.hx",286,0x2fe85d0c)
namespace openfl{
namespace events{
...
bool isTouchPointCanceled = __o_isTouchPointCanceled.Default(false);
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_449_new)
HXLINE( 450)		super::__construct(type,bubbles,cancelable);
HXLINE( 452)		this->touchPointID = touchPointID;
HXLINE( 453)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 454)		this->localX = localX;
HXLINE( 455)		this->localY = localY;
HXLINE( 456)		this->sizeX = sizeX;
HXLINE( 457)		this->sizeY = sizeY;
HXLINE( 458)		this->pressure = pressure;
HXLINE( 459)		this->relatedObject = relatedObject;
HXLINE( 460)		this->ctrlKey = ctrlKey;
HXLINE( 461)		this->altKey = altKey;
HXLINE( 462)		this->shiftKey = shiftKey;
HXLINE( 463)		this->commandKey = commandKey;
HXLINE( 464)		this->controlKey = controlKey;
HXLINE( 466)		this->stageX = ::Math_obj::NaN;
HXLINE( 467)		this->stageY = ::Math_obj::NaN;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_471_clone)
HXLINE( 472)		 ::openfl::events::TouchEvent event =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
HXLINE( 474)		event->target = this->target;
HXLINE( 475)		event->currentTarget = this->currentTarget;
HXLINE( 476)		event->eventPhase = this->eventPhase;
HXLINE( 477)		return event;
            	}


::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_482_toString)
HXDLIN( 482)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_493_updateAfterEvent)
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_497___create)
HXLINE( 498)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,(int)0,true,local->x,local->y,(int)1,(int)1,(int)1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 499)		evt->stageX = stageX;
HXLINE( 500)		evt->stageY = stageY;
HXLINE( 501)		evt->target = target;
HXLINE( 503)		return evt;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_38_boot)
...
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_76_boot)
HXDLIN(  76)		TOUCH_BEGIN = HX_("touchBegin",ea,cd,e6,a9);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_106_boot)
HXDLIN( 106)		TOUCH_END = HX_("touchEnd",5c,c5,09,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_136_boot)
HXDLIN( 136)		TOUCH_MOVE = HX_("touchMove",70,72,cd,0d);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_166_boot)
HXDLIN( 166)		TOUCH_OUT = HX_("touchOut",0f,62,11,00);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_196_boot)
HXDLIN( 196)		TOUCH_OVER = HX_("touchOver",b3,20,25,0f);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_226_boot)
HXDLIN( 226)		TOUCH_ROLL_OUT = HX_("touchRollOut",12,0f,74,87);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_256_boot)
HXDLIN( 256)		TOUCH_ROLL_OVER = HX_("touchRollOver",50,d6,19,fe);
            	}
{
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_286_boot)
HXDLIN( 286)		TOUCH_TAP = HX_("touchTap",e4,1b,15,00);
            	}
}
