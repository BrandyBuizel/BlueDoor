...
HXDLIN(  17)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN(  17)		 ::haxe::io::Bytes _hx_tmp1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  17)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gzip_compress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
...
HXDLIN(  39)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN(  39)		 ::haxe::io::Bytes _hx_tmp1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  39)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_gzip_decompress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
