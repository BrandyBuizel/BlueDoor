...
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_379_updateCustomCursors,"flixel.system.debug.interaction.Interaction","updateCustomCursors",0x218c1283,"flixel.system.debug.interaction.Interaction.updateCustomCursors","flixel/system/debug/interaction/Interaction.hx",379,0x4548a912)
...
HX_LOCAL_STACK_FRAME(_hx_pos_b2dd90bb9bc9fb13_483_setSystemCursorVisibility,"flixel.system.debug.interaction.Interaction","setSystemCursorVisibility",0x3bad5fb9,"flixel.system.debug.interaction.Interaction.setSystemCursorVisibility","flixel/system/debug/interaction/Interaction.hx",483,0x4548a912)
...
HXLINE(  64)		super::__construct(HX_("Tools",fb,01,5c,a7), ::flixel::_hx_system::debug::GraphicInteractive_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()),(int)40,(int)25,false,null(),null(),null());
HXLINE(  65)		this->reposition((int)2,(int)100);
...
HXLINE( 116)				offsetX = ((Float)((Float)cursorIcon->width / (Float)::flixel::FlxG_obj::scaleMode->scale->x) / (Float)(int)2);
HXLINE( 117)				offsetY = ((Float)((Float)cursorIcon->height / (Float)::flixel::FlxG_obj::scaleMode->scale->y) / (Float)(int)2);
            			}
            		}
HXLINE( 121)		 ::openfl::display::Sprite _hx_tmp = this->_customCursor;
HXDLIN( 121)		_hx_tmp->set_x((event->stageX + offsetX));
HXLINE( 122)		 ::openfl::display::Sprite _hx_tmp1 = this->_customCursor;
HXDLIN( 122)		_hx_tmp1->set_y((event->stageY + offsetY));
            	}
...
HXLINE( 155)			if (::Std_obj::is(object,hx::ClassOf< ::flixel::_hx_system::debug::FlxDebugger >())) {
...
HXLINE( 217)		int buttonsPerLine = (int)2;
HXLINE( 218)		int buttons = this->countToolsWithUIButton();
HXLINE( 219)		int lines = ::Std_obj::_hx_int(::Math_obj::ceil(((Float)buttons / (Float)buttonsPerLine)));
HXLINE( 220)		int slot = ::Std_obj::_hx_int(((Float)buttons / (Float)lines));
HXLINE( 222)		button->set_x(((int)-15 + (slot * (int)25)));
HXLINE( 223)		button->set_y(((int)20 * lines));
HXLINE( 225)		this->addChild(button);
HXLINE( 226)		Float _hx_tmp = (((int)25 * ::Math_obj::min(buttons,buttonsPerLine)) + (int)10);
HXDLIN( 226)		this->resize(_hx_tmp,(((int)25 * lines) + (int)10));
            	}
...
HXLINE( 319)		{
HXLINE( 319)			 ::flixel::group::FlxTypedGroupIterator member =  ::flixel::group::FlxTypedGroupIterator_obj::__alloc( HX_CTX ,this->selectedItems->members,null());
...
HXLINE( 324)					gfx->lineStyle(((Float)0.9),(int)16711680,null(),null(),null(),null(),null(),null());
HXLINE( 325)					Float _hx_tmp2 = (member1->x - ::flixel::FlxG_obj::camera->scroll->x);
HXDLIN( 325)					Float _hx_tmp3 = (member1->y - ::flixel::FlxG_obj::camera->scroll->y);
HXDLIN( 325)					Float _hx_tmp4 = member1->get_width();
HXDLIN( 325)					gfx->drawRect(_hx_tmp2,_hx_tmp3,_hx_tmp4,member1->get_height());
            				}
            			}
            		}
...
HXLINE( 345)				if (::Std_obj::is(tool,className)) {
...
void Interaction_obj::updateCustomCursors(){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_379_updateCustomCursors)
            	}
...
void Interaction_obj::setSystemCursorVisibility(bool status){
            	HX_STACKFRAME(&_hx_pos_b2dd90bb9bc9fb13_483_setSystemCursorVisibility)
HXDLIN( 483)		this->_customCursor->set_visible(!(status));
            	}
...
HXLINE( 499)		{
HXLINE( 499)			int _g1 = (int)0;
HXDLIN( 499)			int _g = this->_customCursor->get_numChildren();
...
HXDLIN( 510)		return ( (bool)(this->_keysDown->get(key)) );
            	}
...
HXLINE( 515)			value = (int)0;
            		}
            		else {
HXLINE( 515)			value = ( (int)(this->_keysUp->get(key)) );
            		}
HXLINE( 516)		return ((this->_turn - value) == (int)1);
            	}
...
HXDLIN( 552)			if (!(((i + (int)1) > (int)0))) {
HXLINE( 552)				goto _hx_goto_35;
            			}
...
HXDLIN( 562)				if (::Std_obj::is(member,hx::ClassOf< ::flixel::FlxSprite >())) {
...
HXLINE( 562)						Float Rect1 = Rect->x;
HXDLIN( 562)						result2 = (Rect1 < (area->x + area->width));
            					}
            					else {
...
HXLINE( 562)						Float Rect2 = Rect->y;
HXDLIN( 562)						result = (Rect2 < (area->y + area->height));
            					}
            					else {
...
static ::String Interaction_obj_sMemberFields[] = {
	...
	HX_HCSTRING("isInUse","\x18","\xe9","\x8e","\x5a"),
