...
static void HBFTFont_Impl__obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HBFTFont_Impl__obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void HBFTFont_Impl__obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HBFTFont_Impl__obj::__mClass,"__mClass");
};
...
static ::String HBFTFont_Impl__obj_sStaticFields[] = {
	...
	HX_HCSTRING("get_loadFlags","\x18","\x4b","\x27","\xdf"),
	HX_HCSTRING("set_loadFlags","\x24","\x2d","\x2d","\x24"),
	::String(null())
};

void HBFTFont_Impl__obj::__register()
{
	hx::Object *dummy = new HBFTFont_Impl__obj;
	HBFTFont_Impl__obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.text.harfbuzz._HBFTFont.HBFTFont_Impl_","\x95","\x39","\xf7","\xcd");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &HBFTFont_Impl__obj::__GetStatic;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = HBFTFont_Impl__obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = HBFTFont_Impl__obj_sVisitStatics;
#endif
