...
HXLINE(  84)		this->_hx___numClipRects = (int)0;
HXLINE(  85)		this->_hx___z = (int)0;
...
HXDLIN( 220)		if ((this->_hx___numClipRects > (int)0)) {
HXLINE( 222)			this->_hx___numClipRects--;
HXLINE( 224)			if ((this->_hx___numClipRects > (int)0)) {
HXLINE( 226)				::Array< ::Dynamic> _hx_tmp = this->_hx___clipRects;
HXDLIN( 226)				this->_hx___currentClipRect = _hx_tmp->__get((this->_hx___numClipRects - (int)1)).StaticCast<  ::openfl::geom::Rectangle >();
            			}
            			else {
...
HXLINE( 261)			::Array< ::Dynamic> _hx_tmp = this->_hx___clipRects;
HXDLIN( 261)			int _hx_tmp1 = this->_hx___numClipRects;
HXDLIN( 261)			_hx_tmp[_hx_tmp1] =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,null(),null(),null(),null());
            		}
...
HXLINE( 267)		if ((this->_hx___numClipRects > (int)0)) {
HXLINE( 269)			::Array< ::Dynamic> parentClipRect = this->_hx___clipRects;
HXDLIN( 269)			 ::openfl::geom::Rectangle parentClipRect1 = parentClipRect->__get((this->_hx___numClipRects - (int)1)).StaticCast<  ::openfl::geom::Rectangle >();
HXLINE( 270)			clipRect->_hx___contract(parentClipRect1->x,parentClipRect1->y,parentClipRect1->width,parentClipRect1->height);
            		}
HXLINE( 273)		if ((clipRect->height < (int)0)) {
HXLINE( 275)			clipRect->height = (int)0;
            		}
HXLINE( 278)		if ((clipRect->width < (int)0)) {
HXLINE( 280)			clipRect->width = (int)0;
            		}
