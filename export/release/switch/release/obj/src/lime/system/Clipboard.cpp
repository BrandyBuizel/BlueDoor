...
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_57_get_text,"lime.system.Clipboard","get_text",0xe647e374,"lime.system.Clipboard.get_text","lime/system/Clipboard.hx",57,0x9490b5ee)
HX_LOCAL_STACK_FRAME(_hx_pos_21630ac4203d4998_61_set_text,"lime.system.Clipboard","set_text",0x94a53ce8,"lime.system.Clipboard.set_text","lime/system/Clipboard.hx",61,0x9490b5ee)
...
HXLINE(  32)		::lime::_hx_system::Clipboard_obj::_text = ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_get_text()) );
HXLINE(  42)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE(  44)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
            	}
...
::String Clipboard_obj::get_text(){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_57_get_text)
HXDLIN(  57)		return ::lime::_hx_system::Clipboard_obj::_text;
            	}
...
::String Clipboard_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_21630ac4203d4998_61_set_text)
HXLINE(  62)		::String cacheText = ::lime::_hx_system::Clipboard_obj::_text;
HXLINE(  63)		::lime::_hx_system::Clipboard_obj::_text = value;
HXLINE(  66)		::lime::_internal::backend::native::NativeCFFI_obj::lime_clipboard_set_text(value);
HXLINE(  77)		if ((::lime::_hx_system::Clipboard_obj::_text != cacheText)) {
HXLINE(  79)			::lime::_hx_system::Clipboard_obj::onUpdate->dispatch();
            		}
