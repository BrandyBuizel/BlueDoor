...
HXLINE(  43)		this->STACK_UNDERFLOW = (int)1284;
HXLINE(  42)		this->STACK_OVERFLOW = (int)1283;
HXLINE(  41)		this->CONTEXT_FLAG_DEBUG_BIT = (int)2;
HXLINE(  40)		this->DEBUG_OUTPUT = (int)37600;
HXLINE(  39)		this->DEBUG_SEVERITY_LOW = (int)37192;
HXLINE(  38)		this->DEBUG_SEVERITY_MEDIUM = (int)37191;
HXLINE(  37)		this->DEBUG_SEVERITY_HIGH = (int)37190;
HXLINE(  36)		this->DEBUG_LOGGED_MESSAGES = (int)37189;
HXLINE(  35)		this->MAX_DEBUG_LOGGED_MESSAGES = (int)37188;
HXLINE(  34)		this->MAX_DEBUG_MESSAGE_LENGTH = (int)37187;
HXLINE(  33)		this->MAX_LABEL_LENGTH = (int)33512;
HXLINE(  32)		this->SAMPLER = (int)33510;
HXLINE(  31)		this->QUERY = (int)33507;
HXLINE(  30)		this->PROGRAM = (int)33506;
HXLINE(  29)		this->SHADER = (int)33505;
HXLINE(  28)		this->BUFFER = (int)33504;
HXLINE(  27)		this->DEBUG_GROUP_STACK_DEPTH = (int)33389;
HXLINE(  26)		this->MAX_DEBUG_GROUP_STACK_DEPTH = (int)33388;
HXLINE(  25)		this->DEBUG_SEVERITY_NOTIFICATION = (int)33387;
HXLINE(  24)		this->DEBUG_TYPE_POP_GROUP = (int)33386;
HXLINE(  23)		this->DEBUG_TYPE_PUSH_GROUP = (int)33385;
HXLINE(  22)		this->DEBUG_TYPE_MARKER = (int)33384;
HXLINE(  21)		this->DEBUG_TYPE_OTHER = (int)33361;
HXLINE(  20)		this->DEBUG_TYPE_PERFORMANCE = (int)33360;
HXLINE(  19)		this->DEBUG_TYPE_PORTABILITY = (int)33359;
HXLINE(  18)		this->DEBUG_TYPE_UNDEFINED_BEHAVIOR = (int)33358;
HXLINE(  17)		this->DEBUG_TYPE_DEPRECATED_BEHAVIOR = (int)33357;
HXLINE(  16)		this->DEBUG_TYPE_ERROR = (int)33356;
HXLINE(  15)		this->DEBUG_SOURCE_OTHER = (int)33355;
HXLINE(  14)		this->DEBUG_SOURCE_APPLICATION = (int)33354;
HXLINE(  13)		this->DEBUG_SOURCE_THIRD_PARTY = (int)33353;
HXLINE(  12)		this->DEBUG_SOURCE_SHADER_COMPILER = (int)33352;
HXLINE(  11)		this->DEBUG_SOURCE_WINDOW_SYSTEM = (int)33351;
HXLINE(  10)		this->DEBUG_SOURCE_API = (int)33350;
HXLINE(   9)		this->DEBUG_CALLBACK_USER_PARAM = (int)33349;
HXLINE(   8)		this->DEBUG_CALLBACK_FUNCTION = (int)33348;
HXLINE(   7)		this->DEBUG_NEXT_LOGGED_MESSAGE_LENGTH = (int)33347;
HXLINE(   6)		this->DEBUG_OUTPUT_SYNCHRONOUS = (int)33346;
            	}
