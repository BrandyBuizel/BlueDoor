...
class HXCPP_CLASS_ATTRIBUTES Context3D_obj : public  ::openfl::events::EventDispatcher_obj
{
	...
	public:
		...
		void __construct( ::openfl::display::Stage stage, ::openfl::_internal::renderer::context3D::Context3DState contextState, ::openfl::display::Stage3D stage3D);
		...
		static hx::ObjectPtr< Context3D_obj > __new( ::openfl::display::Stage stage, ::openfl::_internal::renderer::context3D::Context3DState contextState, ::openfl::display::Stage3D stage3D);
		static hx::ObjectPtr< Context3D_obj > __alloc(hx::Ctx *_hx_ctx, ::openfl::display::Stage stage, ::openfl::_internal::renderer::context3D::Context3DState contextState, ::openfl::display::Stage3D stage3D);
		...
		bool _hx___cleared;
		 ...
		 ::openfl::_internal::renderer::context3D::Context3DState _hx___contextState;
		...
		int _hx___quadIndexBufferElements;
		 ...
		 ::openfl::_internal::renderer::context3D::Context3DState _hx___state;
