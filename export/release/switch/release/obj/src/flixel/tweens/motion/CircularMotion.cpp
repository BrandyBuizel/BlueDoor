...
HXLINE(  42)		this->angle = (this->_angleStart = ((Float)(Angle * ::Math_obj::PI) / (Float)(int)-180));
HXLINE(  43)		int _hx_tmp;
HXDLIN(  43)		if (Clockwise) {
HXLINE(  43)			_hx_tmp = (int)1;
            		}
            		else {
HXLINE(  43)			_hx_tmp = (int)-1;
            		}
HXDLIN(  43)		this->_angleFinish = ((::Math_obj::PI * (int)2) * _hx_tmp);
HXLINE(  45)		if (UseDuration) {
HXLINE(  47)			this->duration = DurationOrSpeed;
            		}
            		else {
HXLINE(  51)			Float _hx_tmp1 = this->_radius;
HXDLIN(  51)			this->duration = ((Float)(_hx_tmp1 * (::Math_obj::PI * (int)2)) / (Float)DurationOrSpeed);
            		}
...
HXLINE(  61)		Float _hx_tmp = this->_angleStart;
HXDLIN(  61)		this->angle = (_hx_tmp + (this->_angleFinish * this->scale));
HXLINE(  62)		Float _hx_tmp1 = this->_centerX;
HXDLIN(  62)		this->x = (_hx_tmp1 + (::Math_obj::cos(this->angle) * this->_radius));
HXLINE(  63)		Float _hx_tmp2 = this->_centerY;
HXDLIN(  63)		this->y = (_hx_tmp2 + (::Math_obj::sin(this->angle) * this->_radius));
...
HXDLIN(  72)		Float _hx_tmp = this->_radius;
HXDLIN(  72)		return (_hx_tmp * (::Math_obj::PI * (int)2));
            	}
