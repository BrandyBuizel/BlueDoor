...
HX_DEFINE_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_60_new,"openfl.display3D.textures.VideoTexture","new",0x6f95260f,"openfl.display3D.textures.VideoTexture.new","openfl/display3D/textures/VideoTexture.hx",60,0x1fe25aa2)
...
HX_LOCAL_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_125___getTexture,"openfl.display3D.textures.VideoTexture","__getTexture",0x7429c676,"openfl.display3D.textures.VideoTexture.__getTexture","openfl/display3D/textures/VideoTexture.hx",125,0x1fe25aa2)
HX_LOCAL_STACK_FRAME(_hx_pos_8bd748bb3c8a0c13_129___textureReady,"openfl.display3D.textures.VideoTexture","__textureReady",0x47bb8b59,"openfl.display3D.textures.VideoTexture.__textureReady","openfl/display3D/textures/VideoTexture.hx",129,0x1fe25aa2)
namespace openfl{
namespace display3D{
namespace textures{

void VideoTexture_obj::__construct( ::openfl::display3D::Context3D context){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_60_new)
HXLINE(  61)		super::__construct(context);
HXLINE(  63)		this->_hx___textureTarget = this->_hx___context->gl->TEXTURE_2D;
            	}
...
HXDLIN(  92)		this->_hx___netStream = netStream;
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(VideoTexture_obj,attachNetStream,(void))
 ...
 ::lime::graphics::opengl::GLObject VideoTexture_obj::_hx___getTexture(){
            	HX_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_125___getTexture)
HXDLIN( 125)		return this->_hx___textureID;
            	}


void VideoTexture_obj::_hx___textureReady(){
            	HX_GC_STACKFRAME(&_hx_pos_8bd748bb3c8a0c13_129___textureReady)
HXLINE( 135)		 ::openfl::events::Event event = null();
HXLINE( 140)		event =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("textureReady",88,4d,5a,df),null(),null());
HXLINE( 143)		this->dispatchEvent(event);
            	}
