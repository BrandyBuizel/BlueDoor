...
HXDLIN(  18)		int _g = a->get_length();
HXDLIN(  18)		switch((int)(_g)){
            			case (int)0: {
HXLINE(  21)				return method(jobject);
            			}
            			break;
            			case (int)1: {
HXLINE(  23)				return method(jobject,a->__get((int)0));
            			}
            			break;
            			case (int)2: {
HXLINE(  25)				return method(jobject,a->__get((int)0),a->__get((int)1));
            			...
            			break;
            			case (int)3: {
HXLINE(  27)				return method(jobject,a->__get((int)0),a->__get((int)1),a->__get((int)2));
            			}
            			break;
            			case (int)4: {
HXLINE(  29)				return method(jobject,a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3));
            			...
            			break;
            			case (int)5: {
HXLINE(  31)				return method(jobject,a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4));
            			}
            			break;
            			case (int)6: {
HXLINE(  33)				return method(jobject,a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4),a->__get((int)5));
            			}
            			break;
            			case (int)7: {
HXLINE(  35)				return method(jobject,a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4),a->__get((int)5),a->__get((int)6));
            			}
            			break;
            			default:{
...
HXDLIN(  43)		int _g = a->get_length();
HXDLIN(  43)		switch((int)(_g)){
            			case (int)0: {
HXLINE(  46)				return method();
            			}
            			break;
            			case (int)1: {
HXLINE(  48)				return method(a->__get((int)0));
            			}
            			break;
            			case (int)2: {
HXLINE(  50)				return method(a->__get((int)0),a->__get((int)1));
            			}
            			break;
            			case (int)3: {
HXLINE(  52)				return method(a->__get((int)0),a->__get((int)1),a->__get((int)2));
            			}
            			break;
            			case (int)4: {
HXLINE(  54)				return method(a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3));
            			}
            			break;
            			case (int)5: {
HXLINE(  56)				return method(a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4));
            			}
            			break;
            			case (int)6: {
HXLINE(  58)				return method(a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4),a->__get((int)5));
            			}
            			break;
            			case (int)7: {
HXLINE(  60)				return method(a->__get((int)0),a->__get((int)1),a->__get((int)2),a->__get((int)3),a->__get((int)4),a->__get((int)5),a->__get((int)6));
            			}
            			break;
            			default:{
...
HXDLIN( 173)		_hx_tmp((HX_("onCallback - unknown field ",2b,28,2a,3c) + method),hx::SourceInfo(HX_("JNI.hx",d9,c8,0d,b0),173,HX_("lime.system.JNI",bf,02,fc,60),HX_("onCallback",04,6e,bd,5c)));
