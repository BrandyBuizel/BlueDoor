...
HXLINE( 202)		this->_facingVerticalMult = (int)1;
HXLINE( 200)		this->_facingHorizontalMult = (int)1;
HXLINE( 167)		this->useColorTransform = false;
HXLINE( 160)		this->color = (int)16777215;
HXLINE( 130)		this->flipY = false;
HXLINE( 125)		this->flipX = false;
HXLINE( 120)		this->facing = (int)16;
HXLINE( 114)		this->alpha = ((Float)1.0);
HXLINE( 109)		this->bakedRotationAngle = ((Float)0);
HXLINE(  96)		this->numFrames = (int)0;
HXLINE(  90)		this->frameHeight = (int)0;
HXLINE(  85)		this->frameWidth = (int)0;
...
HXLINE( 287)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 287)		point->_inPool = false;
HXDLIN( 287)		this->offset = point;
HXLINE( 288)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 288)		point1->_inPool = false;
HXDLIN( 288)		this->origin = point1;
HXLINE( 289)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)1,(int)1);
HXDLIN( 289)		point2->_inPool = false;
HXDLIN( 289)		this->scale = point2;
HXLINE( 290)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 350)		if ((this->bakedRotationAngle > (int)0)) {
...
HXLINE( 392)				Width = Width;
            			}
            		}
HXLINE( 395)		if ((Height == (int)0)) {
...
HXLINE( 444)			brush =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,brushSize,brushSize,true,(int)0);
HXLINE( 445)			 ::openfl::geom::Rectangle _hx_tmp = this->_flashRect;
HXDLIN( 445)			_hx_tmp->setTo((Frame * brushSize),(int)0,brushSize,brushSize);
...
HXLINE( 452)		 ::flixel::graphics::FlxGraphic tempGraph = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
...
HXLINE( 460)			max = ::Std_obj::_hx_int((max * ((Float)1.5)));
            		}
            		else {
HXLINE( 460)			max = max;
            		}
...
HXLINE( 466)			this->set_width(brush->width);
HXLINE( 467)			this->set_height(brush->height);
HXLINE( 468)			this->centerOffsets(null());
            		}
HXLINE( 471)		this->bakedRotationAngle = ((Float)(int)360 / (Float)Rotations);
...
HXDLIN( 493)			 ::flixel::util::LabelValuePair key1 = _this1;
...
HXDLIN( 493)			 ::flixel::util::LabelValuePair key2 = _this2;
...
HXDLIN( 493)			 ::flixel::util::LabelValuePair key3 = _this3;
...
HXDLIN( 493)			key = (key + (HX_(":",3a,00,00,00) + ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(4)->init(0,key1)->init(1,key2)->init(2,key3)->init(3,_this4))));
            		}
HXLINE( 495)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
...
HXLINE( 499)		return this->loadRotatedGraphic(graphic,Rotations,(int)-1,AntiAliasing,AutoBuffer,null());
            	}
...
HXLINE( 539)		this->_flashRect->x = (int)0;
HXLINE( 540)		this->_flashRect->y = (int)0;
HXLINE( 541)		this->_flashRect->width = this->frameWidth;
HXLINE( 542)		this->_flashRect->height = this->frameHeight;
            	}
...
HXLINE( 555)		 ::flixel::math::FlxPoint _hx_tmp = this->_halfSize;
HXDLIN( 555)		Float _hx_tmp1 = (((Float)0.5) * this->frameWidth);
HXDLIN( 555)		_hx_tmp->set(_hx_tmp1,(((Float)0.5) * this->frameHeight));
HXLINE( 556)		{
HXLINE( 556)			this->_flashRect->x = (int)0;
HXDLIN( 556)			this->_flashRect->y = (int)0;
HXDLIN( 556)			this->_flashRect->width = this->frameWidth;
HXDLIN( 556)			this->_flashRect->height = this->frameHeight;
            		}
            	}
...
HXLINE( 564)		this->set_width(this->frameWidth);
HXLINE( 565)		this->set_height(this->frameHeight);
            	}
...
HXDLIN( 588)		if ((Width <= (int)0)) {
HXLINE( 588)			_hx_tmp = (Height <= (int)0);
            		}
            		else {
...
HXLINE( 595)		if ((Width <= (int)0)) {
HXLINE( 596)			this->scale->set_x(newScaleY);
            		}
            		else {
HXLINE( 597)			if ((Height <= (int)0)) {
...
HXLINE( 607)		this->set_width((::Math_obj::abs(this->scale->x) * this->frameWidth));
HXLINE( 608)		this->set_height((::Math_obj::abs(this->scale->y) * this->frameHeight));
HXLINE( 609)		 ::flixel::math::FlxPoint _hx_tmp = this->offset;
HXDLIN( 609)		Float _hx_tmp1 = this->get_width();
HXDLIN( 609)		Float _hx_tmp2 = (((Float)-0.5) * (_hx_tmp1 - this->frameWidth));
HXDLIN( 609)		Float _hx_tmp3 = this->get_height();
HXDLIN( 609)		_hx_tmp->set(_hx_tmp2,(((Float)-0.5) * (_hx_tmp3 - this->frameHeight)));
HXLINE( 610)		 ::flixel::math::FlxPoint _hx_tmp4 = this->origin;
HXDLIN( 610)		Float _hx_tmp5 = (this->frameWidth * ((Float)0.5));
HXDLIN( 610)		_hx_tmp4->set(_hx_tmp5,(this->frameHeight * ((Float)0.5)));
            	}
...
HXDLIN( 619)			 ::flixel::math::FlxPoint _hx_tmp = this->_halfSize;
HXDLIN( 619)			Float _hx_tmp1 = (((Float)0.5) * this->frameWidth);
HXDLIN( 619)			_hx_tmp->set(_hx_tmp1,(((Float)0.5) * this->frameHeight));
HXDLIN( 619)			{
HXLINE( 619)				this->_flashRect->x = (int)0;
HXDLIN( 619)				this->_flashRect->y = (int)0;
HXDLIN( 619)				this->_flashRect->width = this->frameWidth;
HXDLIN( 619)				this->_flashRect->height = this->frameHeight;
            			}
            		}
HXLINE( 620)		{
HXLINE( 620)			this->set_width(this->frameWidth);
HXDLIN( 620)			this->set_height(this->frameHeight);
            		}
HXLINE( 621)		this->_flashRect2->x = (int)0;
HXLINE( 622)		this->_flashRect2->y = (int)0;
HXLINE( 624)		if (hx::IsNotNull( this->graphic )) {
HXLINE( 626)			this->_flashRect2->width = this->graphic->width;
HXLINE( 627)			this->_flashRect2->height = this->graphic->height;
            		}
HXLINE( 630)		 ::flixel::math::FlxPoint _hx_tmp2 = this->origin;
HXDLIN( 630)		Float _hx_tmp3 = (this->frameWidth * ((Float)0.5));
HXDLIN( 630)		_hx_tmp2->set(_hx_tmp3,(this->frameHeight * ((Float)0.5)));
...
HXDLIN( 667)		if ((this->alpha != (int)0)) {
HXLINE( 667)			_hx_tmp = (this->_frame->type == (int)2);
            		}
            		else {
...
HXLINE( 675)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
HXLINE( 675)					_hx_tmp2 = true;
            				}
HXDLIN( 675)				if (!(_hx_tmp2)) {
HXLINE( 675)					_hx_tmp1 = !(this->isOnScreen(camera));
            				}
            				else {
...
HXDLIN( 700)			_this->set_x(::Math_obj::floor(_this->x));
HXDLIN( 700)			_this->set_y(::Math_obj::floor(_this->y));
            		}
HXLINE( 702)		{
HXLINE( 702)			 ::flixel::math::FlxPoint _this1 = this->_point;
...
HXDLIN( 702)			FlashPoint->x = _this1->x;
HXDLIN( 702)			FlashPoint->y = _this1->y;
            		}
...
HXDLIN( 709)		this->_frame->prepareMatrix(this->_matrix,(int)0,_hx_tmp,_hx_tmp1);
HXLINE( 710)		this->_matrix->translate(-(this->origin->x),-(this->origin->y));
HXLINE( 711)		this->_matrix->scale(this->scale->x,this->scale->y);
HXLINE( 713)		if ((this->bakedRotationAngle <= (int)0)) {
HXLINE( 715)			if (this->_angleChanged) {
HXLINE( 715)				Float radians = this->angle;
HXDLIN( 715)				Float radians1 = (radians * ((Float)::Math_obj::PI / (Float)(int)180));
HXDLIN( 715)				this->_sinAngle = ::Math_obj::sin(radians1);
HXDLIN( 715)				this->_cosAngle = ::Math_obj::cos(radians1);
HXDLIN( 715)				this->_angleChanged = false;
            			}
HXLINE( 717)			if ((this->angle != (int)0)) {
...
HXDLIN( 718)				Float a1 = (_this->a * cos);
HXDLIN( 718)				Float a11 = (a1 - (_this->b * sin));
HXDLIN( 718)				Float _hx_tmp2 = (_this->a * sin);
HXDLIN( 718)				_this->b = (_hx_tmp2 + (_this->b * cos));
HXDLIN( 718)				_this->a = a11;
HXDLIN( 718)				Float c1 = (_this->c * cos);
HXDLIN( 718)				Float c11 = (c1 - (_this->d * sin));
HXDLIN( 718)				Float _hx_tmp3 = (_this->c * sin);
HXDLIN( 718)				_this->d = (_hx_tmp3 + (_this->d * cos));
HXDLIN( 718)				_this->c = c11;
HXDLIN( 718)				Float tx1 = (_this->tx * cos);
HXDLIN( 718)				Float tx11 = (tx1 - (_this->ty * sin));
HXDLIN( 718)				Float _hx_tmp4 = (_this->tx * sin);
HXDLIN( 718)				_this->ty = (_hx_tmp4 + (_this->ty * cos));
HXDLIN( 718)				_this->tx = tx11;
            			}
            		}
HXLINE( 721)		{
HXLINE( 721)			 ::flixel::math::FlxPoint _this1 = this->_point;
HXDLIN( 721)			Float Y = this->origin->y;
HXDLIN( 721)			{
HXLINE( 721)				 ::flixel::math::FlxPoint _g = _this1;
HXDLIN( 721)				_g->set_x((_g->x + this->origin->x));
            			}
HXDLIN( 721)			{
HXLINE( 721)				 ::flixel::math::FlxPoint _g1 = _this1;
...
HXLINE( 726)			this->_matrix->tx = ::Math_obj::floor(this->_matrix->tx);
HXLINE( 727)			this->_matrix->ty = ::Math_obj::floor(this->_matrix->ty);
            		}
...
HXLINE( 746)			HX_STACK_DO_THROW(HX_("Cannot stamp to or from a FlxSprite with no graphics.",72,0b,d4,aa));
            		}
...
HXLINE( 754)			this->_flashRect2->width = bitmapData->width;
HXLINE( 755)			this->_flashRect2->height = bitmapData->height;
HXLINE( 756)			this->graphic->bitmap->copyPixels(bitmapData,this->_flashRect2,this->_flashPoint,null(),null(),true);
HXLINE( 757)			this->_flashRect2->width = this->graphic->bitmap->width;
HXLINE( 758)			this->_flashRect2->height = this->graphic->bitmap->height;
            		}
            		else {
...
HXLINE( 765)			if ((Brush->angle != (int)0)) {
HXLINE( 767)				 ::flixel::math::FlxMatrix _hx_tmp1 = this->_matrix;
HXDLIN( 767)				Float Brush1 = Brush->angle;
HXDLIN( 767)				_hx_tmp1->rotate((Brush1 * ((Float)::Math_obj::PI / (Float)(int)180)));
            			}
HXLINE( 769)			 ::flixel::math::FlxMatrix _hx_tmp2 = this->_matrix;
HXDLIN( 769)			Float _hx_tmp3 = ((X + this->frame->frame->x) + Brush->origin->x);
HXDLIN( 769)			_hx_tmp2->translate(_hx_tmp3,((Y + this->frame->frame->y) + Brush->origin->y));
...
HXDLIN( 811)		_hx_tmp->set_x(((_hx_tmp1 - this->get_width()) * ((Float)0.5)));
HXLINE( 812)		 ::flixel::math::FlxPoint _hx_tmp2 = this->offset;
HXDLIN( 812)		int _hx_tmp3 = this->frameHeight;
HXDLIN( 812)		_hx_tmp2->set_y(((_hx_tmp3 - this->get_height()) * ((Float)0.5)));
...
HXDLIN( 826)		 ::flixel::math::FlxPoint _hx_tmp = this->origin;
HXDLIN( 826)		Float _hx_tmp1 = (this->frameWidth * ((Float)0.5));
HXDLIN( 826)		_hx_tmp->set(_hx_tmp1,(this->frameHeight * ((Float)0.5)));
            	}
...
HXLINE( 862)		Float Alpha = (int)1;
HXDLIN( 862)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN( 862)		{
HXLINE( 862)			int Value = ::Math_obj::round((redMultiplier * (int)255));
HXDLIN( 862)			color = ((int)color & (int)(int)-16711681);
HXDLIN( 862)			int color1;
HXDLIN( 862)			if ((Value > (int)255)) {
HXLINE( 862)				color1 = (int)255;
            			}
            			else {
HXLINE( 862)				if ((Value < (int)0)) {
HXLINE( 862)					color1 = (int)0;
            				}
            				else {
HXLINE( 862)					color1 = Value;
            				}
            			}
HXDLIN( 862)			color = ((int)color | (int)((int)color1 << (int)(int)16));
            		}
HXDLIN( 862)		{
HXLINE( 862)			int Value1 = ::Math_obj::round((greenMultiplier * (int)255));
HXDLIN( 862)			color = ((int)color & (int)(int)-65281);
HXDLIN( 862)			int color2;
HXDLIN( 862)			if ((Value1 > (int)255)) {
HXLINE( 862)				color2 = (int)255;
            			}
            			else {
HXLINE( 862)				if ((Value1 < (int)0)) {
HXLINE( 862)					color2 = (int)0;
            				}
            				else {
HXLINE( 862)					color2 = Value1;
            				}
            			}
HXDLIN( 862)			color = ((int)color | (int)((int)color2 << (int)(int)8));
            		}
HXDLIN( 862)		{
HXLINE( 862)			int Value2 = ::Math_obj::round((blueMultiplier * (int)255));
HXDLIN( 862)			color = ((int)color & (int)(int)-256);
HXDLIN( 862)			int color3;
HXDLIN( 862)			if ((Value2 > (int)255)) {
HXLINE( 862)				color3 = (int)255;
            			}
            			else {
HXLINE( 862)				if ((Value2 < (int)0)) {
HXLINE( 862)					color3 = (int)0;
            				}
            				else {
HXLINE( 862)					color3 = Value2;
            				}
            			}
HXDLIN( 862)			color = ((int)color | (int)color3);
            		}
HXDLIN( 862)		{
HXLINE( 862)			int Value3 = ::Math_obj::round((Alpha * (int)255));
HXDLIN( 862)			color = ((int)color & (int)(int)16777215);
HXDLIN( 862)			int color4;
HXDLIN( 862)			if ((Value3 > (int)255)) {
HXLINE( 862)				color4 = (int)255;
            			}
            			else {
HXLINE( 862)				if ((Value3 < (int)0)) {
HXLINE( 862)					color4 = (int)0;
            				}
            				else {
HXLINE( 862)					color4 = Value3;
            				}
            			}
HXDLIN( 862)			color = ((int)color | (int)((int)color4 << (int)(int)24));
            		}
HXDLIN( 862)		this->set_color(((int)color & (int)(int)16777215));
...
HXDLIN( 868)		if ((this->alpha == (int)1)) {
HXLINE( 868)			_hx_tmp1 = (this->color != (int)16777215);
            		}
            		else {
...
HXDLIN( 877)		if ((this->alpha == (int)1)) {
HXLINE( 877)			_hx_tmp = (this->color != (int)16777215);
            		}
            		else {
...
HXLINE( 879)			::flixel::util::FlxColorTransformUtil_obj::setMultipliers(this->colorTransform,((Float)((int)((int)this->color >> (int)(int)16) & (int)(int)255) / (Float)(int)255),((Float)((int)((int)this->color >> (int)(int)8) & (int)(int)255) / (Float)(int)255),((Float)((int)this->color & (int)(int)255) / (Float)(int)255),this->alpha);
            		}
            		else {
HXLINE( 881)			::flixel::util::FlxColorTransformUtil_obj::setMultipliers(this->colorTransform,(int)1,(int)1,(int)1,(int)1);
            		}
...
HXDLIN( 908)		if (!((this->_flashPoint->x < (int)0))) {
...
HXLINE( 908)			_hx_tmp1 = (this->_flashPoint->y < (int)0);
            		}
            		else {
...
HXLINE( 916)			return ((((int)((int)pixelColor1 >> (int)(int)24) & (int)(int)255) * this->alpha) >= Mask);
            		}
...
HXLINE( 955)			_hx_tmp2 = (this->_frame->type == (int)0);
            		}
            		else {
...
HXLINE( 961)			this->framePixels = this->_frame->paintRotatedAndFlipped(this->framePixels,this->_flashPointZero,(int)0,doFlipX1,doFlipY1,false,true);
            		}
...
HXLINE( 991)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 991)			point1->_inPool = false;
HXDLIN( 991)			point = point1;
            		}
HXLINE( 992)		Float _hx_tmp = this->x;
HXDLIN( 992)		Float _hx_tmp1 = (_hx_tmp + (this->frameWidth * ((Float)0.5)));
HXDLIN( 992)		Float _hx_tmp2 = this->y;
HXDLIN( 992)		return point->set(_hx_tmp1,(_hx_tmp2 + (this->frameHeight * ((Float)0.5))));
            	}
...
HXLINE(1007)		Float minX = (this->x - this->offset->x);
HXDLIN(1007)		Float minX1 = (minX - (Camera->scroll->x * this->scrollFactor->x));
HXLINE(1008)		Float minY = (this->y - this->offset->y);
HXDLIN(1008)		Float minY1 = (minY - (Camera->scroll->y * this->scrollFactor->y));
HXLINE(1010)		bool _hx_tmp;
HXDLIN(1010)		bool _hx_tmp1;
HXDLIN(1010)		bool _hx_tmp2;
HXDLIN(1010)		if ((this->angle != (int)0)) {
HXLINE(1010)			_hx_tmp2 = (this->bakedRotationAngle > (int)0);
            		}
            		else {
HXLINE(1010)			_hx_tmp2 = true;
            		}
HXDLIN(1010)		if (_hx_tmp2) {
HXLINE(1010)			_hx_tmp1 = (this->scale->x == (int)1);
            		}
            		else {
HXLINE(1010)			_hx_tmp1 = false;
            		}
HXDLIN(1010)		if (_hx_tmp1) {
HXLINE(1010)			_hx_tmp = (this->scale->y == (int)1);
            		}
            		else {
HXLINE(1010)			_hx_tmp = false;
            		}
HXDLIN(1010)		if (_hx_tmp) {
HXLINE(1012)			this->_point->set(minX1,minY1);
...
HXLINE(1013)				_hx_tmp4 = (point->x < Camera->viewOffsetWidth);
            			}
            			else {
HXLINE(1013)				_hx_tmp4 = false;
            			}
HXDLIN(1013)			if (_hx_tmp4) {
HXLINE(1013)				_hx_tmp3 = ((point->y + this->frameHeight) > Camera->viewOffsetY);
            			}
            			else {
HXLINE(1013)				_hx_tmp3 = false;
            			}
...
HXLINE(1023)			Float x2 = ::Math_obj::abs((this->frameWidth - ox));
...
HXLINE(1031)			Float y2 = ::Math_obj::abs((this->frameHeight - oy));
...
HXLINE(1040)		minX1 = (minX1 + (ox - radius));
HXLINE(1041)		minY1 = (minY1 + (oy - radius));
HXLINE(1043)		Float doubleRadius = ((int)2 * radius);
HXLINE(1045)		this->_point->set(minX1,minY1);
HXLINE(1046)		 ::flixel::math::FlxPoint point1 = this->_point;
HXDLIN(1046)		bool _hx_tmp5;
HXDLIN(1046)		bool _hx_tmp6;
HXDLIN(1046)		if (((point1->x + doubleRadius) > Camera->viewOffsetX)) {
HXLINE(1046)			_hx_tmp6 = (point1->x < Camera->viewOffsetWidth);
            		}
            		else {
HXLINE(1046)			_hx_tmp6 = false;
            		}
HXDLIN(1046)		if (_hx_tmp6) {
HXLINE(1046)			_hx_tmp5 = ((point1->y + doubleRadius) > Camera->viewOffsetY);
            		}
            		else {
HXLINE(1046)			_hx_tmp5 = false;
            		}
HXDLIN(1046)		if (_hx_tmp5) {
HXLINE(1046)			return (point1->y < Camera->viewOffsetHeight);
            		}
            		else {
...
HXDLIN(1071)		if ((this->angle != (int)0)) {
HXLINE(1071)			result3 = (this->bakedRotationAngle > (int)0);
            		}
            		else {
HXLINE(1071)			result3 = true;
            		}
HXDLIN(1071)		if (result3) {
HXLINE(1071)			result2 = (this->scale->x == (int)1);
            		}
            		else {
HXLINE(1071)			result2 = false;
            		}
HXDLIN(1071)		if (result2) {
HXLINE(1071)			result1 = (this->scale->y == (int)1);
            		}
            		else {
...
HXLINE(1072)				result = this->pixelPerfectRender;
            			}
            		}
            		else {
...
HXLINE(1152)			this->set_graphic(( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) ));
            		}
...
HXDLIN(1165)				 ::flixel::math::FlxPoint _hx_tmp = this->_halfSize;
HXDLIN(1165)				Float _hx_tmp1 = (((Float)0.5) * this->frameWidth);
HXDLIN(1165)				_hx_tmp->set(_hx_tmp1,(((Float)0.5) * this->frameHeight));
HXDLIN(1165)				{
HXLINE(1165)					this->_flashRect->x = (int)0;
HXDLIN(1165)					this->_flashRect->y = (int)0;
HXDLIN(1165)					this->_flashRect->width = this->frameWidth;
HXDLIN(1165)					this->_flashRect->height = this->frameHeight;
            				}
            			}
...
HXLINE(1168)				_hx_tmp3 = hx::IsNotNull( this->frames->frames );
            			}
            			else {
HXLINE(1168)				_hx_tmp3 = false;
            			}
HXDLIN(1168)			if (_hx_tmp3) {
HXLINE(1168)				_hx_tmp2 = (this->numFrames > (int)0);
            			}
            			else {
HXLINE(1168)				_hx_tmp2 = false;
            			}
HXDLIN(1168)			if (_hx_tmp2) {
HXLINE(1170)				this->frame = this->frames->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXDLIN(1215)		if ((Alpha < (int)0)) {
HXLINE(1215)			lowerBound = (int)0;
            		}
            		else {
HXLINE(1215)			lowerBound = Alpha;
            		}
HXDLIN(1215)		 ::Dynamic _hx_tmp;
HXDLIN(1215)		if ((lowerBound > (int)1)) {
HXLINE(1215)			_hx_tmp = (int)1;
            		}
            		else {
...
HXLINE(1240)			this->animation->update((int)0);
            		}
...
HXLINE(1250)			Float radians = this->angle;
HXDLIN(1250)			Float radians1 = (radians * ((Float)::Math_obj::PI / (Float)(int)180));
HXLINE(1251)			this->_sinAngle = ::Math_obj::sin(radians1);
HXLINE(1252)			this->_cosAngle = ::Math_obj::cos(radians1);
...
HXDLIN(1274)			int _g1 = _g->get_useCount();
HXDLIN(1274)			_g->set_useCount((_g1 + (int)1));
            		}
...
HXLINE(1279)			 ::flixel::graphics::FlxGraphic _g2 = oldGraphic;
HXDLIN(1279)			int _g11 = _g2->get_useCount();
HXDLIN(1279)			_g2->set_useCount((_g11 - (int)1));
            		}
...
HXLINE(1289)			rect->x = ::Math_obj::round(rect->x);
HXDLIN(1289)			rect->y = ::Math_obj::round(rect->y);
HXDLIN(1289)			rect->width = ::Math_obj::round(rect->width);
HXDLIN(1289)			rect->height = ::Math_obj::round(rect->height);
...
HXLINE(1318)			this->set_frame(this->frames->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >());
HXLINE(1319)			this->numFrames = this->frames->frames->length;
HXLINE(1320)			this->resetHelpers();
HXLINE(1321)			this->bakedRotationAngle = (int)0;
HXLINE(1322)			this->animation->set_frameIndex((int)0);
...
HXLINE(1342)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1342)			_hx_tmp1 = true;
            		}
HXDLIN(1342)		this->dirty = _hx_tmp1;
...
HXLINE(1353)		bool _hx_tmp1;
HXDLIN(1353)		if ((this->flipY == Value)) {
HXLINE(1353)			_hx_tmp1 = this->dirty;
            		}
            		else {
HXLINE(1353)			_hx_tmp1 = true;
            		}
HXDLIN(1353)		this->dirty = _hx_tmp1;
...
static hx::StorageInfo FlxSprite_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::graphics::tile::FlxGraphicsShader*/ ,(int)offsetof(FlxSprite_obj,shader),HX_HCSTRING("shader","\x25","\xbf","\x20","\x1d")},
