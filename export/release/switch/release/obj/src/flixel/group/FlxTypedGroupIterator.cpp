...
HXDLIN( 934)			::cpp::VirtualArray _hx_tmp = this->_groupMembers;
HXDLIN( 934)			return _hx_tmp->__get(this->_cursor++);
            		}
            		else {
...
HXLINE( 939)						 ::Dynamic _hx_tmp1 = this->_filter;
HXDLIN( 939)						_hx_tmp = !(( (bool)(_hx_tmp1(this->_groupMembers->__get(this->_cursor))) ));
            					}
            					else {
