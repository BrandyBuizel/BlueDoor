...
static hx::StaticInfo TouchData_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*::lime::utils::ObjectPool*/ ,(void *) &TouchData_obj::_hx___pool,HX_HCSTRING("__pool","\xfc","\xe3","\x54","\xf9")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
void TouchData_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("openfl._internal.utils.TouchData","\xbc","\xa0","\x3a","\x42");
