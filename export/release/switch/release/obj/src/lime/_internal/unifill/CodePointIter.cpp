...
HXLINE(  25)		this->i = (int)0;
HXLINE(  15)		this->string = s;
HXLINE(  16)		this->index = (int)0;
...
HXDLIN(  30)		if ((c < (int)192)) {
HXLINE(  30)			_hx_tmp2 = (int)1;
            		}
            		else {
HXLINE(  30)			if ((c < (int)224)) {
HXLINE(  30)				_hx_tmp2 = (int)2;
            			}
            			else {
HXLINE(  30)				if ((c < (int)240)) {
HXLINE(  30)					_hx_tmp2 = (int)3;
            				}
            				else {
HXLINE(  30)					if ((c < (int)248)) {
HXLINE(  30)						_hx_tmp2 = (int)4;
            					}
            					else {
HXLINE(  30)						_hx_tmp2 = (int)1;
            					}
...
void CodePointIter_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime._internal.unifill.CodePointIter","\x95","\xae","\xaf","\x9f");
