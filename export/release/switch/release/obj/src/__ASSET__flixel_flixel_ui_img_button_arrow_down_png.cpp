...
HX_DEFINE_STACK_FRAME(_hx_pos_c3174dcb7fd665f5_363_new,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","new",0x3b7e342a,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.new","lime/_internal/macros/AssetsMacro.hx",363,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_71f21b48f52ae898_1_boot,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png","boot",0xcb087128,"__ASSET__flixel_flixel_ui_img_button_arrow_down_png.boot","?",1,0x0000003f)
...
void __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_c3174dcb7fd665f5_363_new)
HXLINE( 392)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 394)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::resourceName),null());
            	}
...
bool __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x66ea719b) {
		...
		return inClassId==(int)0x7fe5518c;
	}
}
...
static hx::StaticInfo __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__mClass,"__mClass");
...
static void __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new __ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj;
	__ASSET__flixel_flixel_ui_img_button_arrow_down_png_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("__ASSET__flixel_flixel_ui_img_button_arrow_down_png","\x38","\x97","\xba","\xf7");
...
{
{
            	HX_STACKFRAME(&_hx_pos_71f21b48f52ae898_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:image___ASSET__flixel_flixel_ui_img_button_arrow_down_png",6a,37,2c,53);
            	}
}
