...
HXDLIN( 150)		if ((pos >= (int)0)) {
HXLINE( 150)			_hx_tmp1 = (len < (int)0);
            		}
            		else {
...
HXLINE( 171)		::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 171)		return  ::haxe::io::Bytes_obj::__alloc( HX_CTX ,len,_hx_tmp2->slice(pos,(pos + len)));
            	}
...
HXDLIN( 236)		if ((pos >= (int)0)) {
HXLINE( 236)			_hx_tmp = ((pos + (int)8) > this->length);
            		}
            		else {
...
HXDLIN( 258)		if ((pos >= (int)0)) {
HXLINE( 258)			_hx_tmp = ((pos + (int)4) > this->length);
            		}
            		else {
...
HXDLIN( 282)		if ((pos >= (int)0)) {
HXLINE( 282)			_hx_tmp = ((pos + (int)8) > this->length);
            		}
            		else {
...
HXDLIN( 308)		if ((pos >= (int)0)) {
HXLINE( 308)			_hx_tmp = ((pos + (int)4) > this->length);
            		}
            		else {
...
HXDLIN( 323)		int _hx_tmp = this->b->__get(pos);
HXDLIN( 323)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 323)		return ((int)_hx_tmp | (int)((int)_hx_tmp1->__get((pos + (int)1)) << (int)(int)8));
            	}
...
HXLINE( 335)		this->b[pos] = v;
HXLINE( 336)		::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 336)		_hx_tmp[(pos + (int)1)] = ((int)v >> (int)(int)8);
            	}
...
HXDLIN( 354)		int _hx_tmp = this->b->__get(pos);
HXDLIN( 354)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 354)		int _hx_tmp2 = ((int)_hx_tmp | (int)((int)_hx_tmp1->__get((pos + (int)1)) << (int)(int)8));
HXDLIN( 354)		::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 354)		int _hx_tmp4 = ((int)_hx_tmp2 | (int)((int)_hx_tmp3->__get((pos + (int)2)) << (int)(int)16));
HXDLIN( 354)		::Array< unsigned char > _hx_tmp5 = this->b;
HXDLIN( 354)		return ((int)_hx_tmp4 | (int)((int)_hx_tmp5->__get((pos + (int)3)) << (int)(int)24));
            	}
...
HXDLIN( 363)		int pos1 = (pos + (int)4);
HXDLIN( 363)		int high = this->b->__get(pos1);
HXDLIN( 363)		::Array< unsigned char > high1 = this->b;
HXDLIN( 363)		int high2 = ((int)high | (int)((int)high1->__get((pos1 + (int)1)) << (int)(int)8));
HXDLIN( 363)		::Array< unsigned char > high3 = this->b;
HXDLIN( 363)		int high4 = ((int)high2 | (int)((int)high3->__get((pos1 + (int)2)) << (int)(int)16));
HXDLIN( 363)		::Array< unsigned char > high5 = this->b;
HXDLIN( 363)		int low = this->b->__get(pos);
HXDLIN( 363)		::Array< unsigned char > low1 = this->b;
HXDLIN( 363)		int low2 = ((int)low | (int)((int)low1->__get((pos + (int)1)) << (int)(int)8));
HXDLIN( 363)		::Array< unsigned char > low3 = this->b;
HXDLIN( 363)		int low4 = ((int)low2 | (int)((int)low3->__get((pos + (int)2)) << (int)(int)16));
HXDLIN( 363)		::Array< unsigned char > low5 = this->b;
HXDLIN( 363)		return _hx_int64_make(((int)high4 | (int)((int)high5->__get((pos1 + (int)3)) << (int)(int)24)),((int)low4 | (int)((int)low5->__get((pos + (int)3)) << (int)(int)24)));
            	}
...
HXLINE( 374)		::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 374)		_hx_tmp[pos] = ((int)v & (int)(int)255);
HXLINE( 375)		::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 375)		_hx_tmp1[(pos + (int)1)] = ((int)((int)v >> (int)(int)8) & (int)(int)255);
HXLINE( 376)		::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 376)		_hx_tmp2[(pos + (int)2)] = ((int)((int)v >> (int)(int)16) & (int)(int)255);
HXLINE( 377)		::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 377)		_hx_tmp3[(pos + (int)3)] = ((int)hx::UShr(v,(int)24) & (int)(int)255);
            	}
...
HXDLIN( 386)			::Array< unsigned char > _hx_tmp = this->b;
HXDLIN( 386)			_hx_tmp[pos] = ((int)v1 & (int)(int)255);
HXDLIN( 386)			::Array< unsigned char > _hx_tmp1 = this->b;
HXDLIN( 386)			_hx_tmp1[(pos + (int)1)] = ((int)((int)v1 >> (int)(int)8) & (int)(int)255);
HXDLIN( 386)			::Array< unsigned char > _hx_tmp2 = this->b;
HXDLIN( 386)			_hx_tmp2[(pos + (int)2)] = ((int)((int)v1 >> (int)(int)16) & (int)(int)255);
HXDLIN( 386)			::Array< unsigned char > _hx_tmp3 = this->b;
HXDLIN( 386)			_hx_tmp3[(pos + (int)3)] = ((int)hx::UShr(v1,(int)24) & (int)(int)255);
            		}
HXLINE( 387)		{
HXLINE( 387)			int pos1 = (pos + (int)4);
HXDLIN( 387)			int v2 = _hx_int64_high(v);
HXDLIN( 387)			::Array< unsigned char > _hx_tmp4 = this->b;
HXDLIN( 387)			_hx_tmp4[pos1] = ((int)v2 & (int)(int)255);
HXDLIN( 387)			::Array< unsigned char > _hx_tmp5 = this->b;
HXDLIN( 387)			_hx_tmp5[(pos1 + (int)1)] = ((int)((int)v2 >> (int)(int)8) & (int)(int)255);
HXDLIN( 387)			::Array< unsigned char > _hx_tmp6 = this->b;
HXDLIN( 387)			_hx_tmp6[(pos1 + (int)2)] = ((int)((int)v2 >> (int)(int)16) & (int)(int)255);
HXDLIN( 387)			::Array< unsigned char > _hx_tmp7 = this->b;
HXDLIN( 387)			_hx_tmp7[(pos1 + (int)3)] = ((int)hx::UShr(v2,(int)24) & (int)(int)255);
            		}
            	}
...
::String Bytes_obj::getString(int pos,int len, ::Dynamic encoding){
            	HX_STACKFRAME(&_hx_pos_7de8773c9a509473_391_getString)
HXLINE( 393)		bool _hx_tmp;
HXDLIN( 393)		bool _hx_tmp1;
HXDLIN( 393)		if ((pos >= (int)0)) {
HXLINE( 393)			_hx_tmp1 = (len < (int)0);
            		}
            		else {
...
HXDLIN( 480)		return this->getString((int)0,this->length,null());
            	}
...
HXDLIN( 491)			int _g2 = this->length;
HXDLIN( 491)			while((_g11 < _g2)){
HXLINE( 491)				_g11 = (_g11 + (int)1);
HXDLIN( 491)				int i1 = (_g11 - (int)1);
HXLINE( 493)				int c = this->b->__get(i1);
HXLINE( 494)				{
HXLINE( 494)					int c1 = chars->__get(((int)c >> (int)(int)4));
HXDLIN( 494)					if (hx::IsNull( s->charBuf )) {
HXLINE( 494)						s->charBuf = ::Array_obj< char >::__new();
            					}
HXDLIN( 494)					s->charBuf->push(c1);
            				}
HXLINE( 495)				{
HXLINE( 495)					int c2 = chars->__get(((int)c & (int)(int)15));
HXDLIN( 495)					if (hx::IsNull( s->charBuf )) {
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(Bytes_obj,alloc,return )
 ...
 ::haxe::io::Bytes Bytes_obj::ofString(::String s, ::Dynamic encoding){
...
HXLINE( 617)		if ((((int)len & (int)(int)1) != (int)0)) {
HXLINE( 617)			HX_STACK_DO_THROW(HX_("Not a hex string (odd number of digits)",96,4b,d1,a4));
            		}
HXLINE( 618)		 ::haxe::io::Bytes ret = ::haxe::io::Bytes_obj::alloc(((int)len >> (int)(int)1));
HXLINE( 619)		{
HXLINE( 619)			int _g1 = (int)0;
HXDLIN( 619)			int _g = ret->length;
HXDLIN( 619)			while((_g1 < _g)){
HXLINE( 619)				_g1 = (_g1 + (int)1);
HXDLIN( 619)				int i = (_g1 - (int)1);
HXLINE( 621)				::String s1 = s;
HXDLIN( 621)				int high = s1.cca((i * (int)2));
HXLINE( 622)				::String s2 = s;
HXDLIN( 622)				int low = s2.cca(((i * (int)2) + (int)1));
HXLINE( 623)				high = (((int)high & (int)(int)15) + (((int)((int)high & (int)(int)64) >> (int)(int)6) * (int)9));
HXLINE( 624)				low = (((int)low & (int)(int)15) + (((int)((int)low & (int)(int)64) >> (int)(int)6) * (int)9));
HXLINE( 625)				::Array< unsigned char > ret1 = ret->b;
HXDLIN( 625)				ret1[i] = ((int)((int)((int)high << (int)(int)4) | (int)low) & (int)(int)255);
            			}
            		}
...
static ::String Bytes_obj_sStaticFields[] = {
	...
	HX_HCSTRING("ofHex","\x04","\x22","\x1d","\x2d"),
