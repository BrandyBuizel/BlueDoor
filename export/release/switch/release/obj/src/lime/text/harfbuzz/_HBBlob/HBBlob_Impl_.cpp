...
HXDLIN(  47)		return ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromFloat(::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_blob_get_data(hx::DynamicPtr(this1)));
            	}
...
HXDLIN(  56)		return ::lime::utils::_DataPointer::DataPointer_Impl__obj::fromFloat(::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_blob_get_data_writable(hx::DynamicPtr(this1)));
            	}
