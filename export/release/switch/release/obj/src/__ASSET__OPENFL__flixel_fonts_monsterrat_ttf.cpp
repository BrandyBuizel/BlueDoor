...
HX_DEFINE_STACK_FRAME(_hx_pos_aa3eaf4dd720a73e_302_new,"__ASSET__OPENFL__flixel_fonts_monsterrat_ttf","new",0x4d419742,"__ASSET__OPENFL__flixel_fonts_monsterrat_ttf.new","ManifestResources.hx",302,0xf77aa668)

void __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::__construct(){
            	HX_GC_STACKFRAME(&_hx_pos_aa3eaf4dd720a73e_302_new)
HXDLIN( 302)		this->_hx___fromLimeFont( ::__ASSET__flixel_fonts_monsterrat_ttf_obj::__alloc( HX_CTX ));
HXDLIN( 302)		super::__construct(null());
            	}
...
bool __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x6aed2e71) {
		if (inClassId<=(int)0x4c188e50) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x4c188e50;
		} else {
...
static void __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(__ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(__ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj;
	__ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("__ASSET__OPENFL__flixel_fonts_monsterrat_ttf","\x50","\x8e","\x18","\x4c");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(0 /* sMemberFields */);
	__mClass->mCanCast = hx::TCanCast< __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = __ASSET__OPENFL__flixel_fonts_monsterrat_ttf_obj_sVisitStatics;
#endif
