...
HXLINE(  92)		this->ALL_DEVICES_SPECIFIER = (int)4115;
HXLINE(  91)		this->DEFAULT_ALL_DEVICES_SPECIFIER = (int)4114;
HXLINE(  90)		this->ENUMERATE_ALL_EXT = (int)1;
HXLINE(  89)		this->DEVICE_SPECIFIER = (int)4101;
HXLINE(  88)		this->DEFAULT_DEVICE_SPECIFIER = (int)4100;
HXLINE(  87)		this->ALL_ATTRIBUTES = (int)4099;
HXLINE(  86)		this->ATTRIBUTES_SIZE = (int)4098;
HXLINE(  85)		this->INVALID_CONTEXT = (int)40962;
HXLINE(  84)		this->INVALID_DEVICE = (int)40961;
HXLINE(  83)		this->STEREO_SOURCES = (int)4113;
HXLINE(  82)		this->MONO_SOURCES = (int)4112;
HXLINE(  81)		this->SYNC = (int)4105;
HXLINE(  80)		this->REFRESH = (int)4104;
