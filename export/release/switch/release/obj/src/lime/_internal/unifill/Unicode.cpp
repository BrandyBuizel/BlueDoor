...
HXDLIN(  17)		return ((int)((int)(hi - (int)55232) << (int)(int)10) | (int)((int)lo & (int)(int)1023));
            	}
...
HXDLIN(  20)		return (((int)c >> (int)(int)10) + (int)55232);
            	}
...
HXDLIN(  23)		return ((int)((int)c & (int)(int)1023) | (int)(int)56320);
            	}
...
HXDLIN(  32)		if (((int)55296 <= code)) {
HXDLIN(  32)			return (code <= (int)56319);
            		}
            		else {
...
HXDLIN(  37)		if (((int)56320 <= code)) {
HXDLIN(  37)			return (code <= (int)57343);
            		}
            		else {
...
void Unicode_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime._internal.unifill.Unicode","\x97","\x79","\x17","\xab");
