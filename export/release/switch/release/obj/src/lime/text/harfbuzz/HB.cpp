...
static void HB_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(HB_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void HB_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(HB_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new HB_obj;
	HB_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.text.harfbuzz.HB","\x20","\x86","\x2b","\xcc");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &HB_obj::__GetStatic;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = HB_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(HB_obj_sStaticFields);
	__mClass->mMembers = hx::Class_obj::dupFunctions(0 /* sMemberFields */);
	__mClass->mCanCast = hx::TCanCast< HB_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = HB_obj_sVisitStatics;
#endif
