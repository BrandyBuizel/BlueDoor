...
HX_DEFINE_STACK_FRAME(_hx_pos_7ed915f9c967dbc3_47_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault","new",0x2f427ecf,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_a270a1a9eabc5120_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault","boot",0x230576e3,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformCursorDefault_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_7ed915f9c967dbc3_47_new)
...
bool GraphicTransformCursorDefault_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x0900a4c1) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x0900a4c1;
	} else {
...
void GraphicTransformCursorDefault_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorDefault","\x5d","\x6b","\xb1","\x77");
...
{
{
            	HX_STACKFRAME(&_hx_pos_a270a1a9eabc5120_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorDefault",25,16,4a,8c);
            	}
}
