...
HXDLIN(  54)		int r = ::Std_obj::_hx_int((((((int)((int)Color2 >> (int)(int)16) & (int)(int)255) - ((int)((int)Color1 >> (int)(int)16) & (int)(int)255)) * Factor) + ((int)((int)Color1 >> (int)(int)16) & (int)(int)255)));
HXDLIN(  54)		int g = ::Std_obj::_hx_int((((((int)((int)Color2 >> (int)(int)8) & (int)(int)255) - ((int)((int)Color1 >> (int)(int)8) & (int)(int)255)) * Factor) + ((int)((int)Color1 >> (int)(int)8) & (int)(int)255)));
HXDLIN(  54)		int b = ::Std_obj::_hx_int((((((int)Color2 & (int)(int)255) - ((int)Color1 & (int)(int)255)) * Factor) + ((int)Color1 & (int)(int)255)));
HXDLIN(  54)		int a = ::Std_obj::_hx_int((((((int)((int)Color2 >> (int)(int)24) & (int)(int)255) - ((int)((int)Color1 >> (int)(int)24) & (int)(int)255)) * Factor) + ((int)((int)Color1 >> (int)(int)24) & (int)(int)255)));
HXDLIN(  54)		int color = ::flixel::util::_FlxColor::FlxColor_Impl__obj::_new(null());
HXDLIN(  54)		{
HXLINE(  54)			color = ((int)color & (int)(int)-16711681);
HXDLIN(  54)			int color1;
HXDLIN(  54)			if ((r > (int)255)) {
HXLINE(  54)				color1 = (int)255;
            			}
            			else {
HXLINE(  54)				if ((r < (int)0)) {
HXLINE(  54)					color1 = (int)0;
            				}
            				else {
HXLINE(  54)					color1 = r;
            				}
            			}
HXDLIN(  54)			color = ((int)color | (int)((int)color1 << (int)(int)16));
            		}
HXDLIN(  54)		{
HXLINE(  54)			color = ((int)color & (int)(int)-65281);
HXDLIN(  54)			int color2;
HXDLIN(  54)			if ((g > (int)255)) {
HXLINE(  54)				color2 = (int)255;
            			}
            			else {
HXLINE(  54)				if ((g < (int)0)) {
HXLINE(  54)					color2 = (int)0;
            				}
            				else {
HXLINE(  54)					color2 = g;
            				}
            			}
HXDLIN(  54)			color = ((int)color | (int)((int)color2 << (int)(int)8));
            		}
HXDLIN(  54)		{
HXLINE(  54)			color = ((int)color & (int)(int)-256);
HXDLIN(  54)			int color3;
HXDLIN(  54)			if ((b > (int)255)) {
HXLINE(  54)				color3 = (int)255;
            			}
            			else {
HXLINE(  54)				if ((b < (int)0)) {
HXLINE(  54)					color3 = (int)0;
            				}
            				else {
HXLINE(  54)					color3 = b;
            				}
            			}
HXDLIN(  54)			color = ((int)color | (int)color3);
            		}
HXDLIN(  54)		{
HXLINE(  54)			color = ((int)color & (int)(int)16777215);
HXDLIN(  54)			int color4;
HXDLIN(  54)			if ((a > (int)255)) {
HXLINE(  54)				color4 = (int)255;
            			}
            			else {
HXLINE(  54)				if ((a < (int)0)) {
HXLINE(  54)					color4 = (int)0;
            				}
            				else {
HXLINE(  54)					color4 = a;
            				}
            			}
HXDLIN(  54)			color = ((int)color | (int)((int)color4 << (int)(int)24));
            		}
HXDLIN(  54)		this->color = color;
HXLINE(  56)		if (hx::IsNotNull( this->sprite )) {
HXLINE(  58)			this->sprite->set_color(this->color);
HXLINE(  59)			this->sprite->set_alpha(((Float)((int)((int)this->color >> (int)(int)24) & (int)(int)255) / (Float)(int)255));
            		}
            	}
