...
HXLINE(   9)		this->TEXTURE_STENCIL_SIZE_EXT = (int)35057;
HXLINE(   8)		this->DEPTH24_STENCIL8_EXT = (int)35056;
HXLINE(   7)		this->UNSIGNED_INT_24_8_EXT = (int)34042;
HXLINE(   6)		this->DEPTH_STENCIL_EXT = (int)34041;
            	}
