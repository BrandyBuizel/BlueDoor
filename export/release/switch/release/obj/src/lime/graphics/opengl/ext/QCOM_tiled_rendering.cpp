...
HXLINE(  35)		this->MULTISAMPLE_BUFFER_BIT5_QCOM = (int)536870912;
HXLINE(  34)		this->MULTISAMPLE_BUFFER_BIT4_QCOM = (int)268435456;
HXLINE(  33)		this->MULTISAMPLE_BUFFER_BIT3_QCOM = (int)134217728;
HXLINE(  32)		this->MULTISAMPLE_BUFFER_BIT2_QCOM = (int)67108864;
HXLINE(  31)		this->MULTISAMPLE_BUFFER_BIT1_QCOM = (int)33554432;
HXLINE(  30)		this->MULTISAMPLE_BUFFER_BIT0_QCOM = (int)16777216;
HXLINE(  29)		this->STENCIL_BUFFER_BIT7_QCOM = (int)8388608;
HXLINE(  28)		this->STENCIL_BUFFER_BIT6_QCOM = (int)4194304;
HXLINE(  27)		this->STENCIL_BUFFER_BIT5_QCOM = (int)2097152;
HXLINE(  26)		this->STENCIL_BUFFER_BIT4_QCOM = (int)1048576;
HXLINE(  25)		this->STENCIL_BUFFER_BIT3_QCOM = (int)524288;
HXLINE(  24)		this->STENCIL_BUFFER_BIT2_QCOM = (int)262144;
HXLINE(  23)		this->STENCIL_BUFFER_BIT1_QCOM = (int)131072;
HXLINE(  22)		this->STENCIL_BUFFER_BIT0_QCOM = (int)65536;
HXLINE(  21)		this->DEPTH_BUFFER_BIT7_QCOM = (int)32768;
HXLINE(  20)		this->DEPTH_BUFFER_BIT6_QCOM = (int)16384;
HXLINE(  19)		this->DEPTH_BUFFER_BIT5_QCOM = (int)8192;
HXLINE(  18)		this->DEPTH_BUFFER_BIT4_QCOM = (int)4096;
HXLINE(  17)		this->DEPTH_BUFFER_BIT3_QCOM = (int)2048;
HXLINE(  16)		this->DEPTH_BUFFER_BIT2_QCOM = (int)1024;
HXLINE(  15)		this->DEPTH_BUFFER_BIT1_QCOM = (int)512;
HXLINE(  14)		this->DEPTH_BUFFER_BIT0_QCOM = (int)256;
HXLINE(  13)		this->COLOR_BUFFER_BIT7_QCOM = (int)128;
HXLINE(  12)		this->COLOR_BUFFER_BIT6_QCOM = (int)64;
HXLINE(  11)		this->COLOR_BUFFER_BIT5_QCOM = (int)32;
HXLINE(  10)		this->COLOR_BUFFER_BIT4_QCOM = (int)16;
HXLINE(   9)		this->COLOR_BUFFER_BIT3_QCOM = (int)8;
HXLINE(   8)		this->COLOR_BUFFER_BIT2_QCOM = (int)4;
HXLINE(   7)		this->COLOR_BUFFER_BIT1_QCOM = (int)2;
HXLINE(   6)		this->COLOR_BUFFER_BIT0_QCOM = (int)1;
            	}
