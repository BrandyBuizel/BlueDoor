...
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_292_reverse,"openfl._internal.text._TextLayout.TextDirection_Impl_","reverse",0xf3fb0bfd,"openfl._internal.text._TextLayout.TextDirection_Impl_.reverse","openfl/_internal/text/TextLayout.hx",292,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_297_toString,"openfl._internal.text._TextLayout.TextDirection_Impl_","toString",0x3e687d71,"openfl._internal.text._TextLayout.TextDirection_Impl_.toString","openfl/_internal/text/TextLayout.hx",297,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_310_toHBDirection,"openfl._internal.text._TextLayout.TextDirection_Impl_","toHBDirection",0x7ad2a365,"openfl._internal.text._TextLayout.TextDirection_Impl_.toHBDirection","openfl/_internal/text/TextLayout.hx",310,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_323_get_backward,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_backward",0x2c628331,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_backward","openfl/_internal/text/TextLayout.hx",323,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_328_get_forward,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_forward",0xda561e37,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_forward","openfl/_internal/text/TextLayout.hx",328,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_333_get_horizontal,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_horizontal",0x3e4093b2,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_horizontal","openfl/_internal/text/TextLayout.hx",333,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_338_get_vertical,"openfl._internal.text._TextLayout.TextDirection_Impl_","get_vertical",0x6f5f63c4,"openfl._internal.text._TextLayout.TextDirection_Impl_.get_vertical","openfl/_internal/text/TextLayout.hx",338,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_280_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",280,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_281_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",281,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_282_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",282,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_283_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",283,0x21621597)
HX_LOCAL_STACK_FRAME(_hx_pos_25e1fe7cb7da8702_284_boot,"openfl._internal.text._TextLayout.TextDirection_Impl_","boot",0xe4242a77,"openfl._internal.text._TextLayout.TextDirection_Impl_.boot","openfl/_internal/text/TextLayout.hx",284,0x21621597)
namespace openfl{
namespace _internal{
namespace text{
...
void TextDirection_Impl__obj::reverse(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_292_reverse)
HXDLIN( 292)		this1 = ((int)this1 ^ (int)(int)1);
            	}
...
::String TextDirection_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_297_toString)
HXDLIN( 297)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 299)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE( 300)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE( 301)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE( 302)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
HXLINE( 303)				return HX_("",00,00,00,00);
            			}
            		}
...
int TextDirection_Impl__obj::toHBDirection(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_310_toHBDirection)
HXDLIN( 310)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 312)				return (int)4;
            			}
            			break;
            			case (int)5: {
HXLINE( 313)				return (int)5;
            			}
            			break;
            			case (int)6: {
HXLINE( 314)				return (int)6;
            			}
            			break;
            			case (int)7: {
HXLINE( 315)				return (int)7;
            			}
            			break;
            			default:{
HXLINE( 316)				return (int)0;
            			}
            		}
...
bool TextDirection_Impl__obj::get_backward(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_323_get_backward)
HXDLIN( 323)		return (((int)this1 & (int)(int)-3) == (int)5);
            	}
...
bool TextDirection_Impl__obj::get_forward(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_328_get_forward)
HXDLIN( 328)		return (((int)this1 & (int)(int)-3) == (int)4);
            	}
...
bool TextDirection_Impl__obj::get_horizontal(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_333_get_horizontal)
HXDLIN( 333)		return (((int)this1 & (int)(int)-2) == (int)4);
            	}
...
bool TextDirection_Impl__obj::get_vertical(int this1){
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_338_get_vertical)
HXDLIN( 338)		return (((int)this1 & (int)(int)-2) == (int)6);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_280_boot)
HXDLIN( 280)		INVALID = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_281_boot)
HXDLIN( 281)		LEFT_TO_RIGHT = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_282_boot)
HXDLIN( 282)		RIGHT_TO_LEFT = (int)5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_283_boot)
HXDLIN( 283)		TOP_TO_BOTTOM = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_25e1fe7cb7da8702_284_boot)
HXDLIN( 284)		BOTTOM_TO_TOP = (int)7;
            	}
}
