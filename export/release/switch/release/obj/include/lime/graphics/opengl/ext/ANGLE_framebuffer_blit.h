...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_blit)(__this) )->READ_FRAMEBUFFER_BINDING_ANGLE = (int)36010;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_blit)(__this) )->DRAW_FRAMEBUFFER_BINDING_ANGLE = (int)36006;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_blit)(__this) )->DRAW_FRAMEBUFFER_ANGLE = (int)36009;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_blit)(__this) )->READ_FRAMEBUFFER_ANGLE = (int)36008;
            	}
