...
HXDLIN( 456)		return ((((x2 - x1) * (y3 - y1)) - ((y2 - y1) * (x3 - x1))) < (int)0);
            	}
...
HXLINE( 465)		{
HXLINE( 465)			int _g1 = (int)1;
HXDLIN( 465)			int _g = (len + (int)1);
HXDLIN( 465)			while((_g1 < _g)){
HXLINE( 465)				_g1 = (_g1 + (int)1);
HXDLIN( 465)				int t = (_g1 - (int)1);
HXLINE( 467)				bool _hx_tmp;
HXDLIN( 467)				if (skipT) {
HXLINE( 467)					_hx_tmp = (hx::Mod(t,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 472)				tmp = uvt->get((t - (int)1));
...
HXLINE( 487)		{
HXLINE( 487)			int _g11 = (int)1;
HXDLIN( 487)			int _g2 = (len + (int)1);
HXDLIN( 487)			while((_g11 < _g2)){
HXLINE( 487)				_g11 = (_g11 + (int)1);
HXDLIN( 487)				int t1 = (_g11 - (int)1);
HXLINE( 489)				bool _hx_tmp1;
HXDLIN( 489)				if (skipT) {
HXLINE( 489)					_hx_tmp1 = (hx::Mod(t1,(int)3) == (int)0);
            				}
            				else {
...
HXLINE( 494)				result->push(uvt->get((t1 - (int)1)));
            			}
            		}
...
static hx::StaticInfo CanvasGraphics_obj_sStaticStorageInfo[] = {
	...
	{hx::fsFloat,(void *) &CanvasGraphics_obj::worldAlpha,HX_HCSTRING("worldAlpha","\xac","\x57","\x43","\x8d")},
	{ hx::fsUnknown, 0, null()}
};
#endif
