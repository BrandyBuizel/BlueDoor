...
HXLINE(   9)		this->COMPRESSED_RGBA_S3TC_DXT5_EXT = (int)33779;
HXLINE(   8)		this->COMPRESSED_RGBA_S3TC_DXT3_EXT = (int)33778;
HXLINE(   7)		this->COMPRESSED_RGBA_S3TC_DXT1_EXT = (int)33777;
HXLINE(   6)		this->COMPRESSED_RGB_S3TC_DXT1_EXT = (int)33776;
            	}
