...
class HXCPP_CLASS_ATTRIBUTES APPLE_texture_format_BGRA8888_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< APPLE_texture_format_BGRA8888_obj > __new() {
			hx::ObjectPtr< APPLE_texture_format_BGRA8888_obj > __this = new APPLE_texture_format_BGRA8888_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< APPLE_texture_format_BGRA8888_obj > __alloc(hx::Ctx *_hx_ctx) {
...
HXDLIN(   6)		( ( ::lime::graphics::opengl::ext::APPLE_texture_format_BGRA8888)(__this) )->BGRA_EXT = (int)32993;
            	}
