...
static hx::StorageInfo RegisterMapEntry_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage*/ ,(int)offsetof(RegisterMapEntry_obj,usage),HX_HCSTRING("usage","\x21","\x5d","\x2f","\xaa")},
	{ hx::fsUnknown, 0, null()}
};
...
void RegisterMapEntry_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("openfl._internal.formats.agal._AGALConverter.RegisterMapEntry","\x9c","\x35","\x8a","\x3a");
