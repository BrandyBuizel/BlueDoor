...
class HXCPP_CLASS_ATTRIBUTES SwitchJoyconLeftID_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< SwitchJoyconLeftID_obj > __new() {
			hx::ObjectPtr< SwitchJoyconLeftID_obj > __this = new SwitchJoyconLeftID_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< SwitchJoyconLeftID_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("SwitchJoyconLeftID","\x24","\x8f","\x85","\x7b"); }
