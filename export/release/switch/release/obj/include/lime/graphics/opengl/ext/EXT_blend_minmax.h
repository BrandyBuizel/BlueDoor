...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_blend_minmax)(__this) )->MAX_EXT = (int)32776;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_blend_minmax)(__this) )->MIN_EXT = (int)32775;
            	}
