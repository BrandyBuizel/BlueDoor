...
static void FlxGamepadModel_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_JOYCON_LEFT,"SWITCH_JOYCON_LEFT");
	HX_MARK_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_JOYCON_RIGHT,"SWITCH_JOYCON_RIGHT");
	HX_MARK_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_PRO,"SWITCH_PRO");
...
static void FlxGamepadModel_obj_sVisitStatic(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_JOYCON_LEFT,"SWITCH_JOYCON_LEFT");
	HX_VISIT_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_JOYCON_RIGHT,"SWITCH_JOYCON_RIGHT");
	HX_VISIT_MEMBER_NAME(FlxGamepadModel_obj::SWITCH_PRO,"SWITCH_PRO");
...
SWITCH_JOYCON_LEFT = hx::CreateEnum< FlxGamepadModel_obj >(HX_HCSTRING("SWITCH_JOYCON_LEFT","\x6d","\xd6","\xf7","\xed"),9,0);
SWITCH_JOYCON_RIGHT = hx::CreateEnum< FlxGamepadModel_obj >(HX_HCSTRING("SWITCH_JOYCON_RIGHT","\x96","\xd6","\xf0","\xc1"),10,0);
SWITCH_PRO = hx::CreateEnum< FlxGamepadModel_obj >(HX_HCSTRING("SWITCH_PRO","\x02","\x41","\x68","\x7a"),8,0);
UNKNOWN = hx::CreateEnum< FlxGamepadModel_obj >(HX_HCSTRING("UNKNOWN","\x6a","\xf7","\x4e","\x61"),11,0);
