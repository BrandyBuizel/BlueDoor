...
void Register_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("longName","\xe7","\xb1","\x76","\xa6"));
...
static hx::StorageInfo Register_obj_sMemberStorageInfo[] = {
	{hx::fsInt,(int)offsetof(Register_obj,emitCode),HX_HCSTRING("emitCode","\x20","\xa1","\x1c","\x38")},
	{hx::fsString,(int)offsetof(Register_obj,name),HX_HCSTRING("name","\x4b","\x72","\xff","\x48")},
	{hx::fsString,(int)offsetof(Register_obj,longName),HX_HCSTRING("longName","\xe7","\xb1","\x76","\xa6")},
	{hx::fsInt,(int)offsetof(Register_obj,flags),HX_HCSTRING("flags","\x47","\x2b","\x8c","\x02")},
	{hx::fsInt,(int)offsetof(Register_obj,range),HX_HCSTRING("range","\xbd","\xa5","\x1f","\xe4")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String Register_obj_sMemberFields[] = {
	...
	HX_HCSTRING("longName","\xe7","\xb1","\x76","\xa6"),
...
{
	hx::Object *dummy = new Register_obj;
	Register_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("openfl.utils._AGALMiniAssembler.Register","\x3d","\x55","\x4b","\xc9");
