...
HXDLIN(  33)		 ::hx::Object * buffer2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_png_decode_bytes(hx::DynamicPtr(bytes),decodeData,hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));
...
HXDLIN(  58)		 ::hx::Object * buffer2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_png_decode_file(path,decodeData,hx::DynamicPtr( ::lime::graphics::ImageBuffer_obj::__alloc( HX_CTX ,this1,null(),null(),null(),null())));
...
HXDLIN(  95)			return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_image_encode(hx::DynamicPtr(image1),(int)0,(int)0,hx::DynamicPtr(_hx_tmp2))) );
            		}
