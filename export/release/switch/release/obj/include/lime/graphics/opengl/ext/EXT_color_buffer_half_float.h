...
HXLINE(  14)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->UNSIGNED_NORMALIZED_EXT = (int)35863;
HXLINE(  13)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT = (int)33297;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->R16F_EXT = (int)33325;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RG16F_EXT = (int)33327;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RGB16F_EXT = (int)34843;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_color_buffer_half_float)(__this) )->RGBA16F_EXT = (int)34842;
            	}
