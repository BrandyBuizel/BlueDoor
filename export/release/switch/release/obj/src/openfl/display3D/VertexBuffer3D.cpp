...
HXLINE(  73)		this->_hx___stride = (this->_hx___vertexSize * (int)4);
HXLINE(  74)		int _hx_tmp;
HXDLIN(  74)		if (hx::IsEq( ::openfl::display3D::_Context3DBufferUsage::Context3DBufferUsage_Impl__obj::fromString(bufferUsage),(int)0 )) {
...
HXLINE( 113)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)8);
HXDLIN( 113)			int in_byteOffset = offset;
HXDLIN( 113)			if ((in_byteOffset < (int)0)) {
HXLINE( 113)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 113)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 113)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 113)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 113)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 113)				if ((newByteLength < (int)0)) {
HXLINE( 113)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
            			else {
...
HXLINE( 168)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,count,(int)8);
            			}
            			else {
...
HXDLIN( 172)				int offset = (int)0;
HXDLIN( 172)				if (hx::IsNotNull( existingFloat32Array )) {
HXLINE( 172)					 ::haxe::io::Bytes _this1 = _this->buffer;
HXDLIN( 172)					_this1->blit((offset * _this->bytesPerElement),existingFloat32Array->buffer,existingFloat32Array->byteOffset,existingFloat32Array->byteLength);
            				}
            				else {
...
HXLINE( 176)		{
HXLINE( 176)			int _g1 = start;
HXDLIN( 176)			int _g = length;
...
HXDLIN( 178)					{
HXLINE( 178)						int this3 = this2->byteOffset;
HXDLIN( 178)						::__hxcpp_memory_set_float(this2->buffer->b,(this3 + ((i - start) * (int)4)),val);
            					}
            				}
            			}
            		}
