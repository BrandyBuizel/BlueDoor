...
HXLINE(  54)		( ( ::flixel::FlxBasic)(NewCamera) )->ID = (::flixel::FlxG_obj::cameras->list->length - (int)1);
...
HXLINE(  71)			this->list->removeRange(index,(int)1);
            		}
            		else {
...
HXDLIN(  81)			int _g = this->list->length;
...
HXLINE( 101)		while((this->list->length > (int)0)){
HXLINE( 102)			this->remove(this->list->__get((int)0).StaticCast<  ::flixel::FlxCamera >(),null());
            		}
HXLINE( 104)		if (hx::IsNull( NewCamera )) {
HXLINE( 105)			NewCamera =  ::flixel::FlxCamera_obj::__alloc( HX_CTX ,(int)0,(int)0,::flixel::FlxG_obj::width,::flixel::FlxG_obj::height,null());
            		}
HXLINE( 107)		::flixel::FlxG_obj::camera = ( ( ::flixel::FlxCamera)(this->add(NewCamera)) );
HXLINE( 108)		NewCamera->ID = (int)0;
...
HXLINE( 209)				camera->fill(((int)camera->bgColor & (int)(int)16777215),camera->useBgAlphaBlending,((Float)((int)((int)camera->bgColor >> (int)(int)24) & (int)(int)255) / (Float)(int)255),null());
            			}
            		}
            	}
...
HXDLIN( 285)			return (int)-16777216;
            		}
            		else {
