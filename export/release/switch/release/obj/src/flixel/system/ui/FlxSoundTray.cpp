...
HXLINE(  57)		 ::openfl::display::Bitmap tmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->_width,(int)30,true,(int)2130706432),null(),null());
...
HXLINE(  74)		 ::openfl::text::TextFormat dtf =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)10,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  75)		dtf->align = (int)0;
...
HXLINE(  87)				tmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)4,(i + (int)1),false,(int)-1),null(),null());
...
bool FlxSoundTray_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x19c29573) {
		...
		if (inClassId<=(int)0x3f2b00af) {
			...
			return inClassId==(int)0x5e035a1a;
		}
	}
}
...
HXLINE( 156)					this->_bars->__get(i).StaticCast<  ::openfl::display::Bitmap >()->set_alpha((int)1);
            				}
            				else {
