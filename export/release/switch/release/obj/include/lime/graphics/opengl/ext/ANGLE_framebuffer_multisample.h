...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_multisample)(__this) )->MAX_SAMPLES_ANGLE = (int)36183;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_multisample)(__this) )->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_ANGLE = (int)36182;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::ANGLE_framebuffer_multisample)(__this) )->RENDERBUFFER_SAMPLES_ANGLE = (int)36011;
            	}
