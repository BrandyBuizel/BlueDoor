...
HXLINE(  60)		if (hx::IsNotEq( handle,hx::DynamicPtr(null()) )) {
...
HXDLIN( 114)		int _g = ::lime::media::openal::ALC_obj::getError(device);
HXDLIN( 114)		switch((int)(_g)){
            			case (int)40961: {
...
HXLINE( 170)		if (hx::IsNotEq( handle,hx::DynamicPtr(null()) )) {
