...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("BlueDoor", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("BlueDoor", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "28";
		app.meta["company"] = "Milktoast Games";
		app.meta["file"] = "BlueDoor";
		app.meta["name"] = "Blue Door the Game";
		...
		#elseif !air
		app.window.context.attributes.background = 1184273;
	...
	macro public static function getPreloader()
	{
		...
		var type = Context.getType("Preloader");
		...
		return macro
		{
			new openfl.display.Preloader(new Preloader());
		}
