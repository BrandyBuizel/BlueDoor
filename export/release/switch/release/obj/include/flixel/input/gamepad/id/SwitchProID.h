...
class HXCPP_CLASS_ATTRIBUTES SwitchProID_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< SwitchProID_obj > __new() {
			hx::ObjectPtr< SwitchProID_obj > __this = new SwitchProID_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< SwitchProID_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("SwitchProID","\x94","\xee","\x41","\xa0"); }
