...
HXDLIN(  33)		_this->x = (int)0;
HXDLIN(  33)		_this->y = (int)0;
HXDLIN(  33)		_this->width = (int)0;
HXDLIN(  33)		_this->height = (int)0;
HXDLIN(  33)		 ::flixel::math::FlxRect rect = _this;
HXDLIN(  33)		rect->_inPool = false;
HXDLIN(  33)		this->bounds = rect;
HXLINE(  31)		this->colorsPosition = (int)0;
HXLINE(  30)		this->indicesPosition = (int)0;
HXLINE(  29)		this->verticesPosition = (int)0;
HXLINE(  27)		int length = null();
HXDLIN(  27)		bool fixed = null();
HXDLIN(  27)		this->colors =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length,fixed,null());
HXLINE(  26)		int length1 = null();
HXDLIN(  26)		bool fixed1 = null();
HXDLIN(  26)		this->uvtData =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length1,fixed1,null(),true);
HXLINE(  25)		int length2 = null();
HXDLIN(  25)		bool fixed2 = null();
HXDLIN(  25)		this->indices =  ::openfl::_Vector::IntVector_obj::__alloc( HX_CTX ,length2,fixed2,null());
HXLINE(  24)		int length3 = null();
HXDLIN(  24)		bool fixed3 = null();
HXDLIN(  24)		this->vertices =  ::openfl::_Vector::FloatVector_obj::__alloc( HX_CTX ,length3,fixed3,null(),true);
...
HXLINE(  46)		if ((this->get_numTriangles() <= (int)0)) {
HXLINE(  47)			return;
            		}
...
HXLINE(  51)		camera->canvas->get_graphics()->drawTriangles(this->vertices,this->indices,this->uvtData,(int)1);
...
HXDLIN(  71)			( ( ::openfl::_Vector::FloatVector)(this1) )->splice((int)0,this->vertices->get_length());
            		}
HXLINE(  72)		{
HXLINE(  72)			::Dynamic this2 = this->indices;
HXDLIN(  72)			( ( ::openfl::_Vector::IntVector)(this2) )->splice((int)0,this->indices->get_length());
            		}
HXLINE(  73)		{
HXLINE(  73)			::Dynamic this3 = this->uvtData;
HXDLIN(  73)			( ( ::openfl::_Vector::FloatVector)(this3) )->splice((int)0,this->uvtData->get_length());
            		}
HXLINE(  74)		{
HXLINE(  74)			::Dynamic this4 = this->colors;
HXDLIN(  74)			( ( ::openfl::_Vector::IntVector)(this4) )->splice((int)0,this->colors->get_length());
            		}
HXLINE(  76)		this->verticesPosition = (int)0;
HXLINE(  77)		this->indicesPosition = (int)0;
HXLINE(  78)		this->colorsPosition = (int)0;
            	}
...
HXDLIN(  99)			_this->x = (int)0;
HXDLIN(  99)			_this->y = (int)0;
HXDLIN(  99)			_this->width = ::flixel::FlxG_obj::width;
HXDLIN(  99)			_this->height = ::flixel::FlxG_obj::height;
...
HXLINE( 103)		int numberOfVertices = ::Std_obj::_hx_int(((Float)verticesLength / (Float)(int)2));
...
HXDLIN( 116)			tempY = (position2 + vertices->get((i + (int)1)));
HXLINE( 118)			{
HXLINE( 118)				currentVertexPosition = (currentVertexPosition + (int)1);
HXDLIN( 118)				this->vertices->set((currentVertexPosition - (int)1),tempX);
            			}
HXLINE( 119)			{
HXLINE( 119)				currentVertexPosition = (currentVertexPosition + (int)1);
HXDLIN( 119)				this->vertices->set((currentVertexPosition - (int)1),tempY);
            			}
HXLINE( 121)			if ((i == (int)0)) {
HXLINE( 123)				 ::flixel::math::FlxRect _this1 = this->bounds;
HXDLIN( 123)				_this1->x = tempX;
HXDLIN( 123)				_this1->y = tempY;
HXDLIN( 123)				_this1->width = (int)0;
HXDLIN( 123)				_this1->height = (int)0;
            			}
            			else {
...
HXLINE( 127)					 ::flixel::math::FlxRect bounds2 = bounds;
HXDLIN( 127)					bounds2->height = (bounds2->height + (bounds->y - tempY));
...
HXLINE( 133)			Float Rect1 = Rect->x;
HXDLIN( 133)			result2 = (Rect1 < (cameraBounds->x + cameraBounds->width));
            		}
            		else {
...
HXLINE( 133)			Float Rect2 = Rect->y;
HXDLIN( 133)			result = (Rect2 < (cameraBounds->y + cameraBounds->height));
            		}
            		else {
...
HXDLIN( 140)				int _g = uvtDataLength;
HXDLIN( 140)				while((_g1 < _g)){
HXLINE( 140)					_g1 = (_g1 + (int)1);
HXDLIN( 140)					int i1 = (_g1 - (int)1);
HXLINE( 142)					{
HXLINE( 142)						::Dynamic this2 = this->uvtData;
HXDLIN( 142)						( ( ::openfl::_Vector::FloatVector)(this2) )->set((prevUVTDataLength + i1),uvtData->get(i1));
            					}
            				}
            			}
HXLINE( 145)			int indicesLength = indices->get_length();
HXLINE( 146)			{
HXLINE( 146)				int _g11 = (int)0;
HXDLIN( 146)				int _g2 = indicesLength;
HXDLIN( 146)				while((_g11 < _g2)){
HXLINE( 146)					_g11 = (_g11 + (int)1);
HXDLIN( 146)					int i2 = (_g11 - (int)1);
HXLINE( 148)					{
HXLINE( 148)						::Dynamic this3 = this->indices;
HXDLIN( 148)						( ( ::openfl::_Vector::IntVector)(this3) )->set((prevIndicesLength + i2),(indices->get(i2) + prevNumberOfVertices));
            					}
            				}
            			}
HXLINE( 151)			if (this->colored) {
HXLINE( 153)				{
HXLINE( 153)					int _g12 = (int)0;
HXDLIN( 153)					int _g3 = numberOfVertices;
HXDLIN( 153)					while((_g12 < _g3)){
HXLINE( 153)						_g12 = (_g12 + (int)1);
HXDLIN( 153)						int i3 = (_g12 - (int)1);
HXLINE( 155)						{
HXLINE( 155)							::Dynamic this4 = this->colors;
HXDLIN( 155)							( ( ::openfl::_Vector::IntVector)(this4) )->set((prevColorsLength + i3),colors->get(i3));
            						}
            					}
            				}
...
HXLINE( 161)			 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 161)			_hx_tmp1->verticesPosition = (_hx_tmp1->verticesPosition + verticesLength);
HXLINE( 162)			 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 162)			_hx_tmp2->indicesPosition = (_hx_tmp2->indicesPosition + indicesLength);
            		}
...
HXLINE( 203)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 203)		point->_inPool = false;
HXDLIN( 203)		 ::flixel::math::FlxPoint point1 = point;
HXLINE( 204)		{
HXLINE( 204)			Float x1 = (point1->x * matrix->a);
HXDLIN( 204)			Float x11 = ((x1 + (point1->y * matrix->c)) + matrix->tx);
HXDLIN( 204)			Float y1 = (point1->x * matrix->b);
HXDLIN( 204)			Float y11 = ((y1 + (point1->y * matrix->d)) + matrix->ty);
HXDLIN( 204)			point1->set(x11,y11);
            		}
HXLINE( 206)		this->vertices->set(prevVerticesPos,point1->x);
HXLINE( 207)		this->vertices->set((prevVerticesPos + (int)1),point1->y);
HXLINE( 209)		this->uvtData->set(prevVerticesPos,frame->uv->x);
HXLINE( 210)		this->uvtData->set((prevVerticesPos + (int)1),frame->uv->y);
HXLINE( 212)		point1->set(frame->frame->width,(int)0);
HXLINE( 213)		{
HXLINE( 213)			Float x12 = (point1->x * matrix->a);
HXDLIN( 213)			Float x13 = ((x12 + (point1->y * matrix->c)) + matrix->tx);
HXDLIN( 213)			Float y12 = (point1->x * matrix->b);
HXDLIN( 213)			Float y13 = ((y12 + (point1->y * matrix->d)) + matrix->ty);
HXDLIN( 213)			point1->set(x13,y13);
            		}
HXLINE( 215)		this->vertices->set((prevVerticesPos + (int)2),point1->x);
HXLINE( 216)		this->vertices->set((prevVerticesPos + (int)3),point1->y);
HXLINE( 218)		this->uvtData->set((prevVerticesPos + (int)2),frame->uv->width);
HXLINE( 219)		this->uvtData->set((prevVerticesPos + (int)3),frame->uv->y);
HXLINE( 221)		point1->set(frame->frame->width,frame->frame->height);
HXLINE( 222)		{
HXLINE( 222)			Float x14 = (point1->x * matrix->a);
HXDLIN( 222)			Float x15 = ((x14 + (point1->y * matrix->c)) + matrix->tx);
HXDLIN( 222)			Float y14 = (point1->x * matrix->b);
HXDLIN( 222)			Float y15 = ((y14 + (point1->y * matrix->d)) + matrix->ty);
HXDLIN( 222)			point1->set(x15,y15);
            		}
HXLINE( 224)		this->vertices->set((prevVerticesPos + (int)4),point1->x);
HXLINE( 225)		this->vertices->set((prevVerticesPos + (int)5),point1->y);
HXLINE( 227)		this->uvtData->set((prevVerticesPos + (int)4),frame->uv->width);
HXLINE( 228)		this->uvtData->set((prevVerticesPos + (int)5),frame->uv->height);
HXLINE( 230)		point1->set((int)0,frame->frame->height);
HXLINE( 231)		{
HXLINE( 231)			Float x16 = (point1->x * matrix->a);
HXDLIN( 231)			Float x17 = ((x16 + (point1->y * matrix->c)) + matrix->tx);
HXDLIN( 231)			Float y16 = (point1->x * matrix->b);
HXDLIN( 231)			Float y17 = ((y16 + (point1->y * matrix->d)) + matrix->ty);
HXDLIN( 231)			point1->set(x17,y17);
            		}
HXLINE( 233)		this->vertices->set((prevVerticesPos + (int)6),point1->x);
HXLINE( 234)		this->vertices->set((prevVerticesPos + (int)7),point1->y);
HXLINE( 236)		point1->put();
HXLINE( 238)		this->uvtData->set((prevVerticesPos + (int)6),frame->uv->x);
HXLINE( 239)		this->uvtData->set((prevVerticesPos + (int)7),frame->uv->height);
HXLINE( 241)		this->indices->set(prevIndicesPos,prevNumberOfVertices);
HXLINE( 242)		this->indices->set((prevIndicesPos + (int)1),(prevNumberOfVertices + (int)1));
HXLINE( 243)		this->indices->set((prevIndicesPos + (int)2),(prevNumberOfVertices + (int)2));
HXLINE( 244)		this->indices->set((prevIndicesPos + (int)3),(prevNumberOfVertices + (int)2));
HXLINE( 245)		this->indices->set((prevIndicesPos + (int)4),(prevNumberOfVertices + (int)3));
HXLINE( 246)		this->indices->set((prevIndicesPos + (int)5),prevNumberOfVertices);
...
HXDLIN( 266)			{
HXLINE( 266)				int Value = ::Math_obj::round((red * (int)255));
HXDLIN( 266)				color = ((int)color & (int)(int)-16711681);
HXDLIN( 266)				int color1;
HXDLIN( 266)				if ((Value > (int)255)) {
HXLINE( 266)					color1 = (int)255;
            				}
            				else {
HXLINE( 266)					if ((Value < (int)0)) {
HXLINE( 266)						color1 = (int)0;
            					}
            					else {
HXLINE( 266)						color1 = Value;
            					}
            				}
HXDLIN( 266)				color = ((int)color | (int)((int)color1 << (int)(int)16));
            			}
HXDLIN( 266)			{
HXLINE( 266)				int Value1 = ::Math_obj::round((green * (int)255));
HXDLIN( 266)				color = ((int)color & (int)(int)-65281);
HXDLIN( 266)				int color2;
HXDLIN( 266)				if ((Value1 > (int)255)) {
HXLINE( 266)					color2 = (int)255;
            				}
            				else {
HXLINE( 266)					if ((Value1 < (int)0)) {
HXLINE( 266)						color2 = (int)0;
            					}
            					else {
HXLINE( 266)						color2 = Value1;
            					}
            				}
HXDLIN( 266)				color = ((int)color | (int)((int)color2 << (int)(int)8));
            			}
HXDLIN( 266)			{
HXLINE( 266)				int Value2 = ::Math_obj::round((blue * (int)255));
HXDLIN( 266)				color = ((int)color & (int)(int)-256);
HXDLIN( 266)				int color3;
HXDLIN( 266)				if ((Value2 > (int)255)) {
HXLINE( 266)					color3 = (int)255;
            				}
            				else {
HXLINE( 266)					if ((Value2 < (int)0)) {
HXLINE( 266)						color3 = (int)0;
            					}
            					else {
HXLINE( 266)						color3 = Value2;
            					}
            				}
HXDLIN( 266)				color = ((int)color | (int)color3);
            			}
HXDLIN( 266)			{
HXLINE( 266)				int Value3 = ::Math_obj::round((alpha * (int)255));
HXDLIN( 266)				color = ((int)color & (int)(int)16777215);
HXDLIN( 266)				int color4;
HXDLIN( 266)				if ((Value3 > (int)255)) {
HXLINE( 266)					color4 = (int)255;
            				}
            				else {
HXLINE( 266)					if ((Value3 < (int)0)) {
HXLINE( 266)						color4 = (int)0;
            					}
            					else {
HXLINE( 266)						color4 = Value3;
            					}
            				}
HXDLIN( 266)				color = ((int)color | (int)((int)color4 << (int)(int)24));
            			}
HXDLIN( 266)			int color5 = color;
HXLINE( 268)			this->colors->set(prevColorsPos,color5);
HXLINE( 269)			this->colors->set((prevColorsPos + (int)1),color5);
HXLINE( 270)			this->colors->set((prevColorsPos + (int)2),color5);
HXLINE( 271)			this->colors->set((prevColorsPos + (int)3),color5);
HXLINE( 273)			 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 273)			_hx_tmp->colorsPosition = (_hx_tmp->colorsPosition + (int)4);
            		}
HXLINE( 276)		 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 276)		_hx_tmp1->verticesPosition = (_hx_tmp1->verticesPosition + (int)8);
HXLINE( 277)		 ::flixel::graphics::tile::FlxDrawTrianglesItem _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 277)		_hx_tmp2->indicesPosition = (_hx_tmp2->indicesPosition + (int)6);
            	}


int FlxDrawTrianglesItem_obj::get_numVertices(){
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_282_get_numVertices)
HXDLIN( 282)		return ::Std_obj::_hx_int(((Float)this->vertices->get_length() / (Float)(int)2));
            	}


int FlxDrawTrianglesItem_obj::get_numTriangles(){
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_287_get_numTriangles)
HXDLIN( 287)		return ::Std_obj::_hx_int(((Float)this->indices->get_length() / (Float)(int)3));
            	}
...
HXLINE( 179)			 ::flixel::math::FlxRect bounds2 = bounds;
HXDLIN( 179)			bounds2->height = (bounds2->height + (bounds->y - y));
...
HXDLIN(  21)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN(  21)			return point;
            	...
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_21_boot)
HXDLIN(  21)		point =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
...
HXDLIN(  22)			_this->x = (int)0;
HXDLIN(  22)			_this->y = (int)0;
HXDLIN(  22)			_this->width = (int)0;
HXDLIN(  22)			_this->height = (int)0;
...
HXDLIN(  22)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_a928be64e2bd594d_22_boot)
HXDLIN(  22)		rect =  ::Dynamic(new _hx_Closure_0())();
            	}
}
