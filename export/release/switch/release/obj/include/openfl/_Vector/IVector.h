...
class HXCPP_CLASS_ATTRIBUTES IVector_obj {
	public:
		...
		static inline ::Dynamic concat( ::Dynamic _hx_,::Dynamic vec) {
			return (_hx_.mPtr->*( static_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_concat)(vec);
		}
		...
		static inline int push( ::Dynamic _hx_, ::Dynamic value) {
			return (_hx_.mPtr->*( static_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_push)(value);
		}
		...
		static inline ::Dynamic slice( ::Dynamic _hx_,hx::Null< int >  startIndex, ::Dynamic endIndex) {
			return (_hx_.mPtr->*( static_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_slice)(startIndex,endIndex);
		}
		...
		static inline void unshift( ::Dynamic _hx_, ::Dynamic value) {
			(_hx_.mPtr->*( static_cast< ::openfl::_Vector::IVector_obj *>(_hx_.mPtr->_hx_getInterface(0x45e7caba)))->_hx_unshift)(value);
		}
};
