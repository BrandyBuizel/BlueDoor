...
HXDLIN( 504)			::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(::haxe::IMap_obj::get(this->frameCollections,type)) );
HXDLIN( 504)			if (hx::IsNull( collections )) {
HXLINE( 504)				collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 504)				::haxe::IMap_obj::set(this->frameCollections,type,collections);
            			}
...
HXLINE( 536)		frame->type = (int)2;
HXLINE( 537)		 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 537)		_this->x = (int)0;
HXDLIN( 537)		_this->y = (int)0;
HXDLIN( 537)		_this->width = (int)0;
HXDLIN( 537)		_this->height = (int)0;
...
HXLINE( 573)			newBitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(this->assetsClass,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            		}
            		else {
...
HXLINE( 575)					 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 575)					newBitmap = null();
            				}
            			}
            		}
...
HXDLIN( 608)		if (Value) {
HXLINE( 608)			_hx_tmp2 = (this->_useCount <= (int)0);
            		}
            		else {
...
HXLINE( 617)			Float Width = this->bitmap->width;
HXDLIN( 617)			Float Height = this->bitmap->height;
...
HXLINE(  46)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXLINE(  53)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
...
HXLINE(  57)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
...
HXLINE(  79)		if (!(Cache)) {
HXLINE(  81)			bitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
...
HXLINE(  87)		 ::flixel::graphics::FlxGraphic graphic = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
HXLINE(  88)		if (hx::IsNotNull( graphic )) {
HXLINE(  89)			return graphic;
            		}
HXLINE(  91)		bitmap = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
...
HXLINE( 257)			::haxe::IMap_obj::set(::flixel::FlxG_obj::bitmap->_cache,graphic->key,graphic);
            		}
            		else {
...
static hx::StorageInfo FlxGraphic_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flixel::graphics::tile::FlxGraphicsShader*/ ,(int)offsetof(FlxGraphic_obj,shader),HX_HCSTRING("shader","\x25","\xbf","\x20","\x1d")},
