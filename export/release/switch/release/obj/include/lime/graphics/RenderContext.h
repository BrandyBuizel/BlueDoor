...
HX_DECLARE_STACK_FRAME(_hx_pos_96059818be203dd4_90_new)
...
class HXCPP_CLASS_ATTRIBUTES RenderContext_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< RenderContext_obj > __new() {
			...
			*(void **)__this = RenderContext_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_HCSTRING("RenderContext","\x19","\x59","\x55","\x5d"); }
