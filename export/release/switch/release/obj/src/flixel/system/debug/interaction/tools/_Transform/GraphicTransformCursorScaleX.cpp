...
HX_DEFINE_STACK_FRAME(_hx_pos_8b2bc0efbb7e42ce_47_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX","new",0xd67be164,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_e3b32a0fee702fae_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX","boot",0xce0256ae,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformCursorScaleX_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_8b2bc0efbb7e42ce_47_new)
...
bool GraphicTransformCursorScaleX_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28c743a7) {
		...
		return inClassId==(int)0x2c3d89e6;
	}
}
...
static hx::StaticInfo GraphicTransformCursorScaleX_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &GraphicTransformCursorScaleX_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void GraphicTransformCursorScaleX_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(GraphicTransformCursorScaleX_obj::__mClass,"__mClass");
...
static void GraphicTransformCursorScaleX_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(GraphicTransformCursorScaleX_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new GraphicTransformCursorScaleX_obj;
	GraphicTransformCursorScaleX_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleX","\x72","\x9f","\xd6","\x3a");
...
{
{
            	HX_STACKFRAME(&_hx_pos_e3b32a0fee702fae_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorScaleX",aa,65,6b,08);
            	}
}
