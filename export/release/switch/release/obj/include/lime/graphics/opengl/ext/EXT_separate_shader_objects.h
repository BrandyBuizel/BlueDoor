...
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->PROGRAM_PIPELINE_BINDING_EXT = (int)33370;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->ACTIVE_PROGRAM_EXT = (int)33369;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->PROGRAM_SEPARABLE_EXT = (int)33368;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->ALL_SHADER_BITS_EXT = (int)-1;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->FRAGMENT_SHADER_BIT_EXT = (int)2;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_separate_shader_objects)(__this) )->VERTEX_SHADER_BIT_EXT = (int)1;
            	}
