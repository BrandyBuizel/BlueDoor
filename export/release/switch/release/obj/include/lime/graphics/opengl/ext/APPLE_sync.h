...
HXLINE(  21)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->TIMEOUT_IGNORED_APPLE = (int)-1;
HXLINE(  20)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_FLUSH_COMMANDS_BIT_APPLE = (int)1;
HXLINE(  19)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->WAIT_FAILED_APPLE = (int)37149;
HXLINE(  18)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->CONDITION_SATISFIED_APPLE = (int)37148;
HXLINE(  17)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->TIMEOUT_EXPIRED_APPLE = (int)37147;
HXLINE(  16)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->ALREADY_SIGNALED_APPLE = (int)37146;
HXLINE(  15)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SIGNALED_APPLE = (int)37145;
HXLINE(  14)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->UNSIGNALED_APPLE = (int)37144;
HXLINE(  13)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_GPU_COMMANDS_COMPLETE_APPLE = (int)37143;
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_FENCE_APPLE = (int)37142;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_FLAGS_APPLE = (int)37141;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_STATUS_APPLE = (int)37140;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_CONDITION_APPLE = (int)37139;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->OBJECT_TYPE_APPLE = (int)37138;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->MAX_SERVER_WAIT_TIMEOUT_APPLE = (int)37137;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::APPLE_sync)(__this) )->SYNC_OBJECT_APPLE = (int)35411;
            	}
