...
HXDLIN(  54)		if ((c < (int)192)) {
HXDLIN(  54)			len = (int)1;
            		}
            		else {
HXDLIN(  54)			if ((c < (int)224)) {
HXDLIN(  54)				len = (int)2;
            			}
            			else {
HXDLIN(  54)				if ((c < (int)240)) {
HXDLIN(  54)					len = (int)3;
            				}
            				else {
HXDLIN(  54)					if ((c < (int)248)) {
HXDLIN(  54)						len = (int)4;
            					}
            					else {
HXDLIN(  54)						len = (int)1;
...
HXDLIN(  72)		if ((c < (int)192)) {
HXDLIN(  72)			return (int)1;
            		}
            		else {
HXDLIN(  72)			if ((c < (int)224)) {
HXDLIN(  72)				return (int)2;
            			}
            			else {
HXDLIN(  72)				if ((c < (int)240)) {
HXDLIN(  72)					return (int)3;
            				}
            				else {
HXDLIN(  72)					if ((c < (int)248)) {
HXDLIN(  72)						return (int)4;
            					}
            					else {
HXDLIN(  72)						return (int)1;
            					}
...
HXDLIN(  90)				if ((c < (int)192)) {
HXDLIN(  90)					index2 = (int)1;
            				}
            				else {
HXDLIN(  90)					if ((c < (int)224)) {
HXDLIN(  90)						index2 = (int)2;
            					}
            					else {
HXDLIN(  90)						if ((c < (int)240)) {
HXDLIN(  90)							index2 = (int)3;
            						}
            						else {
HXDLIN(  90)							if ((c < (int)248)) {
HXDLIN(  90)								index2 = (int)4;
            							}
            							else {
HXDLIN(  90)								index2 = (int)1;
            							}
...
HXDLIN(  90)				::String this5 = this4;
HXDLIN(  90)				int c1 = this5.cca((index3 - (int)1));
HXDLIN(  90)				int index4;
HXDLIN(  90)				bool index5;
HXDLIN(  90)				if ((c1 >= (int)128)) {
HXDLIN(  90)					index5 = (c1 >= (int)192);
            				}
            				else {
HXDLIN(  90)					index5 = true;
            				}
HXDLIN(  90)				if (index5) {
HXDLIN(  90)					index4 = (int)1;
            				}
            				else {
HXDLIN(  90)					::String this6 = this4;
HXDLIN(  90)					if ((((int)this6.cca((index3 - (int)2)) & (int)(int)224) == (int)192)) {
HXDLIN(  90)						index4 = (int)2;
            					}
            					else {
HXDLIN(  90)						::String this7 = this4;
HXDLIN(  90)						if ((((int)this7.cca((index3 - (int)3)) & (int)(int)240) == (int)224)) {
HXDLIN(  90)							index4 = (int)3;
            						}
            						else {
HXDLIN(  90)							::String this8 = this4;
HXDLIN(  90)							if ((((int)this8.cca((index3 - (int)4)) & (int)(int)248) == (int)240)) {
HXDLIN(  90)								index4 = (int)4;
            							}
            							else {
HXDLIN(  90)								index4 = (int)1;
            							}
...
HXDLIN(  90)				count = (count + (int)1);
            			}
            			_hx_goto_8:;
HXDLIN(  90)			return index3;
            		}
HXDLIN(  90)		return (int)0;
            	}
...
HXDLIN( 100)		if ((codePointOffset1 >= (int)0)) {
...
HXDLIN( 100)					index2 = (int)1;
            				}
            				else {
HXDLIN( 100)					if ((c < (int)224)) {
HXDLIN( 100)						index2 = (int)2;
            					}
            					else {
HXDLIN( 100)						if ((c < (int)240)) {
HXDLIN( 100)							index2 = (int)3;
            						}
            						else {
HXDLIN( 100)							if ((c < (int)248)) {
HXDLIN( 100)								index2 = (int)4;
            							}
            							else {
HXDLIN( 100)								index2 = (int)1;
            							}
...
HXDLIN( 100)					_hx_tmp1 = ((int)0 < index3);
            				}
            				else {
...
HXDLIN( 108)		if ((codePoint <= (int)127)) {
HXDLIN( 108)			buf->b->push(codePoint);
            		}
            		else {
HXDLIN( 108)			if ((codePoint <= (int)2047)) {
HXDLIN( 108)				::Array< unsigned char > buf1 = buf->b;
HXDLIN( 108)				buf1->push(((int)(int)192 | (int)((int)codePoint >> (int)(int)6)));
HXDLIN( 108)				::Array< unsigned char > buf2 = buf->b;
HXDLIN( 108)				buf2->push(((int)(int)128 | (int)((int)codePoint & (int)(int)63)));
            			}
            			else {
HXDLIN( 108)				if ((codePoint <= (int)65535)) {
HXDLIN( 108)					::Array< unsigned char > buf3 = buf->b;
HXDLIN( 108)					buf3->push(((int)(int)224 | (int)((int)codePoint >> (int)(int)12)));
HXDLIN( 108)					::Array< unsigned char > buf4 = buf->b;
HXDLIN( 108)					buf4->push(((int)(int)128 | (int)((int)((int)codePoint >> (int)(int)6) & (int)(int)63)));
HXDLIN( 108)					::Array< unsigned char > buf5 = buf->b;
HXDLIN( 108)					buf5->push(((int)(int)128 | (int)((int)codePoint & (int)(int)63)));
            				}
            				else {
HXDLIN( 108)					if ((codePoint <= (int)1114111)) {
HXDLIN( 108)						::Array< unsigned char > buf6 = buf->b;
HXDLIN( 108)						buf6->push(((int)(int)240 | (int)((int)codePoint >> (int)(int)18)));
HXDLIN( 108)						::Array< unsigned char > buf7 = buf->b;
HXDLIN( 108)						buf7->push(((int)(int)128 | (int)((int)((int)codePoint >> (int)(int)12) & (int)(int)63)));
HXDLIN( 108)						::Array< unsigned char > buf8 = buf->b;
HXDLIN( 108)						buf8->push(((int)(int)128 | (int)((int)((int)codePoint >> (int)(int)6) & (int)(int)63)));
HXDLIN( 108)						::Array< unsigned char > buf9 = buf->b;
HXDLIN( 108)						buf9->push(((int)(int)128 | (int)((int)codePoint & (int)(int)63)));
            					}
            					else {
...
HXDLIN( 116)				if ((c1 <= (int)127)) {
HXDLIN( 116)					buf->b->push(c1);
            				}
            				else {
HXDLIN( 116)					if ((c1 <= (int)2047)) {
HXDLIN( 116)						::Array< unsigned char > buf1 = buf->b;
HXDLIN( 116)						buf1->push(((int)(int)192 | (int)((int)c1 >> (int)(int)6)));
HXDLIN( 116)						::Array< unsigned char > buf2 = buf->b;
HXDLIN( 116)						buf2->push(((int)(int)128 | (int)((int)c1 & (int)(int)63)));
            					}
            					else {
HXDLIN( 116)						if ((c1 <= (int)65535)) {
HXDLIN( 116)							::Array< unsigned char > buf3 = buf->b;
HXDLIN( 116)							buf3->push(((int)(int)224 | (int)((int)c1 >> (int)(int)12)));
HXDLIN( 116)							::Array< unsigned char > buf4 = buf->b;
HXDLIN( 116)							buf4->push(((int)(int)128 | (int)((int)((int)c1 >> (int)(int)6) & (int)(int)63)));
HXDLIN( 116)							::Array< unsigned char > buf5 = buf->b;
HXDLIN( 116)							buf5->push(((int)(int)128 | (int)((int)c1 & (int)(int)63)));
            						}
            						else {
HXDLIN( 116)							if ((c1 <= (int)1114111)) {
HXDLIN( 116)								::Array< unsigned char > buf6 = buf->b;
HXDLIN( 116)								buf6->push(((int)(int)240 | (int)((int)c1 >> (int)(int)18)));
HXDLIN( 116)								::Array< unsigned char > buf7 = buf->b;
HXDLIN( 116)								buf7->push(((int)(int)128 | (int)((int)((int)c1 >> (int)(int)12) & (int)(int)63)));
HXDLIN( 116)								::Array< unsigned char > buf8 = buf->b;
HXDLIN( 116)								buf8->push(((int)(int)128 | (int)((int)((int)c1 >> (int)(int)6) & (int)(int)63)));
HXDLIN( 116)								::Array< unsigned char > buf9 = buf->b;
HXDLIN( 116)								buf9->push(((int)(int)128 | (int)((int)c1 & (int)(int)63)));
            							}
            							else {
...
HXDLIN( 148)		if ((c <= (int)127)) {
HXDLIN( 148)			f(c);
            		}
            		else {
HXDLIN( 148)			if ((c <= (int)2047)) {
HXDLIN( 148)				f(((int)(int)192 | (int)((int)c >> (int)(int)6)));
HXDLIN( 148)				f(((int)(int)128 | (int)((int)c & (int)(int)63)));
            			}
            			else {
HXDLIN( 148)				if ((c <= (int)65535)) {
HXDLIN( 148)					f(((int)(int)224 | (int)((int)c >> (int)(int)12)));
HXDLIN( 148)					f(((int)(int)128 | (int)((int)((int)c >> (int)(int)6) & (int)(int)63)));
HXDLIN( 148)					f(((int)(int)128 | (int)((int)c & (int)(int)63)));
            				}
            				else {
HXDLIN( 148)					if ((c <= (int)1114111)) {
HXDLIN( 148)						f(((int)(int)240 | (int)((int)c >> (int)(int)18)));
HXDLIN( 148)						f(((int)(int)128 | (int)((int)((int)c >> (int)(int)12) & (int)(int)63)));
HXDLIN( 148)						f(((int)(int)128 | (int)((int)((int)c >> (int)(int)6) & (int)(int)63)));
HXDLIN( 148)						f(((int)(int)128 | (int)((int)c & (int)(int)63)));
            					}
            					else {
