...
HXDLIN(  49)			{
HXLINE(  49)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),null(),null(),(int)0);
HXDLIN(  49)				gl->texImage2D(target,(int)0,internalformat,width1,height1,(int)0,format1,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
HXLINE(  50)		this->_hx___context->_hx___bindGLTexture2D(null());
HXLINE(  52)		if (optimizeForRenderToTexture) {
HXLINE(  52)			this->_hx___getGLFramebuffer(true,(int)0,(int)0);
            		}
            	}
...
HXLINE(  95)			::haxe::Timer_obj::delay( ::Dynamic(new _hx_Closure_0(_gthis,data,byteArrayOffset)),(int)1);
            		}
            	}
...
HXLINE( 149)		int width = ((int)this->_hx___width >> (int)miplevel);
HXLINE( 150)		int height = ((int)this->_hx___height >> (int)miplevel);
HXLINE( 152)		bool _hx_tmp;
HXDLIN( 152)		if ((width == (int)0)) {
HXLINE( 152)			_hx_tmp = (height == (int)0);
            		}
            		else {
...
HXLINE( 154)		if ((width == (int)0)) {
HXLINE( 154)			width = (int)1;
            		}
HXLINE( 155)		if ((height == (int)0)) {
HXLINE( 155)			height = (int)1;
            		}
...
HXLINE( 159)			 ::openfl::display::BitmapData copy =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
...
HXDLIN( 229)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 229)			int in_byteOffset = byteArrayOffset;
HXDLIN( 229)			if ((in_byteOffset < (int)0)) {
HXDLIN( 229)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 229)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXDLIN( 229)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 229)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXDLIN( 229)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 229)				if ((newByteLength < (int)0)) {
HXDLIN( 229)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXLINE( 248)		int width = ((int)this->_hx___width >> (int)miplevel);
HXLINE( 249)		int height = ((int)this->_hx___height >> (int)miplevel);
HXLINE( 251)		bool _hx_tmp;
HXDLIN( 251)		if ((width == (int)0)) {
HXLINE( 251)			_hx_tmp = (height == (int)0);
            		}
            		else {
...
HXLINE( 253)		if ((width == (int)0)) {
HXLINE( 253)			width = (int)1;
            		}
HXLINE( 254)		if ((height == (int)0)) {
HXLINE( 254)			height = (int)1;
            		}
...
HXDLIN( 257)			{
HXLINE( 257)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data,null(),(int)0);
HXDLIN( 257)				gl->texImage2D(target,miplevel,internalformat,width,height,(int)0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
...
HXDLIN( 267)			if (hx::IsNotEq( state->mipfilter,(int)2 )) {
...
HXLINE( 273)			if ((::openfl::display3D::Context3D_obj::_hx___glMaxTextureMaxAnisotropy != (int)0)) {
HXLINE( 275)				int aniso;
HXDLIN( 275)				 ::Dynamic _g = state->filter;
HXDLIN( 275)				 ::Dynamic _hx_switch_0 = _g;
            				if (  (_hx_switch_0==(int)0) ){
HXLINE( 275)					aniso = (int)16;
HXDLIN( 275)					goto _hx_goto_6;
            				}
            				if (  (_hx_switch_0==(int)1) ){
HXLINE( 275)					aniso = (int)2;
HXDLIN( 275)					goto _hx_goto_6;
            				}
            				if (  (_hx_switch_0==(int)2) ){
HXLINE( 275)					aniso = (int)4;
HXDLIN( 275)					goto _hx_goto_6;
            				}
            				if (  (_hx_switch_0==(int)3) ){
HXLINE( 275)					aniso = (int)8;
HXDLIN( 275)					goto _hx_goto_6;
            				}
            				/* default */{
HXLINE( 275)					aniso = (int)1;
            				}
            				_hx_goto_6:;
...
HXLINE( 289)				gl->texParameterf(gl->TEXTURE_2D,::openfl::display3D::Context3D_obj::_hx___glTextureMaxAnisotropy,aniso);
            			}
...
HXLINE( 314)			if (hx::IsEq( format,(int)0 )) {
HXLINE( 314)				return;
            			}
HXLINE( 316)			hasTexture[(int)0] = true;
HXLINE( 317)			_gthis->_hx___format = format;
HXLINE( 318)			_gthis->_hx___internalFormat = format;
HXLINE( 320)			bool _hx_tmp;
HXDLIN( 320)			if (alpha) {
HXLINE( 320)				_hx_tmp = (gpuFormat == (int)2);
            			}
            			else {
HXLINE( 320)				_hx_tmp = false;
            			}
HXDLIN( 320)			if (_hx_tmp) {
HXLINE( 322)				int size = ::Std_obj::_hx_int(((Float)blockLength / (Float)(int)2));
...
HXLINE( 325)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 325)					int in_byteOffset = (int)0;
HXDLIN( 325)					if ((in_byteOffset < (int)0)) {
HXLINE( 325)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 325)					if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 325)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 325)						if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 325)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 325)						if ((newByteLength < (int)0)) {
HXLINE( 325)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 324)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,_gthis1,level,_gthis2,width,height,(int)0,this1);
HXLINE( 327)				 ::openfl::display3D::textures::Texture alphaTexture =  ::openfl::display3D::textures::Texture_obj::__alloc( HX_CTX ,_gthis->_hx___context,_gthis->_hx___width,_gthis->_hx___height,(int)3,_gthis->_hx___optimizeForRenderToTexture,_gthis->_hx___streamingLevels);
HXLINE( 329)				alphaTexture->_hx___format = format;
HXLINE( 330)				alphaTexture->_hx___internalFormat = format;
...
HXLINE( 334)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 334)					int in_byteOffset1 = size;
HXDLIN( 334)					if ((in_byteOffset1 < (int)0)) {
HXLINE( 334)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 334)					if ((hx::Mod(in_byteOffset1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 334)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 334)						if ((hx::Mod(bufferByteLength1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 334)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 334)						if ((newByteLength1 < (int)0)) {
HXLINE( 334)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 333)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,alphaTexture1,level,alphaTexture2,width,height,(int)0,this2);
...
HXLINE( 341)					 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 341)					int in_byteOffset2 = (int)0;
HXDLIN( 341)					if ((in_byteOffset2 < (int)0)) {
HXLINE( 341)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 341)					if ((hx::Mod(in_byteOffset2,_this2->bytesPerElement) != (int)0)) {
HXLINE( 341)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 341)						if ((hx::Mod(bufferByteLength2,_this2->bytesPerElement) != (int)0)) {
HXLINE( 341)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 341)						if ((newByteLength2 < (int)0)) {
HXLINE( 341)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 340)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,_gthis3,level,_gthis4,width,height,(int)0,this3);
            			}
            		}
...
HXLINE( 345)		if (!(hasTexture->__get((int)0))) {
HXLINE( 347)			 ::Dynamic elements = ((this->_hx___width * this->_hx___height) * (int)4);
HXDLIN( 347)			 ::lime::utils::ArrayBufferView this4;
HXDLIN( 347)			if (hx::IsNotNull( elements )) {
HXLINE( 347)				this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,(int)4);
            			}
            			else {
...
HXDLIN( 348)				{
HXLINE( 348)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data1,null(),(int)0);
HXDLIN( 348)					gl->texImage2D(target1,(int)0,internalformat,width1,height1,(int)0,format1,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            				}
            			}
            		}
