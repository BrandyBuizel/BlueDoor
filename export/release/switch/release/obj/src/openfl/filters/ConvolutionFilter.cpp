...
HXLINE( 227)		this->_hx___numShaderPasses = (int)1;
            	}
...
HXLINE( 239)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uDivisor->value[(int)0] = this->divisor;
HXLINE( 240)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uBias->value[(int)0] = this->bias;
HXLINE( 241)		::openfl::filters::ConvolutionFilter_obj::_hx___convolutionShader->uPreserveAlpha->value[(int)0] = this->preserveAlpha;
