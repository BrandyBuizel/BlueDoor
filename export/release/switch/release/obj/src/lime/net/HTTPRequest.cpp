...
HX_DEFINE_STACK_FRAME(_hx_pos_b3faec552c086965_19_new,"lime.net.HTTPRequest","new",0xc8d2372f,"lime.net.HTTPRequest.new","lime/net/HTTPRequest.hx",19,0x339db723)
namespace lime{
namespace net{

void HTTPRequest_obj::__construct(::String uri){
            	HX_STACKFRAME(&_hx_pos_b3faec552c086965_19_new)
HXDLIN(  19)		super::__construct(uri);
            	}
