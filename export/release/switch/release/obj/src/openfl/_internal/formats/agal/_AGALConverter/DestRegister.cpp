...
HXLINE( 541)		if ((((int)this->mask & (int)(int)1) != (int)0)) {
HXLINE( 541)			str = (str + HX_("x",78,00,00,00));
            		}
HXLINE( 542)		if ((((int)this->mask & (int)(int)2) != (int)0)) {
HXLINE( 542)			str = (str + HX_("y",79,00,00,00));
            		}
HXLINE( 543)		if ((((int)this->mask & (int)(int)4) != (int)0)) {
HXLINE( 543)			str = (str + HX_("z",7a,00,00,00));
            		}
HXLINE( 544)		if ((((int)this->mask & (int)(int)8) != (int)0)) {
...
HXLINE( 571)			_hx_tmp = (this->mask != (int)15);
            		}
            		else {
