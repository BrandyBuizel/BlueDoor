...
HXLINE(  70)		if ((this->_distance >= (int)0)) {
HXLINE(  71)			return this->_distance;
            		}
HXLINE(  72)		Float _hx_tmp = (this->_moveX * this->_moveX);
HXDLIN(  72)		return (this->_distance = ::Math_obj::sqrt((_hx_tmp + (this->_moveY * this->_moveY))));
            	}
