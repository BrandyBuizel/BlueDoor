...
HXDLIN( 639)		_this->x = (int)0;
HXDLIN( 639)		_this->y = (int)0;
HXDLIN( 639)		_this->width = (int)0;
HXDLIN( 639)		_this->height = (int)0;
HXDLIN( 639)		 ::flixel::math::FlxRect rect = _this;
HXDLIN( 639)		rect->_inPool = false;
HXDLIN( 639)		this->_rect = rect;
HXLINE( 637)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 637)		point->_inPool = false;
HXDLIN( 637)		this->_point = point;
HXLINE( 634)		this->path = null();
HXLINE( 592)		this->collisonXDrag = true;
HXLINE( 586)		this->allowCollisions = (int)4369;
HXLINE( 580)		this->wasTouching = (int)0;
HXLINE( 574)		this->touching = (int)0;
...
HXLINE( 665)		this->flixelType = (int)1;
...
HXLINE( 667)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)1,(int)1);
...
HXLINE( 670)		{
HXLINE( 670)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 670)			point2->_inPool = false;
HXDLIN( 670)			this->velocity = point2;
HXDLIN( 670)			 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 670)			point3->_inPool = false;
HXDLIN( 670)			this->acceleration = point3;
HXDLIN( 670)			 ::flixel::math::FlxPoint point4 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 670)			point4->_inPool = false;
HXDLIN( 670)			this->drag = point4;
HXDLIN( 670)			 ::flixel::math::FlxPoint point5 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)10000,(int)10000);
...
HXLINE( 679)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 679)		point->_inPool = false;
HXDLIN( 679)		this->velocity = point;
HXLINE( 680)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 680)		point1->_inPool = false;
HXDLIN( 680)		this->acceleration = point1;
HXLINE( 681)		 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 681)		point2->_inPool = false;
HXDLIN( 681)		this->drag = point2;
HXLINE( 682)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)10000,(int)10000);
...
HXLINE( 729)		this->touching = (int)0;
            	}
...
HXDLIN( 742)			Float _g1 = _g->angle;
HXDLIN( 742)			_g->set_angle((_g1 + (this->angularVelocity * elapsed)));
            		}
...
HXLINE( 746)		{
HXLINE( 746)			 ::flixel::math::FlxPoint _g2 = this->velocity;
HXDLIN( 746)			_g2->set_x((_g2->x + velocityDelta1));
            		}
HXLINE( 747)		Float delta = (this->velocity->x * elapsed);
HXLINE( 748)		{
HXLINE( 748)			 ::flixel::math::FlxPoint _g3 = this->velocity;
HXDLIN( 748)			_g3->set_x((_g3->x + velocityDelta1));
            		}
HXLINE( 749)		{
HXLINE( 749)			 ::flixel::FlxObject _g4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 749)			_g4->set_x((_g4->x + delta));
            		}
...
HXLINE( 752)		{
HXLINE( 752)			 ::flixel::math::FlxPoint _g5 = this->velocity;
HXDLIN( 752)			_g5->set_y((_g5->y + velocityDelta1));
            		}
HXLINE( 753)		delta = (this->velocity->y * elapsed);
HXLINE( 754)		{
HXLINE( 754)			 ::flixel::math::FlxPoint _g6 = this->velocity;
HXDLIN( 754)			_g6->set_y((_g6->y + velocityDelta1));
            		}
HXLINE( 755)		{
HXLINE( 755)			 ::flixel::FlxObject _g7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 755)			_g7->set_y((_g7->y + delta));
            		}
            	}
...
HXLINE( 788)			return ::flixel::group::FlxTypedGroup_obj::overlaps(this->overlapsCallback_dyn(),group,(int)0,(int)0,InScreenSpace,Camera);
            		}
HXLINE( 791)		if ((ObjectOrGroup->flixelType == (int)3)) {
...
HXLINE( 802)				Float object2 = object->x;
HXDLIN( 802)				Float _hx_tmp3 = this->x;
HXDLIN( 802)				_hx_tmp1 = (object2 < (_hx_tmp3 + this->get_width()));
            			}
            			else {
HXLINE( 802)				_hx_tmp1 = false;
            			}
HXDLIN( 802)			if (_hx_tmp1) {
HXLINE( 802)				Float object3 = object->y;
HXDLIN( 802)				Float _hx_tmp4 = (object3 + object->get_height());
HXDLIN( 802)				_hx_tmp = (_hx_tmp4 > this->y);
            			}
            			else {
HXLINE( 802)				_hx_tmp = false;
            			}
HXDLIN( 802)			if (_hx_tmp) {
HXLINE( 802)				Float object4 = object->y;
HXDLIN( 802)				Float _hx_tmp5 = this->y;
HXDLIN( 802)				return (object4 < (_hx_tmp5 + this->get_height()));
            			}
            			else {
...
HXLINE( 811)		bool _hx_tmp6;
HXDLIN( 811)		bool _hx_tmp7;
HXDLIN( 811)		Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 811)		Float _hx_tmp8 = (objectScreenPos1 + object->get_width());
HXDLIN( 811)		if ((_hx_tmp8 > this->_point->x)) {
HXLINE( 812)			Float objectScreenPos2 = objectScreenPos->x;
HXDLIN( 812)			Float _hx_tmp9 = this->_point->x;
HXLINE( 811)			_hx_tmp7 = (objectScreenPos2 < (_hx_tmp9 + this->get_width()));
            		}
            		else {
HXLINE( 811)			_hx_tmp7 = false;
            		}
HXDLIN( 811)		if (_hx_tmp7) {
HXLINE( 813)			Float objectScreenPos3 = objectScreenPos->y;
HXDLIN( 813)			Float _hx_tmp10 = (objectScreenPos3 + object->get_height());
HXLINE( 811)			_hx_tmp6 = (_hx_tmp10 > this->_point->y);
            		}
            		else {
HXLINE( 811)			_hx_tmp6 = false;
            		}
HXDLIN( 811)		if (_hx_tmp6) {
HXLINE( 814)			Float objectScreenPos4 = objectScreenPos->y;
HXDLIN( 814)			Float _hx_tmp11 = this->_point->y;
HXDLIN( 814)			return (objectScreenPos4 < (_hx_tmp11 + this->get_height()));
            		}
            		else {
...
HXLINE( 850)		if ((ObjectOrGroup->flixelType == (int)3)) {
HXLINE( 856)			 ::flixel::tile::FlxBaseTilemap tilemap = ( ( ::flixel::tile::FlxBaseTilemap)(ObjectOrGroup) );
HXLINE( 857)			Float tilemap1 = tilemap->x;
HXDLIN( 857)			Float _hx_tmp = (tilemap1 - (X - this->x));
HXDLIN( 857)			Float tilemap2 = tilemap->y;
HXDLIN( 857)			return tilemap->overlapsAt(_hx_tmp,(tilemap2 - (Y - this->y)),hx::ObjectPtr<OBJ_>(this),InScreenSpace,Camera);
            		}
HXLINE( 860)		 ::flixel::FlxObject object = ( ( ::flixel::FlxObject)(ObjectOrGroup) );
HXLINE( 861)		if (!(InScreenSpace)) {
HXLINE( 863)			bool _hx_tmp1;
HXDLIN( 863)			bool _hx_tmp2;
HXDLIN( 863)			Float object1 = object->x;
HXDLIN( 863)			if (((object1 + object->get_width()) > X)) {
HXLINE( 863)				Float object2 = object->x;
HXDLIN( 863)				_hx_tmp2 = (object2 < (X + this->get_width()));
            			}
            			else {
HXLINE( 863)				_hx_tmp2 = false;
            			}
HXDLIN( 863)			if (_hx_tmp2) {
HXLINE( 863)				Float object3 = object->y;
HXDLIN( 863)				_hx_tmp1 = ((object3 + object->get_height()) > Y);
            			}
            			else {
HXLINE( 863)				_hx_tmp1 = false;
            			}
HXDLIN( 863)			if (_hx_tmp1) {
HXLINE( 863)				Float object4 = object->y;
HXDLIN( 863)				return (object4 < (Y + this->get_height()));
            			}
            			else {
...
HXLINE( 872)		bool _hx_tmp3;
HXDLIN( 872)		bool _hx_tmp4;
HXDLIN( 872)		Float objectScreenPos1 = objectScreenPos->x;
HXDLIN( 872)		Float _hx_tmp5 = (objectScreenPos1 + object->get_width());
HXDLIN( 872)		if ((_hx_tmp5 > this->_point->x)) {
HXLINE( 873)			Float objectScreenPos2 = objectScreenPos->x;
HXDLIN( 873)			Float _hx_tmp6 = this->_point->x;
HXLINE( 872)			_hx_tmp4 = (objectScreenPos2 < (_hx_tmp6 + this->get_width()));
            		}
            		else {
HXLINE( 872)			_hx_tmp4 = false;
            		}
HXDLIN( 872)		if (_hx_tmp4) {
HXLINE( 874)			Float objectScreenPos3 = objectScreenPos->y;
HXDLIN( 874)			Float _hx_tmp7 = (objectScreenPos3 + object->get_height());
HXLINE( 872)			_hx_tmp3 = (_hx_tmp7 > this->_point->y);
            		}
            		else {
HXLINE( 872)			_hx_tmp3 = false;
            		}
HXDLIN( 872)		if (_hx_tmp3) {
HXLINE( 875)			Float objectScreenPos4 = objectScreenPos->y;
HXDLIN( 875)			Float _hx_tmp8 = this->_point->y;
HXDLIN( 875)			return (objectScreenPos4 < (_hx_tmp8 + this->get_height()));
            		}
            		else {
...
HXDLIN( 897)				Float _hx_tmp2 = this->x;
HXDLIN( 897)				_hx_tmp1 = (point1 < (_hx_tmp2 + this->get_width()));
            			}
            			else {
...
HXLINE( 897)				Float point2 = point->y;
HXDLIN( 897)				Float _hx_tmp3 = this->y;
HXDLIN( 897)				return (point2 < (_hx_tmp3 + this->get_height()));
            			}
            			else {
...
HXDLIN( 908)		bool _hx_tmp5;
HXDLIN( 908)		if ((xPos >= this->_point->x)) {
HXLINE( 908)			Float _hx_tmp6 = this->_point->x;
HXDLIN( 908)			_hx_tmp5 = (xPos < (_hx_tmp6 + this->get_width()));
            		}
            		else {
HXLINE( 908)			_hx_tmp5 = false;
            		}
HXDLIN( 908)		if (_hx_tmp5) {
HXLINE( 908)			_hx_tmp4 = (yPos >= this->_point->y);
            		}
            		else {
HXLINE( 908)			_hx_tmp4 = false;
            		}
HXDLIN( 908)		if (_hx_tmp4) {
HXLINE( 908)			Float _hx_tmp7 = this->_point->y;
HXDLIN( 908)			return (yPos < (_hx_tmp7 + this->get_height()));
            		}
            		else {
...
HXDLIN( 919)			Float _hx_tmp4 = this->y;
HXDLIN( 919)			Float _hx_tmp5 = (_hx_tmp4 + this->get_height());
HXDLIN( 919)			_hx_tmp = (_hx_tmp5 > ::flixel::FlxG_obj::worldBounds->y);
            		}
            		else {
HXDLIN( 919)			_hx_tmp = false;
            		}
HXDLIN( 919)		if (_hx_tmp) {
HXDLIN( 919)			 ::flixel::math::FlxRect _this1 = ::flixel::FlxG_obj::worldBounds;
HXDLIN( 919)			return (this->y < (_this1->y + _this1->height));
            		}
            		else {
...
HXLINE( 934)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 941)			point->set_x(::Math_obj::floor(point->x));
HXDLIN( 941)			point->set_y(::Math_obj::floor(point->y));
            		}
...
HXLINE( 949)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 963)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 970)			_this->x = (int)0;
HXDLIN( 970)			_this->y = (int)0;
HXDLIN( 970)			_this->width = (int)0;
HXDLIN( 970)			_this->height = (int)0;
...
HXLINE( 983)		this->touching = (int)0;
HXLINE( 984)		this->wasTouching = (int)0;
...
HXLINE(1014)			return this->pixelPerfectRender;
            		}
...
HXDLIN(1026)		return (((int)this->touching & (int)Direction) > (int)0);
            	}
...
HXDLIN(1038)		if ((((int)this->touching & (int)Direction) > (int)0)) {
HXDLIN(1038)			return (((int)this->wasTouching & (int)Direction) <= (int)0);
            		}
            		else {
...
HXLINE(1050)		if ((this->health <= (int)0)) {
...
HXLINE(1066)			Float _hx_tmp = ((Float)::flixel::FlxG_obj::width / (Float)(int)2);
HXDLIN(1066)			this->set_x((_hx_tmp - ((Float)this->get_width() / (Float)(int)2)));
            		}
HXLINE(1067)		if (hx::IsNotEq( axes,::flixel::util::FlxAxes_obj::X_dyn() )) {
HXLINE(1068)			Float _hx_tmp1 = ((Float)::flixel::FlxG_obj::height / (Float)(int)2);
HXDLIN(1068)			this->set_y((_hx_tmp1 - ((Float)this->get_height() / (Float)(int)2)));
            		}
...
HXLINE(1181)			 ::flixel::math::FlxRect _this1 = this->_rect;
HXDLIN(1181)			_this1->x = ::Math_obj::floor(_this1->x);
HXDLIN(1181)			_this1->y = ::Math_obj::floor(_this1->y);
HXDLIN(1181)			_this1->width = ::Math_obj::floor(_this1->width);
HXDLIN(1181)			_this1->height = ::Math_obj::floor(_this1->height);
            		}
...
HXDLIN(1193)		 ::flixel::util::LabelValuePair _hx_tmp = _this;
...
HXDLIN(1194)		 ::flixel::util::LabelValuePair _hx_tmp1 = _this1;
...
HXDLIN(1195)		 ::flixel::util::LabelValuePair _hx_tmp2 = _this2;
...
HXDLIN(1196)		 ::flixel::util::LabelValuePair _hx_tmp3 = _this3;
...
HXDLIN(1197)		 ::flixel::util::LabelValuePair _hx_tmp4 = _this4;
...
HXLINE(1192)		return ::flixel::util::FlxStringUtil_obj::getDebugString(::Array_obj< ::Dynamic>::__new(6)->init(0,_hx_tmp)->init(1,_hx_tmp1)->init(2,_hx_tmp2)->init(3,_hx_tmp3)->init(4,_hx_tmp4)->init(5,_this5));
            	}
...
HXDLIN(1257)		return (((int)this->allowCollisions & (int)(int)4369) > (int)0);
            	}
...
HXLINE(1263)			_hx_tmp = (int)4369;
            		}
            		else {
HXLINE(1263)			_hx_tmp = (int)0;
            		}
...
HXDLIN(1288)		return (this->pixelPerfectRender = Value);
            	}
...
HXLINE( 122)		Float overlap = (int)0;
...
HXLINE( 139)				Float obj1rect1 = obj1rect->x;
HXLINE( 138)				_hx_tmp2 = (obj1rect1 < (obj2rect->x + obj2rect->width));
            			}
            			else {
...
HXLINE( 141)				Float obj1rect2 = obj1rect->y;
HXLINE( 138)				_hx_tmp = (obj1rect2 < (obj2rect->y + obj2rect->height));
            			}
            			else {
...
HXLINE( 149)						_hx_tmp5 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 149)						_hx_tmp5 = false;
            					}
HXDLIN( 149)					if (!(_hx_tmp5)) {
HXLINE( 149)						_hx_tmp4 = (((int)Object1->allowCollisions & (int)(int)16) == (int)0);
            					}
            					else {
HXLINE( 149)						_hx_tmp4 = true;
            					}
HXDLIN( 149)					if (!(_hx_tmp4)) {
HXLINE( 149)						_hx_tmp3 = (((int)Object2->allowCollisions & (int)(int)1) == (int)0);
            					}
            					else {
HXLINE( 149)						_hx_tmp3 = true;
            					}
HXDLIN( 149)					if (_hx_tmp3) {
HXLINE( 153)						overlap = (int)0;
            					}
            					else {
HXLINE( 157)						 ::flixel::FlxObject Object12 = Object1;
HXDLIN( 157)						Object12->touching = ((int)Object12->touching | (int)(int)16);
HXLINE( 158)						 ::flixel::FlxObject Object21 = Object2;
HXDLIN( 158)						Object21->touching = ((int)Object21->touching | (int)(int)1);
            					}
            				}
            				else {
HXLINE( 161)					if ((obj1delta < obj2delta)) {
HXLINE( 163)						Float Object13 = Object1->x;
HXDLIN( 163)						Float overlap2 = (Object13 - Object2->get_width());
HXDLIN( 163)						overlap = (overlap2 - Object2->x);
HXLINE( 164)						bool _hx_tmp6;
HXDLIN( 164)						bool _hx_tmp7;
HXDLIN( 164)						bool _hx_tmp8;
HXDLIN( 164)						if (checkMaxOverlap) {
HXLINE( 164)							_hx_tmp8 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 164)							_hx_tmp8 = false;
            						}
HXDLIN( 164)						if (!(_hx_tmp8)) {
HXLINE( 164)							_hx_tmp7 = (((int)Object1->allowCollisions & (int)(int)1) == (int)0);
            						}
            						else {
HXLINE( 164)							_hx_tmp7 = true;
            						}
HXDLIN( 164)						if (!(_hx_tmp7)) {
HXLINE( 164)							_hx_tmp6 = (((int)Object2->allowCollisions & (int)(int)16) == (int)0);
            						}
            						else {
HXLINE( 164)							_hx_tmp6 = true;
            						}
HXDLIN( 164)						if (_hx_tmp6) {
HXLINE( 168)							overlap = (int)0;
            						}
            						else {
HXLINE( 172)							 ::flixel::FlxObject Object14 = Object1;
HXDLIN( 172)							Object14->touching = ((int)Object14->touching | (int)(int)1);
HXLINE( 173)							 ::flixel::FlxObject Object22 = Object2;
HXDLIN( 173)							Object22->touching = ((int)Object22->touching | (int)(int)16);
            						}
            					}
            				}
            			}
...
HXLINE( 199)		if ((Object1->flixelType == (int)3)) {
...
HXLINE( 204)		if ((Object2->flixelType == (int)3)) {
HXLINE( 206)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 207)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateX_dyn(),true,null());
            		}
HXLINE( 210)		Float overlap = ::flixel::FlxObject_obj::computeOverlapX(Object1,Object2,null());
HXLINE( 212)		if ((overlap != (int)0)) {
...
HXLINE( 217)				_hx_tmp1 = !(obj2immovable);
            			}
            			else {
...
HXDLIN( 223)				if ((obj2v > (int)0)) {
HXLINE( 223)					obj1velocity = (int)1;
            				}
            				else {
HXLINE( 223)					obj1velocity = (int)-1;
            				}
HXDLIN( 223)				Float obj1velocity1 = (::Math_obj::sqrt(((Float)((obj2v * obj2v) * Object2->mass) / (Float)Object1->mass)) * obj1velocity);
HXLINE( 224)				int obj2velocity;
HXDLIN( 224)				if ((obj1v > (int)0)) {
HXLINE( 224)					obj2velocity = (int)1;
            				}
            				else {
HXLINE( 224)					obj2velocity = (int)-1;
            				}
HXDLIN( 224)				Float obj2velocity1 = (::Math_obj::sqrt(((Float)((obj1v * obj1v) * Object1->mass) / (Float)Object2->mass)) * obj2velocity);
...
HXLINE( 228)				 ::flixel::math::FlxPoint Object11 = Object1->velocity;
HXDLIN( 228)				Object11->set_x((average + (obj1velocity1 * Object1->elasticity)));
HXLINE( 229)				 ::flixel::math::FlxPoint Object21 = Object2->velocity;
HXDLIN( 229)				Object21->set_x((average + (obj2velocity1 * Object2->elasticity)));
            			}
            			else {
HXLINE( 231)				if (!(obj1immovable)) {
HXLINE( 233)					Object1->set_x((Object1->x - overlap));
HXLINE( 234)					 ::flixel::math::FlxPoint Object12 = Object1->velocity;
HXDLIN( 234)					Object12->set_x((obj2v - (obj1v * Object1->elasticity)));
            				}
            				else {
HXLINE( 236)					if (!(obj2immovable)) {
HXLINE( 238)						{
HXLINE( 238)							 ::flixel::FlxObject _g1 = Object2;
HXDLIN( 238)							_g1->set_x((_g1->x + overlap));
            						}
HXLINE( 239)						 ::flixel::math::FlxPoint Object22 = Object2->velocity;
HXDLIN( 239)						Object22->set_x((obj1v - (obj2v * Object2->elasticity)));
            					}
            				}
            			}
...
HXLINE( 257)		if ((Object1->flixelType == (int)3)) {
...
HXLINE( 262)		if ((Object2->flixelType == (int)3)) {
HXLINE( 264)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 265)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::updateTouchingFlagsX_dyn(),true,null());
            		}
HXLINE( 268)		return (::flixel::FlxObject_obj::computeOverlapX(Object1,Object2,false) != (int)0);
            	}
...
HXLINE( 279)		Float overlap = (int)0;
...
HXLINE( 296)				Float obj1rect1 = obj1rect->x;
HXLINE( 295)				_hx_tmp2 = (obj1rect1 < (obj2rect->x + obj2rect->width));
            			}
            			else {
...
HXLINE( 298)				Float obj1rect2 = obj1rect->y;
HXLINE( 295)				_hx_tmp = (obj1rect2 < (obj2rect->y + obj2rect->height));
            			}
            			else {
...
HXLINE( 306)					bool _hx_tmp3;
HXDLIN( 306)					bool _hx_tmp4;
HXDLIN( 306)					bool _hx_tmp5;
HXDLIN( 306)					if (checkMaxOverlap) {
HXLINE( 306)						_hx_tmp5 = (overlap > maxOverlap);
            					}
            					else {
HXLINE( 306)						_hx_tmp5 = false;
            					}
HXDLIN( 306)					if (!(_hx_tmp5)) {
HXLINE( 306)						_hx_tmp4 = (((int)Object1->allowCollisions & (int)(int)4096) == (int)0);
            					}
            					else {
HXLINE( 306)						_hx_tmp4 = true;
            					}
HXDLIN( 306)					if (!(_hx_tmp4)) {
HXLINE( 306)						_hx_tmp3 = (((int)Object2->allowCollisions & (int)(int)256) == (int)0);
            					}
            					else {
HXLINE( 306)						_hx_tmp3 = true;
            					}
HXDLIN( 306)					if (_hx_tmp3) {
HXLINE( 310)						overlap = (int)0;
            					}
            					else {
HXLINE( 314)						 ::flixel::FlxObject Object12 = Object1;
HXDLIN( 314)						Object12->touching = ((int)Object12->touching | (int)(int)4096);
HXLINE( 315)						 ::flixel::FlxObject Object21 = Object2;
HXDLIN( 315)						Object21->touching = ((int)Object21->touching | (int)(int)256);
            					}
            				}
            				else {
HXLINE( 318)					if ((obj1delta < obj2delta)) {
HXLINE( 320)						Float Object13 = Object1->y;
HXDLIN( 320)						Float overlap2 = (Object13 - Object2->get_height());
HXDLIN( 320)						overlap = (overlap2 - Object2->y);
HXLINE( 321)						bool _hx_tmp6;
HXDLIN( 321)						bool _hx_tmp7;
HXDLIN( 321)						bool _hx_tmp8;
HXDLIN( 321)						if (checkMaxOverlap) {
HXLINE( 321)							_hx_tmp8 = (-(overlap) > maxOverlap);
            						}
            						else {
HXLINE( 321)							_hx_tmp8 = false;
            						}
HXDLIN( 321)						if (!(_hx_tmp8)) {
HXLINE( 321)							_hx_tmp7 = (((int)Object1->allowCollisions & (int)(int)256) == (int)0);
            						}
            						else {
HXLINE( 321)							_hx_tmp7 = true;
            						}
HXDLIN( 321)						if (!(_hx_tmp7)) {
HXLINE( 321)							_hx_tmp6 = (((int)Object2->allowCollisions & (int)(int)4096) == (int)0);
            						}
            						else {
HXLINE( 321)							_hx_tmp6 = true;
            						}
HXDLIN( 321)						if (_hx_tmp6) {
HXLINE( 325)							overlap = (int)0;
            						}
            						else {
HXLINE( 329)							 ::flixel::FlxObject Object14 = Object1;
HXDLIN( 329)							Object14->touching = ((int)Object14->touching | (int)(int)256);
HXLINE( 330)							 ::flixel::FlxObject Object22 = Object2;
HXDLIN( 330)							Object22->touching = ((int)Object22->touching | (int)(int)4096);
            						}
            					}
            				}
            			}
...
HXLINE( 356)		if ((Object1->flixelType == (int)3)) {
...
HXLINE( 361)		if ((Object2->flixelType == (int)3)) {
HXLINE( 363)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 364)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::separateY_dyn(),true,null());
            		}
HXLINE( 367)		Float overlap = ::flixel::FlxObject_obj::computeOverlapY(Object1,Object2,null());
HXLINE( 369)		if ((overlap != (int)0)) {
...
HXLINE( 376)				_hx_tmp1 = !(obj2immovable);
            			}
            			else {
...
HXDLIN( 382)				if ((obj2v > (int)0)) {
HXLINE( 382)					obj1velocity = (int)1;
            				}
            				else {
HXLINE( 382)					obj1velocity = (int)-1;
            				}
HXDLIN( 382)				Float obj1velocity1 = (::Math_obj::sqrt(((Float)((obj2v * obj2v) * Object2->mass) / (Float)Object1->mass)) * obj1velocity);
HXLINE( 383)				int obj2velocity;
HXDLIN( 383)				if ((obj1v > (int)0)) {
HXLINE( 383)					obj2velocity = (int)1;
            				}
            				else {
HXLINE( 383)					obj2velocity = (int)-1;
            				}
HXDLIN( 383)				Float obj2velocity1 = (::Math_obj::sqrt(((Float)((obj1v * obj1v) * Object1->mass) / (Float)Object2->mass)) * obj2velocity);
...
HXLINE( 387)				 ::flixel::math::FlxPoint Object11 = Object1->velocity;
HXDLIN( 387)				Object11->set_y((average + (obj1velocity1 * Object1->elasticity)));
HXLINE( 388)				 ::flixel::math::FlxPoint Object21 = Object2->velocity;
HXDLIN( 388)				Object21->set_y((average + (obj2velocity1 * Object2->elasticity)));
            			}
            			else {
HXLINE( 390)				if (!(obj1immovable)) {
HXLINE( 392)					Object1->set_y((Object1->y - overlap));
HXLINE( 393)					 ::flixel::math::FlxPoint Object12 = Object1->velocity;
HXDLIN( 393)					Object12->set_y((obj2v - (obj1v * Object1->elasticity)));
HXLINE( 395)					bool _hx_tmp2;
HXDLIN( 395)					bool _hx_tmp3;
HXDLIN( 395)					bool _hx_tmp4;
HXDLIN( 395)					if (Object1->collisonXDrag) {
HXLINE( 395)						_hx_tmp4 = Object2->active;
            					}
            					else {
HXLINE( 395)						_hx_tmp4 = false;
            					}
HXDLIN( 395)					if (_hx_tmp4) {
HXLINE( 395)						_hx_tmp3 = Object2->moves;
            					}
            					else {
HXLINE( 395)						_hx_tmp3 = false;
            					}
HXDLIN( 395)					if (_hx_tmp3) {
HXLINE( 395)						_hx_tmp2 = (obj1delta > obj2delta);
            					}
            					else {
HXLINE( 395)						_hx_tmp2 = false;
            					}
HXDLIN( 395)					if (_hx_tmp2) {
HXLINE( 397)						 ::flixel::FlxObject _g1 = Object1;
HXDLIN( 397)						Float _g2 = _g1->x;
HXDLIN( 397)						_g1->set_x((_g2 + (Object2->x - Object2->last->x)));
            					}
            				}
            				else {
HXLINE( 400)					if (!(obj2immovable)) {
HXLINE( 402)						{
HXLINE( 402)							 ::flixel::FlxObject _g3 = Object2;
HXDLIN( 402)							_g3->set_y((_g3->y + overlap));
            						}
HXLINE( 403)						 ::flixel::math::FlxPoint Object22 = Object2->velocity;
HXDLIN( 403)						Object22->set_y((obj1v - (obj2v * Object2->elasticity)));
HXLINE( 405)						bool _hx_tmp5;
HXDLIN( 405)						bool _hx_tmp6;
HXDLIN( 405)						bool _hx_tmp7;
HXDLIN( 405)						if (Object2->collisonXDrag) {
HXLINE( 405)							_hx_tmp7 = Object1->active;
            						}
            						else {
HXLINE( 405)							_hx_tmp7 = false;
            						}
HXDLIN( 405)						if (_hx_tmp7) {
HXLINE( 405)							_hx_tmp6 = Object1->moves;
            						}
            						else {
HXLINE( 405)							_hx_tmp6 = false;
            						}
HXDLIN( 405)						if (_hx_tmp6) {
HXLINE( 405)							_hx_tmp5 = (obj1delta < obj2delta);
            						}
            						else {
HXLINE( 405)							_hx_tmp5 = false;
            						}
HXDLIN( 405)						if (_hx_tmp5) {
HXLINE( 407)							 ::flixel::FlxObject _g4 = Object2;
HXDLIN( 407)							Float _g5 = _g4->x;
HXDLIN( 407)							_g4->set_x((_g5 + (Object1->x - Object1->last->x)));
            						}
            					}
            				}
            			}
...
HXLINE( 426)		if ((Object1->flixelType == (int)3)) {
...
HXLINE( 431)		if ((Object2->flixelType == (int)3)) {
HXLINE( 433)			 ::flixel::tile::FlxBaseTilemap tilemap1 = ( ( ::flixel::tile::FlxBaseTilemap)(Object2) );
HXLINE( 434)			return tilemap1->overlapsWithCallback(Object1,::flixel::FlxObject_obj::updateTouchingFlagsY_dyn(),true,null());
            		}
HXLINE( 437)		return (::flixel::FlxObject_obj::computeOverlapY(Object1,Object2,false) != (int)0);
            	}
...
HXDLIN(  81)			_this->x = (int)0;
HXDLIN(  81)			_this->y = (int)0;
HXDLIN(  81)			_this->width = (int)0;
HXDLIN(  81)			_this->height = (int)0;
...
HXDLIN(  81)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_81_boot)
HXDLIN(  81)		_firstSeparateFlxRect =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
...
HXDLIN(  83)			_this->x = (int)0;
HXDLIN(  83)			_this->y = (int)0;
HXDLIN(  83)			_this->width = (int)0;
HXDLIN(  83)			_this->height = (int)0;
...
HXDLIN(  83)			return rect;
            	...
            	HX_STACKFRAME(&_hx_pos_c625bfaa5b4263df_83_boot)
HXDLIN(  83)		_secondSeparateFlxRect =  ::Dynamic(new _hx_Closure_0())();
            	}
}
