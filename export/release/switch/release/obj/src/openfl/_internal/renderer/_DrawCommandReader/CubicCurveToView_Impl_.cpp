...
HXDLIN( 487)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 487)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 494)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 494)		return this2->__get((this1->fPos + (int)2));
            	}
...
HXDLIN( 501)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 501)		return this2->__get((this1->fPos + (int)3));
            	}
...
HXDLIN( 508)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 508)		return this2->__get((this1->fPos + (int)4));
            	}
...
HXDLIN( 515)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 515)		return this2->__get((this1->fPos + (int)5));
            	}
