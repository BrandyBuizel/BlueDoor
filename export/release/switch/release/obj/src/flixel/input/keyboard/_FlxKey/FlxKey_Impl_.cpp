...
HXLINE( 114)			return ( (int)(::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::fromStringMap->get(s)) );
            		}
            		else {
...
HXDLIN( 120)		return ( (::String)(::flixel::input::keyboard::_FlxKey::FlxKey_Impl__obj::toStringMap->get(this1)) );
            	}
...
HXDLIN(  54)			_g->set(HX_("ANY",cc,96,31,00),(int)-2);
HXDLIN(  54)			_g->set(HX_("A",41,00,00,00),(int)65);
HXDLIN(  54)			_g->set(HX_("B",42,00,00,00),(int)66);
HXDLIN(  54)			_g->set(HX_("C",43,00,00,00),(int)67);
HXDLIN(  54)			_g->set(HX_("D",44,00,00,00),(int)68);
HXDLIN(  54)			_g->set(HX_("E",45,00,00,00),(int)69);
HXDLIN(  54)			_g->set(HX_("F",46,00,00,00),(int)70);
HXDLIN(  54)			_g->set(HX_("G",47,00,00,00),(int)71);
HXDLIN(  54)			_g->set(HX_("H",48,00,00,00),(int)72);
HXDLIN(  54)			_g->set(HX_("I",49,00,00,00),(int)73);
HXDLIN(  54)			_g->set(HX_("J",4a,00,00,00),(int)74);
HXDLIN(  54)			_g->set(HX_("K",4b,00,00,00),(int)75);
HXDLIN(  54)			_g->set(HX_("L",4c,00,00,00),(int)76);
HXDLIN(  54)			_g->set(HX_("M",4d,00,00,00),(int)77);
HXDLIN(  54)			_g->set(HX_("N",4e,00,00,00),(int)78);
HXDLIN(  54)			_g->set(HX_("O",4f,00,00,00),(int)79);
HXDLIN(  54)			_g->set(HX_("P",50,00,00,00),(int)80);
HXDLIN(  54)			_g->set(HX_("Q",51,00,00,00),(int)81);
HXDLIN(  54)			_g->set(HX_("R",52,00,00,00),(int)82);
HXDLIN(  54)			_g->set(HX_("S",53,00,00,00),(int)83);
HXDLIN(  54)			_g->set(HX_("T",54,00,00,00),(int)84);
HXDLIN(  54)			_g->set(HX_("U",55,00,00,00),(int)85);
HXDLIN(  54)			_g->set(HX_("V",56,00,00,00),(int)86);
HXDLIN(  54)			_g->set(HX_("W",57,00,00,00),(int)87);
HXDLIN(  54)			_g->set(HX_("X",58,00,00,00),(int)88);
HXDLIN(  54)			_g->set(HX_("Y",59,00,00,00),(int)89);
HXDLIN(  54)			_g->set(HX_("Z",5a,00,00,00),(int)90);
HXDLIN(  54)			_g->set(HX_("ZERO",28,d7,b1,3b),(int)48);
HXDLIN(  54)			_g->set(HX_("ONE",46,36,3c,00),(int)49);
HXDLIN(  54)			_g->set(HX_("TWO",6c,09,40,00),(int)50);
HXDLIN(  54)			_g->set(HX_("THREE",3e,8c,7e,8d),(int)51);
HXDLIN(  54)			_g->set(HX_("FOUR",e6,2b,81,2e),(int)52);
HXDLIN(  54)			_g->set(HX_("FIVE",32,9f,7c,2e),(int)53);
HXDLIN(  54)			_g->set(HX_("SIX",02,3b,3f,00),(int)54);
HXDLIN(  54)			_g->set(HX_("SEVEN",ed,5c,1f,f8),(int)55);
HXDLIN(  54)			_g->set(HX_("EIGHT",2f,b9,1c,eb),(int)56);
HXDLIN(  54)			_g->set(HX_("NINE",32,4d,c6,33),(int)57);
HXDLIN(  54)			_g->set(HX_("PAGEUP",6a,5e,bb,98),(int)33);
HXDLIN(  54)			_g->set(HX_("PAGEDOWN",31,36,e2,b9),(int)34);
HXDLIN(  54)			_g->set(HX_("HOME",1f,92,d3,2f),(int)36);
HXDLIN(  54)			_g->set(HX_("END",bb,9f,34,00),(int)35);
HXDLIN(  54)			_g->set(HX_("INSERT",39,ef,5f,50),(int)45);
HXDLIN(  54)			_g->set(HX_("ESCAPE",81,ef,5c,8d),(int)27);
HXDLIN(  54)			_g->set(HX_("MINUS",50,b8,56,86),(int)189);
HXDLIN(  54)			_g->set(HX_("PLUS",5a,07,1b,35),(int)187);
HXDLIN(  54)			_g->set(HX_("DELETE",2b,6c,5b,1d),(int)46);
HXDLIN(  54)			_g->set(HX_("BACKSPACE",1f,f5,42,c6),(int)8);
HXDLIN(  54)			_g->set(HX_("LBRACKET",3c,3b,54,16),(int)219);
HXDLIN(  54)			_g->set(HX_("RBRACKET",f6,e7,82,6d),(int)221);
HXDLIN(  54)			_g->set(HX_("BACKSLASH",96,28,9e,c3),(int)220);
HXDLIN(  54)			_g->set(HX_("CAPSLOCK",8c,6c,6e,80),(int)20);
HXDLIN(  54)			_g->set(HX_("SEMICOLON",11,86,2a,49),(int)186);
HXDLIN(  54)			_g->set(HX_("QUOTE",1c,5b,e0,db),(int)222);
HXDLIN(  54)			_g->set(HX_("ENTER",f8,a4,74,ee),(int)13);
HXDLIN(  54)			_g->set(HX_("SHIFT",62,24,11,fa),(int)16);
HXDLIN(  54)			_g->set(HX_("COMMA",b5,69,4b,c8),(int)188);
HXDLIN(  54)			_g->set(HX_("PERIOD",01,0d,9e,ed),(int)190);
HXDLIN(  54)			_g->set(HX_("SLASH",1d,f8,af,fc),(int)191);
HXDLIN(  54)			_g->set(HX_("GRAVEACCENT",6f,63,9a,0e),(int)192);
HXDLIN(  54)			_g->set(HX_("CONTROL",3d,3f,55,99),(int)17);
HXDLIN(  54)			_g->set(HX_("ALT",09,95,31,00),(int)18);
HXDLIN(  54)			_g->set(HX_("SPACE",a6,c4,54,ff),(int)32);
HXDLIN(  54)			_g->set(HX_("UP",5b,4a,00,00),(int)38);
HXDLIN(  54)			_g->set(HX_("DOWN",62,c0,2e,2d),(int)40);
HXDLIN(  54)			_g->set(HX_("LEFT",07,d0,70,32),(int)37);
HXDLIN(  54)			_g->set(HX_("RIGHT",bc,43,52,67),(int)39);
HXDLIN(  54)			_g->set(HX_("TAB",35,f6,3f,00),(int)9);
HXDLIN(  54)			_g->set(HX_("PRINTSCREEN",39,7f,7c,10),(int)301);
HXDLIN(  54)			_g->set(HX_("F1",2b,3d,00,00),(int)112);
HXDLIN(  54)			_g->set(HX_("F2",2c,3d,00,00),(int)113);
HXDLIN(  54)			_g->set(HX_("F3",2d,3d,00,00),(int)114);
HXDLIN(  54)			_g->set(HX_("F4",2e,3d,00,00),(int)115);
HXDLIN(  54)			_g->set(HX_("F5",2f,3d,00,00),(int)116);
HXDLIN(  54)			_g->set(HX_("F6",30,3d,00,00),(int)117);
HXDLIN(  54)			_g->set(HX_("F7",31,3d,00,00),(int)118);
HXDLIN(  54)			_g->set(HX_("F8",32,3d,00,00),(int)119);
HXDLIN(  54)			_g->set(HX_("F9",33,3d,00,00),(int)120);
HXDLIN(  54)			_g->set(HX_("F10",a5,48,35,00),(int)121);
HXDLIN(  54)			_g->set(HX_("F11",a6,48,35,00),(int)122);
HXDLIN(  54)			_g->set(HX_("F12",a7,48,35,00),(int)123);
HXDLIN(  54)			_g->set(HX_("NUMPADZERO",75,90,dd,33),(int)96);
HXDLIN(  54)			_g->set(HX_("NUMPADONE",99,e5,09,5c),(int)97);
HXDLIN(  54)			_g->set(HX_("NUMPADTWO",bf,b8,0d,5c),(int)98);
HXDLIN(  54)			_g->set(HX_("NUMPADTHREE",51,f6,94,bb),(int)99);
HXDLIN(  54)			_g->set(HX_("NUMPADFOUR",33,e5,ac,26),(int)100);
HXDLIN(  54)			_g->set(HX_("NUMPADFIVE",7f,58,a8,26),(int)101);
HXDLIN(  54)			_g->set(HX_("NUMPADSIX",55,ea,0c,5c),(int)102);
HXDLIN(  54)			_g->set(HX_("NUMPADSEVEN",00,c7,35,26),(int)103);
HXDLIN(  54)			_g->set(HX_("NUMPADEIGHT",42,23,33,19),(int)104);
HXDLIN(  54)			_g->set(HX_("NUMPADNINE",7f,06,f2,2b),(int)105);
HXDLIN(  54)			_g->set(HX_("NUMPADMINUS",63,22,6d,b4),(int)109);
HXDLIN(  54)			_g->set(HX_("NUMPADPLUS",a7,c0,46,2d),(int)107);
HXDLIN(  54)			_g->set(HX_("NUMPADPERIOD",8e,73,24,13),(int)110);
HXDLIN(  54)			_g->set(HX_("NUMPADMULTIPLY",f1,55,e9,54),(int)106);
HXDLIN(  54)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_b641261cd9bd2dff_54_boot)
HXDLIN(  54)		fromStringMap =  ::Dynamic(new _hx_Closure_0())();
            	}
{
            		HX_BEGIN_LOCAL_FUNC_S0(hx::LocalFunc,_hx_Closure_0) HXARGC(0)
            		 ::Dynamic _hx_run(){
...
HXDLIN(  54)			_g->set((int)-2,HX_("ANY",cc,96,31,00));
HXDLIN(  54)			_g->set((int)65,HX_("A",41,00,00,00));
HXDLIN(  54)			_g->set((int)66,HX_("B",42,00,00,00));
HXDLIN(  54)			_g->set((int)67,HX_("C",43,00,00,00));
HXDLIN(  54)			_g->set((int)68,HX_("D",44,00,00,00));
HXDLIN(  54)			_g->set((int)69,HX_("E",45,00,00,00));
HXDLIN(  54)			_g->set((int)70,HX_("F",46,00,00,00));
HXDLIN(  54)			_g->set((int)71,HX_("G",47,00,00,00));
HXDLIN(  54)			_g->set((int)72,HX_("H",48,00,00,00));
HXDLIN(  54)			_g->set((int)73,HX_("I",49,00,00,00));
HXDLIN(  54)			_g->set((int)74,HX_("J",4a,00,00,00));
HXDLIN(  54)			_g->set((int)75,HX_("K",4b,00,00,00));
HXDLIN(  54)			_g->set((int)76,HX_("L",4c,00,00,00));
HXDLIN(  54)			_g->set((int)77,HX_("M",4d,00,00,00));
HXDLIN(  54)			_g->set((int)78,HX_("N",4e,00,00,00));
HXDLIN(  54)			_g->set((int)79,HX_("O",4f,00,00,00));
HXDLIN(  54)			_g->set((int)80,HX_("P",50,00,00,00));
HXDLIN(  54)			_g->set((int)81,HX_("Q",51,00,00,00));
HXDLIN(  54)			_g->set((int)82,HX_("R",52,00,00,00));
HXDLIN(  54)			_g->set((int)83,HX_("S",53,00,00,00));
HXDLIN(  54)			_g->set((int)84,HX_("T",54,00,00,00));
HXDLIN(  54)			_g->set((int)85,HX_("U",55,00,00,00));
HXDLIN(  54)			_g->set((int)86,HX_("V",56,00,00,00));
HXDLIN(  54)			_g->set((int)87,HX_("W",57,00,00,00));
HXDLIN(  54)			_g->set((int)88,HX_("X",58,00,00,00));
HXDLIN(  54)			_g->set((int)89,HX_("Y",59,00,00,00));
HXDLIN(  54)			_g->set((int)90,HX_("Z",5a,00,00,00));
HXDLIN(  54)			_g->set((int)48,HX_("ZERO",28,d7,b1,3b));
HXDLIN(  54)			_g->set((int)49,HX_("ONE",46,36,3c,00));
HXDLIN(  54)			_g->set((int)50,HX_("TWO",6c,09,40,00));
HXDLIN(  54)			_g->set((int)51,HX_("THREE",3e,8c,7e,8d));
HXDLIN(  54)			_g->set((int)52,HX_("FOUR",e6,2b,81,2e));
HXDLIN(  54)			_g->set((int)53,HX_("FIVE",32,9f,7c,2e));
HXDLIN(  54)			_g->set((int)54,HX_("SIX",02,3b,3f,00));
HXDLIN(  54)			_g->set((int)55,HX_("SEVEN",ed,5c,1f,f8));
HXDLIN(  54)			_g->set((int)56,HX_("EIGHT",2f,b9,1c,eb));
HXDLIN(  54)			_g->set((int)57,HX_("NINE",32,4d,c6,33));
HXDLIN(  54)			_g->set((int)33,HX_("PAGEUP",6a,5e,bb,98));
HXDLIN(  54)			_g->set((int)34,HX_("PAGEDOWN",31,36,e2,b9));
HXDLIN(  54)			_g->set((int)36,HX_("HOME",1f,92,d3,2f));
HXDLIN(  54)			_g->set((int)35,HX_("END",bb,9f,34,00));
HXDLIN(  54)			_g->set((int)45,HX_("INSERT",39,ef,5f,50));
HXDLIN(  54)			_g->set((int)27,HX_("ESCAPE",81,ef,5c,8d));
HXDLIN(  54)			_g->set((int)189,HX_("MINUS",50,b8,56,86));
HXDLIN(  54)			_g->set((int)187,HX_("PLUS",5a,07,1b,35));
HXDLIN(  54)			_g->set((int)46,HX_("DELETE",2b,6c,5b,1d));
HXDLIN(  54)			_g->set((int)8,HX_("BACKSPACE",1f,f5,42,c6));
HXDLIN(  54)			_g->set((int)219,HX_("LBRACKET",3c,3b,54,16));
HXDLIN(  54)			_g->set((int)221,HX_("RBRACKET",f6,e7,82,6d));
HXDLIN(  54)			_g->set((int)220,HX_("BACKSLASH",96,28,9e,c3));
HXDLIN(  54)			_g->set((int)20,HX_("CAPSLOCK",8c,6c,6e,80));
HXDLIN(  54)			_g->set((int)186,HX_("SEMICOLON",11,86,2a,49));
HXDLIN(  54)			_g->set((int)222,HX_("QUOTE",1c,5b,e0,db));
HXDLIN(  54)			_g->set((int)13,HX_("ENTER",f8,a4,74,ee));
HXDLIN(  54)			_g->set((int)16,HX_("SHIFT",62,24,11,fa));
HXDLIN(  54)			_g->set((int)188,HX_("COMMA",b5,69,4b,c8));
HXDLIN(  54)			_g->set((int)190,HX_("PERIOD",01,0d,9e,ed));
HXDLIN(  54)			_g->set((int)191,HX_("SLASH",1d,f8,af,fc));
HXDLIN(  54)			_g->set((int)192,HX_("GRAVEACCENT",6f,63,9a,0e));
HXDLIN(  54)			_g->set((int)17,HX_("CONTROL",3d,3f,55,99));
HXDLIN(  54)			_g->set((int)18,HX_("ALT",09,95,31,00));
HXDLIN(  54)			_g->set((int)32,HX_("SPACE",a6,c4,54,ff));
HXDLIN(  54)			_g->set((int)38,HX_("UP",5b,4a,00,00));
HXDLIN(  54)			_g->set((int)40,HX_("DOWN",62,c0,2e,2d));
HXDLIN(  54)			_g->set((int)37,HX_("LEFT",07,d0,70,32));
HXDLIN(  54)			_g->set((int)39,HX_("RIGHT",bc,43,52,67));
HXDLIN(  54)			_g->set((int)9,HX_("TAB",35,f6,3f,00));
HXDLIN(  54)			_g->set((int)301,HX_("PRINTSCREEN",39,7f,7c,10));
HXDLIN(  54)			_g->set((int)112,HX_("F1",2b,3d,00,00));
HXDLIN(  54)			_g->set((int)113,HX_("F2",2c,3d,00,00));
HXDLIN(  54)			_g->set((int)114,HX_("F3",2d,3d,00,00));
HXDLIN(  54)			_g->set((int)115,HX_("F4",2e,3d,00,00));
HXDLIN(  54)			_g->set((int)116,HX_("F5",2f,3d,00,00));
HXDLIN(  54)			_g->set((int)117,HX_("F6",30,3d,00,00));
HXDLIN(  54)			_g->set((int)118,HX_("F7",31,3d,00,00));
HXDLIN(  54)			_g->set((int)119,HX_("F8",32,3d,00,00));
HXDLIN(  54)			_g->set((int)120,HX_("F9",33,3d,00,00));
HXDLIN(  54)			_g->set((int)121,HX_("F10",a5,48,35,00));
HXDLIN(  54)			_g->set((int)122,HX_("F11",a6,48,35,00));
HXDLIN(  54)			_g->set((int)123,HX_("F12",a7,48,35,00));
HXDLIN(  54)			_g->set((int)96,HX_("NUMPADZERO",75,90,dd,33));
HXDLIN(  54)			_g->set((int)97,HX_("NUMPADONE",99,e5,09,5c));
HXDLIN(  54)			_g->set((int)98,HX_("NUMPADTWO",bf,b8,0d,5c));
HXDLIN(  54)			_g->set((int)99,HX_("NUMPADTHREE",51,f6,94,bb));
HXDLIN(  54)			_g->set((int)100,HX_("NUMPADFOUR",33,e5,ac,26));
HXDLIN(  54)			_g->set((int)101,HX_("NUMPADFIVE",7f,58,a8,26));
HXDLIN(  54)			_g->set((int)102,HX_("NUMPADSIX",55,ea,0c,5c));
HXDLIN(  54)			_g->set((int)103,HX_("NUMPADSEVEN",00,c7,35,26));
HXDLIN(  54)			_g->set((int)104,HX_("NUMPADEIGHT",42,23,33,19));
HXDLIN(  54)			_g->set((int)105,HX_("NUMPADNINE",7f,06,f2,2b));
HXDLIN(  54)			_g->set((int)109,HX_("NUMPADMINUS",63,22,6d,b4));
HXDLIN(  54)			_g->set((int)107,HX_("NUMPADPLUS",a7,c0,46,2d));
HXDLIN(  54)			_g->set((int)110,HX_("NUMPADPERIOD",8e,73,24,13));
HXDLIN(  54)			_g->set((int)106,HX_("NUMPADMULTIPLY",f1,55,e9,54));
HXDLIN(  54)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)

            	HX_STACKFRAME(&_hx_pos_b641261cd9bd2dff_54_boot)
HXDLIN(  54)		toStringMap =  ::Dynamic(new _hx_Closure_0())();
            	}
{
