...
HXDLIN( 182)		LEFT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)0,(int)1, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN( 188)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
            			->setFixed(0,HX_("right",dc,0b,64,e9),(int)29)
            			->setFixed(1,HX_("up",5b,66,00,00),(int)26)
            			->setFixed(2,HX_("down",62,f8,6d,42),(int)27)
            			->setFixed(3,HX_("left",07,08,b0,47),(int)28)));
