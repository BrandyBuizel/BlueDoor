...
HXLINE( 679)			int _hx_tmp = a1->type;
HXDLIN( 679)			return (_hx_tmp - b1->type);
            		}
            		HX_END_LOCAL_FUNC2(return)
...
HXDLIN( 684)			int _g = this->mEntries->length;
...
HXLINE( 690)				bool _hx_tmp1;
HXDLIN( 690)				bool _hx_tmp2;
HXDLIN( 690)				if (tempRegistersOnly) {
HXLINE( 690)					_hx_tmp2 = (entry->type != (int)2);
            				}
            				else {
...
HXLINE( 690)						_hx_tmp1 = (entry->type == (int)2);
            					}
            					else {
...
HXLINE( 697)				if ((entry->type == (int)3)) {
HXLINE( 699)					continue;
            				}
HXLINE( 702)				{
HXLINE( 702)					int _g2 = entry->type;
HXDLIN( 702)					switch((int)(_g2)){
            						case (int)0: {
...
HXLINE( 727)				{
HXLINE( 727)					 ::openfl::_internal::formats::agal::_AGALConverter::RegisterUsage _g3 = entry->usage;
HXDLIN( 727)					switch((int)(_hx_getEnumValueIndex(_g3))){
            						case (int)0: {
HXLINE( 745)							::lime::utils::Log_obj::info(HX_("Missing switch patten: RegisterUsage.UNUSED",38,09,f6,02),hx::SourceInfo(HX_("AGALConverter.hx",8f,36,cd,e2),745,HX_("openfl._internal.formats.agal.RegisterMap",be,44,18,8a),HX_("toGLSL",f9,58,08,7a)));
            						}
            						break;
            						case (int)1: {
