...
HXDLIN(  55)			while((_g < (int)512)){
HXLINE(  55)				_g = (_g + (int)1);
HXDLIN(  55)				int i = (_g - (int)1);
HXLINE(  57)				::Array< int > _hx_tmp = this->p_perm;
HXDLIN(  57)				::Array< int > _hx_tmp1 = ::openfl::_internal::utils::PerlinNoise_obj::P;
HXDLIN(  57)				_hx_tmp[i] = _hx_tmp1->__get(((int)i & (int)(int)255));
            			}
            		}
...
HXLINE(  74)		bool isRed = (((int)(int)1 & (int)this->channels) == (int)1);
HXLINE(  75)		bool isGreen = (((int)(int)2 & (int)this->channels) == (int)2);
HXLINE(  76)		bool isBlue = (((int)(int)4 & (int)this->channels) == (int)4);
HXLINE(  78)		int channels = (int)0;
HXLINE(  80)		if (isRed) {
HXLINE(  82)			channels = (channels + (int)1);
            		}
HXLINE(  85)		if (isGreen) {
HXLINE(  87)			channels = (channels + (int)1);
            		}
HXLINE(  90)		if (isBlue) {
HXLINE(  92)			channels = (channels + (int)1);
            		}
HXLINE(  95)		bool grayscale = this->grayscale;
HXLINE(  97)		int stitch_w = ::Std_obj::_hx_int((this->stitch_threshold * width));
HXLINE(  98)		int stitch_h = ::Std_obj::_hx_int((this->stitch_threshold * height));
...
HXDLIN( 108)			int _g = height;
HXDLIN( 108)			while((_g1 < _g)){
HXLINE( 108)				_g1 = (_g1 + (int)1);
HXDLIN( 108)				int py = (_g1 - (int)1);
HXLINE( 110)				_scale_x = base_x;
HXLINE( 112)				{
HXLINE( 112)					int _g3 = (int)0;
HXDLIN( 112)					int _g2 = width;
HXDLIN( 112)					while((_g3 < _g2)){
HXLINE( 112)						_g3 = (_g3 + (int)1);
HXDLIN( 112)						int px = (_g3 - (int)1);
HXLINE( 114)						Float color1 = ((Float)0.0);
HXLINE( 115)						Float color2 = ((Float)0.0);
HXLINE( 116)						Float color3 = ((Float)0.0);
HXLINE( 118)						{
HXLINE( 118)							int _g5 = (int)0;
HXDLIN( 118)							int _g4 = octaves;
HXDLIN( 118)							while((_g5 < _g4)){
HXLINE( 118)								_g5 = (_g5 + (int)1);
HXDLIN( 118)								int i = (_g5 - (int)1);
...
HXLINE( 190)		Float xf = (x - hx::Mod(x,(int)1));
HXLINE( 191)		Float yf = (y - hx::Mod(y,(int)1));
HXLINE( 192)		Float zf = (z - hx::Mod(z,(int)1));
HXLINE( 194)		x = (x - xf);
HXLINE( 195)		y = (y - yf);
HXLINE( 196)		z = (z - zf);
HXLINE( 198)		int X = ((int)::Std_obj::_hx_int(xf) & (int)(int)255);
HXLINE( 199)		int Y = ((int)::Std_obj::_hx_int(yf) & (int)(int)255);
HXLINE( 200)		int Z = ((int)::Std_obj::_hx_int(zf) & (int)(int)255);
...
HXLINE( 208)		::Array< int > AB = this->p_perm;
HXDLIN( 208)		int AB1 = (AB->__get((A + (int)1)) + Z);
HXLINE( 209)		::Array< int > B = this->p_perm;
HXDLIN( 209)		int B1 = (B->__get((X + (int)1)) + Y);
HXLINE( 210)		int BA = (this->p_perm->__get(B1) + Z);
HXLINE( 211)		::Array< int > BB = this->p_perm;
HXDLIN( 211)		int BB1 = (BB->__get((B1 + (int)1)) + Z);
HXLINE( 213)		Float x1 = (x - (int)1);
HXLINE( 214)		Float y1 = (y - (int)1);
HXLINE( 215)		Float z1 = (z - (int)1);
HXLINE( 217)		::Array< int > hash = this->p_perm;
HXDLIN( 217)		int hash1 = ((int)hash->__get((BB1 + (int)1)) & (int)(int)15);
HXLINE( 218)		Float g1;
HXDLIN( 218)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 218)			if ((hash1 < (int)8)) {
HXLINE( 218)				g1 = x1;
            			}
            			else {
HXLINE( 218)				g1 = y1;
...
HXDLIN( 219)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 219)			if ((hash1 < (int)4)) {
HXLINE( 219)				g11 = y1;
            			}
            			else {
HXLINE( 219)				if ((hash1 == (int)12)) {
HXLINE( 219)					g11 = x1;
            				}
            				else {
HXLINE( 219)					g11 = z1;
...
HXLINE( 221)		::Array< int > hash2 = this->p_perm;
HXDLIN( 221)		hash1 = ((int)hash2->__get((AB1 + (int)1)) & (int)(int)15);
HXLINE( 222)		Float g2;
HXDLIN( 222)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 222)			if ((hash1 < (int)8)) {
HXLINE( 222)				g2 = x;
            			}
            			else {
HXLINE( 222)				g2 = y1;
...
HXDLIN( 223)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 223)			if ((hash1 < (int)4)) {
HXLINE( 223)				g21 = y1;
            			}
            			else {
HXLINE( 223)				if ((hash1 == (int)12)) {
HXLINE( 223)					g21 = x;
            				}
            				else {
HXLINE( 223)					g21 = z1;
...
HXLINE( 225)		::Array< int > hash3 = this->p_perm;
HXDLIN( 225)		hash1 = ((int)hash3->__get((BA + (int)1)) & (int)(int)15);
HXLINE( 226)		Float g3;
...
HXDLIN( 227)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 227)			if ((hash1 < (int)4)) {
HXLINE( 227)				g31 = y;
            			}
            			else {
HXLINE( 227)				if ((hash1 == (int)12)) {
HXLINE( 227)					g31 = x1;
            				}
            				else {
HXLINE( 227)					g31 = z1;
...
HXLINE( 229)		::Array< int > hash4 = this->p_perm;
HXDLIN( 229)		hash1 = ((int)hash4->__get((AA + (int)1)) & (int)(int)15);
HXLINE( 230)		Float g4;
HXDLIN( 230)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 230)			if ((hash1 < (int)8)) {
HXLINE( 230)				g4 = x;
            			}
            			else {
HXLINE( 230)				g4 = y;
...
HXDLIN( 231)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 231)			if ((hash1 < (int)4)) {
HXLINE( 231)				g41 = y;
            			}
            			else {
HXLINE( 231)				if ((hash1 == (int)12)) {
HXLINE( 231)					g41 = x;
            				}
            				else {
HXLINE( 231)					g41 = z1;
...
HXLINE( 233)		hash1 = ((int)this->p_perm->__get(BB1) & (int)(int)15);
HXLINE( 234)		Float g5;
HXDLIN( 234)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 234)			if ((hash1 < (int)8)) {
HXLINE( 234)				g5 = x1;
            			}
            			else {
HXLINE( 234)				g5 = y1;
...
HXLINE( 237)		hash1 = ((int)this->p_perm->__get(AB1) & (int)(int)15);
HXLINE( 238)		Float g6;
...
HXDLIN( 239)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 239)			if ((hash1 < (int)4)) {
HXLINE( 239)				g61 = y1;
            			}
            			else {
HXLINE( 239)				if ((hash1 == (int)12)) {
HXLINE( 239)					g61 = x;
            				}
            				else {
HXLINE( 239)					g61 = z;
...
HXLINE( 241)		hash1 = ((int)this->p_perm->__get(BA) & (int)(int)15);
HXLINE( 242)		Float g7;
HXDLIN( 242)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 242)			if ((hash1 < (int)8)) {
HXLINE( 242)				g7 = x1;
            			}
            			else {
HXLINE( 242)				g7 = y;
...
HXDLIN( 243)		if ((((int)hash1 & (int)(int)2) == (int)0)) {
HXLINE( 243)			if ((hash1 < (int)4)) {
HXLINE( 243)				g71 = y;
            			}
            			else {
HXLINE( 243)				if ((hash1 == (int)12)) {
HXLINE( 243)					g71 = x1;
            				}
            				else {
HXLINE( 243)					g71 = z;
...
HXLINE( 245)		hash1 = ((int)this->p_perm->__get(AA) & (int)(int)15);
HXLINE( 246)		Float g8;
HXDLIN( 246)		if ((((int)hash1 & (int)(int)1) == (int)0)) {
HXLINE( 246)			if ((hash1 < (int)8)) {
HXLINE( 246)				g8 = x;
            			}
            			else {
HXLINE( 246)				g8 = y;
...
HXDLIN( 262)		this->x_offset = seed;
HXLINE( 263)		seed = ::Std_obj::_hx_int(hx::Mod((seed * ((Float)16807.0)),(int)2147483647));
HXDLIN( 263)		this->y_offset = seed;
HXLINE( 264)		seed = ::Std_obj::_hx_int(hx::Mod((seed * ((Float)16807.0)),(int)2147483647));
HXDLIN( 264)		this->z_offset = seed;
            	}
