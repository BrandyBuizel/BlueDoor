...
HXLINE( 295)		multipliers[(int)0] = matrix->__get((int)0);
HXLINE( 296)		multipliers[(int)1] = matrix->__get((int)1);
HXLINE( 297)		multipliers[(int)2] = matrix->__get((int)2);
HXLINE( 298)		multipliers[(int)3] = matrix->__get((int)3);
HXLINE( 299)		multipliers[(int)4] = matrix->__get((int)5);
HXLINE( 300)		multipliers[(int)5] = matrix->__get((int)6);
HXLINE( 301)		multipliers[(int)6] = matrix->__get((int)7);
HXLINE( 302)		multipliers[(int)7] = matrix->__get((int)8);
HXLINE( 303)		multipliers[(int)8] = matrix->__get((int)10);
HXLINE( 304)		multipliers[(int)9] = matrix->__get((int)11);
HXLINE( 305)		multipliers[(int)10] = matrix->__get((int)12);
HXLINE( 306)		multipliers[(int)11] = matrix->__get((int)13);
HXLINE( 307)		multipliers[(int)12] = matrix->__get((int)15);
HXLINE( 308)		multipliers[(int)13] = matrix->__get((int)16);
HXLINE( 309)		multipliers[(int)14] = matrix->__get((int)17);
HXLINE( 310)		multipliers[(int)15] = matrix->__get((int)18);
HXLINE( 312)		offsets[(int)0] = ((Float)matrix->__get((int)4) / (Float)((Float)255.0));
HXLINE( 313)		offsets[(int)1] = ((Float)matrix->__get((int)9) / (Float)((Float)255.0));
HXLINE( 314)		offsets[(int)2] = ((Float)matrix->__get((int)14) / (Float)((Float)255.0));
HXLINE( 315)		offsets[(int)3] = ((Float)matrix->__get((int)19) / (Float)((Float)255.0));
            	}
