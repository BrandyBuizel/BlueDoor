...
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->PERFMON_RESULT_AMD = (int)35782;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->PERFMON_RESULT_SIZE_AMD = (int)35781;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->PERFMON_RESULT_AVAILABLE_AMD = (int)35780;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->PERCENTAGE_AMD = (int)35779;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->UNSIGNED_INT64_AMD = (int)35778;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->COUNTER_RANGE_AMD = (int)35777;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::AMD_performance_monitor)(__this) )->COUNTER_TYPE_AMD = (int)35776;
            	}
