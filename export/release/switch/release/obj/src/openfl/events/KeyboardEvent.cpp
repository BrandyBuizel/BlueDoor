...
HX_DEFINE_STACK_FRAME(_hx_pos_c70c2341539e31f3_165_new,"openfl.events.KeyboardEvent","new",0xa9982e4e,"openfl.events.KeyboardEvent.new","openfl/events/KeyboardEvent.hx",165,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_182_clone,"openfl.events.KeyboardEvent","clone",0x11ed48cb,"openfl.events.KeyboardEvent.clone","openfl/events/KeyboardEvent.hx",182,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_194_toString,"openfl.events.KeyboardEvent","toString",0xd22933fe,"openfl.events.KeyboardEvent.toString","openfl/events/KeyboardEvent.hx",194,0xce5f4702)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_43_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",43,0xce5f4702)
HX_LOCAL_STACK_FRAME(_hx_pos_c70c2341539e31f3_64_boot,"openfl.events.KeyboardEvent","boot",0xb3a95684,"openfl.events.KeyboardEvent.boot","openfl/events/KeyboardEvent.hx",64,0xce5f4702)
namespace openfl{
namespace events{
...
bool commandKeyValue = __o_commandKeyValue.Default(false);
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_165_new)
HXLINE( 166)		super::__construct(type,bubbles,cancelable);
HXLINE( 168)		this->charCode = charCodeValue;
HXLINE( 169)		this->keyCode = keyCodeValue;
HXLINE( 170)		int _hx_tmp;
HXDLIN( 170)		if (hx::IsNotNull( keyLocationValue )) {
HXLINE( 170)			_hx_tmp = keyLocationValue;
            		}
            		else {
HXLINE( 170)			_hx_tmp = (int)0;
            		}
HXDLIN( 170)		this->keyLocation = _hx_tmp;
HXLINE( 171)		this->ctrlKey = ctrlKeyValue;
HXLINE( 172)		this->altKey = altKeyValue;
HXLINE( 173)		this->shiftKey = shiftKeyValue;
HXLINE( 176)		this->controlKey = controlKeyValue;
HXLINE( 177)		this->commandKey = commandKeyValue;
            	}
...
bool KeyboardEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event KeyboardEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c70c2341539e31f3_182_clone)
HXLINE( 183)		 ::openfl::events::KeyboardEvent event =  ::openfl::events::KeyboardEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->charCode,this->keyCode,this->keyLocation,this->ctrlKey,this->altKey,this->shiftKey,this->controlKey,this->commandKey);
HXLINE( 186)		event->target = this->target;
HXLINE( 187)		event->currentTarget = this->currentTarget;
HXLINE( 188)		event->eventPhase = this->eventPhase;
HXLINE( 189)		return event;
            	}


::String KeyboardEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_194_toString)
HXDLIN( 194)		return this->_hx___formatToString(HX_("KeyboardEvent",d3,8d,88,91),::Array_obj< ::String >::fromData( _hx_array_data_d8fbaf5c_3,9));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_43_boot)
HXDLIN(  43)		KEY_DOWN = HX_("keyDown",a1,69,47,9c);
            	}
{
            	HX_STACKFRAME(&_hx_pos_c70c2341539e31f3_64_boot)
HXDLIN(  64)		KEY_UP = HX_("keyUp",da,b9,fe,de);
            	}
}
