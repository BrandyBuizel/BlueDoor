...
HXLINE(  19)		this->NETWORK_NO_SOURCE = (int)3;
HXLINE(  18)		this->NETWORK_LOADING = (int)2;
HXLINE(  17)		this->NETWORK_IDLE = (int)1;
HXLINE(  16)		this->NETWORK_EMPTY = (int)0;
HXLINE(  15)		this->HAVE_NOTHING = (int)0;
HXLINE(  14)		this->HAVE_METADATA = (int)1;
HXLINE(  13)		this->HAVE_FUTURE_DATA = (int)3;
HXLINE(  12)		this->HAVE_ENOUGH_DATA = (int)4;
HXLINE(  11)		this->HAVE_CURRENT_DATA = (int)2;
            	}
