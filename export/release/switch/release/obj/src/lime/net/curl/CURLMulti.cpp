...
HXLINE(  57)			return  ::lime::net::curl::CURLMultiMessage_obj::__alloc( HX_CTX , ::Dynamic(msg->__Field(HX_("curl",ec,4a,c9,41),hx::paccDynamic)), ::Dynamic(msg->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)));
            		}
