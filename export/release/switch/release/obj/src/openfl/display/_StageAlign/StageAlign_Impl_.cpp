...
HXDLIN(  45)		TOP_LEFT = (int)6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_9f809a2b617ac4f8_50_boot)
HXDLIN(  50)		TOP_RIGHT = (int)7;
            	}
}
