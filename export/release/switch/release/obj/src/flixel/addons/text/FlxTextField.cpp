...
HXLINE(  45)		{
HXLINE(  45)			 ::openfl::text::TextField Child = this->textField;
...
HXLINE( 117)		 ::openfl::text::TextField _hx_tmp = this->textField;
...
HXLINE( 122)		 ::openfl::text::TextField _hx_tmp3 = this->textField;
HXDLIN( 122)		_hx_tmp3->set_x((this->x - this->offset->x));
HXLINE( 123)		 ::openfl::text::TextField _hx_tmp4 = this->textField;
