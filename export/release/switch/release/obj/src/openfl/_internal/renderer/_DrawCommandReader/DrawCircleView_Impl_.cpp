...
HXDLIN( 573)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 573)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 580)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 580)		return this2->__get((this1->fPos + (int)2));
            	}
