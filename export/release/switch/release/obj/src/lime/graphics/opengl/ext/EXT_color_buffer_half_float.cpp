...
HXLINE(  14)		this->UNSIGNED_NORMALIZED_EXT = (int)35863;
HXLINE(  13)		this->FRAMEBUFFER_ATTACHMENT_COMPONENT_TYPE_EXT = (int)33297;
HXLINE(  11)		this->R16F_EXT = (int)33325;
HXLINE(  10)		this->RG16F_EXT = (int)33327;
HXLINE(   8)		this->RGB16F_EXT = (int)34843;
HXLINE(   7)		this->RGBA16F_EXT = (int)34842;
            	}
