...
HXLINE(  86)		graph->beginFill((int)47394,null());
HXLINE(  87)		graph->moveTo((int)50,(int)13);
HXLINE(  88)		graph->lineTo((int)51,(int)13);
HXLINE(  89)		graph->lineTo((int)87,(int)50);
HXLINE(  90)		graph->lineTo((int)87,(int)51);
HXLINE(  91)		graph->lineTo((int)51,(int)87);
HXLINE(  92)		graph->lineTo((int)50,(int)87);
HXLINE(  93)		graph->lineTo((int)13,(int)51);
HXLINE(  94)		graph->lineTo((int)13,(int)50);
HXLINE(  95)		graph->lineTo((int)50,(int)13);
HXLINE(  96)		graph->endFill();
HXLINE(  99)		graph->beginFill((int)16761138,null());
HXLINE( 100)		graph->moveTo((int)0,(int)0);
HXLINE( 101)		graph->lineTo((int)25,(int)0);
HXLINE( 102)		graph->lineTo((int)50,(int)13);
HXLINE( 103)		graph->lineTo((int)13,(int)50);
HXLINE( 104)		graph->lineTo((int)0,(int)25);
HXLINE( 105)		graph->lineTo((int)0,(int)0);
HXLINE( 106)		graph->endFill();
HXLINE( 109)		graph->beginFill((int)16066382,null());
HXLINE( 110)		graph->moveTo((int)100,(int)0);
HXLINE( 111)		graph->lineTo((int)75,(int)0);
HXLINE( 112)		graph->lineTo((int)51,(int)13);
HXLINE( 113)		graph->lineTo((int)87,(int)50);
HXLINE( 114)		graph->lineTo((int)100,(int)25);
HXLINE( 115)		graph->lineTo((int)100,(int)0);
HXLINE( 116)		graph->endFill();
HXLINE( 119)		graph->beginFill((int)3555839,null());
HXLINE( 120)		graph->moveTo((int)0,(int)100);
HXLINE( 121)		graph->lineTo((int)25,(int)100);
HXLINE( 122)		graph->lineTo((int)50,(int)87);
HXLINE( 123)		graph->lineTo((int)13,(int)51);
HXLINE( 124)		graph->lineTo((int)0,(int)75);
HXLINE( 125)		graph->lineTo((int)0,(int)100);
HXLINE( 126)		graph->endFill();
HXLINE( 129)		graph->beginFill((int)314875,null());
HXLINE( 130)		graph->moveTo((int)100,(int)100);
HXLINE( 131)		graph->lineTo((int)75,(int)100);
HXLINE( 132)		graph->lineTo((int)51,(int)87);
HXLINE( 133)		graph->lineTo((int)87,(int)51);
HXLINE( 134)		graph->lineTo((int)100,(int)75);
HXLINE( 135)		graph->lineTo((int)100,(int)100);
...
HXDLIN( 155)		return ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(source,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            	}
...
HXLINE( 170)		if (::Std_obj::is(Graphic,hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 172)			return ( ( ::openfl::display::BitmapData)(Graphic) );
            		}
            		else {
HXLINE( 174)			if (::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >())) {
HXLINE( 176)				return ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(Graphic,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
            			}
            			else {
HXLINE( 178)				if (::Std_obj::is(Graphic,hx::ClassOf< ::String >())) {
...
HXLINE( 204)		if (::Std_obj::is(Graphic,hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 206)			return Key;
            		}
            		else {
HXLINE( 208)			if (::Std_obj::is(Graphic,hx::ClassOf< ::hx::Class >())) {
...
HXLINE( 212)				if (::Std_obj::is(Graphic,hx::ClassOf< ::String >())) {
...
HXLINE( 233)		 ::flixel::_hx_system::GraphicVirtualInput bitmapData =  ::flixel::_hx_system::GraphicVirtualInput_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null());
