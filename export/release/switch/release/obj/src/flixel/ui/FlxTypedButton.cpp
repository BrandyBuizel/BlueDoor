...
HXLINE( 137)		this->statusAnimations = ::Array_obj< ::String >::fromData( _hx_array_data_f696ad12_1,3);
HXLINE( 131)		this->labelAlphas = ::Array_obj< Float >::fromData( _hx_array_data_f696ad12_2,3);
...
HXLINE( 375)				 ::Dynamic _hx_tmp1 = this->label;
HXDLIN( 375)				( ( ::flixel::FlxSprite)(_hx_tmp1) )->set_frames(labelNode->getImageFrame());
            			}
            		}
