...
HXDLIN(  32)		return (((Float)::Math_obj::abs((EndTicks - StartTicks)) / (Float)(int)1000) + HX_("s",73,00,00,00));
            	}
...
HXLINE(  44)		::String timeString = (::Std_obj::_hx_int(((Float)Seconds / (Float)(int)60)) + HX_(":",3a,00,00,00));
HXLINE(  45)		int timeStringHelper = hx::Mod(::Std_obj::_hx_int(Seconds),(int)60);
HXLINE(  46)		if ((timeStringHelper < (int)10)) {
...
HXLINE(  54)			timeStringHelper = ::Std_obj::_hx_int(((Seconds - ::Std_obj::_hx_int(Seconds)) * (int)100));
HXLINE(  55)			if ((timeStringHelper < (int)10)) {
...
HXLINE(  75)			_hx_tmp = (AnyArray->get_length() > (int)0);
            		}
            		else {
HXLINE(  75)			_hx_tmp = false;
            		}
HXDLIN(  75)		if (_hx_tmp) {
HXLINE(  77)			string = ::Std_obj::string(AnyArray->__get((int)0));
HXLINE(  78)			int i = (int)1;
HXLINE(  79)			int l = AnyArray->get_length();
HXLINE(  80)			while((i < l)){
HXLINE(  82)				i = (i + (int)1);
HXDLIN(  82)				string = (string + (HX_(", ",74,26,00,00) + ::Std_obj::string(AnyArray->__get((i - (int)1)))));
            			}
            		}
...
HXLINE( 103)		return string.substring((int)0,(string.length - (int)2));
            	}
...
HXLINE( 119)		bool isNegative = (Amount < (int)0);
...
HXLINE( 125)		while((amount > (int)0)){
HXLINE( 127)			bool _hx_tmp;
HXDLIN( 127)			if ((string.length > (int)0)) {
HXLINE( 127)				_hx_tmp = (comma.length <= (int)0);
            			}
            			else {
...
HXLINE( 131)			Float helper = (amount - (::Math_obj::ffloor(((Float)amount / (Float)(int)1000)) * (int)1000));
HXLINE( 132)			amount = ::Math_obj::ffloor(((Float)amount / (Float)(int)1000));
HXLINE( 133)			if ((amount > (int)0)) {
HXLINE( 135)				if ((helper < (int)100)) {
HXLINE( 136)					zeroes = (zeroes + HX_("0",30,00,00,00));
            				}
HXLINE( 137)				if ((helper < (int)10)) {
...
HXLINE( 148)			Float amount1 = ::Math_obj::ffloor((Amount * (int)100));
HXDLIN( 148)			amount = (amount1 - (::Math_obj::ffloor(Amount) * (int)100));
...
HXLINE( 167)		int curUnit = (int)0;
HXLINE( 168)		while(true){
HXLINE( 168)			bool _hx_tmp;
HXDLIN( 168)			if ((Bytes >= (int)1024)) {
HXLINE( 168)				_hx_tmp = (curUnit < (units->length - (int)1));
            			}
            			else {
...
HXLINE( 170)			Bytes = ((Float)Bytes / (Float)(int)1024);
HXLINE( 171)			curUnit = (curUnit + (int)1);
            		}
            		_hx_goto_8:;
...
HXDLIN( 185)			int _g = Input.length;
...
HXDLIN( 188)				if (hx::IsGreaterEq( c,(int)48 )) {
HXLINE( 188)					_hx_tmp = hx::IsLessEq( c,(int)57 );
            				}
            				else {
...
HXDLIN( 190)					output->charBuf->push(c);
            				}
            			}
            		}
...
HXLINE( 243)		if (::Std_obj::is(objectOrClass,hx::ClassOf< ::hx::Class >())) {
...
HXLINE( 262)		if (::Std_obj::is(enumValueOrEnum,hx::ClassOf< ::Enum >())) {
...
HXLINE( 277)			s = s.substr((s.lastIndexOf(HX_(".",2e,00,00,00),null()) + (int)1),null());
            		}
HXLINE( 278)		return s;
            	}
...
HXLINE( 294)			::String host = hostFromURL->matched((int)1);
...
HXLINE( 316)			::String domain = domainFromHost->matched((int)1);
...
HXLINE( 393)		int offset = (int)0;
HXLINE( 395)		while((row < height)){
HXLINE( 397)			column = (int)0;
HXLINE( 399)			while((column < Width)){
HXLINE( 401)				index = Data->__get(offset);
HXLINE( 403)				if (Invert) {
HXLINE( 405)					if ((index == (int)0)) {
HXLINE( 407)						index = (int)1;
            					}
            					else {
HXLINE( 409)						if ((index == (int)1)) {
HXLINE( 411)							index = (int)0;
            						}
            					}
            				}
HXLINE( 415)				if ((column == (int)0)) {
HXLINE( 417)					if ((row == (int)0)) {
...
HXLINE( 431)				column = (column + (int)1);
HXLINE( 432)				offset = (offset + (int)1);
            			}
HXLINE( 435)			row = (row + (int)1);
            		}
...
HXLINE( 453)		if ((Scale < (int)1)) {
HXLINE( 455)			Scale = (int)1;
            		}
HXLINE( 459)		if ((Scale > (int)1)) {
HXLINE( 461)			 ::openfl::display::BitmapData bd = Bitmap;
HXLINE( 462)			int Bitmap1 = (Bitmap->width * Scale);
HXDLIN( 462)			Bitmap =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,Bitmap1,(Bitmap->height * Scale),null(),null());
HXLINE( 465)			int bdW = bd->width;
HXLINE( 466)			int bdH = bd->height;
HXLINE( 467)			int pCol = (int)0;
HXLINE( 469)			{
HXLINE( 469)				int _g1 = (int)0;
HXDLIN( 469)				int _g = bdW;
HXDLIN( 469)				while((_g1 < _g)){
HXLINE( 469)					_g1 = (_g1 + (int)1);
HXDLIN( 469)					int i = (_g1 - (int)1);
HXLINE( 471)					{
HXLINE( 471)						int _g3 = (int)0;
HXDLIN( 471)						int _g2 = bdH;
HXDLIN( 471)						while((_g3 < _g2)){
HXLINE( 471)							_g3 = (_g3 + (int)1);
HXDLIN( 471)							int j = (_g3 - (int)1);
HXLINE( 473)							pCol = bd->getPixel(i,j);
HXLINE( 475)							{
HXLINE( 475)								int _g5 = (int)0;
HXDLIN( 475)								int _g4 = Scale;
HXDLIN( 475)								while((_g5 < _g4)){
HXLINE( 475)									_g5 = (_g5 + (int)1);
HXDLIN( 475)									int k = (_g5 - (int)1);
HXLINE( 477)									{
HXLINE( 477)										int _g7 = (int)0;
HXDLIN( 477)										int _g6 = Scale;
HXDLIN( 477)										while((_g7 < _g6)){
HXLINE( 477)											_g7 = (_g7 + (int)1);
HXDLIN( 477)											int m = (_g7 - (int)1);
...
HXLINE( 493)			int _g11 = (int)0;
HXDLIN( 493)			int _g8 = ColorMap->length;
HXDLIN( 493)			while((_g11 < _g8)){
HXLINE( 493)				_g11 = (_g11 + (int)1);
HXDLIN( 493)				int i1 = (_g11 - (int)1);
HXLINE( 495)				ColorMap[i1] = ((int)ColorMap->__get(i1) & (int)(int)16777215);
            			}
            		}
HXLINE( 500)		int row = (int)0;
...
HXLINE( 520)						_hx_tmp1 = (pixel > (int)0);
            					}
            					else {
...
HXLINE( 520)							_hx_tmp = (pixel == (int)0);
            						}
            						else {
...
HXLINE( 522)						pixel = (int)1;
            					}
            					else {
HXLINE( 526)						pixel = (int)0;
            					}
            				}
HXLINE( 530)				if ((column == (int)0)) {
HXLINE( 532)					if ((row == (int)0)) {
...
HXLINE( 546)				column = (column + (int)1);
            			}
HXLINE( 549)			row = (row + (int)1);
            		}
...
HXLINE( 569)		if (::Std_obj::is(ImageFile,hx::ClassOf< ::String >())) {
...
HXLINE( 571)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXLINE( 602)		output = ::StringTools_obj::trim(output.substr((int)0,(output.length - (int)2)));
...
HXDLIN( 608)		return (s.indexOf(str,null()) != (int)-1);
            	}
...
HXDLIN( 624)		::String _hx_tmp = (s.substring((int)0,pos) + insertion);
...
HXLINE( 633)			if ((a < b)) {
HXLINE( 634)				return (int)-1;
            			}
HXLINE( 635)			if ((a > b)) {
HXLINE( 636)				return (int)1;
            			}
...
HXDLIN( 648)			return (s.length == (int)0);
            		}
            		else {
