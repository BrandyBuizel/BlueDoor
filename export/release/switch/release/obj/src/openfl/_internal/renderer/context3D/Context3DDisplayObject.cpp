...
HXDLIN(  38)			rect->setTo((int)0,(int)0,_hx_tmp5,displayObject->get_height());
HXLINE(  39)			renderer->_hx___pushMaskRect(rect,displayObject->_hx___renderTransform);
HXLINE(  42)			int color = displayObject->opaqueBackground;
HXLINE(  43)			context->clear(((Float)((int)hx::UShr(color,(int)16) & (int)(int)255) / (Float)(int)255),((Float)((int)hx::UShr(color,(int)8) & (int)(int)255) / (Float)(int)255),((Float)((int)color & (int)(int)255) / (Float)(int)255),(int)1,(int)0,(int)0,(int)1);
