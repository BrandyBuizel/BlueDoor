...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::IMG_texture_compression_pvrtc)(__this) )->COMPRESSED_RGBA_PVRTC_2BPPV1_IMG = (int)35843;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::IMG_texture_compression_pvrtc)(__this) )->COMPRESSED_RGBA_PVRTC_4BPPV1_IMG = (int)35842;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::IMG_texture_compression_pvrtc)(__this) )->COMPRESSED_RGB_PVRTC_2BPPV1_IMG = (int)35841;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::IMG_texture_compression_pvrtc)(__this) )->COMPRESSED_RGB_PVRTC_4BPPV1_IMG = (int)35840;
            	}
