...
HXLINE(  74)				::flixel::util::FlxBitmapDataPool_obj::_rect->x = (int)0;
HXLINE(  75)				::flixel::util::FlxBitmapDataPool_obj::_rect->y = (int)0;
HXLINE(  76)				::flixel::util::FlxBitmapDataPool_obj::_rect->width = w;
HXLINE(  77)				::flixel::util::FlxBitmapDataPool_obj::_rect->height = h;
HXLINE(  78)				res->fillRect(::flixel::util::FlxBitmapDataPool_obj::_rect,fillColor);
            			}
            		}
            		else {
HXLINE(  83)			int res1;
HXDLIN(  83)			if (hx::IsNotNull( fillColor )) {
HXLINE(  83)				res1 = fillColor;
            			}
            			else {
HXLINE(  83)				res1 = (int)-1;
            			}
...
HXLINE( 134)		::flixel::util::FlxBitmapDataPool_obj::length = (int)0;
...
static hx::StaticInfo FlxBitmapDataPool_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(void *) &FlxBitmapDataPool_obj::_rect,HX_HCSTRING("_rect","\x03","\x69","\xb8","\xfe")},
	{ hx::fsUnknown, 0, null()}
};
#endif
