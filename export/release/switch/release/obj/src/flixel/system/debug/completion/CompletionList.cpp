...
HXLINE(  25)		this->upperVisibleIndex = (int)0;
HXLINE(  24)		this->lowerVisibleIndex = (int)0;
HXLINE(  23)		this->selectedIndex = (int)0;
HXLINE(  21)		this->entries = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  31)		super::__construct();
HXLINE(  33)		this->set_visible(false);
HXLINE(  34)		this->upperVisibleIndex = (capacity - (int)1);
HXLINE(  35)		this->actualHeight = (capacity * (int)20);
...
bool CompletionList_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x19c29573) {
		...
		if (inClassId<=(int)0x3815113e) {
			return inClassId==(int)0x1b123bf8 || inClassId==(int)0x3815113e;
		} else {
...
HXDLIN(  56)		this->set_y((y - this->actualHeight));
            	}
...
HXDLIN(  70)		int _g1 = (int)0;
HXDLIN(  70)		int _g = amount;
...
HXLINE(  75)			entry->set_y(((int)20 * i));
            		}
            	}
...
HXLINE(  81)		this->scrollBar =  ::flixel::_hx_system::debug::completion::CompletionListScrollBar_obj::__alloc( HX_CTX ,(int)150,(int)0,(int)5,this->actualHeight);
