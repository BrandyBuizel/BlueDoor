...
class HXCPP_CLASS_ATTRIBUTES UnicodeBuffer_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< UnicodeBuffer_Impl__obj > __new() {
			hx::ObjectPtr< UnicodeBuffer_Impl__obj > __this = new UnicodeBuffer_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< UnicodeBuffer_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("UnicodeBuffer_Impl_","\x3d","\xc6","\x85","\x60"); }

		static  ::haxe::Utf8 _new(::String s);
		static ::Dynamic _new_dyn();

		static  ::haxe::Utf8 addChar( ::haxe::Utf8 this1,int c);
		static ::Dynamic addChar_dyn();

		static ::String toString( ::haxe::Utf8 this1);
