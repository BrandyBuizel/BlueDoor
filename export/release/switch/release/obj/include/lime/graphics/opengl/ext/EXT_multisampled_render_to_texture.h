...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_multisampled_render_to_texture)(__this) )->MAX_SAMPLES_EXT = (int)36183;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_multisampled_render_to_texture)(__this) )->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_EXT = (int)36182;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_multisampled_render_to_texture)(__this) )->RENDERBUFFER_SAMPLES_EXT = (int)36011;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_multisampled_render_to_texture)(__this) )->FRAMEBUFFER_ATTACHMENT_TEXTURE_SAMPLES_EXT = (int)36204;
            	}
