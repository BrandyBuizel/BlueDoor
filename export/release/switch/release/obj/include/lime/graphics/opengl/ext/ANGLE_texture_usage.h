...
class HXCPP_CLASS_ATTRIBUTES ANGLE_texture_usage_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< ANGLE_texture_usage_obj > __new() {
			hx::ObjectPtr< ANGLE_texture_usage_obj > __this = new ANGLE_texture_usage_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< ANGLE_texture_usage_obj > __alloc(hx::Ctx *_hx_ctx) {
...
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->FRAMEBUFFER_ATTACHMENT_ANGLE = (int)37795;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::ANGLE_texture_usage)(__this) )->TEXTURE_USAGE_ANGLE = (int)37794;
            	}
