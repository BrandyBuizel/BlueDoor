...
HXLINE(  27)			_hx_tmp = (shape->_hx___worldAlpha <= (int)0);
            		}
            		else {
...
HXLINE(  47)				renderer->applyMatrix(renderer->_hx___getMatrix(graphics->_hx___worldTransform,(int)1));
...
HXLINE(  89)				renderer->applyMatrix(renderer->_hx___getMatrix(graphics->_hx___worldTransform,(int)1));
...
HXLINE(  93)					context->setVertexBufferAt(shader->_hx___position->index,vertexBuffer,(int)0,(int)3);
            				}
HXLINE(  94)				if (hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(  94)					context->setVertexBufferAt(shader->_hx___textureCoord->index,vertexBuffer,(int)3,(int)2);
            				}
