...
HXLINE( 133)		return  ::lime::math::Matrix3_obj::__alloc( HX_CTX , ::Dynamic(m->__Field(HX_("a",61,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("b",62,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("c",63,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("d",64,00,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("tx",84,65,00,00),hx::paccDynamic)), ::Dynamic(m->__Field(HX_("ty",85,65,00,00),hx::paccDynamic)));
            	}
