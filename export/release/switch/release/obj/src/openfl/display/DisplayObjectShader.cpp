...
{
	outFields->push(HX_HCSTRING("openfl_Alpha","\x0f","\xce","\x3e","\x6a"));
	outFields->push(HX_HCSTRING("openfl_ColorMultiplier","\xb5","\xe4","\xdc","\x18"));
	outFields->push(HX_HCSTRING("openfl_ColorOffset","\xc7","\xea","\x07","\x41"));
	...
	outFields->push(HX_HCSTRING("openfl_HasColorTransform","\xb4","\x00","\x4b","\x62"));
...
static hx::StorageInfo DisplayObjectShader_obj_sMemberStorageInfo[] = {
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_Alpha),HX_HCSTRING("openfl_Alpha","\x0f","\xce","\x3e","\x6a")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_ColorMultiplier),HX_HCSTRING("openfl_ColorMultiplier","\xb5","\xe4","\xdc","\x18")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_ColorOffset),HX_HCSTRING("openfl_ColorOffset","\xc7","\xea","\x07","\x41")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_Position),HX_HCSTRING("openfl_Position","\x98","\xfe","\x6c","\xee")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_TextureCoord),HX_HCSTRING("openfl_TextureCoord","\x49","\xe9","\x27","\xe8")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_Matrix),HX_HCSTRING("openfl_Matrix","\x70","\xea","\x41","\x06")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Bool*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_HasColorTransform),HX_HCSTRING("openfl_HasColorTransform","\xb4","\x00","\x4b","\x62")},
	{hx::fsObject /*::openfl::display::ShaderParameter_Float*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_TextureSize),HX_HCSTRING("openfl_TextureSize","\xad","\x60","\x72","\x29")},
	{hx::fsObject /*::openfl::display::ShaderInput_openfl_display_BitmapData*/ ,(int)offsetof(DisplayObjectShader_obj,openfl_Texture),HX_HCSTRING("openfl_Texture","\xcc","\xbd","\xe4","\x7e")},
	{ hx::fsUnknown, 0, null()}
};
...
static ::String DisplayObjectShader_obj_sMemberFields[] = {
	HX_HCSTRING("openfl_Alpha","\x0f","\xce","\x3e","\x6a"),
	HX_HCSTRING("openfl_ColorMultiplier","\xb5","\xe4","\xdc","\x18"),
	HX_HCSTRING("openfl_ColorOffset","\xc7","\xea","\x07","\x41"),
	...
	HX_HCSTRING("openfl_HasColorTransform","\xb4","\x00","\x4b","\x62"),
	HX_HCSTRING("openfl_TextureSize","\xad","\x60","\x72","\x29"),
	HX_HCSTRING("openfl_Texture","\xcc","\xbd","\xe4","\x7e"),
	::String(null()) };

static void DisplayObjectShader_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(DisplayObjectShader_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void DisplayObjectShader_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(DisplayObjectShader_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new DisplayObjectShader_obj;
	DisplayObjectShader_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("openfl.display.DisplayObjectShader","\x7c","\x52","\x64","\x22");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = DisplayObjectShader_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = DisplayObjectShader_obj_sVisitStatics;
#endif
