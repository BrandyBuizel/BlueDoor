...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_texture_rg)(__this) )->RG8_EXT = (int)33323;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_texture_rg)(__this) )->R8_EXT = (int)33321;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_texture_rg)(__this) )->RG_EXT = (int)33319;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_texture_rg)(__this) )->RED_EXT = (int)6403;
            	}
