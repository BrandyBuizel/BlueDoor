...
HXLINE( 211)		this->_hx___height = (int)0;
...
HXLINE( 214)		this->_hx___width = (int)0;
HXLINE( 215)		this->_hx___x = (int)0;
HXLINE( 216)		this->_hx___y = (int)0;
HXLINE( 218)		this->visible = true;
HXLINE( 220)		bool _hx_tmp;
HXDLIN( 220)		if ((stage->stageWidth > (int)0)) {
HXLINE( 220)			_hx_tmp = (stage->stageHeight > (int)0);
            		}
            		else {
...
HXLINE( 296)			::haxe::Timer_obj::delay(this->_hx___dispatchCreate_dyn(),(int)1);
            		}
            		else {
HXLINE( 298)			if (!(this->_hx___contextRequested)) {
HXLINE( 300)				this->_hx___contextRequested = true;
HXLINE( 301)				::haxe::Timer_obj::delay(this->_hx___createContext_dyn(),(int)1);
            			}
            		}
            	}
...
HXLINE( 519)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
...
HXLINE( 534)		this->_hx___renderTransform->appendTranslation(this->_hx___x,this->_hx___y,(int)0);
...
void Stage3D_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("__contextLost","\x53","\xd0","\x33","\x6d"));
	...
	outFields->push(HX_HCSTRING("__projectionTransform","\xbd","\x9b","\xb6","\x20"));
...
static hx::StorageInfo Stage3D_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(Stage3D_obj,_hx___contextLost),HX_HCSTRING("__contextLost","\x53","\xd0","\x33","\x6d")},
	{hx::fsBool,(int)offsetof(Stage3D_obj,_hx___contextRequested),HX_HCSTRING("__contextRequested","\x9f","\x10","\x4e","\x81")},
	{hx::fsInt,(int)offsetof(Stage3D_obj,_hx___height),HX_HCSTRING("__height","\x07","\x73","\x7b","\xaa")},
	{hx::fsObject /*::openfl::display3D::IndexBuffer3D*/ ,(int)offsetof(Stage3D_obj,_hx___indexBuffer),HX_HCSTRING("__indexBuffer","\x92","\xa6","\x1e","\x3e")},
	{hx::fsObject /*::openfl::geom::Matrix3D*/ ,(int)offsetof(Stage3D_obj,_hx___projectionTransform),HX_HCSTRING("__projectionTransform","\xbd","\x9b","\xb6","\x20")},
	{hx::fsObject /*::openfl::geom::Matrix3D*/ ,(int)offsetof(Stage3D_obj,_hx___renderTransform),HX_HCSTRING("__renderTransform","\x16","\xb8","\x95","\xb1")},
	{hx::fsObject /*::openfl::display::Stage*/ ,(int)offsetof(Stage3D_obj,_hx___stage),HX_HCSTRING("__stage","\x9e","\xc3","\x69","\xee")},
	{hx::fsObject /*::openfl::display3D::VertexBuffer3D*/ ,(int)offsetof(Stage3D_obj,_hx___vertexBuffer),HX_HCSTRING("__vertexBuffer","\xa4","\x32","\x6a","\x91")},
	{hx::fsInt,(int)offsetof(Stage3D_obj,_hx___width),HX_HCSTRING("__width","\xe6","\x0e","\xc1","\x34")},
...
static ::String Stage3D_obj_sMemberFields[] = {
	...
	HX_HCSTRING("__projectionTransform","\xbd","\x9b","\xb6","\x20"),
	...
	HX_HCSTRING("__lostContext","\x4b","\x19","\xae","\x9a"),
	HX_HCSTRING("__resize","\x14","\xc5","\xaa","\xb0"),
	HX_HCSTRING("__restoreContext","\x61","\x87","\xa1","\x1f"),
