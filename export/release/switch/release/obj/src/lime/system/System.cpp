...
HXLINE( 214)			 ::lime::_hx_system::DisplayMode currentMode =  ::lime::_hx_system::DisplayMode_obj::__alloc( HX_CTX , ::Dynamic(mode1->__Field(HX_("width",06,b6,62,ca),hx::paccDynamic)), ::Dynamic(mode1->__Field(HX_("height",e7,07,4c,02),hx::paccDynamic)), ::Dynamic(mode1->__Field(HX_("refreshRate",5b,e2,3f,40),hx::paccDynamic)), ::Dynamic(mode1->__Field(HX_("pixelFormat",5d,72,1b,6f),hx::paccDynamic)));
HXLINE( 216)			{
HXLINE( 216)				int _g1 = (int)0;
HXDLIN( 216)				::Array< ::Dynamic> _g11 = display->supportedModes;
HXDLIN( 216)				while((_g1 < _g11->length)){
HXLINE( 216)					 ::lime::_hx_system::DisplayMode mode2 = _g11->__get(_g1).StaticCast<  ::lime::_hx_system::DisplayMode >();
...
HXDLIN( 271)		return ::lime::_internal::backend::native::NativeCFFI_obj::lime_system_get_timer();
            	}
...
HXLINE( 310)			::lime::_internal::backend::native::NativeCFFI_obj::lime_system_open_file(path);
            		}
            	}
...
HXLINE( 329)			::lime::_internal::backend::native::NativeCFFI_obj::lime_system_open_url(url,target);
            		}
            	}
...
HXLINE( 352)			return ( (::String)(::lime::_hx_system::System_obj::_hx___directories->get(type)) );
            		}
            		else {
HXLINE( 356)			::String path;
HXLINE( 358)			if ((type == (int)1)) {
...
HXLINE( 367)						company = ( (::String)(::lime::app::Application_obj::current->meta->get(HX_("company",3d,15,69,83))) );
            					}
HXLINE( 370)					if (::lime::app::Application_obj::current->meta->exists(HX_("file",7c,ce,bb,43))) {
HXLINE( 372)						file = ( (::String)(::lime::app::Application_obj::current->meta->get(HX_("file",7c,ce,bb,43))) );
            					}
            				}
...
HXLINE( 397)				_hx_tmp1 = (path.length > (int)0);
            			}
            			else {
...
HXLINE( 436)			int _g = (int)0;
HXDLIN( 436)			while((_g < arguments->length)){
HXLINE( 436)				::String argument = arguments->__get(_g);
HXDLIN( 436)				_g = (_g + (int)1);
HXLINE( 438)				equals = argument.indexOf(HX_("=",3d,00,00,00),null());
HXLINE( 440)				if ((equals > (int)0)) {
HXLINE( 442)					argValue = argument.substr((equals + (int)1),null());
HXLINE( 444)					if (stripQuotes->match(argValue)) {
HXLINE( 446)						argValue = stripQuotes->matched((int)1);
            					}
HXLINE( 449)					if (hx::IsNull( parameters )) {
HXLINE( 449)						parameters =  ::haxe::ds::StringMap_obj::__alloc( HX_CTX );
            					}
HXLINE( 450)					parameters->set(argument.substr((int)0,equals),argValue);
            				}
            			}
            		}
HXLINE( 455)		if (hx::IsNotNull( parameters )) {
HXLINE( 457)			if (hx::IsNull(  ::Dynamic(attributes->__Field(HX_("parameters",aa,be,7e,51),hx::paccDynamic)) )) {
...
HXLINE( 462)					argValue = ( (::String)(parameters->get(parameter1)) );
HXLINE( 464)					if (::StringTools_obj::startsWith(parameter1,windowParamPrefix)) {
HXLINE( 466)						::String _g1 = parameter1.substr(windowParamPrefix.length,null());
HXDLIN( 466)						::String _hx_switch_0 = _g1;
...
HXLINE( 546)			 ::sys::io::Process process =  ::sys::io::Process_obj::__alloc( HX_CTX ,command,args);
...
HXLINE( 579)			::lime::_hx_system::System_obj::_hx___applicationDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)0);
            		}
...
HXLINE( 589)			::lime::_hx_system::System_obj::_hx___applicationStorageDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)1);
            		}
...
HXLINE( 597)		bool _hx_tmp = hx::IsNull( ::lime::_hx_system::System_obj::_hx___deviceModel );
...
HXLINE( 632)		bool _hx_tmp = hx::IsNull( ::lime::_hx_system::System_obj::_hx___deviceVendor );
...
HXLINE( 660)			::lime::_hx_system::System_obj::_hx___desktopDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)2);
            		}
...
HXLINE( 670)			::lime::_hx_system::System_obj::_hx___documentsDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)3);
            		}
...
HXLINE( 683)			 ::haxe::io::Bytes this1 = ::haxe::io::Bytes_obj::alloc((int)2);
HXDLIN( 683)			 ::haxe::io::Bytes arrayBuffer = this1;
HXLINE( 684)			 ::lime::utils::ArrayBufferView this2;
HXDLIN( 684)			if (hx::IsNotNull( arrayBuffer )) {
HXLINE( 684)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 684)				int in_byteOffset = (int)0;
HXDLIN( 684)				if ((in_byteOffset < (int)0)) {
HXLINE( 684)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 684)				if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 684)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
...
HXDLIN( 684)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 684)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 684)					if ((newByteLength < (int)0)) {
HXLINE( 684)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
...
HXLINE( 685)			 ::lime::utils::ArrayBufferView this3;
HXDLIN( 685)			if (hx::IsNotNull( arrayBuffer )) {
HXLINE( 685)				 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)6);
HXDLIN( 685)				int in_byteOffset1 = (int)0;
HXDLIN( 685)				if ((in_byteOffset1 < (int)0)) {
HXLINE( 685)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 685)				if ((hx::Mod(in_byteOffset1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 685)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 685)				int bufferByteLength1 = arrayBuffer->length;
HXDLIN( 685)				int elementSize1 = _this1->bytesPerElement;
HXDLIN( 685)				int newByteLength1 = bufferByteLength1;
HXDLIN( 685)				{
HXLINE( 685)					newByteLength1 = (bufferByteLength1 - in_byteOffset1);
HXDLIN( 685)					if ((hx::Mod(bufferByteLength1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 685)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 685)					if ((newByteLength1 < (int)0)) {
HXLINE( 685)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
HXDLIN( 685)				_this1->buffer = arrayBuffer;
HXDLIN( 685)				_this1->byteOffset = in_byteOffset1;
HXDLIN( 685)				_this1->byteLength = newByteLength1;
HXDLIN( 685)				_this1->length = ::Std_obj::_hx_int(((Float)newByteLength1 / (Float)_this1->bytesPerElement));
HXDLIN( 685)				this3 = _this1;
            			}
            			else {
...
HXLINE( 686)			::__hxcpp_memory_set_byte(uint8Array->buffer->b,uint8Array->byteOffset,(int)170);
HXLINE( 687)			::__hxcpp_memory_set_byte(uint8Array->buffer->b,(uint8Array->byteOffset + (int)1),(int)187);
HXLINE( 688)			if ((((int)::__hxcpp_memory_get_ui16(uint16array->buffer->b,uint16array->byteOffset) & (int)(int)65535) == (int)43707)) {
...
HXLINE( 701)			::lime::_hx_system::System_obj::_hx___fontsDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)4);
            		}
...
HXLINE( 742)		bool _hx_tmp = hx::IsNull( ::lime::_hx_system::System_obj::_hx___platformName );
...
HXLINE( 780)		bool _hx_tmp = hx::IsNull( ::lime::_hx_system::System_obj::_hx___platformVersion );
...
HXLINE( 810)			::lime::_hx_system::System_obj::_hx___userDirectory = ::lime::_hx_system::System_obj::_hx___getDirectory((int)5);
            		}
