...
HXLINE(   9)		this->SAMPLER_2D_SHADOW_EXT = (int)35682;
HXLINE(   8)		this->COMPARE_REF_TO_TEXTURE_EXT = (int)34894;
HXLINE(   7)		this->TEXTURE_COMPARE_FUNC_EXT = (int)34893;
HXLINE(   6)		this->TEXTURE_COMPARE_MODE_EXT = (int)34892;
            	}
