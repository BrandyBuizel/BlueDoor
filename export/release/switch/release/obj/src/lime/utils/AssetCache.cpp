...
HXLINE(  33)		this->version = (int)744689;
            	}
...
HXLINE(  72)			::haxe::IMap_obj::set(this->audio,id,( ( ::lime::media::AudioBuffer)(asset) ));
