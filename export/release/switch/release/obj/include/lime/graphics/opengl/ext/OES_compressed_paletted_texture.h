...
HXLINE(  15)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE8_RGB5_A1_OES = (int)35737;
HXLINE(  14)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE8_RGBA4_OES = (int)35736;
HXLINE(  13)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE8_R5_G6_B5_OES = (int)35735;
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE8_RGBA8_OES = (int)35734;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE8_RGB8_OES = (int)35733;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE4_RGB5_A1_OES = (int)35732;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE4_RGBA4_OES = (int)35731;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE4_R5_G6_B5_OES = (int)35730;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE4_RGBA8_OES = (int)35729;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_compressed_paletted_texture)(__this) )->PALETTE4_RGB8_OES = (int)35728;
            	}
