...
class HXCPP_CLASS_ATTRIBUTES StackBlur_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< StackBlur_obj > __new() {
			hx::ObjectPtr< StackBlur_obj > __this = new StackBlur_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< StackBlur_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("StackBlur","\xef","\xf9","\xe9","\x6d"); }
