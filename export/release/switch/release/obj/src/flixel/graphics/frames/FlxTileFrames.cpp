...
HXLINE(  42)		this->numCols = (int)0;
HXLINE(  40)		this->numRows = (int)0;
...
HXDLIN(  54)		::Array< ::Dynamic> _hx_tmp = this->frames;
HXDLIN(  54)		return _hx_tmp->__get(((row * this->numCols) + column)).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            	}
...
HXLINE( 500)			Float Width = this->parent->width;
HXDLIN( 500)			Float Height = this->parent->height;
HXDLIN( 500)			 ::flixel::math::FlxRect _this = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 500)			_this->x = (int)0;
HXDLIN( 500)			_this->y = (int)0;
...
HXLINE( 503)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 506)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 506)			point2->_inPool = false;
HXDLIN( 506)			 ::flixel::math::FlxPoint point3 = point2;
...
HXLINE( 510)			 ::flixel::math::FlxPoint _this2 = this->tileSize;
...
HXLINE( 511)			 ::flixel::math::FlxPoint _this3 = this->tileSpacing;
...
HXLINE( 512)			 ::flixel::math::FlxPoint _this4 = this->border;
...
HXLINE( 517)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 517)		point->_inPool = false;
HXDLIN( 517)		 ::flixel::math::FlxPoint resultBorder = point->addPoint(this->border)->addPoint(border);
HXLINE( 518)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 518)		Float Y = ((int)2 * border->y);
HXDLIN( 518)		{
HXLINE( 518)			 ::flixel::math::FlxPoint _g = _this1;
HXDLIN( 518)			_g->set_x((_g->x - ((int)2 * border->x)));
            		}
HXDLIN( 518)		{
...
HXDLIN( 527)		_this2->x = (int)0;
HXDLIN( 527)		_this2->y = (int)0;
HXDLIN( 527)		_this2->width = (int)0;
HXDLIN( 527)		_this2->height = (int)0;
...
HXLINE( 530)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 532)		{
HXLINE( 532)			int _g2 = (int)0;
HXDLIN( 532)			::Array< ::Dynamic> _g11 = this->frames;
HXDLIN( 532)			while((_g2 < _g11->length)){
HXLINE( 532)				 ::flixel::graphics::frames::FlxFrame frame = _g11->__get(_g2).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 532)				_g2 = (_g2 + (int)1);
...
HXLINE(  78)		 ::flixel::graphics::FlxGraphic result = ( ( ::flixel::graphics::FlxGraphic)(::haxe::IMap_obj::get(::flixel::FlxG_obj::bitmap->_cache,key)) );
...
HXLINE(  85)		int borderX = (int)0;
HXLINE(  86)		int borderY = (int)0;
...
HXLINE(  94)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN(  94)			_g->set_x((_g1 + ((int)2 * borderX)));
            		}
HXDLIN(  94)		{
HXLINE(  94)			 ::flixel::math::FlxPoint _g2 = _this;
HXDLIN(  94)			Float _g3 = _g2->y;
HXDLIN(  94)			_g2->set_y((_g3 + ((int)2 * borderY)));
            		}
...
HXLINE( 139)		if (hx::IsNotNull( tileSpacing )) {
HXLINE( 139)			tileSpacing = tileSpacing;
            		}
            		else {
HXLINE( 139)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 147)		{
HXLINE( 147)			tileSpacing->set_x(::Math_obj::floor(tileSpacing->x));
HXDLIN( 147)			tileSpacing->set_y(::Math_obj::floor(tileSpacing->y));
            		}
HXLINE( 148)		{
HXLINE( 148)			tileSize->set_x(::Math_obj::floor(tileSize->x));
HXDLIN( 148)			tileSize->set_y(::Math_obj::floor(tileSize->y));
            		}
...
HXDLIN( 153)		if ((tileSize->y == (int)0)) {
HXLINE( 153)			numRows = (int)1;
            		}
            		else {
HXLINE( 153)			numRows = ::Std_obj::_hx_int(((Float)(frame->sourceSize->y + tileSpacing->y) / (Float)spacedHeight));
            		}
HXLINE( 154)		int numCols;
HXDLIN( 154)		if ((tileSize->x == (int)0)) {
HXLINE( 154)			numCols = (int)1;
            		}
            		else {
HXLINE( 154)			numCols = ::Std_obj::_hx_int(((Float)(frame->sourceSize->x + tileSpacing->x) / (Float)spacedWidth));
            		}
...
HXDLIN( 156)		_this->x = (int)0;
HXDLIN( 156)		_this->y = (int)0;
...
HXDLIN( 158)			int _g = numRows;
HXDLIN( 158)			while((_g1 < _g)){
HXLINE( 158)				_g1 = (_g1 + (int)1);
HXDLIN( 158)				int j = (_g1 - (int)1);
HXLINE( 160)				{
HXLINE( 160)					int _g3 = (int)0;
HXDLIN( 160)					int _g2 = numCols;
HXDLIN( 160)					while((_g3 < _g2)){
HXLINE( 160)						_g3 = (_g3 + (int)1);
HXDLIN( 160)						int i = (_g3 - (int)1);
HXLINE( 162)						helperRect->x = (spacedWidth * i);
HXLINE( 163)						helperRect->y = (spacedHeight * j);
...
HXLINE( 185)		 ::flixel::graphics::frames::FlxFrame firstFrame = Frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
...
HXLINE( 201)		 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 201)		point1->_inPool = false;
HXDLIN( 201)		 ::flixel::math::FlxPoint _this1 = point1;
HXDLIN( 201)		 ::flixel::math::FlxPoint point2 = firstFrame->sourceSize;
HXDLIN( 201)		_this1->set_x(point2->x);
HXDLIN( 201)		_this1->set_y(point2->y);
HXDLIN( 201)		if (point2->_weak) {
HXLINE( 201)			point2->put();
            		}
HXDLIN( 201)		tileFrames->tileSize = _this1;
HXLINE( 202)		 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 202)		point3->_inPool = false;
HXDLIN( 202)		tileFrames->tileSpacing = point3;
HXLINE( 203)		tileFrames->numCols = Frames->length;
HXLINE( 204)		tileFrames->numRows = (int)1;
HXLINE( 206)		{
...
HXLINE( 211)					tileFrames->framesHash->set(frame1->name,frame1);
            				}
            			}
            		}
...
HXLINE( 236)		if ((framesToAdd->length > (int)0)) {
HXLINE( 238)			::String name = framesToAdd->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->name;
HXLINE( 239)			int postIndex = name.indexOf(HX_(".",2e,00,00,00),Prefix.length);
HXLINE( 240)			int postFix;
HXDLIN( 240)			if ((postIndex == (int)-1)) {
...
HXLINE( 386)		int totalArea = (int)0;
HXLINE( 387)		int rows = (int)0;
HXLINE( 388)		int cols = (int)0;
HXLINE( 390)		int tileWidth = ::Std_obj::_hx_int(tileframes->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->x);
HXLINE( 391)		int tileHeight = ::Std_obj::_hx_int(tileframes->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxTileFrames >()->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >()->sourceSize->y);
HXLINE( 393)		int spaceX = (int)0;
HXLINE( 394)		int spaceY = (int)0;
HXLINE( 396)		if (hx::IsNotNull( spacing )) {
HXLINE( 398)			spaceX = ::Std_obj::_hx_int(spacing->x);
HXLINE( 399)			spaceY = ::Std_obj::_hx_int(spacing->y);
            		}
HXLINE( 402)		int borderX = (int)0;
HXLINE( 403)		int borderY = (int)0;
...
HXLINE( 415)				totalArea = (totalArea + ::Std_obj::_hx_int((((cols * (tileWidth + ((int)2 * borderX))) * rows) * (tileHeight + ((int)2 * borderY)))));
            			}
            		}
HXLINE( 418)		Float side = ::Math_obj::sqrt(totalArea);
HXLINE( 419)		cols = ::Std_obj::_hx_int(((Float)side / (Float)(tileWidth + ((int)2 * borderX))));
HXLINE( 420)		rows = ::Math_obj::ceil(((Float)totalArea / (Float)((cols * (tileWidth + ((int)2 * borderX))) * (tileHeight + ((int)2 * borderY)))));
HXLINE( 421)		int width = ::Std_obj::_hx_int((cols * (tileWidth + ((int)2 * borderX))));
HXDLIN( 421)		int width1 = (width + ((cols - (int)1) * spaceX));
HXLINE( 422)		int height = ::Std_obj::_hx_int((rows * (tileHeight + ((int)2 * borderY))));
HXDLIN( 422)		int height1 = (height + ((rows - (int)1) * spaceY));
HXLINE( 425)		 ::openfl::display::BitmapData combined =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width1,height1,true,(int)0);
...
HXDLIN( 430)		_this->width = width1;
HXDLIN( 430)		_this->height = height1;
...
HXDLIN( 437)				_g1 = (_g1 + (int)1);
HXLINE( 439)				{
HXLINE( 439)					int _g11 = (int)0;
HXDLIN( 439)					::Array< ::Dynamic> _g2 = collection1->frames;
HXDLIN( 439)					while((_g11 < _g2->length)){
HXLINE( 439)						 ::flixel::graphics::frames::FlxFrame frame = _g2->__get(_g11).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
HXDLIN( 439)						_g11 = (_g11 + (int)1);
HXLINE( 441)						frame->paint(combined,destPoint,true,null());
HXLINE( 443)						Float X = destPoint->x;
HXDLIN( 443)						Float Y = destPoint->y;
HXDLIN( 443)						 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 443)						_this1->x = X;
HXDLIN( 443)						_this1->y = Y;
HXDLIN( 443)						_this1->width = tileWidth;
HXDLIN( 443)						_this1->height = tileHeight;
HXDLIN( 443)						 ::flixel::math::FlxRect rect1 = _this1;
HXDLIN( 443)						rect1->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxRect _hx_tmp = rect1;
HXDLIN( 443)						 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set(tileWidth,tileHeight);
HXDLIN( 443)						point2->_inPool = false;
HXDLIN( 443)						 ::flixel::math::FlxPoint _hx_tmp1 = point2;
HXDLIN( 443)						 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN( 443)						point3->_inPool = false;
HXDLIN( 443)						result->addAtlasFrame(_hx_tmp,_hx_tmp1,point3,null(),null(),null(),null());
HXLINE( 444)						 ::openfl::geom::Point destPoint1 = destPoint;
HXDLIN( 444)						destPoint1->x = (destPoint1->x + ((tileWidth + ((int)2 * borderX)) + spaceX));
HXLINE( 446)						if ((destPoint->x >= combined->width)) {
HXLINE( 448)							destPoint->x = borderX;
HXLINE( 449)							 ::openfl::geom::Point destPoint2 = destPoint;
HXDLIN( 449)							destPoint2->y = (destPoint2->y + ((tileHeight + ((int)2 * borderY)) + spaceY));
            						}
            					}
            				}
            			}
...
HXDLIN( 473)		::cpp::VirtualArray collections = ( (::cpp::VirtualArray)(::haxe::IMap_obj::get(graphic->frameCollections,type)) );
HXDLIN( 473)		if (hx::IsNull( collections )) {
HXLINE( 473)			collections = ::Array_obj< ::Dynamic>::__new();
HXDLIN( 473)			::haxe::IMap_obj::set(graphic->frameCollections,type,collections);
            		}
