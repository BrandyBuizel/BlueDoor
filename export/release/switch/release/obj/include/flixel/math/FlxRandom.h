...
class HXCPP_CLASS_ATTRIBUTES FlxRandom_obj : public hx::Object
{
	...
	public:
		...
		static int MODULUS;
		static int _stateSeed;
		static int _recordingSeed;
		static int updateStateSeed();
		static ::Dynamic updateStateSeed_dyn();

		static int updateRecordingSeed(hx::Null< bool >  StandardMode);
		static ::Dynamic updateRecordingSeed_dyn();

		static int getRecordingSeed();
		static ::Dynamic getRecordingSeed_dyn();
