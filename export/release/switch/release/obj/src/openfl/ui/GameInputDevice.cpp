...
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_97_getCachedSamples,"openfl.ui.GameInputDevice","getCachedSamples",0x0422a56d,"openfl.ui.GameInputDevice.getCachedSamples","openfl/ui/GameInputDevice.hx",97,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_106_getControlAt,"openfl.ui.GameInputDevice","getControlAt",0xc65be2d6,"openfl.ui.GameInputDevice.getControlAt","openfl/ui/GameInputDevice.hx",106,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_120_startCachingSamples,"openfl.ui.GameInputDevice","startCachingSamples",0xf3794db0,"openfl.ui.GameInputDevice.startCachingSamples","openfl/ui/GameInputDevice.hx",120,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_125_stopCachingSamples,"openfl.ui.GameInputDevice","stopCachingSamples",0xbbb05408,"openfl.ui.GameInputDevice.stopCachingSamples","openfl/ui/GameInputDevice.hx",125,0x744a6f4c)
HX_LOCAL_STACK_FRAME(_hx_pos_fafdee3291969395_130_get_numControls,"openfl.ui.GameInputDevice","get_numControls",0x2a978757,"openfl.ui.GameInputDevice.get_numControls","openfl/ui/GameInputDevice.hx",130,0x744a6f4c)
...
void GameInputDevice_obj::__construct(::String id,::String name,int npadId){
            	HX_GC_STACKFRAME(&_hx_pos_fafdee3291969395_14_new)
HXLINE(  51)		this->_hx___controls = ::Array_obj< ::Dynamic>::__new();
HXLINE(  50)		this->_hx___button =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  49)		this->_hx___axis =  ::haxe::ds::IntMap_obj::__alloc( HX_CTX );
HXLINE(  68)		this->id = id;
HXLINE(  69)		this->name = name;
HXLINE(  70)		this->npadID = npadId;
HXLINE(  72)		 ::openfl::ui::GameInputControl control;
HXLINE(  74)		{
HXLINE(  74)			int _g = (int)0;
HXDLIN(  74)			while((_g < (int)6)){
HXLINE(  74)				_g = (_g + (int)1);
HXDLIN(  74)				int i = (_g - (int)1);
HXLINE(  76)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("AXIS_",9e,28,6e,a7) + i),(int)-1,(int)1,null());
HXLINE(  77)				this->_hx___axis->set(i,control);
HXLINE(  78)				this->_hx___controls->push(control);
            			}
            		}
HXLINE(  81)		{
HXLINE(  81)			int _g1 = (int)0;
HXDLIN(  81)			while((_g1 < (int)15)){
HXLINE(  81)				_g1 = (_g1 + (int)1);
HXDLIN(  81)				int i1 = (_g1 - (int)1);
HXLINE(  83)				control =  ::openfl::ui::GameInputControl_obj::__alloc( HX_CTX ,hx::ObjectPtr<OBJ_>(this),(HX_("BUTTON_",2d,26,49,4a) + i1),(int)0,(int)1,null());
HXLINE(  84)				this->_hx___button->set(i1,control);
HXLINE(  85)				this->_hx___controls->push(control);
            			}
            		}
            	}
...
bool append = __o_append.Default(false);
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_97_getCachedSamples)
...
HX_DEFINE_DYNAMIC_FUNC2(GameInputDevice_obj,getCachedSamples,return )
 ...
 ::openfl::ui::GameInputControl GameInputDevice_obj::getControlAt(int i){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_106_getControlAt)
HXLINE( 107)		bool _hx_tmp;
HXDLIN( 107)		if ((i >= (int)0)) {
HXLINE( 107)			_hx_tmp = (i < this->_hx___controls->length);
            		}
            		else {
HXLINE( 107)			_hx_tmp = false;
            		}
HXDLIN( 107)		if (_hx_tmp) {
HXLINE( 109)			return this->_hx___controls->__get(i).StaticCast<  ::openfl::ui::GameInputControl >();
            		}
...
void GameInputDevice_obj::startCachingSamples(int numSamples, ::openfl::_Vector::ObjectVector controls){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_120_startCachingSamples)
            	}
...
void GameInputDevice_obj::stopCachingSamples(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_125_stopCachingSamples)
            	}
...
int GameInputDevice_obj::get_numControls(){
            	HX_STACKFRAME(&_hx_pos_fafdee3291969395_130_get_numControls)
HXDLIN( 130)		return this->_hx___controls->length;
            	}
...
hx::ObjectPtr< GameInputDevice_obj > GameInputDevice_obj::__new(::String id,::String name,int npadId) {
	hx::ObjectPtr< GameInputDevice_obj > __this = new GameInputDevice_obj();
	__this->__construct(id,name,npadId);
	return __this;
}

hx::ObjectPtr< GameInputDevice_obj > GameInputDevice_obj::__alloc(hx::Ctx *_hx_ctx,::String id,::String name,int npadId) {
...
void GameInputDevice_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(npadID,"npadID");
...
void GameInputDevice_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(npadID,"npadID");
...
hx::Val GameInputDevice_obj::__Field(const ::String &inName,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"npadID") ) { return hx::Val( npadID ); }
...
hx::Val GameInputDevice_obj::__SetField(const ::String &inName,const hx::Val &inValue,hx::PropertyAccess inCallProp)
{
	...
	case 4:
		...
		break;
	case 6:
		if (HX_FIELD_EQ(inName,"npadID") ) { npadID=inValue.Cast< int >(); return inValue; }
...
void GameInputDevice_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("npadID","\xc0","\x7c","\x8c","\xb8"));
...
static hx::StorageInfo GameInputDevice_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GameInputDevice_obj,npadID),HX_HCSTRING("npadID","\xc0","\x7c","\x8c","\xb8")},
...
static ::String GameInputDevice_obj_sMemberFields[] = {
	...
	HX_HCSTRING("npadID","\xc0","\x7c","\x8c","\xb8"),
...
HXDLIN(  21)		MAX_BUFFER_SIZE = (int)32000;
            	}
}
