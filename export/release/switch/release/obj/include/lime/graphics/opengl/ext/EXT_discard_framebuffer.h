...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_discard_framebuffer)(__this) )->STENCIL_EXT = (int)6146;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_discard_framebuffer)(__this) )->DEPTH_EXT = (int)6145;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_discard_framebuffer)(__this) )->COLOR_EXT = (int)6144;
            	}
