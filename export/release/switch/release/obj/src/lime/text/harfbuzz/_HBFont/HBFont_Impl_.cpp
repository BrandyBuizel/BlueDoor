...
HXLINE( 156)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN( 156)		int _hx_tmp1 = ::Std_obj::_hx_int(value->x);
HXDLIN( 156)		int _hx_tmp2 = ::Std_obj::_hx_int(value->y);
HXDLIN( 156)		::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_font_set_ppem(hx::DynamicPtr(this1),_hx_tmp1,_hx_tmp2);
...
HXLINE( 173)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN( 173)		int _hx_tmp1 = ::Std_obj::_hx_int(value->x);
HXDLIN( 173)		int _hx_tmp2 = ::Std_obj::_hx_int(value->y);
HXDLIN( 173)		::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_font_set_scale(hx::DynamicPtr(this1),_hx_tmp1,_hx_tmp2);
