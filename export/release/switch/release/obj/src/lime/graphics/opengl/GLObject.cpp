...
HXLINE(2624)		if (hx::IsNotEq( object,hx::DynamicPtr(null()) )) {
...
static hx::StorageInfo GLObject_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Dynamic*/ ,(int)offsetof(GLObject_obj,ptr),HX_HCSTRING("ptr","\xee","\x61","\x55","\x00")},
