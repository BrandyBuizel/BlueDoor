...
bool SwitchJoyconRightMapping_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x5f3facff) {
		...
		return inClassId==(int)0x7a55faf4;
	}
}
...
HXLINE(  37)				return (int)10;
            			...
            			break;
            			case (int)12: {
HXLINE(  38)				return (int)7;
            			}
            			break;
            			case (int)13: {
HXLINE(  39)				return (int)8;
            			}
            			break;
            			case (int)15: {
HXLINE(  40)				return (int)4;
            			}
            			break;
            			case (int)16: {
HXLINE(  41)				return (int)5;
            			}
            			break;
            			default:{
...
HXLINE(  59)				return (int)9;
            			...
            			break;
            			case (int)4: {
HXLINE(  63)				return (int)15;
            			}
            			break;
            			case (int)5: {
HXLINE(  64)				return (int)16;
            			}
            			break;
            			case (int)7: {
HXLINE(  61)				return (int)12;
            			}
            			break;
            			case (int)8: {
HXLINE(  62)				return (int)13;
            			}
            			break;
            			case (int)10: {
HXLINE(  60)				return (int)11;
            			}
            			break;
            			case (int)18: {
...
static void SwitchJoyconRightMapping_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(SwitchJoyconRightMapping_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void SwitchJoyconRightMapping_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(SwitchJoyconRightMapping_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new SwitchJoyconRightMapping_obj;
	SwitchJoyconRightMapping_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("flixel.input.gamepad.mappings.SwitchJoyconRightMapping","\xfa","\x64","\xe4","\x52");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = SwitchJoyconRightMapping_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = SwitchJoyconRightMapping_obj_sVisitStatics;
#endif
