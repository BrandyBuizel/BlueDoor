...
HXLINE( 100)			this->_hx___setBlendMode((int)10);
HXLINE( 102)			this->context->__Field(HX_("setTransform",6a,ed,e2,69),hx::paccDynamic)((int)1,(int)0,(int)0,(int)1,(int)0,(int)0);
HXLINE( 103)			this->context->__SetField(HX_("globalAlpha",fb,fe,d4,f9),(int)1,hx::paccDynamic);
...
HXLINE( 108)				 ::Dynamic _hx_tmp1 =  ::Dynamic(this->context->__Field(HX_("fillRect",47,45,b9,6c),hx::paccDynamic));
HXDLIN( 108)				Float _hx_tmp2 = (this->_hx___stage->stageWidth * this->_hx___stage->window->_hx___scale);
HXDLIN( 108)				_hx_tmp1((int)0,(int)0,_hx_tmp2,(this->_hx___stage->stageHeight * this->_hx___stage->window->_hx___scale));
            			}
            			else {
HXLINE( 110)				bool _hx_tmp3;
HXDLIN( 110)				if (this->_hx___stage->_hx___transparent) {
HXLINE( 110)					_hx_tmp3 = this->_hx___stage->_hx___clearBeforeRender;
            				}
            				else {
HXLINE( 110)					_hx_tmp3 = false;
            				}
HXDLIN( 110)				if (_hx_tmp3) {
HXLINE( 112)					 ::Dynamic _hx_tmp4 =  ::Dynamic(this->context->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic));
HXDLIN( 112)					Float _hx_tmp5 = (this->_hx___stage->stageWidth * this->_hx___stage->window->_hx___scale);
HXDLIN( 112)					_hx_tmp4((int)0,(int)0,_hx_tmp5,(this->_hx___stage->stageHeight * this->_hx___stage->window->_hx___scale));
            				}
            			}
