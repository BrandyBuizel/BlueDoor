...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("BlueDoor",48,71,90,66),::ApplicationMain_obj::create_dyn());
...
HXLINE( 116)			::ApplicationMain_obj::start(a1);
            		}
            		HX_END_LOCAL_FUNC0((void))
...
HXLINE(  35)		app->meta->set(HX_("build",2e,db,ea,ba),HX_("25",c3,2b,00,00));
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Milktoast Games",cd,ee,3b,ba));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("BlueDoor",48,71,90,66));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("Blue Door the Game",0d,63,26,d9));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(hx::Anon_obj::Create(16)
            			...
            			->setFixed(2,HX_("width",06,b6,62,ca),(int)960)
            			->setFixed(3,HX_("fullscreen",3b,3a,b4,f9),true)
            			->setFixed(4,HX_("maximized",18,0e,e1,fe),false)
            			->setFixed(5,HX_("x",78,00,00,00),null())
            			->setFixed(6,HX_("y",79,00,00,00),null())
            			->setFixed(7,HX_("height",e7,07,4c,02),(int)540)
            			->setFixed(8,HX_("element",bc,ae,54,06),null())
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("Blue Door the Game",0d,63,26,d9))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),(int)1184273)
...
HXLINE( 106)		 ::openfl::display::Preloader preloader =  ::openfl::display::Preloader_obj::__alloc( HX_CTX , ::Preloader_obj::__alloc( HX_CTX ,null(),null()));
...
HXLINE( 116)		 ::lime::app::_Event_Void_Void preloader1 = preloader->onComplete;
HXDLIN( 116)		 ::openfl::display::Stage a1 = app->_hx___window->stage;
HXDLIN( 116)		preloader1->add( ::Dynamic(new _hx_Closure_2(a1)),null(),null());
HXLINE( 118)		{
...
HXLINE( 123)		{
HXLINE( 123)			int _g3 = (int)0;
HXDLIN( 123)			::Array< ::String > _g12 = ::ManifestResources_obj::preloadLibraryNames;
HXDLIN( 123)			while((_g3 < _g12->length)){
HXLINE( 123)				::String name = _g12->__get(_g3);
HXDLIN( 123)				_g3 = (_g3 + (int)1);
