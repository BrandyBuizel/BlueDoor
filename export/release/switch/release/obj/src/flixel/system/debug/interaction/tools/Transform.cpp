...
HXLINE(  76)		this->setCursor( ::flixel::_hx_system::debug::interaction::tools::_Transform::GraphicTransformCursorDefault_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
HXLINE(  78)		brain->registerCustomCursor(HX_("transformRotate",e7,c0,75,06), ::flixel::_hx_system::debug::interaction::tools::_Transform::GraphicTransformCursorRotate_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
HXLINE(  79)		brain->registerCustomCursor(HX_("transformScaleX",1a,65,7b,77), ::flixel::_hx_system::debug::interaction::tools::_Transform::GraphicTransformCursorScaleX_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
HXLINE(  80)		brain->registerCustomCursor(HX_("transformScaleY",1b,65,7b,77), ::flixel::_hx_system::debug::interaction::tools::_Transform::GraphicTransformCursorScaleY_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
HXLINE(  81)		brain->registerCustomCursor(HX_("transformScaleXY",ff,11,7d,14), ::flixel::_hx_system::debug::interaction::tools::_Transform::GraphicTransformCursorScaleXY_obj::__alloc( HX_CTX ,(int)0,(int)0,null(),null()));
...
HXDLIN(  86)			while((_g < (int)4)){
HXLINE(  86)				_g = (_g + (int)1);
HXDLIN(  86)				int i = (_g - (int)1);
...
HXDLIN( 100)				_this1->width = (int)0;
HXDLIN( 100)				_this1->height = (int)0;
            			}
            		}
            		else {
HXLINE( 104)			{
...
HXLINE( 120)		 ::flixel::math::FlxPoint _hx_tmp = this->_actionStartPoint;
HXDLIN( 120)		Float _hx_tmp1 = (this->_brain->flixelPointer->x - ::flixel::FlxG_obj::camera->scroll->x);
HXDLIN( 120)		_hx_tmp->set(_hx_tmp1,(this->_brain->flixelPointer->y - ::flixel::FlxG_obj::camera->scroll->y));
...
HXLINE( 293)		gfx->lineStyle(((Float)0.9),(int)-65281,((Float)1.0),false,(int)2,(int)2,null(),null());
...
HXLINE( 304)		gfx->lineStyle(((Float)0.9),(int)-65281,((Float)1.0),false,(int)2,(int)2,null(),null());
