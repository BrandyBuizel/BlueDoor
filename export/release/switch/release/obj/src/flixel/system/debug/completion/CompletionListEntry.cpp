...
bool CompletionListEntry_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x19c29573) {
		...
		if (inClassId<=(int)0x3ac19654) {
			return inClassId==(int)0x1b123bf8 || inClassId==(int)0x3ac19654;
		} else {
...
HXLINE(  43)			::flixel::_hx_system::debug::completion::CompletionListEntry_obj::normalBitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)150,(int)20,true,(int)-10526881);
            		}
HXLINE(  44)		if (hx::IsNull( ::flixel::_hx_system::debug::completion::CompletionListEntry_obj::highlightBitmapData )) {
HXLINE(  45)			::flixel::_hx_system::debug::completion::CompletionListEntry_obj::highlightBitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)150,(int)20,true,(int)-9605779);
            		}
            	}
...
HXLINE(  54)			this->label->set_autoSize((int)2);
            		}
            	}
...
static hx::StorageInfo CompletionListEntry_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::Bitmap*/ ,(int)offsetof(CompletionListEntry_obj,background),HX_HCSTRING("background","\xee","\x93","\x1d","\x26")},
	{hx::fsObject /*::openfl::text::TextField*/ ,(int)offsetof(CompletionListEntry_obj,label),HX_HCSTRING("label","\xf4","\x0d","\xaf","\x6f")},
	{ hx::fsUnknown, 0, null()}
};
static hx::StaticInfo CompletionListEntry_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(void *) &CompletionListEntry_obj::normalBitmapData,HX_HCSTRING("normalBitmapData","\xc0","\x02","\xc0","\x05")},
	{hx::fsObject /*::openfl::display::BitmapData*/ ,(void *) &CompletionListEntry_obj::highlightBitmapData,HX_HCSTRING("highlightBitmapData","\x0d","\x59","\xa7","\x3c")},
	{ hx::fsUnknown, 0, null()}
};
#endif
