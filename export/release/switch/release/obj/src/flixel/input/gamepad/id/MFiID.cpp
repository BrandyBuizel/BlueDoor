...
HXDLIN(  32)		RIGHT_ANALOG_STICK =  ::flixel::input::gamepad::FlxGamepadAnalogStick_obj::__alloc( HX_CTX ,(int)2,(int)3, ::Dynamic(hx::Anon_obj::Create(4)
...
HXDLIN(  39)		LEFT_TRIGGER = (int)4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_4baac3ac28c90643_40_boot)
HXDLIN(  40)		RIGHT_TRIGGER = (int)5;
            	}
}
