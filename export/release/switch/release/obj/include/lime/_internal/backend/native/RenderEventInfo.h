...
class HXCPP_CLASS_ATTRIBUTES RenderEventInfo_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< RenderEventInfo_obj > __new( ::Dynamic type) {
			hx::ObjectPtr< RenderEventInfo_obj > __this = new RenderEventInfo_obj();
			__this->__construct(type);
			return __this;
		}

		static hx::ObjectPtr< RenderEventInfo_obj > __alloc(hx::Ctx *_hx_ctx, ::Dynamic type) {
...
HXDLIN( 807)		( ( ::lime::_internal::backend::native::RenderEventInfo)(__this) )->type = type;
            	}
