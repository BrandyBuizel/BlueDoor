...
HX_DEFINE_STACK_FRAME(_hx_pos_12cc29ec0040cf38_53_new,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","new",0x52c31055,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.new","lime/_internal/macros/AssetsMacro.hx",53,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_7548fa0b825b2df0_1_boot,"__ASSET__flixel_flixel_ui_xml_default_popup_xml","boot",0x10043a9d,"__ASSET__flixel_flixel_ui_xml_default_popup_xml.boot","?",1,0x0000003f)

void __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_12cc29ec0040cf38_53_new)
HXLINE(  54)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(::__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::resourceName);
...
bool __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x035f4237) {
		return inClassId==(int)0x00000001 || inClassId==(int)0x035f4237;
	} else {
...
static hx::StaticInfo __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj_sStaticStorageInfo[] = {
	{hx::fsString,(void *) &__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::resourceName,HX_HCSTRING("resourceName","\x39","\x7a","\x62","\x90")},
	{ hx::fsUnknown, 0, null()}
};
#endif

static void __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__mClass,"__mClass");
...
static void __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::__mClass,"__mClass");
...
{
	hx::Object *dummy = new __ASSET__flixel_flixel_ui_xml_default_popup_xml_obj;
	__ASSET__flixel_flixel_ui_xml_default_popup_xml_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("__ASSET__flixel_flixel_ui_xml_default_popup_xml","\xe3","\x41","\xdd","\xc1");
...
{
{
            	HX_STACKFRAME(&_hx_pos_7548fa0b825b2df0_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:file___ASSET__flixel_flixel_ui_xml_default_popup_xml",4a,b4,43,80);
            	}
}
