...
HXLINE( 955)		 ::lime::utils::BytePointerData this1 =  ::lime::utils::BytePointerData_obj::__alloc( HX_CTX ,null(),(int)0);
...
HXLINE( 968)		int index = (this->regIndex * (int)4);
HXLINE( 969)		{
HXLINE( 969)			int _g = this->type;
HXDLIN( 969)			switch((int)(_g)){
            				case (int)35664: {
HXLINE( 994)					int location = this->location;
HXDLIN( 994)					int count = this->regCount;
HXDLIN( 994)					int size = (this->regCount * (int)2);
HXDLIN( 994)					 ::lime::utils::BytePointerData v = this->regDataPointer;
HXDLIN( 994)					 ::lime::utils::ArrayBufferView v1 = this->regData;
HXDLIN( 994)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v,null(),v1,null(),(index * (int)4));
...
HXDLIN( 996)					int size1 = (this->regCount * (int)3);
HXDLIN( 996)					 ::lime::utils::BytePointerData v2 = this->regDataPointer;
HXDLIN( 996)					 ::lime::utils::ArrayBufferView v3 = this->regData;
HXDLIN( 996)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v2,null(),v3,null(),(index * (int)4));
...
HXDLIN( 998)					int size2 = (this->regCount * (int)4);
HXDLIN( 998)					 ::lime::utils::BytePointerData v4 = this->regDataPointer;
HXDLIN( 998)					 ::lime::utils::ArrayBufferView v5 = this->regData;
HXDLIN( 998)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v4,null(),v5,null(),(index * (int)4));
...
HXDLIN( 988)					int size3 = ((this->size * (int)2) * (int)2);
HXDLIN( 988)					 ::lime::utils::BytePointerData v6 = this->regDataPointer;
HXDLIN( 988)					 ::lime::utils::ArrayBufferView v7 = this->regData;
HXDLIN( 988)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v6,null(),v7,null(),(index * (int)4));
...
HXDLIN( 990)					int size4 = ((this->size * (int)3) * (int)3);
HXDLIN( 990)					 ::lime::utils::BytePointerData v8 = this->regDataPointer;
HXDLIN( 990)					 ::lime::utils::ArrayBufferView v9 = this->regData;
HXDLIN( 990)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v8,null(),v9,null(),(index * (int)4));
...
HXDLIN( 992)					int size5 = ((this->size * (int)4) * (int)4);
HXDLIN( 992)					 ::lime::utils::BytePointerData v10 = this->regDataPointer;
HXDLIN( 992)					 ::lime::utils::ArrayBufferView v11 = this->regData;
HXDLIN( 992)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v10,null(),v11,null(),(index * (int)4));
...
HXDLIN(1000)					int size6 = (this->regCount * (int)4);
HXDLIN(1000)					 ::lime::utils::BytePointerData v12 = this->regDataPointer;
HXDLIN(1000)					 ::lime::utils::ArrayBufferView v13 = this->regData;
HXDLIN(1000)					::lime::utils::_BytePointer::BytePointer_Impl__obj::set(v12,null(),v13,null(),(index * (int)4));
...
HXLINE(1014)		 ::lime::utils::BytePointerData _hx_tmp = this->regDataPointer;
HXDLIN(1014)		 ::lime::utils::ArrayBufferView _hx_tmp1 = this->regData;
HXDLIN(1014)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(_hx_tmp,null(),_hx_tmp1,null(),(index * (int)4));
