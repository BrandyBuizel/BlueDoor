...
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_273_unload,"openfl._internal.formats.swf.SWFLiteLibrary","unload",0x0a96a7b4,"openfl._internal.formats.swf.SWFLiteLibrary.unload","openfl/_internal/formats/swf/SWFLiteLibrary.hx",273,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_296___copyChannel,"openfl._internal.formats.swf.SWFLiteLibrary","__copyChannel",0x7aec2859,"openfl._internal.formats.swf.SWFLiteLibrary.__copyChannel","openfl/_internal/formats/swf/SWFLiteLibrary.hx",296,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_312___fromManifest,"openfl._internal.formats.swf.SWFLiteLibrary","__fromManifest",0x1d309e0e,"openfl._internal.formats.swf.SWFLiteLibrary.__fromManifest","openfl/_internal/formats/swf/SWFLiteLibrary.hx",312,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_328___load,"openfl._internal.formats.swf.SWFLiteLibrary","__load",0x9bba03fb,"openfl._internal.formats.swf.SWFLiteLibrary.__load","openfl/_internal/formats/swf/SWFLiteLibrary.hx",328,0x8efd6c01)
HX_LOCAL_STACK_FRAME(_hx_pos_34737d8619f6a20d_335___loadImage,"openfl._internal.formats.swf.SWFLiteLibrary","__loadImage",0x60453d60,"openfl._internal.formats.swf.SWFLiteLibrary.__loadImage","openfl/_internal/formats/swf/SWFLiteLibrary.hx",335,0x8efd6c01)
...
HXLINE(  87)			id = ( (::String)(this->imageClassNames->get(id)) );
            		}
...
HXLINE( 201)				path = ( (::String)(this->paths->get(this->id)) );
            			}
            			else {
...
HXLINE( 223)			id = ( (::String)(this->imageClassNames->get(id)) );
            		}
...
HXLINE( 267)		return this->super::loadImage(id);
            	}


void SWFLiteLibrary_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_273_unload)
HXLINE( 274)		if (hx::IsNull( this->swf )) {
HXLINE( 274)			return;
            		}
HXLINE( 276)		bool _hx_tmp;
HXDLIN( 276)		if (::openfl::_internal::formats::swf::SWFLite_obj::instances->exists(this->instanceID)) {
HXLINE( 276)			 ::openfl::_internal::formats::swf::SWFLite _hx_tmp1 = ::openfl::_internal::formats::swf::SWFLite_obj::instances->get(this->instanceID).StaticCast<  ::openfl::_internal::formats::swf::SWFLite >();
HXDLIN( 276)			_hx_tmp = hx::IsEq( _hx_tmp1,this->swf );
            		}
            		else {
HXLINE( 276)			_hx_tmp = false;
            		}
HXDLIN( 276)		if (_hx_tmp) {
HXLINE( 278)			::openfl::_internal::formats::swf::SWFLite_obj::instances->remove(this->instanceID);
            		}
HXLINE( 281)		 ::openfl::_internal::symbols::BitmapSymbol bitmap;
HXLINE( 283)		{
HXLINE( 283)			 ::Dynamic symbol = this->swf->symbols->iterator();
HXDLIN( 283)			while(( (bool)(symbol->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 283)				 ::openfl::_internal::symbols::SWFSymbol symbol1 = ( ( ::openfl::_internal::symbols::SWFSymbol)(symbol->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 285)				if (::Std_obj::is(symbol1,hx::ClassOf< ::openfl::_internal::symbols::BitmapSymbol >())) {
HXLINE( 287)					bitmap = ( ( ::openfl::_internal::symbols::BitmapSymbol)(symbol1) );
HXLINE( 288)					::openfl::utils::IAssetCache_obj::removeBitmapData(::openfl::utils::Assets_obj::cache,bitmap->path);
            				}
            			}
            		}
            	}
...
void SWFLiteLibrary_obj::_hx___copyChannel( ::lime::graphics::Image image, ::lime::graphics::Image alpha){
            	HX_GC_STACKFRAME(&_hx_pos_34737d8619f6a20d_296___copyChannel)
HXLINE( 297)		if (hx::IsNotNull( alpha )) {
HXLINE( 299)			 ::lime::math::Rectangle _hx_tmp = alpha->get_rect();
HXDLIN( 299)			image->copyChannel(alpha,_hx_tmp, ::lime::math::Vector2_obj::__alloc( HX_CTX ,null(),null()),::lime::graphics::ImageChannel_obj::RED_dyn(),::lime::graphics::ImageChannel_obj::ALPHA_dyn());
            		}
HXLINE( 302)		image->buffer->premultiplied = true;
            	}
...
void SWFLiteLibrary_obj::_hx___fromManifest( ::lime::utils::AssetManifest manifest){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_312___fromManifest)
HXLINE( 313)		this->rootPath = manifest->rootPath;
HXLINE( 314)		this->super::_hx___fromManifest(manifest);
HXLINE( 316)		this->bytesTotal = (int)0;
HXLINE( 318)		{
HXLINE( 318)			 ::Dynamic id = this->paths->keys();
HXDLIN( 318)			while(( (bool)(id->__Field(HX_("hasNext",6d,a5,46,18),hx::paccDynamic)()) )){
HXLINE( 318)				::String id1 = ( (::String)(id->__Field(HX_("next",f3,84,02,49),hx::paccDynamic)()) );
HXLINE( 320)				 ::openfl::_internal::formats::swf::SWFLiteLibrary _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 320)				int _hx_tmp1 = _hx_tmp->bytesTotal;
HXDLIN( 320)				_hx_tmp->bytesTotal = (_hx_tmp1 + this->sizes->get(id1));
            			}
            		}
            	}
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___load(){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_328___load)
...
HX_DEFINE_DYNAMIC_FUNC0(SWFLiteLibrary_obj,_hx___load,return )
 ...
 ::lime::app::Future SWFLiteLibrary_obj::_hx___loadImage(::String id){
            	HX_STACKFRAME(&_hx_pos_34737d8619f6a20d_335___loadImage)
