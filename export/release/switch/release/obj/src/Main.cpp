...
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_38_init,"Main","init",0xea732345,"Main.init","Main.hx",38,0x087e5c05)
HX_LOCAL_STACK_FRAME(_hx_pos_e47a9afac0942eb9_47_setupGame,"Main","setupGame",0x7f7688ba,"Main.setupGame","Main.hx",47,0x087e5c05)
...
HXLINE(  17)		this->framerate = (int)60;
HXLINE(  16)		this->zoom = ((Float)-1);
HXLINE(  15)		this->initialState = hx::ClassOf< ::MenuState >();
HXLINE(  14)		this->gameHeight = (int)480;
HXLINE(  13)		this->gameWidth = (int)960;
HXLINE(  28)		super::__construct();
HXLINE(  30)		if (hx::IsNotNull( this->stage )) {
HXLINE(  31)			this->init(null());
            		}
            		else {
HXLINE(  33)			this->addEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null(),null(),null());
            		}
            	}
...
void Main_obj::init( ::openfl::events::Event E){
            	HX_STACKFRAME(&_hx_pos_e47a9afac0942eb9_38_init)
HXLINE(  39)		if (this->hasEventListener(HX_("addedToStage",63,22,55,0c))) {
HXLINE(  40)			this->removeEventListener(HX_("addedToStage",63,22,55,0c),this->init_dyn(),null());
            		}
HXLINE(  43)		this->setupGame();
            	}
...
void Main_obj::setupGame(){
            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_47_setupGame)
HXLINE(  48)		int stageWidth = ::openfl::Lib_obj::get_current()->stage->stageWidth;
HXLINE(  49)		int stageHeight = ::openfl::Lib_obj::get_current()->stage->stageHeight;
HXLINE(  51)		if ((this->zoom == (int)-1)) {
HXLINE(  52)			Float ratioX = ((Float)stageWidth / (Float)this->gameWidth);
HXLINE(  53)			Float ratioY = ((Float)stageHeight / (Float)this->gameHeight);
HXLINE(  54)			this->zoom = ::Math_obj::min(ratioX,ratioY);
HXLINE(  55)			this->gameWidth = ::Math_obj::ceil(((Float)stageWidth / (Float)this->zoom));
HXLINE(  56)			this->gameHeight = ::Math_obj::ceil(((Float)stageHeight / (Float)this->zoom));
            		}
HXLINE(  59)		this->addChild( ::flixel::FlxGame_obj::__alloc( HX_CTX ,this->gameWidth,this->gameHeight,this->initialState,this->zoom,this->framerate,this->framerate,this->skipSplash,this->startFullscreen));
            	}
...
HXDLIN(  23)		 ::openfl::display::MovieClip _hx_tmp = ::openfl::Lib_obj::get_current();
HXDLIN(  23)		_hx_tmp->addChild( ::Main_obj::__alloc( HX_CTX ));
            	}
