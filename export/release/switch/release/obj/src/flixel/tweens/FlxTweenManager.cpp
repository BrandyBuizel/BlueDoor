...
HXLINE(1055)			while((finishedTweens->length > (int)0)){
...
HXDLIN(1102)			if ((index != (int)-1)) {
HXLINE(1102)				array[index] = array->__get((array->length - (int)1)).StaticCast<  ::flixel::tweens::FlxTween >();
...
HXLINE(1121)		this->_tweens->removeRange((int)0,this->_tweens->length);
            	}
...
HXDLIN(1139)			_g = (_g + (int)1);
HXLINE(1140)			bool _hx_tmp;
HXDLIN(1140)			bool _hx_tmp1;
HXDLIN(1140)			if ((((int)tween->type & (int)(int)2) == (int)0)) {
HXLINE(1140)				_hx_tmp1 = (((int)tween->type & (int)(int)4) == (int)0);
            			}
            			else {
