...
class HXCPP_CLASS_ATTRIBUTES SwitchJoyconRightID_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< SwitchJoyconRightID_obj > __new() {
			hx::ObjectPtr< SwitchJoyconRightID_obj > __this = new SwitchJoyconRightID_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< SwitchJoyconRightID_obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("SwitchJoyconRightID","\xf5","\x94","\xde","\xb7"); }
