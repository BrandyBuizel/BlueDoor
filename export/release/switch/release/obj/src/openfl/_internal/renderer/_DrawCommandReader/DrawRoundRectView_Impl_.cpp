...
HXDLIN( 703)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 703)		return this2->__get((this1->fPos + (int)1));
            	}
...
HXDLIN( 710)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 710)		return this2->__get((this1->fPos + (int)2));
            	}
...
HXDLIN( 717)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 717)		return this2->__get((this1->fPos + (int)3));
            	}
...
HXDLIN( 724)		::Array< Float > this2 = this1->buffer->f;
HXDLIN( 724)		return this2->__get((this1->fPos + (int)4));
            	}
