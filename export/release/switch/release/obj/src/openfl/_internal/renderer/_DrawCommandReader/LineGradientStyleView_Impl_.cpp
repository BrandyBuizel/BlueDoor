...
HXDLIN( 847)		::Array< ::Dynamic> this2 = this1->buffer->ii;
HXDLIN( 847)		return this2->__get((this1->iiPos + (int)1)).StaticCast< ::Array< int > >();
            	}
...
HXDLIN( 854)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 854)		return ( ( ::openfl::geom::Matrix)(this2->__get((this1->oPos + (int)1))) );
            	}
...
HXDLIN( 861)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 861)		return this2->__get((this1->oPos + (int)2));
            	}
...
HXDLIN( 868)		::cpp::VirtualArray this2 = this1->buffer->o;
HXDLIN( 868)		return this2->__get((this1->oPos + (int)3));
            	}
