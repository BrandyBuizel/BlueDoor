...
static hx::StorageInfo FrameObject_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_internal::symbols::timeline::FrameObjectType*/ ,(int)offsetof(FrameObject_obj,type),HX_HCSTRING("type","\xba","\xf2","\x08","\x4d")},
...
void FrameObject_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("openfl._internal.symbols.timeline.FrameObject","\xa2","\xc4","\x1c","\xaa");
