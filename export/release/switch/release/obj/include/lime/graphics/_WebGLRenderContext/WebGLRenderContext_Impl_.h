...
class HXCPP_CLASS_ATTRIBUTES WebGLRenderContext_Impl__obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< WebGLRenderContext_Impl__obj > __new() {
			hx::ObjectPtr< WebGLRenderContext_Impl__obj > __this = new WebGLRenderContext_Impl__obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< WebGLRenderContext_Impl__obj > __alloc(hx::Ctx *_hx_ctx) {
		...
		::String __ToString() const { return HX_HCSTRING("WebGLRenderContext_Impl_","\x80","\x12","\x9c","\x4c"); }
