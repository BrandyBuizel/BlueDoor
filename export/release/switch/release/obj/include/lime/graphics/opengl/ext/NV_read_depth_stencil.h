...
class HXCPP_CLASS_ATTRIBUTES NV_read_depth_stencil_obj : public hx::Object
{
	...
	public:
		...
		hx::ObjectPtr< NV_read_depth_stencil_obj > __new() {
			hx::ObjectPtr< NV_read_depth_stencil_obj > __this = new NV_read_depth_stencil_obj();
			__this->__construct();
			return __this;
		}

		static hx::ObjectPtr< NV_read_depth_stencil_obj > __alloc(hx::Ctx *_hx_ctx) {
			...
			*(void **)__this = NV_read_depth_stencil_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_HCSTRING("NV_read_depth_stencil","\x6e","\x76","\x04","\x4b"); }
