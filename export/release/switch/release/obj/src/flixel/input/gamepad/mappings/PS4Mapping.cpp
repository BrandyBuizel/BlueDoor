...
HXLINE(  32)				return (int)1;
            			...
            			break;
            			case (int)8: {
HXLINE(  33)				return (int)2;
            			}
            			break;
            			case (int)9: {
HXLINE(  34)				return (int)3;
            			}
            			break;
            			case (int)10: {
...
HXLINE(  68)				return (int)8;
            			...
            			break;
            			case (int)3: {
HXLINE(  69)				return (int)9;
            			}
            			break;
            			case (int)4: {
HXLINE(  79)				return (int)15;
            			}
            			break;
            			case (int)5: {
HXLINE(  80)				return (int)16;
            			}
            			break;
            			case (int)6: {
HXLINE(  73)				return (int)10;
            			}
            			break;
            			case (int)7: {
HXLINE(  76)				return (int)12;
            			}
            			break;
            			case (int)8: {
HXLINE(  77)				return (int)13;
            			}
            			break;
            			case (int)9: {
HXLINE(  78)				return (int)14;
            			}
            			break;
            			case (int)10: {
HXLINE(  75)				return (int)11;
            			}
            			break;
            			case (int)11: {
HXLINE(  81)				return (int)17;
            			}
            			break;
            			case (int)12: {
HXLINE(  82)				return (int)18;
            			}
            			break;
            			case (int)13: {
HXLINE(  83)				return (int)19;
            			}
            			break;
            			case (int)14: {
HXLINE(  84)				return (int)20;
            			}
            			break;
            			case (int)17: {
