...
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->READ_FRAMEBUFFER_BINDING_APPLE = (int)36010;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->DRAW_FRAMEBUFFER_BINDING_APPLE = (int)36006;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->DRAW_FRAMEBUFFER_APPLE = (int)36009;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->READ_FRAMEBUFFER_APPLE = (int)36008;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->MAX_SAMPLES_APPLE = (int)36183;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->FRAMEBUFFER_INCOMPLETE_MULTISAMPLE_APPLE = (int)36182;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::APPLE_framebuffer_multisample)(__this) )->RENDERBUFFER_SAMPLES_APPLE = (int)36011;
            	}
