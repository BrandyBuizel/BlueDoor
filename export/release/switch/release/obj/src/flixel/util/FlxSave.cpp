...
HXLINE(  82)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXDLIN( 129)		if (hx::IsEq( result,(int)0 )) {
...
HXLINE( 159)		switch((int)(_hx_getEnumValueIndex(Result))){
            			case (int)1: {
HXLINE( 162)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
            			}
            			break;
            			case (int)2: {
HXLINE( 164)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this1 = ::flixel::FlxG_obj::log;
            			}
            			break;
            			default:{
            			}
...
HXLINE( 169)			 ::Dynamic _hx_tmp = this->_onComplete;
HXDLIN( 169)			_hx_tmp(hx::IsEq( Result,::flixel::util::FlxSaveStatus_obj::SUCCESS_dyn() ));
            		}
...
HXLINE( 186)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
