...
HXDLIN( 122)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_this->framesHash,this->key)) );
...
HXDLIN( 143)		 ::flixel::graphics::frames::FlxFrame frame = ( ( ::flixel::graphics::frames::FlxFrame)(::haxe::IMap_obj::get(_this->framesHash,this->key)) );
...
HXLINE( 173)		this->rect->width = value;
...
HXLINE( 184)		this->rect->height = value;
