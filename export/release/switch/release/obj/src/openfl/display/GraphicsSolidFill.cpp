...
HXLINE(  49)		this->_hx___graphicsDataType = (int)1;
HXLINE(  50)		this->_hx___graphicsFillType = (int)0;
            	}
...
static hx::StorageInfo GraphicsSolidFill_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(GraphicsSolidFill_obj,_hx___graphicsDataType),HX_HCSTRING("__graphicsDataType","\x0f","\x5d","\x4d","\x46")},
	{hx::fsInt,(int)offsetof(GraphicsSolidFill_obj,_hx___graphicsFillType),HX_HCSTRING("__graphicsFillType","\xe8","\x75","\xeb","\x27")},
	{ hx::fsUnknown, 0, null()}
};
