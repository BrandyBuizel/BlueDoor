...
HXLINE( 268)		Float _hx_tmp = value->rawData->get((int)0);
HXDLIN( 268)		Float _hx_tmp1 = value->rawData->get((int)1);
HXDLIN( 268)		Float _hx_tmp2 = value->rawData->get((int)5);
HXDLIN( 268)		Float _hx_tmp3 = value->rawData->get((int)6);
HXDLIN( 268)		Float _hx_tmp4 = value->rawData->get((int)12);
HXDLIN( 268)		this->_hx___setTransform(_hx_tmp,_hx_tmp1,_hx_tmp2,_hx_tmp3,_hx_tmp4,value->rawData->get((int)13));
...
HXLINE( 280)			if ((b == (int)0)) {
HXLINE( 282)				scaleX = a;
            			}
            			else {
HXLINE( 286)				scaleX = ::Math_obj::sqrt(((a * a) + (b * b)));
            			}
HXLINE( 289)			if ((c == (int)0)) {
HXLINE( 291)				scaleY = a;
            			}
            			else {
...
HXLINE( 301)			Float rotation = ((Float)(int)180 / (Float)::Math_obj::PI);
HXDLIN( 301)			Float rotation1 = ((rotation * ::Math_obj::atan2(d,c)) - (int)90);
HXLINE( 303)			if ((rotation1 != this->_hx___displayObject->_hx___rotation)) {
HXLINE( 305)				this->_hx___displayObject->_hx___rotation = rotation1;
HXLINE( 306)				Float radians = (rotation1 * ((Float)::Math_obj::PI / (Float)(int)180));
