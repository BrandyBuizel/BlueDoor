...
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_114_stop,"openfl.media.SoundChannel","stop",0x090ae1f4,"openfl.media.SoundChannel.stop","openfl/media/SoundChannel.hx",114,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_126___dispose,"openfl.media.SoundChannel","__dispose",0x8d7f924d,"openfl.media.SoundChannel.__dispose","openfl/media/SoundChannel.hx",126,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_139___updateTransform,"openfl.media.SoundChannel","__updateTransform",0xba5f6dd1,"openfl.media.SoundChannel.__updateTransform","openfl/media/SoundChannel.hx",139,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_144_get_position,"openfl.media.SoundChannel","get_position",0x46d188a4,"openfl.media.SoundChannel.get_position","openfl/media/SoundChannel.hx",144,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_155_set_position,"openfl.media.SoundChannel","set_position",0x5bcaac18,"openfl.media.SoundChannel.set_position","openfl/media/SoundChannel.hx",155,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_166_get_soundTransform,"openfl.media.SoundChannel","get_soundTransform",0xc6e884d8,"openfl.media.SoundChannel.get_soundTransform","openfl/media/SoundChannel.hx",166,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_170_set_soundTransform,"openfl.media.SoundChannel","set_soundTransform",0xa397b74c,"openfl.media.SoundChannel.set_soundTransform","openfl/media/SoundChannel.hx",170,0xa4290000)
HX_LOCAL_STACK_FRAME(_hx_pos_3e0758e1dc9f2fd3_203_source_onComplete,"openfl.media.SoundChannel","source_onComplete",0xb57ef7ea,"openfl.media.SoundChannel.source_onComplete","openfl/media/SoundChannel.hx",203,0xa4290000)
namespace openfl{
namespace media{
...
HXLINE(  82)		this->leftPeak = (int)1;
HXLINE(  83)		this->rightPeak = (int)1;
...
HXLINE( 105)		 ::Dynamic _hx_tmp = ::haxe::Log_obj::trace;
HXDLIN( 105)		::String _hx_tmp1 = (HX_("VALID ",c4,93,30,02) + ::Std_obj::string(this->_hx___isValid));
HXDLIN( 105)		_hx_tmp(_hx_tmp1,hx::SourceInfo(HX_("SoundChannel.hx",6a,2f,ff,28),105,HX_("openfl.media.SoundChannel",bc,b3,ae,75),HX_("new",60,d0,53,00)));
HXLINE( 107)		::openfl::media::SoundMixer_obj::_hx___registerSoundChannel(hx::ObjectPtr<OBJ_>(this));
            	}
...
void SoundChannel_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_114_stop)
HXLINE( 115)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 117)		if (!(this->_hx___isValid)) {
HXLINE( 117)			return;
            		}
HXLINE( 120)		this->_hx___source->stop();
HXLINE( 122)		this->_hx___dispose();
            	}
...
void SoundChannel_obj::_hx___dispose(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_126___dispose)
HXLINE( 127)		if (!(this->_hx___isValid)) {
HXLINE( 127)			return;
            		}
HXLINE( 130)		this->_hx___source->onComplete->remove(this->source_onComplete_dyn());
HXLINE( 131)		this->_hx___source->dispose();
HXLINE( 132)		this->_hx___source = null();
HXLINE( 134)		this->_hx___isValid = false;
            	}
...
void SoundChannel_obj::_hx___updateTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_139___updateTransform)
HXDLIN( 139)		this->set_soundTransform(this->get_soundTransform());
            	}
...
Float SoundChannel_obj::get_position(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_144_get_position)
HXLINE( 145)		if (!(this->_hx___isValid)) {
HXLINE( 145)			return (int)0;
            		}
HXLINE( 148)		int _hx_tmp = this->_hx___source->get_currentTime();
HXDLIN( 148)		return (_hx_tmp + this->_hx___source->offset);
            	}
...
Float SoundChannel_obj::set_position(Float value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_155_set_position)
HXLINE( 156)		if (!(this->_hx___isValid)) {
HXLINE( 156)			return (int)0;
            		}
HXLINE( 159)		 ::lime::media::AudioSource _hx_tmp = this->_hx___source;
HXDLIN( 159)		int _hx_tmp1 = ::Std_obj::_hx_int(value);
HXDLIN( 159)		_hx_tmp->set_currentTime((_hx_tmp1 - this->_hx___source->offset));
...
HX_DEFINE_DYNAMIC_FUNC1(SoundChannel_obj,set_position,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::get_soundTransform(){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_166_get_soundTransform)
HXDLIN( 166)		return this->_hx___soundTransform->clone();
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SoundChannel_obj,get_soundTransform,return )
 ...
 ::openfl::media::SoundTransform SoundChannel_obj::set_soundTransform( ::openfl::media::SoundTransform value){
            	HX_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_170_set_soundTransform)
HXLINE( 171)		if (hx::IsNotNull( value )) {
HXLINE( 173)			this->_hx___soundTransform->pan = value->pan;
HXLINE( 174)			this->_hx___soundTransform->volume = value->volume;
HXLINE( 176)			Float pan = (::openfl::media::SoundMixer_obj::_hx___soundTransform->pan + this->_hx___soundTransform->pan);
HXLINE( 178)			if ((pan < (int)-1)) {
HXLINE( 178)				pan = (int)-1;
            			}
HXLINE( 179)			if ((pan > (int)1)) {
HXLINE( 179)				pan = (int)1;
            			}
HXLINE( 181)			Float volume = (::openfl::media::SoundMixer_obj::_hx___soundTransform->volume * this->_hx___soundTransform->volume);
HXLINE( 183)			if (this->_hx___isValid) {
HXLINE( 186)				this->_hx___source->set_gain(volume);
HXLINE( 188)				 ::lime::math::Vector4 position = this->_hx___source->get_position();
HXLINE( 189)				position->x = pan;
HXLINE( 190)				position->z = ((int)-1 * ::Math_obj::sqrt(((int)1 - ::Math_obj::pow(pan,(int)2))));
HXLINE( 191)				this->_hx___source->set_position(position);
...
void SoundChannel_obj::source_onComplete(){
            	HX_GC_STACKFRAME(&_hx_pos_3e0758e1dc9f2fd3_203_source_onComplete)
HXLINE( 204)		::openfl::media::SoundMixer_obj::_hx___unregisterSoundChannel(hx::ObjectPtr<OBJ_>(this));
HXLINE( 206)		this->_hx___dispose();
HXLINE( 207)		this->dispatchEvent( ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("soundComplete",a8,30,e6,1c),null(),null()));
            	}
