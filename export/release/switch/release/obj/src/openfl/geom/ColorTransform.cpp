...
HX_DEFINE_STACK_FRAME(_hx_pos_82e72dbfef9da50a_165_new,"openfl.geom.ColorTransform","new",0x35d8b8af,"openfl.geom.ColorTransform.new","openfl/geom/ColorTransform.hx",165,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_188_concat,"openfl.geom.ColorTransform","concat",0x6a83fc25,"openfl.geom.ColorTransform.concat","openfl/geom/ColorTransform.hx",188,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_209_toString,"openfl.geom.ColorTransform","toString",0xe65269fd,"openfl.geom.ColorTransform.toString","openfl/geom/ColorTransform.hx",209,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_215___clone,"openfl.geom.ColorTransform","__clone",0x6d82280c,"openfl.geom.ColorTransform.__clone","openfl/geom/ColorTransform.hx",215,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_219___copyFrom,"openfl.geom.ColorTransform","__copyFrom",0x0c92ce70,"openfl.geom.ColorTransform.__copyFrom","openfl/geom/ColorTransform.hx",219,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_232___combine,"openfl.geom.ColorTransform","__combine",0x74bf08ee,"openfl.geom.ColorTransform.__combine","openfl/geom/ColorTransform.hx",232,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_245___identity,"openfl.geom.ColorTransform","__identity",0xfd6107ef,"openfl.geom.ColorTransform.__identity","openfl/geom/ColorTransform.hx",245,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_257___invert,"openfl.geom.ColorTransform","__invert",0xf5ebeb87,"openfl.geom.ColorTransform.__invert","openfl/geom/ColorTransform.hx",257,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_270___equals,"openfl.geom.ColorTransform","__equals",0x1605f2b0,"openfl.geom.ColorTransform.__equals","openfl/geom/ColorTransform.hx",270,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_283___isDefault,"openfl.geom.ColorTransform","__isDefault",0x071aee26,"openfl.geom.ColorTransform.__isDefault","openfl/geom/ColorTransform.hx",283,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_301___setArrays,"openfl.geom.ColorTransform","__setArrays",0x7ef0862b,"openfl.geom.ColorTransform.__setArrays","openfl/geom/ColorTransform.hx",301,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_315_get_color,"openfl.geom.ColorTransform","get_color",0x07485b49,"openfl.geom.ColorTransform.get_color","openfl/geom/ColorTransform.hx",315,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_319_set_color,"openfl.geom.ColorTransform","set_color",0xea994755,"openfl.geom.ColorTransform.set_color","openfl/geom/ColorTransform.hx",319,0x850de941)
HX_LOCAL_STACK_FRAME(_hx_pos_82e72dbfef9da50a_333___toLimeColorMatrix,"openfl.geom.ColorTransform","__toLimeColorMatrix",0x55c98ae3,"openfl.geom.ColorTransform.__toLimeColorMatrix","openfl/geom/ColorTransform.hx",333,0x850de941)
...
Float alphaOffset = __o_alphaOffset.Default(0);
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_165_new)
HXLINE( 166)		this->redMultiplier = redMultiplier;
HXLINE( 167)		this->greenMultiplier = greenMultiplier;
HXLINE( 168)		this->blueMultiplier = blueMultiplier;
HXLINE( 169)		this->alphaMultiplier = alphaMultiplier;
HXLINE( 170)		this->redOffset = redOffset;
HXLINE( 171)		this->greenOffset = greenOffset;
HXLINE( 172)		this->blueOffset = blueOffset;
HXLINE( 173)		this->alphaOffset = alphaOffset;
            	}
...
void ColorTransform_obj::concat( ::openfl::geom::ColorTransform second){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_188_concat)
HXLINE( 189)		this->redOffset = ((second->redOffset * this->redMultiplier) + this->redOffset);
HXLINE( 190)		this->greenOffset = ((second->greenOffset * this->greenMultiplier) + this->greenOffset);
HXLINE( 191)		this->blueOffset = ((second->blueOffset * this->blueMultiplier) + this->blueOffset);
HXLINE( 192)		this->alphaOffset = ((second->alphaOffset * this->alphaMultiplier) + this->alphaOffset);
HXLINE( 194)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 194)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * second->redMultiplier);
HXLINE( 195)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 195)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * second->greenMultiplier);
HXLINE( 196)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 196)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * second->blueMultiplier);
HXLINE( 197)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 197)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * second->alphaMultiplier);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(ColorTransform_obj,toString,return )
 ...
 ::openfl::geom::ColorTransform ColorTransform_obj::_hx___clone(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_215___clone)
HXDLIN( 215)		return  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,this->redMultiplier,this->greenMultiplier,this->blueMultiplier,this->alphaMultiplier,this->redOffset,this->greenOffset,this->blueOffset,this->alphaOffset);
            	}
...
void ColorTransform_obj::_hx___copyFrom( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_219___copyFrom)
HXLINE( 220)		this->redMultiplier = ct->redMultiplier;
HXLINE( 221)		this->greenMultiplier = ct->greenMultiplier;
HXLINE( 222)		this->blueMultiplier = ct->blueMultiplier;
HXLINE( 223)		this->alphaMultiplier = ct->alphaMultiplier;
HXLINE( 225)		this->redOffset = ct->redOffset;
HXLINE( 226)		this->greenOffset = ct->greenOffset;
HXLINE( 227)		this->blueOffset = ct->blueOffset;
HXLINE( 228)		this->alphaOffset = ct->alphaOffset;
            	}
...
void ColorTransform_obj::_hx___combine( ::openfl::geom::ColorTransform ct){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_232___combine)
HXLINE( 233)		 ::openfl::geom::ColorTransform _hx_tmp = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 233)		_hx_tmp->redMultiplier = (_hx_tmp->redMultiplier * ct->redMultiplier);
HXLINE( 234)		 ::openfl::geom::ColorTransform _hx_tmp1 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 234)		_hx_tmp1->greenMultiplier = (_hx_tmp1->greenMultiplier * ct->greenMultiplier);
HXLINE( 235)		 ::openfl::geom::ColorTransform _hx_tmp2 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 235)		_hx_tmp2->blueMultiplier = (_hx_tmp2->blueMultiplier * ct->blueMultiplier);
HXLINE( 236)		 ::openfl::geom::ColorTransform _hx_tmp3 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 236)		_hx_tmp3->alphaMultiplier = (_hx_tmp3->alphaMultiplier * ct->alphaMultiplier);
HXLINE( 238)		 ::openfl::geom::ColorTransform _hx_tmp4 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 238)		_hx_tmp4->redOffset = (_hx_tmp4->redOffset + ct->redOffset);
HXLINE( 239)		 ::openfl::geom::ColorTransform _hx_tmp5 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 239)		_hx_tmp5->greenOffset = (_hx_tmp5->greenOffset + ct->greenOffset);
HXLINE( 240)		 ::openfl::geom::ColorTransform _hx_tmp6 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 240)		_hx_tmp6->blueOffset = (_hx_tmp6->blueOffset + ct->blueOffset);
HXLINE( 241)		 ::openfl::geom::ColorTransform _hx_tmp7 = hx::ObjectPtr<OBJ_>(this);
HXDLIN( 241)		_hx_tmp7->alphaOffset = (_hx_tmp7->alphaOffset + ct->alphaOffset);
            	}
...
void ColorTransform_obj::_hx___identity(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_245___identity)
HXLINE( 246)		this->redMultiplier = (int)1;
HXLINE( 247)		this->greenMultiplier = (int)1;
HXLINE( 248)		this->blueMultiplier = (int)1;
HXLINE( 249)		this->alphaMultiplier = (int)1;
HXLINE( 250)		this->redOffset = (int)0;
HXLINE( 251)		this->greenOffset = (int)0;
HXLINE( 252)		this->blueOffset = (int)0;
HXLINE( 253)		this->alphaOffset = (int)0;
            	}
...
void ColorTransform_obj::_hx___invert(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_257___invert)
HXLINE( 258)		this->redMultiplier = ((Float)(int)1 / (Float)this->redMultiplier);
HXLINE( 259)		this->greenMultiplier = ((Float)(int)1 / (Float)this->greenMultiplier);
HXLINE( 260)		this->blueMultiplier = ((Float)(int)1 / (Float)this->blueMultiplier);
HXLINE( 261)		this->alphaMultiplier = ((Float)(int)1 / (Float)this->alphaMultiplier);
HXLINE( 262)		this->redOffset = -(this->redOffset);
HXLINE( 263)		this->greenOffset = -(this->greenOffset);
HXLINE( 264)		this->blueOffset = -(this->blueOffset);
HXLINE( 265)		this->alphaOffset = -(this->alphaOffset);
            	}
...
bool ColorTransform_obj::_hx___equals( ::openfl::geom::ColorTransform ct,bool ignoreAlphaMultiplier){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_270___equals)
HXDLIN( 270)		bool _hx_tmp;
HXDLIN( 270)		bool _hx_tmp1;
HXDLIN( 270)		bool _hx_tmp2;
HXDLIN( 270)		bool _hx_tmp3;
HXDLIN( 270)		bool _hx_tmp4;
HXDLIN( 270)		bool _hx_tmp5;
HXDLIN( 270)		bool _hx_tmp6;
HXDLIN( 270)		if (hx::IsNotNull( ct )) {
HXDLIN( 270)			_hx_tmp6 = (this->redMultiplier == ct->redMultiplier);
            		}
            		else {
HXDLIN( 270)			_hx_tmp6 = false;
            		}
HXDLIN( 270)		if (_hx_tmp6) {
HXDLIN( 270)			_hx_tmp5 = (this->greenMultiplier == ct->greenMultiplier);
            		}
            		else {
HXDLIN( 270)			_hx_tmp5 = false;
            		}
HXDLIN( 270)		if (_hx_tmp5) {
HXDLIN( 270)			_hx_tmp4 = (this->blueMultiplier == ct->blueMultiplier);
            		}
            		else {
HXDLIN( 270)			_hx_tmp4 = false;
            		}
HXDLIN( 270)		if (_hx_tmp4) {
HXLINE( 274)			if (!(ignoreAlphaMultiplier)) {
HXDLIN( 270)				_hx_tmp3 = (this->alphaMultiplier == ct->alphaMultiplier);
            			}
            			else {
...
HXDLIN( 270)			_hx_tmp2 = (this->redOffset == ct->redOffset);
            		}
            		else {
HXDLIN( 270)			_hx_tmp2 = false;
            		}
HXDLIN( 270)		if (_hx_tmp2) {
HXDLIN( 270)			_hx_tmp1 = (this->greenOffset == ct->greenOffset);
            		}
            		else {
HXDLIN( 270)			_hx_tmp1 = false;
            		}
HXDLIN( 270)		if (_hx_tmp1) {
HXDLIN( 270)			_hx_tmp = (this->blueOffset == ct->blueOffset);
            		}
            		else {
HXDLIN( 270)			_hx_tmp = false;
            		}
HXDLIN( 270)		if (_hx_tmp) {
HXLINE( 278)			return (this->alphaOffset == ct->alphaOffset);
            		}
            		else {
...
bool ColorTransform_obj::_hx___isDefault(bool ignoreAlphaMultiplier){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_283___isDefault)
HXDLIN( 283)		if (ignoreAlphaMultiplier) {
HXLINE( 285)			bool _hx_tmp;
HXDLIN( 285)			bool _hx_tmp1;
HXDLIN( 285)			bool _hx_tmp2;
HXDLIN( 285)			bool _hx_tmp3;
HXDLIN( 285)			bool _hx_tmp4;
HXDLIN( 285)			if ((this->redMultiplier == (int)1)) {
HXLINE( 285)				_hx_tmp4 = (this->greenMultiplier == (int)1);
            			}
            			else {
HXLINE( 285)				_hx_tmp4 = false;
            			}
HXDLIN( 285)			if (_hx_tmp4) {
HXLINE( 285)				_hx_tmp3 = (this->blueMultiplier == (int)1);
            			}
            			else {
HXLINE( 285)				_hx_tmp3 = false;
            			}
HXDLIN( 285)			if (_hx_tmp3) {
HXLINE( 285)				_hx_tmp2 = (this->redOffset == (int)0);
            			}
            			else {
HXLINE( 285)				_hx_tmp2 = false;
            			}
HXDLIN( 285)			if (_hx_tmp2) {
HXLINE( 285)				_hx_tmp1 = (this->greenOffset == (int)0);
            			}
            			else {
HXLINE( 285)				_hx_tmp1 = false;
            			}
HXDLIN( 285)			if (_hx_tmp1) {
HXLINE( 285)				_hx_tmp = (this->blueOffset == (int)0);
            			}
            			else {
HXLINE( 285)				_hx_tmp = false;
            			}
HXDLIN( 285)			if (_hx_tmp) {
HXLINE( 291)				return (this->alphaOffset == (int)0);
            			}
            			else {
...
HXLINE( 295)			bool _hx_tmp5;
HXDLIN( 295)			bool _hx_tmp6;
HXDLIN( 295)			bool _hx_tmp7;
HXDLIN( 295)			bool _hx_tmp8;
HXDLIN( 295)			bool _hx_tmp9;
HXDLIN( 295)			bool _hx_tmp10;
HXDLIN( 295)			if ((this->redMultiplier == (int)1)) {
HXLINE( 295)				_hx_tmp10 = (this->greenMultiplier == (int)1);
            			}
            			else {
HXLINE( 295)				_hx_tmp10 = false;
            			}
HXDLIN( 295)			if (_hx_tmp10) {
HXLINE( 295)				_hx_tmp9 = (this->blueMultiplier == (int)1);
            			}
            			else {
HXLINE( 295)				_hx_tmp9 = false;
            			}
HXDLIN( 295)			if (_hx_tmp9) {
HXLINE( 295)				_hx_tmp8 = (this->alphaMultiplier == (int)1);
            			}
            			else {
HXLINE( 295)				_hx_tmp8 = false;
            			}
HXDLIN( 295)			if (_hx_tmp8) {
HXLINE( 295)				_hx_tmp7 = (this->redOffset == (int)0);
            			}
            			else {
HXLINE( 295)				_hx_tmp7 = false;
            			}
HXDLIN( 295)			if (_hx_tmp7) {
HXLINE( 295)				_hx_tmp6 = (this->greenOffset == (int)0);
            			}
            			else {
HXLINE( 295)				_hx_tmp6 = false;
            			}
HXDLIN( 295)			if (_hx_tmp6) {
HXLINE( 295)				_hx_tmp5 = (this->blueOffset == (int)0);
            			}
            			else {
...
void ColorTransform_obj::_hx___setArrays(::Array< Float > colorMultipliers,::Array< Float > colorOffsets){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_301___setArrays)
HXLINE( 302)		colorMultipliers[(int)0] = this->redMultiplier;
HXLINE( 303)		colorMultipliers[(int)1] = this->greenMultiplier;
HXLINE( 304)		colorMultipliers[(int)2] = this->blueMultiplier;
HXLINE( 305)		colorMultipliers[(int)3] = this->alphaMultiplier;
HXLINE( 306)		colorOffsets[(int)0] = this->redOffset;
HXLINE( 307)		colorOffsets[(int)1] = this->greenOffset;
HXLINE( 308)		colorOffsets[(int)2] = this->blueOffset;
HXLINE( 309)		colorOffsets[(int)3] = this->alphaOffset;
            	}
...
int ColorTransform_obj::get_color(){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_315_get_color)
HXDLIN( 315)		int _hx_tmp = ((int)::Std_obj::_hx_int(this->redOffset) << (int)(int)16);
HXDLIN( 315)		int _hx_tmp1 = ((int)_hx_tmp | (int)((int)::Std_obj::_hx_int(this->greenOffset) << (int)(int)8));
HXDLIN( 315)		return ((int)_hx_tmp1 | (int)::Std_obj::_hx_int(this->blueOffset));
            	}
...
int ColorTransform_obj::set_color(int value){
            	HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_319_set_color)
HXLINE( 320)		this->redOffset = ((int)((int)value >> (int)(int)16) & (int)(int)255);
HXLINE( 321)		this->greenOffset = ((int)((int)value >> (int)(int)8) & (int)(int)255);
HXLINE( 322)		this->blueOffset = ((int)value & (int)(int)255);
HXLINE( 324)		this->redMultiplier = (int)0;
HXLINE( 325)		this->greenMultiplier = (int)0;
HXLINE( 326)		this->blueMultiplier = (int)0;
HXLINE( 328)		return this->get_color();
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(ColorTransform_obj,set_color,return )
 ...
 ::lime::utils::ArrayBufferView ColorTransform_obj::_hx___toLimeColorMatrix(){
            	HX_GC_STACKFRAME(&_hx_pos_82e72dbfef9da50a_333___toLimeColorMatrix)
HXLINE( 334)		if (hx::IsNull( ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix )) {
HXLINE( 336)			 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)20,(int)8);
HXDLIN( 336)			::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix = this1;
            		}
HXLINE( 339)		{
HXLINE( 339)			 ::lime::utils::ArrayBufferView this2 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 339)			Float val = this->redMultiplier;
HXDLIN( 339)			::__hxcpp_memory_set_float(this2->buffer->b,this2->byteOffset,val);
            		}
HXLINE( 340)		{
HXLINE( 340)			 ::lime::utils::ArrayBufferView this3 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 340)			Float val1 = ((Float)this->redOffset / (Float)(int)255);
HXDLIN( 340)			::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)16),val1);
            		}
HXLINE( 341)		{
HXLINE( 341)			 ::lime::utils::ArrayBufferView this4 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 341)			Float val2 = this->greenMultiplier;
HXDLIN( 341)			::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)24),val2);
            		}
HXLINE( 342)		{
HXLINE( 342)			 ::lime::utils::ArrayBufferView this5 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 342)			Float val3 = ((Float)this->greenOffset / (Float)(int)255);
HXDLIN( 342)			::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)36),val3);
            		}
HXLINE( 343)		{
HXLINE( 343)			 ::lime::utils::ArrayBufferView this6 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 343)			Float val4 = this->blueMultiplier;
HXDLIN( 343)			::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)48),val4);
            		}
HXLINE( 344)		{
HXLINE( 344)			 ::lime::utils::ArrayBufferView this7 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 344)			Float val5 = ((Float)this->blueOffset / (Float)(int)255);
HXDLIN( 344)			::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)56),val5);
            		}
HXLINE( 345)		{
HXLINE( 345)			 ::lime::utils::ArrayBufferView this8 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 345)			Float val6 = this->alphaMultiplier;
HXDLIN( 345)			::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)72),val6);
            		}
HXLINE( 346)		{
HXLINE( 346)			 ::lime::utils::ArrayBufferView this9 = ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
HXDLIN( 346)			Float val7 = ((Float)this->alphaOffset / (Float)(int)255);
HXDLIN( 346)			::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)76),val7);
            		}
HXLINE( 348)		return ::openfl::geom::ColorTransform_obj::_hx___limeColorMatrix;
            	}
...
HXDLIN(  59)			return  ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
            		...
            		void _hx_run( ::openfl::geom::ColorTransform ct){
            			HX_STACKFRAME(&_hx_pos_82e72dbfef9da50a_59_boot)
HXDLIN(  59)			ct->_hx___identity();
            		}
