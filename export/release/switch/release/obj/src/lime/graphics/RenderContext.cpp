...
HX_DEFINE_STACK_FRAME(_hx_pos_96059818be203dd4_90_new,"lime.graphics.RenderContext","new",0xb60c3ce1,"lime.graphics.RenderContext.new","lime/graphics/RenderContext.hx",90,0xd99af18f)
namespace lime{
namespace graphics{

void RenderContext_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_96059818be203dd4_90_new)
            	}
