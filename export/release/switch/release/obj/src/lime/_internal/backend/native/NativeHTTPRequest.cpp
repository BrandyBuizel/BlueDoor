...
HXLINE(  90)		this->bytes = ::haxe::io::Bytes_obj::alloc((int)0);
HXLINE(  92)		this->bytesLoaded = (int)0;
HXLINE(  93)		this->bytesTotal = (int)0;
HXLINE(  94)		this->writeBytesLoaded = (int)0;
HXLINE(  95)		this->writeBytesTotal = (int)0;
HXLINE(  96)		this->writePosition = (int)0;
...
HXLINE( 114)					if ((query.length > (int)0)) {
...
HXLINE( 120)				if ((( (::String)(this->parent->__Field(HX_("method",e1,f6,5a,09),hx::paccDynamic)) ) == HX_("GET",76,1c,36,00))) {
HXLINE( 122)					if ((uri.indexOf(HX_("?",3f,00,00,00),null()) > (int)-1)) {
...
HXLINE( 142)		this->curl->setOption((int)10002,uri);
HXLINE( 144)		{
HXLINE( 144)			::String _g = ( (::String)(this->parent->__Field(HX_("method",e1,f6,5a,09),hx::paccDynamic)) );
HXDLIN( 144)			::String _hx_switch_0 = _g;
            			if (  (_hx_switch_0==HX_("GET",76,1c,36,00)) ){
HXLINE( 150)				this->curl->setOption((int)80,true);
HXDLIN( 150)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("HEAD",20,f1,cb,2f)) ){
HXLINE( 147)				this->curl->setOption((int)44,true);
HXDLIN( 147)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("POST",60,4c,1d,35)) ){
HXLINE( 153)				this->curl->setOption((int)47,true);
HXLINE( 155)				if (hx::IsNotNull( data )) {
HXLINE( 157)					this->curl->setOption((int)10009,data);
HXLINE( 158)					this->curl->setOption((int)14,data->length);
HXLINE( 159)					this->curl->setOption((int)60,data->length);
            				}
            				else {
HXLINE( 163)					this->curl->setOption((int)60,(int)0);
            				}
HXLINE( 152)				goto _hx_goto_4;
            			}
            			if (  (_hx_switch_0==HX_("PUT",af,fe,3c,00)) ){
HXLINE( 167)				this->curl->setOption((int)46,true);
HXLINE( 169)				if (hx::IsNotNull( data )) {
HXLINE( 171)					this->curl->setOption((int)10009,data);
HXLINE( 172)					this->curl->setOption((int)14,data->length);
            				}
HXLINE( 166)				goto _hx_goto_4;
            			}
            			/* default */{
HXLINE( 176)				 ::lime::net::curl::CURL _hx_tmp1 = this->curl;
HXDLIN( 176)				_hx_tmp1->setOption((int)10036,::Std_obj::string( ::Dynamic(this->parent->__Field(HX_("method",e1,f6,5a,09),hx::paccDynamic))));
HXLINE( 178)				if (hx::IsNotNull( data )) {
HXLINE( 180)					this->curl->setOption((int)10009,data);
HXLINE( 181)					this->curl->setOption((int)14,data->length);
            				}
            			}
            			_hx_goto_4:;
            		}
HXLINE( 185)		this->curl->setOption((int)52, ::Dynamic(this->parent->__Field(HX_("followRedirects",26,5a,40,75),hx::paccDynamic)));
HXLINE( 186)		this->curl->setOption((int)58,true);
...
HXDLIN( 193)				_g1 = (_g1 + (int)1);
HXLINE( 195)				if (hx::IsEq(  ::Dynamic(header->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)),HX_("Content-Type",ce,69,5d,3c) )) {
...
HXLINE( 205)		if (hx::IsNotNull( ( (::String)(this->parent->__Field(HX_("contentType",93,3c,7b,2a),hx::paccDynamic)) ) )) {
...
HXLINE( 212)			if (hx::IsNotNull( ( ( ::haxe::io::Bytes)(this->parent->__Field(HX_("data",2a,56,63,42),hx::paccDynamic)) ) )) {
...
HXLINE( 227)		this->curl->setOption((int)10023,headers);
HXLINE( 229)		this->curl->setOption((int)20056,this->curl_onProgress_dyn());
HXLINE( 230)		this->curl->setOption((int)20011,this->curl_onWrite_dyn());
...
HXLINE( 235)			this->curl->setOption((int)20079,this->curl_onHeader_dyn());
            		}
HXLINE( 240)		bool _hx_tmp3 = ( (bool)(this->parent->__Field(HX_("withCredentials",56,86,c4,ca),hx::paccDynamic)) );
HXLINE( 245)		this->curl->setOption((int)64,false);
HXLINE( 246)		this->curl->setOption((int)81,(int)0);
HXLINE( 247)		 ::Dynamic _hx_tmp4;
HXDLIN( 247)		if (hx::IsNull( ( (::String)(this->parent->__Field(HX_("userAgent",7a,f0,12,c8),hx::paccDynamic)) ) )) {
...
HXDLIN( 247)		this->curl->setOption((int)10018,_hx_tmp4);
HXLINE( 250)		this->curl->setOption((int)99,true);
HXLINE( 252)		this->curl->setOption((int)53,!(binary));
            	}
...
HXDLIN( 271)		if ((uri.indexOf(HX_("http://",52,75,cd,5a),null()) == (int)-1)) {
HXLINE( 271)			_hx_tmp = (uri.indexOf(HX_("https://",cf,b4,ae,3e),null()) == (int)-1);
            		}
            		else {
...
HXLINE( 275)				::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,(int)0,(int)1);
...
HXLINE( 288)				::lime::net::curl::CURL_obj::globalInit((int)3);
...
HXLINE( 303)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiAddHandle =  ::cpp::vm::Deque_obj::__alloc( HX_CTX );
            				}
...
HXLINE( 309)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiThreadPool =  ::lime::_hx_system::ThreadPool_obj::__alloc( HX_CTX ,(int)0,(int)1);
...
HXLINE( 323)					::lime::_internal::backend::native::NativeHTTPRequest_obj::multiProgressTimer =  ::haxe::Timer_obj::__alloc( HX_CTX ,(int)8);
...
HXLINE( 349)				::String _hx_tmp = bytes->getString((int)0,bytes->length,null());
...
HXLINE( 362)			this->bytes->blit((int)0,cacheBytes,(int)0,cacheBytes->length);
            		}
            	}
...
HXLINE( 371)		if ((parts->length == (int)2)) {
HXLINE( 373)			::Array< ::Dynamic> _hx_tmp = ( (::Array< ::Dynamic>)(this->parent->__Field(HX_("responseHeaders",c5,0d,ca,43),hx::paccDynamic)) );
HXDLIN( 373)			::String _hx_tmp1 = ::StringTools_obj::trim(parts->__get((int)0));
HXDLIN( 373)			_hx_tmp->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,_hx_tmp1,::StringTools_obj::trim(parts->__get((int)1))));
            		}
            	}
...
HXLINE( 396)		this->bytes->blit(this->writePosition,output,(int)0,output->length);
...
bool NativeHTTPRequest_obj::multiThreadPoolRunning;
 ...
 ::cpp::vm::Deque NativeHTTPRequest_obj::multiAddHandle;
...
HXLINE( 410)		if ((index > (int)-1)) {
HXLINE( 412)			path = path.substring((int)0,index);
            		}
...
HXDLIN( 418)			path = (path1 + path.substr((int)2,null()));
            		}
...
HXLINE( 424)			 ::lime::app::Promise_haxe_io_Bytes instance1 = instance->promise;
HXDLIN( 424)			::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendError( ::Dynamic(hx::Anon_obj::Create(3)
...
HXLINE( 443)				 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 443)				::lime::_internal::backend::native::NativeHTTPRequest_obj::localThreadPool->sendError( ::Dynamic(hx::Anon_obj::Create(3)
...
HXLINE( 505)			int code = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->wait((int)1000);
HXLINE( 507)			if ((code == (int)0)) {
...
HXLINE( 512)					_hx_tmp = (::lime::_internal::backend::native::NativeHTTPRequest_obj::multi->get_runningHandles() == (int)0);
            				}
            				else {
...
HXLINE( 521)					 ::Dynamic status = curl1->getInfo((int)2097154);
...
HXLINE( 560)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = ::lime::_internal::backend::native::NativeHTTPRequest_obj::multiInstances->get( ::Dynamic(state->__Field(HX_("curl",ec,4a,c9,41),hx::paccDynamic))).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
...
HXLINE( 564)			instance->parent->__SetField(HX_("responseStatus",93,60,a4,78),( (int)(state->__Field(HX_("status",32,e7,fb,05),hx::paccDynamic)) ),hx::paccDynamic);
HXLINE( 566)			if ((( (int)(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) ) == (int)0)) {
HXLINE( 568)				bool _hx_tmp;
HXDLIN( 568)				bool _hx_tmp1;
HXDLIN( 568)				if ((( (int)(state->__Field(HX_("status",32,e7,fb,05),hx::paccDynamic)) ) >= (int)200)) {
HXLINE( 568)					_hx_tmp1 = (( (int)(state->__Field(HX_("status",32,e7,fb,05),hx::paccDynamic)) ) < (int)400);
            				}
            				else {
HXLINE( 568)					_hx_tmp1 = false;
            				}
HXDLIN( 568)				if (!(_hx_tmp1)) {
HXLINE( 568)					_hx_tmp = (( (int)(state->__Field(HX_("status",32,e7,fb,05),hx::paccDynamic)) ) == (int)0);
            				}
            				else {
...
HXDLIN( 577)						instance1->error(instance->bytes->getString((int)0,instance->bytes->length,null()));
            					}
            					else {
HXLINE( 581)						 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 581)						instance2->error((HX_("Status ",8e,8c,bf,03) + ( (int)(state->__Field(HX_("status",32,e7,fb,05),hx::paccDynamic)) )));
            					}
            				}
            			}
            			else {
HXLINE( 586)				 ::lime::app::Promise_haxe_io_Bytes instance3 = instance->promise;
HXDLIN( 586)				instance3->error(::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),hx::paccDynamic)) )));
            			}
...
bool NativeHTTPRequest_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,hx::PropertyAccess inCallProp)
{
	...
	case 14:
		...
		if (HX_FIELD_EQ(inName,"multiAddHandle") ) { multiAddHandle=ioValue.Cast<  ::cpp::vm::Deque >(); return true; }
		break;
	case 15:
...
void NativeHTTPRequest_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("writeBytesLoaded","\x31","\x90","\x43","\xd2"));
	outFields->push(HX_HCSTRING("writeBytesTotal","\x18","\x35","\x23","\x6d"));
...
static hx::StorageInfo NativeHTTPRequest_obj_sMemberStorageInfo[] = {
	...
	{hx::fsInt,(int)offsetof(NativeHTTPRequest_obj,writeBytesLoaded),HX_HCSTRING("writeBytesLoaded","\x31","\x90","\x43","\xd2")},
	{hx::fsInt,(int)offsetof(NativeHTTPRequest_obj,writeBytesTotal),HX_HCSTRING("writeBytesTotal","\x18","\x35","\x23","\x6d")},
...
static hx::StaticInfo NativeHTTPRequest_obj_sStaticStorageInfo[] = {
	{hx::fsObject /*Array< ::Dynamic >*/ ,(void *) &NativeHTTPRequest_obj::activeInstances,HX_HCSTRING("activeInstances","\x98","\xb8","\xef","\x7f")},
	{hx::fsObject /*::lime::_hx_system::ThreadPool*/ ,(void *) &NativeHTTPRequest_obj::localThreadPool,HX_HCSTRING("localThreadPool","\x11","\x36","\xf3","\xc0")},
	...
	{hx::fsObject /*::haxe::Timer*/ ,(void *) &NativeHTTPRequest_obj::multiProgressTimer,HX_HCSTRING("multiProgressTimer","\x9f","\x32","\x2f","\x30")},
	{hx::fsObject /*::lime::_hx_system::ThreadPool*/ ,(void *) &NativeHTTPRequest_obj::multiThreadPool,HX_HCSTRING("multiThreadPool","\x9f","\x14","\x5d","\xb8")},
	{hx::fsBool,(void *) &NativeHTTPRequest_obj::multiThreadPoolRunning,HX_HCSTRING("multiThreadPoolRunning","\x20","\xe3","\x3c","\xed")},
	{hx::fsObject /*::cpp::vm::Deque*/ ,(void *) &NativeHTTPRequest_obj::multiAddHandle,HX_HCSTRING("multiAddHandle","\xf0","\x76","\xd0","\xd6")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
static ::String NativeHTTPRequest_obj_sMemberFields[] = {
	...
	HX_HCSTRING("writeBytesLoaded","\x31","\x90","\x43","\xd2"),
	HX_HCSTRING("writeBytesTotal","\x18","\x35","\x23","\x6d"),
...
static ::String NativeHTTPRequest_obj_sStaticFields[] = {
	HX_HCSTRING("activeInstances","\x98","\xb8","\xef","\x7f"),
	HX_HCSTRING("localThreadPool","\x11","\x36","\xf3","\xc0"),
	HX_HCSTRING("multi","\x79","\x8a","\x55","\x10"),
	HX_HCSTRING("multiInstances","\x85","\x41","\xc9","\xb1"),
	HX_HCSTRING("multiProgressTimer","\x9f","\x32","\x2f","\x30"),
	HX_HCSTRING("multiThreadPool","\x9f","\x14","\x5d","\xb8"),
	HX_HCSTRING("multiThreadPoolRunning","\x20","\xe3","\x3c","\xed"),
	HX_HCSTRING("multiAddHandle","\xf0","\x76","\xd0","\xd6"),
	HX_HCSTRING("localThreadPool_doWork","\xaa","\xd6","\x50","\x91"),
	HX_HCSTRING("localThreadPool_onComplete","\xa6","\x73","\xcb","\x3c"),
	HX_HCSTRING("localThreadPool_onError","\xbb","\xf2","\x40","\x9d"),
	HX_HCSTRING("localThreadPool_onProgress","\x9a","\x6a","\x2e","\x43"),
	HX_HCSTRING("multiThreadPool_doWork","\xdc","\x05","\xfa","\xc1"),
	HX_HCSTRING("multiThreadPool_onComplete","\xd8","\x23","\x41","\x15"),
	HX_HCSTRING("multiThreadPool_onProgress","\xcc","\x1a","\xa4","\x1b"),
	HX_HCSTRING("multiProgressTimer_onRun","\x8c","\x36","\xcb","\x30"),
	::String(null())
};
