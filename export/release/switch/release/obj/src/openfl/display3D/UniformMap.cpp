...
HXLINE(1047)		int total = (int)0;
HXLINE(1049)		{
HXLINE(1049)			int _g = (int)0;
...
HXDLIN(1057)		this->_hx___registerLookup =  ::openfl::_Vector::ObjectVector_obj::__alloc( HX_CTX ,total,fixed,null(),true);
HXLINE(1059)		{
HXLINE(1059)			int _g2 = (int)0;
HXDLIN(1059)			::Array< ::Dynamic> _g11 = this->_hx___uniforms;
HXDLIN(1059)			while((_g2 < _g11->length)){
HXLINE(1059)				 ::openfl::display3D::Uniform uniform1 = _g11->__get(_g2).StaticCast<  ::openfl::display3D::Uniform >();
HXDLIN(1059)				_g2 = (_g2 + (int)1);
HXLINE(1061)				{
HXLINE(1061)					int _g3 = (int)0;
HXDLIN(1061)					int _g21 = uniform1->regCount;
HXDLIN(1061)					while((_g3 < _g21)){
HXLINE(1061)						_g3 = (_g3 + (int)1);
HXDLIN(1061)						int i = (_g3 - (int)1);
