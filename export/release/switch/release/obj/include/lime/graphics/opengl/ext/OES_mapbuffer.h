...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::OES_mapbuffer)(__this) )->BUFFER_MAP_POINTER_OES = (int)35005;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_mapbuffer)(__this) )->BUFFER_MAPPED_OES = (int)35004;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_mapbuffer)(__this) )->BUFFER_ACCESS_OES = (int)35003;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_mapbuffer)(__this) )->WRITE_ONLY_OES = (int)35001;
            	}
