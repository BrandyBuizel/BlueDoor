...
HXLINE( 323)			Float _hx_tmp = (this->width + this->height);
HXDLIN( 323)			::flixel::_hx_system::FlxQuadTree_obj::_min = ::Math_obj::floor(((Float)_hx_tmp / (Float)((int)2 * ::flixel::_hx_system::FlxQuadTree_obj::divisions)));
            		}
HXLINE( 325)		bool _hx_tmp1;
HXDLIN( 325)		if (!((this->width > ::flixel::_hx_system::FlxQuadTree_obj::_min))) {
HXLINE( 325)			_hx_tmp1 = (this->height > ::flixel::_hx_system::FlxQuadTree_obj::_min);
            		}
            		else {
HXLINE( 325)			_hx_tmp1 = true;
            		}
HXDLIN( 325)		this->_canSubdivide = _hx_tmp1;
...
HXLINE( 334)		this->_halfWidth = ((Float)this->width / (Float)(int)2);
...
HXLINE( 338)		this->_halfHeight = ((Float)this->height / (Float)(int)2);
...
HXLINE( 383)		this->add(ObjectOrGroup1,(int)0);
HXLINE( 384)		if (hx::IsNotNull( ObjectOrGroup2 )) {
HXLINE( 386)			this->add(ObjectOrGroup2,(int)1);
...
HXLINE( 418)				i = (i + (int)1);
HXDLIN( 418)				basic = members->__get((i - (int)1)).StaticCast<  ::flixel::FlxBasic >();
...
HXLINE( 429)							_hx_tmp1 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != (int)0);
            						}
            						else {
...
HXLINE( 444)				_hx_tmp4 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != (int)0);
            			}
            			else {
...
HXLINE( 554)		if ((::flixel::_hx_system::FlxQuadTree_obj::_list == (int)0)) {
...
HXLINE( 619)					_hx_tmp3 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions > (int)0);
            				}
            				else {
...
HXDLIN( 658)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectHullWidth > (int)0)) {
...
HXDLIN( 660)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectHullHeight > (int)0)) {
...
HXLINE( 669)				_hx_tmp6 = (checkObject->allowCollisions <= (int)0);
            			}
            			else {
...
HXDLIN( 679)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth > (int)0)) {
...
HXDLIN( 681)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight > (int)0)) {
...
HXLINE( 685)				Float _hx_tmp17 = ::flixel::_hx_system::FlxQuadTree_obj::_objectHullX;
HXLINE( 684)				_hx_tmp16 = (_hx_tmp17 < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullX + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth));
            			}
            			else {
...
HXLINE( 687)				Float _hx_tmp18 = ::flixel::_hx_system::FlxQuadTree_obj::_objectHullY;
HXLINE( 684)				_hx_tmp14 = (_hx_tmp18 < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight));
            			}
            			else {
HXLINE( 684)				_hx_tmp14 = false;
            			}
HXDLIN( 684)			if (_hx_tmp14) {
HXLINE( 690)				bool _hx_tmp19;
HXDLIN( 690)				if (hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_processingCallback )) {
HXLINE( 690)					_hx_tmp19 = ( (bool)(::flixel::_hx_system::FlxQuadTree_obj::_processingCallback(::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject)) );
            				}
            				else {
HXLINE( 690)					_hx_tmp19 = true;
            				}
HXDLIN( 690)				if (_hx_tmp19) {
...
HXLINE( 273)		::flixel::_hx_system::FlxQuadTree_obj::_NUM_CACHED_QUAD_TREES = (int)0;
            	}
...
HXDLIN(  26)		B_LIST = (int)1;
            	}
{
            	HX_STACKFRAME(&_hx_pos_d6b090d39d0d72d3_222_boot)
HXDLIN( 222)		_NUM_CACHED_QUAD_TREES = (int)0;
            	}
}
