...
HXLINE( 232)		int r = ((int)((int)this->_hx___color >> (int)(int)16) & (int)(int)255);
HXLINE( 233)		int g = ((int)((int)this->_hx___color >> (int)(int)8) & (int)(int)255);
HXLINE( 234)		int b = ((int)this->_hx___color & (int)(int)255);
...
HXDLIN( 238)		finalImage2->colorTransform(_hx_tmp, ::openfl::geom::ColorTransform_obj::__alloc( HX_CTX ,(int)0,(int)0,(int)0,this->_hx___alpha,r,g,b,(int)0)->_hx___toLimeColorMatrix());
...
HXLINE( 250)			Float scale = ::Math_obj::pow(((Float)0.5),((int)pass >> (int)(int)1));
HXLINE( 251)			::Array< Float > _hx_tmp = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value;
HXDLIN( 251)			_hx_tmp[(int)0] = (this->get_blurX() * scale);
HXLINE( 252)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[(int)1] = (int)0;
            		}
            		else {
HXLINE( 256)			Float scale1 = ::Math_obj::pow(((Float)0.5),((int)(pass - this->_hx___horizontalPasses) >> (int)(int)1));
HXLINE( 257)			::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value[(int)0] = (int)0;
HXLINE( 258)			::Array< Float > _hx_tmp1 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uRadius->value;
HXDLIN( 258)			_hx_tmp1[(int)1] = (this->get_blurY() * scale1);
            		}
HXLINE( 261)		::Array< Float > _hx_tmp2 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 261)		_hx_tmp2[(int)0] = ((Float)((int)((int)this->get_color() >> (int)(int)16) & (int)(int)255) / (Float)(int)255);
HXLINE( 262)		::Array< Float > _hx_tmp3 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 262)		_hx_tmp3[(int)1] = ((Float)((int)((int)this->get_color() >> (int)(int)8) & (int)(int)255) / (Float)(int)255);
HXLINE( 263)		::Array< Float > _hx_tmp4 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 263)		_hx_tmp4[(int)2] = ((Float)((int)this->get_color() & (int)(int)255) / (Float)(int)255);
HXLINE( 264)		::Array< Float > _hx_tmp5 = ::openfl::filters::GlowFilter_obj::_hx___glowShader->uColor->value;
HXDLIN( 264)		Float _hx_tmp6 = this->get_alpha();
HXDLIN( 264)		_hx_tmp5[(int)3] = (_hx_tmp6 * ((Float)this->_hx___strength / (Float)this->_hx___numShaderPasses));
...
HXDLIN( 293)			if ((value > (int)0)) {
HXLINE( 293)				_hx_tmp = ::Math_obj::ceil((value * ((Float)1.5)));
            			}
            			else {
HXLINE( 293)				_hx_tmp = (int)0;
            			}
...
HXDLIN( 310)			if ((value > (int)0)) {
HXLINE( 310)				_hx_tmp = ::Math_obj::ceil((value * ((Float)1.5)));
            			}
            			else {
HXLINE( 310)				_hx_tmp = (int)0;
            			}
...
HXDLIN( 358)		if ((this->_hx___blurX <= (int)0)) {
HXLINE( 358)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 358)			Float _hx_tmp1 = this->_hx___blurX;
HXDLIN( 358)			_hx_tmp = (::Math_obj::round((_hx_tmp1 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 358)		this->_hx___horizontalPasses = _hx_tmp;
HXLINE( 359)		int _hx_tmp2;
HXDLIN( 359)		if ((this->_hx___blurY <= (int)0)) {
HXLINE( 359)			_hx_tmp2 = (int)0;
            		}
            		else {
HXLINE( 359)			Float _hx_tmp3 = this->_hx___blurY;
HXDLIN( 359)			_hx_tmp2 = (::Math_obj::round((_hx_tmp3 * ((Float)value / (Float)(int)4))) + (int)1);
            		}
HXDLIN( 359)		this->_hx___verticalPasses = _hx_tmp2;
