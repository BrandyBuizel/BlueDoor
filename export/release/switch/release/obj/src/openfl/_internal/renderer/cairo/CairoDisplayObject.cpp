...
HXLINE(  27)			_hx_tmp2 = (displayObject->get_width() > (int)0);
            		}
            		else {
HXLINE(  27)			_hx_tmp2 = false;
            		}
HXDLIN(  27)		if (_hx_tmp2) {
HXLINE(  27)			_hx_tmp1 = (displayObject->get_height() > (int)0);
            		}
            		else {
...
HXLINE(  39)			int color = displayObject->opaqueBackground;
HXLINE(  40)			cairo->setSourceRGB(((Float)((int)hx::UShr(color,(int)16) & (int)(int)255) / (Float)(int)255),((Float)((int)hx::UShr(color,(int)8) & (int)(int)255) / (Float)(int)255),((Float)((int)color & (int)(int)255) / (Float)(int)255));
HXLINE(  41)			Float _hx_tmp4 = displayObject->get_width();
HXDLIN(  41)			cairo->rectangle((int)0,(int)0,_hx_tmp4,displayObject->get_height());
