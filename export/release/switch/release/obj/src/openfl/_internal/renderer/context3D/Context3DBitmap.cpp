...
HXLINE(  26)			_hx_tmp = (bitmap->_hx___worldAlpha <= (int)0);
            		}
            		else {
...
HXLINE(  45)				context->setVertexBufferAt(shader->_hx___position->index,vertexBuffer,(int)0,(int)3);
            			}
HXLINE(  46)			if (hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(  46)				context->setVertexBufferAt(shader->_hx___textureCoord->index,vertexBuffer,(int)3,(int)2);
            			}
...
HXLINE(  74)				context->setVertexBufferAt(shader->_hx___position->index,vertexBuffer,(int)0,(int)3);
            			}
HXLINE(  75)			if (hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(  75)				context->setVertexBufferAt(shader->_hx___textureCoord->index,vertexBuffer,(int)3,(int)2);
            			}
