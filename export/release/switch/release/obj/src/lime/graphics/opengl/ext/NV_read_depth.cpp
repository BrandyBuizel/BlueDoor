...
bool NV_read_depth_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x3dcd65ff;
}
...
static void NV_read_depth_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(NV_read_depth_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void NV_read_depth_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new NV_read_depth_obj;
	NV_read_depth_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = NV_read_depth_obj_sMarkStatics;
	__mClass->mStatics = hx::Class_obj::dupFunctions(0 /* sStaticFields */);
	__mClass->mMembers = hx::Class_obj::dupFunctions(0 /* sMemberFields */);
	__mClass->mCanCast = hx::TCanCast< NV_read_depth_obj >;
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = NV_read_depth_obj_sVisitStatics;
#endif
