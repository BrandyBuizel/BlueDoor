...
HXLINE( 136)			return ( (int)(::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::fromStringMap->get(s)) );
            		}
            		else {
...
HXDLIN( 142)		return ( (::String)(::flixel::input::gamepad::_FlxGamepadInputID::FlxGamepadInputID_Impl__obj::toStringMap->get(this1)) );
            	}
...
HXDLIN(  54)			_g->set(HX_("A",41,00,00,00),(int)0);
HXDLIN(  54)			_g->set(HX_("B",42,00,00,00),(int)1);
HXDLIN(  54)			_g->set(HX_("X",58,00,00,00),(int)2);
HXDLIN(  54)			_g->set(HX_("Y",59,00,00,00),(int)3);
HXDLIN(  54)			_g->set(HX_("LEFT_SHOULDER",d8,b1,a9,01),(int)4);
HXDLIN(  54)			_g->set(HX_("RIGHT_SHOULDER",83,9f,28,11),(int)5);
HXDLIN(  54)			_g->set(HX_("BACK",27,a2,d1,2b),(int)6);
HXDLIN(  54)			_g->set(HX_("START",42,ac,f9,01),(int)7);
HXDLIN(  54)			_g->set(HX_("LEFT_STICK_CLICK",21,9d,4a,bf),(int)8);
HXDLIN(  54)			_g->set(HX_("RIGHT_STICK_CLICK",56,4c,25,0b),(int)9);
HXDLIN(  54)			_g->set(HX_("GUIDE",9c,f2,d9,19),(int)10);
HXDLIN(  54)			_g->set(HX_("DPAD_UP",6b,00,87,a2),(int)11);
HXDLIN(  54)			_g->set(HX_("DPAD_DOWN",72,1a,5b,87),(int)12);
HXDLIN(  54)			_g->set(HX_("DPAD_LEFT",17,2a,9d,8c),(int)13);
HXDLIN(  54)			_g->set(HX_("DPAD_RIGHT",ac,b7,f4,f3),(int)14);
HXDLIN(  54)			_g->set(HX_("LEFT_TRIGGER_BUTTON",f1,61,33,1b),(int)15);
HXDLIN(  54)			_g->set(HX_("RIGHT_TRIGGER_BUTTON",dc,61,f8,02),(int)16);
HXDLIN(  54)			_g->set(HX_("LEFT_TRIGGER",a0,31,c6,eb),(int)17);
HXDLIN(  54)			_g->set(HX_("RIGHT_TRIGGER",55,e2,81,00),(int)18);
HXDLIN(  54)			_g->set(HX_("LEFT_ANALOG_STICK",19,49,58,a5),(int)19);
HXDLIN(  54)			_g->set(HX_("RIGHT_ANALOG_STICK",44,e8,d6,b8),(int)20);
HXDLIN(  54)			_g->set(HX_("DPAD",6f,6f,2f,2d),(int)21);
HXDLIN(  54)			_g->set(HX_("TILT_PITCH",de,59,c1,1b),(int)26);
HXDLIN(  54)			_g->set(HX_("TILT_ROLL",ff,5e,73,5e),(int)27);
HXDLIN(  54)			_g->set(HX_("POINTER_X",f6,08,fa,28),(int)28);
HXDLIN(  54)			_g->set(HX_("POINTER_Y",f7,08,fa,28),(int)29);
HXDLIN(  54)			_g->set(HX_("EXTRA_0",61,a1,be,f8),(int)30);
HXDLIN(  54)			_g->set(HX_("EXTRA_1",62,a1,be,f8),(int)31);
HXDLIN(  54)			_g->set(HX_("EXTRA_2",63,a1,be,f8),(int)32);
HXDLIN(  54)			_g->set(HX_("EXTRA_3",64,a1,be,f8),(int)33);
HXDLIN(  54)			_g->set(HX_("LEFT_STICK_DIGITAL_UP",29,d8,3b,d5),(int)34);
HXDLIN(  54)			_g->set(HX_("LEFT_STICK_DIGITAL_RIGHT",ae,ca,36,04),(int)35);
HXDLIN(  54)			_g->set(HX_("LEFT_STICK_DIGITAL_DOWN",b0,dd,c3,72),(int)36);
HXDLIN(  54)			_g->set(HX_("LEFT_STICK_DIGITAL_LEFT",55,ed,05,78),(int)37);
HXDLIN(  54)			_g->set(HX_("RIGHT_STICK_DIGITAL_UP",d4,e8,30,f8),(int)38);
HXDLIN(  54)			_g->set(HX_("RIGHT_STICK_DIGITAL_RIGHT",e3,36,d3,6c),(int)39);
HXDLIN(  54)			_g->set(HX_("RIGHT_STICK_DIGITAL_DOWN",1b,af,9e,09),(int)40);
HXDLIN(  54)			_g->set(HX_("RIGHT_STICK_DIGITAL_LEFT",c0,be,e0,0e),(int)41);
HXDLIN(  54)			return _g;
            		}
...
HXDLIN(  54)			_g->set((int)0,HX_("A",41,00,00,00));
HXDLIN(  54)			_g->set((int)1,HX_("B",42,00,00,00));
HXDLIN(  54)			_g->set((int)2,HX_("X",58,00,00,00));
HXDLIN(  54)			_g->set((int)3,HX_("Y",59,00,00,00));
HXDLIN(  54)			_g->set((int)4,HX_("LEFT_SHOULDER",d8,b1,a9,01));
HXDLIN(  54)			_g->set((int)5,HX_("RIGHT_SHOULDER",83,9f,28,11));
HXDLIN(  54)			_g->set((int)6,HX_("BACK",27,a2,d1,2b));
HXDLIN(  54)			_g->set((int)7,HX_("START",42,ac,f9,01));
HXDLIN(  54)			_g->set((int)8,HX_("LEFT_STICK_CLICK",21,9d,4a,bf));
HXDLIN(  54)			_g->set((int)9,HX_("RIGHT_STICK_CLICK",56,4c,25,0b));
HXDLIN(  54)			_g->set((int)10,HX_("GUIDE",9c,f2,d9,19));
HXDLIN(  54)			_g->set((int)11,HX_("DPAD_UP",6b,00,87,a2));
HXDLIN(  54)			_g->set((int)12,HX_("DPAD_DOWN",72,1a,5b,87));
HXDLIN(  54)			_g->set((int)13,HX_("DPAD_LEFT",17,2a,9d,8c));
HXDLIN(  54)			_g->set((int)14,HX_("DPAD_RIGHT",ac,b7,f4,f3));
HXDLIN(  54)			_g->set((int)15,HX_("LEFT_TRIGGER_BUTTON",f1,61,33,1b));
HXDLIN(  54)			_g->set((int)16,HX_("RIGHT_TRIGGER_BUTTON",dc,61,f8,02));
HXDLIN(  54)			_g->set((int)17,HX_("LEFT_TRIGGER",a0,31,c6,eb));
HXDLIN(  54)			_g->set((int)18,HX_("RIGHT_TRIGGER",55,e2,81,00));
HXDLIN(  54)			_g->set((int)19,HX_("LEFT_ANALOG_STICK",19,49,58,a5));
HXDLIN(  54)			_g->set((int)20,HX_("RIGHT_ANALOG_STICK",44,e8,d6,b8));
HXDLIN(  54)			_g->set((int)21,HX_("DPAD",6f,6f,2f,2d));
HXDLIN(  54)			_g->set((int)26,HX_("TILT_PITCH",de,59,c1,1b));
HXDLIN(  54)			_g->set((int)27,HX_("TILT_ROLL",ff,5e,73,5e));
HXDLIN(  54)			_g->set((int)28,HX_("POINTER_X",f6,08,fa,28));
HXDLIN(  54)			_g->set((int)29,HX_("POINTER_Y",f7,08,fa,28));
HXDLIN(  54)			_g->set((int)30,HX_("EXTRA_0",61,a1,be,f8));
HXDLIN(  54)			_g->set((int)31,HX_("EXTRA_1",62,a1,be,f8));
HXDLIN(  54)			_g->set((int)32,HX_("EXTRA_2",63,a1,be,f8));
HXDLIN(  54)			_g->set((int)33,HX_("EXTRA_3",64,a1,be,f8));
HXDLIN(  54)			_g->set((int)34,HX_("LEFT_STICK_DIGITAL_UP",29,d8,3b,d5));
HXDLIN(  54)			_g->set((int)35,HX_("LEFT_STICK_DIGITAL_RIGHT",ae,ca,36,04));
HXDLIN(  54)			_g->set((int)36,HX_("LEFT_STICK_DIGITAL_DOWN",b0,dd,c3,72));
HXDLIN(  54)			_g->set((int)37,HX_("LEFT_STICK_DIGITAL_LEFT",55,ed,05,78));
HXDLIN(  54)			_g->set((int)38,HX_("RIGHT_STICK_DIGITAL_UP",d4,e8,30,f8));
HXDLIN(  54)			_g->set((int)39,HX_("RIGHT_STICK_DIGITAL_RIGHT",e3,36,d3,6c));
HXDLIN(  54)			_g->set((int)40,HX_("RIGHT_STICK_DIGITAL_DOWN",1b,af,9e,09));
HXDLIN(  54)			_g->set((int)41,HX_("RIGHT_STICK_DIGITAL_LEFT",c0,be,e0,0e));
HXDLIN(  54)			return _g;
            		}
            		HX_END_LOCAL_FUNC0(return)
