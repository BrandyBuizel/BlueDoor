...
HXLINE( 174)			if (!((min <= (int)0))) {
HXLINE( 174)				_hx_tmp2 = (((Float)time1 / (Float)min) >= (int)1);
            			}
            			else {
...
HXLINE( 203)		this->_percent = (int)1;
            	}
...
HXLINE( 223)		 ::openfl::display::Bitmap bmp =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0)),null(),null());
...
HXLINE( 245)		 ::openfl::display::BitmapData bmpData = ( ( ::openfl::display::BitmapData)(::Type_obj::createInstance(bitmapDataClass,::cpp::VirtualArray_obj::__new(2)->init(0,(int)0)->init(1,(int)0))) );
...
void FlxBasePreloader_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("_destroyed","\x9a","\xb3","\xc9","\x4f"));
...
static hx::StorageInfo FlxBasePreloader_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(FlxBasePreloader_obj,_destroyed),HX_HCSTRING("_destroyed","\x9a","\xb3","\xc9","\x4f")},
...
static ::String FlxBasePreloader_obj_sMemberFields[] = {
	...
	HX_HCSTRING("_destroyed","\x9a","\xb3","\xc9","\x4f"),
