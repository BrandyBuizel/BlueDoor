...
HXLINE(  57)		this->unusedTouchesPool =  ::List_obj::__alloc( HX_CTX );
...
HXLINE(  53)		this->renderEventInfo =  ::lime::_internal::backend::native::RenderEventInfo_obj::__alloc( HX_CTX ,(int)0);
...
HXLINE(  45)		this->applicationEventInfo =  ::lime::_internal::backend::native::ApplicationEventInfo_obj::__alloc( HX_CTX ,(int)0,null());
HXLINE(  75)		this->parent = parent;
HXLINE(  76)		this->pauseTimer = (int)-1;
...
HXDLIN(  93)		if ((this->pauseTimer > (int)-1)) {
...
HXDLIN(  96)				int _g = ::haxe::Timer_obj::sRunningTimers->length;
...
HXLINE( 100)			this->pauseTimer = (int)-1;
            		}
            	}
...
HXDLIN( 170)		int _g = this->applicationEventInfo->type;
HXDLIN( 170)		if ((_g == (int)0)) {
...
HXDLIN( 196)		int _g = this->gamepadEventInfo->type;
HXDLIN( 196)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 199)				 ::lime::ui::Gamepad gamepad = ( ( ::lime::ui::Gamepad)(::haxe::IMap_obj::get(::lime::ui::Gamepad_obj::devices,this->gamepadEventInfo->id)) );
...
HXLINE( 200)					gamepad->onAxisMove->dispatch(this->gamepadEventInfo->axis,this->gamepadEventInfo->axisValue);
            			...
            			break;
            			case (int)1: {
HXLINE( 203)				 ::lime::ui::Gamepad gamepad1 = ( ( ::lime::ui::Gamepad)(::haxe::IMap_obj::get(::lime::ui::Gamepad_obj::devices,this->gamepadEventInfo->id)) );
...
HXLINE( 204)					gamepad1->onButtonDown->dispatch(this->gamepadEventInfo->button);
            			...
            			break;
            			case (int)2: {
HXLINE( 207)				 ::lime::ui::Gamepad gamepad2 = ( ( ::lime::ui::Gamepad)(::haxe::IMap_obj::get(::lime::ui::Gamepad_obj::devices,this->gamepadEventInfo->id)) );
...
HXDLIN( 220)		int _g = this->joystickEventInfo->type;
HXDLIN( 220)		switch((int)(_g)){
            			case (int)0: {
HXLINE( 223)				 ::lime::ui::Joystick joystick = ( ( ::lime::ui::Joystick)(::haxe::IMap_obj::get(::lime::ui::Joystick_obj::devices,this->joystickEventInfo->id)) );
...
HXLINE( 224)					joystick->onAxisMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x);
            			...
            			break;
            			case (int)1: {
HXLINE( 227)				 ::lime::ui::Joystick joystick1 = ( ( ::lime::ui::Joystick)(::haxe::IMap_obj::get(::lime::ui::Joystick_obj::devices,this->joystickEventInfo->id)) );
...
HXLINE( 228)					joystick1->onHatMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->eventValue);
            			...
            			break;
            			case (int)2: {
HXLINE( 231)				 ::lime::ui::Joystick joystick2 = ( ( ::lime::ui::Joystick)(::haxe::IMap_obj::get(::lime::ui::Joystick_obj::devices,this->joystickEventInfo->id)) );
...
HXLINE( 232)					joystick2->onTrackballMove->dispatch(this->joystickEventInfo->index,this->joystickEventInfo->x,this->joystickEventInfo->y);
            			...
            			break;
            			case (int)3: {
HXLINE( 235)				 ::lime::ui::Joystick joystick3 = ( ( ::lime::ui::Joystick)(::haxe::IMap_obj::get(::lime::ui::Joystick_obj::devices,this->joystickEventInfo->id)) );
...
HXLINE( 236)					joystick3->onButtonDown->dispatch(this->joystickEventInfo->index);
            			...
            			break;
            			case (int)4: {
HXLINE( 239)				 ::lime::ui::Joystick joystick4 = ( ( ::lime::ui::Joystick)(::haxe::IMap_obj::get(::lime::ui::Joystick_obj::devices,this->joystickEventInfo->id)) );
...
HXLINE( 252)		 ::lime::ui::Window window = this->parent->_hx___windowByID->get(this->keyEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
...
HXLINE( 330)		 ::lime::ui::Window window = this->parent->_hx___windowByID->get(this->mouseEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 332)		if (hx::IsNotNull( window )) {
HXLINE( 334)			int _g = this->mouseEventInfo->type;
HXDLIN( 334)			switch((int)(_g)){
            				case (int)0: {
...
HXLINE( 364)			{
HXLINE( 364)				int _g2 = this->renderEventInfo->type;
HXDLIN( 364)				switch((int)(_g2)){
            					case (int)0: {
...
HXLINE( 381)							{
HXLINE( 381)								::String _g21 = window->context->type;
HXDLIN( 381)								::String _hx_switch_0 = _g21;
...
HXLINE( 411)		 ::lime::_hx_system::Sensor sensor = ::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id).StaticCast<  ::lime::_hx_system::Sensor >();
...
HXLINE( 421)		 ::lime::ui::Window window = this->parent->_hx___windowByID->get(this->textEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 423)		if (hx::IsNotNull( window )) {
HXLINE( 425)			int _g = this->textEventInfo->type;
...
HXDLIN( 441)		int _g = this->touchEventInfo->type;
HXDLIN( 441)		switch((int)(_g)){
            			case (int)0: {
...
HXLINE( 462)				::haxe::IMap_obj::set(this->currentTouches,touch->id,touch);
HXLINE( 464)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			}
            			break;
            			case (int)1: {
HXLINE( 467)				 ::lime::ui::Touch touch1 = ( ( ::lime::ui::Touch)(::haxe::IMap_obj::get(this->currentTouches,this->touchEventInfo->id)) );
...
HXLINE( 479)					::haxe::IMap_obj::remove(this->currentTouches,this->touchEventInfo->id);
HXLINE( 480)					this->unusedTouchesPool->add(touch1);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 484)				 ::lime::ui::Touch touch2 = ( ( ::lime::ui::Touch)(::haxe::IMap_obj::get(this->currentTouches,this->touchEventInfo->id)) );
...
HXLINE( 503)		 ::lime::ui::Window window = this->parent->_hx___windowByID->get(this->windowEventInfo->windowID).StaticCast<  ::lime::ui::Window >();
HXLINE( 505)		if (hx::IsNotNull( window )) {
HXLINE( 507)			int _g = this->windowEventInfo->type;
HXDLIN( 507)			switch((int)(_g)){
            				case (int)0: {
...
HXLINE( 552)					window->onMove->dispatch(this->windowEventInfo->x,this->windowEventInfo->y);
            				}
            				break;
            				case (int)11: {
...
HXDLIN( 570)		if ((::haxe::Timer_obj::sRunningTimers->length > (int)0)) {
...
HXDLIN( 576)				int _g = ::haxe::Timer_obj::sRunningTimers->length;
