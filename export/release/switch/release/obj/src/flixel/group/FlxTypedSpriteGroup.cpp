...
HX_LOCAL_STACK_FRAME(_hx_pos_790ec110ce1e7f7f_603_transformChildren_openfl_display_BlendMode,"flixel.group.FlxTypedSpriteGroup","transformChildren_openfl_display_BlendMode",0x546b9da9,"flixel.group.FlxTypedSpriteGroup.transformChildren_openfl_display_BlendMode","flixel/group/FlxSpriteGroup.hx",603,0xeb1fa7f3)
...
void FlxTypedSpriteGroup_obj::transformChildren_openfl_display_BlendMode( ::Dynamic Function, ::Dynamic Value){
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_603_transformChildren_openfl_display_BlendMode)
HXLINE( 604)		if (hx::IsNull( this->group )) {
HXLINE( 605)			return;
            		}
HXLINE( 607)		{
...
HXLINE( 635)					int _g3 = (int)0;
HXDLIN( 635)					int _g2 = numProps;
HXDLIN( 635)					while((_g3 < _g2)){
HXLINE( 635)						_g3 = (_g3 + (int)1);
HXDLIN( 635)						int i = (_g3 - (int)1);
...
HXLINE(  96)		{
HXLINE(  96)			 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  96)			point->_inPool = false;
HXDLIN(  96)			this->velocity = point;
HXDLIN(  96)			 ::flixel::math::FlxPoint point1 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  96)			point1->_inPool = false;
HXDLIN(  96)			this->acceleration = point1;
HXDLIN(  96)			 ::flixel::math::FlxPoint point2 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
HXDLIN(  96)			point2->_inPool = false;
HXDLIN(  96)			this->drag = point2;
HXDLIN(  96)			 ::flixel::math::FlxPoint point3 = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)10000,(int)10000);
...
HXDLIN( 297)				 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get();
HXDLIN( 297)				_this1->x = X;
HXDLIN( 297)				_this1->y = Y;
HXDLIN( 297)				_this1->width = Width;
HXDLIN( 297)				_this1->height = Height;
HXDLIN( 297)				 ::flixel::math::FlxRect rect = _this1;
...
HXDLIN( 371)			return ( (int)(f(a1,a2,a3)) );
            		}
            		HX_END_LOCAL_FUNC2(return)

int Order = __o_Order.Default(-1);
            	HX_STACKFRAME(&_hx_pos_790ec110ce1e7f7f_371_sort)
HXDLIN( 371)		 ::Dynamic f = Function;
HXDLIN( 371)		int a1 = Order;
HXDLIN( 371)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
...
HXDLIN( 722)		if ((Value < (int)0)) {
HXLINE( 722)			lowerBound = (int)0;
            		}
            		else {
HXLINE( 722)			lowerBound = Value;
            		}
HXDLIN( 722)		 ::Dynamic Value1;
HXDLIN( 722)		if ((lowerBound > (int)1)) {
HXLINE( 722)			Value1 = (int)1;
            		}
            		else {
HXLINE( 722)			Value1 = lowerBound;
            		}
HXDLIN( 722)		Value = Value1;
...
HXDLIN( 726)			if ((this->alpha > (int)0)) {
HXLINE( 726)				factor = ((Float)Value / (Float)this->alpha);
            			}
            			else {
HXLINE( 726)				factor = (int)0;
            			}
HXLINE( 727)			bool _hx_tmp1;
HXDLIN( 727)			if (!(this->directAlpha)) {
HXLINE( 727)				_hx_tmp1 = (this->alpha != (int)0);
            			}
            			else {
...
HXLINE( 772)			_hx_tmp = ((((int)this->allowCollisions & (int)(int)4369) > (int)0) != Value);
            		}
            		else {
...
HXLINE( 787)			this->transformChildren_openfl_display_BlendMode(this->blendTransform_dyn(),Value);
            		}
...
HXLINE( 815)		if ((this->group->length == (int)0)) {
HXLINE( 816)			return (int)0;
            		}
...
HXDLIN( 904)		if ((Sprite->alpha == (int)0)) {
HXDLIN( 904)			_hx_tmp = (Alpha == (int)0);
            		}
            		else {
...
HXLINE( 907)			Sprite->set_alpha(((Float)(int)1 / (Float)Alpha));
            		}
            	}
...
void FlxTypedSpriteGroup_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("directAlpha","\x75","\xb7","\xcb","\xe0"));
...
static hx::StorageInfo FlxTypedSpriteGroup_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(FlxTypedSpriteGroup_obj,directAlpha),HX_HCSTRING("directAlpha","\x75","\xb7","\xcb","\xe0")},
...
static ::String FlxTypedSpriteGroup_obj_sMemberFields[] = {
	...
	HX_HCSTRING("directAlpha","\x75","\xb7","\xcb","\xe0"),
	...
	HX_HCSTRING("directAlphaTransform","\x37","\x3f","\xf4","\x32"),
