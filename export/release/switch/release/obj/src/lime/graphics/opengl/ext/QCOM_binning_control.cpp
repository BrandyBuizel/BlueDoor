...
HXLINE(   9)		this->RENDER_DIRECT_TO_FRAMEBUFFER_QCOM = (int)36787;
HXLINE(   8)		this->GPU_OPTIMIZED_QCOM = (int)36786;
HXLINE(   7)		this->CPU_OPTIMIZED_QCOM = (int)36785;
HXLINE(   6)		this->BINNING_CONTROL_HINT_QCOM = (int)36784;
            	}
