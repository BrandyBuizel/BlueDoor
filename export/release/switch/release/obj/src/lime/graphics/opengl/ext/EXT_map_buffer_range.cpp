...
HXLINE(  11)		this->MAP_UNSYNCHRONIZED_BIT_EXT = (int)32;
HXLINE(  10)		this->MAP_FLUSH_EXPLICIT_BIT_EXT = (int)16;
HXLINE(   9)		this->MAP_INVALIDATE_BUFFER_BIT_EXT = (int)8;
HXLINE(   8)		this->MAP_INVALIDATE_RANGE_BIT_EXT = (int)4;
HXLINE(   7)		this->MAP_WRITE_BIT_EXT = (int)2;
HXLINE(   6)		this->MAP_READ_BIT_EXT = (int)1;
            	}
