...
HX_DEFINE_STACK_FRAME(_hx_pos_84dc687d4538b090_37_new,"lime.system.Display","new",0x04208dce,"lime.system.Display.new","lime/system/Display.hx",37,0x4536ff82)
namespace lime{
namespace _hx_system{

void Display_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_84dc687d4538b090_37_new)
            	}
