...
HXDLIN( 485)		::Array< ::Dynamic> _hx_tmp = this->list;
HXDLIN( 485)		return _hx_tmp->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
