...
HX_DEFINE_STACK_FRAME(_hx_pos_5c3b455efc9a64ca_47_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorRotate","new",0xea64a7b1,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorRotate.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_746598ba63f25f62_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorRotate","boot",0x25c713c1,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorRotate.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformCursorRotate_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_5c3b455efc9a64ca_47_new)
...
bool GraphicTransformCursorRotate_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28c743a7) {
		...
		return inClassId==(int)0x69c413cf;
	}
}
...
void GraphicTransformCursorRotate_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorRotate","\x3f","\xfb","\xd0","\xc9");
...
{
{
            	HX_STACKFRAME(&_hx_pos_746598ba63f25f62_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorRotate",77,c1,65,97);
            	}
}
