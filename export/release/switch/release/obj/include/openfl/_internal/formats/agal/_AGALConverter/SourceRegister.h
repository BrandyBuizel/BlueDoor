...
#define INCLUDED_openfl__internal_formats_agal__AGALConverter_SourceRegister
...
class HXCPP_CLASS_ATTRIBUTES SourceRegister_obj : public hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x7f87c9c3 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="openfl._internal.formats.agal._AGALConverter.SourceRegister")
			{ return hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return hx::Object::operator new(inSize+extra,true,"openfl._internal.formats.agal._AGALConverter.SourceRegister"); }
		...
		static  ::openfl::_internal::formats::agal::_AGALConverter::SourceRegister parse( cpp::Int64Struct v, ::openfl::_internal::formats::agal::_AGALConverter::ProgramType programType,int sourceMask);
...
#endif /* INCLUDED_openfl__internal_formats_agal__AGALConverter_SourceRegister */ 
