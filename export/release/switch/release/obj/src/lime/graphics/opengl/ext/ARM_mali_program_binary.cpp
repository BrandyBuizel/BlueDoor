...
HXDLIN(   6)		this->MALI_PROGRAM_BINARY_ARM = (int)36705;
            	}
...
bool ARM_mali_program_binary_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x558df155;
}
...
static void ARM_mali_program_binary_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(ARM_mali_program_binary_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void ARM_mali_program_binary_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new ARM_mali_program_binary_obj;
	ARM_mali_program_binary_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = ARM_mali_program_binary_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = ARM_mali_program_binary_obj_sVisitStatics;
#endif
