...
HX_DEFINE_STACK_FRAME(_hx_pos_f9a9f6c797ee2962_857_new,"openfl.utils._AGALMiniAssembler.Sampler","new",0x5dee1f60,"openfl.utils._AGALMiniAssembler.Sampler.new","openfl/utils/AGALMiniAssembler.hx",857,0x125eff83)
HX_LOCAL_STACK_FRAME(_hx_pos_f9a9f6c797ee2962_865_toString,"openfl.utils._AGALMiniAssembler.Sampler","toString",0x7e1621ac,"openfl.utils._AGALMiniAssembler.Sampler.toString","openfl/utils/AGALMiniAssembler.hx",865,0x125eff83)
HX_LOCAL_STACK_FRAME(_hx_pos_f9a9f6c797ee2962_850_boot,"openfl.utils._AGALMiniAssembler.Sampler","boot",0xca865532,"openfl.utils._AGALMiniAssembler.Sampler.boot","openfl/utils/AGALMiniAssembler.hx",850,0x125eff83)
namespace openfl{
namespace utils{
namespace _AGALMiniAssembler{

void Sampler_obj::__construct(::String name,int flag,int mask){
            	HX_STACKFRAME(&_hx_pos_f9a9f6c797ee2962_857_new)
HXLINE( 858)		this->name = name;
HXLINE( 859)		this->flag = flag;
HXLINE( 860)		this->mask = mask;
            	}
...
::String Sampler_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_f9a9f6c797ee2962_865_toString)
HXDLIN( 865)		::String _hx_tmp = ((HX_("[Sampler name=\"",23,b2,ab,02) + this->name) + HX_("\", flag=\"",87,eb,83,43));
HXDLIN( 865)		int _hx_int = this->flag;
HXDLIN( 865)		Float _hx_tmp1;
HXDLIN( 865)		if ((_hx_int < (int)0)) {
HXDLIN( 865)			_hx_tmp1 = (((Float)4294967296.0) + _hx_int);
            		}
            		else {
HXDLIN( 865)			_hx_tmp1 = (_hx_int + ((Float)0.0));
            		}
HXDLIN( 865)		::String _hx_tmp2 = ((_hx_tmp + ::Std_obj::string(_hx_tmp1)) + HX_("\", mask=",fb,aa,f1,8c));
HXDLIN( 865)		int int1 = this->mask;
HXDLIN( 865)		Float _hx_tmp3;
HXDLIN( 865)		if ((int1 < (int)0)) {
HXDLIN( 865)			_hx_tmp3 = (((Float)4294967296.0) + int1);
            		}
            		else {
HXDLIN( 865)			_hx_tmp3 = (int1 + ((Float)0.0));
            		}
HXDLIN( 865)		return ((_hx_tmp2 + ::Std_obj::string(_hx_tmp3)) + HX_("]",5d,00,00,00));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_f9a9f6c797ee2962_850_boot)
