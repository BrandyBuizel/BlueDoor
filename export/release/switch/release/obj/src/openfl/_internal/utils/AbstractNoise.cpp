...
HX_DEFINE_STACK_FRAME(_hx_pos_85815fa8339ff72c_32_new,"openfl._internal.utils.AbstractNoise","new",0x67969e7d,"openfl._internal.utils.AbstractNoise.new","openfl/_internal/utils/AbstractNoise.hx",32,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_45_fill,"openfl._internal.utils.AbstractNoise","fill",0x36ed59c6,"openfl._internal.utils.AbstractNoise.fill","openfl/_internal/utils/AbstractNoise.hx",45,0x6f8fbe56)
...
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_89_color,"openfl._internal.utils.AbstractNoise","color",0x2284c0c0,"openfl._internal.utils.AbstractNoise.color","openfl/_internal/utils/AbstractNoise.hx",89,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_114_noiseToColor,"openfl._internal.utils.AbstractNoise","noiseToColor",0x8c2ae3b1,"openfl._internal.utils.AbstractNoise.noiseToColor","openfl/_internal/utils/AbstractNoise.hx",114,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_119_fade,"openfl._internal.utils.AbstractNoise","fade",0x36e740bf,"openfl._internal.utils.AbstractNoise.fade","openfl/_internal/utils/AbstractNoise.hx",119,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_124_mixI,"openfl._internal.utils.AbstractNoise","mixI",0x3b8de270,"openfl._internal.utils.AbstractNoise.mixI","openfl/_internal/utils/AbstractNoise.hx",124,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_129_mix,"openfl._internal.utils.AbstractNoise","mix",0x6795dfb9,"openfl._internal.utils.AbstractNoise.mix","openfl/_internal/utils/AbstractNoise.hx",129,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_134_fastfloor,"openfl._internal.utils.AbstractNoise","fastfloor",0x0aaddb8d,"openfl._internal.utils.AbstractNoise.fastfloor","openfl/_internal/utils/AbstractNoise.hx",134,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_139_dot2d,"openfl._internal.utils.AbstractNoise","dot2d",0xb5f13218,"openfl._internal.utils.AbstractNoise.dot2d","openfl/_internal/utils/AbstractNoise.hx",139,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_144_dot,"openfl._internal.utils.AbstractNoise","dot",0x678f10a6,"openfl._internal.utils.AbstractNoise.dot","openfl/_internal/utils/AbstractNoise.hx",144,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_148_calculateOctaves,"openfl._internal.utils.AbstractNoise","calculateOctaves",0xb5f9a480,"openfl._internal.utils.AbstractNoise.calculateOctaves","openfl/_internal/utils/AbstractNoise.hx",148,0x6f8fbe56)
HX_LOCAL_STACK_FRAME(_hx_pos_85815fa8339ff72c_20_boot,"openfl._internal.utils.AbstractNoise","boot",0x344d0f75,"openfl._internal.utils.AbstractNoise.boot","openfl/_internal/utils/AbstractNoise.hx",20,0x6f8fbe56)
namespace openfl{
namespace _internal{
namespace utils{
...
Float stitch_threshold = __o_stitch_threshold.Default(((Float)0.05));
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_32_new)
...
void AbstractNoise_obj::fill( ::openfl::display::BitmapData bitmap,Float _scale_x,Float _scale_y,Float _scale_z){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_45_fill)
            	}
...
HXLINE(  58)			int dest_r = ((int)((int)dest >> (int)(int)16) & (int)(int)255);
HXLINE(  59)			int dest_g = ((int)((int)dest >> (int)(int)8) & (int)(int)255);
HXLINE(  60)			int dest_b = ((int)dest & (int)(int)255);
...
HXLINE(  73)			int dest_r1 = ((int)((int)dest1 >> (int)(int)16) & (int)(int)255);
HXLINE(  74)			int dest_g1 = ((int)((int)dest1 >> (int)(int)8) & (int)(int)255);
HXLINE(  75)			int dest_b1 = ((int)dest1 & (int)(int)255);
...
HXLINE(  85)		return ((int)((int)((int)(int)-16777216 | (int)((int)r << (int)(int)16)) | (int)((int)g << (int)(int)8)) | (int)b);
            	}
...
int AbstractNoise_obj::color( ::Dynamic r_noise, ::Dynamic g_noise, ::Dynamic b_noise){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_89_color)
HXLINE(  90)		int color_r = (int)0;
HXLINE(  91)		int color_g = (int)0;
HXLINE(  92)		int color_b = (int)0;
HXLINE(  94)		if (hx::IsNotNull( r_noise )) {
HXLINE(  96)			color_r = this->noiseToColor(r_noise);
            		}
HXLINE(  99)		if (hx::IsNotNull( g_noise )) {
HXLINE( 101)			color_g = this->noiseToColor(g_noise);
            		}
HXLINE( 104)		if (hx::IsNotNull( b_noise )) {
HXLINE( 106)			color_b = this->noiseToColor(b_noise);
            		}
HXLINE( 109)		return ((int)((int)((int)(int)-16777216 | (int)((int)color_r << (int)(int)16)) | (int)((int)color_g << (int)(int)8)) | (int)color_b);
            	}
...
int AbstractNoise_obj::noiseToColor(Float noise){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_114_noiseToColor)
HXDLIN( 114)		return ::Std_obj::_hx_int((((noise * this->persistence_max) + ((Float)1.0)) * (int)128));
            	}
...
Float AbstractNoise_obj::fade(Float t){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_119_fade)
...
int AbstractNoise_obj::mixI(int x,int y,Float t){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_124_mixI)
HXDLIN( 124)		return ::Std_obj::_hx_int((((((Float)1.0) - t) * x) + (t * y)));
            	}
...
Float AbstractNoise_obj::mix(Float x,Float y,Float t){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_129_mix)
...
int AbstractNoise_obj::fastfloor(Float x){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_134_fastfloor)
HXDLIN( 134)		if ((x > (int)0)) {
HXDLIN( 134)			return ::Std_obj::_hx_int(x);
            		}
            		else {
HXDLIN( 134)			return ::Std_obj::_hx_int((x - (int)1));
            		}
HXDLIN( 134)		return (int)0;
            	}
...
Float AbstractNoise_obj::dot2d(::Array< int > grad,Float x,Float y){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_139_dot2d)
HXDLIN( 139)		return ((grad->__get((int)0) * x) + (grad->__get((int)1) * y));
            	}
...
Float AbstractNoise_obj::dot(::Array< int > grad,Float x,Float y,Float z){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_144_dot)
HXDLIN( 144)		return (((grad->__get((int)0) * x) + (grad->__get((int)1) * y)) + (grad->__get((int)2) * z));
            	}
...
void AbstractNoise_obj::calculateOctaves(Float fPersistence){
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_148_calculateOctaves)
...
HXLINE( 153)		this->persistence_max = (int)0;
HXLINE( 155)		{
HXLINE( 155)			int _g1 = (int)0;
HXDLIN( 155)			int _g = this->octaves;
HXDLIN( 155)			while((_g1 < _g)){
HXLINE( 155)				_g1 = (_g1 + (int)1);
HXDLIN( 155)				int i = (_g1 - (int)1);
HXLINE( 157)				fFreq = ::Math_obj::pow(((Float)2.0),i);
HXLINE( 158)				fPers = ::Math_obj::pow(fPersistence,i);
HXLINE( 160)				 ::openfl::_internal::utils::AbstractNoise _hx_tmp = hx::ObjectPtr<OBJ_>(this);
...
HXLINE( 165)		this->persistence_max = ((Float)((Float)1.0) / (Float)this->persistence_max);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_85815fa8339ff72c_20_boot)
