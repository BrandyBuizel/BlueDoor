...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::APPLE_rgb_422)(__this) )->UNSIGNED_SHORT_8_8_REV_APPLE = (int)34235;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::APPLE_rgb_422)(__this) )->UNSIGNED_SHORT_8_8_APPLE = (int)34234;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::APPLE_rgb_422)(__this) )->RGB_422_APPLE = (int)35359;
            	}
