...
HXLINE( 130)			_hx_tmp1 = (sourceRect->width < (int)1);
            		}
            		else {
HXLINE( 130)			_hx_tmp1 = true;
            		}
HXDLIN( 130)		if (!(_hx_tmp1)) {
HXLINE( 130)			_hx_tmp = (sourceRect->height < (int)1);
            		}
            		else {
...
HXLINE( 154)				 ::Dynamic image1 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic));
HXDLIN( 154)				Float _hx_tmp8 = (destPoint->x + image->offsetX);
HXDLIN( 154)				Float _hx_tmp9 = (destPoint->y + image->offsetY);
HXDLIN( 154)				Float _hx_tmp10 = (sourceRect->width + image->offsetX);
HXDLIN( 154)				image1(_hx_tmp8,_hx_tmp9,_hx_tmp10,(sourceRect->height + image->offsetY));
            			}
            		}
...
HXLINE( 166)			 ::Dynamic image2 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic));
HXDLIN( 166)			 ::Dynamic _hx_tmp11 = sourceImage->buffer->get_src();
HXDLIN( 166)			int _hx_tmp12 = ::Std_obj::_hx_int((sourceRect->x + sourceImage->offsetX));
HXLINE( 167)			int _hx_tmp13 = ::Std_obj::_hx_int((sourceRect->y + sourceImage->offsetY));
HXDLIN( 167)			int _hx_tmp14 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 167)			int _hx_tmp15 = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN( 167)			int _hx_tmp16 = ::Std_obj::_hx_int((destPoint->x + image->offsetX));
HXLINE( 168)			int _hx_tmp17 = ::Std_obj::_hx_int((destPoint->y + image->offsetY));
HXDLIN( 168)			int _hx_tmp18 = ::Std_obj::_hx_int(sourceRect->width);
HXLINE( 166)			image2(_hx_tmp11,_hx_tmp12,_hx_tmp13,_hx_tmp14,_hx_tmp15,_hx_tmp16,_hx_tmp17,_hx_tmp18,::Std_obj::_hx_int(sourceRect->height));
            		}
...
HXDLIN( 225)		int b;
HXDLIN( 225)		int a;
HXLINE( 227)		if ((format == (int)1)) {
HXLINE( 229)			r = ((int)((int)color >> (int)(int)16) & (int)(int)255);
HXLINE( 230)			g = ((int)((int)color >> (int)(int)8) & (int)(int)255);
HXLINE( 231)			b = ((int)color & (int)(int)255);
HXLINE( 232)			if (image->get_transparent()) {
HXLINE( 232)				a = ((int)((int)color >> (int)(int)24) & (int)(int)255);
            			}
            			else {
HXLINE( 232)				a = (int)255;
            			}
            		}
            		else {
HXLINE( 236)			r = ((int)((int)color >> (int)(int)24) & (int)(int)255);
HXLINE( 237)			g = ((int)((int)color >> (int)(int)16) & (int)(int)255);
HXLINE( 238)			b = ((int)((int)color >> (int)(int)8) & (int)(int)255);
HXLINE( 239)			if (image->get_transparent()) {
HXLINE( 239)				a = ((int)color & (int)(int)255);
            			}
            			else {
HXLINE( 239)				a = (int)255;
            			}
            		}
HXLINE( 242)		bool _hx_tmp;
HXDLIN( 242)		bool _hx_tmp1;
HXDLIN( 242)		bool _hx_tmp2;
HXDLIN( 242)		if ((rect->x == (int)0)) {
HXLINE( 242)			_hx_tmp2 = (rect->y == (int)0);
            		}
            		else {
...
HXLINE( 251)		if ((a < (int)255)) {
HXLINE( 253)			 ::Dynamic image1 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("clearRect",51,35,68,bf),hx::paccDynamic));
HXDLIN( 253)			Float _hx_tmp4 = (rect->x + image->offsetX);
HXDLIN( 253)			Float _hx_tmp5 = (rect->y + image->offsetY);
HXDLIN( 253)			Float _hx_tmp6 = (rect->width + image->offsetX);
HXDLIN( 253)			image1(_hx_tmp4,_hx_tmp5,_hx_tmp6,(rect->height + image->offsetY));
            		}
HXLINE( 256)		if ((a > (int)0)) {
HXLINE( 258)			image->buffer->_hx___srcContext->__SetField(HX_("fillStyle",ae,cb,c4,52),((((((((HX_("rgba(",f4,cc,0d,e8) + r) + HX_(", ",74,26,00,00)) + g) + HX_(", ",74,26,00,00)) + b) + HX_(", ",74,26,00,00)) + ((Float)a / (Float)(int)255)) + HX_(")",29,00,00,00)),hx::paccDynamic);
HXLINE( 259)			 ::Dynamic image2 =  ::Dynamic(image->buffer->_hx___srcContext->__Field(HX_("fillRect",47,45,b9,6c),hx::paccDynamic));
HXDLIN( 259)			Float _hx_tmp7 = (rect->x + image->offsetX);
HXDLIN( 259)			Float _hx_tmp8 = (rect->y + image->offsetY);
HXDLIN( 259)			Float _hx_tmp9 = (rect->width + image->offsetX);
HXDLIN( 259)			image2(_hx_tmp7,_hx_tmp8,_hx_tmp9,(rect->height + image->offsetY));
            		}
...
HXDLIN( 310)			buffer1(buffer->get_src(),(int)0,(int)0,newWidth,newHeight);
            		}
            		else {
...
HXLINE( 318)			buffer->_hx___srcContext->__Field(HX_("drawImage",b7,54,74,85),hx::paccDynamic)(sourceCanvas,(int)0,(int)0,newWidth,newHeight);
            		}
...
HXDLIN( 330)		if ((hx::Mod(x,image->width) == (int)0)) {
HXLINE( 330)			_hx_tmp = (hx::Mod(y,image->height) == (int)0);
            		}
            		else {
