...
HXLINE( 108)		this->_marker = (int)0;
HXLINE(  81)		this->length = (int)0;
HXLINE( 115)		super::__construct();
HXLINE( 117)		this->members = ::cpp::VirtualArray_obj::__new(0);
HXLINE( 118)		this->set_maxSize(::Std_obj::_hx_int(::Math_obj::abs(MaxSize)));
HXLINE( 119)		this->flixelType = (int)2;
            	}
...
HXLINE( 141)			int i = (int)0;
HXLINE( 142)			 ::flixel::FlxBasic basic = null();
HXLINE( 144)			while((i < this->length)){
HXLINE( 146)				::cpp::VirtualArray basic1 = this->members;
HXDLIN( 146)				i = (i + (int)1);
HXDLIN( 146)				basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 161)		int i = (int)0;
HXLINE( 162)		 ::flixel::FlxBasic basic = null();
HXLINE( 164)		while((i < this->length)){
HXLINE( 166)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 166)			i = (i + (int)1);
HXDLIN( 166)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 191)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 191)			i = (i + (int)1);
HXDLIN( 191)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 276)		if ((this->members->indexOf(object,null()) >= (int)0)) {
...
HXDLIN( 291)		if ((this->maxSize > (int)0)) {
...
HXLINE( 334)		if ((this->maxSize > (int)0)) {
...
HXLINE( 344)				::cpp::VirtualArray basic1 = this->members;
HXDLIN( 344)				basic = ( ( ::flixel::FlxBasic)(basic1->__get(this->_marker++)) );
HXLINE( 346)				if ((this->_marker >= this->maxSize)) {
HXLINE( 347)					this->_marker = (int)0;
            				}
...
HXLINE( 367)			 ::Dynamic object1 = null();
HXDLIN( 367)			if (hx::IsNotNull( ObjectFactory )) {
HXLINE( 367)				object1 = ObjectFactory();
HXDLIN( 367)				this->add(object1);
            			}
            			else {
HXLINE( 367)				if (hx::IsNotNull( ObjectClass )) {
HXLINE( 367)					object1 = ::Type_obj::createInstance(ObjectClass,::cpp::VirtualArray_obj::__new(0));
HXDLIN( 367)					this->add(object1);
            				}
            			}
HXDLIN( 367)			return object1;
            		}
...
HXLINE( 398)		if ((index < (int)0)) {
HXLINE( 399)			return null();
            		}
HXLINE( 401)		if (Splice) {
HXLINE( 403)			this->members->splice(index,(int)1);
...
HXDLIN( 452)			return ( (int)(f(a1,a2,a3)) );
            		}
            		HX_END_LOCAL_FUNC2(return)

int Order = __o_Order.Default(-1);
            	HX_STACKFRAME(&_hx_pos_bfa1de30d9ec9fbd_452_sort)
HXDLIN( 452)		 ::Dynamic f = Function;
HXDLIN( 452)		int a1 = Order;
HXDLIN( 452)		 ::Dynamic _hx_tmp =  ::Dynamic(new _hx_Closure_0(f,a1));
...
HXLINE( 466)		int i = (int)0;
HXLINE( 467)		 ::flixel::FlxBasic basic = null();
HXLINE( 469)		while((i < this->length)){
HXLINE( 471)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 471)			i = (i + (int)1);
HXDLIN( 471)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 473)					_hx_tmp = ::Std_obj::is(basic,ObjectClass);
            				}
            				else {
...
HXDLIN( 475)				if (Force) {
HXLINE( 475)					::String _hx_tmp3 = ::Type_obj::getClassName(::Type_obj::getClass(basic));
HXDLIN( 475)					_hx_tmp2 = (_hx_tmp3 != ::Type_obj::getClassName(ObjectClass));
            				}
            				else {
...
HXLINE( 479)				::cpp::VirtualArray _hx_tmp4 = this->members;
HXDLIN( 479)				return _hx_tmp4->__get((i - (int)1));
            			}
            		}
...
HXLINE( 514)		int i = (int)0;
HXLINE( 515)		 ::flixel::FlxBasic basic = null();
HXLINE( 517)		while((i < this->length)){
HXLINE( 519)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 519)			i = (i + (int)1);
HXDLIN( 519)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 541)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 541)			i = (i + (int)1);
HXDLIN( 541)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 558)		int i = (int)0;
HXLINE( 559)		 ::flixel::FlxBasic basic = null();
HXLINE( 561)		while((i < this->length)){
HXLINE( 563)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 563)			i = (i + (int)1);
HXDLIN( 563)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 579)		int i = (int)0;
HXLINE( 580)		int count = (int)-1;
HXLINE( 581)		 ::flixel::FlxBasic basic = null();
HXLINE( 583)		while((i < this->length)){
HXLINE( 585)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 585)			i = (i + (int)1);
HXDLIN( 585)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
HXLINE( 587)			if (hx::IsNotNull( basic )) {
HXLINE( 589)				if ((count < (int)0)) {
HXLINE( 590)					count = (int)0;
            				}
...
HXLINE( 606)		int i = (int)0;
HXLINE( 607)		int count = (int)-1;
HXLINE( 608)		 ::flixel::FlxBasic basic = null();
HXLINE( 610)		while((i < this->length)){
HXLINE( 612)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 612)			i = (i + (int)1);
HXDLIN( 612)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
HXLINE( 614)			if (hx::IsNotNull( basic )) {
HXLINE( 616)				if ((count < (int)0)) {
HXLINE( 617)					count = (int)0;
            				}
HXLINE( 618)				if (!(basic->alive)) {
HXLINE( 619)					count = (count + (int)1);
            				}
            			}
            		}
...
HXLINE( 636)		if ((StartIndex < (int)0)) {
HXLINE( 637)			StartIndex = (int)0;
            		}
HXLINE( 638)		if ((Length <= (int)0)) {
...
HXLINE( 670)		int i = (int)0;
HXLINE( 671)		 ::flixel::FlxBasic basic = null();
HXLINE( 673)		while((i < this->length)){
HXLINE( 675)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 675)			i = (i + (int)1);
HXDLIN( 675)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 689)		int i = (int)0;
HXLINE( 690)		 ::flixel::FlxBasic basic = null();
HXLINE( 692)		while((i < this->length)){
HXLINE( 694)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 694)			i = (i + (int)1);
HXDLIN( 694)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 719)		int i = (int)0;
HXLINE( 720)		 ::flixel::FlxBasic basic = null();
HXLINE( 722)		while((i < this->length)){
HXLINE( 724)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 724)			i = (i + (int)1);
HXDLIN( 724)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 748)		int i = (int)0;
HXLINE( 749)		 ::flixel::FlxBasic basic = null();
HXLINE( 751)		while((i < this->length)){
HXLINE( 753)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 753)			i = (i + (int)1);
HXDLIN( 753)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 777)		int i = (int)0;
HXLINE( 778)		 ::flixel::FlxBasic basic = null();
HXLINE( 780)		while((i < this->length)){
HXLINE( 782)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 782)			i = (i + (int)1);
HXDLIN( 782)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 806)		int i = (int)0;
HXLINE( 807)		 ::flixel::FlxBasic basic = null();
HXLINE( 809)		while((i < this->length)){
HXLINE( 811)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 811)			i = (i + (int)1);
HXDLIN( 811)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 836)		int i = (int)0;
HXLINE( 837)		 ::flixel::FlxBasic basic = null();
HXLINE( 839)		while((i < this->length)){
HXLINE( 841)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 841)			i = (i + (int)1);
HXDLIN( 841)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
...
HXLINE( 852)				if (::Std_obj::is(basic,ObjectClass)) {
...
HXLINE( 861)		this->maxSize = ::Std_obj::_hx_int(::Math_obj::abs(Size));
HXLINE( 863)		if ((this->_marker >= this->maxSize)) {
HXLINE( 864)			this->_marker = (int)0;
            		}
HXLINE( 866)		bool _hx_tmp;
HXDLIN( 866)		bool _hx_tmp1;
HXDLIN( 866)		if ((this->maxSize != (int)0)) {
...
HXLINE( 876)			::cpp::VirtualArray basic1 = this->members;
HXDLIN( 876)			i = (i + (int)1);
HXDLIN( 876)			basic = ( ( ::flixel::FlxBasic)(basic1->__get((i - (int)1))) );
