...
HXLINE(  16)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->STATE_RESTORE = (int)35804;
HXLINE(  15)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_OBJECT_VALID_QCOM = (int)35803;
HXLINE(  14)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_TARGET_QCOM = (int)35802;
HXLINE(  13)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_NUM_LEVELS_QCOM = (int)35801;
HXLINE(  12)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_IMAGE_VALID_QCOM = (int)35800;
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_TYPE_QCOM = (int)35799;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_FORMAT_QCOM = (int)35798;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_INTERNAL_FORMAT_QCOM = (int)35797;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_DEPTH_QCOM = (int)35796;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_HEIGHT_QCOM = (int)35795;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::QCOM_extended_get)(__this) )->TEXTURE_WIDTH_QCOM = (int)35794;
            	}
