...
HX_DEFINE_STACK_FRAME(_hx_pos_c2f85669dc13e38b_174_new,"openfl.events.UncaughtErrorEvent","new",0x17652810,"openfl.events.UncaughtErrorEvent.new","openfl/events/UncaughtErrorEvent.hx",174,0x0dad2340)
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_181_clone,"openfl.events.UncaughtErrorEvent","clone",0x483db70d,"openfl.events.UncaughtErrorEvent.clone","openfl/events/UncaughtErrorEvent.hx",181,0x0dad2340)
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_191_toString,"openfl.events.UncaughtErrorEvent","toString",0x4ef19afc,"openfl.events.UncaughtErrorEvent.toString","openfl/events/UncaughtErrorEvent.hx",191,0x0dad2340)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c2f85669dc13e38b_93_boot,"openfl.events.UncaughtErrorEvent","boot",0x5936e682,"openfl.events.UncaughtErrorEvent.boot","openfl/events/UncaughtErrorEvent.hx",93,0x0dad2340)
namespace openfl{
namespace events{
...
bool cancelable = __o_cancelable.Default(true);
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_174_new)
HXLINE( 175)		super::__construct(type,bubbles,cancelable,null(),null());
HXLINE( 177)		this->error = error;
            	}
...
bool UncaughtErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event UncaughtErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c2f85669dc13e38b_181_clone)
HXLINE( 182)		 ::openfl::events::UncaughtErrorEvent event =  ::openfl::events::UncaughtErrorEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->error);
HXLINE( 183)		event->target = this->target;
HXLINE( 184)		event->currentTarget = this->currentTarget;
HXLINE( 185)		event->eventPhase = this->eventPhase;
HXLINE( 186)		return event;
            	}


::String UncaughtErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_191_toString)
HXDLIN( 191)		return this->_hx___formatToString(HX_("UncaughtErrorEvent",47,72,9a,e0),::Array_obj< ::String >::fromData( _hx_array_data_4614201e_3,4));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c2f85669dc13e38b_93_boot)
HXDLIN(  93)		UNCAUGHT_ERROR = HX_("uncaughtError",f3,98,8b,8b);
            	}
}
