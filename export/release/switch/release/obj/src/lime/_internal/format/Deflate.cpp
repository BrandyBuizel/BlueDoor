...
HXDLIN(  20)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_deflate_compress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
...
HXDLIN(  50)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_deflate_decompress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
