...
HXLINE( 139)		this->_hx___numShaderPasses = (int)1;
...
HXLINE( 164)		int sourceStride = (sourceBitmapData->width * (int)4);
HXLINE( 165)		int destStride = (destBitmapData->width * (int)4);
...
HXDLIN( 172)		int destPixel = (int)0;
HXLINE( 173)		int sourceOffset;
HXDLIN( 173)		int destOffset;
HXLINE( 175)		{
HXLINE( 175)			int _g1 = ::Std_obj::_hx_int(sourceRect->y);
HXDLIN( 175)			int _g = ::Std_obj::_hx_int(sourceRect->height);
HXDLIN( 175)			while((_g1 < _g)){
HXLINE( 175)				_g1 = (_g1 + (int)1);
HXDLIN( 175)				int row = (_g1 - (int)1);
HXLINE( 177)				{
HXLINE( 177)					int _g3 = ::Std_obj::_hx_int(sourceRect->x);
HXDLIN( 177)					int _g2 = ::Std_obj::_hx_int(sourceRect->width);
HXDLIN( 177)					while((_g3 < _g2)){
HXLINE( 177)						_g3 = (_g3 + (int)1);
HXDLIN( 177)						int column = (_g3 - (int)1);
HXLINE( 179)						sourceOffset = ((row * sourceStride) + (column * (int)4));
HXLINE( 180)						destOffset = (((row + offsetX) * destStride) + ((column + offsetY) * (int)4));
HXLINE( 182)						{
HXLINE( 182)							switch((int)(sourceFormat)){
            								case (int)0: {
HXLINE( 182)									int r = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & (int)(int)255);
HXDLIN( 182)									int sourceData1 = sourceData->byteOffset;
HXDLIN( 182)									int g = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData1 + (sourceOffset + (int)1))) & (int)(int)255);
HXDLIN( 182)									int sourceData2 = sourceData->byteOffset;
HXDLIN( 182)									int b = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData2 + (sourceOffset + (int)2))) & (int)(int)255);
HXDLIN( 182)									int sourceData3 = sourceData->byteOffset;
HXDLIN( 182)									sourcePixel = ((int)((int)((int)((int)((int)r & (int)(int)255) << (int)(int)24) | (int)((int)((int)g & (int)(int)255) << (int)(int)16)) | (int)((int)((int)b & (int)(int)255) << (int)(int)8)) | (int)((int)((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData3 + (sourceOffset + (int)3))) & (int)(int)255) & (int)(int)255));
            								}
            								break;
            								case (int)1: {
HXLINE( 182)									int sourceData4 = sourceData->byteOffset;
HXDLIN( 182)									int r1 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData4 + (sourceOffset + (int)1))) & (int)(int)255);
HXDLIN( 182)									int sourceData5 = sourceData->byteOffset;
HXDLIN( 182)									int g1 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData5 + (sourceOffset + (int)2))) & (int)(int)255);
HXDLIN( 182)									int sourceData6 = sourceData->byteOffset;
HXDLIN( 182)									int b1 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData6 + (sourceOffset + (int)3))) & (int)(int)255);
HXDLIN( 182)									sourcePixel = ((int)((int)((int)((int)((int)r1 & (int)(int)255) << (int)(int)24) | (int)((int)((int)g1 & (int)(int)255) << (int)(int)16)) | (int)((int)((int)b1 & (int)(int)255) << (int)(int)8)) | (int)((int)((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & (int)(int)255) & (int)(int)255));
            								}
            								break;
            								case (int)2: {
HXLINE( 182)									int sourceData7 = sourceData->byteOffset;
HXDLIN( 182)									int r2 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData7 + (sourceOffset + (int)2))) & (int)(int)255);
HXDLIN( 182)									int sourceData8 = sourceData->byteOffset;
HXDLIN( 182)									int g2 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData8 + (sourceOffset + (int)1))) & (int)(int)255);
HXDLIN( 182)									int b2 = ((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData->byteOffset + sourceOffset)) & (int)(int)255);
HXDLIN( 182)									int sourceData9 = sourceData->byteOffset;
HXDLIN( 182)									sourcePixel = ((int)((int)((int)((int)((int)r2 & (int)(int)255) << (int)(int)24) | (int)((int)((int)g2 & (int)(int)255) << (int)(int)16)) | (int)((int)((int)b2 & (int)(int)255) << (int)(int)8)) | (int)((int)((int)::__hxcpp_memory_get_byte(sourceData->buffer->b,(sourceData9 + (sourceOffset + (int)3))) & (int)(int)255) & (int)(int)255));
            								}
            								break;
            							}
HXDLIN( 182)							if (sourcePremultiplied) {
HXLINE( 182)								bool _hx_tmp;
HXDLIN( 182)								if ((((int)sourcePixel & (int)(int)255) != (int)0)) {
HXLINE( 182)									_hx_tmp = (((int)sourcePixel & (int)(int)255) != (int)255);
            								}
            								else {
HXLINE( 182)									_hx_tmp = false;
            								}
HXDLIN( 182)								if (_hx_tmp) {
HXLINE( 182)									::lime::math::_RGBA::RGBA_Impl__obj::unmult = ((Float)((Float)255.0) / (Float)((int)sourcePixel & (int)(int)255));
HXDLIN( 182)									{
HXLINE( 182)										 ::lime::utils::ArrayBufferView this1 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 182)										int r3 = ((int)::__hxcpp_memory_get_byte(this1->buffer->b,(this1->byteOffset + ::Math_obj::round((((int)hx::UShr(sourcePixel,(int)24) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & (int)(int)255);
HXDLIN( 182)										 ::lime::utils::ArrayBufferView this2 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 182)										int g3 = ((int)::__hxcpp_memory_get_byte(this2->buffer->b,(this2->byteOffset + ::Math_obj::round((((int)hx::UShr(sourcePixel,(int)16) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & (int)(int)255);
HXDLIN( 182)										 ::lime::utils::ArrayBufferView this3 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___clamp;
HXDLIN( 182)										sourcePixel = ((int)((int)((int)((int)((int)r3 & (int)(int)255) << (int)(int)24) | (int)((int)((int)g3 & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)::__hxcpp_memory_get_byte(this3->buffer->b,(this3->byteOffset + ::Math_obj::round((((int)hx::UShr(sourcePixel,(int)8) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::unmult)))) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)sourcePixel & (int)(int)255) & (int)(int)255));
            									}
            								}
            							}
            						}
HXLINE( 184)						if ((((int)sourcePixel & (int)(int)255) == (int)0)) {
HXLINE( 186)							destPixel = (int)0;
            						}
            						else {
HXLINE( 190)							{
HXLINE( 191)								Float value = (this->_hx___matrix->__get((int)0) * ((int)hx::UShr(sourcePixel,(int)24) & (int)(int)255));
HXDLIN( 191)								Float value1 = (value + (this->_hx___matrix->__get((int)1) * ((int)hx::UShr(sourcePixel,(int)16) & (int)(int)255)));
HXDLIN( 191)								Float value2 = (value1 + (this->_hx___matrix->__get((int)2) * ((int)hx::UShr(sourcePixel,(int)8) & (int)(int)255)));
HXDLIN( 191)								Float value3 = (value2 + (this->_hx___matrix->__get((int)3) * ((int)sourcePixel & (int)(int)255)));
HXLINE( 190)								int value4 = ::Std_obj::_hx_int(::Math_obj::max((int)0,::Math_obj::min((value3 + this->_hx___matrix->__get((int)4)),(int)255)));
HXDLIN( 190)								destPixel = ((int)((int)((int)((int)((int)value4 & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(destPixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(destPixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)destPixel & (int)(int)255) & (int)(int)255));
            							}
HXLINE( 196)							{
HXLINE( 197)								Float value5 = (this->_hx___matrix->__get((int)5) * ((int)hx::UShr(sourcePixel,(int)24) & (int)(int)255));
HXDLIN( 197)								Float value6 = (value5 + (this->_hx___matrix->__get((int)6) * ((int)hx::UShr(sourcePixel,(int)16) & (int)(int)255)));
HXDLIN( 197)								Float value7 = (value6 + (this->_hx___matrix->__get((int)7) * ((int)hx::UShr(sourcePixel,(int)8) & (int)(int)255)));
HXDLIN( 197)								Float value8 = (value7 + (this->_hx___matrix->__get((int)8) * ((int)sourcePixel & (int)(int)255)));
HXLINE( 196)								int value9 = ::Std_obj::_hx_int(::Math_obj::max((int)0,::Math_obj::min((value8 + this->_hx___matrix->__get((int)9)),(int)255)));
HXDLIN( 196)								destPixel = ((int)((int)((int)((int)((int)((int)hx::UShr(destPixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)value9 & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(destPixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)destPixel & (int)(int)255) & (int)(int)255));
            							}
HXLINE( 202)							{
HXLINE( 203)								Float value10 = (this->_hx___matrix->__get((int)10) * ((int)hx::UShr(sourcePixel,(int)24) & (int)(int)255));
HXDLIN( 203)								Float value11 = (value10 + (this->_hx___matrix->__get((int)11) * ((int)hx::UShr(sourcePixel,(int)16) & (int)(int)255)));
HXDLIN( 203)								Float value12 = (value11 + (this->_hx___matrix->__get((int)12) * ((int)hx::UShr(sourcePixel,(int)8) & (int)(int)255)));
HXDLIN( 203)								Float value13 = (value12 + (this->_hx___matrix->__get((int)13) * ((int)sourcePixel & (int)(int)255)));
HXLINE( 202)								int value14 = ::Std_obj::_hx_int(::Math_obj::max((int)0,::Math_obj::min((value13 + this->_hx___matrix->__get((int)14)),(int)255)));
HXDLIN( 202)								destPixel = ((int)((int)((int)((int)((int)((int)hx::UShr(destPixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(destPixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)value14 & (int)(int)255) << (int)(int)8)) | (int)((int)((int)destPixel & (int)(int)255) & (int)(int)255));
            							}
HXLINE( 208)							{
HXLINE( 209)								Float value15 = (this->_hx___matrix->__get((int)15) * ((int)hx::UShr(sourcePixel,(int)24) & (int)(int)255));
HXDLIN( 209)								Float value16 = (value15 + (this->_hx___matrix->__get((int)16) * ((int)hx::UShr(sourcePixel,(int)16) & (int)(int)255)));
HXDLIN( 209)								Float value17 = (value16 + (this->_hx___matrix->__get((int)17) * ((int)hx::UShr(sourcePixel,(int)8) & (int)(int)255)));
HXDLIN( 209)								Float value18 = (value17 + (this->_hx___matrix->__get((int)18) * ((int)sourcePixel & (int)(int)255)));
HXLINE( 208)								int value19 = ::Std_obj::_hx_int(::Math_obj::max((int)0,::Math_obj::min((value18 + this->_hx___matrix->__get((int)19)),(int)255)));
HXDLIN( 208)								destPixel = ((int)((int)((int)((int)((int)((int)hx::UShr(destPixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(destPixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(destPixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)value19 & (int)(int)255));
            							}
            						}
HXLINE( 216)						{
HXLINE( 216)							if (destPremultiplied) {
HXLINE( 216)								if ((((int)destPixel & (int)(int)255) == (int)0)) {
HXLINE( 216)									if ((destPixel != (int)0)) {
HXLINE( 216)										destPixel = (int)0;
            									}
            								}
            								else {
HXLINE( 216)									if ((((int)destPixel & (int)(int)255) != (int)255)) {
HXLINE( 216)										 ::lime::utils::ArrayBufferView this4 = ::lime::math::_RGBA::RGBA_Impl__obj::_hx___alpha16;
HXDLIN( 216)										int this5 = this4->byteOffset;
HXDLIN( 216)										::lime::math::_RGBA::RGBA_Impl__obj::a16 = ::__hxcpp_memory_get_ui32(this4->buffer->b,(this5 + (((int)destPixel & (int)(int)255) * (int)4)));
HXDLIN( 216)										destPixel = ((int)((int)((int)((int)((int)((int)(((int)hx::UShr(destPixel,(int)24) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)(((int)hx::UShr(destPixel,(int)16) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)(((int)hx::UShr(destPixel,(int)8) & (int)(int)255) * ::lime::math::_RGBA::RGBA_Impl__obj::a16) >> (int)(int)16) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)destPixel & (int)(int)255) & (int)(int)255));
            									}
            								}
            							}
HXDLIN( 216)							switch((int)(destFormat)){
            								case (int)0: {
HXLINE( 216)									{
HXLINE( 216)										int val = ((int)hx::UShr(destPixel,(int)24) & (int)(int)255);
HXDLIN( 216)										::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val);
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val1 = ((int)hx::UShr(destPixel,(int)16) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData1 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData1 + (destOffset + (int)1)),val1);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val2 = ((int)hx::UShr(destPixel,(int)8) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData2 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData2 + (destOffset + (int)2)),val2);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val3 = ((int)destPixel & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData3 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData3 + (destOffset + (int)3)),val3);
            										}
            									}
            								}
            								break;
            								case (int)1: {
HXLINE( 216)									{
HXLINE( 216)										int val4 = ((int)destPixel & (int)(int)255);
HXDLIN( 216)										::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val4);
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val5 = ((int)hx::UShr(destPixel,(int)24) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData4 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData4 + (destOffset + (int)1)),val5);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val6 = ((int)hx::UShr(destPixel,(int)16) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData5 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData5 + (destOffset + (int)2)),val6);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val7 = ((int)hx::UShr(destPixel,(int)8) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData6 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData6 + (destOffset + (int)3)),val7);
            										}
            									}
            								}
            								break;
            								case (int)2: {
HXLINE( 216)									{
HXLINE( 216)										int val8 = ((int)hx::UShr(destPixel,(int)8) & (int)(int)255);
HXDLIN( 216)										::__hxcpp_memory_set_byte(destData->buffer->b,(destData->byteOffset + destOffset),val8);
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val9 = ((int)hx::UShr(destPixel,(int)16) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData7 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData7 + (destOffset + (int)1)),val9);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val10 = ((int)hx::UShr(destPixel,(int)24) & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData8 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData8 + (destOffset + (int)2)),val10);
            										}
            									}
HXDLIN( 216)									{
HXLINE( 216)										int val11 = ((int)destPixel & (int)(int)255);
HXDLIN( 216)										{
HXLINE( 216)											int destData9 = destData->byteOffset;
HXDLIN( 216)											::__hxcpp_memory_set_byte(destData->buffer->b,(destData9 + (destOffset + (int)3)),val11);
            										}
            									}
            								}
            								break;
