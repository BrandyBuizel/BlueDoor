...
HXDLIN( 980)		if ((this->s == (int)228)) {
HXLINE( 980)			fullxyzw = (this->sourceMask == (int)15);
            		}
            		else {
...
HXLINE( 985)			int _g = (int)0;
HXDLIN( 985)			while((_g < (int)4)){
HXLINE( 985)				_g = (_g + (int)1);
HXDLIN( 985)				int i = (_g - (int)1);
HXLINE( 988)				int _hx_tmp1 = this->sourceMask;
HXDLIN( 988)				if ((((int)_hx_tmp1 & (int)((int)(int)1 << (int)i)) != (int)0)) {
HXLINE( 990)					int _g1 = this->s;
HXDLIN( 990)					int _g11 = ((int)((int)_g1 >> (int)(i * (int)2)) & (int)(int)3);
HXDLIN( 990)					switch((int)(_g11)){
            						case (int)0: {
...
HXLINE(1007)		if ((this->d == (int)0)) {
HXLINE(1010)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1015)			str = (str + this->o);
HXLINE(1016)			 ::Dynamic indexComponent = HX_("x",78,00,00,00).charCodeAt((int)0);
...
HXLINE(1021)			_hx_tmp2 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
...
HXLINE( 962)		 cpp::Int64Struct a = _hx_int64_shr(v,(int)63);
HXDLIN( 962)		sr->d = _hx_int64_low(_hx_int64_and(a,( ::cpp::Int64Struct((int)1))));
HXLINE( 963)		 cpp::Int64Struct a1 = _hx_int64_shr(v,(int)48);
HXDLIN( 963)		sr->q = _hx_int64_low(_hx_int64_and(a1,( ::cpp::Int64Struct((int)3))));
HXLINE( 964)		 cpp::Int64Struct a2 = _hx_int64_shr(v,(int)40);
HXDLIN( 964)		sr->itype = _hx_int64_low(_hx_int64_and(a2,( ::cpp::Int64Struct((int)15))));
HXLINE( 965)		 cpp::Int64Struct a3 = _hx_int64_shr(v,(int)32);
HXDLIN( 965)		sr->type = _hx_int64_low(_hx_int64_and(a3,( ::cpp::Int64Struct((int)15))));
HXLINE( 966)		 cpp::Int64Struct a4 = _hx_int64_shr(v,(int)24);
HXDLIN( 966)		sr->s = _hx_int64_low(_hx_int64_and(a4,( ::cpp::Int64Struct((int)255))));
HXLINE( 967)		 cpp::Int64Struct a5 = _hx_int64_shr(v,(int)16);
HXDLIN( 967)		sr->o = _hx_int64_low(_hx_int64_and(a5,( ::cpp::Int64Struct((int)255))));
HXLINE( 968)		sr->n = _hx_int64_low(_hx_int64_and(v,( ::cpp::Int64Struct((int)65535))));
