...
HXLINE(  62)			Float _hx_tmp1 = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  62)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,_hx_tmp1,(this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y),(int)80,Text,null(),null()));
HXDLIN(  62)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  62)			 ::flixel::text::FlxText _hx_tmp2 = this->label;
HXDLIN(  62)			_hx_tmp2->set_alpha(this->labelAlphas->__get(this->status));
...
HXDLIN(  74)			_hx_tmp->set_fieldWidth((this->label->frameWidth = ::Std_obj::_hx_int(_hx_tmp1)));
HXLINE(  75)			 ::flixel::text::FlxText _hx_tmp2 = this->label;
HXDLIN(  75)			_hx_tmp2->set_size(::Std_obj::_hx_int(this->label->_defaultFormat->size));
            		}
            	}
...
HXLINE(  83)			Float _hx_tmp = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  83)			this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,_hx_tmp,(this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y),(int)80,Text,null(),null()));
HXLINE(  84)			this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXLINE(  85)			 ::flixel::text::FlxText _hx_tmp1 = this->label;
HXDLIN(  85)			_hx_tmp1->set_alpha(this->labelAlphas->__get(this->status));
...
HXLINE(  99)				Float _hx_tmp = (this->x + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->x);
HXDLIN(  99)				this->set_label( ::flixel::text::FlxText_obj::__alloc( HX_CTX ,_hx_tmp,(this->y + this->labelOffsets->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >()->y),(int)80,Text,null(),null()));
HXDLIN(  99)				this->label->setFormat(null(),(int)8,(int)3355443,HX_("center",d5,25,db,05),null(),null(),null());
HXDLIN(  99)				 ::flixel::text::FlxText _hx_tmp1 = this->label;
HXDLIN(  99)				_hx_tmp1->set_alpha(this->labelAlphas->__get(this->status));
