...
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::EXT_occlusion_query_boolean)(__this) )->QUERY_RESULT_AVAILABLE_EXT = (int)34919;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_occlusion_query_boolean)(__this) )->QUERY_RESULT_EXT = (int)34918;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_occlusion_query_boolean)(__this) )->CURRENT_QUERY_EXT = (int)34917;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_occlusion_query_boolean)(__this) )->ANY_SAMPLES_PASSED_CONSERVATIVE_EXT = (int)36202;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_occlusion_query_boolean)(__this) )->ANY_SAMPLES_PASSED_EXT = (int)35887;
            	}
