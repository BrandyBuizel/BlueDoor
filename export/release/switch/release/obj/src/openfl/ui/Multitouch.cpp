...
HX_LOCAL_STACK_FRAME(_hx_pos_d04537844d94f90f_111___init__,"::openfl::ui::Multitouch_obj","__init__",0xd9e1825c,"::openfl::ui::Multitouch_obj.__init__","openfl/ui/Multitouch.hx",111,0xce42901c)
HX_LOCAL_STACK_FRAME(_hx_pos_0f8b8e224a678ffc_142_get_supportsTouchEvents,"openfl.ui.Multitouch","get_supportsTouchEvents",0x2ba8207f,"openfl.ui.Multitouch.get_supportsTouchEvents","openfl/ui/Multitouch.hx",142,0xce42901c)
namespace openfl{
namespace ui{
...
void Multitouch_obj::__init__(){
            	HX_STACKFRAME(&_hx_pos_d04537844d94f90f_111___init__)
HXLINE( 112)		::openfl::ui::Multitouch_obj::maxTouchPoints = (int)2;
HXLINE( 113)		::openfl::ui::Multitouch_obj::supportedGestures = null();
HXLINE( 114)		::openfl::ui::Multitouch_obj::supportsGestureEvents = false;
HXLINE( 115)		::openfl::ui::Multitouch_obj::inputMode = (int)2;
            	}
...
bool Multitouch_obj::get_supportsTouchEvents(){
            	HX_STACKFRAME(&_hx_pos_0f8b8e224a678ffc_142_get_supportsTouchEvents)
...
static hx::StaticInfo Multitouch_obj_sStaticStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::_Vector::ObjectVector*/ ,(void *) &Multitouch_obj::supportedGestures,HX_HCSTRING("supportedGestures","\x18","\xbe","\xc8","\xbc")},
