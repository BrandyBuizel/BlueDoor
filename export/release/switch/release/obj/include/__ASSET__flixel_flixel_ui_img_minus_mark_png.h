...
class HXCPP_CLASS_ATTRIBUTES __ASSET__flixel_flixel_ui_img_minus_mark_png_obj : public  ::lime::graphics::Image_obj
{
	public:
	...
	public:
		...
		static hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_minus_mark_png_obj > __new( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type);
		static hx::ObjectPtr< __ASSET__flixel_flixel_ui_img_minus_mark_png_obj > __alloc(hx::Ctx *_hx_ctx, ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type);
