...
HXLINE(  32)			_hx_tmp = hx::IsNotEq( length,(int)0 );
            		}
            		else {
HXLINE(  32)			_hx_tmp = false;
            		}
HXDLIN(  32)		if (_hx_tmp) {
HXLINE(  34)			this->set_length(length);
            		}
...
static hx::StorageInfo AudioSource_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::lime::_internal::backend::native::NativeAudioSource*/ ,(int)offsetof(AudioSource_obj,_hx___backend),HX_HCSTRING("__backend","\xf4","\x0c","\xd6","\x7c")},
	{ hx::fsUnknown, 0, null()}
};
