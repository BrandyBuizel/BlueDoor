...
HX_DEFINE_STACK_FRAME(_hx_pos_468ad21a63384077_324_new,"__ASSET__flixel_fonts_monsterrat_ttf","new",0x5ab5a7f2,"__ASSET__flixel_fonts_monsterrat_ttf.new","lime/_internal/macros/AssetsMacro.hx",324,0xc651f030)
...
void __ASSET__flixel_fonts_monsterrat_ttf_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_468ad21a63384077_324_new)
HXLINE( 325)		super::__construct(null());
HXLINE( 327)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(::__ASSET__flixel_fonts_monsterrat_ttf_obj::resourceName));
            	}
...
HXDLIN(   1)		resourceName = HX_("LIME_font___ASSET__flixel_fonts_monsterrat_ttf",c6,95,44,8e);
            	}
}
