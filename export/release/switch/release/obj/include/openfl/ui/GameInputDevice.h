...
class HXCPP_CLASS_ATTRIBUTES GameInputDevice_obj : public hx::Object
{
	...
	public:
		...
		void __construct(::String id,::String name,int npadId);
		...
		static hx::ObjectPtr< GameInputDevice_obj > __new(::String id,::String name,int npadId);
		static hx::ObjectPtr< GameInputDevice_obj > __alloc(hx::Ctx *_hx_ctx,::String id,::String name,int npadId);
