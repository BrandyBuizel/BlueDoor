...
HXLINE(  40)		::flixel::FlxG_obj::cameras->set_bgColor((int)-16777216);
...
HXLINE(  72)		 ::openfl::text::TextFormat dtf =  ::openfl::text::TextFormat_obj::__alloc( HX_CTX ,::flixel::_hx_system::FlxAssets_obj::FONT_DEFAULT,(int)16,(int)16777215,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE(  73)		dtf->align = (int)0;
...
HXLINE( 103)		 ::openfl::display::Sprite _hx_tmp = this->_sprite;
HXDLIN( 103)		_hx_tmp->set_x(((Float)Width / (Float)(int)2));
HXLINE( 104)		 ::openfl::display::Sprite _hx_tmp1 = this->_sprite;
HXDLIN( 104)		_hx_tmp1->set_y((((Float)Height / (Float)(int)2) - ((int)20 * ::flixel::FlxG_obj::game->get_scaleY())));
HXLINE( 106)		 ::openfl::text::TextField _hx_tmp2 = this->_text;
HXDLIN( 106)		_hx_tmp2->set_width(((Float)Width / (Float)::flixel::FlxG_obj::game->get_scaleX()));
HXLINE( 107)		this->_text->set_x((int)0);
HXLINE( 108)		 ::openfl::text::TextField _hx_tmp3 = this->_text;
HXDLIN( 108)		Float _hx_tmp4 = this->_sprite->get_y();
HXDLIN( 108)		_hx_tmp3->set_y((_hx_tmp4 + ((int)80 * ::flixel::FlxG_obj::game->get_scaleY())));
HXLINE( 110)		 ::openfl::display::Sprite _hx_tmp5 = this->_sprite;
HXDLIN( 110)		 ::openfl::text::TextField _hx_tmp6 = this->_text;
HXDLIN( 110)		_hx_tmp5->set_scaleX(_hx_tmp6->set_scaleX(::flixel::FlxG_obj::game->get_scaleX()));
HXLINE( 111)		 ::openfl::display::Sprite _hx_tmp7 = this->_sprite;
HXDLIN( 111)		 ::openfl::text::TextField _hx_tmp8 = this->_text;
HXDLIN( 111)		_hx_tmp7->set_scaleY(_hx_tmp8->set_scaleY(::flixel::FlxG_obj::game->get_scaleY()));
            	}
...
HXLINE( 117)		 ::openfl::text::TextField _hx_tmp = this->_text;
HXDLIN( 117)		_hx_tmp->set_textColor(this->_colors->__get(this->_curPart));
HXLINE( 118)		this->_text->set_text(HX_("HaxeFlixel",42,8f,0c,ac));
HXLINE( 119)		this->_curPart++;
HXLINE( 121)		if ((this->_curPart == (int)5)) {
...
HXLINE( 131)		this->_gfx->beginFill((int)47394,null());
HXLINE( 132)		this->_gfx->moveTo((int)0,(int)-37);
HXLINE( 133)		this->_gfx->lineTo((int)1,(int)-37);
HXLINE( 134)		this->_gfx->lineTo((int)37,(int)0);
HXLINE( 135)		this->_gfx->lineTo((int)37,(int)1);
HXLINE( 136)		this->_gfx->lineTo((int)1,(int)37);
HXLINE( 137)		this->_gfx->lineTo((int)0,(int)37);
HXLINE( 138)		this->_gfx->lineTo((int)-37,(int)1);
HXLINE( 139)		this->_gfx->lineTo((int)-37,(int)0);
HXLINE( 140)		this->_gfx->lineTo((int)0,(int)-37);
...
HXLINE( 146)		this->_gfx->beginFill((int)16761138,null());
HXLINE( 147)		this->_gfx->moveTo((int)-50,(int)-50);
HXLINE( 148)		this->_gfx->lineTo((int)-25,(int)-50);
HXLINE( 149)		this->_gfx->lineTo((int)0,(int)-37);
HXLINE( 150)		this->_gfx->lineTo((int)-37,(int)0);
HXLINE( 151)		this->_gfx->lineTo((int)-50,(int)-25);
HXLINE( 152)		this->_gfx->lineTo((int)-50,(int)-50);
...
HXLINE( 158)		this->_gfx->beginFill((int)16066382,null());
HXLINE( 159)		this->_gfx->moveTo((int)50,(int)-50);
HXLINE( 160)		this->_gfx->lineTo((int)25,(int)-50);
HXLINE( 161)		this->_gfx->lineTo((int)1,(int)-37);
HXLINE( 162)		this->_gfx->lineTo((int)37,(int)0);
HXLINE( 163)		this->_gfx->lineTo((int)50,(int)-25);
HXLINE( 164)		this->_gfx->lineTo((int)50,(int)-50);
...
HXLINE( 170)		this->_gfx->beginFill((int)3555839,null());
HXLINE( 171)		this->_gfx->moveTo((int)-50,(int)50);
HXLINE( 172)		this->_gfx->lineTo((int)-25,(int)50);
HXLINE( 173)		this->_gfx->lineTo((int)0,(int)37);
HXLINE( 174)		this->_gfx->lineTo((int)-37,(int)1);
HXLINE( 175)		this->_gfx->lineTo((int)-50,(int)25);
HXLINE( 176)		this->_gfx->lineTo((int)-50,(int)50);
...
HXLINE( 182)		this->_gfx->beginFill((int)314875,null());
HXLINE( 183)		this->_gfx->moveTo((int)50,(int)50);
HXLINE( 184)		this->_gfx->lineTo((int)25,(int)50);
HXLINE( 185)		this->_gfx->lineTo((int)1,(int)37);
HXLINE( 186)		this->_gfx->lineTo((int)37,(int)1);
HXLINE( 187)		this->_gfx->lineTo((int)50,(int)25);
HXLINE( 188)		this->_gfx->lineTo((int)50,(int)50);
...
static hx::StaticInfo FlxSplash_obj_sStaticStorageInfo[] = {
	...
	{hx::fsBool,(void *) &FlxSplash_obj::muted,HX_HCSTRING("muted","\x6b","\x8f","\x5b","\x10")},
	{ hx::fsUnknown, 0, null()}
};
#endif
