...
HXLINE( 250)		if ((width < (int)0)) {
HXLINE( 250)			width = (int)0;
            		}
            		else {
HXLINE( 250)			width = width;
            		}
HXLINE( 251)		if ((height < (int)0)) {
HXLINE( 251)			height = (int)0;
            		}
            		else {
...
HXLINE( 255)		this->rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,width,height);
...
HXLINE( 264)				if ((((int)fillColor & (int)(int)-16777216) == (int)0)) {
HXLINE( 266)					fillColor = (int)0;
            				}
            			}
            			else {
HXLINE( 271)				fillColor = ((int)(int)-16777216 | (int)((int)fillColor & (int)(int)16777215));
            			}
HXLINE( 274)			fillColor = ((int)((int)fillColor << (int)(int)8) | (int)((int)hx::UShr(fillColor,(int)24) & (int)(int)255));
...
HXLINE( 279)			buffer->format = (int)2;
HXLINE( 280)			buffer->premultiplied = true;
HXLINE( 282)			this->image =  ::lime::graphics::Image_obj::__alloc( HX_CTX ,buffer,(int)0,(int)0,width,height,null(),null());
HXLINE( 284)			if ((fillColor != (int)0)) {
...
HXLINE( 314)		this->_hx___worldAlpha = (int)1;
...
HXLINE( 359)			bitmapData2 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0);
            		}
            		else {
HXLINE( 363)			bitmapData2 = hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 366)		if (needCopyOfOriginal) {
HXLINE( 368)			bitmapData3 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,true,(int)0);
            		}
...
HXLINE( 404)			bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,this->transparent,(int)0);
            		}
            		else {
...
HXLINE( 408)				bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)0,(int)0,this->transparent,(int)0);
...
HXLINE( 493)			{
HXLINE( 493)				int _g1 = (int)0;
HXDLIN( 493)				int _g = bytes->length;
HXDLIN( 493)				while((_g1 < _g)){
HXLINE( 493)					_g1 = (_g1 + (int)1);
HXDLIN( 493)					int i = (_g1 - (int)1);
HXLINE( 495)					int a = ((int)::__hxcpp_memory_get_byte(bytes->buffer->b,(bytes->byteOffset + i)) & (int)(int)255);
HXDLIN( 495)					if (hx::IsNotEq( a,((int)::__hxcpp_memory_get_byte(otherBytes->buffer->b,(otherBytes->byteOffset + i)) & (int)(int)255) )) {
...
HXDLIN( 511)			int _g2 = this->height;
HXDLIN( 511)			while((_g11 < _g2)){
HXLINE( 511)				_g11 = (_g11 + (int)1);
HXDLIN( 511)				int y = (_g11 - (int)1);
HXLINE( 513)				{
HXLINE( 513)					int _g3 = (int)0;
HXDLIN( 513)					int _g21 = this->width;
HXDLIN( 513)					while((_g3 < _g21)){
HXLINE( 513)						_g3 = (_g3 + (int)1);
HXDLIN( 513)						int x = (_g3 - (int)1);
HXLINE( 515)						foundDifference = false;
HXLINE( 517)						pixel = this->getPixel32(x,y);
HXLINE( 518)						otherPixel = otherBitmapData->getPixel32(x,y);
HXLINE( 519)						comparePixel = (int)0;
HXLINE( 521)						if ((pixel != otherPixel)) {
HXLINE( 523)							r = (((int)hx::UShr(pixel,(int)16) & (int)(int)255) - ((int)hx::UShr(otherPixel,(int)16) & (int)(int)255));
HXLINE( 524)							g = (((int)hx::UShr(pixel,(int)8) & (int)(int)255) - ((int)hx::UShr(otherPixel,(int)8) & (int)(int)255));
HXLINE( 525)							b = (((int)pixel & (int)(int)255) - ((int)otherPixel & (int)(int)255));
HXLINE( 527)							if ((r < (int)0)) {
HXLINE( 527)								r = (r * (int)-1);
            							}
HXLINE( 528)							if ((g < (int)0)) {
HXLINE( 528)								g = (g * (int)-1);
            							}
HXLINE( 529)							if ((b < (int)0)) {
HXLINE( 529)								b = (b * (int)-1);
            							}
HXLINE( 531)							bool _hx_tmp4;
HXDLIN( 531)							bool _hx_tmp5;
HXDLIN( 531)							if ((r == (int)0)) {
HXLINE( 531)								_hx_tmp5 = (g == (int)0);
            							}
            							else {
HXLINE( 531)								_hx_tmp5 = false;
            							}
HXDLIN( 531)							if (_hx_tmp5) {
HXLINE( 531)								_hx_tmp4 = (b == (int)0);
            							}
            							else {
HXLINE( 531)								_hx_tmp4 = false;
            							}
HXDLIN( 531)							if (_hx_tmp4) {
HXLINE( 533)								a1 = (((int)hx::UShr(pixel,(int)24) & (int)(int)255) - ((int)hx::UShr(otherPixel,(int)24) & (int)(int)255));
HXLINE( 535)								if ((a1 != (int)0)) {
HXLINE( 537)									comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)(int)16711680) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
HXLINE( 538)									comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)(int)65280) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
HXLINE( 539)									comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)(int)255);
HXLINE( 540)									comparePixel = ((int)((int)((int)((int)((int)a1 & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
HXLINE( 542)									foundDifference = true;
            								}
            							}
            							else {
HXLINE( 547)								comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)r & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
HXLINE( 548)								comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)g & (int)(int)255) << (int)(int)8)) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
HXLINE( 549)								comparePixel = ((int)((int)((int)((int)((int)((int)hx::UShr(comparePixel,(int)24) & (int)(int)255) & (int)(int)255) << (int)(int)24) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)b & (int)(int)255));
HXLINE( 550)								comparePixel = ((int)((int)((int)(int)-16777216 | (int)((int)((int)((int)hx::UShr(comparePixel,(int)16) & (int)(int)255) & (int)(int)255) << (int)(int)16)) | (int)((int)((int)((int)hx::UShr(comparePixel,(int)8) & (int)(int)255) & (int)(int)255) << (int)(int)8)) | (int)((int)((int)comparePixel & (int)(int)255) & (int)(int)255));
...
HXDLIN( 560)								bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,this->width,this->height,bitmapData1,(int)0);
            							}
...
HXLINE( 730)		this->width = (int)0;
HXLINE( 731)		this->height = (int)0;
...
HXLINE( 905)			renderer->_hx___worldAlpha = ((Float)(int)1 / (Float)( (Float)(source->__Field(HX_("__worldAlpha",cc,d2,d6,c5),hx::paccDynamic)) ));
...
HXLINE( 939)				 ::openfl::display::BitmapData copy =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,width,height,true,(int)0);
...
HXLINE( 966)			renderer1->_hx___worldAlpha = ((Float)(int)1 / (Float)( (Float)(source->__Field(HX_("__worldAlpha",cc,d2,d6,c5),hx::paccDynamic)) ));
...
HXDLIN(1083)		if (hx::IsNotEq( quality,(int)2 )) {
...
HXLINE(1112)			 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,(int)0);
...
HXLINE(1119)			matrix->tx = ::Math_obj::round(-(rect->x));
HXLINE(1120)			matrix->ty = ::Math_obj::round(-(rect->y));
HXLINE(1122)			int bitmapData = ::Math_obj::ceil(rect->width);
HXDLIN(1122)			 ::openfl::display::BitmapData bitmapData1 =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,bitmapData,::Math_obj::ceil(rect->height),true,(int)0);
HXLINE(1123)			bitmapData1->draw(hx::ObjectPtr<OBJ_>(this),matrix,null(),null(),null(),null());
HXLINE(1125)			image = bitmapData1->image;
...
HXLINE(1132)			byteArray->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(image->encode(::lime::graphics::ImageFileFormat_obj::PNG_dyn(),null())),(int)0,(int)0);
HXLINE(1133)			return byteArray;
            		}
            		else {
HXLINE(1135)			if (::Std_obj::is(compressor,hx::ClassOf< ::openfl::display::JPEGEncoderOptions >())) {
HXLINE(1137)				byteArray->writeBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(image->encode(::lime::graphics::ImageFileFormat_obj::JPEG_dyn(),hx::TCast<  ::openfl::display::JPEGEncoderOptions >::cast(compressor)->quality)),(int)0,(int)0);
...
HXLINE(1174)		this->image->floodFill(x,y,color,(int)1);
            	}
...
HXDLIN(1388)				if ((centerX != (int)0)) {
HXLINE(1388)					_hx_tmp3 = (centerY != (int)0);
            				}
            				else {
HXLINE(1388)					_hx_tmp3 = false;
            				}
HXDLIN(1388)				if (_hx_tmp3) {
HXLINE(1390)					 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)54,(int)6);
HXDLIN(1390)					this->_hx___indexBufferData = this1;
HXLINE(1401)					{
HXLINE(1401)						 ::lime::utils::ArrayBufferView this2 = this->_hx___indexBufferData;
HXDLIN(1401)						::__hxcpp_memory_set_ui16(this2->buffer->b,this2->byteOffset,(int)0);
            					}
HXLINE(1402)					{
HXLINE(1402)						 ::lime::utils::ArrayBufferView this3 = this->_hx___indexBufferData;
HXDLIN(1402)						::__hxcpp_memory_set_ui16(this3->buffer->b,(this3->byteOffset + (int)2),(int)1);
            					}
HXLINE(1403)					{
HXLINE(1403)						 ::lime::utils::ArrayBufferView this4 = this->_hx___indexBufferData;
HXDLIN(1403)						::__hxcpp_memory_set_ui16(this4->buffer->b,(this4->byteOffset + (int)4),(int)2);
            					}
HXLINE(1404)					{
HXLINE(1404)						 ::lime::utils::ArrayBufferView this5 = this->_hx___indexBufferData;
HXDLIN(1404)						::__hxcpp_memory_set_ui16(this5->buffer->b,(this5->byteOffset + (int)6),(int)2);
            					}
HXLINE(1405)					{
HXLINE(1405)						 ::lime::utils::ArrayBufferView this6 = this->_hx___indexBufferData;
HXDLIN(1405)						::__hxcpp_memory_set_ui16(this6->buffer->b,(this6->byteOffset + (int)8),(int)1);
            					}
HXLINE(1406)					{
HXLINE(1406)						 ::lime::utils::ArrayBufferView this7 = this->_hx___indexBufferData;
HXDLIN(1406)						::__hxcpp_memory_set_ui16(this7->buffer->b,(this7->byteOffset + (int)10),(int)3);
            					}
HXLINE(1409)					{
HXLINE(1409)						 ::lime::utils::ArrayBufferView this8 = this->_hx___indexBufferData;
HXDLIN(1409)						::__hxcpp_memory_set_ui16(this8->buffer->b,(this8->byteOffset + (int)12),(int)4);
            					}
HXLINE(1410)					{
HXLINE(1410)						 ::lime::utils::ArrayBufferView this9 = this->_hx___indexBufferData;
HXDLIN(1410)						::__hxcpp_memory_set_ui16(this9->buffer->b,(this9->byteOffset + (int)14),(int)0);
            					}
HXLINE(1411)					{
HXLINE(1411)						 ::lime::utils::ArrayBufferView this10 = this->_hx___indexBufferData;
HXDLIN(1411)						::__hxcpp_memory_set_ui16(this10->buffer->b,(this10->byteOffset + (int)16),(int)5);
            					}
HXLINE(1412)					{
HXLINE(1412)						 ::lime::utils::ArrayBufferView this11 = this->_hx___indexBufferData;
HXDLIN(1412)						::__hxcpp_memory_set_ui16(this11->buffer->b,(this11->byteOffset + (int)18),(int)5);
            					}
HXLINE(1413)					{
HXLINE(1413)						 ::lime::utils::ArrayBufferView this12 = this->_hx___indexBufferData;
HXDLIN(1413)						::__hxcpp_memory_set_ui16(this12->buffer->b,(this12->byteOffset + (int)20),(int)0);
            					}
HXLINE(1414)					{
HXLINE(1414)						 ::lime::utils::ArrayBufferView this13 = this->_hx___indexBufferData;
HXDLIN(1414)						::__hxcpp_memory_set_ui16(this13->buffer->b,(this13->byteOffset + (int)22),(int)2);
            					}
HXLINE(1417)					{
HXLINE(1417)						 ::lime::utils::ArrayBufferView this14 = this->_hx___indexBufferData;
HXDLIN(1417)						::__hxcpp_memory_set_ui16(this14->buffer->b,(this14->byteOffset + (int)24),(int)6);
            					}
HXLINE(1418)					{
HXLINE(1418)						 ::lime::utils::ArrayBufferView this15 = this->_hx___indexBufferData;
HXDLIN(1418)						::__hxcpp_memory_set_ui16(this15->buffer->b,(this15->byteOffset + (int)26),(int)4);
            					}
HXLINE(1419)					{
HXLINE(1419)						 ::lime::utils::ArrayBufferView this16 = this->_hx___indexBufferData;
HXDLIN(1419)						::__hxcpp_memory_set_ui16(this16->buffer->b,(this16->byteOffset + (int)28),(int)7);
            					}
HXLINE(1420)					{
HXLINE(1420)						 ::lime::utils::ArrayBufferView this17 = this->_hx___indexBufferData;
HXDLIN(1420)						::__hxcpp_memory_set_ui16(this17->buffer->b,(this17->byteOffset + (int)30),(int)7);
            					}
HXLINE(1421)					{
HXLINE(1421)						 ::lime::utils::ArrayBufferView this18 = this->_hx___indexBufferData;
HXDLIN(1421)						::__hxcpp_memory_set_ui16(this18->buffer->b,(this18->byteOffset + (int)32),(int)4);
            					}
HXLINE(1422)					{
HXLINE(1422)						 ::lime::utils::ArrayBufferView this19 = this->_hx___indexBufferData;
HXDLIN(1422)						::__hxcpp_memory_set_ui16(this19->buffer->b,(this19->byteOffset + (int)34),(int)5);
            					}
HXLINE(1425)					{
HXLINE(1425)						 ::lime::utils::ArrayBufferView this20 = this->_hx___indexBufferData;
HXDLIN(1425)						::__hxcpp_memory_set_ui16(this20->buffer->b,(this20->byteOffset + (int)36),(int)8);
            					}
HXLINE(1426)					{
HXLINE(1426)						 ::lime::utils::ArrayBufferView this21 = this->_hx___indexBufferData;
HXDLIN(1426)						::__hxcpp_memory_set_ui16(this21->buffer->b,(this21->byteOffset + (int)38),(int)9);
            					}
HXLINE(1427)					{
HXLINE(1427)						 ::lime::utils::ArrayBufferView this22 = this->_hx___indexBufferData;
HXDLIN(1427)						::__hxcpp_memory_set_ui16(this22->buffer->b,(this22->byteOffset + (int)40),(int)0);
            					}
HXLINE(1428)					{
HXLINE(1428)						 ::lime::utils::ArrayBufferView this23 = this->_hx___indexBufferData;
HXDLIN(1428)						::__hxcpp_memory_set_ui16(this23->buffer->b,(this23->byteOffset + (int)42),(int)0);
            					}
HXLINE(1429)					{
HXLINE(1429)						 ::lime::utils::ArrayBufferView this24 = this->_hx___indexBufferData;
HXDLIN(1429)						::__hxcpp_memory_set_ui16(this24->buffer->b,(this24->byteOffset + (int)44),(int)9);
            					}
HXLINE(1430)					{
HXLINE(1430)						 ::lime::utils::ArrayBufferView this25 = this->_hx___indexBufferData;
HXDLIN(1430)						::__hxcpp_memory_set_ui16(this25->buffer->b,(this25->byteOffset + (int)46),(int)1);
            					}
HXLINE(1433)					{
HXLINE(1433)						 ::lime::utils::ArrayBufferView this26 = this->_hx___indexBufferData;
HXDLIN(1433)						::__hxcpp_memory_set_ui16(this26->buffer->b,(this26->byteOffset + (int)48),(int)10);
            					}
HXLINE(1434)					{
HXLINE(1434)						 ::lime::utils::ArrayBufferView this27 = this->_hx___indexBufferData;
HXDLIN(1434)						::__hxcpp_memory_set_ui16(this27->buffer->b,(this27->byteOffset + (int)50),(int)8);
            					}
HXLINE(1435)					{
HXLINE(1435)						 ::lime::utils::ArrayBufferView this28 = this->_hx___indexBufferData;
HXDLIN(1435)						::__hxcpp_memory_set_ui16(this28->buffer->b,(this28->byteOffset + (int)52),(int)4);
            					}
HXLINE(1436)					{
HXLINE(1436)						 ::lime::utils::ArrayBufferView this29 = this->_hx___indexBufferData;
HXDLIN(1436)						::__hxcpp_memory_set_ui16(this29->buffer->b,(this29->byteOffset + (int)54),(int)4);
            					}
HXLINE(1437)					{
HXLINE(1437)						 ::lime::utils::ArrayBufferView this30 = this->_hx___indexBufferData;
HXDLIN(1437)						::__hxcpp_memory_set_ui16(this30->buffer->b,(this30->byteOffset + (int)56),(int)8);
            					}
HXLINE(1438)					{
HXLINE(1438)						 ::lime::utils::ArrayBufferView this31 = this->_hx___indexBufferData;
HXDLIN(1438)						::__hxcpp_memory_set_ui16(this31->buffer->b,(this31->byteOffset + (int)58),(int)0);
            					}
HXLINE(1441)					{
HXLINE(1441)						 ::lime::utils::ArrayBufferView this32 = this->_hx___indexBufferData;
HXDLIN(1441)						::__hxcpp_memory_set_ui16(this32->buffer->b,(this32->byteOffset + (int)60),(int)11);
            					}
HXLINE(1442)					{
HXLINE(1442)						 ::lime::utils::ArrayBufferView this33 = this->_hx___indexBufferData;
HXDLIN(1442)						::__hxcpp_memory_set_ui16(this33->buffer->b,(this33->byteOffset + (int)62),(int)10);
            					}
HXLINE(1443)					{
HXLINE(1443)						 ::lime::utils::ArrayBufferView this34 = this->_hx___indexBufferData;
HXDLIN(1443)						::__hxcpp_memory_set_ui16(this34->buffer->b,(this34->byteOffset + (int)64),(int)6);
            					}
HXLINE(1444)					{
HXLINE(1444)						 ::lime::utils::ArrayBufferView this35 = this->_hx___indexBufferData;
HXDLIN(1444)						::__hxcpp_memory_set_ui16(this35->buffer->b,(this35->byteOffset + (int)66),(int)6);
            					}
HXLINE(1445)					{
HXLINE(1445)						 ::lime::utils::ArrayBufferView this36 = this->_hx___indexBufferData;
HXDLIN(1445)						::__hxcpp_memory_set_ui16(this36->buffer->b,(this36->byteOffset + (int)68),(int)10);
            					}
HXLINE(1446)					{
HXLINE(1446)						 ::lime::utils::ArrayBufferView this37 = this->_hx___indexBufferData;
HXDLIN(1446)						::__hxcpp_memory_set_ui16(this37->buffer->b,(this37->byteOffset + (int)70),(int)4);
            					}
HXLINE(1449)					{
HXLINE(1449)						 ::lime::utils::ArrayBufferView this38 = this->_hx___indexBufferData;
HXDLIN(1449)						::__hxcpp_memory_set_ui16(this38->buffer->b,(this38->byteOffset + (int)72),(int)12);
            					}
HXLINE(1450)					{
HXLINE(1450)						 ::lime::utils::ArrayBufferView this39 = this->_hx___indexBufferData;
HXDLIN(1450)						::__hxcpp_memory_set_ui16(this39->buffer->b,(this39->byteOffset + (int)74),(int)13);
            					}
HXLINE(1451)					{
HXLINE(1451)						 ::lime::utils::ArrayBufferView this40 = this->_hx___indexBufferData;
HXDLIN(1451)						::__hxcpp_memory_set_ui16(this40->buffer->b,(this40->byteOffset + (int)76),(int)8);
            					}
HXLINE(1452)					{
HXLINE(1452)						 ::lime::utils::ArrayBufferView this41 = this->_hx___indexBufferData;
HXDLIN(1452)						::__hxcpp_memory_set_ui16(this41->buffer->b,(this41->byteOffset + (int)78),(int)8);
            					}
HXLINE(1453)					{
HXLINE(1453)						 ::lime::utils::ArrayBufferView this42 = this->_hx___indexBufferData;
HXDLIN(1453)						::__hxcpp_memory_set_ui16(this42->buffer->b,(this42->byteOffset + (int)80),(int)13);
            					}
HXLINE(1454)					{
HXLINE(1454)						 ::lime::utils::ArrayBufferView this43 = this->_hx___indexBufferData;
HXDLIN(1454)						::__hxcpp_memory_set_ui16(this43->buffer->b,(this43->byteOffset + (int)82),(int)9);
            					}
HXLINE(1457)					{
HXLINE(1457)						 ::lime::utils::ArrayBufferView this44 = this->_hx___indexBufferData;
HXDLIN(1457)						::__hxcpp_memory_set_ui16(this44->buffer->b,(this44->byteOffset + (int)84),(int)14);
            					}
HXLINE(1458)					{
HXLINE(1458)						 ::lime::utils::ArrayBufferView this45 = this->_hx___indexBufferData;
HXDLIN(1458)						::__hxcpp_memory_set_ui16(this45->buffer->b,(this45->byteOffset + (int)86),(int)12);
            					}
HXLINE(1459)					{
HXLINE(1459)						 ::lime::utils::ArrayBufferView this46 = this->_hx___indexBufferData;
HXDLIN(1459)						::__hxcpp_memory_set_ui16(this46->buffer->b,(this46->byteOffset + (int)88),(int)10);
            					}
HXLINE(1460)					{
HXLINE(1460)						 ::lime::utils::ArrayBufferView this47 = this->_hx___indexBufferData;
HXDLIN(1460)						::__hxcpp_memory_set_ui16(this47->buffer->b,(this47->byteOffset + (int)90),(int)10);
            					}
HXLINE(1461)					{
HXLINE(1461)						 ::lime::utils::ArrayBufferView this48 = this->_hx___indexBufferData;
HXDLIN(1461)						::__hxcpp_memory_set_ui16(this48->buffer->b,(this48->byteOffset + (int)92),(int)12);
            					}
HXLINE(1462)					{
HXLINE(1462)						 ::lime::utils::ArrayBufferView this49 = this->_hx___indexBufferData;
HXDLIN(1462)						::__hxcpp_memory_set_ui16(this49->buffer->b,(this49->byteOffset + (int)94),(int)8);
            					}
HXLINE(1465)					{
HXLINE(1465)						 ::lime::utils::ArrayBufferView this50 = this->_hx___indexBufferData;
HXDLIN(1465)						::__hxcpp_memory_set_ui16(this50->buffer->b,(this50->byteOffset + (int)96),(int)15);
            					}
HXLINE(1466)					{
HXLINE(1466)						 ::lime::utils::ArrayBufferView this51 = this->_hx___indexBufferData;
HXDLIN(1466)						::__hxcpp_memory_set_ui16(this51->buffer->b,(this51->byteOffset + (int)98),(int)14);
            					}
HXLINE(1467)					{
HXLINE(1467)						 ::lime::utils::ArrayBufferView this52 = this->_hx___indexBufferData;
HXDLIN(1467)						::__hxcpp_memory_set_ui16(this52->buffer->b,(this52->byteOffset + (int)100),(int)11);
            					}
HXLINE(1468)					{
HXLINE(1468)						 ::lime::utils::ArrayBufferView this53 = this->_hx___indexBufferData;
HXDLIN(1468)						::__hxcpp_memory_set_ui16(this53->buffer->b,(this53->byteOffset + (int)102),(int)11);
            					}
HXLINE(1469)					{
HXLINE(1469)						 ::lime::utils::ArrayBufferView this54 = this->_hx___indexBufferData;
HXDLIN(1469)						::__hxcpp_memory_set_ui16(this54->buffer->b,(this54->byteOffset + (int)104),(int)14);
            					}
HXLINE(1470)					{
HXLINE(1470)						 ::lime::utils::ArrayBufferView this55 = this->_hx___indexBufferData;
HXDLIN(1470)						::__hxcpp_memory_set_ui16(this55->buffer->b,(this55->byteOffset + (int)106),(int)10);
            					}
HXLINE(1472)					this->_hx___indexBuffer = context->createIndexBuffer((int)54,null());
            				}
            				else {
HXLINE(1474)					bool _hx_tmp4;
HXDLIN(1474)					if ((centerX == (int)0)) {
HXLINE(1474)						_hx_tmp4 = (centerY != (int)0);
            					}
            					else {
HXLINE(1474)						_hx_tmp4 = false;
            					}
HXDLIN(1474)					if (_hx_tmp4) {
HXLINE(1476)						 ::lime::utils::ArrayBufferView this56 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)18,(int)6);
HXDLIN(1476)						this->_hx___indexBufferData = this56;
HXLINE(1487)						{
HXLINE(1487)							 ::lime::utils::ArrayBufferView this57 = this->_hx___indexBufferData;
HXDLIN(1487)							::__hxcpp_memory_set_ui16(this57->buffer->b,this57->byteOffset,(int)0);
            						}
HXLINE(1488)						{
HXLINE(1488)							 ::lime::utils::ArrayBufferView this58 = this->_hx___indexBufferData;
HXDLIN(1488)							::__hxcpp_memory_set_ui16(this58->buffer->b,(this58->byteOffset + (int)2),(int)1);
            						}
HXLINE(1489)						{
HXLINE(1489)							 ::lime::utils::ArrayBufferView this59 = this->_hx___indexBufferData;
HXDLIN(1489)							::__hxcpp_memory_set_ui16(this59->buffer->b,(this59->byteOffset + (int)4),(int)2);
            						}
HXLINE(1490)						{
HXLINE(1490)							 ::lime::utils::ArrayBufferView this60 = this->_hx___indexBufferData;
HXDLIN(1490)							::__hxcpp_memory_set_ui16(this60->buffer->b,(this60->byteOffset + (int)6),(int)2);
            						}
HXLINE(1491)						{
HXLINE(1491)							 ::lime::utils::ArrayBufferView this61 = this->_hx___indexBufferData;
HXDLIN(1491)							::__hxcpp_memory_set_ui16(this61->buffer->b,(this61->byteOffset + (int)8),(int)1);
            						}
HXLINE(1492)						{
HXLINE(1492)							 ::lime::utils::ArrayBufferView this62 = this->_hx___indexBufferData;
HXDLIN(1492)							::__hxcpp_memory_set_ui16(this62->buffer->b,(this62->byteOffset + (int)10),(int)3);
            						}
HXLINE(1495)						{
HXLINE(1495)							 ::lime::utils::ArrayBufferView this63 = this->_hx___indexBufferData;
HXDLIN(1495)							::__hxcpp_memory_set_ui16(this63->buffer->b,(this63->byteOffset + (int)12),(int)4);
            						}
HXLINE(1496)						{
HXLINE(1496)							 ::lime::utils::ArrayBufferView this64 = this->_hx___indexBufferData;
HXDLIN(1496)							::__hxcpp_memory_set_ui16(this64->buffer->b,(this64->byteOffset + (int)14),(int)5);
            						}
HXLINE(1497)						{
HXLINE(1497)							 ::lime::utils::ArrayBufferView this65 = this->_hx___indexBufferData;
HXDLIN(1497)							::__hxcpp_memory_set_ui16(this65->buffer->b,(this65->byteOffset + (int)16),(int)0);
            						}
HXLINE(1498)						{
HXLINE(1498)							 ::lime::utils::ArrayBufferView this66 = this->_hx___indexBufferData;
HXDLIN(1498)							::__hxcpp_memory_set_ui16(this66->buffer->b,(this66->byteOffset + (int)18),(int)0);
            						}
HXLINE(1499)						{
HXLINE(1499)							 ::lime::utils::ArrayBufferView this67 = this->_hx___indexBufferData;
HXDLIN(1499)							::__hxcpp_memory_set_ui16(this67->buffer->b,(this67->byteOffset + (int)20),(int)5);
            						}
HXLINE(1500)						{
HXLINE(1500)							 ::lime::utils::ArrayBufferView this68 = this->_hx___indexBufferData;
HXDLIN(1500)							::__hxcpp_memory_set_ui16(this68->buffer->b,(this68->byteOffset + (int)22),(int)1);
            						}
HXLINE(1503)						{
HXLINE(1503)							 ::lime::utils::ArrayBufferView this69 = this->_hx___indexBufferData;
HXDLIN(1503)							::__hxcpp_memory_set_ui16(this69->buffer->b,(this69->byteOffset + (int)24),(int)6);
            						}
HXLINE(1504)						{
HXLINE(1504)							 ::lime::utils::ArrayBufferView this70 = this->_hx___indexBufferData;
HXDLIN(1504)							::__hxcpp_memory_set_ui16(this70->buffer->b,(this70->byteOffset + (int)26),(int)7);
            						}
HXLINE(1505)						{
HXLINE(1505)							 ::lime::utils::ArrayBufferView this71 = this->_hx___indexBufferData;
HXDLIN(1505)							::__hxcpp_memory_set_ui16(this71->buffer->b,(this71->byteOffset + (int)28),(int)4);
            						}
HXLINE(1506)						{
HXLINE(1506)							 ::lime::utils::ArrayBufferView this72 = this->_hx___indexBufferData;
HXDLIN(1506)							::__hxcpp_memory_set_ui16(this72->buffer->b,(this72->byteOffset + (int)30),(int)4);
            						}
HXLINE(1507)						{
HXLINE(1507)							 ::lime::utils::ArrayBufferView this73 = this->_hx___indexBufferData;
HXDLIN(1507)							::__hxcpp_memory_set_ui16(this73->buffer->b,(this73->byteOffset + (int)32),(int)7);
            						}
HXLINE(1508)						{
HXLINE(1508)							 ::lime::utils::ArrayBufferView this74 = this->_hx___indexBufferData;
HXDLIN(1508)							::__hxcpp_memory_set_ui16(this74->buffer->b,(this74->byteOffset + (int)34),(int)5);
            						}
HXLINE(1510)						this->_hx___indexBuffer = context->createIndexBuffer((int)18,null());
            					}
            					else {
HXLINE(1512)						bool _hx_tmp5;
HXDLIN(1512)						if ((centerX != (int)0)) {
HXLINE(1512)							_hx_tmp5 = (centerY == (int)0);
            						}
            						else {
HXLINE(1512)							_hx_tmp5 = false;
            						}
HXDLIN(1512)						if (_hx_tmp5) {
HXLINE(1514)							 ::lime::utils::ArrayBufferView this75 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)18,(int)6);
HXDLIN(1514)							this->_hx___indexBufferData = this75;
HXLINE(1521)							{
HXLINE(1521)								 ::lime::utils::ArrayBufferView this76 = this->_hx___indexBufferData;
HXDLIN(1521)								::__hxcpp_memory_set_ui16(this76->buffer->b,this76->byteOffset,(int)0);
            							}
HXLINE(1522)							{
HXLINE(1522)								 ::lime::utils::ArrayBufferView this77 = this->_hx___indexBufferData;
HXDLIN(1522)								::__hxcpp_memory_set_ui16(this77->buffer->b,(this77->byteOffset + (int)2),(int)1);
            							}
HXLINE(1523)							{
HXLINE(1523)								 ::lime::utils::ArrayBufferView this78 = this->_hx___indexBufferData;
HXDLIN(1523)								::__hxcpp_memory_set_ui16(this78->buffer->b,(this78->byteOffset + (int)4),(int)2);
            							}
HXLINE(1524)							{
HXLINE(1524)								 ::lime::utils::ArrayBufferView this79 = this->_hx___indexBufferData;
HXDLIN(1524)								::__hxcpp_memory_set_ui16(this79->buffer->b,(this79->byteOffset + (int)6),(int)2);
            							}
HXLINE(1525)							{
HXLINE(1525)								 ::lime::utils::ArrayBufferView this80 = this->_hx___indexBufferData;
HXDLIN(1525)								::__hxcpp_memory_set_ui16(this80->buffer->b,(this80->byteOffset + (int)8),(int)1);
            							}
HXLINE(1526)							{
HXLINE(1526)								 ::lime::utils::ArrayBufferView this81 = this->_hx___indexBufferData;
HXDLIN(1526)								::__hxcpp_memory_set_ui16(this81->buffer->b,(this81->byteOffset + (int)10),(int)3);
            							}
HXLINE(1529)							{
HXLINE(1529)								 ::lime::utils::ArrayBufferView this82 = this->_hx___indexBufferData;
HXDLIN(1529)								::__hxcpp_memory_set_ui16(this82->buffer->b,(this82->byteOffset + (int)12),(int)4);
            							}
HXLINE(1530)							{
HXLINE(1530)								 ::lime::utils::ArrayBufferView this83 = this->_hx___indexBufferData;
HXDLIN(1530)								::__hxcpp_memory_set_ui16(this83->buffer->b,(this83->byteOffset + (int)14),(int)0);
            							}
HXLINE(1531)							{
HXLINE(1531)								 ::lime::utils::ArrayBufferView this84 = this->_hx___indexBufferData;
HXDLIN(1531)								::__hxcpp_memory_set_ui16(this84->buffer->b,(this84->byteOffset + (int)16),(int)5);
            							}
HXLINE(1532)							{
HXLINE(1532)								 ::lime::utils::ArrayBufferView this85 = this->_hx___indexBufferData;
HXDLIN(1532)								::__hxcpp_memory_set_ui16(this85->buffer->b,(this85->byteOffset + (int)18),(int)5);
            							}
HXLINE(1533)							{
HXLINE(1533)								 ::lime::utils::ArrayBufferView this86 = this->_hx___indexBufferData;
HXDLIN(1533)								::__hxcpp_memory_set_ui16(this86->buffer->b,(this86->byteOffset + (int)20),(int)0);
            							}
HXLINE(1534)							{
HXLINE(1534)								 ::lime::utils::ArrayBufferView this87 = this->_hx___indexBufferData;
HXDLIN(1534)								::__hxcpp_memory_set_ui16(this87->buffer->b,(this87->byteOffset + (int)22),(int)2);
            							}
HXLINE(1537)							{
HXLINE(1537)								 ::lime::utils::ArrayBufferView this88 = this->_hx___indexBufferData;
HXDLIN(1537)								::__hxcpp_memory_set_ui16(this88->buffer->b,(this88->byteOffset + (int)24),(int)6);
            							}
HXLINE(1538)							{
HXLINE(1538)								 ::lime::utils::ArrayBufferView this89 = this->_hx___indexBufferData;
HXDLIN(1538)								::__hxcpp_memory_set_ui16(this89->buffer->b,(this89->byteOffset + (int)26),(int)4);
            							}
HXLINE(1539)							{
HXLINE(1539)								 ::lime::utils::ArrayBufferView this90 = this->_hx___indexBufferData;
HXDLIN(1539)								::__hxcpp_memory_set_ui16(this90->buffer->b,(this90->byteOffset + (int)28),(int)7);
            							}
HXLINE(1540)							{
HXLINE(1540)								 ::lime::utils::ArrayBufferView this91 = this->_hx___indexBufferData;
HXDLIN(1540)								::__hxcpp_memory_set_ui16(this91->buffer->b,(this91->byteOffset + (int)30),(int)7);
            							}
HXLINE(1541)							{
HXLINE(1541)								 ::lime::utils::ArrayBufferView this92 = this->_hx___indexBufferData;
HXDLIN(1541)								::__hxcpp_memory_set_ui16(this92->buffer->b,(this92->byteOffset + (int)32),(int)4);
            							}
HXLINE(1542)							{
HXLINE(1542)								 ::lime::utils::ArrayBufferView this93 = this->_hx___indexBufferData;
HXDLIN(1542)								::__hxcpp_memory_set_ui16(this93->buffer->b,(this93->byteOffset + (int)34),(int)5);
            							}
HXLINE(1544)							this->_hx___indexBuffer = context->createIndexBuffer((int)18,null());
            						}
            					}
            				}
            			}
...
HXLINE(1554)				 ::lime::utils::ArrayBufferView this94 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)6,(int)6);
HXDLIN(1554)				this->_hx___indexBufferData = this94;
HXLINE(1555)				{
HXLINE(1555)					 ::lime::utils::ArrayBufferView this95 = this->_hx___indexBufferData;
HXDLIN(1555)					::__hxcpp_memory_set_ui16(this95->buffer->b,this95->byteOffset,(int)0);
            				}
HXLINE(1556)				{
HXLINE(1556)					 ::lime::utils::ArrayBufferView this96 = this->_hx___indexBufferData;
HXDLIN(1556)					::__hxcpp_memory_set_ui16(this96->buffer->b,(this96->byteOffset + (int)2),(int)1);
            				}
HXLINE(1557)				{
HXLINE(1557)					 ::lime::utils::ArrayBufferView this97 = this->_hx___indexBufferData;
HXDLIN(1557)					::__hxcpp_memory_set_ui16(this97->buffer->b,(this97->byteOffset + (int)4),(int)2);
            				}
HXLINE(1558)				{
HXLINE(1558)					 ::lime::utils::ArrayBufferView this98 = this->_hx___indexBufferData;
HXDLIN(1558)					::__hxcpp_memory_set_ui16(this98->buffer->b,(this98->byteOffset + (int)6),(int)2);
            				}
HXLINE(1559)				{
HXLINE(1559)					 ::lime::utils::ArrayBufferView this99 = this->_hx___indexBufferData;
HXDLIN(1559)					::__hxcpp_memory_set_ui16(this99->buffer->b,(this99->byteOffset + (int)8),(int)1);
            				}
HXLINE(1560)				{
HXLINE(1560)					 ::lime::utils::ArrayBufferView this100 = this->_hx___indexBufferData;
HXDLIN(1560)					::__hxcpp_memory_set_ui16(this100->buffer->b,(this100->byteOffset + (int)10),(int)3);
            				}
HXLINE(1561)				this->_hx___indexBuffer = context->createIndexBuffer((int)6,null());
            			}
...
HXLINE(1618)			this->_hx___uvRect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->width,this->height);
HXLINE(1620)			int uvWidth = (int)1;
HXLINE(1621)			int uvHeight = (int)1;
...
HXDLIN(1653)				if ((centerX != (int)0)) {
HXLINE(1653)					_hx_tmp11 = (centerY != (int)0);
            				}
            				else {
HXLINE(1653)					_hx_tmp11 = false;
            				}
HXDLIN(1653)				if (_hx_tmp11) {
HXLINE(1655)					 ::lime::utils::ArrayBufferView this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)224,(int)8);
HXDLIN(1655)					this->_hx___vertexBufferData = this1;
HXLINE(1657)					Float left = scale9Grid->x;
HXLINE(1658)					Float top = scale9Grid->y;
HXLINE(1659)					Float right = ((this->width - centerX) - left);
HXLINE(1660)					Float bottom = ((this->height - centerY) - top);
HXLINE(1662)					Float uvLeft = ((Float)left / (Float)this->width);
HXLINE(1663)					Float uvTop = ((Float)top / (Float)this->height);
HXLINE(1664)					Float uvCenterX = ((Float)centerX / (Float)this->width);
HXLINE(1665)					Float uvCenterY = ((Float)centerY / (Float)this->height);
HXLINE(1666)					Float uvRight = ((Float)right / (Float)this->width);
HXLINE(1667)					Float uvBottom = ((Float)bottom / (Float)this->height);
HXLINE(1669)					Float renderedLeft = ((Float)left / (Float)targetObject->get_scaleX());
HXLINE(1670)					Float renderedTop = ((Float)top / (Float)targetObject->get_scaleY());
HXLINE(1671)					Float renderedRight = ((Float)right / (Float)targetObject->get_scaleX());
HXLINE(1672)					Float renderedBottom = ((Float)bottom / (Float)targetObject->get_scaleY());
HXLINE(1673)					Float renderedCenterX = targetObject->get_width();
HXDLIN(1673)					Float renderedCenterX1 = ((((Float)renderedCenterX / (Float)targetObject->get_scaleX()) - renderedLeft) - renderedRight);
HXLINE(1674)					Float renderedCenterY = targetObject->get_height();
HXDLIN(1674)					Float renderedCenterY1 = ((((Float)renderedCenterY / (Float)targetObject->get_scaleY()) - renderedTop) - renderedBottom);
HXLINE(1685)					{
...
HXDLIN(1686)						::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)4),renderedTop);
            					}
HXLINE(1687)					{
HXLINE(1687)						 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN(1687)						Float val = (uvWidth * uvLeft);
HXDLIN(1687)						::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)12),val);
            					}
HXLINE(1688)					{
HXLINE(1688)						 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN(1688)						Float val1 = (uvHeight * uvTop);
HXDLIN(1688)						::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)16),val1);
            					}
HXLINE(1690)					{
HXLINE(1690)						 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN(1690)						::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)60),renderedTop);
            					}
HXLINE(1691)					{
HXLINE(1691)						 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN(1691)						Float val2 = (uvHeight * uvTop);
HXDLIN(1691)						::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)72),val2);
            					}
HXLINE(1693)					{
HXLINE(1693)						 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN(1693)						::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)112),renderedLeft);
            					}
HXLINE(1694)					{
HXLINE(1694)						 ::lime::utils::ArrayBufferView this9 = this->_hx___vertexBufferData;
HXDLIN(1694)						Float val3 = (uvWidth * uvLeft);
HXDLIN(1694)						::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)124),val3);
            					}
HXLINE(1697)					{
...
HXDLIN(1697)						::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + (int)224),val4);
            					}
HXLINE(1698)					{
HXLINE(1698)						 ::lime::utils::ArrayBufferView this11 = this->_hx___vertexBufferData;
HXDLIN(1698)						::__hxcpp_memory_set_float(this11->buffer->b,(this11->byteOffset + (int)228),renderedTop);
            					}
HXLINE(1699)					{
HXLINE(1699)						 ::lime::utils::ArrayBufferView this12 = this->_hx___vertexBufferData;
HXDLIN(1699)						Float val5 = (uvWidth * (uvLeft + uvCenterX));
HXDLIN(1699)						::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + (int)236),val5);
            					}
HXLINE(1700)					{
HXLINE(1700)						 ::lime::utils::ArrayBufferView this13 = this->_hx___vertexBufferData;
HXDLIN(1700)						Float val6 = (uvHeight * uvTop);
HXDLIN(1700)						::__hxcpp_memory_set_float(this13->buffer->b,(this13->byteOffset + (int)240),val6);
            					}
HXLINE(1702)					{
...
HXDLIN(1702)						::__hxcpp_memory_set_float(this14->buffer->b,(this14->byteOffset + (int)280),val7);
            					}
HXLINE(1703)					{
HXLINE(1703)						 ::lime::utils::ArrayBufferView this15 = this->_hx___vertexBufferData;
HXDLIN(1703)						Float val8 = (uvWidth * (uvLeft + uvCenterX));
HXDLIN(1703)						::__hxcpp_memory_set_float(this15->buffer->b,(this15->byteOffset + (int)292),val8);
            					}
HXLINE(1706)					{
HXLINE(1706)						 ::lime::utils::ArrayBufferView this16 = this->_hx___vertexBufferData;
HXDLIN(1706)						Float val9 = this->width;
HXDLIN(1706)						::__hxcpp_memory_set_float(this16->buffer->b,(this16->byteOffset + (int)336),val9);
            					}
HXLINE(1707)					{
HXLINE(1707)						 ::lime::utils::ArrayBufferView this17 = this->_hx___vertexBufferData;
HXDLIN(1707)						::__hxcpp_memory_set_float(this17->buffer->b,(this17->byteOffset + (int)340),renderedTop);
            					}
HXLINE(1708)					{
HXLINE(1708)						 ::lime::utils::ArrayBufferView this18 = this->_hx___vertexBufferData;
HXDLIN(1708)						::__hxcpp_memory_set_float(this18->buffer->b,(this18->byteOffset + (int)348),uvWidth);
            					}
HXLINE(1709)					{
HXLINE(1709)						 ::lime::utils::ArrayBufferView this19 = this->_hx___vertexBufferData;
HXDLIN(1709)						Float val10 = (uvHeight * uvTop);
HXDLIN(1709)						::__hxcpp_memory_set_float(this19->buffer->b,(this19->byteOffset + (int)352),val10);
            					}
HXLINE(1711)					{
HXLINE(1711)						 ::lime::utils::ArrayBufferView this20 = this->_hx___vertexBufferData;
HXDLIN(1711)						Float val11 = this->width;
HXDLIN(1711)						::__hxcpp_memory_set_float(this20->buffer->b,(this20->byteOffset + (int)392),val11);
            					}
HXLINE(1712)					{
HXLINE(1712)						 ::lime::utils::ArrayBufferView this21 = this->_hx___vertexBufferData;
HXDLIN(1712)						::__hxcpp_memory_set_float(this21->buffer->b,(this21->byteOffset + (int)404),uvWidth);
            					}
HXLINE(1715)					{
HXLINE(1715)						 ::lime::utils::ArrayBufferView this22 = this->_hx___vertexBufferData;
HXDLIN(1715)						::__hxcpp_memory_set_float(this22->buffer->b,(this22->byteOffset + (int)448),renderedLeft);
            					}
HXLINE(1716)					{
...
HXDLIN(1716)						::__hxcpp_memory_set_float(this23->buffer->b,(this23->byteOffset + (int)452),val12);
            					}
HXLINE(1717)					{
HXLINE(1717)						 ::lime::utils::ArrayBufferView this24 = this->_hx___vertexBufferData;
HXDLIN(1717)						Float val13 = (uvWidth * uvLeft);
HXDLIN(1717)						::__hxcpp_memory_set_float(this24->buffer->b,(this24->byteOffset + (int)460),val13);
            					}
HXLINE(1718)					{
HXLINE(1718)						 ::lime::utils::ArrayBufferView this25 = this->_hx___vertexBufferData;
HXDLIN(1718)						Float val14 = (uvHeight * (uvTop + uvCenterY));
HXDLIN(1718)						::__hxcpp_memory_set_float(this25->buffer->b,(this25->byteOffset + (int)464),val14);
            					}
HXLINE(1720)					{
...
HXDLIN(1720)						::__hxcpp_memory_set_float(this26->buffer->b,(this26->byteOffset + (int)508),val15);
            					}
HXLINE(1721)					{
HXLINE(1721)						 ::lime::utils::ArrayBufferView this27 = this->_hx___vertexBufferData;
HXDLIN(1721)						Float val16 = (uvHeight * (uvTop + uvCenterY));
HXDLIN(1721)						::__hxcpp_memory_set_float(this27->buffer->b,(this27->byteOffset + (int)520),val16);
            					}
HXLINE(1724)					{
...
HXDLIN(1724)						::__hxcpp_memory_set_float(this28->buffer->b,(this28->byteOffset + (int)560),val17);
            					}
HXLINE(1725)					{
...
HXDLIN(1725)						::__hxcpp_memory_set_float(this29->buffer->b,(this29->byteOffset + (int)564),val18);
            					}
HXLINE(1726)					{
HXLINE(1726)						 ::lime::utils::ArrayBufferView this30 = this->_hx___vertexBufferData;
HXDLIN(1726)						Float val19 = (uvWidth * (uvLeft + uvCenterX));
HXDLIN(1726)						::__hxcpp_memory_set_float(this30->buffer->b,(this30->byteOffset + (int)572),val19);
            					}
HXLINE(1727)					{
HXLINE(1727)						 ::lime::utils::ArrayBufferView this31 = this->_hx___vertexBufferData;
HXDLIN(1727)						Float val20 = (uvHeight * (uvTop + uvCenterY));
HXDLIN(1727)						::__hxcpp_memory_set_float(this31->buffer->b,(this31->byteOffset + (int)576),val20);
            					}
HXLINE(1730)					{
HXLINE(1730)						 ::lime::utils::ArrayBufferView this32 = this->_hx___vertexBufferData;
HXDLIN(1730)						Float val21 = this->width;
HXDLIN(1730)						::__hxcpp_memory_set_float(this32->buffer->b,(this32->byteOffset + (int)616),val21);
            					}
HXLINE(1731)					{
...
HXDLIN(1731)						::__hxcpp_memory_set_float(this33->buffer->b,(this33->byteOffset + (int)620),val22);
            					}
HXLINE(1732)					{
HXLINE(1732)						 ::lime::utils::ArrayBufferView this34 = this->_hx___vertexBufferData;
HXDLIN(1732)						::__hxcpp_memory_set_float(this34->buffer->b,(this34->byteOffset + (int)628),uvWidth);
            					}
HXLINE(1733)					{
HXLINE(1733)						 ::lime::utils::ArrayBufferView this35 = this->_hx___vertexBufferData;
HXDLIN(1733)						Float val23 = (uvHeight * (uvTop + uvCenterY));
HXDLIN(1733)						::__hxcpp_memory_set_float(this35->buffer->b,(this35->byteOffset + (int)632),val23);
            					}
HXLINE(1736)					{
HXLINE(1736)						 ::lime::utils::ArrayBufferView this36 = this->_hx___vertexBufferData;
HXDLIN(1736)						::__hxcpp_memory_set_float(this36->buffer->b,(this36->byteOffset + (int)672),renderedLeft);
            					}
HXLINE(1737)					{
HXLINE(1737)						 ::lime::utils::ArrayBufferView this37 = this->_hx___vertexBufferData;
HXDLIN(1737)						Float val24 = this->height;
HXDLIN(1737)						::__hxcpp_memory_set_float(this37->buffer->b,(this37->byteOffset + (int)676),val24);
            					}
HXLINE(1738)					{
HXLINE(1738)						 ::lime::utils::ArrayBufferView this38 = this->_hx___vertexBufferData;
HXDLIN(1738)						Float val25 = (uvWidth * uvLeft);
HXDLIN(1738)						::__hxcpp_memory_set_float(this38->buffer->b,(this38->byteOffset + (int)684),val25);
            					}
HXLINE(1739)					{
HXLINE(1739)						 ::lime::utils::ArrayBufferView this39 = this->_hx___vertexBufferData;
HXDLIN(1739)						::__hxcpp_memory_set_float(this39->buffer->b,(this39->byteOffset + (int)688),uvHeight);
            					}
HXLINE(1741)					{
HXLINE(1741)						 ::lime::utils::ArrayBufferView this40 = this->_hx___vertexBufferData;
HXDLIN(1741)						Float val26 = this->height;
HXDLIN(1741)						::__hxcpp_memory_set_float(this40->buffer->b,(this40->byteOffset + (int)732),val26);
            					}
HXLINE(1742)					{
HXLINE(1742)						 ::lime::utils::ArrayBufferView this41 = this->_hx___vertexBufferData;
HXDLIN(1742)						::__hxcpp_memory_set_float(this41->buffer->b,(this41->byteOffset + (int)744),uvHeight);
            					}
HXLINE(1745)					{
...
HXDLIN(1745)						::__hxcpp_memory_set_float(this42->buffer->b,(this42->byteOffset + (int)784),val27);
            					}
HXLINE(1746)					{
HXLINE(1746)						 ::lime::utils::ArrayBufferView this43 = this->_hx___vertexBufferData;
HXDLIN(1746)						Float val28 = this->height;
HXDLIN(1746)						::__hxcpp_memory_set_float(this43->buffer->b,(this43->byteOffset + (int)788),val28);
            					}
HXLINE(1747)					{
HXLINE(1747)						 ::lime::utils::ArrayBufferView this44 = this->_hx___vertexBufferData;
HXDLIN(1747)						Float val29 = (uvWidth * (uvLeft + uvCenterX));
HXDLIN(1747)						::__hxcpp_memory_set_float(this44->buffer->b,(this44->byteOffset + (int)796),val29);
            					}
HXLINE(1748)					{
HXLINE(1748)						 ::lime::utils::ArrayBufferView this45 = this->_hx___vertexBufferData;
HXDLIN(1748)						::__hxcpp_memory_set_float(this45->buffer->b,(this45->byteOffset + (int)800),uvHeight);
            					}
HXLINE(1751)					{
HXLINE(1751)						 ::lime::utils::ArrayBufferView this46 = this->_hx___vertexBufferData;
HXDLIN(1751)						Float val30 = this->width;
HXDLIN(1751)						::__hxcpp_memory_set_float(this46->buffer->b,(this46->byteOffset + (int)840),val30);
            					}
HXLINE(1752)					{
HXLINE(1752)						 ::lime::utils::ArrayBufferView this47 = this->_hx___vertexBufferData;
HXDLIN(1752)						Float val31 = this->height;
HXDLIN(1752)						::__hxcpp_memory_set_float(this47->buffer->b,(this47->byteOffset + (int)844),val31);
            					}
HXLINE(1753)					{
HXLINE(1753)						 ::lime::utils::ArrayBufferView this48 = this->_hx___vertexBufferData;
HXDLIN(1753)						::__hxcpp_memory_set_float(this48->buffer->b,(this48->byteOffset + (int)852),uvWidth);
            					}
HXLINE(1754)					{
HXLINE(1754)						 ::lime::utils::ArrayBufferView this49 = this->_hx___vertexBufferData;
HXDLIN(1754)						::__hxcpp_memory_set_float(this49->buffer->b,(this49->byteOffset + (int)856),uvHeight);
            					}
HXLINE(1756)					this->_hx___vertexBuffer = context->createVertexBuffer((int)16,(int)14,null());
            				}
            				else {
HXLINE(1758)					bool _hx_tmp12;
HXDLIN(1758)					if ((centerX == (int)0)) {
HXLINE(1758)						_hx_tmp12 = (centerY != (int)0);
            					}
            					else {
HXLINE(1758)						_hx_tmp12 = false;
            					}
HXDLIN(1758)					if (_hx_tmp12) {
HXLINE(1760)						 ::lime::utils::ArrayBufferView this50 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)112,(int)8);
HXDLIN(1760)						this->_hx___vertexBufferData = this50;
HXLINE(1762)						Float top1 = scale9Grid->y;
HXLINE(1763)						Float bottom1 = ((this->height - centerY) - top1);
HXLINE(1765)						Float uvTop1 = ((Float)top1 / (Float)this->height);
HXLINE(1766)						Float uvCenterY1 = ((Float)centerY / (Float)this->height);
HXLINE(1767)						Float uvBottom1 = ((Float)bottom1 / (Float)this->height);
HXLINE(1769)						Float renderedTop1 = ((Float)top1 / (Float)targetObject->get_scaleY());
HXLINE(1770)						Float renderedBottom1 = ((Float)bottom1 / (Float)targetObject->get_scaleY());
HXLINE(1771)						Float renderedCenterY2 = targetObject->get_height();
HXDLIN(1771)						Float renderedCenterY3 = ((((Float)renderedCenterY2 / (Float)targetObject->get_scaleY()) - renderedTop1) - renderedBottom1);
HXLINE(1773)						Float renderedWidth = targetObject->get_width();
HXDLIN(1773)						Float renderedWidth1 = ((Float)renderedWidth / (Float)targetObject->get_scaleX());
HXLINE(1784)						{
...
HXDLIN(1785)							::__hxcpp_memory_set_float(this52->buffer->b,(this52->byteOffset + (int)4),renderedTop1);
            						}
HXLINE(1786)						{
HXLINE(1786)							 ::lime::utils::ArrayBufferView this53 = this->_hx___vertexBufferData;
HXDLIN(1786)							::__hxcpp_memory_set_float(this53->buffer->b,(this53->byteOffset + (int)12),uvWidth);
            						}
HXLINE(1787)						{
HXLINE(1787)							 ::lime::utils::ArrayBufferView this54 = this->_hx___vertexBufferData;
HXDLIN(1787)							Float val32 = (uvHeight * uvTop1);
HXDLIN(1787)							::__hxcpp_memory_set_float(this54->buffer->b,(this54->byteOffset + (int)16),val32);
            						}
HXLINE(1789)						{
HXLINE(1789)							 ::lime::utils::ArrayBufferView this55 = this->_hx___vertexBufferData;
HXDLIN(1789)							::__hxcpp_memory_set_float(this55->buffer->b,(this55->byteOffset + (int)60),renderedTop1);
            						}
HXLINE(1790)						{
HXLINE(1790)							 ::lime::utils::ArrayBufferView this56 = this->_hx___vertexBufferData;
HXDLIN(1790)							Float val33 = (uvHeight * uvTop1);
HXDLIN(1790)							::__hxcpp_memory_set_float(this56->buffer->b,(this56->byteOffset + (int)72),val33);
            						}
HXLINE(1792)						{
HXLINE(1792)							 ::lime::utils::ArrayBufferView this57 = this->_hx___vertexBufferData;
HXDLIN(1792)							::__hxcpp_memory_set_float(this57->buffer->b,(this57->byteOffset + (int)112),renderedWidth1);
            						}
HXLINE(1793)						{
HXLINE(1793)							 ::lime::utils::ArrayBufferView this58 = this->_hx___vertexBufferData;
HXDLIN(1793)							::__hxcpp_memory_set_float(this58->buffer->b,(this58->byteOffset + (int)124),uvWidth);
            						}
HXLINE(1796)						{
HXLINE(1796)							 ::lime::utils::ArrayBufferView this59 = this->_hx___vertexBufferData;
HXDLIN(1796)							::__hxcpp_memory_set_float(this59->buffer->b,(this59->byteOffset + (int)224),renderedWidth1);
            						}
HXLINE(1797)						{
...
HXDLIN(1797)							::__hxcpp_memory_set_float(this60->buffer->b,(this60->byteOffset + (int)228),val34);
            						}
HXLINE(1798)						{
HXLINE(1798)							 ::lime::utils::ArrayBufferView this61 = this->_hx___vertexBufferData;
HXDLIN(1798)							::__hxcpp_memory_set_float(this61->buffer->b,(this61->byteOffset + (int)236),uvWidth);
            						}
HXLINE(1799)						{
HXLINE(1799)							 ::lime::utils::ArrayBufferView this62 = this->_hx___vertexBufferData;
HXDLIN(1799)							Float val35 = (uvHeight * (uvTop1 + uvCenterY1));
HXDLIN(1799)							::__hxcpp_memory_set_float(this62->buffer->b,(this62->byteOffset + (int)240),val35);
            						}
HXLINE(1801)						{
...
HXDLIN(1801)							::__hxcpp_memory_set_float(this63->buffer->b,(this63->byteOffset + (int)284),val36);
            						}
HXLINE(1802)						{
HXLINE(1802)							 ::lime::utils::ArrayBufferView this64 = this->_hx___vertexBufferData;
HXDLIN(1802)							Float val37 = (uvHeight * (uvTop1 + uvCenterY1));
HXDLIN(1802)							::__hxcpp_memory_set_float(this64->buffer->b,(this64->byteOffset + (int)296),val37);
            						}
HXLINE(1805)						{
HXLINE(1805)							 ::lime::utils::ArrayBufferView this65 = this->_hx___vertexBufferData;
HXDLIN(1805)							::__hxcpp_memory_set_float(this65->buffer->b,(this65->byteOffset + (int)336),renderedWidth1);
            						}
HXLINE(1806)						{
HXLINE(1806)							 ::lime::utils::ArrayBufferView this66 = this->_hx___vertexBufferData;
HXDLIN(1806)							Float val38 = this->height;
HXDLIN(1806)							::__hxcpp_memory_set_float(this66->buffer->b,(this66->byteOffset + (int)340),val38);
            						}
HXLINE(1807)						{
HXLINE(1807)							 ::lime::utils::ArrayBufferView this67 = this->_hx___vertexBufferData;
HXDLIN(1807)							::__hxcpp_memory_set_float(this67->buffer->b,(this67->byteOffset + (int)348),uvWidth);
            						}
HXLINE(1808)						{
HXLINE(1808)							 ::lime::utils::ArrayBufferView this68 = this->_hx___vertexBufferData;
HXDLIN(1808)							::__hxcpp_memory_set_float(this68->buffer->b,(this68->byteOffset + (int)352),uvHeight);
            						}
HXLINE(1810)						{
HXLINE(1810)							 ::lime::utils::ArrayBufferView this69 = this->_hx___vertexBufferData;
HXDLIN(1810)							Float val39 = this->height;
HXDLIN(1810)							::__hxcpp_memory_set_float(this69->buffer->b,(this69->byteOffset + (int)396),val39);
            						}
HXLINE(1811)						{
HXLINE(1811)							 ::lime::utils::ArrayBufferView this70 = this->_hx___vertexBufferData;
HXDLIN(1811)							::__hxcpp_memory_set_float(this70->buffer->b,(this70->byteOffset + (int)408),uvHeight);
            						}
HXLINE(1813)						this->_hx___vertexBuffer = context->createVertexBuffer((int)8,(int)14,null());
            					}
            					else {
HXLINE(1815)						bool _hx_tmp13;
HXDLIN(1815)						if ((centerY == (int)0)) {
HXLINE(1815)							_hx_tmp13 = (centerX != (int)0);
            						}
            						else {
HXLINE(1815)							_hx_tmp13 = false;
            						}
HXDLIN(1815)						if (_hx_tmp13) {
HXLINE(1817)							 ::lime::utils::ArrayBufferView this71 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)112,(int)8);
HXDLIN(1817)							this->_hx___vertexBufferData = this71;
HXLINE(1819)							Float left1 = scale9Grid->x;
HXLINE(1820)							Float right1 = ((this->width - centerX) - left1);
HXLINE(1822)							Float uvLeft1 = ((Float)left1 / (Float)this->width);
HXLINE(1823)							Float uvCenterX1 = ((Float)centerX / (Float)this->width);
HXLINE(1824)							Float uvRight1 = ((Float)right1 / (Float)this->width);
HXLINE(1826)							Float renderedLeft1 = ((Float)left1 / (Float)targetObject->get_scaleX());
HXLINE(1827)							Float renderedRight1 = ((Float)right1 / (Float)targetObject->get_scaleX());
HXLINE(1828)							Float renderedCenterX2 = targetObject->get_width();
HXDLIN(1828)							Float renderedCenterX3 = ((((Float)renderedCenterX2 / (Float)targetObject->get_scaleX()) - renderedLeft1) - renderedRight1);
HXLINE(1830)							Float renderedHeight = targetObject->get_height();
HXDLIN(1830)							Float renderedHeight1 = ((Float)renderedHeight / (Float)targetObject->get_scaleY());
HXLINE(1837)							{
...
HXDLIN(1838)								::__hxcpp_memory_set_float(this73->buffer->b,(this73->byteOffset + (int)4),renderedHeight1);
            							}
HXLINE(1839)							{
HXLINE(1839)								 ::lime::utils::ArrayBufferView this74 = this->_hx___vertexBufferData;
HXDLIN(1839)								Float val40 = (uvWidth * uvLeft1);
HXDLIN(1839)								::__hxcpp_memory_set_float(this74->buffer->b,(this74->byteOffset + (int)12),val40);
            							}
HXLINE(1840)							{
HXLINE(1840)								 ::lime::utils::ArrayBufferView this75 = this->_hx___vertexBufferData;
HXDLIN(1840)								::__hxcpp_memory_set_float(this75->buffer->b,(this75->byteOffset + (int)16),uvHeight);
            							}
HXLINE(1842)							{
HXLINE(1842)								 ::lime::utils::ArrayBufferView this76 = this->_hx___vertexBufferData;
HXDLIN(1842)								::__hxcpp_memory_set_float(this76->buffer->b,(this76->byteOffset + (int)60),renderedHeight1);
            							}
HXLINE(1843)							{
HXLINE(1843)								 ::lime::utils::ArrayBufferView this77 = this->_hx___vertexBufferData;
HXDLIN(1843)								::__hxcpp_memory_set_float(this77->buffer->b,(this77->byteOffset + (int)72),uvHeight);
            							}
HXLINE(1845)							{
HXLINE(1845)								 ::lime::utils::ArrayBufferView this78 = this->_hx___vertexBufferData;
HXDLIN(1845)								::__hxcpp_memory_set_float(this78->buffer->b,(this78->byteOffset + (int)112),renderedLeft1);
            							}
HXLINE(1846)							{
HXLINE(1846)								 ::lime::utils::ArrayBufferView this79 = this->_hx___vertexBufferData;
HXDLIN(1846)								Float val41 = (uvWidth * uvLeft1);
HXDLIN(1846)								::__hxcpp_memory_set_float(this79->buffer->b,(this79->byteOffset + (int)124),val41);
            							}
HXLINE(1849)							{
...
HXDLIN(1849)								::__hxcpp_memory_set_float(this80->buffer->b,(this80->byteOffset + (int)224),val42);
            							}
HXLINE(1850)							{
HXLINE(1850)								 ::lime::utils::ArrayBufferView this81 = this->_hx___vertexBufferData;
HXDLIN(1850)								::__hxcpp_memory_set_float(this81->buffer->b,(this81->byteOffset + (int)228),renderedHeight1);
            							}
HXLINE(1851)							{
HXLINE(1851)								 ::lime::utils::ArrayBufferView this82 = this->_hx___vertexBufferData;
HXDLIN(1851)								Float val43 = (uvWidth * (uvLeft1 + uvCenterX1));
HXDLIN(1851)								::__hxcpp_memory_set_float(this82->buffer->b,(this82->byteOffset + (int)236),val43);
            							}
HXLINE(1852)							{
HXLINE(1852)								 ::lime::utils::ArrayBufferView this83 = this->_hx___vertexBufferData;
HXDLIN(1852)								::__hxcpp_memory_set_float(this83->buffer->b,(this83->byteOffset + (int)240),uvHeight);
            							}
HXLINE(1854)							{
...
HXDLIN(1854)								::__hxcpp_memory_set_float(this84->buffer->b,(this84->byteOffset + (int)280),val44);
            							}
HXLINE(1855)							{
HXLINE(1855)								 ::lime::utils::ArrayBufferView this85 = this->_hx___vertexBufferData;
HXDLIN(1855)								Float val45 = (uvWidth * (uvLeft1 + uvCenterX1));
HXDLIN(1855)								::__hxcpp_memory_set_float(this85->buffer->b,(this85->byteOffset + (int)292),val45);
            							}
HXLINE(1858)							{
HXLINE(1858)								 ::lime::utils::ArrayBufferView this86 = this->_hx___vertexBufferData;
HXDLIN(1858)								Float val46 = this->width;
HXDLIN(1858)								::__hxcpp_memory_set_float(this86->buffer->b,(this86->byteOffset + (int)336),val46);
            							}
HXLINE(1859)							{
HXLINE(1859)								 ::lime::utils::ArrayBufferView this87 = this->_hx___vertexBufferData;
HXDLIN(1859)								::__hxcpp_memory_set_float(this87->buffer->b,(this87->byteOffset + (int)340),renderedHeight1);
            							}
HXLINE(1860)							{
HXLINE(1860)								 ::lime::utils::ArrayBufferView this88 = this->_hx___vertexBufferData;
HXDLIN(1860)								::__hxcpp_memory_set_float(this88->buffer->b,(this88->byteOffset + (int)348),uvWidth);
            							}
HXLINE(1861)							{
HXLINE(1861)								 ::lime::utils::ArrayBufferView this89 = this->_hx___vertexBufferData;
HXDLIN(1861)								::__hxcpp_memory_set_float(this89->buffer->b,(this89->byteOffset + (int)352),uvHeight);
            							}
HXLINE(1863)							{
HXLINE(1863)								 ::lime::utils::ArrayBufferView this90 = this->_hx___vertexBufferData;
HXDLIN(1863)								Float val47 = this->width;
HXDLIN(1863)								::__hxcpp_memory_set_float(this90->buffer->b,(this90->byteOffset + (int)392),val47);
            							}
HXLINE(1864)							{
HXLINE(1864)								 ::lime::utils::ArrayBufferView this91 = this->_hx___vertexBufferData;
HXDLIN(1864)								::__hxcpp_memory_set_float(this91->buffer->b,(this91->byteOffset + (int)404),uvWidth);
            							}
HXLINE(1866)							this->_hx___vertexBuffer = context->createVertexBuffer((int)8,(int)14,null());
            						}
            					}
            				}
            			}
...
HXLINE(1876)				 ::lime::utils::ArrayBufferView this92 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)56,(int)8);
HXDLIN(1876)				this->_hx___vertexBufferData = this92;
HXLINE(1878)				{
HXLINE(1878)					 ::lime::utils::ArrayBufferView this93 = this->_hx___vertexBufferData;
HXDLIN(1878)					Float val48 = this->width;
...
HXDLIN(1879)					Float val49 = this->height;
HXDLIN(1879)					::__hxcpp_memory_set_float(this94->buffer->b,(this94->byteOffset + (int)4),val49);
            				}
HXLINE(1880)				{
HXLINE(1880)					 ::lime::utils::ArrayBufferView this95 = this->_hx___vertexBufferData;
HXDLIN(1880)					::__hxcpp_memory_set_float(this95->buffer->b,(this95->byteOffset + (int)12),uvWidth);
            				}
HXLINE(1881)				{
HXLINE(1881)					 ::lime::utils::ArrayBufferView this96 = this->_hx___vertexBufferData;
HXDLIN(1881)					::__hxcpp_memory_set_float(this96->buffer->b,(this96->byteOffset + (int)16),uvHeight);
            				}
HXLINE(1882)				{
HXLINE(1882)					 ::lime::utils::ArrayBufferView this97 = this->_hx___vertexBufferData;
HXDLIN(1882)					Float val50 = this->height;
HXDLIN(1882)					::__hxcpp_memory_set_float(this97->buffer->b,(this97->byteOffset + (int)60),val50);
            				}
HXLINE(1883)				{
HXLINE(1883)					 ::lime::utils::ArrayBufferView this98 = this->_hx___vertexBufferData;
HXDLIN(1883)					::__hxcpp_memory_set_float(this98->buffer->b,(this98->byteOffset + (int)72),uvHeight);
            				}
HXLINE(1884)				{
HXLINE(1884)					 ::lime::utils::ArrayBufferView this99 = this->_hx___vertexBufferData;
HXDLIN(1884)					Float val51 = this->width;
HXDLIN(1884)					::__hxcpp_memory_set_float(this99->buffer->b,(this99->byteOffset + (int)112),val51);
            				}
HXLINE(1885)				{
HXLINE(1885)					 ::lime::utils::ArrayBufferView this100 = this->_hx___vertexBufferData;
HXDLIN(1885)					::__hxcpp_memory_set_float(this100->buffer->b,(this100->byteOffset + (int)124),uvWidth);
            				}
HXLINE(1887)				this->_hx___vertexBuffer = context->createVertexBuffer((int)3,(int)14,null());
            			}
...
HXLINE(2026)			return  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->width,this->height);
            		}
HXLINE(2028)		bool _hx_tmp;
HXDLIN(2028)		if (!(!(this->transparent))) {
HXLINE(2028)			_hx_tmp = (((int)((int)mask >> (int)(int)24) & (int)(int)255) > (int)0);
            		}
            		else {
...
HXLINE(2031)			if ((((int)hx::UShr(color1,(int)24) & (int)(int)255) == (int)0)) {
HXLINE(2031)				color1 = (int)0;
            			}
            		}
HXLINE(2034)		 ::lime::math::Rectangle rect = this->image->getColorBoundsRect(mask,color,findColor,(int)1);
...
HXLINE(2066)			return (int)0;
            		}
HXLINE(2068)		return this->image->getPixel(x,y,(int)1);
            	}
...
HXLINE(2098)			return (int)0;
            		}
HXLINE(2100)		return this->image->getPixel32(x,y,(int)1);
            	}
...
HXDLIN(2120)		 ::openfl::utils::ByteArrayData byteArray1 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(byteArray->getPixels(rect->_hx___toLimeRectangle(),(int)1));
HXLINE(2122)		byteArray1->_hx___endian = (int)0;
...
HXLINE(2169)			this->_hx___texture = context->createRectangleTexture(this->width,this->height,(int)1,false);
HXLINE(2176)			this->_hx___textureVersion = (int)-1;
            		}
...
HXLINE(2265)			rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,this->width,this->height);
            		}
HXLINE(2266)		 ::openfl::utils::ByteArrayData pixels = this->getPixels(rect);
HXLINE(2267)		::Array< ::Dynamic> _g = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN(2267)		{
HXLINE(2267)			int _g1 = (int)0;
HXDLIN(2267)			while((_g1 < (int)4)){
HXLINE(2267)				_g1 = (_g1 + (int)1);
HXDLIN(2267)				int i = (_g1 - (int)1);
HXDLIN(2267)				::Array< int > _g2 = ::Array_obj< int >::__new(0);
HXDLIN(2267)				{
HXLINE(2267)					int _g3 = (int)0;
HXDLIN(2267)					while((_g3 < (int)256)){
HXLINE(2267)						_g3 = (_g3 + (int)1);
HXDLIN(2267)						int j = (_g3 - (int)1);
HXDLIN(2267)						_g2->push((int)0);
            					}
            				}
HXDLIN(2267)				_g->push(_g2);
            			}
            		}
HXDLIN(2267)		::Array< ::Dynamic> result = _g;
HXLINE(2269)		{
HXLINE(2269)			int _g21 = (int)0;
HXDLIN(2269)			int _g11 = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(pixels);
HXDLIN(2269)			while((_g21 < _g11)){
HXLINE(2269)				_g21 = (_g21 + (int)1);
HXDLIN(2269)				int i1 = (_g21 - (int)1);
HXLINE(2271)				++result->__get(hx::Mod(i1,(int)4)).StaticCast< ::Array< int > >()[pixels->readUnsignedByte()];
            			}
            		}
...
HXLINE(2326)			if (this->rect->contains(x,y)) {
HXLINE(2328)				int pixel = this->getPixel32(x,y);
HXLINE(2330)				if ((((int)((int)pixel >> (int)(int)24) & (int)(int)255) > firstAlphaThreshold)) {
...
HXLINE(2343)					x1 = (int)0;
HXLINE(2344)					y1 = (int)0;
            				}
            				else {
...
HXLINE(2353)				hitRect->setTo(x1,y1,secondBitmapData->width,secondBitmapData->height);
HXLINE(2355)				if (this->rect->intersects(hitRect)) {
HXLINE(2357)					if ((x1 < (int)0)) {
HXLINE(2359)						hitRect->x = (int)0;
HXLINE(2360)						hitRect->width = ::Math_obj::min((secondBitmapData->width + x1),this->width);
            					}
            					else {
HXLINE(2364)						int secondBitmapData1 = secondBitmapData->width;
HXDLIN(2364)						hitRect->width = ::Math_obj::min(secondBitmapData1,(this->width - x1));
            					}
HXLINE(2367)					if ((y1 < (int)0)) {
HXLINE(2369)						hitRect->y = (int)0;
HXLINE(2370)						hitRect->height = ::Math_obj::min((secondBitmapData->height + y1),this->height);
            					}
            					else {
HXLINE(2374)						int secondBitmapData2 = secondBitmapData->height;
HXDLIN(2374)						hitRect->height = ::Math_obj::min(secondBitmapData2,(this->height - y1));
            					}
HXLINE(2377)					 ::openfl::utils::ByteArrayData pixels = this->getPixels(hitRect);
HXLINE(2379)					Float _hx_tmp;
HXDLIN(2379)					if ((x1 < (int)0)) {
HXLINE(2379)						_hx_tmp = -(x1);
            					}
            					else {
HXLINE(2379)						_hx_tmp = (int)0;
            					}
HXDLIN(2379)					hitRect->x = _hx_tmp;
HXLINE(2380)					Float _hx_tmp1;
HXDLIN(2380)					if ((y1 < (int)0)) {
HXLINE(2380)						_hx_tmp1 = -(y1);
            					}
            					else {
HXLINE(2380)						_hx_tmp1 = (int)0;
            					}
...
HXLINE(2387)					{
HXLINE(2387)						int _g1 = (int)0;
HXDLIN(2387)						int _g = length;
HXDLIN(2387)						while((_g1 < _g)){
HXLINE(2387)							_g1 = (_g1 + (int)1);
HXDLIN(2387)							int i = (_g1 - (int)1);
HXLINE(2389)							pixel1 = pixels->readUnsignedInt();
HXLINE(2390)							testPixel = testPixels->readUnsignedInt();
HXLINE(2392)							bool _hx_tmp2;
HXDLIN(2392)							int a = ((int)hx::UShr(pixel1,(int)24) & (int)(int)255);
HXDLIN(2392)							bool aNeg = (a < (int)0);
HXDLIN(2392)							bool bNeg = (firstAlphaThreshold < (int)0);
...
HXLINE(2392)								int a1 = ((int)hx::UShr(testPixel,(int)24) & (int)(int)255);
HXDLIN(2392)								bool aNeg1 = (a1 < (int)0);
HXDLIN(2392)								bool bNeg1 = (secondAlphaThreshold < (int)0);
...
HXLINE(2407)					secondRectangle->_hx___contract((int)0,(int)0,this->width,this->height);
HXLINE(2409)					bool _hx_tmp4;
HXDLIN(2409)					if ((secondRectangle->width > (int)0)) {
HXLINE(2409)						_hx_tmp4 = (secondRectangle->height > (int)0);
            					}
            					else {
...
HXDLIN(2412)						if ((_hx_int < (int)0)) {
HXLINE(2412)							length1 = (((Float)4294967296.0) + _hx_int);
            						}
            						else {
HXLINE(2412)							length1 = (_hx_int + ((Float)0.0));
            						}
HXDLIN(2412)						int int1 = (int)4;
HXDLIN(2412)						Float length2;
HXDLIN(2412)						if ((int1 < (int)0)) {
HXLINE(2412)							length2 = (((Float)4294967296.0) + int1);
            						}
            						else {
HXLINE(2412)							length2 = (int1 + ((Float)0.0));
            						}
HXDLIN(2412)						int length3 = ::Std_obj::_hx_int(((Float)length1 / (Float)length2));
HXLINE(2413)						int pixel2;
HXLINE(2415)						{
HXLINE(2415)							int _g11 = (int)0;
HXDLIN(2415)							int _g2 = length3;
HXDLIN(2415)							while((_g11 < _g2)){
HXLINE(2415)								_g11 = (_g11 + (int)1);
HXDLIN(2415)								int i1 = (_g11 - (int)1);
HXLINE(2417)								pixel2 = pixels1->readUnsignedInt();
HXLINE(2419)								int a2 = ((int)hx::UShr(pixel2,(int)24) & (int)(int)255);
HXDLIN(2419)								bool aNeg2 = (a2 < (int)0);
HXDLIN(2419)								bool bNeg2 = (firstAlphaThreshold < (int)0);
...
HXLINE(2602)			randomSeed1[(int)0] = ((randomSeed1->__get((int)0) * (int)1103515245) + (int)12345);
HXLINE(2603)			return hx::Mod(::Std_obj::_hx_int(::Math_obj::abs(((Float)randomSeed1->__get((int)0) / (Float)(int)65536))),(int)32768);
            		}
...
HXLINE(2611)		bool redChannel = (((int)channelOptions & (int)(int)1) == (int)1);
HXLINE(2612)		bool greenChannel = (((int)((int)channelOptions & (int)(int)2) >> (int)(int)1) == (int)1);
HXLINE(2613)		bool blueChannel = (((int)((int)channelOptions & (int)(int)4) >> (int)(int)2) == (int)1);
HXLINE(2614)		bool alphaChannel = (((int)((int)channelOptions & (int)(int)8) >> (int)(int)3) == (int)1);
HXLINE(2616)		{
HXLINE(2616)			int _g1 = (int)0;
HXDLIN(2616)			int _g = this->height;
HXDLIN(2616)			while((_g1 < _g)){
HXLINE(2616)				_g1 = (_g1 + (int)1);
HXDLIN(2616)				int y = (_g1 - (int)1);
HXLINE(2618)				{
HXLINE(2618)					int _g3 = (int)0;
HXDLIN(2618)					int _g2 = this->width;
HXDLIN(2618)					while((_g3 < _g2)){
HXLINE(2618)						_g3 = (_g3 + (int)1);
HXDLIN(2618)						int x = (_g3 - (int)1);
HXLINE(2621)						int red = (int)0;
HXLINE(2622)						int blue = (int)0;
HXLINE(2623)						int green = (int)0;
HXLINE(2624)						int alpha = (int)255;
HXLINE(2626)						if (grayScale) {
HXLINE(2628)							blue = (low + hx::Mod(( (int)(rand()) ),range));
HXDLIN(2628)							green = blue;
HXDLIN(2628)							red = green;
HXLINE(2629)							alpha = (int)255;
            						}
            						else {
HXLINE(2633)							if (redChannel) {
HXLINE(2633)								red = (low + hx::Mod(( (int)(rand()) ),range));
            							}
HXLINE(2634)							if (greenChannel) {
HXLINE(2634)								green = (low + hx::Mod(( (int)(rand()) ),range));
            							}
HXLINE(2635)							if (blueChannel) {
HXLINE(2635)								blue = (low + hx::Mod(( (int)(rand()) ),range));
            							}
HXLINE(2636)							if (alphaChannel) {
HXLINE(2636)								alpha = (low + hx::Mod(( (int)(rand()) ),range));
            							}
            						}
HXLINE(2639)						int rgb = alpha;
HXLINE(2640)						rgb = (((int)rgb << (int)(int)8) + red);
HXLINE(2641)						rgb = (((int)rgb << (int)(int)8) + green);
HXLINE(2642)						rgb = (((int)rgb << (int)(int)8) + blue);
...
HXLINE(2699)		{
HXLINE(2699)			int _g1 = (int)0;
HXDLIN(2699)			int _g = (sh * sw);
HXDLIN(2699)			while((_g1 < _g)){
HXLINE(2699)				_g1 = (_g1 + (int)1);
HXDLIN(2699)				int i = (_g1 - (int)1);
HXLINE(2701)				pixelValue = pixels->readUnsignedInt();
HXLINE(2703)				if (hx::IsNull( alphaArray )) {
HXLINE(2703)					a = ((int)pixelValue & (int)(int)-16777216);
            				}
            				else {
HXLINE(2703)					a = alphaArray->__get(((int)((int)pixelValue >> (int)(int)24) & (int)(int)255));
            				}
HXLINE(2704)				if (hx::IsNull( redArray )) {
HXLINE(2704)					r = ((int)pixelValue & (int)(int)16711680);
            				}
            				else {
HXLINE(2704)					r = redArray->__get(((int)((int)pixelValue >> (int)(int)16) & (int)(int)255));
            				}
HXLINE(2705)				if (hx::IsNull( greenArray )) {
HXLINE(2705)					g = ((int)pixelValue & (int)(int)65280);
            				}
            				else {
HXLINE(2705)					g = greenArray->__get(((int)((int)pixelValue >> (int)(int)8) & (int)(int)255));
            				}
HXLINE(2706)				if (hx::IsNull( blueArray )) {
HXLINE(2706)					b = ((int)pixelValue & (int)(int)255);
            				}
            				else {
HXLINE(2706)					b = blueArray->__get(((int)pixelValue & (int)(int)255));
            				}
HXLINE(2708)				color = (((a + r) + g) + b);
HXLINE(2710)				pixels->position = (i * (int)4);
HXLINE(2711)				pixels->writeUnsignedInt(color);
            			}
            		}
HXLINE(2714)		pixels->position = (int)0;
HXLINE(2715)		 ::openfl::geom::Rectangle destRect = ::openfl::geom::Rectangle_obj::_hx___pool->get().StaticCast<  ::openfl::geom::Rectangle >();
HXLINE(2716)		destRect->setTo(destPoint->x,destPoint->y,sw,sh);
...
HXLINE(2792)		noise->fill(hx::ObjectPtr<OBJ_>(this),baseX,baseY,(int)0);
            	}
...
HXLINE(2831)		this->image->setPixel(x,y,color,(int)1);
            	}
...
HXLINE(2870)		this->image->setPixel32(x,y,color,(int)1);
            	}
...
HXLINE(2898)			HX_STACK_DO_THROW( ::openfl::errors::Error_obj::__alloc( HX_CTX ,HX_("End of file was encountered.",d3,7b,d9,4f),(int)2030));
            		}
...
HXDLIN(2901)		_hx_tmp2->setPixels(_hx_tmp3,_hx_tmp4,(int)1,::openfl::utils::_Endian::Endian_Impl__obj::toLimeEndian(byteArray->_hx___endian));
            	}
...
HXLINE(2916)		 ::openfl::utils::ByteArrayData this1 =  ::openfl::utils::ByteArrayData_obj::__alloc( HX_CTX ,(int)0);
HXDLIN(2916)		 ::openfl::utils::ByteArrayData byteArray = this1;
HXLINE(2917)		::openfl::utils::_ByteArray::ByteArray_Impl__obj::set_length(byteArray,(inputVector->get_length() * (int)4));
HXLINE(2919)		{
HXLINE(2919)			int _g = (int)0;
HXDLIN(2919)			while((_g < inputVector->get_length())){
HXLINE(2919)				int color = inputVector->get(_g);
HXDLIN(2919)				_g = (_g + (int)1);
HXLINE(2921)				byteArray->writeUnsignedInt(color);
            			}
            		}
HXLINE(2924)		byteArray->position = (int)0;
...
HXDLIN(2991)		return _hx_tmp6->threshold(sourceBitmapData1,_hx_tmp7,destPoint->_hx___toLimeVector2(),operation,threshold,color,mask,copySource,(int)1);
            	}
...
HXLINE(3021)		{
HXLINE(3021)			int _g1 = (int)0;
HXDLIN(3021)			int _g = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::get_length(alpha);
HXDLIN(3021)			while((_g1 < _g)){
HXLINE(3021)				_g1 = (_g1 + (int)1);
HXDLIN(3021)				int i = (_g1 - (int)1);
HXLINE(3023)				{
HXLINE(3023)					int val = alpha->readUnsignedByte();
HXDLIN(3023)					{
HXLINE(3023)						int data1 = data->byteOffset;
HXDLIN(3023)						::__hxcpp_memory_set_byte(data->buffer->b,(data1 + ((i * (int)4) + (int)3)),val);
            					}
            				}
            			}
            		}
...
HXLINE(3062)		buffer->_hx___srcContext->__Field(HX_("setTransform",6a,ed,e2,69),hx::paccDynamic)((int)1,(int)0,(int)0,(int)1,(int)0,(int)0);
...
HXLINE(3098)			_hx_tmp = (((int)color & (int)(int)-16777216) == (int)0);
            		}
            		else {
HXLINE(3098)			_hx_tmp = false;
            		}
HXDLIN(3098)		if (_hx_tmp) {
HXLINE(3100)			color = (int)0;
            		}
...
HXLINE(3125)				_hx_tmp4 = ((Float)((int)hx::UShr(color1,(int)24) & (int)(int)255) / (Float)(int)255);
            			}
            			else {
HXLINE(3125)				_hx_tmp4 = (int)1;
            			}
HXDLIN(3125)			context->clear(((Float)((int)hx::UShr(color1,(int)16) & (int)(int)255) / (Float)(int)255),((Float)((int)hx::UShr(color1,(int)8) & (int)(int)255) / (Float)(int)255),((Float)((int)color1 & (int)(int)255) / (Float)(int)255),_hx_tmp4,(int)0,(int)0,(int)1);
...
HXDLIN(3143)				_hx_tmp5->fillRect(rect->_hx___toLimeRectangle(),color,(int)1);
            			}
            		}
            	}
...
HXLINE(3187)			this->rect =  ::openfl::geom::Rectangle_obj::__alloc( HX_CTX ,(int)0,(int)0,image->width,image->height);
HXLINE(3189)			this->_hx___textureWidth = this->width;
HXLINE(3190)			this->_hx___textureHeight = this->height;
HXLINE(3193)			image->set_format((int)2);
...
HXLINE(3353)				_hx_tmp = (cairo->get_antialias() == (int)1);
            			}
            			else {
HXLINE(3353)				_hx_tmp = true;
            			}
HXDLIN(3353)			if (_hx_tmp) {
HXLINE(3355)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,(int)3);
            			}
            			else {
HXLINE(3359)				::lime::graphics::cairo::_CairoPattern::CairoPattern_Impl__obj::set_filter(pattern,(int)1);
            			}
...
HXLINE(3398)		renderer->_hx___setBlendMode((int)10);
...
HXLINE(3403)		renderer->applyMatrix(renderer->_hx___getMatrix(this->_hx___worldTransform,(int)1));
...
HXLINE(3411)			context->setVertexBufferAt(shader->_hx___position->index,vertexBuffer,(int)0,(int)3);
            		}
HXLINE(3412)		if (hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(3412)			context->setVertexBufferAt(shader->_hx___textureCoord->index,vertexBuffer,(int)3,(int)2);
            		}
...
HXLINE(3431)		renderer->applyMatrix(renderer->_hx___getMatrix(this->_hx___worldTransform,(int)1));
...
HXLINE(3435)			context->setVertexBufferAt(shader->_hx___position->index,vertexBuffer,(int)0,(int)3);
            		}
HXLINE(3436)		if (hx::IsNotNull( shader->_hx___textureCoord )) {
HXLINE(3436)			context->setVertexBufferAt(shader->_hx___textureCoord->index,vertexBuffer,(int)3,(int)2);
            		}
...
HXLINE(3451)		this->rect->width = width;
HXLINE(3452)		this->rect->height = height;
...
HXDLIN(3469)			if ((this->_hx___textureWidth > (int)0)) {
HXLINE(3469)				uvX = ((Float)x / (Float)this->_hx___textureWidth);
            			}
            			else {
HXLINE(3469)				uvX = (int)0;
            			}
HXLINE(3470)			Float uvY;
HXDLIN(3470)			if ((this->_hx___textureHeight > (int)0)) {
HXLINE(3470)				uvY = ((Float)y / (Float)this->_hx___textureHeight);
            			}
            			else {
HXLINE(3470)				uvY = (int)0;
            			}
HXLINE(3471)			Float uvWidth;
HXDLIN(3471)			if ((this->_hx___textureWidth > (int)0)) {
HXLINE(3471)				uvWidth = ((Float)width / (Float)this->_hx___textureWidth);
            			}
            			else {
HXLINE(3471)				uvWidth = (int)0;
            			}
HXLINE(3472)			Float uvHeight;
HXDLIN(3472)			if ((this->_hx___textureHeight > (int)0)) {
HXLINE(3472)				uvHeight = ((Float)height / (Float)this->_hx___textureHeight);
            			}
            			else {
HXLINE(3472)				uvHeight = (int)0;
            			}
HXLINE(3474)			{
...
HXDLIN(3475)				::__hxcpp_memory_set_float(this2->buffer->b,(this2->byteOffset + (int)4),height);
            			}
HXLINE(3476)			{
HXLINE(3476)				 ::lime::utils::ArrayBufferView this3 = this->_hx___vertexBufferData;
HXDLIN(3476)				Float val = (uvX + uvWidth);
HXDLIN(3476)				::__hxcpp_memory_set_float(this3->buffer->b,(this3->byteOffset + (int)12),val);
            			}
HXLINE(3477)			{
HXLINE(3477)				 ::lime::utils::ArrayBufferView this4 = this->_hx___vertexBufferData;
HXDLIN(3477)				Float val1 = (uvY + uvHeight);
HXDLIN(3477)				::__hxcpp_memory_set_float(this4->buffer->b,(this4->byteOffset + (int)16),val1);
            			}
HXLINE(3478)			{
HXLINE(3478)				 ::lime::utils::ArrayBufferView this5 = this->_hx___vertexBufferData;
HXDLIN(3478)				::__hxcpp_memory_set_float(this5->buffer->b,(this5->byteOffset + (int)60),height);
            			}
HXLINE(3479)			{
HXLINE(3479)				 ::lime::utils::ArrayBufferView this6 = this->_hx___vertexBufferData;
HXDLIN(3479)				::__hxcpp_memory_set_float(this6->buffer->b,(this6->byteOffset + (int)68),uvX);
            			}
HXLINE(3480)			{
HXLINE(3480)				 ::lime::utils::ArrayBufferView this7 = this->_hx___vertexBufferData;
HXDLIN(3480)				Float val2 = (uvY + uvHeight);
HXDLIN(3480)				::__hxcpp_memory_set_float(this7->buffer->b,(this7->byteOffset + (int)72),val2);
            			}
HXLINE(3481)			{
HXLINE(3481)				 ::lime::utils::ArrayBufferView this8 = this->_hx___vertexBufferData;
HXDLIN(3481)				::__hxcpp_memory_set_float(this8->buffer->b,(this8->byteOffset + (int)112),width);
            			}
HXLINE(3482)			{
HXLINE(3482)				 ::lime::utils::ArrayBufferView this9 = this->_hx___vertexBufferData;
HXDLIN(3482)				Float val3 = (uvX + uvWidth);
HXDLIN(3482)				::__hxcpp_memory_set_float(this9->buffer->b,(this9->byteOffset + (int)124),val3);
            			}
HXLINE(3483)			{
HXLINE(3483)				 ::lime::utils::ArrayBufferView this10 = this->_hx___vertexBufferData;
HXDLIN(3483)				::__hxcpp_memory_set_float(this10->buffer->b,(this10->byteOffset + (int)128),uvY);
            			}
HXLINE(3484)			{
HXLINE(3484)				 ::lime::utils::ArrayBufferView this11 = this->_hx___vertexBufferData;
HXDLIN(3484)				::__hxcpp_memory_set_float(this11->buffer->b,(this11->byteOffset + (int)180),uvX);
            			}
HXLINE(3485)			{
HXLINE(3485)				 ::lime::utils::ArrayBufferView this12 = this->_hx___vertexBufferData;
HXDLIN(3485)				::__hxcpp_memory_set_float(this12->buffer->b,(this12->byteOffset + (int)184),uvY);
            			}
...
HXLINE(1199)		 ::openfl::display::BitmapData bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)0,(int)0,true,(int)0);
HXLINE(1200)		{
...
HXLINE(1227)		 ::openfl::display::BitmapData bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)0,(int)0,true,(int)0);
HXLINE(1228)		{
...
HXLINE(1275)		 ::openfl::display::BitmapData bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)0,(int)0,true,(int)0);
...
HXLINE(1296)		 ::openfl::display::BitmapData bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,(int)0,(int)0,transparent,(int)0);
...
HXLINE(1317)		 ::openfl::display::BitmapData bitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,texture->_hx___width,texture->_hx___height,true,(int)0);
...
void BitmapData_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("__indexBufferGrid","\x78","\x5a","\x2f","\x69"));
	...
	outFields->push(HX_HCSTRING("__vertexBufferGrid","\x8a","\x57","\x67","\x34"));
	outFields->push(HX_HCSTRING("__vertexBufferHeight","\xab","\x41","\xbc","\x88"));
	outFields->push(HX_HCSTRING("__vertexBufferScaleX","\x52","\x24","\x96","\xc2"));
	outFields->push(HX_HCSTRING("__vertexBufferScaleY","\x53","\x24","\x96","\xc2"));
	outFields->push(HX_HCSTRING("__vertexBufferWidth","\xc2","\xe0","\x77","\xd6"));
...
static hx::StorageInfo BitmapData_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(BitmapData_obj,_hx___indexBufferGrid),HX_HCSTRING("__indexBufferGrid","\x78","\x5a","\x2f","\x69")},
	...
	{hx::fsObject /*::openfl::geom::Rectangle*/ ,(int)offsetof(BitmapData_obj,_hx___vertexBufferGrid),HX_HCSTRING("__vertexBufferGrid","\x8a","\x57","\x67","\x34")},
	{hx::fsFloat,(int)offsetof(BitmapData_obj,_hx___vertexBufferHeight),HX_HCSTRING("__vertexBufferHeight","\xab","\x41","\xbc","\x88")},
	{hx::fsFloat,(int)offsetof(BitmapData_obj,_hx___vertexBufferScaleX),HX_HCSTRING("__vertexBufferScaleX","\x52","\x24","\x96","\xc2")},
	{hx::fsFloat,(int)offsetof(BitmapData_obj,_hx___vertexBufferScaleY),HX_HCSTRING("__vertexBufferScaleY","\x53","\x24","\x96","\xc2")},
	{hx::fsFloat,(int)offsetof(BitmapData_obj,_hx___vertexBufferWidth),HX_HCSTRING("__vertexBufferWidth","\xc2","\xe0","\x77","\xd6")},
...
static hx::StaticInfo BitmapData_obj_sStaticStorageInfo[] = {
	{hx::fsInt,(void *) &BitmapData_obj::VERTEX_BUFFER_STRIDE,HX_HCSTRING("VERTEX_BUFFER_STRIDE","\x5d","\xb3","\xe6","\xc3")},
...
static ::String BitmapData_obj_sMemberFields[] = {
	...
	HX_HCSTRING("__indexBufferGrid","\x78","\x5a","\x2f","\x69"),
	...
	HX_HCSTRING("__vertexBufferGrid","\x8a","\x57","\x67","\x34"),
	HX_HCSTRING("__vertexBufferHeight","\xab","\x41","\xbc","\x88"),
	HX_HCSTRING("__vertexBufferScaleX","\x52","\x24","\x96","\xc2"),
	HX_HCSTRING("__vertexBufferScaleY","\x53","\x24","\x96","\xc2"),
	HX_HCSTRING("__vertexBufferWidth","\xc2","\xe0","\x77","\xd6"),
...
static ::String BitmapData_obj_sStaticFields[] = {
	HX_HCSTRING("VERTEX_BUFFER_STRIDE","\x5d","\xb3","\xe6","\xc3"),
...
HXDLIN( 130)		VERTEX_BUFFER_STRIDE = (int)14;
            	}
{
