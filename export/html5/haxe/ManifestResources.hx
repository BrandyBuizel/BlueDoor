...
@:keep @:dox(hide) class ManifestResources {
	...
	public static function init (config:Dynamic):Void {
		...
		data = '{"name":null,"assets":"aoy4:pathy26:assets%2Fimages%2Ficon.pngy4:sizei101416y4:typey5:IMAGEy2:idR1y7:preloadtgoR0y34:assets%2Fimages%2FpreloaderArt.pngR2i202249R3R4R5R7R6tgoR0y34:assets%2Fimages%2FpreloaderArt.psdR2i3243446R3y6:BINARYR5R8R6tgoR2i41344R3y5:MUSICR5y33:assets%2Fsounds%2FmenuConfirm.mp3y9:pathGroupaR11y33:assets%2Fsounds%2FmenuConfirm.ogghR6tgoR2i8343R3y5:SOUNDR5R13R12aR11R13hgoR2i5842R3R10R5y30:assets%2Fsounds%2FmenuDown.mp3R12aR15y30:assets%2Fsounds%2FmenuDown.ogghR6tgoR2i13167R3R14R5R16R12aR15R16hgoR2i5685R3R10R5y28:assets%2Fsounds%2FmenuUp.mp3R12aR17y28:assets%2Fsounds%2FmenuUp.ogghR6tgoR2i14538R3R14R5R18R12aR17R18hgoR2i2114R3R10R5y26:flixel%2Fsounds%2Fbeep.mp3R12aR19y26:flixel%2Fsounds%2Fbeep.ogghR6tgoR2i39706R3R10R5y28:flixel%2Fsounds%2Fflixel.mp3R12aR21y28:flixel%2Fsounds%2Fflixel.ogghR6tgoR2i5794R3R14R5R20R12aR19R20hgoR2i33629R3R14R5R22R12aR21R22hgoR2i15744R3y4:FONTy9:classNamey35:__ASSET__flixel_fonts_nokiafc22_ttfR5y30:flixel%2Ffonts%2Fnokiafc22.ttfR6tgoR2i29724R3R23R24y36:__ASSET__flixel_fonts_monsterrat_ttfR5y31:flixel%2Ffonts%2Fmonsterrat.ttfR6tgoR0y33:flixel%2Fimages%2Fui%2Fbutton.pngR2i519R3R4R5R29R6tgoR0y36:flixel%2Fimages%2Flogo%2Fdefault.pngR2i3280R3R4R5R30R6tgh","rootPath":null,"version":2,"libraryArgs":[],"libraryType":null}';
...
@:keep @:bind #if display private #end class __ASSET__assets_images_preloaderart_psd extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menuconfirm_mp3 extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menuconfirm_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menudown_mp3 extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menudown_ogg extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menuup_mp3 extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_sounds_menuup_ogg extends null { }
...
@:keep @:image("assets/images/icon.png") #if display private #end class __ASSET__assets_images_icon_png extends lime.graphics.Image {}
@:keep @:image("assets/images/preloaderArt.png") #if display private #end class __ASSET__assets_images_preloaderart_png extends lime.graphics.Image {}
@:keep @:file("assets/images/preloaderArt.psd") #if display private #end class __ASSET__assets_images_preloaderart_psd extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuConfirm.mp3") #if display private #end class __ASSET__assets_sounds_menuconfirm_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuConfirm.ogg") #if display private #end class __ASSET__assets_sounds_menuconfirm_ogg extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuDown.mp3") #if display private #end class __ASSET__assets_sounds_menudown_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuDown.ogg") #if display private #end class __ASSET__assets_sounds_menudown_ogg extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuUp.mp3") #if display private #end class __ASSET__assets_sounds_menuup_mp3 extends haxe.io.Bytes {}
@:keep @:file("assets/sounds/menuUp.ogg") #if display private #end class __ASSET__assets_sounds_menuup_ogg extends haxe.io.Bytes {}
