...
class HXCPP_CLASS_ATTRIBUTES NativeCFFI_obj : public hx::Object
{
	...
	public:
		...
		static ::cpp::Function< int  (int) > lime_gamepad_get_device_npadid;
		static Dynamic lime_gamepad_get_device_npadid_dyn() { return lime_gamepad_get_device_npadid;}
		...
		static ::cpp::Function< int  (int) > lime_joystick_get_device_npadid;
		static Dynamic lime_joystick_get_device_npadid_dyn() { return lime_joystick_get_device_npadid;}
