...
HXLINE(  12)		this->NO_RESET_NOTIFICATION_EXT = (int)33377;
HXLINE(  11)		this->LOSE_CONTEXT_ON_RESET_EXT = (int)33362;
HXLINE(  10)		this->RESET_NOTIFICATION_STRATEGY_EXT = (int)33366;
HXLINE(   9)		this->CONTEXT_ROBUST_ACCESS_EXT = (int)37107;
HXLINE(   8)		this->UNKNOWN_CONTEXT_RESET_EXT = (int)33365;
HXLINE(   7)		this->INNOCENT_CONTEXT_RESET_EXT = (int)33364;
HXLINE(   6)		this->GUILTY_CONTEXT_RESET_EXT = (int)33363;
            	}
