...
HX_DEFINE_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_64_new,"openfl.events.IOErrorEvent","new",0x69722dc1,"openfl.events.IOErrorEvent.new","openfl/events/IOErrorEvent.hx",64,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_68_clone,"openfl.events.IOErrorEvent","clone",0xfbdc4afe,"openfl.events.IOErrorEvent.clone","openfl/events/IOErrorEvent.hx",68,0x9ba976af)
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_78_toString,"openfl.events.IOErrorEvent","toString",0xfbbd53ab,"openfl.events.IOErrorEvent.toString","openfl/events/IOErrorEvent.hx",78,0x9ba976af)
...
HX_LOCAL_STACK_FRAME(_hx_pos_c1a0d6ee9eb05388_35_boot,"openfl.events.IOErrorEvent","boot",0xd28edbb1,"openfl.events.IOErrorEvent.boot","openfl/events/IOErrorEvent.hx",35,0x9ba976af)
namespace openfl{
namespace events{
...
int id = __o_id.Default(0);
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_64_new)
...
bool IOErrorEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event IOErrorEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_68_clone)
...
::String IOErrorEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_78_toString)
HXDLIN(  78)		return this->_hx___formatToString(HX_("IOErrorEvent",b8,16,b3,65),::Array_obj< ::String >::fromData( _hx_array_data_1ffe394f_3,5));
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_c1a0d6ee9eb05388_35_boot)
HXDLIN(  35)		IO_ERROR = HX_("ioError",02,fe,41,76);
            	}
}
