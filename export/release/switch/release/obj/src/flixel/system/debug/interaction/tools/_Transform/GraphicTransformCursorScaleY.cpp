...
HX_LOCAL_STACK_FRAME(_hx_pos_e42292668f5e3f26_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleY","boot",0x345db30d,"flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleY.boot","?",1,0x0000003f)
namespace flixel{
...
bool GraphicTransformCursorScaleY_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28c743a7) {
		...
		return inClassId==(int)0x2c3d89e7;
	}
}
...
void GraphicTransformCursorScaleY_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformCursorScaleY","\x73","\x9f","\xd6","\x3a");
...
{
{
            	HX_STACKFRAME(&_hx_pos_e42292668f5e3f26_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformCursorScaleY",ab,65,6b,08);
            	}
}
