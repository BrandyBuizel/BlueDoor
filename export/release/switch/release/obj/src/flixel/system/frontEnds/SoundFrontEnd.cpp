...
HXLINE( 125)			 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXLINE( 163)		 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
...
HXLINE( 192)		if (::Std_obj::is(EmbeddedSound,hx::ClassOf< ::String >())) {
...
HXLINE( 194)				 ::flixel::_hx_system::frontEnds::LogFrontEnd _this = ::flixel::FlxG_obj::log;
HXDLIN( 194)				EmbeddedSound1 = null();
            			}
...
HXLINE( 231)					_hx_tmp3 = sound->exists;
            				}
            				else {
HXLINE( 231)					_hx_tmp3 = false;
            				}
HXDLIN( 231)				if (_hx_tmp3) {
HXLINE( 231)					_hx_tmp2 = sound->active;
            				}
            				else {
...
HXLINE( 250)					_hx_tmp1 = sound->exists;
            				}
            				else {
...
HXLINE( 272)						_hx_tmp1 = !(sound->persist);
            					}
            					else {
...
HXLINE( 342)		if (::flixel::FlxG_obj::keys->checkKeyArrayState(this->muteKeys,(int)-1)) {
HXLINE( 343)			this->toggleMuted();
            		}
            		else {
HXLINE( 344)			if (::flixel::FlxG_obj::keys->checkKeyArrayState(this->volumeUpKeys,(int)-1)) {
HXLINE( 345)				this->changeVolume(((Float)0.1));
            			}
            			else {
HXLINE( 346)				if (::flixel::FlxG_obj::keys->checkKeyArrayState(this->volumeDownKeys,(int)-1)) {
...
HXLINE( 390)		if (hx::IsNotNull(  ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("volume",da,29,53,5f),hx::paccDynamic)) )) {
HXLINE( 392)			this->set_volume(( (Float)(::flixel::FlxG_obj::save->data->__Field(HX_("volume",da,29,53,5f),hx::paccDynamic)) ));
            		}
HXLINE( 395)		if (hx::IsNotNull(  ::Dynamic(::flixel::FlxG_obj::save->data->__Field(HX_("mute",d9,6e,65,48),hx::paccDynamic)) )) {
...
HXDLIN( 403)		if ((Volume < (int)0)) {
HXLINE( 403)			lowerBound = (int)0;
            		}
            		else {
HXLINE( 403)			lowerBound = Volume;
            		}
HXDLIN( 403)		 ::Dynamic Volume1;
HXDLIN( 403)		if ((lowerBound > (int)1)) {
HXLINE( 403)			Volume1 = (int)1;
            		}
            		else {
HXLINE( 403)			Volume1 = lowerBound;
            		}
HXDLIN( 403)		Volume = Volume1;
HXLINE( 405)		if (hx::IsNotNull( this->volumeHandler )) {
HXLINE( 407)			Float param;
HXDLIN( 407)			if (this->muted) {
HXLINE( 407)				param = (int)0;
            			}
            			else {
