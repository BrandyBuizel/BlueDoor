...
HXLINE(  10)		this->FRAMEBUFFER_ATTACHMENT_COLOR_ENCODING_EXT = (int)33296;
HXLINE(   9)		this->SRGB8_ALPHA8_EXT = (int)35907;
HXLINE(   8)		this->SRGB_ALPHA_EXT = (int)35906;
HXLINE(   7)		this->SRGB_EXT = (int)35904;
            	}
