...
HX_DEFINE_STACK_FRAME(_hx_pos_c2bd5577d2333332_47_new,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool","new",0x20b2a6b8,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool.new","openfl/_internal/macros/AssetsMacro.hx",47,0xf7db08ab)
HX_LOCAL_STACK_FRAME(_hx_pos_d55cc551c1fe4c59_1_boot,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool","boot",0x73b83ada,"flixel.system.debug.interaction.tools._Transform.GraphicTransformTool.boot","?",1,0x0000003f)
namespace flixel{
...
void GraphicTransformTool_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
 ...
 ::Dynamic fillRGBA = __o_fillRGBA.Default(-1);
            	HX_STACKFRAME(&_hx_pos_c2bd5577d2333332_47_new)
...
bool GraphicTransformTool_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x28c743a7) {
		...
		return inClassId==(int)0x6ac5e572;
	}
}
...
void GraphicTransformTool_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("flixel.system.debug.interaction.tools._Transform.GraphicTransformTool","\xc6","\x2a","\xc3","\x0e");
...
{
{
            	HX_STACKFRAME(&_hx_pos_d55cc551c1fe4c59_1_boot)
HXDLIN(   1)		resourceName = HX_("__ASSET__:bitmap_flixel_system_debug_interaction_tools__Transform_GraphicTransformTool",fe,f8,0a,56);
            	}
}
