...
HX_DEFINE_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_41_new,"lime.app._Event_Dynamic_Void","new",0xa035b3a4,"lime.app._Event_Dynamic_Void.new","lime/app/Event.hx",41,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_57_add,"lime.app._Event_Dynamic_Void","add",0xa02bd565,"lime.app._Event_Dynamic_Void.add","lime/app/Event.hx",57,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_81_cancel,"lime.app._Event_Dynamic_Void","cancel",0xb3546cb6,"lime.app._Event_Dynamic_Void.cancel","lime/app/Event.hx",81,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_126_has,"lime.app._Event_Dynamic_Void","has",0xa031229e,"lime.app._Event_Dynamic_Void.has","lime/app/Event.hx",126,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_1c30b4cf7548edbd_142_remove,"lime.app._Event_Dynamic_Void","remove",0xffa91b80,"lime.app._Event_Dynamic_Void.remove","lime/app/Event.hx",142,0xbda45bec)
...
void _Event_Dynamic_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_41_new)
...
bool _Event_Dynamic_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x1d3b9434;
}
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_57_add)
HXLINE(  59)		{
...
void _Event_Dynamic_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_81_cancel)
...
bool _Event_Dynamic_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_126_has)
HXLINE( 128)		{
...
void _Event_Dynamic_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_1c30b4cf7548edbd_142_remove)
...
static hx::StorageInfo _Event_Dynamic_Void_obj_sMemberStorageInfo[] = {
	...
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(_Event_Dynamic_Void_obj,_hx___listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
...
static void _Event_Dynamic_Void_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(_Event_Dynamic_Void_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void _Event_Dynamic_Void_obj_sVisitStatics(HX_VISIT_PARAMS) {
...
{
	hx::Object *dummy = new _Event_Dynamic_Void_obj;
	_Event_Dynamic_Void_obj::_hx_vtable = *(void **)dummy;
	...
	__mClass->mMarkFunc = _Event_Dynamic_Void_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = _Event_Dynamic_Void_obj_sVisitStatics;
#endif
