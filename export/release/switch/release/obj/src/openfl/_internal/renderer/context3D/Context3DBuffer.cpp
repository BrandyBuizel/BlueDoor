...
HXLINE(  34)		this->indexCount = (int)0;
HXLINE(  35)		this->vertexCount = (int)0;
...
HXDLIN(  42)		if ((this->indexCount != (int)0)) {
HXLINE(  42)			_hx_tmp = (this->vertexCount == (int)0);
            		}
            		else {
...
HXLINE(  44)		{
HXLINE(  44)			 ::openfl::_internal::renderer::context3D::Context3DElementType _g = this->elementType;
HXDLIN(  44)			if ((_hx_getEnumValueIndex(_g) == (int)0)) {
HXLINE(  47)				if ((length == (int)-1)) {
HXLINE(  47)					length = (this->elementCount * (int)2);
            				}
HXLINE(  49)				bool _hx_tmp1;
HXDLIN(  49)				if ((start < (int)10922)) {
HXLINE(  49)					_hx_tmp1 = ((length - start) < (int)10922);
            				}
            				else {
HXLINE(  49)					_hx_tmp1 = false;
            				}
HXDLIN(  49)				if (_hx_tmp1) {
HXLINE(  51)					 ::openfl::display3D::Context3D _hx_tmp2 = this->context3D;
HXDLIN(  51)					 ::openfl::display3D::IndexBuffer3D _hx_tmp3 = this->indexBuffers->__get((int)0).StaticCast<  ::openfl::display3D::IndexBuffer3D >();
HXDLIN(  51)					_hx_tmp2->drawTriangles(_hx_tmp3,start,(length * (int)2));
            				}
            				else {
HXLINE(  55)					int end = (start + length);
HXLINE(  57)					while((start < end)){
HXLINE(  59)						int arrayBufferIndex = ::Math_obj::floor(((Float)start / (Float)(int)10922));
HXLINE(  61)						length = ::Std_obj::_hx_int(::Math_obj::min((end - start),(int)10922));
HXLINE(  62)						if ((length <= (int)0)) {
HXLINE(  62)							goto _hx_goto_1;
            						}
HXLINE(  66)						 ::openfl::display3D::Context3D _hx_tmp4 = this->context3D;
HXDLIN(  66)						 ::openfl::display3D::IndexBuffer3D _hx_tmp5 = this->indexBuffers->__get(arrayBufferIndex).StaticCast<  ::openfl::display3D::IndexBuffer3D >();
HXDLIN(  66)						_hx_tmp4->drawTriangles(_hx_tmp5,((start - (arrayBufferIndex * (int)10922)) * (int)3),(length * (int)2));
...
HXLINE(  80)			this->vertexBuffer = this->context3D->createVertexBuffer(this->vertexCount,this->dataPerVertex,(int)0);
            		}
...
HXLINE(  90)		if ((dataPerVertex == (int)-1)) {
HXLINE(  90)			dataPerVertex = this->dataPerVertex;
            		}
HXLINE(  92)		if ((dataPerVertex != this->dataPerVertex)) {
HXLINE(  94)			this->vertexBuffer = null();
HXLINE(  95)			this->vertexCount = (int)0;
HXLINE(  97)			this->dataPerVertex = dataPerVertex;
            		}
HXLINE( 100)		int numVertices = (int)0;
HXLINE( 102)		{
HXLINE( 102)			 ::openfl::_internal::renderer::context3D::Context3DElementType _g = this->elementType;
HXDLIN( 102)			switch((int)(_hx_getEnumValueIndex(_g))){
            				case (int)0: {
HXLINE( 105)					numVertices = (elementCount * (int)4);
            				}
            				break;
            				case (int)1: {
HXLINE( 108)					numVertices = (elementCount * (int)3);
            				}
            				break;
            				case (int)2: {
HXLINE( 112)					numVertices = (elementCount * (int)3);
            				}
            				break;
            			}
            		}
...
HXLINE( 122)				this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,(int)8);
            			}
            			else {
...
HXLINE( 127)					this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,vertexLength,(int)8);
            				}
            				else {
...
HXDLIN( 128)						_this1->blit((offset * _this->bytesPerElement),cacheBufferData->buffer,cacheBufferData->byteOffset,cacheBufferData->byteLength);
            					}
            					else {
...
HXDLIN(  12)		MAX_INDEX_BUFFER_LENGTH = (int)65535;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_13_boot)
HXDLIN(  13)		MAX_QUADS_PER_INDEX_BUFFER = (int)10922;
            	}
{
            	HX_STACKFRAME(&_hx_pos_b4e1347513889d4b_14_boot)
HXDLIN(  14)		MAX_QUAD_INDEX_BUFFER_LENGTH = (int)65532;
            	}
}
