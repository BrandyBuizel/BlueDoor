...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_texture_filter_anisotropic)(__this) )->MAX_TEXTURE_MAX_ANISOTROPY_EXT = (int)34047;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_texture_filter_anisotropic)(__this) )->TEXTURE_MAX_ANISOTROPY_EXT = (int)34046;
            	}
