...
HXLINE( 115)			_hx_tmp = (int)0;
            		}
            		else {
HXLINE( 115)			_hx_tmp = format;
            		}
...
HXLINE( 176)			bytes->blit((int)0,buffer->data->buffer,(int)0,this->data->byteLength);
HXLINE( 177)			 ::lime::utils::ArrayBufferView this1;
HXDLIN( 177)			if (hx::IsNotNull( bytes )) {
HXLINE( 177)				 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 177)				int in_byteOffset = (int)0;
HXDLIN( 177)				if ((in_byteOffset < (int)0)) {
HXLINE( 177)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 177)				if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 177)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
...
HXDLIN( 177)					if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 177)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 177)					if ((newByteLength < (int)0)) {
HXLINE( 177)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
            				}
...
HXDLIN( 224)		return (_hx_tmp * ::Std_obj::_hx_int(((Float)this->bitsPerPixel / (Float)(int)8)));
            	}
