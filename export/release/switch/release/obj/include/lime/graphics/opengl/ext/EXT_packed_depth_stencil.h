...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::EXT_packed_depth_stencil)(__this) )->TEXTURE_STENCIL_SIZE_EXT = (int)35057;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::EXT_packed_depth_stencil)(__this) )->DEPTH24_STENCIL8_EXT = (int)35056;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::EXT_packed_depth_stencil)(__this) )->UNSIGNED_INT_24_8_EXT = (int)34042;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::EXT_packed_depth_stencil)(__this) )->DEPTH_STENCIL_EXT = (int)34041;
            	}
