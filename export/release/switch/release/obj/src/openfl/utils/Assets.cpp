...
HXLINE( 103)			 ::openfl::display::BitmapData bitmapData1 = ::openfl::display::BitmapData_obj::fromImage(image,null());
HXLINE( 106)			bool _hx_tmp2;
HXDLIN( 106)			if (useCache) {
HXLINE( 106)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
HXLINE( 106)				_hx_tmp2 = false;
            			}
HXDLIN( 106)			if (_hx_tmp2) {
HXLINE( 108)				::openfl::utils::IAssetCache_obj::setBitmapData(::openfl::utils::Assets_obj::cache,id,bitmapData1);
            			}
HXLINE( 111)			return bitmapData1;
            		}
...
HXLINE( 159)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
...
HXLINE( 189)		::String libraryName = id.substring((int)0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 190)		::String symbolName = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + (int)1),null());
...
HXLINE( 195)			if (::Std_obj::is(limeLibrary,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
...
HXLINE( 207)						::lime::utils::Log_obj::error(((HX_("MovieClip asset \"",52,88,7e,e3) + id) + HX_("\" exists, but only asynchronously",dc,ca,f2,dd)),hx::SourceInfo(HX_("Assets.hx",fb,cd,c6,67),207,HX_("openfl.utils.Assets",de,b0,04,7c),HX_("getMovieClip",2a,9f,71,27)));
HXLINE( 208)						return null();
            					}
            				}
            			}
HXLINE( 213)			::lime::utils::Log_obj::error(((HX_("There is no MovieClip asset with an ID of \"",d0,88,de,8c) + id) + HX_("\"",22,00,00,00)),hx::SourceInfo(HX_("Assets.hx",fb,cd,c6,67),213,HX_("openfl.utils.Assets",de,b0,04,7c),HX_("getMovieClip",2a,9f,71,27)));
            		}
            		else {
HXLINE( 217)			::lime::utils::Log_obj::error(((HX_("There is no asset library named \"",a1,83,5f,51) + libraryName) + HX_("\"",22,00,00,00)),hx::SourceInfo(HX_("Assets.hx",fb,cd,c6,67),217,HX_("openfl.utils.Assets",de,b0,04,7c),HX_("getMovieClip",2a,9f,71,27)));
            		}
...
HXLINE( 273)			 ::openfl::media::Sound sound1 = ::openfl::media::Sound_obj::fromAudioBuffer(buffer);
HXLINE( 276)			bool _hx_tmp2;
HXDLIN( 276)			if (useCache) {
HXLINE( 276)				_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
HXLINE( 276)				_hx_tmp2 = false;
            			}
HXDLIN( 276)			if (_hx_tmp2) {
HXLINE( 278)				::openfl::utils::IAssetCache_obj::setSound(::openfl::utils::Assets_obj::cache,id,sound1);
            			}
HXLINE( 281)			return sound1;
            		}
...
HXLINE( 329)				_hx_tmp1 = hx::IsNull( type );
            			}
            			else {
...
HXLINE( 334)				_hx_tmp2 = hx::IsNull( type );
            			}
            			else {
...
HXLINE( 339)				_hx_tmp4 = (type == HX_("MUSIC",85,08,49,8e));
            			}
            			else {
HXLINE( 339)				_hx_tmp4 = true;
            			}
HXDLIN( 339)			if (!(_hx_tmp4)) {
HXLINE( 339)				_hx_tmp3 = hx::IsNull( type );
            			}
            			else {
...
HXLINE( 345)		::String libraryName = id.substring((int)0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 346)		::String symbolName = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + (int)1),null());
...
HXDLIN( 372)		return ((bool)hx::IsNotNull( bitmapData ) && (bool)hx::IsNotNull( bitmapData->image ));
            	}
...
HXLINE( 435)				 ::openfl::display::BitmapData bitmapData1 = ::openfl::display::BitmapData_obj::fromImage(image,null());
HXLINE( 438)				bool _hx_tmp2;
HXDLIN( 438)				if (useCache) {
HXLINE( 438)					_hx_tmp2 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            				}
            				else {
HXLINE( 438)					_hx_tmp2 = false;
            				}
HXDLIN( 438)				if (_hx_tmp2) {
HXLINE( 440)					::openfl::utils::IAssetCache_obj::setBitmapData(::openfl::utils::Assets_obj::cache,id,bitmapData1);
            				}
HXLINE( 443)				promise->complete(bitmapData1);
            			}
            			else {
...
HXLINE( 469)			promise->complete(::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(bytes));
            		}
            		HX_END_LOCAL_FUNC1((void))
...
HXLINE( 509)			bool _hx_tmp3;
HXDLIN( 509)			if (useCache) {
HXLINE( 509)				_hx_tmp3 = ::openfl::utils::IAssetCache_obj::get_enabled(::openfl::utils::Assets_obj::cache);
            			}
            			else {
...
HXLINE( 495)			 ::openfl::text::Font _hx_tmp2 = ::openfl::utils::IAssetCache_obj::getFont(::openfl::utils::Assets_obj::cache,id);
HXDLIN( 495)			promise->complete(_hx_tmp2);
...
HXLINE( 539)				if (::Std_obj::is(library,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
...
HXLINE( 620)		::String libraryName = id.substring((int)0,id.indexOf(HX_(":",3a,00,00,00),null()));
HXLINE( 621)		::String symbolName = id.substr((id.indexOf(HX_(":",3a,00,00,00),null()) + (int)1),null());
...
HXLINE( 626)			if (::Std_obj::is(limeLibrary,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
