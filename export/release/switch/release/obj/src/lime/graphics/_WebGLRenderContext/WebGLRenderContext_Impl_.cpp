...
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_145_uniformMatrix2fv,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","uniformMatrix2fv",0x2c1d1c62,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.uniformMatrix2fv","lime/graphics/WebGLRenderContext.hx",145,0x59a06254)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_150_uniformMatrix3fv,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","uniformMatrix3fv",0x2c1ddea3,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.uniformMatrix3fv","lime/graphics/WebGLRenderContext.hx",150,0x59a06254)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_155_uniformMatrix4fv,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","uniformMatrix4fv",0x2c1ea0e4,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.uniformMatrix4fv","lime/graphics/WebGLRenderContext.hx",155,0x59a06254)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_160_fromWebGL2RenderContext,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","fromWebGL2RenderContext",0x08f222a1,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.fromWebGL2RenderContext","lime/graphics/WebGLRenderContext.hx",160,0x59a06254)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_165_fromRenderContext,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","fromRenderContext",0x3f3021fa,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.fromRenderContext","lime/graphics/WebGLRenderContext.hx",165,0x59a06254)
HX_LOCAL_STACK_FRAME(_hx_pos_03d5164364d6a378_170_fromGL,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_","fromGL",0xe3a577a4,"lime.graphics._WebGLRenderContext.WebGLRenderContext_Impl_.fromGL","lime/graphics/WebGLRenderContext.hx",170,0x59a06254)
...
HXDLIN(  85)			size = (int)0;
            		}
HXDLIN(  85)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),(int)0);
HXDLIN(  85)		this1->bufferSubData(target,offset,size,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            	}
...
HXDLIN(  97)			imageSize = (int)0;
            		}
HXDLIN(  97)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),(int)0);
HXDLIN(  97)		this1->compressedTexSubImage2D(target,level,xoffset,yoffset,width,height,format,imageSize,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            	}
...
HXDLIN( 103)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),pixels,null(),(int)0);
...
HXDLIN( 110)		::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),srcData,null(),(int)0);
...
void WebGLRenderContext_Impl__obj::uniformMatrix2fv( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1,int location,bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_145_uniformMatrix2fv)
HXDLIN( 145)		::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::uniformMatrix2fv(this1,location,transpose,v,null(),null());
            	}
...
void WebGLRenderContext_Impl__obj::uniformMatrix3fv( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1,int location,bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_150_uniformMatrix3fv)
HXDLIN( 150)		::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::uniformMatrix3fv(this1,location,transpose,v,null(),null());
            	}
...
void WebGLRenderContext_Impl__obj::uniformMatrix4fv( ::lime::_internal::backend::native::NativeOpenGLRenderContext this1,int location,bool transpose, ::lime::utils::ArrayBufferView v){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_155_uniformMatrix4fv)
HXDLIN( 155)		::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::uniformMatrix4fv(this1,location,transpose,v,null(),null());
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC4(WebGLRenderContext_Impl__obj,uniformMatrix4fv,(void))
 ...
 ::lime::_internal::backend::native::NativeOpenGLRenderContext WebGLRenderContext_Impl__obj::fromWebGL2RenderContext( ::lime::_internal::backend::native::NativeOpenGLRenderContext gl){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_160_fromWebGL2RenderContext)
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(WebGLRenderContext_Impl__obj,fromWebGL2RenderContext,return )
 ...
 ::lime::_internal::backend::native::NativeOpenGLRenderContext WebGLRenderContext_Impl__obj::fromRenderContext( ::lime::graphics::RenderContext context){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_165_fromRenderContext)
HXDLIN( 165)		return context->webgl;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(WebGLRenderContext_Impl__obj,fromRenderContext,return )
 ...
 ::lime::_internal::backend::native::NativeOpenGLRenderContext WebGLRenderContext_Impl__obj::fromGL(hx::Class gl){
            	HX_STACKFRAME(&_hx_pos_03d5164364d6a378_170_fromGL)
HXDLIN( 170)		return ::lime::graphics::opengl::GL_obj::context;
            	}
