...
HXLINE(   9)		this->BUFFER_MAP_POINTER_OES = (int)35005;
HXLINE(   8)		this->BUFFER_MAPPED_OES = (int)35004;
HXLINE(   7)		this->BUFFER_ACCESS_OES = (int)35003;
HXLINE(   6)		this->WRITE_ONLY_OES = (int)35001;
            	}
