...
HXDLIN( 140)			int _g = priorities->length;
HXDLIN( 140)			while((_g1 < _g)){
HXLINE( 140)				_g1 = (_g1 + (int)1);
HXDLIN( 140)				int i = (_g1 - (int)1);
HXLINE( 141)				{
HXLINE( 141)					int _g2 = (int)0;
HXDLIN( 141)					::Array< ::String > _g3 = priorities->__get(i).StaticCast< ::Array< ::String > >();
HXDLIN( 141)					while((_g2 < _g3->length)){
HXLINE( 141)						::String x = _g3->__get(_g2);
HXDLIN( 141)						_g2 = (_g2 + (int)1);
HXLINE( 142)						this->opPriority->set(x,i);
HXLINE( 143)						if ((i == (int)9)) {
...
HXDLIN( 145)			::Array< ::String > _g11 = ::Array_obj< ::String >::fromData( _hx_array_data_e9f29f9a_14,5);
HXDLIN( 145)			while((_g4 < _g11->length)){
HXLINE( 145)				::String x1 = _g11->__get(_g4);
HXDLIN( 145)				_g4 = (_g4 + (int)1);
HXLINE( 146)				{
HXLINE( 146)					bool _hx_tmp;
HXDLIN( 146)					if ((x1 != HX_("++",a0,25,00,00))) {
HXLINE( 146)						_hx_tmp = (x1 == HX_("--",60,27,00,00));
            					}
            					else {
HXLINE( 146)						_hx_tmp = true;
            					}
HXDLIN( 146)					this->unops->set(x1,_hx_tmp);
            				}
            			}
            		}
            	}
...
HXLINE( 154)			HX_STACK_DO_THROW(err);
            		}
            	}
...
HXDLIN( 159)		int pmin = (this->readPos - (int)1);
HXDLIN( 159)		int pmax = (this->readPos - (int)1);
HXDLIN( 159)		if (!(this->resumeErrors)) {
HXDLIN( 159)			HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidChar(c));
            		}
            	}
...
HXLINE( 176)		this->_hx_char = (int)-1;
HXLINE( 177)		this->ops = ::Array_obj< bool >::__new();
HXLINE( 178)		this->idents = ::Array_obj< bool >::__new();
HXLINE( 179)		this->uid = (int)0;
HXLINE( 180)		{
HXLINE( 180)			int _g1 = (int)0;
HXDLIN( 180)			int _g = this->opChars.length;
HXDLIN( 180)			while((_g1 < _g)){
HXLINE( 180)				_g1 = (_g1 + (int)1);
HXDLIN( 180)				int i = (_g1 - (int)1);
HXLINE( 181)				::Array< bool > _hx_tmp = this->ops;
HXDLIN( 181)				_hx_tmp[this->opChars.charCodeAt(i)] = true;
            			}
            		}
HXLINE( 182)		{
HXLINE( 182)			int _g11 = (int)0;
HXDLIN( 182)			int _g2 = this->identChars.length;
HXDLIN( 182)			while((_g11 < _g2)){
HXLINE( 182)				_g11 = (_g11 + (int)1);
HXDLIN( 182)				int i1 = (_g11 - (int)1);
HXLINE( 183)				::Array< bool > _hx_tmp1 = this->idents;
HXDLIN( 183)				_hx_tmp1[this->identChars.charCodeAt(i1)] = true;
            			}
            		}
            	}
...
HXLINE( 195)			this->parseFullExpr(a);
            		...
            		_hx_goto_20:;
HXLINE( 197)		if ((a->length == (int)1)) {
HXLINE( 197)			return a->__get((int)0).StaticCast<  ::hscript::Expr >();
            		}
            		else {
...
HXLINE( 201)				HX_STACK_DO_THROW(err);
            			}
            		}
...
HXLINE( 235)		if ((_hx_getEnumValueIndex(tk) == (int)2)) {
...
HXLINE( 280)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)2: {
HXLINE( 283)				 ::hscript::Expr e1 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
...
HXLINE( 283)							if ((_hx_getEnumValueIndex(t) == (int)2)) {
...
HXLINE( 283)						return false;
            			...
            			break;
            			case (int)6: {
HXLINE( 285)				 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 285)				return this->isBlock(e2);
            			}
            			break;
            			case (int)7: {
HXLINE( 286)				 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 286)				bool prefix = e->_hx_getBool(1);
HXDLIN( 286)				if (!(prefix)) {
HXLINE( 286)					return this->isBlock(e3);
            				}
            				else {
HXLINE( 286)					return false;
            			...
            			break;
            			case (int)9: {
HXLINE( 284)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				 ::hscript::Expr e11 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 284)				if (hx::IsNotNull( e21 )) {
HXLINE( 284)					return this->isBlock(e21);
            				}
            				else {
HXLINE( 284)					return this->isBlock(e11);
            				}
            			}
            			break;
            			case (int)10: {
HXLINE( 287)				 ::hscript::Expr e4 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 287)				return this->isBlock(e4);
            			}
            			break;
            			case (int)11: {
HXLINE( 289)				 ::hscript::Expr e5 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 289)				return this->isBlock(e5);
            			}
            			break;
            			case (int)14: {
HXLINE( 282)				 ::hscript::Expr e6 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 282)				return this->isBlock(e6);
            			}
            			break;
            			case (int)15: {
HXLINE( 290)				 ::hscript::Expr e7 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 290)				if (hx::IsNotNull( e7 )) {
HXLINE( 290)					return this->isBlock(e7);
            				}
            				else {
HXLINE( 290)					return false;
            			...
            			break;
            			case (int)20: {
HXLINE( 291)				 ::hscript::Expr e8 = e->_hx_getObject(3).StaticCast<  ::hscript::Expr >();
HXDLIN( 291)				return this->isBlock(e8);
            			}
            			break;
...
HXLINE( 281)				return true;
            			...
            			break;
            			case (int)24: {
HXLINE( 288)				 ::hscript::Expr e9 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 288)				return this->isBlock(e9);
            			}
            			break;
            			case (int)25: {
HXLINE( 292)				 ::hscript::Expr e10 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 292)				return this->isBlock(e10);
            			}
            			break;
            			default:{
...
HXLINE( 303)				if ((_hx_getEnumValueIndex(e) == (int)2)) {
...
HXLINE( 309)			_hx_tmp2 = hx::IsNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            		}
            		else {
...
HXLINE( 323)			switch((int)(_hx_getEnumValueIndex(tk))){
            				case (int)1: {
...
HXLINE( 328)						if ((_hx_getEnumValueIndex(c) == (int)2)) {
...
HXDLIN( 324)					id = i;
            				...
            				break;
            				case (int)7: {
HXLINE( 333)					goto _hx_goto_35;
            				}
            				break;
            				default:{
HXLINE( 335)					this->unexpected(tk);
HXLINE( 336)					goto _hx_goto_35;
            				}
            			}
HXLINE( 338)			{
...
HXLINE( 341)			switch((int)(_hx_getEnumValueIndex(tk))){
            				case (int)7: {
HXLINE( 343)					goto _hx_goto_35;
            				}
            				break;
            				case (int)9: {
            				}
...
HXLINE( 357)		switch((int)(_hx_getEnumValueIndex(tk))){
            			case (int)1: {
...
HXLINE( 436)				if (::haxe::IMap_obj::exists(this->unops,op)) {
HXLINE( 437)					int start = (int)0;
HXLINE( 438)					 ::hscript::Expr e1 = this->parseExpr();
HXLINE( 439)					bool _hx_tmp;
HXDLIN( 439)					if ((op == HX_("-",2d,00,00,00))) {
HXLINE( 439)						_hx_tmp = hx::IsNotNull( e1 );
            					}
            					else {
HXLINE( 439)						_hx_tmp = false;
            					}
HXDLIN( 439)					if (_hx_tmp) {
HXLINE( 440)						if ((_hx_getEnumValueIndex(e1) == (int)0)) {
HXLINE( 440)							switch((int)(_hx_getEnumValueIndex(e1->_hx_getObject(0).StaticCast<  ::hscript::Const >()))){
            								case (int)0: {
HXLINE( 441)									int i = e1->_hx_getObject(0).StaticCast<  ::hscript::Const >()->_hx_getInt(0);
HXLINE( 442)									return ::hscript::Expr_obj::EConst(::hscript::Const_obj::CInt(-(i)));
            								}
            								break;
            								case (int)1: {
HXLINE( 443)									Float f = e1->_hx_getObject(0).StaticCast<  ::hscript::Const >()->_hx_getFloat(0);
...
HXLINE( 447)					return this->makeUnop(op,e1);
            				}
HXLINE( 449)				return this->unexpected(tk);
            			}
            			break;
            			case (int)4: {
HXLINE( 366)				 ::hscript::Expr e2 = this->parseExpr();
HXLINE( 367)				tk = this->token();
HXLINE( 368)				switch((int)(_hx_getEnumValueIndex(tk))){
            					case (int)5: {
HXLINE( 370)						return this->parseExprNext(::hscript::Expr_obj::EParent(e2));
            					}
            					break;
            					case (int)9: {
HXLINE( 385)						if ((_hx_getEnumValueIndex(e2) == (int)1)) {
HXLINE( 386)							::String v = e2->_hx_getString(0);
...
HXLINE( 374)						switch((int)(_hx_getEnumValueIndex(tk))){
            							case (int)5: {
HXLINE( 376)								return this->parseExprNext(::hscript::Expr_obj::ECheckType(e2,t));
            							}
            							break;
            							case (int)9: {
HXLINE( 378)								if ((_hx_getEnumValueIndex(e2) == (int)1)) {
HXLINE( 379)									::String v1 = e2->_hx_getString(0);
...
HXLINE( 394)				switch((int)(_hx_getEnumValueIndex(tk))){
            					case (int)1: {
HXLINE( 406)						 ::hscript::Const c1 = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >();
HXLINE( 407)						if (this->allowJSON) {
HXLINE( 408)							if ((_hx_getEnumValueIndex(c1) == (int)2)) {
...
HXLINE( 413)								if ((_hx_getEnumValueIndex(tk2) == (int)14)) {
HXLINE( 415)									return this->parseExprNext(this->parseObject((int)0));
            								}
            							}
            							else {
HXLINE( 419)								 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 419)								_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            							}
            						}
            						else {
HXLINE( 422)							 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 422)							_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            						}
            					}
            					break;
            					case (int)2: {
HXLINE( 398)						 ::hscript::Token tk21 = this->token();
HXLINE( 399)						{
HXLINE( 399)							 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 399)							_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk21,_this4->head);
            						}
HXLINE( 400)						{
HXLINE( 400)							 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 400)							_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            						}
HXLINE( 401)						if ((_hx_getEnumValueIndex(tk21) == (int)14)) {
HXLINE( 403)							return this->parseExprNext(this->parseObject((int)0));
            						}
            					}
            					break;
            					case (int)7: {
HXLINE( 396)						return this->parseExprNext(::hscript::Expr_obj::EObject(::Array_obj< ::Dynamic>::__new(0)));
            					...
            					break;
            					default:{
HXLINE( 424)						 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 424)						_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            					}
            				}
...
HXLINE( 430)							_hx_tmp1 = hx::IsEq( tk,::hscript::Token_obj::TEof_dyn() );
            						}
            						else {
...
HXLINE( 431)						goto _hx_goto_37;
            					}
HXLINE( 432)					{
HXLINE( 432)						 ::haxe::ds::GenericStack_hscript_Token _this7 = this->tokens;
HXDLIN( 432)						_this7->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this7->head);
            					}
            				}
            				_hx_goto_37:;
HXLINE( 434)				return ::hscript::Expr_obj::EBlock(a);
            			...
            			break;
            			case (int)11: {
HXLINE( 451)				::Array< ::Dynamic> a1 = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 453)							_hx_tmp2 = hx::IsNotEq( tk,::hscript::Token_obj::TEof_dyn() );
            						}
            						else {
...
HXLINE( 453)						goto _hx_goto_38;
            					}
HXLINE( 454)					{
HXLINE( 454)						 ::haxe::ds::GenericStack_hscript_Token _this8 = this->tokens;
HXDLIN( 454)						_this8->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this8->head);
            					}
HXLINE( 455)					a1->push(this->parseExpr());
...
HXDLIN( 460)				if ((a1->length == (int)1)) {
HXLINE( 460)					_hx_tmp3 = hx::IsNotNull( a1->__get((int)0).StaticCast<  ::hscript::Expr >() );
            				}
            				else {
HXLINE( 460)					_hx_tmp3 = false;
            				}
HXDLIN( 460)				if (_hx_tmp3) {
HXLINE( 461)					 ::hscript::Expr _g = a1->__get((int)0).StaticCast<  ::hscript::Expr >();
HXDLIN( 461)					switch((int)(_hx_getEnumValueIndex(_g))){
            						case (int)10: case (int)11: case (int)24: {
HXLINE( 463)							::String tmp = (HX_("__a_",fe,af,13,3f) + this->uid++);
HXLINE( 465)							 ::hscript::Expr e3 = ::hscript::Expr_obj::EVar(tmp,null(),::hscript::Expr_obj::EArrayDecl(::Array_obj< ::Dynamic>::__new(0)));
HXLINE( 464)							 ::hscript::Expr e4 = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(3)->init(0,e3)->init(1,this->mapCompr(tmp,a1->__get((int)0).StaticCast<  ::hscript::Expr >()))->init(2,::hscript::Expr_obj::EIdent(tmp)));
HXLINE( 469)							return this->parseExprNext(e4);
            						}
            						break;
            						default:{
            						}
...
HXLINE( 472)				return this->parseExprNext(::hscript::Expr_obj::EArrayDecl(a1));
            			}
            			break;
            			case (int)15: {
HXLINE( 473)				::String id1 = tk->_hx_getString(0);
HXDLIN( 473)				if (this->allowMetadata) {
HXLINE( 474)					::Array< ::Dynamic> args = this->parseMetaArgs();
HXLINE( 475)					return ::hscript::Expr_obj::EMeta(id1,args,this->parseExpr());
            				}
            				else {
...
HXLINE( 487)			switch((int)(_hx_getEnumValueIndex(tk))){
            				case (int)5: {
HXLINE( 490)					goto _hx_goto_40;
            				}
            				break;
            				case (int)9: {
            				}
...
HXLINE( 493)					goto _hx_goto_40;
            				}
            			}
            		}
            		_hx_goto_40:;
HXLINE( 496)		{
HXLINE( 496)			 ::hscript::Token t1 = this->token();
HXDLIN( 496)			if (!(::Type_obj::enumEq(t1,::hscript::Token_obj::TOp(HX_("->",71,27,00,00))))) {
HXLINE( 496)				this->unexpected(t1);
            			}
            		}
...
HXLINE( 510)			{
HXLINE( 510)				 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 510)				_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            			}
...
HXLINE( 516)							goto _hx_goto_42;
            						...
            						break;
            						default:{
HXLINE( 517)							 ::hscript::Token tk1 = _g;
...
HXDLIN( 527)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)3: {
...
HXLINE( 527)				edef = ::hscript::Expr_obj::EParent(this->mapCompr(tmp,e2));
            			...
            			break;
            			case (int)4: {
HXLINE( 527)				if ((e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >()->length == (int)1)) {
HXLINE( 536)					 ::hscript::Expr e1 = e->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >()->__get((int)0).StaticCast<  ::hscript::Expr >();
HXLINE( 527)					edef = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(1)->init(0,this->mapCompr(tmp,e1)));
            				}
            				else {
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            			...
            			break;
            			case (int)9: {
HXLINE( 534)				 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				 ::hscript::Expr e11 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				 ::hscript::Expr cond = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 534)				if (hx::IsNull( e21 )) {
HXLINE( 527)					edef = ::hscript::Expr_obj::EIf(cond,this->mapCompr(tmp,e11),null());
            				}
            				else {
HXLINE( 527)					edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
            				}
            			...
            			break;
            			case (int)10: {
HXLINE( 530)				 ::hscript::Expr e22 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 530)				 ::hscript::Expr cond1 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EWhile(cond1,this->mapCompr(tmp,e22));
            			}
            			break;
            			case (int)11: {
HXLINE( 528)				 ::hscript::Expr e23 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				 ::hscript::Expr it = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 528)				::String v = e->_hx_getString(0);
HXLINE( 527)				edef = ::hscript::Expr_obj::EFor(v,it,this->mapCompr(tmp,e23));
            			}
            			break;
            			case (int)24: {
HXLINE( 532)				 ::hscript::Expr e24 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 532)				 ::hscript::Expr cond2 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 527)				edef = ::hscript::Expr_obj::EDoWhile(cond2,this->mapCompr(tmp,e24));
            			}
            			break;
            			default:{
HXLINE( 527)				edef = ::hscript::Expr_obj::ECall(::hscript::Expr_obj::EField(::hscript::Expr_obj::EIdent(tmp),HX_("push",da,11,61,4a)),::Array_obj< ::Dynamic>::__new(1)->init(0,e));
...
HXLINE( 549)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)6: {
...
HXDLIN( 551)				 ::hscript::Expr e21 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				 ::hscript::Expr e11 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXDLIN( 551)				return ::hscript::Expr_obj::ETernary(this->makeUnop(op,e11),e21,e3);
            			}
            			break;
            			default:{
...
HXLINE( 559)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)6: {
...
HXDLIN( 561)				 ::Dynamic _hx_tmp2 = ::haxe::IMap_obj::get(this->opPriority,op);
HXDLIN( 561)				if (hx::IsLessEq( _hx_tmp2,::haxe::IMap_obj::get(this->opPriority,op2) )) {
HXLINE( 561)					_hx_tmp1 = !(::haxe::IMap_obj::exists(this->opRightAssoc,op));
            				}
            				else {
...
HXDLIN( 565)				 ::hscript::Expr e31 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXDLIN( 565)				 ::hscript::Expr e21 = e->_hx_getObject(0).StaticCast<  ::hscript::Expr >();
HXLINE( 566)				if (::haxe::IMap_obj::exists(this->opRightAssoc,op)) {
HXLINE( 567)					return ::hscript::Expr_obj::EBinop(op,e1,e);
            				}
            				else {
HXLINE( 569)					return ::hscript::Expr_obj::ETernary(this->makeBinop(op,e1,e21),e31,e4);
            				}
            			}
            			break;
            			default:{
...
HXLINE( 633)			 ::hscript::Expr e1 = this->parseExpr();
HXLINE( 634)			return ::hscript::Expr_obj::EFor(vname,eiter,e1);
HXLINE( 627)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("function",18,ab,52,14)) ){
HXLINE( 642)			 ::hscript::Token tk1 = this->token();
HXLINE( 643)			::String name = null();
HXLINE( 644)			if ((_hx_getEnumValueIndex(tk1) == (int)2)) {
HXLINE( 645)				::String id1 = tk1->_hx_getString(0);
HXDLIN( 645)				name = id1;
            			}
            			else {
HXLINE( 646)				 ::haxe::ds::GenericStack_hscript_Token _this = this->tokens;
HXDLIN( 646)				_this->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk1,_this->head);
            			}
HXLINE( 648)			 ::Dynamic inf = this->parseFunctionDecl();
HXLINE( 649)			 ::hscript::Expr e2 = inf->__Field(HX_("body",a2,7a,1b,41),hx::paccDynamic);
HXDLIN( 649)			 ::Dynamic pmax = (int)0;
HXDLIN( 649)			return ::hscript::Expr_obj::EFunction( ::Dynamic(inf->__Field(HX_("args",5d,8d,74,40),hx::paccDynamic)), ::Dynamic(inf->__Field(HX_("body",a2,7a,1b,41),hx::paccDynamic)),name, ::Dynamic(inf->__Field(HX_("ret",61,d9,56,00),hx::paccDynamic)));
HXLINE( 641)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("if",dd,5b,00,00)) ){
HXLINE( 581)			{
HXLINE( 581)				 ::hscript::Token t3 = this->token();
HXDLIN( 581)				if (hx::IsNotEq( t3,::hscript::Token_obj::TPOpen_dyn() )) {
HXLINE( 581)					this->unexpected(t3);
            				}
            			}
HXLINE( 582)			 ::hscript::Expr cond = this->parseExpr();
HXLINE( 583)			{
HXLINE( 583)				 ::hscript::Token t4 = this->token();
HXDLIN( 583)				if (hx::IsNotEq( t4,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 583)					this->unexpected(t4);
            				}
            			}
HXLINE( 584)			 ::hscript::Expr e11 = this->parseExpr();
HXLINE( 585)			 ::hscript::Expr e21 = null();
HXLINE( 586)			bool semic = false;
HXLINE( 587)			 ::hscript::Token tk2 = this->token();
HXLINE( 588)			if (hx::IsEq( tk2,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 589)				semic = true;
HXLINE( 590)				tk2 = this->token();
            			}
HXLINE( 592)			if (::Type_obj::enumEq(tk2,::hscript::Token_obj::TId(HX_("else",b9,e4,14,43)))) {
HXLINE( 593)				e21 = this->parseExpr();
            			}
            			else {
HXLINE( 595)				{
HXLINE( 595)					 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 595)					_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk2,_this1->head);
            				}
HXLINE( 596)				if (semic) {
HXLINE( 596)					 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 596)					_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TSemicolon_dyn(),_this2->head);
            				}
            			}
HXLINE( 598)			return ::hscript::Expr_obj::EIf(cond,e11,e21);
HXLINE( 580)			goto _hx_goto_47;
            		}
...
HXLINE( 659)				 ::hscript::Token tk3 = this->token();
HXLINE( 660)				switch((int)(_hx_getEnumValueIndex(tk3))){
            					case (int)4: {
...
HXLINE( 662)						a->push(this->getIdent());
            					...
            					break;
            					default:{
HXLINE( 666)						this->unexpected(tk3);
HXLINE( 667)						goto _hx_goto_48;
            					}
            				}
            			}
            			_hx_goto_48:;
...
HXLINE( 655)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("return",b0,a4,2d,09)) ){
HXLINE( 651)			 ::hscript::Token tk4 = this->token();
HXLINE( 652)			{
HXLINE( 652)				 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 652)				_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk4,_this3->head);
            			}
HXLINE( 653)			 ::hscript::Expr e3;
HXDLIN( 653)			if (hx::IsEq( tk4,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 653)				e3 = null();
            			}
            			else {
HXLINE( 653)				e3 = this->parseExpr();
            			}
HXLINE( 654)			return ::hscript::Expr_obj::EReturn(e3);
HXLINE( 650)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("switch",f4,49,79,c5)) ){
HXLINE( 690)			 ::hscript::Expr e4 = this->parseExpr();
HXLINE( 691)			 ::hscript::Expr def = null();
HXDLIN( 691)			::Array< ::Dynamic> cases = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 692)			{
HXLINE( 692)				 ::hscript::Token t5 = this->token();
HXDLIN( 692)				if (hx::IsNotEq( t5,::hscript::Token_obj::TBrOpen_dyn() )) {
HXLINE( 692)					this->unexpected(t5);
            				}
            			}
HXLINE( 693)			while(true){
HXLINE( 694)				 ::hscript::Token tk5 = this->token();
HXLINE( 695)				switch((int)(_hx_getEnumValueIndex(tk5))){
            					case (int)2: {
HXLINE( 695)						::String _hx_switch_1 = tk5->_hx_getString(0);
...
HXLINE( 700)								 ::hscript::Expr e5 = this->parseExpr();
HXLINE( 701)								( (::Array< ::Dynamic>)(c->__Field(HX_("values",e2,03,b7,4f),hx::paccDynamic)) )->push(e5);
HXLINE( 702)								tk5 = this->token();
HXLINE( 703)								switch((int)(_hx_getEnumValueIndex(tk5))){
            									case (int)9: {
            									}
            									break;
            									case (int)14: {
HXLINE( 707)										goto _hx_goto_51;
            									}
            									break;
            									default:{
HXLINE( 709)										this->unexpected(tk5);
HXLINE( 710)										goto _hx_goto_51;
            									}
            								}
            							}
            							_hx_goto_51:;
...
HXLINE( 715)								tk5 = this->token();
HXLINE( 716)								{
HXLINE( 716)									 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN( 716)									_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this4->head);
            								}
HXLINE( 717)								switch((int)(_hx_getEnumValueIndex(tk5))){
            									case (int)0: {
HXLINE( 720)										if (this->resumeErrors) {
HXLINE( 721)											goto _hx_goto_52;
            										}
            										else {
HXLINE( 723)											this->parseFullExpr(exprs);
            									...
            									break;
            									case (int)2: {
HXLINE( 717)										::String _hx_switch_2 = tk5->_hx_getString(0);
            										if (  (_hx_switch_2==HX_("case",b0,1e,ba,41)) ||  (_hx_switch_2==HX_("default",c1,d8,c3,9b)) ){
HXLINE( 719)											goto _hx_goto_52;
HXDLIN( 719)											goto _hx_goto_53;
            										}
            										/* default */{
HXLINE( 723)											this->parseFullExpr(exprs);
            										}
...
HXDLIN( 726)							if ((exprs->length == (int)1)) {
HXLINE( 726)								_hx_tmp = exprs->__get((int)0).StaticCast<  ::hscript::Expr >();
            							}
            							else {
HXLINE( 728)								if ((exprs->length == (int)0)) {
HXLINE( 726)									_hx_tmp = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
            								}
            								else {
HXLINE( 731)									 ::hscript::Expr e6 = exprs->__get((exprs->length - (int)1)).StaticCast<  ::hscript::Expr >();
HXDLIN( 731)									 ::Dynamic pmax1 = (int)0;
HXLINE( 726)									_hx_tmp = ::hscript::Expr_obj::EBlock(exprs);
            								}
            							}
HXDLIN( 726)							c->__SetField(HX_("expr",35,fd,1d,43),_hx_tmp,hx::paccDynamic);
HXLINE( 696)							goto _hx_goto_50;
            						}
            						if (  (_hx_switch_1==HX_("default",c1,d8,c3,9b)) ){
HXLINE( 733)							if (hx::IsNotNull( def )) {
HXLINE( 733)								this->unexpected(tk5);
            							}
HXLINE( 734)							{
HXLINE( 734)								 ::hscript::Token t6 = this->token();
HXDLIN( 734)								if (hx::IsNotEq( t6,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 734)									this->unexpected(t6);
            								}
            							}
HXLINE( 735)							::Array< ::Dynamic> exprs1 = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 736)							while(true){
HXLINE( 737)								tk5 = this->token();
HXLINE( 738)								{
HXLINE( 738)									 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 738)									_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk5,_this5->head);
            								}
HXLINE( 739)								switch((int)(_hx_getEnumValueIndex(tk5))){
            									case (int)0: {
HXLINE( 742)										if (this->resumeErrors) {
HXLINE( 743)											goto _hx_goto_54;
            										}
            										else {
HXLINE( 745)											this->parseFullExpr(exprs1);
            										}
            									}
            									break;
            									case (int)2: {
HXLINE( 739)										::String _hx_switch_3 = tk5->_hx_getString(0);
            										if (  (_hx_switch_3==HX_("case",b0,1e,ba,41)) ||  (_hx_switch_3==HX_("default",c1,d8,c3,9b)) ){
HXLINE( 741)											goto _hx_goto_54;
HXDLIN( 741)											goto _hx_goto_55;
            										}
            										/* default */{
HXLINE( 745)											this->parseFullExpr(exprs1);
            										}
...
HXLINE( 745)										this->parseFullExpr(exprs1);
            							...
            							_hx_goto_54:;
HXLINE( 748)							if ((exprs1->length == (int)1)) {
HXLINE( 749)								def = exprs1->__get((int)0).StaticCast<  ::hscript::Expr >();
            							}
            							else {
HXLINE( 750)								if ((exprs1->length == (int)0)) {
HXLINE( 751)									def = ::hscript::Expr_obj::EBlock(::Array_obj< ::Dynamic>::__new(0));
            								}
            								else {
HXLINE( 753)									 ::hscript::Expr e7 = exprs1->__get((exprs1->length - (int)1)).StaticCast<  ::hscript::Expr >();
HXDLIN( 753)									 ::Dynamic pmax2 = (int)0;
HXDLIN( 753)									def = ::hscript::Expr_obj::EBlock(exprs1);
            								}
            							}
HXLINE( 732)							goto _hx_goto_50;
            						}
            						/* default */{
HXLINE( 757)							this->unexpected(tk5);
HXLINE( 758)							goto _hx_goto_49;
            						}
            						_hx_goto_50:;
            					}
            					break;
            					case (int)7: {
HXLINE( 755)						goto _hx_goto_49;
            					}
            					break;
            					default:{
HXLINE( 757)						this->unexpected(tk5);
HXLINE( 758)						goto _hx_goto_49;
            			...
            			_hx_goto_49:;
HXLINE( 761)			return ::hscript::Expr_obj::ESwitch(e4,cases,def);
HXLINE( 689)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("throw",26,5d,90,0f)) ){
HXLINE( 673)			 ::hscript::Expr e8 = this->parseExpr();
HXLINE( 674)			return ::hscript::Expr_obj::EThrow(e8);
HXLINE( 672)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("try",3b,69,58,00)) ){
HXLINE( 676)			 ::hscript::Expr e9 = this->parseExpr();
HXLINE( 677)			{
HXLINE( 677)				 ::hscript::Token t7 = this->token();
HXDLIN( 677)				if (!(::Type_obj::enumEq(t7,::hscript::Token_obj::TId(HX_("catch",3b,7c,21,41))))) {
HXLINE( 677)					this->unexpected(t7);
            				}
            			}
HXLINE( 678)			{
HXLINE( 678)				 ::hscript::Token t8 = this->token();
HXDLIN( 678)				if (hx::IsNotEq( t8,::hscript::Token_obj::TPOpen_dyn() )) {
HXLINE( 678)					this->unexpected(t8);
            				}
            			}
HXLINE( 679)			::String vname1 = this->getIdent();
HXLINE( 680)			{
HXLINE( 680)				 ::hscript::Token t9 = this->token();
HXDLIN( 680)				if (hx::IsNotEq( t9,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 680)					this->unexpected(t9);
            				}
            			}
HXLINE( 681)			 ::hscript::CType t10 = null();
HXLINE( 682)			if (this->allowTypes) {
HXLINE( 683)				t10 = this->parseType();
            			}
            			else {
HXLINE( 685)				 ::hscript::Token t11 = this->token();
HXDLIN( 685)				if (!(::Type_obj::enumEq(t11,::hscript::Token_obj::TId(HX_("Dynamic",5f,c7,66,03))))) {
HXLINE( 685)					this->unexpected(t11);
            				}
            			}
HXLINE( 686)			{
HXLINE( 686)				 ::hscript::Token t12 = this->token();
HXDLIN( 686)				if (hx::IsNotEq( t12,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 686)					this->unexpected(t12);
            				}
            			}
HXLINE( 687)			 ::hscript::Expr ec = this->parseExpr();
HXLINE( 688)			return ::hscript::Expr_obj::ETry(e9,vname1,t10,ec);
HXLINE( 675)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE( 600)			::String ident = this->getIdent();
HXLINE( 601)			 ::hscript::Token tk6 = this->token();
HXLINE( 602)			 ::hscript::CType t13 = null();
HXLINE( 603)			bool _hx_tmp1;
HXDLIN( 603)			if (hx::IsEq( tk6,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 603)				_hx_tmp1 = this->allowTypes;
            			}
            			else {
HXLINE( 603)				_hx_tmp1 = false;
            			}
HXDLIN( 603)			if (_hx_tmp1) {
HXLINE( 604)				t13 = this->parseType();
HXLINE( 605)				tk6 = this->token();
            			}
HXLINE( 607)			 ::hscript::Expr e10 = null();
HXLINE( 608)			if (::Type_obj::enumEq(tk6,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00)))) {
HXLINE( 609)				e10 = this->parseExpr();
            			}
            			else {
HXLINE( 611)				 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN( 611)				_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk6,_this6->head);
            			}
HXLINE( 612)			return ::hscript::Expr_obj::EVar(ident,t13,e10);
HXLINE( 599)			goto _hx_goto_47;
            		}
            		if (  (_hx_switch_0==HX_("while",b1,43,bd,c9)) ){
HXLINE( 614)			 ::hscript::Expr econd1 = this->parseExpr();
HXLINE( 615)			 ::hscript::Expr e12 = this->parseExpr();
HXLINE( 616)			return ::hscript::Expr_obj::EWhile(econd1,e12);
...
HXLINE( 769)		switch((int)(_hx_getEnumValueIndex(tk))){
            			case (int)3: {
HXLINE( 770)				::String op = tk->_hx_getString(0);
HXLINE( 772)				if ((op == HX_("->",71,27,00,00))) {
HXLINE( 774)					switch((int)(_hx_getEnumValueIndex(e1))){
            						case (int)1: {
...
HXDLIN( 774)							if ((_hx_getEnumValueIndex(_hx_tmp) == (int)1)) {
HXLINE( 775)								::String i1 = _hx_tmp->_hx_getString(0);
HXLINE( 776)								 ::hscript::Expr eret1 = this->parseExpr();
HXLINE( 777)								return ::hscript::Expr_obj::EFunction(::Array_obj< ::Dynamic>::__new(1)->init(0, ::Dynamic(hx::Anon_obj::Create(1)
...
HXDLIN( 774)							if ((_hx_getEnumValueIndex(_hx_tmp1) == (int)1)) {
HXLINE( 778)								 ::hscript::CType t = e1->_hx_getObject(1).StaticCast<  ::hscript::CType >();
HXDLIN( 778)								::String i2 = _hx_tmp1->_hx_getString(0);
HXLINE( 779)								 ::hscript::Expr eret2 = this->parseExpr();
...
HXLINE( 786)				if (( (bool)(::haxe::IMap_obj::get(this->unops,op)) )) {
HXLINE( 787)					bool _hx_tmp2;
HXDLIN( 787)					if (!(this->isBlock(e1))) {
HXLINE( 787)						if ((_hx_getEnumValueIndex(e1) == (int)3)) {
...
HXLINE( 801)				{
HXLINE( 801)					 ::hscript::Token t1 = this->token();
HXDLIN( 801)					if (hx::IsNotEq( t1,::hscript::Token_obj::TBkClose_dyn() )) {
HXLINE( 801)						this->unexpected(t1);
            					}
            				}
HXLINE( 802)				return this->parseExprNext(::hscript::Expr_obj::EArray(e1,e2));
            			...
            			break;
            			case (int)13: {
HXLINE( 804)				 ::hscript::Expr e21 = this->parseExpr();
HXLINE( 805)				{
HXLINE( 805)					 ::hscript::Token t2 = this->token();
HXDLIN( 805)					if (hx::IsNotEq( t2,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 805)						this->unexpected(t2);
            					}
            				}
HXLINE( 806)				 ::hscript::Expr e3 = this->parseExpr();
HXLINE( 807)				return ::hscript::Expr_obj::ETernary(e1,e21,e3);
            			}
            			break;
            			default:{
HXLINE( 809)				{
HXLINE( 809)					 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 809)					_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            				}
...
HXLINE( 821)				if ((_hx_getEnumValueIndex(tk) == (int)13)) {
HXLINE( 823)					opt = true;
HXLINE( 824)					tk = this->token();
            				}
HXLINE( 827)				if ((_hx_getEnumValueIndex(tk) == (int)2)) {
HXLINE( 828)					::String id = tk->_hx_getString(0);
HXDLIN( 828)					name = id;
            				}
            				else {
HXLINE( 830)					this->unexpected(tk);
HXLINE( 831)					goto _hx_goto_58;
            				}
...
HXLINE( 843)				switch((int)(_hx_getEnumValueIndex(tk))){
            					case (int)5: {
...
HXLINE( 885)		switch((int)(_hx_getEnumValueIndex(t))){
            			case (int)2: {
...
HXLINE( 891)				if ((_hx_getEnumValueIndex(t) == (int)3)) {
...
HXLINE( 898)							switch((int)(_hx_getEnumValueIndex(t))){
            								case (int)3: {
HXLINE( 900)									::String op1 = t->_hx_getString(0);
HXDLIN( 900)									{
HXLINE( 901)										if ((op1 == HX_(">",3e,00,00,00))) {
HXLINE( 901)											goto _hx_goto_63;
            										}
HXLINE( 902)										if (hx::IsEq( op1.charCodeAt((int)0),(int)62 )) {
HXLINE( 906)											{
HXLINE( 906)												 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN( 906)												 ::hscript::Token item = ::hscript::Token_obj::TOp(op1.substr((int)1,null()));
HXDLIN( 906)												_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,item,_this1->head);
            											}
HXLINE( 908)											goto _hx_goto_63;
            										}
            									}
            								}
            								break;
...
HXLINE( 913)							goto _hx_goto_63;
            						}
            						_hx_goto_63:;
            					}
            					else {
HXLINE( 916)						 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN( 916)						_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this2->head);
            					}
            				}
            				else {
HXLINE( 918)					 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN( 918)					_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this3->head);
            				}
...
HXDLIN( 929)						if ((_hx_getEnumValueIndex(_g) == (int)3)) {
HXLINE( 929)							if ((_g->_hx_getString(0) != HX_("->",71,27,00,00))) {
HXLINE( 931)								 ::hscript::Token t1 = _g;
HXDLIN( 931)								_gthis->unexpected(t1);
            							}
            						}
            						else {
HXLINE( 931)							 ::hscript::Token t2 = _g;
HXDLIN( 931)							_gthis->unexpected(t2);
            						}
            					}
...
HXDLIN( 925)					_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,b,_this4->head);
            				}
HXLINE( 926)				{
HXLINE( 926)					 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN( 926)					_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,a,_this5->head);
            				}
HXLINE( 928)				 ::Dynamic withReturn =  ::Dynamic(new _hx_Closure_0(_gthis));
HXLINE( 937)				switch((int)(_hx_getEnumValueIndex(a))){
            					case (int)2: {
HXLINE( 937)						if ((_hx_getEnumValueIndex(b) == (int)14)) {
HXLINE( 940)							::Array< ::Dynamic> _g1 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)							{
HXLINE( 940)								int _g11 = (int)0;
HXDLIN( 940)								::Array< ::Dynamic> _g2 = this->parseFunctionArgs();
HXDLIN( 940)								while((_g11 < _g2->length)){
HXLINE( 940)									 ::Dynamic arg = _g2->__get(_g11);
HXDLIN( 940)									_g11 = (_g11 + (int)1);
HXLINE( 941)									{
HXLINE( 941)										 ::hscript::Expr _g3 = arg->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic);
HXLINE( 942)										if (hx::IsNotNull( _g3 )) {
HXLINE( 943)											 ::hscript::Expr v1 = _g3;
HXLINE( 944)											if (!(this->resumeErrors)) {
HXLINE( 944)												HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            											}
            										}
            									}
...
HXLINE( 940)									_g1->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)),_hx_tmp));
            								}
            							}
HXDLIN( 940)							::Array< ::Dynamic> args1 = _g1;
HXLINE( 950)							return withReturn(args1);
            						}
            						else {
HXLINE( 953)							 ::hscript::CType t3 = this->parseType();
HXLINE( 954)							 ::hscript::Token _g4 = this->token();
HXDLIN( 954)							switch((int)(_hx_getEnumValueIndex(_g4))){
            								case (int)5: {
HXLINE( 965)									return this->parseTypeNext(::hscript::CType_obj::CTParent(t3));
            								}
            								break;
            								case (int)9: {
HXLINE( 956)									::Array< ::Dynamic> args2 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t3);
HXLINE( 958)									while(true){
HXLINE( 959)										args2->push(this->parseType());
...
HXLINE( 960)											goto _hx_goto_66;
            									...
            									_hx_goto_66:;
HXLINE( 962)									{
HXLINE( 962)										 ::hscript::Token t4 = this->token();
HXDLIN( 962)										if (hx::IsNotEq( t4,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)											this->unexpected(t4);
            										}
            									}
HXLINE( 963)									return withReturn(args2);
            								}
            								break;
            								default:{
HXLINE( 966)									 ::hscript::Token t5 = _g4;
HXDLIN( 966)									return this->unexpected(t5);
            								}
            							}
            						}
            					}
            					break;
            					case (int)5: {
HXLINE( 940)						::Array< ::Dynamic> _g5 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 940)						{
HXLINE( 940)							int _g12 = (int)0;
HXDLIN( 940)							::Array< ::Dynamic> _g21 = this->parseFunctionArgs();
HXDLIN( 940)							while((_g12 < _g21->length)){
HXLINE( 940)								 ::Dynamic arg1 = _g21->__get(_g12);
HXDLIN( 940)								_g12 = (_g12 + (int)1);
HXLINE( 941)								{
HXLINE( 941)									 ::hscript::Expr _g31 = arg1->__Field(HX_("value",71,7f,b8,31),hx::paccDynamic);
HXLINE( 942)									if (hx::IsNotNull( _g31 )) {
HXLINE( 943)										 ::hscript::Expr v2 = _g31;
HXLINE( 944)										if (!(this->resumeErrors)) {
HXLINE( 944)											HX_STACK_DO_THROW(::hscript::Error_obj::ECustom(HX_("Default values not allowed in function types",28,46,7a,e6)));
            										}
            									}
            								}
HXLINE( 947)								 ::hscript::CType _hx_tmp1;
HXDLIN( 947)								if (( (bool)(arg1->__Field(HX_("opt",33,9c,54,00),hx::paccDynamic)) )) {
HXLINE( 947)									_hx_tmp1 = ::hscript::CType_obj::CTOpt( ::Dynamic(arg1->__Field(HX_("t",74,00,00,00),hx::paccDynamic)));
            								}
            								else {
HXLINE( 947)									_hx_tmp1 = arg1->__Field(HX_("t",74,00,00,00),hx::paccDynamic);
            								}
HXLINE( 940)								_g5->push(::hscript::CType_obj::CTNamed( ::Dynamic(arg1->__Field(HX_("name",4b,72,ff,48),hx::paccDynamic)),_hx_tmp1));
            							}
            						}
HXDLIN( 940)						::Array< ::Dynamic> args3 = _g5;
HXLINE( 950)						return withReturn(args3);
            					}
            					break;
            					default:{
HXLINE( 953)						 ::hscript::CType t6 = this->parseType();
HXLINE( 954)						 ::hscript::Token _g6 = this->token();
HXDLIN( 954)						switch((int)(_hx_getEnumValueIndex(_g6))){
            							case (int)5: {
HXLINE( 965)								return this->parseTypeNext(::hscript::CType_obj::CTParent(t6));
            							}
            							break;
            							case (int)9: {
HXLINE( 956)								::Array< ::Dynamic> args4 = ::Array_obj< ::Dynamic>::__new(1)->init(0,t6);
HXLINE( 958)								while(true){
HXLINE( 959)									args4->push(this->parseType());
HXLINE( 960)									if (!(this->maybe(::hscript::Token_obj::TComma_dyn()))) {
HXLINE( 960)										goto _hx_goto_64;
            								...
            								_hx_goto_64:;
HXLINE( 962)								{
HXLINE( 962)									 ::hscript::Token t7 = this->token();
HXDLIN( 962)									if (hx::IsNotEq( t7,::hscript::Token_obj::TPClose_dyn() )) {
HXLINE( 962)										this->unexpected(t7);
            									}
            								}
HXLINE( 963)								return withReturn(args4);
            							}
            							break;
            							default:{
HXLINE( 966)								 ::hscript::Token t8 = _g6;
HXDLIN( 966)								return this->unexpected(t8);
            							}
            						}
            					}
            				}
...
HXLINE( 974)					switch((int)(_hx_getEnumValueIndex(t))){
            						case (int)2: {
HXLINE( 974)							if ((t->_hx_getString(0) == HX_("var",e7,de,59,00))) {
HXLINE( 977)								::String name = this->getIdent();
HXLINE( 978)								{
HXLINE( 978)									 ::hscript::Token t9 = this->token();
HXDLIN( 978)									if (hx::IsNotEq( t9,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 978)										this->unexpected(t9);
            									}
            								}
...
HXLINE( 981)								{
HXLINE( 981)									 ::hscript::Token t10 = this->token();
HXDLIN( 981)									if (hx::IsNotEq( t10,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE( 981)										this->unexpected(t10);
            									}
            								}
            							}
            							else {
HXLINE( 982)								::String name1 = t->_hx_getString(0);
HXDLIN( 982)								{
HXLINE( 983)									{
HXLINE( 983)										 ::hscript::Token t11 = this->token();
HXDLIN( 983)										if (hx::IsNotEq( t11,::hscript::Token_obj::TDoubleDot_dyn() )) {
HXLINE( 983)											this->unexpected(t11);
            										}
            									}
...
HXLINE( 986)									switch((int)(_hx_getEnumValueIndex(t))){
            										case (int)7: {
...
HXLINE( 975)							goto _hx_goto_68;
            						...
            						break;
            						case (int)15: {
HXLINE( 991)							::String name2 = t->_hx_getString(0);
HXDLIN( 991)							{
...
HXLINE(1007)		if ((_hx_getEnumValueIndex(tk) == (int)3)) {
...
HXLINE(1014)			{
HXLINE(1014)				 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1014)				_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this1->head);
            			}
HXLINE(1015)			return t;
            		}
HXLINE(1017)		 ::hscript::CType t2 = this->parseType();
HXLINE(1018)		if ((_hx_getEnumValueIndex(t2) == (int)1)) {
HXLINE(1019)			::Array< ::Dynamic> args = t2->_hx_getObject(0).StaticCast< ::Array< ::Dynamic> >();
...
HXLINE(1036)			if ((_hx_getEnumValueIndex(tk) != (int)9)) {
...
HXLINE(1052)		this->readPos = (int)0;
...
HXLINE(1069)			if ((_hx_getEnumValueIndex(tk) == (int)15)) {
...
HXLINE(1082)			int pmin = this->readPos;
HXDLIN(1082)			int pmax = this->readPos;
HXDLIN(1082)			if (!(this->resumeErrors)) {
HXLINE(1082)				HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidOp(HX_("Unsupported class type parameters",9d,ae,a3,50)));
            			}
            		}
...
HXLINE(1135)				if ((_hx_getEnumValueIndex(t) == (int)2)) {
HXLINE(1135)					::String _hx_switch_2 = t->_hx_getString(0);
...
HXLINE(1141)					{
HXLINE(1141)						 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1141)						_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t,_this1->head);
            					}
HXLINE(1142)					goto _hx_goto_82;
            				}
            			}
...
HXLINE(1147)			{
HXLINE(1147)				 ::hscript::Token t1 = this->token();
HXDLIN(1147)				if (hx::IsNotEq( t1,::hscript::Token_obj::TBrOpen_dyn() )) {
HXLINE(1147)					this->unexpected(t1);
            				}
            			}
...
HXLINE(1110)				 ::hscript::Token t2 = this->token();
HXLINE(1111)				if (hx::IsNotEq( t2,::hscript::Token_obj::TDot_dyn() )) {
HXLINE(1112)					{
HXLINE(1112)						 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1112)						_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,t2,_this2->head);
            					}
HXLINE(1113)					goto _hx_goto_85;
            				}
HXLINE(1115)				t2 = this->token();
HXLINE(1116)				switch((int)(_hx_getEnumValueIndex(t2))){
            					case (int)2: {
HXLINE(1117)						::String id = t2->_hx_getString(0);
HXLINE(1118)						path->push(id);
            					}
            					break;
            					case (int)3: {
HXLINE(1116)						if ((t2->_hx_getString(0) == HX_("*",2a,00,00,00))) {
HXLINE(1120)							star = true;
            						}
            						else {
HXLINE(1122)							this->unexpected(t2);
            						}
            					}
            					break;
            					default:{
HXLINE(1122)						this->unexpected(t2);
            			...
            			_hx_goto_85:;
HXLINE(1125)			{
HXLINE(1125)				 ::hscript::Token t3 = this->token();
HXDLIN(1125)				if (hx::IsNotEq( t3,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE(1125)					this->unexpected(t3);
            				}
            			}
...
HXLINE(1103)			::Array< ::String > path1 = this->parsePath();
HXLINE(1104)			{
HXLINE(1104)				 ::hscript::Token t4 = this->token();
HXDLIN(1104)				if (hx::IsNotEq( t4,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE(1104)					this->unexpected(t4);
            				}
            			}
HXLINE(1105)			return ::hscript::ModuleDecl_obj::DPackage(path1);
HXLINE(1102)			goto _hx_goto_81;
            		}
            		if (  (_hx_switch_1==HX_("typedef",4b,37,d8,f8)) ){
HXLINE(1162)			::String name1 = this->getIdent();
HXLINE(1163)			 ::Dynamic params1 = this->parseParams();
HXLINE(1164)			{
HXLINE(1164)				 ::hscript::Token t5 = this->token();
HXDLIN(1164)				if (!(::Type_obj::enumEq(t5,::hscript::Token_obj::TOp(HX_("=",3d,00,00,00))))) {
HXLINE(1164)					this->unexpected(t5);
            				}
            			}
HXLINE(1165)			 ::hscript::CType t6 = this->parseType();
...
HXDLIN(1194)				goto _hx_goto_88;
            			...
            			if (  (_hx_switch_0==HX_("var",e7,de,59,00)) ){
HXLINE(1211)				::String name1 = this->getIdent();
...
HXLINE(1226)						 ::hscript::Token t2 = this->token();
HXDLIN(1226)						if (hx::IsNotEq( t2,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE(1226)							this->unexpected(t2);
            						}
            					}
            				}
            				else {
...
HXLINE(1227)						if ((_hx_getEnumValueIndex(type) == (int)2)) {
...
HXLINE(1230)						 ::hscript::Token t3 = this->token();
HXDLIN(1230)						if (hx::IsNotEq( t3,::hscript::Token_obj::TSemicolon_dyn() )) {
HXLINE(1230)							this->unexpected(t3);
            						}
            					}
            				}
...
HXDLIN(1280)							b->charBuf->push(c1);
            						}
            						else {
HXLINE(1280)							this->invalidChar(c1);
            						}
            					}
            					break;
            					case (int)110: {
...
HXDLIN(1276)						b->charBuf->push((int)10);
            					}
            					break;
            					case (int)114: {
...
HXDLIN(1277)						b->charBuf->push((int)13);
            					}
            					break;
            					case (int)116: {
...
HXDLIN(1278)						b->charBuf->push((int)9);
            					}
            					break;
            					case (int)117: {
HXLINE(1282)						if (!(this->allowJSON)) {
HXLINE(1282)							this->invalidChar(c1);
            						}
HXLINE(1283)						int k = (int)0;
HXLINE(1284)						{
HXLINE(1284)							int _g = (int)0;
HXDLIN(1284)							while((_g < (int)4)){
HXLINE(1284)								_g = (_g + (int)1);
HXDLIN(1284)								int i = (_g - (int)1);
HXLINE(1285)								k = ((int)k << (int)(int)4);
...
HXDLIN(1302)							b->charBuf->push(k);
            					...
            					break;
            					default:{
HXLINE(1303)						this->invalidChar(c1);
            					}
            				}
            			}
            			else {
HXLINE(1305)				if ((c1 == (int)92)) {
HXLINE(1306)					esc = true;
            				}
            				else {
HXLINE(1307)					if ((c1 == until)) {
HXLINE(1308)						goto _hx_goto_91;
            					}
            					else {
HXLINE(1310)						if ((c1 == (int)10)) {
...
HXLINE(1468)							if ((_hx_char != (int)46)) {
...
HXLINE(1470)							return ::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00));
            						...
            						break;
            						case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1453)							int n = (_hx_char - (int)48);
HXLINE(1454)							int exp = (int)1;
HXLINE(1455)							while(true){
HXLINE(1456)								_hx_char = this->input.cca(this->readPos++);
HXLINE(1457)								exp = (exp * (int)10);
HXLINE(1458)								switch((int)(_hx_char)){
            									case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1460)										n = ((n * (int)10) + (_hx_char - (int)48));
            									}
            									break;
            									default:{
...
HXLINE(1473)							return ::hscript::Token_obj::TDot_dyn();
            				...
            				break;
            				case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1362)					Float n1 = ((_hx_char - (int)48) * ((Float)1.0));
HXLINE(1363)					Float exp1 = ((Float)0.);
HXLINE(1364)					while(true){
HXLINE(1365)						_hx_char = this->input.cca(this->readPos++);
HXLINE(1366)						exp1 = (exp1 * (int)10);
HXLINE(1367)						switch((int)(_hx_char)){
            							case (int)46: {
HXLINE(1388)								if ((exp1 > (int)0)) {
HXLINE(1390)									bool _hx_tmp;
HXDLIN(1390)									if ((exp1 == (int)10)) {
HXLINE(1390)										_hx_tmp = (this->input.cca(this->readPos++) == (int)46);
            									}
            									else {
...
HXLINE(1391)										{
HXLINE(1391)											 ::haxe::ds::GenericStack_hscript_Token _this1 = this->tokens;
HXDLIN(1391)											_this1->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,::hscript::Token_obj::TOp(HX_("...",ee,0f,23,00)),_this1->head);
            										}
HXLINE(1392)										int i = ::Std_obj::_hx_int(n1);
HXLINE(1393)										 ::hscript::Const _hx_tmp1;
HXDLIN(1393)										if ((i == n1)) {
HXLINE(1393)											_hx_tmp1 = ::hscript::Const_obj::CInt(i);
            										}
            										else {
HXLINE(1393)											_hx_tmp1 = ::hscript::Const_obj::CFloat(n1);
            										}
HXDLIN(1393)										return ::hscript::Token_obj::TConst(_hx_tmp1);
            									}
HXLINE(1395)									this->invalidChar(_hx_char);
            								}
HXLINE(1397)								exp1 = ((Float)1.);
            							}
            							break;
            							case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1369)								n1 = ((n1 * (int)10) + (_hx_char - (int)48));
            							}
            							break;
            							case (int)69: case (int)101: {
HXLINE(1371)								 ::hscript::Token tk = this->token();
HXLINE(1372)								 ::Dynamic pow = null();
HXLINE(1373)								switch((int)(_hx_getEnumValueIndex(tk))){
            									case (int)1: {
HXLINE(1373)										if ((_hx_getEnumValueIndex(tk->_hx_getObject(0).StaticCast<  ::hscript::Const >()) == (int)0)) {
HXLINE(1374)											int e = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >()->_hx_getInt(0);
HXDLIN(1374)											pow = e;
            										}
            										else {
HXLINE(1382)											 ::haxe::ds::GenericStack_hscript_Token _this2 = this->tokens;
HXDLIN(1382)											_this2->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this2->head);
            										}
            									}
            									break;
            									case (int)3: {
HXLINE(1373)										if ((tk->_hx_getString(0) == HX_("-",2d,00,00,00))) {
HXLINE(1376)											tk = this->token();
HXLINE(1377)											if ((_hx_getEnumValueIndex(tk) == (int)1)) {
HXLINE(1377)												if ((_hx_getEnumValueIndex(tk->_hx_getObject(0).StaticCast<  ::hscript::Const >()) == (int)0)) {
HXLINE(1378)													int e1 = tk->_hx_getObject(0).StaticCast<  ::hscript::Const >()->_hx_getInt(0);
HXDLIN(1378)													pow = -(e1);
            												}
            												else {
HXLINE(1379)													 ::haxe::ds::GenericStack_hscript_Token _this3 = this->tokens;
HXDLIN(1379)													_this3->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this3->head);
            												}
            											}
            											else {
HXLINE(1379)												 ::haxe::ds::GenericStack_hscript_Token _this4 = this->tokens;
HXDLIN(1379)												_this4->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this4->head);
            											}
            										}
            										else {
HXLINE(1382)											 ::haxe::ds::GenericStack_hscript_Token _this5 = this->tokens;
HXDLIN(1382)											_this5->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this5->head);
            										}
            									}
            									break;
            									default:{
HXLINE(1382)										 ::haxe::ds::GenericStack_hscript_Token _this6 = this->tokens;
HXDLIN(1382)										_this6->head =  ::haxe::ds::GenericCell_hscript_Token_obj::__alloc( HX_CTX ,tk,_this6->head);
            									}
            								}
HXLINE(1384)								if (hx::IsNull( pow )) {
HXLINE(1385)									this->invalidChar(_hx_char);
            								}
HXLINE(1386)								return ::hscript::Token_obj::TConst(::hscript::Const_obj::CFloat(((((Float)::Math_obj::pow((int)10,pow) / (Float)exp1) * n1) * (int)10)));
            							}
            							break;
            							case (int)120: {
HXLINE(1399)								bool _hx_tmp2;
HXDLIN(1399)								if (!((n1 > (int)0))) {
HXLINE(1399)									_hx_tmp2 = (exp1 > (int)0);
            								}
            								else {
HXLINE(1399)									_hx_tmp2 = true;
            								}
HXDLIN(1399)								if (_hx_tmp2) {
HXLINE(1400)									this->invalidChar(_hx_char);
            								}
HXLINE(1403)								int n2 = (int)0;
HXLINE(1404)								while(true){
HXLINE(1405)									_hx_char = this->input.cca(this->readPos++);
HXLINE(1406)									switch((int)(_hx_char)){
            										case (int)48: case (int)49: case (int)50: case (int)51: case (int)52: case (int)53: case (int)54: case (int)55: case (int)56: case (int)57: {
HXLINE(1408)											n2 = ((((int)n2 << (int)(int)4) + _hx_char) - (int)48);
            										}
            										break;
            										case (int)65: case (int)66: case (int)67: case (int)68: case (int)69: case (int)70: {
HXLINE(1410)											n2 = (((int)n2 << (int)(int)4) + (_hx_char - (int)55));
            										}
            										break;
            										case (int)97: case (int)98: case (int)99: case (int)100: case (int)101: case (int)102: {
HXLINE(1412)											n2 = (((int)n2 << (int)(int)4) + (_hx_char - (int)87));
            										}
            										break;
            										default:{
HXLINE(1414)											this->_hx_char = _hx_char;
HXLINE(1415)											return ::hscript::Token_obj::TConst(::hscript::Const_obj::CInt(n2));
            										}
            									}
            								}
            							}
...
HXLINE(1441)								int i1 = ::Std_obj::_hx_int(n1);
HXLINE(1442)								 ::hscript::Const _hx_tmp3;
HXDLIN(1442)								if ((exp1 > (int)0)) {
HXLINE(1442)									_hx_tmp3 = ::hscript::Const_obj::CFloat(((Float)(n1 * (int)10) / (Float)exp1));
            								}
            								else {
HXLINE(1442)									if ((i1 == n1)) {
HXLINE(1442)										_hx_tmp3 = ::hscript::Const_obj::CInt(i1);
            									}
            									else {
HXLINE(1442)										_hx_tmp3 = ::hscript::Const_obj::CFloat(n1);
            									}
            								}
HXDLIN(1442)								return ::hscript::Token_obj::TConst(_hx_tmp3);
            							}
            						}
            					}
            				}
...
HXLINE(1484)					if ((_hx_char == (int)61)) {
HXLINE(1485)						return ::hscript::Token_obj::TOp(HX_("==",60,35,00,00));
            					}
            					else {
HXLINE(1486)						if ((_hx_char == (int)62)) {
...
HXLINE(1492)						_hx_tmp4 = (_hx_char == (int)58);
            					}
            					else {
HXLINE(1492)						_hx_tmp4 = true;
            					}
HXDLIN(1492)					if (_hx_tmp4) {
HXLINE(1493)						::String id1 = ::String::fromCharCode(_hx_char);
...
HXLINE(1498)								return ::hscript::Token_obj::TMeta(id1);
            							}
HXLINE(1500)							id1 = (id1 + ::String::fromCharCode(_hx_char));
            						}
            					}
...
HXLINE(1521)						int prev = (int)-1;
HXLINE(1522)						while(true){
HXLINE(1523)							_hx_char = this->input.cca(this->readPos++);
HXLINE(1524)							if ((_hx_char == (int)0)) {
HXLINE(1524)								_hx_char = (int)0;
            							}
HXLINE(1525)							bool _hx_tmp5;
HXDLIN(1525)							if (!(!(this->ops->__get(_hx_char)))) {
HXLINE(1525)								_hx_tmp5 = (prev == (int)61);
            							}
            							else {
HXLINE(1525)								_hx_tmp5 = true;
            							}
HXDLIN(1525)							if (_hx_tmp5) {
HXLINE(1526)								if (hx::IsEq( op.charCodeAt((int)0),(int)47 )) {
...
HXLINE(1536)						::String id2 = ::String::fromCharCode(_hx_char);
HXLINE(1537)						while(true){
HXLINE(1538)							_hx_char = this->input.cca(this->readPos++);
HXLINE(1539)							if ((_hx_char == (int)0)) {
HXLINE(1539)								_hx_char = (int)0;
            							}
HXLINE(1540)							if (!(this->idents->__get(_hx_char))) {
HXLINE(1541)								this->_hx_char = _hx_char;
HXLINE(1542)								return ::hscript::Token_obj::TId(id2);
            							}
HXLINE(1544)							id2 = (id2 + ::String::fromCharCode(_hx_char));
            						}
            					}
...
HXLINE(1562)		switch((int)(_hx_getEnumValueIndex(tk))){
            			case (int)2: {
...
HXLINE(1567)				return ::hscript::Expr_obj::EIdent(id);
            			...
            			break;
            			case (int)3: {
HXLINE(1562)				if ((tk->_hx_getString(0) == HX_("!",21,00,00,00))) {
...
HXDLIN(1576)		switch((int)(_hx_getEnumValueIndex(e))){
            			case (int)1: {
...
HXLINE(1582)				return this->evalPreproCond(e1);
            			...
            			break;
            			case (int)6: {
HXDLIN(1576)				::String _hx_switch_0 = e->_hx_getString(0);
            				if (  (_hx_switch_0==HX_("&&",40,21,00,00)) ){
HXLINE(1583)					 ::hscript::Expr e2 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1583)					 ::hscript::Expr e11 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE(1584)					if (this->evalPreproCond(e11)) {
...
HXLINE(1585)					 ::hscript::Expr e21 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXDLIN(1585)					 ::hscript::Expr e12 = e->_hx_getObject(1).StaticCast<  ::hscript::Expr >();
HXLINE(1586)					if (!(this->evalPreproCond(e12))) {
HXLINE(1586)						return this->evalPreproCond(e21);
            					}
            					else {
...
HXLINE(1588)							HX_STACK_DO_THROW(err);
            						}
            					}
HXLINE(1589)					return false;
            			...
            			break;
            			case (int)7: {
HXDLIN(1576)				if ((e->_hx_getString(0) == HX_("!",21,00,00,00))) {
HXLINE(1579)					 ::hscript::Expr e3 = e->_hx_getObject(2).StaticCast<  ::hscript::Expr >();
HXLINE(1580)					return !(this->evalPreproCond(e3));
            				}
            				else {
HXLINE(1588)					{
HXLINE(1588)						 ::hscript::Error err1 = ::hscript::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e)));
HXDLIN(1588)						int pmin1 = this->readPos;
HXDLIN(1588)						int pmax1 = this->readPos;
HXDLIN(1588)						if (!(this->resumeErrors)) {
HXLINE(1588)							HX_STACK_DO_THROW(err1);
            						}
            					}
HXLINE(1589)					return false;
            				}
            			...
            			default:{
HXLINE(1588)				{
HXLINE(1588)					 ::hscript::Error err2 = ::hscript::Error_obj::EInvalidPreprocessor((HX_("Can't eval ",01,17,bf,09) + ::Type_obj::enumConstructor(e)));
HXDLIN(1588)					int pmin2 = this->readPos;
HXDLIN(1588)					int pmax2 = this->readPos;
HXDLIN(1588)					if (!(this->resumeErrors)) {
HXLINE(1588)						HX_STACK_DO_THROW(err2);
            					}
            				}
HXLINE(1589)				return false;
            			}
...
HXLINE(1604)			if ((this->preprocStack->length > (int)0)) {
HXLINE(1605)				::Array< ::Dynamic> _hx_tmp = this->preprocStack;
HXDLIN(1605)				if (( (bool)(_hx_tmp->__get((this->preprocStack->length - (int)1))->__Field(HX_("r",72,00,00,00),hx::paccDynamic)) )) {
HXLINE(1606)					::Array< ::Dynamic> _hx_tmp1 = this->preprocStack;
HXDLIN(1606)					_hx_tmp1->__get((this->preprocStack->length - (int)1))->__SetField(HX_("r",72,00,00,00),false,hx::paccDynamic);
...
HXLINE(1618)			if ((this->preprocStack->length > (int)0)) {
...
HXLINE(1627)		int spos = (this->preprocStack->length - (int)1);
...
HXLINE(1633)					HX_STACK_DO_THROW(::hscript::Error_obj::EInvalidPreprocessor(HX_("Unclosed",e5,94,4a,ea)));
            				}
            			}
...
HXLINE(1642)		 ::Dynamic c = op.charCodeAt((int)1);
HXLINE(1643)		::String s = this->input;
HXLINE(1644)		if (hx::IsEq( c,(int)47 )) {
HXLINE(1645)			while(true){
HXLINE(1645)				bool _hx_tmp;
HXDLIN(1645)				if ((_hx_char != (int)13)) {
HXLINE(1645)					_hx_tmp = (_hx_char != (int)10);
            				}
            				else {
...
HXLINE(1652)		if (hx::IsEq( c,(int)42 )) {
...
HXLINE(1659)				while((_hx_char != (int)42)){
HXLINE(1660)					if ((_hx_char == (int)10)) {
HXLINE(1660)						this->line++;
            					}
HXLINE(1661)					_hx_char = this->input.cca(this->readPos++);
HXLINE(1662)					if ((_hx_char == (int)0)) {
HXLINE(1663)						this->line = old;
HXLINE(1664)						if (!(this->resumeErrors)) {
HXLINE(1664)							HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedComment_dyn());
            						}
...
HXLINE(1669)				if ((_hx_char == (int)0)) {
HXLINE(1670)					this->line = old;
HXLINE(1671)					if (!(this->resumeErrors)) {
HXLINE(1671)						HX_STACK_DO_THROW(::hscript::Error_obj::EUnterminatedComment_dyn());
            					}
HXLINE(1672)					goto _hx_goto_112;
            				}
HXLINE(1674)				if ((_hx_char == (int)47)) {
...
HXDLIN(1684)		switch((int)(_hx_getEnumValueIndex(c))){
            			case (int)0: {
...
HXDLIN(1695)		switch((int)(_hx_getEnumValueIndex(t))){
            			case (int)0: {
...
HXDLIN(1698)				return s;
            			...
            			break;
            			case (int)3: {
HXLINE(1699)				::String s1 = t->_hx_getString(0);
HXDLIN(1699)				return s1;
            			}
            			break;
            			case (int)4: {
...
HXDLIN(1711)				return (HX_("@",40,00,00,00) + id);
            			...
            			break;
            			case (int)16: {
HXLINE(1712)				::String id1 = t->_hx_getString(0);
HXDLIN(1712)				return (HX_("#",23,00,00,00) + id1);
            			}
            			break;
            		}
...
void Parser_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_HCSTRING("resumeErrors","\x38","\x61","\x37","\x31"));
...
static hx::StorageInfo Parser_obj_sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(Parser_obj,resumeErrors),HX_HCSTRING("resumeErrors","\x38","\x61","\x37","\x31")},
...
static ::String Parser_obj_sMemberFields[] = {
	...
	HX_HCSTRING("resumeErrors","\x38","\x61","\x37","\x31"),
...
HXDLIN( 104)		tokenMin = (int)0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_2fd3d36595bebf3d_105_boot)
HXDLIN( 105)		tokenMax = (int)0;
            	}
}
