...
HXLINE(  49)		this->_hx___uploadedSides = (int)0;
            	}
...
HXLINE(  92)			::haxe::Timer_obj::delay( ::Dynamic(new _hx_Closure_0(_gthis,data,byteArrayOffset)),(int)1);
            		}
            	}
...
HXLINE( 147)		int size = ((int)this->_hx___size >> (int)miplevel);
HXLINE( 148)		if ((size == (int)0)) {
HXLINE( 148)			return;
            		}
...
HXDLIN( 214)			 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 214)			int in_byteOffset = byteArrayOffset;
HXDLIN( 214)			if ((in_byteOffset < (int)0)) {
HXDLIN( 214)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
HXDLIN( 214)			if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXDLIN( 214)				HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            			}
...
HXDLIN( 214)				if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXDLIN( 214)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
HXDLIN( 214)				if ((newByteLength < (int)0)) {
HXDLIN( 214)					HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            				}
            			}
...
HXLINE( 243)		int size = ((int)this->_hx___size >> (int)miplevel);
HXLINE( 244)		if ((size == (int)0)) {
HXLINE( 244)			return;
            		}
...
HXDLIN( 249)			{
HXLINE( 249)				::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data,null(),(int)0);
HXDLIN( 249)				gl->texImage2D(target,miplevel,internalformat,size,size,(int)0,format,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            			}
            		}
...
HXDLIN( 252)		_hx_tmp->_hx___uploadedSides = ((int)_hx_tmp->_hx___uploadedSides | (int)((int)(int)1 << (int)side));
            	}
...
HXLINE( 262)			this->_hx___framebufferSurface = (int)-1;
            		}
...
HXLINE( 270)			gl->framebufferTexture2D(gl->FRAMEBUFFER,gl->COLOR_ATTACHMENT0,(gl->TEXTURE_CUBE_MAP_POSITIVE_X + surfaceSelector),this->_hx___textureID,(int)0);
...
HXLINE( 279)					::lime::utils::Log_obj::error((((((HX_("Error: Context3D.setRenderToTexture status:",4c,0a,86,52) + code) + HX_(" width:",94,67,ab,7e)) + this->_hx___width) + HX_(" height:",53,26,89,26)) + this->_hx___height),hx::SourceInfo(HX_("CubeTexture.hx",38,ae,c0,7e),279,HX_("openfl.display3D.textures.CubeTexture",09,1a,15,3a),HX_("__getGLFramebuffer",92,f3,72,c9)));
            				}
            			}
            		}
...
HXDLIN( 293)			if (hx::IsNotEq( state->mipfilter,(int)2 )) {
...
HXLINE( 299)			if ((::openfl::display3D::Context3D_obj::_hx___glMaxTextureMaxAnisotropy != (int)0)) {
HXLINE( 301)				int aniso;
HXDLIN( 301)				 ::Dynamic _g = state->filter;
HXDLIN( 301)				 ::Dynamic _hx_switch_0 = _g;
            				if (  (_hx_switch_0==(int)0) ){
HXLINE( 301)					aniso = (int)16;
HXDLIN( 301)					goto _hx_goto_7;
            				}
            				if (  (_hx_switch_0==(int)1) ){
HXLINE( 301)					aniso = (int)2;
HXDLIN( 301)					goto _hx_goto_7;
            				}
            				if (  (_hx_switch_0==(int)2) ){
HXLINE( 301)					aniso = (int)4;
HXDLIN( 301)					goto _hx_goto_7;
            				}
            				if (  (_hx_switch_0==(int)3) ){
HXLINE( 301)					aniso = (int)8;
HXDLIN( 301)					goto _hx_goto_7;
            				}
            				/* default */{
HXLINE( 301)					aniso = (int)1;
            				}
            				_hx_goto_7:;
...
HXLINE( 315)				gl->texParameterf(gl->TEXTURE_CUBE_MAP,::openfl::display3D::Context3D_obj::_hx___glTextureMaxAnisotropy,aniso);
            			}
...
HXLINE( 355)			if (hx::IsEq( format,(int)0 )) {
HXLINE( 355)				return;
            			}
HXLINE( 357)			hasTexture[(int)0] = true;
HXLINE( 358)			int target = _gthis->_hx___sideToTarget(side);
HXLINE( 360)			_gthis->_hx___format = format;
HXLINE( 361)			_gthis->_hx___internalFormat = format;
HXLINE( 363)			bool _hx_tmp;
HXDLIN( 363)			if (alpha) {
HXLINE( 363)				_hx_tmp = (gpuFormat == (int)2);
            			}
            			else {
HXLINE( 363)				_hx_tmp = false;
            			}
HXDLIN( 363)			if (_hx_tmp) {
HXLINE( 365)				int size = ::Std_obj::_hx_int(((Float)blockLength / (Float)(int)2));
...
HXLINE( 368)					 ::lime::utils::ArrayBufferView _this =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 368)					int in_byteOffset = (int)0;
HXDLIN( 368)					if ((in_byteOffset < (int)0)) {
HXLINE( 368)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 368)					if ((hx::Mod(in_byteOffset,_this->bytesPerElement) != (int)0)) {
HXLINE( 368)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 368)						if ((hx::Mod(bufferByteLength,_this->bytesPerElement) != (int)0)) {
HXLINE( 368)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 368)						if ((newByteLength < (int)0)) {
HXLINE( 368)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 367)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,target,level,_gthis1,width,height,(int)0,this1);
HXLINE( 370)				 ::openfl::display3D::textures::CubeTexture alphaTexture =  ::openfl::display3D::textures::CubeTexture_obj::__alloc( HX_CTX ,_gthis->_hx___context,_gthis->_hx___size,(int)3,_gthis->_hx___optimizeForRenderToTexture,_gthis->_hx___streamingLevels);
HXLINE( 371)				alphaTexture->_hx___format = format;
HXLINE( 372)				alphaTexture->_hx___internalFormat = format;
...
HXLINE( 376)					 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 376)					int in_byteOffset1 = size;
HXDLIN( 376)					if ((in_byteOffset1 < (int)0)) {
HXLINE( 376)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 376)					if ((hx::Mod(in_byteOffset1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 376)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 376)						if ((hx::Mod(bufferByteLength1,_this1->bytesPerElement) != (int)0)) {
HXLINE( 376)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 376)						if ((newByteLength1 < (int)0)) {
HXLINE( 376)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 375)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,target,level,alphaTexture1,width,height,(int)0,this2);
...
HXLINE( 383)					 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,(int)0,(int)4);
HXDLIN( 383)					int in_byteOffset2 = (int)0;
HXDLIN( 383)					if ((in_byteOffset2 < (int)0)) {
HXLINE( 383)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
HXDLIN( 383)					if ((hx::Mod(in_byteOffset2,_this2->bytesPerElement) != (int)0)) {
HXLINE( 383)						HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            					}
...
HXDLIN( 383)						if ((hx::Mod(bufferByteLength2,_this2->bytesPerElement) != (int)0)) {
HXLINE( 383)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
HXDLIN( 383)						if ((newByteLength2 < (int)0)) {
HXLINE( 383)							HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            						}
            					}
            					else {
...
HXLINE( 382)				::lime::graphics::_WebGLRenderContext::WebGLRenderContext_Impl__obj::compressedTexImage2D(gl,target,level,_gthis2,width,height,(int)0,this3);
            			}
            		}
...
HXLINE( 349)		::Array< bool > hasTexture = ::Array_obj< bool >::fromData( _hx_array_data_3a151a09_13,1);
HXLINE( 352)		reader->readTextures( ::Dynamic(new _hx_Closure_0(_gthis,hasTexture,alpha,gl)));
HXLINE( 387)		if (!(hasTexture->__get((int)0))) {
HXLINE( 389)			int _g = (int)0;
HXDLIN( 389)			while((_g < (int)6)){
HXLINE( 389)				_g = (_g + (int)1);
HXDLIN( 389)				int side1 = (_g - (int)1);
HXLINE( 391)				 ::Dynamic elements = ((this->_hx___size * this->_hx___size) * (int)4);
HXDLIN( 391)				 ::lime::utils::ArrayBufferView this4;
HXDLIN( 391)				if (hx::IsNotNull( elements )) {
HXLINE( 391)					this4 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,elements,(int)4);
            				}
            				else {
...
HXLINE( 392)				{
HXLINE( 392)					int target1 = this->_hx___sideToTarget(side1);
...
HXDLIN( 392)					{
HXLINE( 392)						::lime::utils::_BytePointer::BytePointer_Impl__obj::set(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer,null(),data1,null(),(int)0);
HXDLIN( 392)						gl->texImage2D(target1,(int)0,internalformat,width1,height1,(int)0,format1,type,::lime::utils::_DataPointer::DataPointer_Impl__obj::fromBytesPointer(::lime::graphics::_WebGL2RenderContext::WebGL2RenderContext_Impl__obj::_hx___tempPointer));
            					}
            				}
            			}
            		}
