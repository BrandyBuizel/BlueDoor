...
HXLINE(  69)			if (::Std_obj::is(library,hx::ClassOf< ::openfl::utils::AssetLibrary >())) {
...
HXLINE( 323)				return ::lime::app::Future_obj::withValue(( ( ::openfl::utils::AssetLibrary)(library1) ));
            			}
            			HX_END_LOCAL_FUNC1(return)
