...
HX_DEFINE_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_41_new,"lime.app.Event","new",0xaf38c4c6,"lime.app.Event.new","lime/app/Event.hx",41,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_57_add,"lime.app.Event","add",0xaf2ee687,"lime.app.Event.add","lime/app/Event.hx",57,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_81_cancel,"lime.app.Event","cancel",0xfb4b3cd4,"lime.app.Event.cancel","lime/app/Event.hx",81,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_126_has,"lime.app.Event","has",0xaf3433c0,"lime.app.Event.has","lime/app/Event.hx",126,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_0b5c7580c5ba99fe_142_remove,"lime.app.Event","remove",0x479feb9e,"lime.app.Event.remove","lime/app/Event.hx",142,0xbda45bec)
namespace lime{
namespace app{

void Event_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_41_new)
HXLINE(  43)		this->canceled = false;
HXLINE(  44)		this->_hx___listeners = ::cpp::VirtualArray_obj::__new();
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_57_add)
HXLINE(  59)		{
...
void Event_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_81_cancel)
...
bool Event_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_126_has)
HXLINE( 128)		{
HXLINE( 128)			int _g = (int)0;
HXDLIN( 128)			::cpp::VirtualArray _g1 = this->_hx___listeners;
HXDLIN( 128)			while((_g < _g1->get_length())){
...
void Event_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_0b5c7580c5ba99fe_142_remove)
HXLINE( 144)		int i = this->_hx___listeners->get_length();
...
HXLINE( 150)				this->_hx___listeners->splice(i,(int)1);
