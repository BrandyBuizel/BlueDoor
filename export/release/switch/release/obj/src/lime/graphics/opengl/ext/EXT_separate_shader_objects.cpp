...
HXLINE(  11)		this->PROGRAM_PIPELINE_BINDING_EXT = (int)33370;
HXLINE(  10)		this->ACTIVE_PROGRAM_EXT = (int)33369;
HXLINE(   9)		this->PROGRAM_SEPARABLE_EXT = (int)33368;
HXLINE(   8)		this->ALL_SHADER_BITS_EXT = (int)-1;
HXLINE(   7)		this->FRAGMENT_SHADER_BIT_EXT = (int)2;
HXLINE(   6)		this->VERTEX_SHADER_BIT_EXT = (int)1;
            	}
