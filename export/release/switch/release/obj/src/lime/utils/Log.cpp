...
HXDLIN( 114)		if (!((args->indexOf(HX_("-v",a9,27,00,00),null()) > (int)-1))) {
HXLINE( 114)			_hx_tmp = (args->indexOf(HX_("-verbose",f5,e6,97,7f),null()) > (int)-1);
            		}
            		else {
HXLINE( 114)			_hx_tmp = true;
            		}
HXDLIN( 114)		if (_hx_tmp) {
HXLINE( 116)			::lime::utils::Log_obj::level = (int)5;
            		}
            		else {
HXLINE( 124)			::lime::utils::Log_obj::level = (int)3;
            		}
            	}
...
HXDLIN(  16)		if ((::lime::utils::Log_obj::level >= (int)4)) {
HXLINE(  21)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
...
HXDLIN(  28)		if ((::lime::utils::Log_obj::level >= (int)1)) {
HXLINE(  30)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ERROR: ",8b,d9,df,31));
...
HXDLIN(  49)		if ((::lime::utils::Log_obj::level >= (int)3)) {
HXLINE(  54)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
...
HXDLIN(  87)		if ((::lime::utils::Log_obj::level >= (int)5)) {
HXLINE(  89)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] ",23,51,00,00));
...
HXDLIN(  95)		if ((::lime::utils::Log_obj::level >= (int)2)) {
HXLINE( 100)			::String message1 = ((HX_("[",5b,00,00,00) + ( (::String)(info->__Field(HX_("className",a3,92,3d,dc),hx::paccDynamic)) )) + HX_("] WARNING: ",5f,da,b0,cd));
