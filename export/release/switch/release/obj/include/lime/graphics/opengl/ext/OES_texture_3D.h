...
HXLINE(  11)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->FRAMEBUFFER_ATTACHMENT_TEXTURE_3D_ZOFFSET_OES = (int)36052;
HXLINE(  10)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->SAMPLER_3D_OES = (int)35679;
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->MAX_3D_TEXTURE_SIZE_OES = (int)32883;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->TEXTURE_BINDING_3D_OES = (int)32874;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->TEXTURE_3D_OES = (int)32879;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_texture_3D)(__this) )->TEXTURE_WRAP_R_OES = (int)32882;
            	}
