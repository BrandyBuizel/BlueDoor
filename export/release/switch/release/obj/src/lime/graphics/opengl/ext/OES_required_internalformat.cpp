...
HXLINE(  19)		this->RGB10_EXT = (int)32850;
HXLINE(  18)		this->RGBA8_OES = (int)32856;
HXLINE(  17)		this->RGB8_OES = (int)32849;
HXLINE(  16)		this->RGB565_OES = (int)36194;
HXLINE(  15)		this->RGB5_A1_OES = (int)32855;
HXLINE(  14)		this->RGBA4_OES = (int)32854;
HXLINE(  13)		this->LUMINANCE8_OES = (int)32832;
HXLINE(  12)		this->LUMINANCE8_ALPHA8_OES = (int)32837;
HXLINE(  11)		this->LUMINANCE4_ALPHA4_OES = (int)32835;
HXLINE(  10)		this->DEPTH_COMPONENT32_OES = (int)33191;
HXLINE(   9)		this->DEPTH24_STENCIL8_OES = (int)35056;
HXLINE(   8)		this->DEPTH_COMPONENT24_OES = (int)33190;
HXLINE(   7)		this->DEPTH_COMPONENT16_OES = (int)33189;
HXLINE(   6)		this->ALPHA8_OES = (int)32828;
            	}
