...
HXDLIN(  32)		if ((transform->redMultiplier == (int)1)) {
HXDLIN(  32)			_hx_tmp = (transform->greenMultiplier != (int)1);
            		}
            		else {
HXDLIN(  32)			_hx_tmp = true;
            		}
HXDLIN(  32)		if (!(_hx_tmp)) {
HXDLIN(  32)			return (transform->blueMultiplier != (int)1);
            		}
            		else {
...
HXDLIN(  40)			return (transform->alphaMultiplier != (int)1);
            		}
            		else {
...
HXDLIN(  48)		if ((transform->redOffset == (int)0)) {
HXDLIN(  48)			_hx_tmp = (transform->greenOffset != (int)0);
            		}
            		else {
HXDLIN(  48)			_hx_tmp = true;
            		}
HXDLIN(  48)		if (!(_hx_tmp)) {
HXDLIN(  48)			return (transform->blueOffset != (int)0);
            		}
            		else {
...
HXDLIN(  56)			return (transform->alphaOffset != (int)0);
            		}
            		else {
