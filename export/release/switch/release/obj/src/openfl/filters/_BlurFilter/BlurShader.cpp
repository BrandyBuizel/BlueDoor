...
HX_DEFINE_STACK_FRAME(_hx_pos_4c03b94c358d6de6_310_new,"openfl.filters._BlurFilter.BlurShader","new",0x1c9d0f9f,"openfl.filters._BlurFilter.BlurShader.new","openfl/filters/BlurFilter.hx",310,0x46563eac)
static const Float _hx_array_data_309f542d_1[] = {
	(Float)0,(Float)0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_4c03b94c358d6de6_319___update,"openfl.filters._BlurFilter.BlurShader","__update",0x96830d8a,"openfl.filters._BlurFilter.BlurShader.__update","openfl/filters/BlurFilter.hx",319,0x46563eac)
namespace openfl{
namespace filters{
namespace _BlurFilter{

void BlurShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_310_new)
...
HXLINE( 311)		super::__construct(null());
HXLINE( 314)		this->uRadius->value = ::Array_obj< Float >::fromData( _hx_array_data_309f542d_1,2);
...
void BlurShader_obj::_hx___update(){
            	HX_STACKFRAME(&_hx_pos_4c03b94c358d6de6_319___update)
HXLINE( 321)		this->uTextureSize->value = ::Array_obj< Float >::__new(2)->init(0,this->_hx___texture->input->width)->init(1,this->_hx___texture->input->height);
HXLINE( 324)		this->super::_hx___update();
            	}
