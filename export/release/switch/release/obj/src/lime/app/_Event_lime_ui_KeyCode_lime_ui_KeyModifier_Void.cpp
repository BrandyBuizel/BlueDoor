...
HX_DEFINE_STACK_FRAME(_hx_pos_56b65ef141dbb467_41_new,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","new",0xf84a4b82,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void.new","lime/app/Event.hx",41,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_56b65ef141dbb467_57_add,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","add",0xf8406d43,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void.add","lime/app/Event.hx",57,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_56b65ef141dbb467_81_cancel,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","cancel",0x01b59398,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void.cancel","lime/app/Event.hx",81,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_56b65ef141dbb467_126_has,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","has",0xf845ba7c,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void.has","lime/app/Event.hx",126,0xbda45bec)
HX_LOCAL_STACK_FRAME(_hx_pos_56b65ef141dbb467_142_remove,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","remove",0x4e0a4262,"lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void.remove","lime/app/Event.hx",142,0xbda45bec)
...
void _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_56b65ef141dbb467_41_new)
...
bool _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x7f02c176;
}
...
int priority = __o_priority.Default(0);
            	HX_STACKFRAME(&_hx_pos_56b65ef141dbb467_57_add)
HXLINE(  59)		{
...
void _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::cancel(){
            	HX_STACKFRAME(&_hx_pos_56b65ef141dbb467_81_cancel)
...
bool _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::has( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_56b65ef141dbb467_126_has)
HXLINE( 128)		{
...
void _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::remove( ::Dynamic listener){
            	HX_STACKFRAME(&_hx_pos_56b65ef141dbb467_142_remove)
...
static hx::StorageInfo _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj_sMemberStorageInfo[] = {
	{hx::fsBool,(int)offsetof(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj,canceled),HX_HCSTRING("canceled","\x59","\x18","\x26","\x1f")},
	{hx::fsObject /*Array< bool >*/ ,(int)offsetof(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj,_hx___repeat),HX_HCSTRING("__repeat","\x7b","\x02","\xac","\xae")},
	{hx::fsObject /*Array< int >*/ ,(int)offsetof(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj,_hx___priorities),HX_HCSTRING("__priorities","\xe2","\xcb","\xe6","\x1c")},
	{hx::fsObject /*cpp::ArrayBase*/ ,(int)offsetof(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj,_hx___listeners),HX_HCSTRING("__listeners","\x5f","\xae","\xba","\x21")},
	{ hx::fsUnknown, 0, null()}
};
...
static void _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj_sMarkStatics(HX_MARK_PARAMS) {
	HX_MARK_MEMBER_NAME(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__mClass,"__mClass");
};

#ifdef HXCPP_VISIT_ALLOCS
static void _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj_sVisitStatics(HX_VISIT_PARAMS) {
	HX_VISIT_MEMBER_NAME(_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::__mClass,"__mClass");
};
...
{
	hx::Object *dummy = new _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj;
	_Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj::_hx_vtable = *(void **)dummy;
	hx::Static(__mClass) = new hx::Class_obj();
	__mClass->mName = HX_HCSTRING("lime.app._Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void","\x90","\x22","\x22","\x17");
	__mClass->mSuper = &super::__SGetClass();
	__mClass->mConstructEmpty = &__CreateEmpty;
	__mClass->mConstructArgs = &__Create;
	__mClass->mGetStaticField = &hx::Class_obj::GetNoStaticField;
	__mClass->mSetStaticField = &hx::Class_obj::SetNoStaticField;
	__mClass->mMarkFunc = _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj_sMarkStatics;
...
#ifdef HXCPP_VISIT_ALLOCS
	__mClass->mVisitFunc = _Event_lime_ui_KeyCode_lime_ui_KeyModifier_Void_obj_sVisitStatics;
#endif
