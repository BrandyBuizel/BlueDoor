...
HXLINE( 150)		this->_inc = (int)1;
HXLINE( 140)		this->finished = false;
HXLINE( 138)		this->nodeIndex = (int)0;
...
HXLINE( 232)		if ((this->_nodes->length > (int)0)) {
...
HXLINE( 249)		this->active = (this->_nodes->length > (int)0);
HXLINE( 250)		if (!(this->active)) {
HXLINE( 252)			return hx::ObjectPtr<OBJ_>(this);
            		}
HXLINE( 256)		bool _hx_tmp;
HXDLIN( 256)		if ((this->_mode != (int)1)) {
HXLINE( 256)			_hx_tmp = (this->_mode == (int)256);
            		}
            		else {
HXLINE( 256)			_hx_tmp = true;
            		}
HXDLIN( 256)		if (_hx_tmp) {
HXLINE( 258)			this->nodeIndex = (this->_nodes->length - (int)1);
HXLINE( 259)			this->_inc = (int)-1;
            		}
            		else {
HXLINE( 263)			this->nodeIndex = (int)0;
HXLINE( 264)			this->_inc = (int)1;
            		}
...
HXLINE( 277)		if ((NodeIndex < (int)0)) {
HXLINE( 278)			NodeIndex = (int)0;
            		}
            		else {
HXLINE( 279)			if ((NodeIndex > (this->_nodes->length - (int)1))) {
HXLINE( 280)				NodeIndex = (this->_nodes->length - (int)1);
            			}
            		}
...
HXLINE( 315)		bool horizontalOnly = (((int)this->_mode & (int)(int)65536) > (int)0);
HXLINE( 316)		bool verticalOnly = (((int)this->_mode & (int)(int)1048576) > (int)0);
HXLINE( 318)		if (horizontalOnly) {
HXLINE( 320)			Float _hx_tmp;
HXDLIN( 320)			if ((deltaX > (int)0)) {
...
HXLINE( 334)				Float _hx_tmp2 = ::Math_obj::sqrt(((deltaX * deltaX) + (deltaY * deltaY)));
HXDLIN( 334)				if ((_hx_tmp2 < (this->speed * elapsed))) {
...
HXLINE( 341)			_hx_tmp3 = (this->speed != (int)0);
            		}
            		else {
...
HXLINE( 364)				this->object->angularVelocity = (int)0;
HXLINE( 365)				this->object->angularAcceleration = (int)0;
...
HXDLIN( 381)			if ((this->object->velocity->x < (int)0)) {
HXLINE( 381)				_hx_tmp2 = (int)-90;
            			}
            			else {
HXLINE( 381)				_hx_tmp2 = (int)90;
            			}
...
HXLINE( 385)				this->object->velocity->set_y((int)0);
            			}
            		}
            		else {
...
HXDLIN( 391)				if ((this->object->velocity->y < (int)0)) {
HXLINE( 391)					_hx_tmp5 = (int)0;
            				}
            				else {
HXLINE( 391)					_hx_tmp5 = (int)180;
            				}
HXDLIN( 391)				this->angle = _hx_tmp5;
HXLINE( 393)				if (!(verticalOnly)) {
HXLINE( 395)					this->object->velocity->set_x((int)0);
            				}
            			}
            			else {
...
HXLINE( 405)				this->object->velocity->set((int)0,-(this->speed));
HXLINE( 406)				 ::flixel::math::FlxPoint _hx_tmp8 = this->object->velocity;
HXDLIN( 406)				 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXLINE( 422)				if ((((int)this->_mode & (int)(int)1048576) == (int)0)) {
...
HXLINE( 428)				if ((((int)this->_mode & (int)(int)65536) == (int)0)) {
...
HXLINE( 440)		if ((((int)this->_mode & (int)(int)1) > (int)0)) {
HXLINE( 442)			if ((this->nodeIndex < (int)0)) {
HXLINE( 444)				this->nodeIndex = (int)0;
HXLINE( 445)				callComplete = true;
HXLINE( 446)				this->onEnd();
            			}
            		}
            		else {
HXLINE( 449)			if ((((int)this->_mode & (int)(int)16) > (int)0)) {
HXLINE( 451)				if ((this->nodeIndex >= this->_nodes->length)) {
HXLINE( 453)					callComplete = true;
HXLINE( 454)					this->nodeIndex = (int)0;
            				}
            			}
            			else {
HXLINE( 457)				if ((((int)this->_mode & (int)(int)256) > (int)0)) {
HXLINE( 459)					if ((this->nodeIndex < (int)0)) {
HXLINE( 461)						this->nodeIndex = (this->_nodes->length - (int)1);
HXLINE( 462)						callComplete = true;
HXLINE( 463)						if ((this->nodeIndex < (int)0)) {
HXLINE( 465)							this->nodeIndex = (int)0;
            						}
            					}
            				}
            				else {
HXLINE( 469)					if ((((int)this->_mode & (int)(int)4096) > (int)0)) {
HXLINE( 471)						if ((this->_inc > (int)0)) {
HXLINE( 473)							if ((this->nodeIndex >= this->_nodes->length)) {
HXLINE( 475)								this->nodeIndex = (this->_nodes->length - (int)2);
HXLINE( 476)								callComplete = true;
HXLINE( 477)								if ((this->nodeIndex < (int)0)) {
HXLINE( 479)									this->nodeIndex = (int)0;
            								}
HXLINE( 481)								this->_inc = -(this->_inc);
            							}
            						}
            						else {
HXLINE( 484)							if ((this->nodeIndex < (int)0)) {
HXLINE( 486)								this->nodeIndex = (int)1;
HXLINE( 487)								callComplete = true;
HXLINE( 488)								if ((this->nodeIndex >= this->_nodes->length)) {
HXLINE( 490)									this->nodeIndex = (this->_nodes->length - (int)1);
            								}
HXLINE( 492)								if ((this->nodeIndex < (int)0)) {
HXLINE( 494)									this->nodeIndex = (int)0;
            								}
...
HXLINE( 503)							this->nodeIndex = (this->_nodes->length - (int)1);
...
HXLINE( 528)			this->object->velocity->set((int)0,(int)0);
            		}
...
HXLINE( 541)			this->object->set_immovable(this->_wasObjectImmovable);
            		}
...
HXLINE( 646)		if ((index >= (int)0)) {
HXLINE( 648)			return this->_nodes->splice(index,(int)1)->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
            		}
...
HXLINE( 661)		if ((this->_nodes->length <= (int)0)) {
HXLINE( 663)			return null();
            		}
HXLINE( 665)		if ((Index >= (this->_nodes->length - (int)1))) {
HXLINE( 667)			this->_nodes->pop().StaticCast<  ::flixel::math::FlxPoint >();
            		}
HXLINE( 669)		return this->_nodes->splice(Index,(int)1)->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
            	}
...
HXLINE( 681)			return this->_nodes->__get((int)0).StaticCast<  ::flixel::math::FlxPoint >();
            		}
...
HXLINE( 693)		if ((this->_nodes->length > (int)0)) {
HXLINE( 695)			::Array< ::Dynamic> _hx_tmp = this->_nodes;
HXDLIN( 695)			return _hx_tmp->__get((this->_nodes->length - (int)1)).StaticCast<  ::flixel::math::FlxPoint >();
            		}
...
HXDLIN(  84)			return point;
            	...
            	HX_STACKFRAME(&_hx_pos_bbe6117fedb3c10f_84_boot)
HXDLIN(  84)		_point =  ::Dynamic(new _hx_Closure_0())();
            	}
}
