...
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::OES_packed_depth_stencil)(__this) )->DEPTH24_STENCIL8_OES = (int)35056;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::OES_packed_depth_stencil)(__this) )->UNSIGNED_INT_24_8_OES = (int)34042;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::OES_packed_depth_stencil)(__this) )->DEPTH_STENCIL_OES = (int)34041;
            	}
