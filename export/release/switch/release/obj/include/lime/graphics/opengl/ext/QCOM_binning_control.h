...
HXLINE(   9)		( ( ::lime::graphics::opengl::ext::QCOM_binning_control)(__this) )->RENDER_DIRECT_TO_FRAMEBUFFER_QCOM = (int)36787;
HXLINE(   8)		( ( ::lime::graphics::opengl::ext::QCOM_binning_control)(__this) )->GPU_OPTIMIZED_QCOM = (int)36786;
HXLINE(   7)		( ( ::lime::graphics::opengl::ext::QCOM_binning_control)(__this) )->CPU_OPTIMIZED_QCOM = (int)36785;
HXLINE(   6)		( ( ::lime::graphics::opengl::ext::QCOM_binning_control)(__this) )->BINNING_CONTROL_HINT_QCOM = (int)36784;
            	}
