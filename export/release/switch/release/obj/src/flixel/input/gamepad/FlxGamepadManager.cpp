...
HXLINE( 340)		{
HXLINE( 340)			int _g1 = (int)0;
HXDLIN( 340)			int _g = ::openfl::ui::GameInput_obj::numDevices;
HXDLIN( 340)			while((_g1 < _g)){
HXLINE( 340)				_g1 = (_g1 + (int)1);
HXDLIN( 340)				int i = (_g1 - (int)1);
...
HXDLIN( 115)				int _g = this->_activeGamepads->length;
...
HXDLIN( 224)		return this->anyHasState(buttonID,(int)1);
            	}
...
HXDLIN( 232)		return this->anyHasState(buttonID,(int)2);
            	}
...
HXDLIN( 240)		return this->anyHasState(buttonID,(int)-1);
            	}
...
HXDLIN( 361)			int _g = ::openfl::ui::GameInput_obj::numDevices;
HXDLIN( 361)			while((_g1 < _g)){
HXLINE( 361)				_g1 = (_g1 + (int)1);
HXDLIN( 361)				int i = (_g1 - (int)1);
...
HXLINE( 404)		if ((name.indexOf(HX_("ouya",6e,e0,b7,49),null()) != (int)-1)) {
HXLINE( 405)			return ::flixel::input::gamepad::FlxGamepadModel_obj::OUYA_dyn();
            		}
            		else {
HXLINE( 406)			bool _hx_tmp;
HXDLIN( 406)			if ((name.indexOf(HX_("wireless controller",5e,0b,31,72),null()) == (int)-1)) {
HXLINE( 406)				_hx_tmp = (name.indexOf(HX_("ps4",d1,60,55,00),null()) != (int)-1);
            			}
            			else {
...
HXLINE( 408)				if ((name.indexOf(HX_("logitech",3b,70,e5,19),null()) != (int)-1)) {
HXLINE( 409)					return ::flixel::input::gamepad::FlxGamepadModel_obj::LOGITECH_dyn();
            				}
            				else {
HXLINE( 410)					bool _hx_tmp1;
HXDLIN( 410)					bool _hx_tmp2;
HXDLIN( 410)					if ((name.indexOf(HX_("xbox",93,58,9c,4f),null()) != (int)-1)) {
HXLINE( 410)						_hx_tmp2 = (name.indexOf(HX_("360",2d,e2,26,00),null()) != (int)-1);
            					}
            					else {
HXLINE( 410)						_hx_tmp2 = false;
            					}
HXDLIN( 410)					if (!(_hx_tmp2)) {
HXLINE( 410)						_hx_tmp1 = (name.indexOf(HX_("xinput",92,10,f1,b8),null()) != (int)-1);
            					}
            					else {
...
HXLINE( 412)						if ((name.indexOf(HX_("nintendo rvlcnt01tr",cb,02,13,80),null()) != (int)-1)) {
HXLINE( 413)							return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            						}
            						else {
HXLINE( 414)							if ((name.indexOf(HX_("nintendo rvlcnt01",0d,c0,58,28),null()) != (int)-1)) {
HXLINE( 415)								return ::flixel::input::gamepad::FlxGamepadModel_obj::WII_REMOTE_dyn();
            							}
            							else {
HXLINE( 416)								if ((name.indexOf(HX_("mayflash wiimote pc adapter",ed,5a,02,8e),null()) != (int)-1)) {
HXLINE( 417)									return ::flixel::input::gamepad::FlxGamepadModel_obj::MAYFLASH_WII_REMOTE_dyn();
            								}
            								else {
HXLINE( 418)									bool _hx_tmp3;
HXDLIN( 418)									if ((name.indexOf(HX_("pro controller",af,e5,18,de),null()) == (int)-1)) {
HXLINE( 418)										_hx_tmp3 = (name.indexOf(HX_("joycon l+r",e1,d0,50,00),null()) != (int)-1);
            									}
            									else {
...
HXLINE( 420)										if ((name.indexOf(HX_("joycon (l)",f3,6f,1d,00),null()) != (int)-1)) {
HXLINE( 421)											return ::flixel::input::gamepad::FlxGamepadModel_obj::SWITCH_JOYCON_LEFT_dyn();
            										}
            										else {
HXLINE( 422)											if ((name.indexOf(HX_("joycon (r)",2d,75,1d,00),null()) != (int)-1)) {
HXLINE( 423)												return ::flixel::input::gamepad::FlxGamepadModel_obj::SWITCH_JOYCON_RIGHT_dyn();
            											}
            											else {
HXLINE( 424)												if ((name.indexOf(HX_("mfi",f0,0e,53,00),null()) != (int)-1)) {
...
HXDLIN( 435)			int _g = this->_gamepads->length;
