...
HXDLIN(  20)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN(  20)		 ::haxe::io::Bytes _hx_tmp1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  20)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_zlib_compress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
...
HXDLIN(  50)		 ::Dynamic _hx_tmp = hx::ClassOf< ::lime::_internal::backend::native::NativeCFFI >();
HXDLIN(  50)		 ::haxe::io::Bytes _hx_tmp1 = ::haxe::io::Bytes_obj::alloc((int)0);
HXDLIN(  50)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_zlib_decompress(hx::DynamicPtr(bytes),hx::DynamicPtr(_hx_tmp1))) );
            	}
...
void Zlib_obj::__register()
{
	...
	__mClass->mName = HX_HCSTRING("lime._internal.format.Zlib","\xd7","\xd2","\x35","\x70");
