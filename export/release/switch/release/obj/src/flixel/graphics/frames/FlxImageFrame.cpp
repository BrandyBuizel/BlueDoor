...
HXLINE( 237)		 ::flixel::math::FlxPoint point = ::flixel::math::FlxPoint_obj::_pool->get()->set((int)0,(int)0);
...
HXDLIN( 256)		return this->frames->__get((int)0).StaticCast<  ::flixel::graphics::frames::FlxFrame >();
            	}
